...
/area/rnd/outpost/firstaid
	name = "\improper Research Outpost First Aid"
	
/area/rnd/outpost/breakroom/outdoor_seating
	name = "\improper Research Outpost Outdoors Seating Area"
	
/area/rnd/outpost/west_hallway
