...
/datum/map/tropic_southern_cross
	name = "Southern Cross"
	...
	zlevel_datum_type = /datum/map_z_level/tropic_southern_cross
	...
	default_skybox = /datum/skybox_settings/tropic_southern_cross
	unit_test_exempt_areas = list(/area/ninja_dojo, /area/shuttle/ninja)
	unit_test_exempt_from_atmos = list(/area/tcomm/chamber)

	planet_datums_to_make = list(/datum/planet/tropicsif) //This must be added to load maps at round start otherwise they will have weather or sun.
...
*/
/datum/map/tropic_southern_cross/perform_map_generation()
	...
	seed_submaps(list(Z_LEVEL_MINE), 300, /area/surface/deepcaverns, /datum/map_template/surface/crystalcore/layer1)
	seed_submaps(list(Z_LEVEL_MINE_DEEPER), 300, /area/surface/deepcaverns/deepest, /datum/map_template/surface/crystalcore/layer3)
	seed_submaps(list(Z_LEVEL_MINE_DEEPEST), 300, /area/surface/deepcaverns/dark, /datum/map_template/surface/crystalcore/layer4)


	// Now for the tunnels. (This decides the load order of ore generation and cave generation. Check Random_Map to see % )
	new /datum/random_map/automata/cave_system/purplelayer/(null, 1, 1, Z_LEVEL_MINE, world.maxx, world.maxy) // Create the mining Z-level.
	new /datum/random_map/noise/ore(null, 1, 1, Z_LEVEL_MINE, 64, 64)         // Create the mining ore distribution map.
	new /datum/random_map/automata/cave_system/redlayer/(null, 1, 1, Z_LEVEL_MINE_DEEPER, world.maxx, world.maxy) // Create the mining Z-level.
	new /datum/random_map/noise/ore(null, 1, 1, Z_LEVEL_MINE_DEEPER, 64, 64)
	new /datum/random_map/automata/cave_system/darklayer/(null, 1, 1, Z_LEVEL_MINE_DEEPEST, world.maxx, world.maxy) // Create the mining Z-level.
	new /datum/random_map/noise/ore(null, 1, 1, Z_LEVEL_MINE_DEEPEST, 64, 64)
	// Todo: Forest generation.
	return 1

// Skybox Settings
/datum/skybox_settings/tropic_southern_cross
	icon_state = "dyable"
	random_color = TRUE
...
/datum/map_z_level/tropic_southern_cross/station
	flags = MAP_LEVEL_STATION|MAP_LEVEL_CONTACT|MAP_LEVEL_PLAYER|MAP_LEVEL_CONSOLES|MAP_LEVEL_VORESPAWN
	holomap_legend_x = 220
	holomap_legend_y = 160

/datum/map_z_level/tropic_southern_cross/station/station_one
...
/datum/map_z_level/tropic_southern_cross/station/station_two
...
/datum/map_z_level/tropic_southern_cross/station/station_three
...
/datum/map_z_level/southern_cross/empty_space
	...
	transit_chance = 60
*/
/datum/map_z_level/tropic_southern_cross/surface
	z = Z_LEVEL_SURFACE
	name = "Plains"
	flags = MAP_LEVEL_CONTACT|MAP_LEVEL_PLAYER|MAP_LEVEL_CONSOLES|MAP_LEVEL_VORESPAWN
	base_turf = /turf/simulated/floor/outdoors/rocks

/datum/map_z_level/tropic_southern_cross/surface_mine
	z = Z_LEVEL_MINE
	name = "Mountains"
...
/datum/map_z_level/tropic_southern_cross/surface_wild
	z = Z_LEVEL_MINE_DEEPER
	name = "Wilderness"
	flags = MAP_LEVEL_PLAYER|MAP_LEVEL_CONTACT|MAP_LEVEL_CONSOLES
	base_turf = /turf/simulated/floor/outdoors/rocks

/*
/datum/map_z_level/tropic_southern_cross/surface_skylands
	z = Z_LEVEL_MINE_DEEPER
...
/datum/map_z_level/tropic_southern_cross/surface_valley
	z = Z_LEVEL_MINE_DEEPEST
	name = "Valley"
	flags = MAP_LEVEL_PLAYER|MAP_LEVEL_CONTACT|MAP_LEVEL_CONSOLES
	base_turf = /turf/simulated/floor/outdoors/rocks
...
/*/datum/map_z_level/southern_cross/surface_casino
	...
	base_turf = /turf/simulated/floor/outdoors/rocks
*/
/datum/map_z_level/tropic_southern_cross/misc
	z = Z_LEVEL_MISC
	name = "Misc"
	flags = MAP_LEVEL_PLAYER|MAP_LEVEL_VORESPAWN
	transit_chance = 15

/datum/map_z_level/tropic_southern_cross/centcom
	z = Z_LEVEL_CENTCOM
	name = "Centcom"
	flags = MAP_LEVEL_ADMIN|MAP_LEVEL_CONTACT

/datum/map_z_level/tropic_southern_cross/transit
	z = Z_LEVEL_TRANSIT
	name = "Transit"
