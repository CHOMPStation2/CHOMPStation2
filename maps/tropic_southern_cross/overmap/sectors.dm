...
/obj/effect/overmap/visitable/planet/tropicSif
	name = "Sif?"
...
[b]Notice[/b]: The Vir government welcomes you to this world."}
	...
	map_z = list(Z_LEVEL_MINE_DEEPEST, Z_LEVEL_MINE_DEEPER, Z_LEVEL_MINE, Z_LEVEL_SURFACE)
...
/obj/effect/overmap/visitable/planet/tropicSif/Initialize()
...
/obj/effect/overmap/visitable/planet/tropicSif/get_skybox_representation()
	var/image/tmp = ..()
...
[b]Notice[/b]: NanoTrasen communications station, authorized personnel only"}
	...
	extra_z_levels = list(Z_LEVEL_TRANSIT, Z_LEVEL_MISC,Z_LEVEL_MINE_DEEPEST, Z_LEVEL_MINE_DEEPER, Z_LEVEL_MINE, Z_LEVEL_SURFACE) //This should allow for comms to reach people from the station. Basically this defines all the areas of Southern Cross and the Sif local system on the overmap.
