...
/obj/machinery/porta_turret/alien/ion
	...
	installation = /obj/item/gun/energy/ionrifle/weak // CHOMPEdit - Removal of obj/item/weapon
	enabled = TRUE
	lethal = TRUE
	ailock = TRUE
	check_all = TRUE
...
/obj/item/reagent_containers/hypospray/autoinjector/alien // CHOMPEdit - Removal of obj/item/weapon
	name = "alien injector(?)"
