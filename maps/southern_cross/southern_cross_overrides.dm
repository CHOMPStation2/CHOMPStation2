...
/obj/item/card/id/platform/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/disposable_teleporter/attack_self(mob/user as mob)//Prevents people from using technomancer gear to escape to station from the VR pods. // CHOMPEdit - Removal of obj/item/weapon
