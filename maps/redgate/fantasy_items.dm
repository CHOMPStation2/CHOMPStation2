...
/obj/item/healthanalyzer/scroll //reports all of the above, as well as name and quantity of nonmed reagents in stomach // CHOMPEdit - Removal of obj/item/device
...
/obj/item/tool/crowbar/alien/magic // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/tool/screwdriver/alien/magic // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/weldingtool/alien/magic // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/tool/wirecutters/alien/magic // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/tool/wrench/alien/magic // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/surgical/bone_clamp/alien/magic // CHOMPEdit - Removal of obj/item/weapon
	icon = 'icons/obj/abductor.dmi'
	toolspeed = 0.75
...
/obj/structure/bed/bath/attackby(obj/item/I, mob/user)
	if(istype(I, /obj/item/mop) || istype(I, /obj/item/soap)) //VOREStation Edit - "Allows soap and rags to be used on mopbuckets" // CHOMPEdit - Removal of obj/item/weapon
		if(reagents.total_volume < 1)
	...
	if(istype(I, /obj/item/reagent_containers/glass)) // CHOMPEdit - Removal of obj/item/weapon
		update_icon()
		return
	else if(istype(I, /obj/item/grab)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/microwave/cookingpot/attackby(var/obj/item/O as obj, var/mob/user as mob)
	if(src.broken > 0)
		...
		if(istype(O, /obj/item/reagent_containers/spray/cleaner) || istype(O, /obj/item/soap)) // If they're trying to clean it then let them // CHOMPEdit - Removal of obj/item/weapon
			user.visible_message( \
		...
		//	user.remove_from_mob(O)	//This just causes problems so far as I can tell. -Pete - Man whoever you are, it's been years. o7
			...
			SStgui.update_uis(src)
			return
	else if (istype(O,/obj/item/storage/bag/plants)) // There might be a better way about making plant bags dump their contents into a microwave, but it works. // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/storage/bag/plants/bag = O // CHOMPEdit - Removal of obj/item/weapon
		var/failed = 1
		...
		for (var/datum/reagent/R in O.reagents.reagent_list)
			if (!(R.id in acceptable_reagents))
				...
				return 1
		return
	else if(istype(O,/obj/item/grab)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/grab/G = O // CHOMPEdit - Removal of obj/item/weapon
		...
		return
	else if(istype(O, /obj/item/paicard)) // CHOMPEdit - Removal of obj/item/device
		if(!paicard)
			insertpai(user, O)
	else
...
/obj/item/bluespace_harpoon/wand // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/bluespace_harpoon/wand/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(transforming)
		switch(mode)
			if(0)
...
/obj/item/gun/energy/taser/magic // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/chemical_dispenser/kettle/full
	spawn_cartridges = list(
			...
			/obj/item/reagent_containers/chem_disp_cartridge/chaitea, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/reagent_containers/chem_disp_cartridge/decafchai // CHOMPEdit - Removal of obj/item/weapon
		)

// teleporter

/obj/item/perfect_tele/magic // CHOMPEdit - Removal of obj/item/device
...
/obj/item/perfect_tele_beacon/magic // CHOMPEdit - Removal of obj/item/device
...
/obj/item/perfect_tele/magic/attack_self(mob/user, var/radial_menu_anchor = src) // CHOMPEdit - Removal of obj/item/device
	if(loc_network)
		for(var/obj/item/perfect_tele_beacon/stationary/nb in GLOB.premade_tele_beacons) //ChompEDIT - GLOB // CHOMPEdit - Removal of obj/item/device
...
"},"OOC Warning")
	...
	if(!choice)
		...
		var/obj/item/perfect_tele_beacon/magic/nb = new(get_turf(src)) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/slow_sizegun/magic // CHOMPEdit - Removal of obj/item/device
...
/obj/item/simple_key/dungeon // CHOMPEdit - Removal of obj/item/weapon
	name = "old key"
