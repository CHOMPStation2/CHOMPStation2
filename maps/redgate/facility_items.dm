/obj/item/card/id/keycard // CHOMPEdit - Removal of obj/item/weapon
	name = "keycard"
...
/obj/item/card/id/keycard/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/card/id/keycard/read() // CHOMPEdit - Removal of obj/item/weapon
	to_chat(usr, "<span class='notice'>It is a red keycard, it must unlock something.</span>")

/obj/item/card/id/keycard/attack_self(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/card/id/keycard/blue // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "keycard-blue"
	access = list(802)

/obj/item/card/id/keycard/green // CHOMPEdit - Removal of obj/item/weapon
