...
/obj/item/cell/after_trash_eaten(var/mob/living/user)
	visible_message(span_warning("[user] sates their electric appetite with a [I]!"))
...
/obj/item/walkpod/after_trash_eaten(var/mob/living/user)
	visible_message(span_warning("[user] sates their musical appetite with a [I]!"))
...
/obj/item/mail/junkmail/after_trash_eaten(var/mob/living/user)
	visible_message(span_warning("[user] devours the [I]!"))
