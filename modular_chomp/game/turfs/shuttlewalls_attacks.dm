...
/turf/simulated/shuttlewalls/attackby(var/obj/item/W, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
*/
	...
	if(istype(W, /obj/item/electronic_assembly/wallmount)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/electronic_assembly/wallmount/IC = W // CHOMPEdit - Removal of obj/item/device
	...
	if(thermite)
		...
		else if(istype(W, /obj/item/pickaxe/plasmacutter)) // CHOMPEdit - Removal of obj/item/weapon
			thermitemelt(user)
			return

		else if( istype(W, /obj/item/melee/energy/blade) ) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/melee/energy/blade/EB = W // CHOMPEdit - Removal of obj/item/weapon
	...
	if(isnull(construction_stage) || !reinf_material)
		...
		//	cut_delay *= 0.7 // Tools themselves now can shorten the time it takes.
			...
			cut_delay *= 0.5
		else if(istype(W,/obj/item/pickaxe)) // CHOMPEdit - Removal of obj/item/weapon
	...
	else if(!istype(W,/obj/item/rcd) && !istype(W, /obj/item/reagent_containers)) // CHOMPEdit - Removal of obj/item/weapon
