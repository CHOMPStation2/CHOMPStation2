...
[b]Notice[/b]: NanoTrasen communications station, authorized personnel only"}
	...
	extra_z_levels = list(Z_LEVEL_SN_TRANSIT, Z_LEVEL_SN_MISC, Z_LEVEL_SN_SURFACE, Z_LEVEL_SN_SURFACE_MINE, Z_LEVEL_SN_SURFACE_WILD) //This should allow for comms to reach people from the station. Basically this defines all the areas of Southern Cross and the Sif local system on the overmap.
...
[b]Notice[/b]: The Vir government welcomes you to this world."}
	...
	map_z = list(Z_LEVEL_RB_CATACOMBS, Z_LEVEL_RB_UNDERGROUND, Z_LEVEL_RB_SURFACE, Z_LEVEL_RB_UPPER_FLOORS, Z_LEVEL_RB_SURFACE_WILDS, Z_LEVEL_RB_SURFACE_OCEAN, Z_LEVEL_RB_CARRIER)
...
/obj/effect/overmap/visitable/planet/Thor/get_space_zlevels()
	return list(Z_LEVEL_RB_CARRIER)
...
[b]Notice[/b]: The Vir government welcomes you to this world."}
	...
	map_z = list(Z_LEVEL_SC_SURFACE, Z_LEVEL_SC_SURFACE_MINE, Z_LEVEL_SC_SURFACE_WILD)
	//Z_LEVEL_SURFACE_SKYLANDS, //removed due to lack of use
