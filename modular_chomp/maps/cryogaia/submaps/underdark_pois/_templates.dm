...
/datum/map_template/underdark/mimicry
	...
	mappath = "maps/yw/submaps/underdark_pois/mimicry.dmm"
	cost = 15

/datum/map_template/underdark/wolf_den
	name = "Underdark Wolf Den"
	mappath = "maps/yw/submaps/underdark_pois/wolf_den.dmm"
	cost = 15

/datum/map_template/underdark/puzzle_corridor
	name = "Underdark Puzzle Corridor"
	mappath = "maps/yw/submaps/underdark_pois/puzzle_corridor.dmm"
	cost = 10
...
/datum/map_template/underdark/rad_threat
	...
	mappath = "maps/yw/submaps/underdark_pois/rad_threat.dmm"
	cost = 10

/datum/map_template/underdark/broken_engine
	name = "Underdark Broken Twin Engine"
	mappath = "maps/yw/submaps/underdark_pois/broken_engine.dmm"
	cost = 10

/datum/map_template/underdark/boss_mob
	name = "Underdark Boss Mob Spawn"
	mappath = "maps/yw/submaps/underdark_pois/boss_mob.dmm"
	cost = 60
	allow_duplicates = FALSE

/datum/map_template/underdark/whatever_treasure
	name = "Some Kinda Treasure" //A name, only visible to admins
	mappath = "maps/yw/submaps/underdark_pois/hard_mob.dmm" //The .dmm file for this template (in this folder)
