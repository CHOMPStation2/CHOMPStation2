...
//		#include "southern_cross-0.dmm" // Deck 0
		...
		#include "../southern_cross/southern_cross-4.dmm" //Sif outpost z4
		#include "../southern_cross/southern_cross-5.dmm" //Sif mine z5
		#include "soluna_nexus-6.dmm" //Carrier z6
		#include "soluna_nexus-7.dmm" //Centcom z7
		#include "soluna_nexus-8.dmm" //Transit z8
		#include "../southern_cross/southern_cross-9.dmm" //Sif wilds z9
