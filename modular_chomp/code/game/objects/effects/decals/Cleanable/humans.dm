...
/obj/effect/decal/cleanable/mucus/attackby(obj/item/I, mob/user)
	...
	if(istype(I, /obj/item/reagent_containers/glass/beaker/vial) && virus2.len && !sampled) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/virusdish/sample // CHOMPEdit - Removal of obj/item/weapon
		user.balloon_alert_visible("Takes a virus sample", "Taking a virus sample")
		for(var/datum/disease2/disease/D in virus2)
			sample = new /obj/item/virusdish(src.loc) // CHOMPEdit - Removal of obj/item/weapon
