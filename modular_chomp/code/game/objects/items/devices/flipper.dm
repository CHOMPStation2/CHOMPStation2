...
/obj/item/paicard/flipper // CHOMPEdit - Removal of obj/item/device
	name 				= "Vix"
	...
	var/obj/item/multitool/MultiTool // CHOMPEdit - Removal of obj/item/device
	var/obj/item/assembly/signaler/Signal // CHOMPEdit - Removal of obj/item/device
...
*
*/
/obj/item/paicard/flipper/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(selected && selected != "Emag")
		var/obj/item/module = selected
		return module.attack_self(user)
	..()

/obj/item/paicard/flipper/Initialize() //ChompEDIT New --> Initialize // CHOMPEdit - Removal of obj/item/device
	..()
	...
	MultiTool 	= new /obj/item/multitool(src) // CHOMPEdit - Removal of obj/item/device
	Signal 	= new /obj/item/assembly/signaler(src) // CHOMPEdit - Removal of obj/item/device
 ...
 */
/obj/item/paicard/flipper/pre_attack(atom/A, mob/user, params) // CHOMPEdit - Removal of obj/item/device
	if(selected)
		if(selected=="Emag")
 ...
 */
/obj/item/paicard/flipper/proc/proxy_attackby(atom/A,atom/B, mob/user, var/click_parameters) // CHOMPEdit - Removal of obj/item/device
 ...
 */
/obj/item/paicard/flipper/proc/system_select(mob/user) // CHOMPEdit - Removal of obj/item/device
 ...
 */
/obj/item/paicard/flipper/AltClick(mob/living/user) // CHOMPEdit - Removal of obj/item/device
	system_select(user)
...
/obj/item/paicard/flipper/attack_ghost(mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	...
	if(choice == "No")
		...
		if(isnull(actual_pai_name))
			return ..()
		var/obj/item/paicard/flipper/card = new(location) // CHOMPEdit - Removal of obj/item/device
