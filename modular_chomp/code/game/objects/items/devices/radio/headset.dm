...
/obj/item/radio/headset/event // CHOMPEdit - Removal of obj/item/device
...
/obj/item/radio/headset/event/equipped(var/mob/living/carbon/human/H) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/radio/headset/event/dropped(var/mob/living/carbon/human/H) // CHOMPEdit - Removal of obj/item/device
	..()
	if(wearer)
		wearer = null
		if(light_power)
...
/obj/item/radio/headset/event/handle_shield(mob/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, var/attack_text = "the attack") // CHOMPEdit - Removal of obj/item/device
	if(!telez)
		return FALSE
...
/obj/item/radio/headset/outsider // CHOMPEdit - Removal of obj/item/device
	name = "generic headset"
	desc = "Headset used by those upon the planet, or in other words, outsiders."
	icon_state = "exp_headset"
	adhoc_fallback = TRUE

	ks1type = /obj/item/encryptionkey/headset_outsider // CHOMPEdit - Removal of obj/item/device


/obj/item/encryptionkey/headset_outsider // CHOMPEdit - Removal of obj/item/device
