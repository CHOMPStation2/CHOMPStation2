...
/obj/item/mindbinder // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mindbinder/New() // CHOMPEdit - Removal of obj/item/device
	..()
	flags |= NOBLUDGEON //So borgs don't spark.

/obj/item/mindbinder/attack(mob/living/M, mob/living/user) // CHOMPEdit - Removal of obj/item/device
	usr.setClickCooldown(DEFAULT_ATTACK_COOLDOWN)
	return

/obj/item/mindbinder/attack_self(mob/living/user) // CHOMPEdit - Removal of obj/item/device
	return

/obj/item/mindbinder/proc/toggle_self_bind() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mindbinder/pre_attack(atom/A) // CHOMPEdit - Removal of obj/item/device
	if(istype(A, /obj/structure/gargoyle))
		var/obj/structure/gargoyle/G = A
		A = G.gargoyle
	if(istype(A, /obj/item/holder)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/holder/H = A // CHOMPEdit - Removal of obj/item/weapon
		A = H.held_mob
...
/obj/item/mindbinder/proc/bind_mob(mob/living/target) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mindbinder/proc/bind_item(obj/item/item) // CHOMPEdit - Removal of obj/item/device
	if(possessed_voice.len == 0 && !self_bind)
		to_chat(usr,"<span class='warning'>The device beeps a warning that it doesn't contain a mind to bind!</span>")
		return
...
/obj/item/mindbinder/proc/store_mob(mob/living/target) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mindbinder/proc/store_item(obj/item/item) // CHOMPEdit - Removal of obj/item/device
	if(possessed_voice.len != 0)
		to_chat(usr,"<span class='warning'>The device beeps a warning that there is already a mind loaded!</span>")
		return
...
/obj/item/mindbinder/update_icon() // CHOMPEdit - Removal of obj/item/device
