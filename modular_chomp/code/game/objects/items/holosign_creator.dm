/obj/item/holosign_creator // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/holosign_creator/afterattack(atom/target, mob/user, clickchain_flags, list/params) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/holosign_creator/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(.)
		return
	if(signs.len)
...
/obj/item/holosign_creator/combifan // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/holosign_creator/medical // CHOMPEdit - Removal of obj/item/weapon
