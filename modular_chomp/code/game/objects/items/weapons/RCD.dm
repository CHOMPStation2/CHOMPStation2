...
/obj/item/rcd/advanced // CHOMPEdit - Removal of obj/item/weapon
	can_remove_rwalls = 1
/*
Material values
plasteel = 12
...
/obj/item/rcd/emag_act(var/remaining_charges, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(!emagged)
		emagged = 1
...
/obj/item/rcd/proc/loadwithsheets(obj/item/stack/S, value, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	...
	switch(choice)
		...
		if("WallFrames")
			...
			switch(selected_wall_frame_type)
				...
				if("Intercom")
					wall_frame_type = /obj/item/radio/intercom // CHOMPEdit - Removal of obj/item/device
				if("Keycard Authenticator")
					wall_frame_type = /obj/machinery/keycard_auth
				if("Geiger Counter")
					wall_frame_type = /obj/item/geiger/wall // CHOMPEdit - Removal of obj/item/device
...
/obj/item/rcd/proc/get_airlock_image(airlock_type) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rcd/proc/change_airlock_setting(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!user)
		return
...
/obj/item/rcd/proc/change_airlock_access(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rcd/Topic(href, href_list) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/rcd/proc/toggle_access(acc) // CHOMPEdit - Removal of obj/item/weapon
	if (acc == "all")
		conf_access = null
	else if(acc == "one")
...
///////////////FLOOR//////////////////
//////////////////////////////////////
/turf/simulated/floor/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	switch(passed_mode)
		if(RCD_FLOORWALL)
...
/turf/simulated/floor/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	switch(passed_mode)
		if(RCD_FLOORWALL)
		...
		if(RCD_AIRLOCK)
			...
			A.electronics = new/obj/item/airlock_electronics(A) // CHOMPEdit - Removal of obj/item/weapon
...
//////////////WALL////////////////////
//////////////////////////////////////
/turf/simulated/wall/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	switch(passed_mode)
		if(RCD_DECONSTRUCT)
...
/turf/simulated/wall/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	switch(passed_mode)
		if(RCD_DECONSTRUCT)
			to_chat(user, span("notice", "You deconstruct \the [src]."))
			ChangeTurf(/turf/simulated/floor/airless, preserve_outdoors = TRUE)
...
//////////////GIRDER//////////////////
//////////////////////////////////////
/obj/structure/girder/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/girder/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	var/turf/simulated/T = get_turf(src)
...
/////////////WINDOW///////////////////
//////////////////////////////////////
/obj/structure/window/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	switch(passed_mode)
		if(RCD_DECONSTRUCT)
			return list(
				RCD_VALUE_MODE = RCD_DECONSTRUCT,
...
/obj/structure/window/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	switch(passed_mode)
		if(RCD_DECONSTRUCT)
			to_chat(user, span("notice", "You deconstruct \the [src]."))
			qdel(src)
...
//////////////GRILLE//////////////////
//////////////////////////////////////
/obj/structure/grille/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	switch(passed_mode)
		if(RCD_WINDOWGRILLE)
...
/obj/structure/grille/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	switch(passed_mode)
		if(RCD_DECONSTRUCT)
			to_chat(user, span("notice", "You deconstruct \the [src]."))
			qdel(src)
...
////////////AIRLOCK///////////////////
//////////////////////////////////////
/obj/machinery/door/airlock/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	switch(passed_mode)
		if(RCD_DECONSTRUCT)
...
/obj/machinery/door/airlock/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	switch(passed_mode)
		if(RCD_DECONSTRUCT)
			to_chat(user, span("notice", "You deconstruct \the [src]."))
			qdel(src)
...
/////////////FIRELOCK/////////////////
//////////////////////////////////////
/obj/machinery/door/firedoor/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/door/firedoor/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
////////////WALL FRAMES///////////////
//////////////////////////////////////
/obj/machinery/computer/security/telescreen/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/computer/security/telescreen/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/doorbell_chime/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/doorbell_chime/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/status_display/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/status_display/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/requests_console/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/requests_console/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/atm/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/atm/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/newscaster/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/newscaster/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/recharger/wallcharger/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/recharger/wallcharger/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/firealarm/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/firealarm/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/alarm/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/alarm/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/computer/guestpass/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/computer/guestpass/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/item/radio/intercom/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/item/radio/intercom/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/keycard_auth/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/keycard_auth/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/item/geiger/wall/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/item/geiger/wall/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/button/windowtint/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/button/windowtint/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/computer/id_restorer/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/computer/id_restorer/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/computer/timeclock/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/computer/timeclock/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/station_map/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/station_map/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/structure/trash_pile/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
...
/obj/structure/trash_pile/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/structure/loot_pile/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 8 SECONDS,
...
/obj/structure/loot_pile/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/structure/frame/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/structure/frame/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/ai_status_display/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/ai_status_display/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/light/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/light/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/hologram/holopad/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/hologram/holopad/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/light_switch/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/light_switch/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/structure/table/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/structure/table/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/conveyor/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 2 SECONDS,
...
/obj/machinery/conveyor/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/door/window/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 3 SECONDS,
...
/obj/machinery/door/window/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/structure/firedoor_assembly/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 1 SECONDS,
...
/obj/structure/firedoor_assembly/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/structure/door_assembly/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 1 SECONDS,
...
/obj/structure/door_assembly/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
...
/obj/machinery/button/doorbell/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		return list(
			RCD_VALUE_MODE = RCD_DECONSTRUCT,
			RCD_VALUE_DELAY = 1 SECONDS,
...
/obj/machinery/button/doorbell/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	if(passed_mode == RCD_DECONSTRUCT)
		to_chat(user, span("notice", "You deconstruct \the [src]."))
		qdel(src)
		return TRUE
