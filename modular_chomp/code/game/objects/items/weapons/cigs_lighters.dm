/obj/item/flame/lighter/supermatter // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flame/lighter/supermatter/syndismzippo // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flame/lighter/supermatter/expsmzippo // CHOMPEdit - Removal of obj/item/weapon
...
// safe smzippo
/obj/item/flame/lighter/supermatter/attack_self(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!base_state)
	...
	if(!lit)
		...
		if(istype(src, /obj/item/flame/lighter/supermatter) ) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flame/lighter/supermatter/attack(mob/living/carbon/M as mob, mob/living/carbon/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(M, /mob))
		return
...
/obj/item/flame/lighter/supermatter/process() // CHOMPEdit - Removal of obj/item/weapon
...
// syndicate smzippo
/obj/item/flame/lighter/supermatter/syndismzippo/attack_self(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!base_state)
		base_state = icon_state
	if(!lit)
		lit = 1
		...
		item_state = "[base_state]"
		playsound(src, deactivation_sound, 75, 1)
		if(istype(src, /obj/item/flame/lighter/supermatter/syndismzippo) ) // CHOMPEdit - Removal of obj/item/weapon
			user.visible_message("<span class='rose'>You hear a quiet click, as [user] shuts the [src] without even looking at what they're doing.</span>")
		else
			user.visible_message("<span class='notice'>[user] quietly shuts the [src].</span>")
...
/obj/item/flame/lighter/supermatter/syndismzippo/attack(mob/living/carbon/M as mob, mob/living/carbon/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(M, /mob))
		return
...
/obj/item/flame/lighter/supermatter/expsmzippo/attack_self(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if (!base_state)
		base_state = icon_state
	if (!lit)
		lit = 1
		...
		item_state = "[base_state]"
		playsound(src, deactivation_sound, 75, 1)
		if (istype(src, /obj/item/flame/lighter/supermatter/expsmzippo)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flame/lighter/supermatter/expsmzippo/attack(mob/living/carbon/M as mob, mob/living/carbon/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if (!istype(M, /mob))
		return
...
/obj/item/flame/lighter/supermatter/expsmzippo/process() // CHOMPEdit - Removal of obj/item/weapon
	var/turf/location = get_turf(src)
	if (location)
		location.hotspot_expose(700, 5)
	return
