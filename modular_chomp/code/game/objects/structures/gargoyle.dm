...
/obj/structure/gargoyle/attackby(var/obj/item/W as obj, var/mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(W.is_wrench())
		if (isspace(loc) || isopenspace(loc))
		...
		if(istype(W,/obj/item/grab || /obj/item/holder)) // CHOMPEdit - Removal of obj/item/weapon
