/obj/machinery/paradoxrift
	...
	icon_state = "paradox"
	circuit = /obj/item/circuitboard/paradoxrift // CHOMPEdit - Removal of obj/item/weapon
	var/build_eff = 1
	var/loot_eff = 1
	var/chaos_eff = 1

/obj/item/circuitboard/paradoxrift // CHOMPEdit - Removal of obj/item/weapon
	...
	req_components = list(
							...
							/obj/item/stock_parts/capacitor = 4, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/stock_parts/manipulator = 6, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/stock_parts/scanning_module = 10) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/random/portalloot/item_to_spawn()
	return pick(prob(6);/obj/item/stock_parts/capacitor/omni, // CHOMPEdit - Removal of obj/item/weapon
				prob(6);/obj/item/stock_parts/manipulator/omni, // CHOMPEdit - Removal of obj/item/weapon
				prob(6);/obj/item/stock_parts/scanning_module/omni, // CHOMPEdit - Removal of obj/item/weapon
				prob(6);/obj/item/stock_parts/matter_bin/omni, // CHOMPEdit - Removal of obj/item/weapon
				prob(6);/obj/item/stock_parts/micro_laser/omni, // CHOMPEdit - Removal of obj/item/weapon
...
/obj/random/greaterportalloot/item_to_spawn()
	return pick(prob(6);/obj/item/stock_parts/capacitor/omni, // CHOMPEdit - Removal of obj/item/weapon
				...
				prob(1);/obj/item/rcd, // CHOMPEdit - Removal of obj/item/weapon
				prob(4);/obj/item/rcd/advanced, // CHOMPEdit - Removal of obj/item/weapon
				...
				prob(1);/obj/item/circuitboard/paradoxrift, // CHOMPEdit - Removal of obj/item/weapon
