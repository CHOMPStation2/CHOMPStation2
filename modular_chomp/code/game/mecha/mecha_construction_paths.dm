...
/datum/construction/reversible/mecha/hades
	...
	steps = list(
					...
					//12
					list("key"=/obj/item/circuitboard/mecha/hades/targeting, // CHOMPEdit - Removal of obj/item/weapon
							"backkey"=IS_SCREWDRIVER,
					...
					//14
					list("key"=/obj/item/circuitboard/mecha/hades/peripherals, // CHOMPEdit - Removal of obj/item/weapon
							"backkey"=IS_SCREWDRIVER,
					...
					//16
					list("key"=/obj/item/circuitboard/mecha/hades/main, // CHOMPEdit - Removal of obj/item/weapon
							"backkey"=IS_SCREWDRIVER,
	...
	switch(index)
		...
		if(15)
			if(diff==FORWARD)
				...
				new /obj/item/circuitboard/mecha/hades/main(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "phazon4"
		if(14)
			if(diff==FORWARD)
		...
		if(13)
			if(diff==FORWARD)
				...
				new /obj/item/circuitboard/mecha/hades/peripherals(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "phazon6"
		if(12)
			if(diff==FORWARD)
		...
		if(11)
			if(diff==FORWARD)
				...
				new /obj/item/circuitboard/mecha/hades/targeting(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "phazon8"
		if(10)
			if(diff==FORWARD)
