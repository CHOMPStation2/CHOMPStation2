...
/proc/output_all_ammo_types()
	...
	types = typesof(/obj/item/gun/projectile) // CHOMPEdit - Removal of obj/item/weapon
	var/list/magtypes = list()
	var/list/startmags = list()
	for(var/type in types)
		var/obj/item/gun/projectile/wep = new type(null) // CHOMPEdit - Removal of obj/item/weapon
...
/proc/override_gen()
	var/list/types = typesof(/obj/item/gun/projectile) // CHOMPEdit - Removal of obj/item/weapon
