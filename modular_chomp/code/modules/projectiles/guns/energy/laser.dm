...
/obj/item/gun/energy/lasercannon //This is me trying to make ammo worth while but the cannon...is a cannon. // CHOMPEdit - Removal of obj/item/weapon
	charge_cost = 300
...
/obj/item/gun/energy/gun/rifle // CHOMPEdit - Removal of obj/item/weapon
	firemodes = list(
...
/obj/item/gun/energy/gun/burst //Halving since by 3 seems too much // CHOMPEdit - Removal of obj/item/weapon
	firemodes = list(
...
/obj/item/gun/energy/gun/etommy //Halving this one // CHOMPEdit - Removal of obj/item/weapon
	firemodes = list(
...
/obj/item/gun/energy/gun/eluger // CHOMPEdit - Removal of obj/item/weapon
	firemodes = list(
...
/obj/item/gun/energy/sf2000 // CHOMPEdit - Removal of obj/item/weapon
	firemodes = list(
...
/obj/item/gun/energy/gun/burst/mg42 //I am unsure what this weapon is, and it seems cheap on paper but just putting it at 80 for unity // CHOMPEdit - Removal of obj/item/weapon
	firemodes = list(
