...
/obj/item/gun/energy/clockwork // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/clockwork/unload_ammo(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(recharging)
		return
	recharging = 1
	update_icon()
