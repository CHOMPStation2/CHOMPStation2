...
/datum/species/protean
	...
	var/obj/item/rig/protean/OurRig // CHOMPEdit - Removal of obj/item/weapon
...
/datum/species/protean/create_organs(var/mob/living/carbon/human/H)
	var/obj/item/nif/saved_nif = H.nif // CHOMPEdit - Removal of obj/item/device
	if(saved_nif)
...
/datum/species/protean/equip_survival_gear(var/mob/living/carbon/human/H)
	...
	spawn(0) //Let their real nif load if they have one
		...
		new /obj/item/rig/protean(H,H) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/species/protean/handle_death(var/mob/living/carbon/human/H)
	...
	if(H.temporary_form)
		if(!istype(H.temporary_form.loc, /obj/item/rig/protean)) // CHOMPEdit - Removal of obj/item/weapon
