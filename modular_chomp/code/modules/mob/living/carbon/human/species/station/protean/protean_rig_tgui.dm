...
/obj/item/rig/protean/tgui_state(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return GLOB.tgui_always_state

/obj/item/rig/protean/tgui_data(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	var/list/data = list()
	...
	return data
/*
/obj/item/rig/protean/tgui_act(action, params) // CHOMPEdit - Removal of obj/item/weapon
	switch(action)
		if("toggle_seals")
			toggle_seals(wearer)
			. = TRUE
