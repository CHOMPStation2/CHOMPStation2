...
/obj/item/organ/internal/mmi_holder/posibrain/nano
	...
	brain_type = /obj/item/mmi/digital/posibrain/nano // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mmi/digital/posibrain/nano // CHOMPEdit - Removal of obj/item/device
	name = "protean posibrain"
	desc = "A more advanced version of the standard posibrain, typically found in protean bodies."
	icon = 'modular_chomp/icons/mob/species/protean/protean.dmi'
	icon_state = "posi"

/obj/item/mmi/digital/posibrain/nano/Initialize() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	icon_state = "posi"

/obj/item/mmi/digital/posibrain/nano/request_player() // CHOMPEdit - Removal of obj/item/device
	icon_state = initial(icon_state)
	return //We don't do this stuff

/obj/item/mmi/digital/posibrain/nano/reset_search() // CHOMPEdit - Removal of obj/item/device
	icon_state = initial(icon_state)
	return //Don't do this either because of the above

/obj/item/mmi/digital/posibrain/nano/transfer_personality() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	icon_state = "posi1"

/obj/item/mmi/digital/posibrain/nano/transfer_identity() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	icon_state = "posi1"
...
/datum/design/item/protean_reboot
	...
	build_path = /obj/item/protean_reboot // CHOMPEdit - Removal of obj/item/device
	sort_string = "JVAAZ"

/obj/item/protean_reboot // CHOMPEdit - Removal of obj/item/device
	name = "Protean Reboot Programmer"
