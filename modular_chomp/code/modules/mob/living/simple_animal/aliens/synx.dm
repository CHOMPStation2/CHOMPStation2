...
/mob/living/simple_mob/animal/synx/Initialize()
	...
	build_icons(1)
	voremob_loaded = 1
	mob_radio = new /obj/item/radio/headset/mob_headset(src)	//We always give radios to spawned mobs anyway // CHOMPEdit - Removal of obj/item/device
...
/datum/reagent/inaprovaline/synxchem/clown/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	...
	if(prob(2))
		...
		new /obj/item/bikehorn(location) // CHOMPEdit - Removal of obj/item/weapon
