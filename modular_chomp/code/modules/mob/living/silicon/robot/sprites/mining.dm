...
/datum/robot_sprite/dogborg/tall/mining/dullahancargo/dullcargo
	name = "Dullahan Cargo"
...
/datum/robot_sprite/dogborg/tall/mining/dullahanmine_alt/dullmine_alt
	name = "Dullahan Mining unit alt"
