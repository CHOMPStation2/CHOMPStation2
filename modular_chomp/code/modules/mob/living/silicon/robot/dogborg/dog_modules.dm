/obj/item/robot_tongue/examine(user) // CHOMPEdit - Removal of obj/item/device
	. = ..()
	if(Adjacent(user))
		if(water.energy)
...
/obj/item/gun/energy/taser/mounted/cyborg/flare // CHOMPEdit - Removal of obj/item/weapon
	name = "flare gun"
	desc = "A flare-gun"
...
/obj/item/melee/combat_borgblade/explotailspear // CHOMPEdit - Removal of obj/item/weapon
	name = "energy tail"
...
/obj/item/melee/dogborg/jaws/big/explojaws // CHOMPEdit - Removal of obj/item/weapon
	name = "explo jaws"
...
/obj/item/gun/energy/medigun/mounted/smallmedigun // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/self_repair_system // CHOMPEdit - Removal of obj/item/device
...
/obj/item/self_repair_system/New() // CHOMPEdit - Removal of obj/item/device
	..()
	flags |= NOBLUDGEON

/obj/item/self_repair_system/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(repairing)
		return
...
/obj/item/self_repair_system/proc/self_repair(mob/living/silicon/robot/R, datum/robot_component/C, var/tick_delay, var/heal_per_tick) // CHOMPEdit - Removal of obj/item/device
	if(!C || !R.cell)
		return
...
/obj/item/self_repair_system/advanced // CHOMPEdit - Removal of obj/item/device
