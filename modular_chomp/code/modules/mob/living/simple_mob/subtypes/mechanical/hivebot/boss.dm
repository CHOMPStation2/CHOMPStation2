/mob/living/simple_mob/mechanical/hivebot/precusor/chrono
	...
	var/grenade_type = /obj/item/grenade/shooter/energy/tesla // CHOMPEdit - Removal of obj/item/weapon
	var/grenade_timer = 10
	var/grenade_type2 = /obj/item/grenade/shooter/rubber // CHOMPEdit - Removal of obj/item/weapon
	...
	loot_list = list(/obj/item/clothing/suit/armor/alien = 30,
			...
			/obj/item/prop/alien/junk = 50,
			/obj/item/prop/alien/junk = 50,
			/obj/item/gun/energy/alien = 30, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/gun/energy/alien = 30, // CHOMPEdit - Removal of obj/item/weapon
			/obj/random/tool/alien = 30,
			/obj/random/tool/alien = 30,
			/obj/item/cell/device/weapon/recharge/alien = 30, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/cell/device/weapon/recharge/alien = 30 // CHOMPEdit - Removal of obj/item/weapon
			)
...
/mob/living/simple_mob/mechanical/hivebot/precusor/chrono/proc/launch_rockets(atom/target)
	...
	var/obj/item/grenade/G = new grenade_type2(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(G))
		G.throw_at(G.throw_range, G.throw_speed, src)
...
/obj/item/grenade/spawnboss // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/grenade/spawnergrenade/detonate() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/grenade/spawnboss/hivebot // CHOMPEdit - Removal of obj/item/weapon
