...
/mob/living/simple_mob/mechanical/mecha/eclipse/antipersonal_unit/proc/phase_one(atom/target) //Basic pattern whilst the defense is high
	addtimer(CALLBACK(src, PROC_REF(atkonea), target), 1.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/antipersonal_unit/proc/atkonea(atom/target)
	...
	addtimer(CALLBACK(src, PROC_REF(atkoneb), target), 1.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/antipersonal_unit/proc/atkoneb(atom/target)
	...
	rightfour(target)
	leftfour(target)
	addtimer(CALLBACK(src, PROC_REF(atkonec), target), 1.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/antipersonal_unit/proc/atkonec(atom/target)
	...
	downfour_rightfour(target)
	downfour_leftfour(target)
	addtimer(CALLBACK(src, PROC_REF(atkoned), target), 1.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/antipersonal_unit/proc/atkoned(atom/target)
	...
	rightfour(target)
	leftfour(target)
	addtimer(CALLBACK(src, PROC_REF(atkonee), target), 1.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/antipersonal_unit/proc/phase_two(atom/target) //SPIIIIN TO WIN
	...
	addtimer(CALLBACK(src, PROC_REF(spin_to_win), target), 2 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win(atom/target)
	...
	downfour_rightfour(target)
	downfour_leftfour(target)
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_a), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win_a(atom/target)
	...
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_b), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win_b(atom/target)
	...
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_c), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win_c(atom/target)
	...
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_d), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win_d(atom/target)
	...
	downfour(target)
	leftfour(target)
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_e), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win_e(atom/target)
	...
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_f), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win_f(atom/target)
	...
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_g), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win_g(atom/target)
	...
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_h), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win_h(atom/target)
	...
	downfour_leftfour(target)
	upfour_leftfour(target)
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_ra), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win_ra(atom/target)//Now we reverse
	...
	downfour_leftthree(target)
	upthree_leftfour(target)
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_rb), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win_rb(atom/target)
	...
	downfour_lefttwo(target)
	uptwo_leftfour(target)
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_rc), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win_rc(atom/target)
	...
	downfour_leftone(target)
	upone_leftfour(target)
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_rd), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win_rd(atom/target)
	...
	downfour(target)
	leftfour(target)
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_re), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win_re(atom/target)
	...
	downfour_rightone(target)
	downone_leftfour(target)
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_rf), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win_rf(atom/target)
	...
	downfour_righttwo(target)
	downtwo_leftfour(target)
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_rg), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/spin_to_win_rg(atom/target)
	...
	downfour_rightthree(target)
	downthree_leftfour(target)
	addtimer(CALLBACK(src, PROC_REF(spin_to_win_rh), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/antipersonal_unit/proc/phase_three(atom/target) //The strangest pattern but a last stand at 0 defense.
	addtimer(CALLBACK(src, PROC_REF(random_firing), target), 0.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/mining_guard/proc/phaseone_cycleone(atom/target) //four seconds
	...
	icon_state = "shielded_mining_mecha"
	for(var/i = 1 to 6)
		addtimer(CALLBACK(src, PROC_REF(summon_drones), target), 0.5 SECOND, TIMER_DELETE_ME)
	attackcycle = 2
...
/mob/living/simple_mob/mechanical/mecha/eclipse/mining_guard/proc/phasetwo_cycleone(atom/target) //Seven seconds
	...
	icon_state = "shielded_mining_mecha"
	visible_message(span_danger("The [src] is preparing a deadly attack!"))
	addtimer(CALLBACK(src, PROC_REF(thewall), target), 2.5 SECOND, TIMER_DELETE_ME)
	attackcycle = 2
...
/mob/living/simple_mob/mechanical/mecha/eclipse/proc/thewall(atom/target)
	...
	downthree_leftfour(target)
	downfour_leftfour(target)
	addtimer(CALLBACK(src, PROC_REF(thehall), target), 2.5 SECOND, TIMER_DELETE_ME)
...
/mob/living/simple_mob/mechanical/mecha/eclipse/mining_guard/proc/phasethree_cyclethree(atom/target) //two seconds
	...
	icon_state = "mining_mecha"
	for(var/i = 1 to 20)
		addtimer(CALLBACK(src, PROC_REF(random_firing), target), 0.2 SECOND, TIMER_DELETE_ME)
	attackcycle = 1
