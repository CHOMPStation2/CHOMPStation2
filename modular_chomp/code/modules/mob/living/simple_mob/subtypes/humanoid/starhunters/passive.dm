/mob/living/simple_mob/humanoid/starhunter/trader/weaponsmith
	...
	products	= list(/obj/item/gun/energy/sickshot = 5, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/material/twohanded/fireaxe/scythe = 3, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/material/twohanded/spear/lance = 3, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/beartrap = 12, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/material/barbedwire = 12, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/material/sword/battleaxe = 3 // CHOMPEdit - Removal of obj/item/weapon

		) // For each, use the following pattern:

	premium 	= list(/obj/item/gun/energy/maghowitzer) //This may be a mistake // CHOMPEdit - Removal of obj/item/weapon

	prices     = list(/obj/item/gun/energy/maghowitzer = 8000, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/gun/energy/sickshot = 800, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/material/twohanded/fireaxe/scythe = 400, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/material/twohanded/spear/lance = 400, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/beartrap = 80, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/material/barbedwire = 80, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/material/sword/battleaxe = 400 // CHOMPEdit - Removal of obj/item/weapon
		)
...
/mob/living/simple_mob/humanoid/starhunter/trader/reliccollecter
	...
	products	= list(/obj/item/clothing/head/helmet/combat/crusader = 3,
		...
		/obj/item/soulstone = 8, // CHOMPEdit - Removal of obj/item/device
		/obj/item/clothing/glasses/monocoole = 3,
		/obj/item/storage/belt/holding = 1, // CHOMPEdit - Removal of obj/item/weapon
	...
	prices     = list(/obj/item/clothing/head/helmet/combat/crusader = 600,
		...
		/obj/item/soulstone = 80, // CHOMPEdit - Removal of obj/item/device
		/obj/item/clothing/glasses/monocoole = 1200,
		/obj/item/storage/belt/holding = 1800, // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/simple_mob/humanoid/starhunter/trader/miner
	...
	icon_state = "snektrader"
	icon_living = "snektrader"
	products	= list(/obj/item/kinetic_crusher/glaive = 5, // CHOMPEdit - Removal of obj/item/weapon
		...
		/obj/item/melee/shock_maul = 3, // CHOMPEdit - Removal of obj/item/weapon
		...
		/obj/item/circuitboard/paradoxrift = 3 // CHOMPEdit - Removal of obj/item/weapon
		) // For each, use the following pattern:
	...
	prices     = list(/obj/item/kinetic_crusher/glaive = 600, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/kinetic_crusher = 600, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/gun/energy/mininglaser = 800, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/melee/shock_maul = 600, // CHOMPEdit - Removal of obj/item/weapon
		...
		/obj/item/circuitboard/paradoxrift = 2400, // CHOMPEdit - Removal of obj/item/weapon
