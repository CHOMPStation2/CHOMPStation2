...
/mob/living/simple_mob/mechanical/mecha/vistor/vistorblue/shielded/bullet_act(var/obj/item/projectile/P)
	...
	if(prob(reflectchance))
		...
		if(!(istype(P, /obj/item/projectile/energy) || istype(P, /obj/item/projectile/beam)))
			...
			new /obj/item/material/shard/shrapnel(src.loc) // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/simple_mob/mechanical/mecha/vistor/vistorblue
	...
	var/grenade_type = /obj/item/grenade/shooter/energy/homing // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/grenade/shooter/energy/homing //This is a horrid idea // CHOMPEdit - Removal of obj/item/weapon
	name = "homing grenade"
