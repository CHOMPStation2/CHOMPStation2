/mob/living/simple_mob/vore/weatherbeast/acidrain/death()
	new /obj/item/melee/jellyfishwhip (src.loc) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/cell/slime/jellyfish (src.loc) // CHOMPEdit - Removal of obj/item/weapon
	.=..()

/mob/living/simple_mob/vore/weatherbeast/starsky/death()
	new /obj/item/gun/energy/astarrail (src.loc) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/weldingtool/silver (src.loc) // CHOMPEdit - Removal of obj/item/weapon
	.=..()

/mob/living/simple_mob/vore/weatherbeast/darkmist/death()
	new /obj/item/melee/midnightblade (src.loc) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/reagent_containers/glass/beaker/gilded  (src.loc) // CHOMPEdit - Removal of obj/item/weapon
	.=..()

/mob/living/simple_mob/vore/weatherbeast/sandstorm/death()
	new /obj/item/gun/magnetic/matfed/phoronbore/modified (src.loc) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/personal_shield_generator/belt/magnetbelt (src.loc) // CHOMPEdit - Removal of obj/item/device
	.=..()

//Acid Rain Boss
/obj/item/melee/jellyfishwhip // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/melee/jellyfishwhip/apply_hit_effect(mob/living/target, mob/living/user, var/hit_zone) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/cell/slime/jellyfish //Less max charge then slime but faster recharge // CHOMPEdit - Removal of obj/item/weapon
...
//Starry Nights
/obj/item/gun/energy/astarrail // CHOMPEdit - Removal of obj/item/weapon
	name = "Astral Slicer"
	...
	accept_cell_type = /obj/item/cell/device // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/weldingtool/silver // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/weldingtool/silver/process() // CHOMPEdit - Removal of obj/item/weapon
...
//Midnightfog
//funny melee weapon
/obj/item/melee/midnightblade // CHOMPEdit - Removal of obj/item/weapon
	name = "midnight blade"
	icon_state = "katana"
...
/obj/item/melee/midnightblade/apply_hit_effect(mob/living/target, mob/living/user, var/hit_zone) // CHOMPEdit - Removal of obj/item/weapon
...
//A wierd beaker
/obj/item/reagent_containers/glass/beaker/gilded //Soo technically a good item but cumbersome to use. // CHOMPEdit - Removal of obj/item/weapon
	name = "golden beaker"
...
/obj/item/gun/magnetic/matfed/phoronbore/modified // CHOMPEdit - Removal of obj/item/weapon
	name = "modified portable phoron bore"
	mat_cost = 100 //more unwieldy ammo better effiency
	ammo_material = MAT_TRITIUM

//Mining tool
/obj/item/personal_shield_generator/belt/magnetbelt // CHOMPEdit - Removal of obj/item/device
...
/datum/modifier/magnet/tick()
	for(var/obj/item/ore/O in orange(4, holder)) // CHOMPEdit - Removal of obj/item/weapon
