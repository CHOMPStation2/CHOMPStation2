...
/obj/item/bluespace_crystal/Crossed(atom/movable/M) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/bluespace_crystal/proc/dephase_shadekin() // CHOMPEdit - Removal of obj/item/weapon
	var/turf/T = get_turf(src)
