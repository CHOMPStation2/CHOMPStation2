...
/datum/design_techweb/rifle_mag_9mmval_ap
	...
	materials = list(MAT_STEEL = MATERIAL_COST(0.325), MAT_PLASTEEL = MATERIAL_COST(0.15))
	build_type = AUTOLATHE
...
/datum/design_techweb/rifle_mag_akm762_hp
	...
	materials = list(MAT_STEEL = MATERIAL_COST(0.325), MAT_PLASTEEL = MATERIAL_COST(0.1))
	build_type = AUTOLATHE
...
/datum/design_techweb/rifle_drum_rpk762
	...
	materials = list(MAT_STEEL = MATERIAL_COST(0.85))
	build_type = AUTOLATHE
...
/datum/design_techweb/rifle_drum_rpk762_ap
	...
	materials = list(MAT_STEEL = MATERIAL_COST(0.85), MAT_PLASTEEL = MATERIAL_COST(0.275))
	build_type = AUTOLATHE
...
/datum/design_techweb/rifle_drum_playma
	...
	materials = list(MAT_STEEL = MATERIAL_COST(2.3))
	build_type = AUTOLATHE
...
/datum/design_techweb/rifle_drum_playma_ap
	...
	materials = list(MAT_STEEL = MATERIAL_COST(2.3), MAT_PLASTEEL = MATERIAL_COST(0.7))
	build_type = AUTOLATHE
...
/datum/design_techweb/pistol_mag_vp70
	...
	id = "pistol_mag_vp70"
	materials = list(MAT_STEEL = MATERIAL_COST(0.54))
	build_type = AUTOLATHE
...
/datum/design_techweb/pistol_mag_vp70_ap
	...
	materials = list(MAT_STEEL = MATERIAL_COST(0.54), MAT_PLASTEEL = MATERIAL_COST(0.3))
	build_type = AUTOLATHE
...
/datum/design_techweb/pistol_mag_vp70_hp
	...
	materials = list(MAT_STEEL = MATERIAL_COST(0.54), MAT_PLASTIC = MATERIAL_COST(0.3))
	build_type = AUTOLATHE
...
/datum/design_techweb/ammobox_9mm_practice
	...
	materials = list(MAT_STEEL = MATERIAL_COST(0.55))
	build_type = AUTOLATHE
