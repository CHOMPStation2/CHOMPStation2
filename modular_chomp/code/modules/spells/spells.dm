...
/spell/targeted/unrestricted
	...
	var/obj/item/spell/unrestricted/spell_obj = null //This is the var that determines what Technomancer-style spell is put into their hands. // CHOMPEdit - Removal of obj/item/weapon

/spell/targeted/unrestricted/cast(list/targets, mob/living/user)
	user.place_spell_in_hand(spell_obj)

/obj/item/spell/unrestricted // CHOMPEdit - Removal of obj/item/weapon
	name = "a spell"
...
/obj/item/spell/unrestricted/New() // CHOMPEdit - Removal of obj/item/weapon
	if(isliving(loc))
		owner = loc
	if(!owner)
		qdel(src)
...
/obj/item/spell/unrestricted/run_checks() // CHOMPEdit - Removal of obj/item/weapon
	if(owner)
...
/obj/item/spell/unrestricted/pay_energy(var/amount) // CHOMPEdit - Removal of obj/item/weapon
	if(owner)
		return 1

/obj/item/spell/unrestricted/afterattack(atom/target, mob/user, proximity_flag, click_parameters) // CHOMPEdit - Removal of obj/item/weapon
	if(!run_checks())
		return
	if(!proximity_flag)
...
/obj/item/spell/unrestricted/projectile //This makes me angry, but we need the template, and we can't use it because special check overrides on the base. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/unrestricted/projectile/on_ranged_cast(atom/hit_atom, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/unrestricted/projectile/proc/make_projectile(obj/item/projectile/projectile_type, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/projectile/P = new projectile_type(get_turf(user))
	return P

/obj/item/spell/unrestricted/projectile/proc/set_up(atom/hit_atom, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(spell_projectile)
...
/spell/targeted/unrestricted/plasmastun
	...
	spell_obj = /obj/item/spell/unrestricted/projectile/plasmastun // CHOMPEdit - Removal of obj/item/weapon

/obj/item/spell/unrestricted/projectile/plasmastun // CHOMPEdit - Removal of obj/item/weapon
	name = "plasma snare"
	icon_state = "generic"
...
/spell/targeted/unrestricted/mend
	...
	spell_obj = /obj/item/spell/unrestricted/mend // CHOMPEdit - Removal of obj/item/weapon

/obj/item/spell/unrestricted/mend // CHOMPEdit - Removal of obj/item/weapon
	name = "mend target"
...
/obj/item/spell/unrestricted/mend/on_melee_cast(atom/hit_atom, mob/living/user, def_zone) // CHOMPEdit - Removal of obj/item/weapon
