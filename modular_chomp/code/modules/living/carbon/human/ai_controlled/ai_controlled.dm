/mob/living/carbon/human/ai_controlled/greytide/Initialize()
	to_wear_r_hand = pick(
		prob(20); /obj/item/storage/toolbox/electrical, // CHOMPEdit - Removal of obj/item/weapon
		prob(20); /obj/item/storage/toolbox/mechanical, // CHOMPEdit - Removal of obj/item/weapon
		prob(20); /obj/item/storage/toolbox/emergency, // CHOMPEdit - Removal of obj/item/weapon
		prob(50); /obj/item/melee/baton/cattleprod, // CHOMPEdit - Removal of obj/item/weapon
	)
	if(prob(50))
...
/mob/living/carbon/human/ai_controlled/greytide
	...
	//to_wear_mask =
	to_wear_l_radio = /obj/item/radio/headset // CHOMPEdit - Removal of obj/item/device
	...
	to_wear_l_pocket = /obj/item/soap // CHOMPEdit - Removal of obj/item/weapon
	to_wear_r_pocket = /obj/item/pda // CHOMPEdit - Removal of obj/item/device
	to_wear_back = /obj/item/storage/backpack // CHOMPEdit - Removal of obj/item/weapon
	to_wear_id_type = /obj/item/card/id // CHOMPEdit - Removal of obj/item/weapon
	to_wear_id_job = "Assistant"

	to_wear_l_hand = null
	//to_wear_r_hand = /obj/item/storage/toolbox/mechanical // CHOMPEdit - Removal of obj/item/weapon
	faction = "syndicate"
