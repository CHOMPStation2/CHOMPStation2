/datum/crafting_recipe/ziplaser
	name = "Ziplaser"
	result = /obj/item/gun/energy/zip/craftable // CHOMPEdit - Removal of obj/item/weapon
	reqs = list(list(/obj/item/cell/high  = 1), // CHOMPEdit - Removal of obj/item/weapon
		list(/obj/item/stack/rods  = 2),
		list(/obj/item/stack/material/steel  = 8),
		list(/obj/item/stack/material/plastic  = 5),
		list(/obj/item/cell/device  = 2) // CHOMPEdit - Removal of obj/item/weapon
		)
	time = 120
...
/datum/crafting_recipe/toxinregengloves
	...
	reqs = list(
		...
		list(/obj/item/stock_parts/capacitor = 1) // CHOMPEdit - Removal of obj/item/weapon
	)
	time = 60
	category = CAT_CLOTHING
...
/datum/crafting_recipe/strangepistol
	name = "Strange Weapon"
	result = /obj/item/gun/energy/icelauncher // CHOMPEdit - Removal of obj/item/weapon
	reqs = list(
		list(/obj/item/stack/material/steel  = 8),
		list(/obj/item/stack/material/plastic  = 3),
		list(/obj/item/cell/device  = 1), // CHOMPEdit - Removal of obj/item/weapon
		list(/obj/item/stack/material/frostscale = 2)
		)
	time = 60
	category = CAT_WEAPONRY
...
/datum/crafting_recipe/solarrapier
	name = "Solar Rapier"
	result = /obj/item/material/sword/rapier/solar // CHOMPEdit - Removal of obj/item/weapon
	reqs = list(
...
/datum/crafting_recipe/gravityhammer
	name = "Gravity Hammer"
	result = /obj/item/material/twohanded/sledgehammer/gravity // CHOMPEdit - Removal of obj/item/weapon
	reqs = list(list(/obj/item/stack/material/steel  = 15),
		list(/obj/item/stack/material/leather  = 3),
		list(/obj/item/stack/material/shellchitin = 2),
		list(/obj/item/cell/high  = 1) // CHOMPEdit - Removal of obj/item/weapon
		)
	time = 60
	category = CAT_WEAPONRY
	subcategory = CAT_WEAPON
...
/datum/crafting_recipe/harvester
	name = "Harvester"
	result = /obj/item/material/twohanded/fireaxe/scythe/harvester // CHOMPEdit - Removal of obj/item/weapon
	reqs = list(list(/obj/item/stack/material/steel  = 15),
		list(/obj/item/stack/material/leather  = 3),
		list(/obj/item/stack/material/dreamscale = 2)
		)
...
/datum/crafting_recipe/sandstone
	...
	reqs = list(list(/obj/item/ore/glass = 4)) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/crafting_recipe/marble
	...
	reqs = list(list(/obj/item/ore/marble = 4)) // CHOMPEdit - Removal of obj/item/weapon
	time = 10 //Not realstic but I don't want to waste too much time.
	category = CAT_PRIMAL
