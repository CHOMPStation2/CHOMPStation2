...
/obj/machinery/atmospherics/pipe/attackby(var/obj/item/W as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if (istype(src, /obj/machinery/atmospherics/pipe/tank))
		return ..()

	if(istype(W,/obj/item/pipe_painter)) // CHOMPEdit - Removal of obj/item/device
		return 0
