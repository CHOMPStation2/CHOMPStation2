...
*/
//The language itself
#define LANGUAGE_RATVARIAN "Ratvarian"
...
/datum/language/ratvarian
	...
	key = "R"                     // Character used to speak in language eg. :o for Unathi.
	flags = 2                     // Various language flags.
	list/syllables                // Used when scrambling text for a non-speaker.
	list/space_chance = 55        // Likelihood of getting a space in the random scramble string
	machine_understands = 0
	list/partial_understanding = LANGUAGE_OCCULT

/* this is used specifically for the spells that they get in the gamemode version, so it's not necessary until whenever I get around to making said spells functional
