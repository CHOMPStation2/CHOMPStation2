...
import { createLogger } from 'tgui_ch/logging';
...
class ChatRenderer {
  ...
  processBatch(batch, options = {}) {
    ...
    for (let payload of batch) {
      ...
      this.archived_messages.push(message); // TODO: Better message archive
  ...
  saveToDisk() {
    ...
    let messagesHtml = '';
    // for (let message of this.visibleMessages) { TODO: Better message archive
    for (let message of this.archived_messages) {
      if (message.node) {
