...
export const ColorMateAlways = (props, context) => {
...
export const ColorMateAlwaysTint = (props, context) => {
  const { act, data } = useBackend(context);
  return <Button fluid content="Select new color" icon="paint-brush" onClick={() => act('choose_color')} />;
};

export const ColorMateAlwaysMatrix = (props, context) => {
  const { act, data } = useBackend(context);
...
export const ColorMateAlwaysHSV = (props, context) => {
  const { act, data } = useBackend(context);
