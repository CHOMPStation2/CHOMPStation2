...
.reflex_shoot			{color: #8B8BD0; font-style: italic;}
...
/* Debug Logs */
.debug_error					{color:#FF3232; font-weight:bold}
.debug_warning					{color:#FF3232;}
.debug_info						{}
.debug_debug					{color:#6F6FE2;}
.debug_trace					{color:#b8b8b8;}
