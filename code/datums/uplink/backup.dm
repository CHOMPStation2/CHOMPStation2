...
/datum/uplink_item/item/backup/syndicate_drone_protector
	...
	path = /obj/item/antag_spawner/syndicate_drone/protector // CHOMPEdit - Removal of obj/item/weapon
...
/datum/uplink_item/item/backup/syndicate_drone_combat_medic
	...
	item_cost = DEFAULT_TELECRYSTAL_AMOUNT * 1.5
	antag_roles = list("mercenary", "ert") //VOREStation Edit
	path = /obj/item/antag_spawner/syndicate_drone/combat_medic // CHOMPEdit - Removal of obj/item/weapon
...
/datum/uplink_item/item/backup/syndicate_drone_mechanist
	...
	item_cost = DEFAULT_TELECRYSTAL_AMOUNT * 1.5
	antag_roles = list("mercenary", "ert") //VOREStation Edit
	path = /obj/item/antag_spawner/syndicate_drone/mechanist // CHOMPEdit - Removal of obj/item/weapon
