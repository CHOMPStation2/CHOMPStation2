...
/datum/uplink_item/proc/buy(var/obj/item/uplink/U, var/mob/user) // CHOMPEdit - Removal of obj/item/device
...
/datum/uplink_item/proc/can_buy(var/obj/item/uplink/U, var/telecrystals) // CHOMPEdit - Removal of obj/item/device
	if(cost(U, telecrystals) > telecrystals)
		return FALSE

	return TRUE

/datum/uplink_item/proc/cost(obj/item/uplink/U, mob/M) // CHOMPEdit - Removal of obj/item/device
	. = item_cost
	if(U)
		. = U.get_item_cost(src, .)
...
/datum/uplink_item/proc/get_goods(var/obj/item/uplink/U, var/loc, mob/user) // CHOMPEdit - Removal of obj/item/device
	return FALSE
...
*                           	*
********************************/
/datum/uplink_item/item/buy(var/obj/item/uplink/U, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	var/obj/item/I = ..()
	if(!I)
		return
...
/datum/uplink_item/item/get_goods(var/obj/item/uplink/U, var/loc, var/mob/user) // CHOMPEdit - Removal of obj/item/device
...
/datum/uplink_item/crated/get_goods(var/obj/item/uplink/U, var/loc) // CHOMPEdit - Removal of obj/item/device
...
* Support procs *
****************/
/proc/get_random_uplink_items(var/obj/item/uplink/U, var/remaining_TC, var/loc) // CHOMPEdit - Removal of obj/item/device
...
/proc/get_surplus_items(var/obj/item/uplink/U, var/remaining_TC, var/loc) // CHOMPEdit - Removal of obj/item/device
	var/list/bought_items = list()
	var/override = TRUE
	while(remaining_TC)
