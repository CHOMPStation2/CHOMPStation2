...
/datum/uplink_item/item/telecrystal/get_goods(var/obj/item/uplink/U, var/loc, var/mob/M) // CHOMPEdit - Removal of obj/item/device
...
/datum/uplink_item/item/telecrystal/all/cost(obj/item/uplink/U, mob/M) // CHOMPEdit - Removal of obj/item/device
