...
/datum/uplink_item/abstract/announcements/buy(var/obj/item/uplink/U, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	. = ..()
	if(.)
...
/datum/uplink_item/abstract/announcements/fake_centcom/get_goods(var/obj/item/uplink/U, var/loc, var/mob/user, var/list/args) // CHOMPEdit - Removal of obj/item/device
...
/datum/uplink_item/abstract/announcements/fake_crew_arrival/get_goods(var/obj/item/uplink/U, var/loc, var/mob/user, var/list/args) // CHOMPEdit - Removal of obj/item/device
	if(!user)
		return 0

	var/obj/item/card/id/I = user.GetIdCard() // CHOMPEdit - Removal of obj/item/weapon
...
/datum/uplink_item/abstract/announcements/fake_ion_storm/get_goods(var/obj/item/uplink/U, var/loc) // CHOMPEdit - Removal of obj/item/device
...
/datum/uplink_item/abstract/announcements/fake_radiation/get_goods(var/obj/item/uplink/U, var/loc) // CHOMPEdit - Removal of obj/item/device
