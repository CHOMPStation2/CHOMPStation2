...
/datum/wires/proc/can_see_wire_info(mob/user)
	...
	// if(user.can_admin_interact())
		// return TRUE
	var/obj/item/I = user.get_active_hand()
	if(istype(I, /obj/item/multitool/alien)) // CHOMPEdit - Removal of obj/item/device
		return TRUE
	return FALSE
 ...
 */
/datum/wires/proc/pulse_assembly(obj/item/assembly/signaler/S) // CHOMPEdit - Removal of obj/item/device
 ...
 */
/datum/wires/proc/attach_assembly(color, obj/item/assembly/signaler/S) // CHOMPEdit - Removal of obj/item/device
...
/datum/wires/proc/detach_assembly(color)
	var/obj/item/assembly/signaler/S = get_attached(color) // CHOMPEdit - Removal of obj/item/device
	if(S && istype(S))
		assemblies -= color
		S.connected = null
