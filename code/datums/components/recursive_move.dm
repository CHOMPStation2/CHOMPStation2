...
/obj/item/bananapeel/testing // CHOMPEdit - Removal of obj/item/weapon
	name = "banana peel of testing"
	desc = "spams world log with debugging information"

/obj/item/bananapeel/testing/proc/shmove(var/atom/source, var/atom/old_loc, var/atom/new_loc) // CHOMPEdit - Removal of obj/item/weapon
	world.log << "the [source] moved from [old_loc]([old_loc.x],[old_loc.y],[old_loc.z]) to [new_loc]([new_loc.x],[new_loc.y],[new_loc.z])"

/obj/item/bananapeel/testing/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
