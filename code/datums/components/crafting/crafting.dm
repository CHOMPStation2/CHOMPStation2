	...
	for(var/obj/object in get_environment(a, blacklist))
		if(isitem(object))
			...
			if(istype(item, /obj/item/stack))
				...
				if(istype(item, /obj/item/reagent_containers)) // CHOMPEdit - Removal of obj/item/weapon
					var/obj/item/reagent_containers/container = item // CHOMPEdit - Removal of obj/item/weapon
...
/datum/component/personal_crafting/proc/check_tools(atom/source, datum/crafting_recipe/R, list/surroundings)
	...
	for(var/obj/item/contained_item in source.contents)
		...
		if(istype(contained_item, /obj/item/storage)) // cursed // CHOMPEdit - Removal of obj/item/weapon
...
/datum/component/personal_crafting/proc/del_reqs(datum/crafting_recipe/R, atom/a)
	...
	for(var/path_key in requirements)
		...
		if(ispath(path_key, /datum/reagent))
			...
			for(var/obj/item/reagent_containers/RC in surroundings) // CHOMPEdit - Removal of obj/item/weapon
		...
		// Material stacks may have to accumulate across multiple stacks
			...
			for(var/atom/movable/I in surroundings)
				...
				if(istype(I, /obj/item/reagent_containers)) // CHOMPEdit - Removal of obj/item/weapon
					var/obj/item/reagent_containers/RC = I // CHOMPEdit - Removal of obj/item/weapon
				...
				if(istype(I, /obj/item/reagent_containers)) // CHOMPEdit - Removal of obj/item/weapon
					var/obj/item/reagent_containers/container = I // CHOMPEdit - Removal of obj/item/weapon
					container.reagents.clear_reagents()
					// container.reagents.expose(container.loc, TOUCH)
				else if(istype(I, /obj/item/storage)) // CHOMPEdit - Removal of obj/item/weapon
					var/obj/item/storage/container = I // CHOMPEdit - Removal of obj/item/weapon
					container.spill()
					container.close_all()
				qdel(I)
	return parts
