...
/decl/hierarchy/outfit
	...
	var/backpack = /obj/item/storage/backpack // CHOMPEdit - Removal of obj/item/weapon
	var/satchel_one  = /obj/item/storage/backpack/satchel/norm // CHOMPEdit - Removal of obj/item/weapon
	var/satchel_two  = /obj/item/storage/backpack/satchel // CHOMPEdit - Removal of obj/item/weapon
	var/messenger_bag = /obj/item/storage/backpack/messenger // CHOMPEdit - Removal of obj/item/weapon
	var/sports_bag = /obj/item/storage/backpack/sport // CHOMPEdit - Removal of obj/item/weapon
	var/satchel_three = /obj/item/storage/backpack/satchel/strapless // CHOMPEdit - Removal of obj/item/weapon
...
/decl/hierarchy/outfit/proc/post_equip(mob/living/carbon/human/H)
	if(flags & OUTFIT_HAS_JETPACK)
		var/obj/item/tank/jetpack/J = locate(/obj/item/tank/jetpack) in H // CHOMPEdit - Removal of obj/item/weapon
		if(!J)
			return
		J.toggle()
		J.toggle_valve()
...
/decl/hierarchy/outfit/proc/equip(mob/living/carbon/human/H, var/rank, var/assignment)
	...
	var/obj/item/card/id/W = equip_id(H, rank, assignment) // CHOMPEdit - Removal of obj/item/weapon
	if(W)
		rank = W.rank
...
/decl/hierarchy/outfit/proc/equip_id(mob/living/carbon/human/H, rank, assignment)
	if(!id_slot || !id_type)
		return
	var/obj/item/card/id/W = new id_type(H) // CHOMPEdit - Removal of obj/item/weapon
	if(id_desc)
		W.desc = id_desc
	if(rank)
		W.rank = rank
...
/decl/hierarchy/outfit/proc/equip_pda(mob/living/carbon/human/H, rank, assignment)
	if(!pda_slot || !pda_type)
		return
	var/obj/item/pda/pda = new pda_type(H) // CHOMPEdit - Removal of obj/item/device
