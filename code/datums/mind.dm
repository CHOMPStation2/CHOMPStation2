...
/datum/mind/Topic(href, href_list)
	...
	if(href_list["add_antagonist"])
		...
		switch(href_list["implant"])
			if("remove")
				for(var/obj/item/implant/loyalty/I in H.contents) // CHOMPEdit - Removal of obj/item/weapon
		...
		switch(href_list["common"])
			...
			if("crystals")
				...
				//	var/obj/item/uplink/hidden/suplink = find_syndicate_uplink() No longer needed, uses stored in mind // CHOMPEdit - Removal of obj/item/device
					var/crystals
					crystals = tcrystals
...
/datum/mind/proc/take_uplink()
	var/obj/item/uplink/hidden/H = find_syndicate_uplink() // CHOMPEdit - Removal of obj/item/device
	if(H)
		qdel(H)
...
/datum/mind/proc/is_brigged(duration)
	...
	if(istype(T.loc,/area/security/brig))
		...
		for(var/obj/item/card/id/card in current) // CHOMPEdit - Removal of obj/item/weapon
			is_currently_brigged = 0
			break // if they still have ID they're not brigged
		for(var/obj/item/pda/P in current) // CHOMPEdit - Removal of obj/item/device
			if(P.id)
				is_currently_brigged = 0
				break // if they still have ID they're not brigged
