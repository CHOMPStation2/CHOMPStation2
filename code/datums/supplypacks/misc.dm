...
/datum/supply_pack/randomised/misc/card_packs
	num_contained = 5
	contains = list(
			/obj/item/pack/cardemon, // CHOMPEdit - Removal of obj/item/weapon
...
/datum/supply_pack/misc/eftpos
	contains = list(/obj/item/eftpos) // CHOMPEdit - Removal of obj/item/device
	name = "EFTPOS scanner"
	cost = 10
...
/datum/supply_pack/misc/chaplaingear
	...
	contains = list(
			...
			/obj/item/storage/fancy/candle_box = 3 // CHOMPEdit - Removal of obj/item/weapon
			)
	cost = 10
...
/datum/supply_pack/misc/glucose_hypos
	...
	contains = list(
			/obj/item/reagent_containers/hypospray/autoinjector/biginjector/glucose = 5 // CHOMPEdit - Removal of obj/item/weapon
			)
	cost = 25
...
/datum/supply_pack/misc/mre_rations
	num_contained = 6
	name = "Emergency - MREs"
	contains = list(/obj/item/storage/mre, // CHOMPEdit - Removal of obj/item/weapon
...
/datum/supply_pack/misc/paste_rations
	...
	contains = list(
			/obj/item/storage/mre/menu11 = 2 // CHOMPEdit - Removal of obj/item/weapon
			)
	cost = 25
...
/datum/supply_pack/misc/medical_rations
	...
	contains = list(
			/obj/item/storage/mre/menu13 = 2 // CHOMPEdit - Removal of obj/item/weapon
			)
	cost = 40
	containertype = /obj/structure/closet/crate/zenghu
	containername = "emergency rations"
...
/datum/supply_pack/misc/beltminer
	...
	contains = list(
			/obj/item/gun/energy/particle = 2, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/cell/device/weapon = 2, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/storage/firstaid/regular = 1, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/gps = 2, // CHOMPEdit - Removal of obj/item/device
			/obj/item/storage/box/traumainjectors = 1, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/binoculars = 1 // CHOMPEdit - Removal of obj/item/device
			)
	cost = 60
...
/datum/supply_pack/misc/jetpack
	name = "jetpack (empty)"
	contains = list(
			/obj/item/tank/jetpack = 1 // CHOMPEdit - Removal of obj/item/weapon
			)
	cost = 75
	containertype = /obj/structure/closet/crate/secure/gear
...
/datum/supply_pack/randomised/misc/explorer_shield
	...
	num_contained = 2
	contains = list(
			/obj/item/shield/riot/explorer, // CHOMPEdit - Removal of obj/item/weapon
...
/datum/supply_pack/misc/music_players
	...
	contains = list(
		/obj/item/walkpod = 3 // CHOMPEdit - Removal of obj/item/device
	)
	cost = 150
...
/datum/supply_pack/misc/juke_remotes
	...
	contains = list(
		/obj/item/juke_remote = 2 // CHOMPEdit - Removal of obj/item/device
	)
	cost = 300
	containertype = /obj/structure/closet/crate
...
/datum/supply_pack/misc/explorer_headsets
	...
	contains = list(
		/obj/item/radio/headset/explorer = 4 // CHOMPEdit - Removal of obj/item/device
	)
	cost = 20
	containertype = /obj/structure/closet/crate/secure/gear
...
/datum/supply_pack/misc/emergency_beacons
	...
	contains = list(
		/obj/item/emergency_beacon = 4 // CHOMPEdit - Removal of obj/item/device
	)
	cost = 20
	containertype = /obj/structure/closet/crate
