...
/datum/supply_pack/atmos/inflatable
	...
	contains = list(/obj/item/storage/briefcase/inflatable = 3) // CHOMPEdit - Removal of obj/item/weapon
	cost = 20
...
/datum/supply_pack/atmos/rapid_pipe_dispenser
	contains = list(/obj/item/pipe_dispenser) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/supply_pack/atmos/internals
	...
	contains = list(
			...
			/obj/item/tank/air = 3 // CHOMPEdit - Removal of obj/item/weapon
			)
	cost = 10
	containertype = /obj/structure/closet/crate/aether
...
/datum/supply_pack/atmos/evacuation
	...
	contains = list(
			/obj/item/storage/toolbox/emergency = 2, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/clothing/suit/storage/hazardvest = 2,
			/obj/item/clothing/suit/storage/vest = 2,
			/obj/item/tank/emergency/oxygen/engi = 4, // CHOMPEdit - Removal of obj/item/weapon
...
/datum/supply_pack/atmos/firefighting
	...
	contains = list(
		...
		/obj/item/watertank/atmos = 2, // CHOMPEdit - Removal of obj/item/weapon
