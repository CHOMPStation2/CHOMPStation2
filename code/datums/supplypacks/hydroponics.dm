...
/datum/supply_pack/hydro/monkey
	name = "Monkey crate"
	contains = list (/obj/item/storage/box/monkeycubes) // CHOMPEdit - Removal of obj/item/weapon
	cost = 20
...
/datum/supply_pack/hydro/farwa
	name = "Farwa crate"
	contains = list (/obj/item/storage/box/monkeycubes/farwacubes) // CHOMPEdit - Removal of obj/item/weapon
	cost = 20
...
/datum/supply_pack/hydro/neara
	name = "Neaera crate"
	contains = list (/obj/item/storage/box/monkeycubes/neaeracubes) // CHOMPEdit - Removal of obj/item/weapon
	cost = 20
	containertype = /obj/structure/closet/crate/freezer
...
/datum/supply_pack/hydro/stok
	name = "Stok crate"
	contains = list (/obj/item/storage/box/monkeycubes/stokcubes) // CHOMPEdit - Removal of obj/item/weapon
	cost = 20
	containertype = /obj/structure/closet/crate/freezer
...
/datum/supply_pack/hydro/hydroponics
	...
	contains = list(
			/obj/item/reagent_containers/spray/plantbgone = 4, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/reagent_containers/glass/bottle/ammonia = 2, // CHOMPEdit - Removal of obj/item/weapon
...
/datum/supply_pack/hydro/weedcontrol
	...
	contains = list(
			/obj/item/material/knife/machete/hatchet = 2, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/reagent_containers/spray/plantbgone = 4, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/clothing/mask/gas = 2,
			/obj/item/grenade/chem_grenade/antiweed = 2, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/material/twohanded/fireaxe/scythe // CHOMPEdit - Removal of obj/item/weapon
			)
	cost = 45
...
/datum/supply_pack/hydro/sobaka
	name = "Sobaka crate"
	contains = list (/obj/item/storage/box/monkeycubes/sobakacubes) // CHOMPEdit - Removal of obj/item/weapon
	cost = 20
	containertype = /obj/structure/closet/crate/freezer
...
/datum/supply_pack/hydro/saru
	name = "Saru crate"
	contains = list (/obj/item/storage/box/monkeycubes/sarucubes) // CHOMPEdit - Removal of obj/item/weapon
	cost = 20
	containertype = /obj/structure/closet/crate/freezer
...
/datum/supply_pack/hydro/sparra
	name = "Sparra crate"
	contains = list (/obj/item/storage/box/monkeycubes/sparracubes) // CHOMPEdit - Removal of obj/item/weapon
	cost = 20
	containertype = /obj/structure/closet/crate/freezer
...
/datum/supply_pack/hydro/wolpin
	name = "Wolpin crate"
	contains = list (/obj/item/storage/box/monkeycubes/wolpincubes) // CHOMPEdit - Removal of obj/item/weapon
	cost = 20
	containertype = /obj/structure/closet/crate/freezer
...
/datum/supply_pack/hydro/fish
	...
	contains = list(
			/obj/item/reagent_containers/food/snacks/lobster = 6, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/reagent_containers/food/snacks/cuttlefish = 8, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/reagent_containers/food/snacks/sliceable/monkfish = 1 // CHOMPEdit - Removal of obj/item/weapon
			)
	cost = 20
	containertype = /obj/structure/closet/crate/freezer
...
/datum/supply_pack/hydro/fennec_food
	...
	contains = list(
			/obj/item/reagent_containers/food/snacks/locust = 6, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/storage/box/wings/bucket = 2, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/reagent_containers/food/snacks/grub_pink = 2, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/reagent_containers/food/snacks/grub_blue = 2, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/reagent_containers/food/snacks/grub_purple = 2, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/reagent_containers/food/snacks/honey_candy = 4, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/reagent_containers/food/snacks/scorpion = 4, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/reagent_containers/food/snacks/ant = 4 // CHOMPEdit - Removal of obj/item/weapon
			)
	cost = 20
