...
/datum/supply_pack/voidsuits/atmos
	...
	contains = list(
			...
			/obj/item/tank/oxygen = 2, // CHOMPEdit - Removal of obj/item/weapon
			)
	cost = 35
...
/datum/supply_pack/voidsuits/unathi_bs_NT
	...
	contains = list(/obj/item/rig/breacher) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/supply_pack/voidsuits/unathi_bs_Auth
	...
	contains = list(/obj/item/rig/breacher/fancy) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/supply_pack/voidsuits/voxciv
	...
	contains = list(/obj/item/rig/vox/civilian) // CHOMPEdit - Removal of obj/item/weapon
	cost = 80
...
/datum/supply_pack/voidsuits/voxeng
	...
	contains = list (/obj/item/rig/vox/engineering) // CHOMPEdit - Removal of obj/item/weapon
	cost = 150
	containertype = /obj/structure/closet/crate/oculum
...
/datum/supply_pack/voidsuits/voxsec
	...
	contains = list (/obj/item/rig/vox/security) // CHOMPEdit - Removal of obj/item/weapon
	cost = 90
	containertype = /obj/structure/closet/crate/secure/heph
...
/datum/supply_pack/voidsuits/pilot
	...
	contains = list(
			...
			/obj/item/tank/oxygen = 1 // CHOMPEdit - Removal of obj/item/weapon
			)
	cost = 20
	containertype = /obj/structure/closet/crate/secure
