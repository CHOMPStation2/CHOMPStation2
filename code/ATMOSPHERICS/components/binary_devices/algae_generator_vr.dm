...
/obj/machinery/atmospherics/binary/algae_farm
	...
	circuit = /obj/item/circuitboard/algae_farm // CHOMPEdit - Removal of obj/item/weapon
	anchored = TRUE
	density = TRUE
	power_channel = EQUIP
...
/obj/machinery/atmospherics/binary/algae_farm/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
