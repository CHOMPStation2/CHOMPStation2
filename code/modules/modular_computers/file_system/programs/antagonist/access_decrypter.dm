...
/datum/computer_file/program/access_decrypter/process_tick()
	...
	if(!running)
		return
	var/obj/item/computer_hardware/processor_unit/CPU = computer.processor_unit // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/computer_hardware/card_slot/RFID = computer.card_slot // CHOMPEdit - Removal of obj/item/weapon
...
/datum/computer_file/program/access_decrypter/tgui_data(mob/user, datum/tgui/ui, datum/tgui_state/state)
	...
	if(message)
		...
		var/obj/item/card/id/id_card = computer.card_slot.stored_card // CHOMPEdit - Removal of obj/item/weapon
		for(var/i = 1; i <= 7; i++)
