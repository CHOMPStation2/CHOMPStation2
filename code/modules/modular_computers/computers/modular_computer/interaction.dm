...
/obj/item/modular_computer/attackby(var/obj/item/W as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/card/id)) // ID Card, try to insert it. // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/card/id/I = W // CHOMPEdit - Removal of obj/item/weapon
		if(!card_slot)
		...
		return
	if(istype(W, /obj/item/paper) || istype(W, /obj/item/paper_bundle)) // CHOMPEdit - Removal of obj/item/weapon
		if(!nano_printer)
			return
		nano_printer.attackby(W, user)
	if(istype(W, /obj/item/computer_hardware)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/computer_hardware/C = W // CHOMPEdit - Removal of obj/item/weapon
	...
	if(W.has_tool_quality(TOOL_SCREWDRIVER))
		...
		for(var/obj/item/computer_hardware/H in all_components) // CHOMPEdit - Removal of obj/item/weapon
		...
		var/obj/item/computer_hardware/H = find_hardware_by_name(choice) // CHOMPEdit - Removal of obj/item/weapon
