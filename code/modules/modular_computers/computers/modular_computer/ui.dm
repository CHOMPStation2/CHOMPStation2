...
/obj/item/modular_computer/tgui_data(mob/user, datum/tgui/ui, datum/tgui_state/state)
	...
	data["login"] = list()
	var/obj/item/computer_hardware/card_slot/cardholder = card_slot // CHOMPEdit - Removal of obj/item/weapon
	if(cardholder)
		var/obj/item/card/id/stored_card = cardholder.stored_card // CHOMPEdit - Removal of obj/item/weapon
		if(stored_card)
