/obj/item/computer_hardware/ // CHOMPEdit - Removal of obj/item/weapon
	name = "Hardware"
...
/obj/item/computer_hardware/attackby(obj/item/W as obj, mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/computer_hardware/proc/diagnostics(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	to_chat(user, "Hardware Integrity Test... (Corruption: [damage]/[max_damage]) [damage > damage_failure ? "FAIL" : damage > damage_malfunction ? "WARN" : "PASS"]")

/obj/item/computer_hardware/New(var/obj/L) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/computer_hardware/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	holder2 = null
	return ..()

/// Handles damage checks
/obj/item/computer_hardware/proc/check_functionality() // CHOMPEdit - Removal of obj/item/weapon
	// Turned off
	if(!enabled)
		return FALSE
...
/obj/item/computer_hardware/examine(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(damage > damage_failure)
...
/obj/item/computer_hardware/take_damage(var/amount) // CHOMPEdit - Removal of obj/item/weapon
