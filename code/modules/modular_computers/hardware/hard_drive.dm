/obj/item/computer_hardware/hard_drive/ // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/computer_hardware/hard_drive/advanced // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/computer_hardware/hard_drive/super // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/computer_hardware/hard_drive/cluster // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/computer_hardware/hard_drive/small // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/computer_hardware/hard_drive/micro // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/computer_hardware/hard_drive/diagnostics(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/computer_hardware/hard_drive/proc/store_file(var/datum/computer_file/F) // CHOMPEdit - Removal of obj/item/weapon
	if(!F || !istype(F))
		return 0
...
// Use this proc to add file to the drive. Returns 1 on success and 0 on failure. Contains necessary sanity checks.
/obj/item/computer_hardware/hard_drive/proc/install_default_programs() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/computer_hardware/hard_drive/proc/remove_file(var/datum/computer_file/F) // CHOMPEdit - Removal of obj/item/weapon
	if(!F || !istype(F))
		return 0
...
/obj/item/computer_hardware/hard_drive/proc/recalculate_size() // CHOMPEdit - Removal of obj/item/weapon
	var/total_size = 0
...
/obj/item/computer_hardware/hard_drive/proc/can_store_file(var/size = 1) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/computer_hardware/hard_drive/proc/try_store_file(var/datum/computer_file/F) // CHOMPEdit - Removal of obj/item/weapon
	if(!F || !istype(F))
		return 0
...
/obj/item/computer_hardware/hard_drive/proc/find_file_by_name(var/filename) // CHOMPEdit - Removal of obj/item/weapon
	if(!check_functionality())
		return null
...
/obj/item/computer_hardware/hard_drive/proc/find_file_by_uid(var/uid) // CHOMPEdit - Removal of obj/item/weapon
	if(!check_functionality())
		return null
...
/obj/item/computer_hardware/hard_drive/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	if(holder2 && (holder2.hard_drive == src))
		holder2.hard_drive = null
	stored_files = null
	return ..()

/obj/item/computer_hardware/hard_drive/New() // CHOMPEdit - Removal of obj/item/weapon
