...
/obj/machinery/computer/transhuman/resleeving
	...
	icon_screen = "dna"
	light_color = "#315ab4"
	circuit = /obj/item/circuitboard/resleeving_control // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/disk/transcore/disk // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/transhuman/resleeving/attackby(obj/item/W as obj, mob/user as mob)
	...
	else if(istype(W, /obj/item/disk/transcore) && !our_db.core_dumped) // CHOMPEdit - Removal of obj/item/weapon
		user.unEquip(W)
		disk = W
		disk.forceMove(src)
		to_chat(user, "<span class='notice'>You insert \the [W] into \the [src].</span>")
	if(istype(W, /obj/item/disk/body_record)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/disk/body_record/brDisk = W // CHOMPEdit - Removal of obj/item/weapon
		if(!brDisk.stored)
...
/obj/machinery/computer/transhuman/resleeving/tgui_act(action, params)
	...
	switch(tgui_modal_act(src, action, params))
		if(TGUI_MODAL_ANSWER)
			...
			// 	var/obj/item/card/id/C = usr.get_active_hand() // CHOMPEdit - Removal of obj/item/weapon
			// 	if(!istype(C) && !istype(C, /obj/item/pda)) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/cmo_disk_holder/attack_self(var/mob/attacker) // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/disk/transcore/newdisk = new(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
	attacker.put_in_any_hand_if_possible(newdisk)
	qdel(src)

/obj/item/disk/transcore // CHOMPEdit - Removal of obj/item/weapon
