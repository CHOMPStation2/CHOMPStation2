...
/obj/item/material/fishing_rod // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/reagent_containers/food/snacks/Bait // CHOMPEdit - Removal of obj/item/weapon
	var/bait_type = /obj/item/reagent_containers/food/snacks // CHOMPEdit - Removal of obj/item/weapon

	var/cast = FALSE

	attackspeed = 3 SECONDS

/obj/item/material/fishing_rod/built // CHOMPEdit - Removal of obj/item/weapon
	strung = FALSE

/obj/item/material/fishing_rod/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(Bait)
		. += "<span class='notice'>It has [Bait] hanging on its hook: </span>"
		. += Bait.examine(user)

/obj/item/material/fishing_rod/CtrlClick(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/fishing_rod/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	update_icon()

/obj/item/material/fishing_rod/attackby(obj/item/I as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/fishing_rod/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	cut_overlays()
	..()
	if(strung)
		add_overlay("[icon_state]_string")

/obj/item/material/fishing_rod/proc/update_bait() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/fishing_rod/proc/consume_bait() // CHOMPEdit - Removal of obj/item/weapon
	if(Bait)
		qdel(Bait)
		Bait = null
		return TRUE
...
/obj/item/material/fishing_rod/attack(var/mob/M as mob, var/mob/user as mob, var/def_zone) // CHOMPEdit - Removal of obj/item/weapon
	if(cast)
...
/obj/item/material/fishing_rod/modern/built // CHOMPEdit - Removal of obj/item/weapon
	strung = FALSE

/obj/item/material/fishing_rod/modern/cheap //A rod sold by the fishing vendor. Done so that the rod sold by mining reward vendors doesn't loose its value. // CHOMPEdit - Removal of obj/item/weapon
