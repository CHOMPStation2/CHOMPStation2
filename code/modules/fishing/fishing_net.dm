/obj/item/material/fishing_net // CHOMPEdit - Removal of obj/item/weapon
	name = "fishing net"
...
/obj/item/material/fishing_net/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	update_icon()

/obj/item/material/fishing_net/afterattack(var/atom/A, var/mob/user, var/proximity) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/fishing_net/attack_self(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/fishing_net/attackby(var/obj/item/W, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(contents)
...
/obj/item/material/fishing_net/update_icon() // Also updates name and desc // CHOMPEdit - Removal of obj/item/weapon
	underlays.Cut()
	cut_overlays()
...
/obj/item/material/fishing_net/proc/update_weight() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/fishing_net/butterfly_net/afterattack(var/atom/A, var/mob/user, var/proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(get_dist(get_turf(src), A) > reach)
		return
...
/obj/item/material/fishing_net/butterfly_net/attack_self(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/fishing_net/butterfly_net/container_resist(mob/living/M) // CHOMPEdit - Removal of obj/item/weapon
	if(prob(20))
		M.forceMove(get_turf(src))
...
/obj/item/material/fishing_net/butterfly_net/update_icon() // Also updates name and desc // CHOMPEdit - Removal of obj/item/weapon
	underlays.Cut()
	cut_overlays()
...
/datum/crafting_recipe/butterfly_net
	name = "butterfly net"
	result = /obj/item/material/fishing_net/butterfly_net // CHOMPEdit - Removal of obj/item/weapon
	reqs = list(
