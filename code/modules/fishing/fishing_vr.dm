...
GLOBAL_LIST_INIT(ocean_fishing_uncommon_list, list(
		...
		/obj/item/reagent_containers/food/snacks/sliceable/monkfish = 10 // CHOMPEdit - Removal of obj/item/weapon
		))
...
GLOBAL_LIST_INIT(ocean_fishing_common_list, list(
		...
		/obj/item/reagent_containers/food/snacks/cuttlefish = 10, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/reagent_containers/food/snacks/lobster = 8 // CHOMPEdit - Removal of obj/item/weapon
		))
