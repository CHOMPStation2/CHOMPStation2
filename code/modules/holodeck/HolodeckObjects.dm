...
/turf/simulated/floor/holofloor/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	return
...
/obj/structure/window/reinforced/holowindow/attackby(obj/item/W as obj, mob/user as mob)
	...
	if (istype(W, /obj/item/grab) && get_dist(src,user)<2) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/door/window/holowindoor/attackby(obj/item/I as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon

	if (src.operating == 1)
		return

	if(src.density && istype(I, /obj/item) && !istype(I, /obj/item/card)) // CHOMPEdit - Removal of obj/item/weapon
		var/aforce = I.force
		playsound(src, 'sound/effects/Glasshit.ogg', 75, 1)
...
/obj/structure/bed/chair/holochair/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(W.has_tool_quality(TOOL_WRENCH))
		to_chat(user, "<span class='notice'>It's a holochair, you can't dismantle it!</span>")
	return
//VOREStation Add
/obj/structure/bed/holobed/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(W.has_tool_quality(TOOL_WRENCH))
		to_chat(user, "<span class='notice'>It's a holochair, you can't dismantle it!</span>")
	return
//VOREStation Add End
/obj/item/holo // CHOMPEdit - Removal of obj/item/weapon
	damtype = HALLOSS
	no_attack_log = 1
	no_random_knockdown = TRUE

/obj/item/holo/esword // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/holo/esword/green/New() // CHOMPEdit - Removal of obj/item/weapon
		lcolor = "#008000"

/obj/item/holo/esword/red/New() // CHOMPEdit - Removal of obj/item/weapon
		lcolor = "#FF0000"

/obj/item/holo/esword/handle_shield(mob/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, var/attack_text = "the attack") // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/holo/esword/attack_self(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	active = !active
	if (active)
		force = 30
...
/obj/item/holo/esword/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/multitool) && !active) // CHOMPEdit - Removal of obj/item/device
		if(!rainbow)
			rainbow = TRUE
		else
			rainbow = FALSE
...
/obj/item/holo/esword/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/structure/holohoop/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if (istype(W, /obj/item/grab) && get_dist(src,user)<2) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/grab/G = W // CHOMPEdit - Removal of obj/item/weapon
		if(G.state<2)
...
/obj/machinery/readybutton/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
