...
/obj/item/coin/New() // CHOMPEdit - Removal of obj/item/weapon
	randpixel_xy()
...
/obj/item/coin/diamond // CHOMPEdit - Removal of obj/item/weapon
	name = "diamond coin"
	icon_state = "coin_diamond"
	matter = list(MAT_DIAMOND = 250)

/obj/item/coin/iron // CHOMPEdit - Removal of obj/item/weapon
	name = "iron coin"
	icon_state = "coin_iron"
	matter = list(MAT_IRON = 250)

/obj/item/coin/phoron // CHOMPEdit - Removal of obj/item/weapon
	name = "solid phoron coin"
	icon_state = "coin_phoron"
	matter = list(MAT_PHORON = 250)

/obj/item/coin/uranium // CHOMPEdit - Removal of obj/item/weapon
	name = "uranium coin"
	icon_state = "coin_uranium"
	matter = list(MAT_URANIUM = 250)

/obj/item/coin/platinum // CHOMPEdit - Removal of obj/item/weapon
	name = "platinum coin"
	icon_state = "coin_adamantine"
	matter = list(MAT_GOLD = 250)

/obj/item/coin/morphium // CHOMPEdit - Removal of obj/item/weapon
	name = "morphium coin"
	icon_state = "coin_morphium"
	matter = list(MAT_MORPHIUM = 250)

/obj/item/coin/aluminium // CHOMPEdit - Removal of obj/item/weapon
	name = "aluminium coin"
	icon_state = "coin_aluminium"
	matter = list(MAT_ALUMINIUM = 250)

/obj/item/coin/verdantium // CHOMPEdit - Removal of obj/item/weapon
	name = "verdantium coin"
	icon_state = "coin_verdantium"
	matter = list(MAT_VERDANTIUM = 250)

/obj/item/coin/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/coin/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
