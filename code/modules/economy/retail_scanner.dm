/obj/item/retail_scanner // CHOMPEdit - Removal of obj/item/device
	name = "retail scanner"
...
// Claim machine ID
/obj/item/retail_scanner/New() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/retail_scanner/afterattack(atom/movable/AM, mob/user, proximity) // CHOMPEdit - Removal of obj/item/device
	if(!proximity)	return
...
/obj/item/retail_scanner/pickup(mob/user) // CHOMPEdit - Removal of obj/item/device
	src.dir = SOUTH
	src.pixel_y = 0


/obj/item/retail_scanner/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	user.set_machine(src)
	interact(user)


/obj/item/retail_scanner/AltClick(var/mob/user) // CHOMPEdit - Removal of obj/item/device
	if(Adjacent(user))
		user.set_machine(src)
		interact(user)

/obj/item/retail_scanner/examine(mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	. = ..()
	if(transaction_amount)
		. += "It has a purchase of [transaction_amount] pending[transaction_purpose ? " for [transaction_purpose]" : ""]."

/obj/item/retail_scanner/interact(mob/user as mob) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/retail_scanner/Topic(var/href, var/href_list) // CHOMPEdit - Removal of obj/item/device
	if(..())
		return
...
/obj/item/retail_scanner/attackby(obj/O as obj, user as mob) // CHOMPEdit - Removal of obj/item/device
	// Check for a method of paying (ID, PDA, e-wallet, cash, ect.)
	var/obj/item/card/id/I = O.GetID() // CHOMPEdit - Removal of obj/item/weapon
	if(I)
		scan_card(I, O)
	else if (istype(O, /obj/item/spacecash/ewallet)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/spacecash/ewallet/E = O // CHOMPEdit - Removal of obj/item/weapon
		scan_wallet(E)
	else if (istype(O, /obj/item/spacecash)) // CHOMPEdit - Removal of obj/item/weapon
		to_chat(usr, "<span class='warning'>This device does not accept cash.</span>")

	else if(istype(O, /obj/item/card/emag)) // CHOMPEdit - Removal of obj/item/weapon
		return ..()
...
/obj/item/retail_scanner/showoff(mob/user) // CHOMPEdit - Removal of obj/item/device
	for (var/mob/M in view(user))
		M.show_message("[user] holds up [src]. <a HREF=?src=\ref[M];clickitem=\ref[src]>Swipe card or item.</a>",1)


/obj/item/retail_scanner/proc/confirm(var/obj/item/I) // CHOMPEdit - Removal of obj/item/device
	if(confirm_item == I)
		return 1
	else
		confirm_item = I
...
/obj/item/retail_scanner/proc/scan_card(var/obj/item/card/id/I, var/obj/item/ID_container) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	if (!transaction_amount)
		return
...
/obj/item/retail_scanner/proc/scan_wallet(var/obj/item/spacecash/ewallet/E) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	if (!transaction_amount)
		return
...
/obj/item/retail_scanner/proc/scan_item_price(var/obj/O) // CHOMPEdit - Removal of obj/item/device
	if(!istype(O))	return
	if(item_list.len > 10)
...
/obj/item/retail_scanner/proc/get_current_transaction() // CHOMPEdit - Removal of obj/item/device
	var/dat = {"
	<head><style>
...
/obj/item/retail_scanner/proc/add_transaction_log(var/c_name, var/p_method, var/t_amount) // CHOMPEdit - Removal of obj/item/device
	var/dat = {"
	<head><style>
...
/obj/item/retail_scanner/proc/check_account() // CHOMPEdit - Removal of obj/item/device
	if (!linked_account)
		usr.visible_message("[icon2html(src,viewers(src))]<span class='warning'>Unable to connect to linked account.</span>")
		return 0
...
/obj/item/retail_scanner/proc/transaction_complete() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/retail_scanner/proc/reset_memory() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/retail_scanner/emag_act(var/remaining_charges, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	if(!emagged)
...
/obj/item/retail_scanner/command // CHOMPEdit - Removal of obj/item/device
	account_to_connect = "Command"

/obj/item/retail_scanner/medical // CHOMPEdit - Removal of obj/item/device
	account_to_connect = "Medical"

/obj/item/retail_scanner/engineering // CHOMPEdit - Removal of obj/item/device
	account_to_connect = "Engineering"

/obj/item/retail_scanner/science // CHOMPEdit - Removal of obj/item/device
	account_to_connect = "Science"

/obj/item/retail_scanner/security // CHOMPEdit - Removal of obj/item/device
	account_to_connect = "Security"

/obj/item/retail_scanner/cargo // CHOMPEdit - Removal of obj/item/device
	account_to_connect = "Cargo"

/obj/item/retail_scanner/civilian // CHOMPEdit - Removal of obj/item/device
