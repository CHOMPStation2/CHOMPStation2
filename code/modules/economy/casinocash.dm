...
/obj/machinery/chipmachine/attackby(obj/item/I as obj, mob/user as mob)
	if(istype(I,/obj/item/spacecash) && (I:worth >= 5)) // CHOMPEdit - Removal of obj/item/weapon
		//consume the money
		if(prob(50))
	...
	if(istype(I,/obj/item/spacecasinocash)) // CHOMPEdit - Removal of obj/item/weapon
		//consume the chips
		if(prob(50))
			playsound(loc, 'sound/items/polaroid1.ogg', 50, 1)
		else
...
/obj/item/spacecasinocash/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/spacecasinocash)) // CHOMPEdit - Removal of obj/item/weapon

		var/obj/item/spacecasinocash/SC = W // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spacecasinocash/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	overlays.Cut()
...
/obj/item/spacecasinocash/proc/adjust_worth(var/adjust_worth = 0, var/update = 1) // CHOMPEdit - Removal of obj/item/weapon
	worth += adjust_worth
	if(worth > 0)
		if(update)
			update_icon()
...
/obj/item/spacecasinocash/proc/set_worth(var/new_worth = 0, var/update = 1) // CHOMPEdit - Removal of obj/item/weapon
	worth = max(0, new_worth)
	if(update)
		update_icon()
	return worth

/obj/item/spacecasinocash/attack_self() // CHOMPEdit - Removal of obj/item/weapon
	...
	adjust_worth(-amount)
	var/obj/item/spacecasinocash/SC = new (usr.loc) // CHOMPEdit - Removal of obj/item/weapon
	SC.set_worth(amount)
	usr.put_in_hands(SC)
...
/obj/item/spacecasinocash/c10 // CHOMPEdit - Removal of obj/item/weapon
	name = "10 credit casino chip"
	icon_state = "spacecasinocash10"
	desc = "It's worth 10 credits."
	worth = 10

/obj/item/spacecasinocash/c20 // CHOMPEdit - Removal of obj/item/weapon
	name = "20 credit casino chip"
	icon_state = "spacecasinocash20"
	desc = "It's worth 20 credits."
	worth = 20

/obj/item/spacecasinocash/c50 // CHOMPEdit - Removal of obj/item/weapon
	name = "50 credit casino chip"
	icon_state = "spacecasinocash50"
	desc = "It's worth 50 credits."
	worth = 50

/obj/item/spacecasinocash/c100 // CHOMPEdit - Removal of obj/item/weapon
	name = "100 credit casino chip"
	icon_state = "spacecasinocash100"
	desc = "It's worth 100 credits."
	worth = 100

/obj/item/spacecasinocash/c200 // CHOMPEdit - Removal of obj/item/weapon
...
/proc/spawn_casinochips(var/sum, spawnloc, mob/living/carbon/human/human_user as mob)
	var/obj/item/spacecasinocash/SC = new (spawnloc) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/casino_platinum_chip/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
