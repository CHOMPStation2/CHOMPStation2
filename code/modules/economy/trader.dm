...
/obj/trader/attackby(obj/item/O, mob/user)
	...
	switch(accepts)
		if("coin")
			if(istype(O, /obj/item/aliencoin)) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/aliencoin/a = O // CHOMPEdit - Removal of obj/item/weapon
				coinbalance += a.value
				visible_message("<span class='notice'>\The [src] accepts \the [user]'s [O].</span>")
				qdel(a)
		if("money")
			if(istype(O, /obj/item/spacecash)) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/spacecash/w = O // CHOMPEdit - Removal of obj/item/weapon
				for(var/obj/item/spacecash/c in bank) // CHOMPEdit - Removal of obj/item/weapon
	...
	switch(kind)
		...
		if("money")
			for(var/obj/c in bank)
				if(istype(c, /obj/item/spacecash)) // CHOMPEdit - Removal of obj/item/weapon
					var/obj/item/spacecash/a = c // CHOMPEdit - Removal of obj/item/weapon
					value += a.worth
				else
...
/obj/trader/proc/return_funds()
	...
	switch(accepts)
		if("coin")
			...
			while(coinbalance > 0)
				if(coinbalance >= 20)
					new /obj/item/aliencoin/phoron(get_turf(loc)) // CHOMPEdit - Removal of obj/item/weapon
					coinbalance -= 20
				else if(coinbalance >= 10)
					new /obj/item/aliencoin/gold(get_turf(loc)) // CHOMPEdit - Removal of obj/item/weapon
					coinbalance -= 10
				else if(coinbalance >= 5)
					new /obj/item/aliencoin/silver(get_turf(loc)) // CHOMPEdit - Removal of obj/item/weapon
					coinbalance -= 5
				else
					new /obj/item/aliencoin/basic(get_turf(loc)) // CHOMPEdit - Removal of obj/item/weapon
					coinbalance --
		if("money")
			for(var/obj/c in bank)
				u_get_refund = TRUE
...
/obj/trader/general
	...
	start_products = list(
		...
		/obj/item/perfect_tele = 10, // CHOMPEdit - Removal of obj/item/device
		/obj/item/chameleon = 25, // CHOMPEdit - Removal of obj/item/device
		/obj/item/gun/energy/sizegun = 25, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/slow_sizegun = 25, // CHOMPEdit - Removal of obj/item/device
		/obj/item/clothing/accessory/collar/shock/bluespace = 25,
		/obj/item/implant/sizecontrol = 25, // CHOMPEdit - Removal of obj/item/weapon
		...
		/obj/item/cell/infinite = 10, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/cell/void = 15, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/cell/device/weapon/recharge/alien = 10, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/reagent_containers/food/snacks/jellyfishcore = 50, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/denecrotizer = 10, // CHOMPEdit - Removal of obj/item/device
		/obj/item/clothing/shoes/boots/speed = 15,
		/obj/item/bluespace_harpoon = 20, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/telecube/randomized = 5, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/bodysnatcher = 20, // CHOMPEdit - Removal of obj/item/device
		/obj/item/survivalcapsule = 25, // CHOMPEdit - Removal of obj/item/device
		/obj/item/survivalcapsule/luxury = 20, // CHOMPEdit - Removal of obj/item/device
		/obj/item/survivalcapsule/luxurybar = 15, // CHOMPEdit - Removal of obj/item/device
		/obj/item/survivalcapsule/popcabin = 20, // CHOMPEdit - Removal of obj/item/device
		/obj/item/perfect_tele/frontier/unknown/one = 1 // CHOMPEdit - Removal of obj/item/device
		)
	prices = list(
		/obj/item/capture_crystal/basic = 6,
		/obj/item/capture_crystal/random = 15,
		/obj/item/perfect_tele = 20, // CHOMPEdit - Removal of obj/item/device
		/obj/item/chameleon = 20, // CHOMPEdit - Removal of obj/item/device
		/obj/item/gun/energy/sizegun = 10, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/slow_sizegun = 10, // CHOMPEdit - Removal of obj/item/device
		/obj/item/clothing/accessory/collar/shock/bluespace = 10,
		/obj/item/implant/sizecontrol = 10, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/clothing/under/hyperfiber/bluespace = 10,
		/obj/item/nif/authentic = 100, // CHOMPEdit - Removal of obj/item/device
		/obj/item/toy/bosunwhistle = 1,
		/obj/item/cell/infinite = 20, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/cell/void = 20, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/cell/device/weapon/recharge/alien = 20, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/reagent_containers/food/snacks/jellyfishcore = 3, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/denecrotizer = 20, // CHOMPEdit - Removal of obj/item/device
		/obj/item/clothing/shoes/boots/speed = 20,
		/obj/item/bluespace_harpoon = 20, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/telecube/randomized = 50, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/bodysnatcher = 20, // CHOMPEdit - Removal of obj/item/device
		/obj/item/survivalcapsule = 10, // CHOMPEdit - Removal of obj/item/device
		/obj/item/survivalcapsule/luxury = 20, // CHOMPEdit - Removal of obj/item/device
		/obj/item/survivalcapsule/luxurybar = 25, // CHOMPEdit - Removal of obj/item/device
		/obj/item/survivalcapsule/popcabin = 10, // CHOMPEdit - Removal of obj/item/device
		/obj/item/perfect_tele/frontier/unknown/one = 30 // CHOMPEdit - Removal of obj/item/device
		)
	multiple = list(
		/obj/item/capture_crystal/basic = 10,
		/obj/item/capture_crystal/random = 2,
		/obj/item/gun/energy/sizegun = 2, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/slow_sizegun = 2, // CHOMPEdit - Removal of obj/item/device
		/obj/item/clothing/accessory/collar/shock/bluespace = 2,
		/obj/item/implant/sizecontrol = 2, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/clothing/under/hyperfiber/bluespace = 2,
		/obj/item/reagent_containers/food/snacks/jellyfishcore = 10 // CHOMPEdit - Removal of obj/item/weapon
		)
