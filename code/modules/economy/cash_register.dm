...
/obj/machinery/cash_register/attackby(obj/item/O as obj, user as mob)
	...
	if(I)
		...
		var/obj/item/spacecash/SC = O // CHOMPEdit - Removal of obj/item/weapon
		if(cash_open)
		...
		var/obj/item/tool/wrench/W = O // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/cash_register/proc/scan_card(obj/item/card/id/I, obj/item/ID_container) // CHOMPEdit - Removal of obj/item/weapon
	if (!transaction_amount)
		return
...
/obj/machinery/cash_register/proc/scan_wallet(obj/item/spacecash/ewallet/E) // CHOMPEdit - Removal of obj/item/weapon
	if (!transaction_amount)
		return
...
/obj/machinery/cash_register/proc/scan_cash(obj/item/spacecash/SC) // CHOMPEdit - Removal of obj/item/weapon
	if (!transaction_amount)
		return
...
/obj/machinery/cash_register/proc/toggle_anchors(obj/item/tool/wrench/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
