			...
			if(do_after(user, 2 SECONDS, src))
				...
				if(M.default_type == "silver")
					while(coinsToProduce-- > 0)
						new /obj/item/coin/silver(user.loc) // CHOMPEdit - Removal of obj/item/weapon
				else if(M.default_type == "gold")
					while(coinsToProduce-- > 0)
						new /obj/item/coin/gold(user.loc) // CHOMPEdit - Removal of obj/item/weapon
				else if(M.default_type == "diamond")
					while(coinsToProduce-- > 0)
						new /obj/item/coin/diamond(user.loc) // CHOMPEdit - Removal of obj/item/weapon
				else if(M.default_type == "iron")
					while(coinsToProduce-- > 0)
						new /obj/item/coin/iron(user.loc) // CHOMPEdit - Removal of obj/item/weapon
				else if(M.default_type == "phoron")
					while(coinsToProduce-- > 0)
						new /obj/item/coin/phoron(user.loc) // CHOMPEdit - Removal of obj/item/weapon
				else if(M.default_type == "uranium")
					while(coinsToProduce-- > 0)
						new /obj/item/coin/uranium(user.loc) // CHOMPEdit - Removal of obj/item/weapon
