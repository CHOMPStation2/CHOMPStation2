...
/obj/machinery/vending/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/card/id/I = W.GetID() // CHOMPEdit - Removal of obj/item/weapon

	if(I || istype(W, /obj/item/spacecash)) // CHOMPEdit - Removal of obj/item/weapon
		attack_hand(user)
		return
	else if(istype(W, /obj/item/refill_cartridge)) // CHOMPEdit - Removal of obj/item/weapon
		...
		if(!refillable)
			...
			return
		var/obj/item/refill_cartridge/RC = W // CHOMPEdit - Removal of obj/item/weapon
		...
		return
	else if(istype(W, /obj/item/multitool) || W.has_tool_quality(TOOL_WIRECUTTER)) // CHOMPEdit - Removal of obj/item/device
		if(panel_open)
			attack_hand(user)
		return
	else if(istype(W, /obj/item/coin) && has_premium) // CHOMPEdit - Removal of obj/item/weapon
		user.drop_item()
		W.forceMove(src)
		coin = W
		categories |= CAT_COIN
 ...
 */
/obj/machinery/vending/proc/pay_with_cash(var/obj/item/spacecash/cashmoney, mob/user) // CHOMPEdit - Removal of obj/item/weapon
 ...
 */
/obj/machinery/vending/proc/pay_with_ewallet(var/obj/item/spacecash/ewallet/wallet) // CHOMPEdit - Removal of obj/item/weapon
 ...
 * successful, 0 if failed
 */
/obj/machinery/vending/proc/pay_with_card(obj/item/card/id/I, mob/M) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/vending/tgui_data(mob/user)
	...
	if(ishuman(user))
		H = user
		C = H.GetIdCard()
		var/obj/item/spacecash/S = H.get_active_hand() // CHOMPEdit - Removal of obj/item/weapon
		if(istype(S))
...
/obj/machinery/vending/tgui_act(action, params)
	...
	switch(action)
		...
		if("vend")
			...
			if(istype(usr.get_active_hand(), /obj/item/spacecash)) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/spacecash/cash = usr.get_active_hand() // CHOMPEdit - Removal of obj/item/weapon
				paid = pay_with_cash(cash, usr)
			else if(istype(usr.get_active_hand(), /obj/item/spacecash/ewallet)) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/spacecash/ewallet/wallet = usr.get_active_hand() // CHOMPEdit - Removal of obj/item/weapon
				paid = pay_with_ewallet(wallet)
			else if(istype(C, /obj/item/card)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/vending/proc/do_logging(datum/stored_item/vending_product/R, mob/user, var/vending = 0)
	if(user.GetIdCard())
		var/obj/item/card/id/tempid = user.GetIdCard() // CHOMPEdit - Removal of obj/item/weapon
 ...
 */
/obj/machinery/vending/proc/stock(obj/item/W, var/datum/stored_item/vending_product/R, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!user.unEquip(W))
		return
