...
/obj/item/card/id/var/money = 2000 // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/atm
	...
	idle_power_usage = 10
	circuit =  /obj/item/circuitboard/atm // CHOMPEdit - Removal of obj/item/weapon
	...
	var/machine_id = ""
	var/obj/item/card/held_card // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/atm/process()
	...
	for(var/obj/item/spacecash/S in src) // CHOMPEdit - Removal of obj/item/weapon
		S.loc = src.loc
		if(prob(50))
...
/obj/machinery/atm/attackby(obj/item/I as obj, mob/user as mob)
	...
	if(istype(I, /obj/item/card)) // CHOMPEdit - Removal of obj/item/weapon
		...
		var/obj/item/card/id/idcard = I // CHOMPEdit - Removal of obj/item/weapon
		if(!held_card)
			usr.drop_item()
			idcard.loc = src
			held_card = idcard
		...
		if(istype(I,/obj/item/spacecash)) // CHOMPEdit - Removal of obj/item/weapon
			//consume the money
...
/obj/machinery/atm/proc/scan_user(mob/living/carbon/human/human_user as mob)
	if(!authenticated_account)
		if(human_user.wear_id)
			var/obj/item/card/id/I // CHOMPEdit - Removal of obj/item/weapon
			if(istype(human_user.wear_id, /obj/item/card/id) ) // CHOMPEdit - Removal of obj/item/weapon
				I = human_user.wear_id
			else if(istype(human_user.wear_id, /obj/item/pda) ) // CHOMPEdit - Removal of obj/item/device
				var/obj/item/pda/P = human_user.wear_id // CHOMPEdit - Removal of obj/item/device
				I = P.id
			if(I)
...
/obj/machinery/atm/proc/spawn_ewallet(var/sum, loc, mob/living/carbon/human/human_user as mob)
	var/obj/item/spacecash/ewallet/E = new /obj/item/spacecash/ewallet(loc) // CHOMPEdit - Removal of obj/item/weapon
	if(ishuman(human_user) && !human_user.get_active_hand())
