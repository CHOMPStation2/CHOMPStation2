...
/mob/living/carbon/human/proc/nif_menu()
	...
	var/obj/item/nif/N = nif // CHOMPEdit - Removal of obj/item/device
	if(istype(N))
		N.tgui_interact(usr)
 ...
 */
/obj/item/nif/tgui_state(mob/user) // CHOMPEdit - Removal of obj/item/device
	return GLOB.tgui_nif_main_state

/**
 * Standard TGUI stub to open the NIF.js template.
 */
/obj/item/nif/tgui_interact(mob/user, datum/tgui/ui, datum/tgui/parent_ui) // CHOMPEdit - Removal of obj/item/device
	if(!ishuman(user))
		return FALSE
 ...
 */
/obj/item/nif/tgui_data(mob/user, datum/tgui/ui, datum/tgui_state/state) // CHOMPEdit - Removal of obj/item/device
	var/list/data = ..()
 ...
 */
/obj/item/nif/tgui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state) // CHOMPEdit - Removal of obj/item/device
	if(..())
		return TRUE
