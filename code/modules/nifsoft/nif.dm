...
/mob/living/carbon/human/var/obj/item/nif/nif // CHOMPEdit - Removal of obj/item/device

//Nanotech Implant Foundation
/obj/item/nif // CHOMPEdit - Removal of obj/item/device
	...
	var/obj/item/communicator/commlink/comm		// The commlink requires this // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/New(var/newloc,var/wear,var/list/load_data) // CHOMPEdit - Removal of obj/item/device
	..(newloc)
...
/obj/item/nif/Destroy() // CHOMPEdit - Removal of obj/item/device
	human = null
...
/obj/item/nif/proc/implant(var/mob/living/carbon/human/H) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/proc/quick_implant(var/mob/living/carbon/human/H) // CHOMPEdit - Removal of obj/item/device
	if(istype(H))
...
/obj/item/nif/proc/unimplant(var/mob/living/carbon/human/H) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/emp_act(var/severity) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/proc/wear(var/wear = 0) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/proc/repair(var/repair = 0) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/attackby(obj/item/W, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	if(open == 0 && W.has_tool_quality(TOOL_SCREWDRIVER))
		...
		if(do_after(user, 6 SECONDS, src) && open == 1 && C.use(3))
			...
			open = 2
			update_icon()
	else if(open == 2 && istype(W,/obj/item/multitool)) // CHOMPEdit - Removal of obj/item/device
...
//Icon updating
/obj/item/nif/update_icon() // CHOMPEdit - Removal of obj/item/device
	if(open)
...
/obj/item/nif/proc/handle_install() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/proc/life() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/proc/notify(var/message,var/alert = 0) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/proc/use_charge(var/use_charge) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/proc/can_install(var/datum/nifsoft/path) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/proc/install(var/datum/nifsoft/new_soft) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/proc/uninstall(var/datum/nifsoft/old_soft) // CHOMPEdit - Removal of obj/item/device
...
//Activate a nifsoft
/obj/item/nif/proc/activate(var/datum/nifsoft/soft) // CHOMPEdit - Removal of obj/item/device
	if(stat != NIF_WORKING) return FALSE
...
/obj/item/nif/proc/deactivate(var/datum/nifsoft/soft) // CHOMPEdit - Removal of obj/item/device
	if(human)
		if(prob(5)) human.visible_message("<span class='notice'>\The [human] [pick(look_messages)].</span>")
		human << click_sound
...
/obj/item/nif/proc/deactivate_these(var/list/turn_off) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/proc/set_flag(var/flag,var/hint) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/proc/clear_flag(var/flag,var/hint) // CHOMPEdit - Removal of obj/item/device
	ASSERT(flag != null && hint)
...
/obj/item/nif/proc/imp_check(var/soft) // CHOMPEdit - Removal of obj/item/device
	if(stat != NIF_WORKING) return FALSE
	ASSERT(soft)
...
/obj/item/nif/proc/flag_check(var/flag,var/hint) // CHOMPEdit - Removal of obj/item/device
	if(stat != NIF_WORKING) return FALSE
...
/obj/item/nif/proc/planes_visible() // CHOMPEdit - Removal of obj/item/device
	if(stat != NIF_WORKING)
		return list() //None!

	return planes_visible

/obj/item/nif/proc/add_plane(var/planeid = null) // CHOMPEdit - Removal of obj/item/device
	if(!planeid)
		return
	planes_visible |= planeid

/obj/item/nif/proc/del_plane(var/planeid = null) // CHOMPEdit - Removal of obj/item/device
	if(!planeid)
		return
	planes_visible -= planeid

/obj/item/nif/proc/vis_update() // CHOMPEdit - Removal of obj/item/device
	if(human)
		human.recalculate_vis()

// Alternate NIFs
/obj/item/nif/bad // CHOMPEdit - Removal of obj/item/device
	name = "bootleg NIF"
...
/obj/item/nif/authentic // CHOMPEdit - Removal of obj/item/device
	name = "Authentic NIF"
	desc = "A much more expensive, advanced prototype of the NIF technology. Not usually found in the frontier."
	durability = 1000

/obj/item/nif/authenticbio // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/bioadap // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/protean				// Proteans' integrated NIF // CHOMPEdit - Removal of obj/item/device
...
/obj/item/nif/glitch // CHOMPEdit - Removal of obj/item/device
	name = "weird NIF"
...
/obj/item/nif/attack(mob/living/M, mob/living/user, var/target_zone) // CHOMPEdit - Removal of obj/item/device
