...
/datum/nifsoft/hidelaser/activate()
	if((. = ..()))
		...
		var/mob/living/carbon/human/H = nif.human
		H.adjustHalLoss(30)
		var/obj/item/gun/energy/gun/compact/dazzle/dgun = new(get_turf(H)) // CHOMPEdit - Removal of obj/item/weapon
		H.put_in_hands(dgun)
...
/obj/item/gun/energy/gun/compact/dazzle // CHOMPEdit - Removal of obj/item/weapon
	name = "Microlaser"
