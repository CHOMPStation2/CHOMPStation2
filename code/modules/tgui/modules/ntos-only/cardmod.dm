...
/datum/tgui_module/cardmod/tgui_data(mob/user, datum/tgui/ui, datum/tgui_state/state)
	...
	if(program && program.computer && program.computer.card_slot)
		var/obj/item/card/id/id_card = program.computer.card_slot.stored_card // CHOMPEdit - Removal of obj/item/weapon
...
/datum/tgui_module/cardmod/proc/format_jobs(list/jobs)
	...
	var/obj/item/card/id/id_card = program.computer.card_slot ? program.computer.card_slot.stored_card : null // CHOMPEdit - Removal of obj/item/weapon
...
/datum/tgui_module/cardmod/tgui_act(action, list/params, datum/tgui/ui)
	...
	var/obj/item/card/id/user_id_card = usr.GetIdCard() // CHOMPEdit - Removal of obj/item/weapon
