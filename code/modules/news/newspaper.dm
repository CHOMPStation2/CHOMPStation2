...
/obj/item/newspaper/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(ishuman(user))
...
/obj/item/newspaper/Topic(href, href_list) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/newspaper/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
