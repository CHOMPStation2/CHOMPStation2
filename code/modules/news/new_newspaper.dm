...
obj/item/newspaper/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(ishuman(user))
...
obj/item/newspaper/attackby(obj/item/W as obj, mob/user) // CHOMPEdit - Removal of obj/item/weapon
