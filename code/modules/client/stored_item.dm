...
/obj/item/encryptionkey // CHOMPEdit - Removal of obj/item/device
	persist_storable = FALSE
/obj/item/storage			//There are lots of things that have stuff that we may not want people to just have. And this is mostly intended for a single thing. // CHOMPEdit - Removal of obj/item/weapon
	persist_storable = FALSE		//And it would be annoying to go through and consider all of them, so default to disabled.
/obj/item/storage/backpack	//But we can enable some where it makes sense. Backpacks and their variants basically never start with anything in them, as an example. // CHOMPEdit - Removal of obj/item/weapon
	persist_storable = TRUE
/obj/item/reagent_containers/hypospray/vial // CHOMPEdit - Removal of obj/item/weapon
	persist_storable = FALSE
/obj/item/cmo_disk_holder // CHOMPEdit - Removal of obj/item/weapon
	persist_storable = FALSE
...
/obj/item/disk/nuclear // CHOMPEdit - Removal of obj/item/weapon
	persist_storable = FALSE
/obj/item/gun/energy/locked		//These are guns with security measures on them, so let's say the box won't let you put them in there. // CHOMPEdit - Removal of obj/item/weapon
