...
/mob/living/silicon/ai/get_looc_source()
	if(eyeobj)
		return eyeobj
	return src
||||||| parent of af90f96eed... Merge pull request #9812 from Novacat/nova-basicfixes:code/game/verbs/ooc.dm
...
/mob/living/silicon/ai/get_looc_source()
	if(eyeobj)
		return eyeobj
	return src
>>>>>>> af90f96eed... Merge pull request #9812 from Novacat/nova-basicfixes:code/modules/client/verbs/ooc.dm
