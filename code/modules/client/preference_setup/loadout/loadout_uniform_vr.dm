...
/datum/gear/uniform/swimsuits
	...
	path = /obj/item/storage/box/fluff/swimsuit // CHOMPEdit - Removal of obj/item/weapon

/datum/gear/uniform/swimsuits/New()
	..()
	var/list/swimsuits = list()
	for(var/obj/item/storage/box/fluff/swimsuit/swimsuit_type as anything in typesof(/obj/item/storage/box/fluff/swimsuit)) // CHOMPEdit - Removal of obj/item/weapon
