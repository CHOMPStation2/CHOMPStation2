...
/datum/gear_tweak/tablet
	var/list/ValidProcessors = list(/obj/item/computer_hardware/processor_unit/small) // CHOMPEdit - Removal of obj/item/weapon
	var/list/ValidBatteries = list(/obj/item/computer_hardware/battery_module/nano, /obj/item/computer_hardware/battery_module/micro, /obj/item/computer_hardware/battery_module) // CHOMPEdit - Removal of obj/item/weapon
	var/list/ValidHardDrives = list(/obj/item/computer_hardware/hard_drive/micro, /obj/item/computer_hardware/hard_drive/small, /obj/item/computer_hardware/hard_drive) // CHOMPEdit - Removal of obj/item/weapon
	var/list/ValidNetworkCards = list(/obj/item/computer_hardware/network_card, /obj/item/computer_hardware/network_card/advanced) // CHOMPEdit - Removal of obj/item/weapon
	var/list/ValidNanoPrinters = list(null, /obj/item/computer_hardware/nano_printer) // CHOMPEdit - Removal of obj/item/weapon
	var/list/ValidCardSlots = list(null, /obj/item/computer_hardware/card_slot) // CHOMPEdit - Removal of obj/item/weapon
	var/list/ValidTeslaLinks = list(null, /obj/item/computer_hardware/tesla_link) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/gear_tweak/laptop
	var/list/ValidProcessors = list(/obj/item/computer_hardware/processor_unit/small, /obj/item/computer_hardware/processor_unit) // CHOMPEdit - Removal of obj/item/weapon
	var/list/ValidBatteries = list(/obj/item/computer_hardware/battery_module, /obj/item/computer_hardware/battery_module/advanced, /obj/item/computer_hardware/battery_module/super) // CHOMPEdit - Removal of obj/item/weapon
	var/list/ValidHardDrives = list(/obj/item/computer_hardware/hard_drive, /obj/item/computer_hardware/hard_drive/advanced, /obj/item/computer_hardware/hard_drive/super) // CHOMPEdit - Removal of obj/item/weapon
	var/list/ValidNetworkCards = list(/obj/item/computer_hardware/network_card, /obj/item/computer_hardware/network_card/advanced) // CHOMPEdit - Removal of obj/item/weapon
	var/list/ValidNanoPrinters = list(null, /obj/item/computer_hardware/nano_printer) // CHOMPEdit - Removal of obj/item/weapon
	var/list/ValidCardSlots = list(null, /obj/item/computer_hardware/card_slot) // CHOMPEdit - Removal of obj/item/weapon
	var/list/ValidTeslaLinks = list(null, /obj/item/computer_hardware/tesla_link) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/gear_tweak/implant_location/tweak_item(var/obj/item/implant/I, var/metadata) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(I))
