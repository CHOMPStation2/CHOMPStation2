...
/datum/gear/utility/news_ch
	...
	path = /obj/item/starcaster_news // CHOMPEdit - Removal of obj/item/device
	cost = 0

/datum/gear/utility/implant/egg
	display_name = "Egg implant"
	path = /obj/item/implant/reagent_generator/egg // CHOMPEdit - Removal of obj/item/weapon
	cost = 0

/datum/gear/utility/implant/egg/New()
	..()
	var/list/implants = list()
	for(var/implant in typesof(/obj/item/implant/reagent_generator/egg)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/implant/reagent_generator/egg/implant_type = implant // CHOMPEdit - Removal of obj/item/weapon
...
/datum/gear/utility/saddlebag_common/lightweight
	...
	path = /obj/item/storage/backpack/saddlebag_common/lightweight // CHOMPEdit - Removal of obj/item/weapon
	slot = slot_back
	cost = 2

/datum/gear/utility/saddlebag_common/robust/lightweight
	display_name = "saddle bag, robust (Light)"
	path = /obj/item/storage/backpack/saddlebag_common/robust/lightweight // CHOMPEdit - Removal of obj/item/weapon
	slot = slot_back
	cost = 2

/datum/gear/utility/saddlebag_common/vest/heavy
	display_name = "taur duty vest (backpack) (Heavy)"
	path = /obj/item/storage/backpack/saddlebag_common/vest/heavy // CHOMPEdit - Removal of obj/item/weapon
	slot = slot_back
	cost = 1
