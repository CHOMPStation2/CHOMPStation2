...
||||||| parent of 0d2ef39861... Merge pull request #11089 from VOREStation/Arokha/langinvestigation
...
=======
		if(pref.alternate_languages.len > S.num_alternate_languages)
			...
			pref.alternate_languages.len = S.num_alternate_languages // Truncate to allowed length
>>>>>>> 0d2ef39861... Merge pull request #11089 from VOREStation/Arokha/langinvestigation
