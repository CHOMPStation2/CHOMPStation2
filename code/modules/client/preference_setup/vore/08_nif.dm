...
/datum/preferences
	var/obj/item/nif/nif_path // CHOMPEdit - Removal of obj/item/device
	var/nif_durability
...
/datum/category_item/player_setup_item/vore/nif/sanitize_character()
	...
	if (ispath(pref.nif_path, /obj/item/nif/protean) && pref.species != SPECIES_PROTEAN) //no free nifs // CHOMPEdit - Removal of obj/item/device
		pref.nif_path = null
