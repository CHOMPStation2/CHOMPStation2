...
//	S["auto_backup_implant"]	>> pref.auto_backup_implant //CHOMPedit: Commented out toggling implants for transcore performance test.
...
//	pref.auto_backup_implant		= sanitize_integer(pref.auto_backup_implant, 0, 1, initial(pref.auto_backup_implant)) // CHOMPedit: Commented out toggling implants for transcore performance test.
...
//	. += "<b>Spawn With Backup Implant:</b> <a [pref.auto_backup_implant ? "class='linkOn'" : ""] href='?src=\ref[src];toggle_implant=1'><b>[pref.auto_backup_implant ? "Yes" : "No"]</b></a><br>" // CHOMPedit: Commented out toggling implants for transcore performance test.
...
/datum/category_item/player_setup_item/vore/misc/OnTopic(var/href, var/list/href_list, var/mob/user)
	...
	// CHOMPStation Edit End: Directory Update
		...
		return TOPIC_REFRESH
	//CHOMPedit: Commented out toggling implants for transcore performance test.
