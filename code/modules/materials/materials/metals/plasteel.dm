...
/datum/material/plasteel/generate_recipes()
	...
	recipes += list(
		...
		new /datum/stack_recipe("knife grip", /obj/item/material/butterflyhandle, 4, time = 20, one_per_turf = 0, on_floor = 1, supplied_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		...
		new /datum/stack_recipe("whetstone", /obj/item/whetstone, 2, time = 10, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
