...
/datum/material/steel/generate_recipes()
	...
	recipes += list(
		...
		new /datum/stack_recipe("cannon frame", /obj/item/cannonframe, 10, time = 15, one_per_turf = 0, on_floor = 0, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		...
		new /datum/stack_recipe("grenade casing", /obj/item/grenade/chem_grenade, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		...
		new /datum/stack_recipe("desk bell", /obj/item/deskbell, 1, on_floor = 1, supplied_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
