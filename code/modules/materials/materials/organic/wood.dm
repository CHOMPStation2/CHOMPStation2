...
/datum/material/wood/generate_recipes()
	..()
	recipes += list(
		new /datum/stack_recipe("oar", /obj/item/oar, 2, time = 30, supplied_material = "[name]", pass_stack_color = TRUE), // CHOMPEdit - Removal of obj/item/weapon
		...
		new /datum/stack_recipe("clipboard", /obj/item/clipboard, 1, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		...
		new /datum/stack_recipe("crossbow frame", /obj/item/crossbowframe, 5, time = 25, one_per_turf = 0, on_floor = 0, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		...
		new /datum/stack_recipe("coilgun stock", /obj/item/coilgun_assembly, 5, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("crude fishing rod", /obj/item/material/fishing_rod/built, 8, time = 10 SECONDS, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		...
		new /datum/stack_recipe("shovel", /obj/item/shovel/wood, 2, time = 10, on_floor = TRUE, supplied_material = "[name]") // CHOMPEdit - Removal of obj/item/weapon
	)
