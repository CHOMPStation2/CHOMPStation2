...
/datum/material/leather/generate_recipes()
	recipes = list(
		...
		new /datum/stack_recipe("pouch, medium", /obj/item/storage/pouch, 10, time = 20 SECONDS, pass_stack_color = FALSE, recycle_material = "[name]"), //vorestation Add // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("pouch, large", /obj/item/storage/pouch/large, 15, time = 30 SECONDS, pass_stack_color = FALSE, recycle_material = "[name]"), //vorestation Add // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("pouch, holster", /obj/item/storage/pouch/holster, 10, time = 20 SECONDS, pass_stack_color = FALSE, recycle_material = "[name]"), //vorestation Add // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("pouch, melee", /obj/item/storage/pouch/baton, 10, time = 20 SECONDS, pass_stack_color = FALSE, recycle_material = "[name]"), //vorestation Add // CHOMPEdit - Removal of obj/item/weapon
		...
		new /datum/stack_recipe("[display_name] net", /obj/item/material/fishing_net, 10, time = 5 SECONDS, supplied_material = "[name]", pass_stack_color = TRUE), // CHOMPEdit - Removal of obj/item/weapon
		...
		new /datum/stack_recipe("whip", /obj/item/material/whip, 5, time = 15 SECONDS, pass_stack_color = TRUE, supplied_material = "[name]") // CHOMPEdit - Removal of obj/item/weapon
	)