...
/datum/material/resin/generate_recipes()
	recipes = list(
		new /datum/stack_recipe_list("Resin Specific Construction",list(
			...
			// new /datum/stack_recipe("[display_name] wall girders", /obj/structure/girder/resin, 2, time = 5 SECONDS, one_per_turf = 1, on_floor = 1, supplied_material = "[name]", pass_stack_color = TRUE), // CHOMPRemove
			...
			new /datum/stack_recipe("[display_name] net", /obj/item/material/fishing_net, 1, time = 5 SECONDS, supplied_material = "[name]", pass_stack_color = TRUE), // CHOMPedit: Reduced material cost.
			...
			// new /datum/stack_recipe("[display_name] node", /obj/effect/alien/weeds/node, 1, time = 4 SECONDS, recycle_material = "[name]") // CHOMPRemove
		))
	)
