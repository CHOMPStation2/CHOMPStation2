...
/datum/material/plastic/generate_recipes()
	...
	recipes += list(
		...
		new /datum/stack_recipe("plastic bag", /obj/item/storage/bag/plasticbag, 3, on_floor = 1, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("blood pack", /obj/item/reagent_containers/blood/empty, 4, on_floor = 0, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("reagent dispenser cartridge (large)", /obj/item/reagent_containers/chem_disp_cartridge,        5, on_floor=0, pass_stack_color = TRUE, recycle_material = "[name]"), // 500u // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("reagent dispenser cartridge (med)",   /obj/item/reagent_containers/chem_disp_cartridge/medium, 3, on_floor=0, pass_stack_color = TRUE, recycle_material = "[name]"), // 250u // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("reagent dispenser cartridge (small)", /obj/item/reagent_containers/chem_disp_cartridge/small,  1, on_floor=0, pass_stack_color = TRUE, recycle_material = "[name]"), // 100u // CHOMPEdit - Removal of obj/item/weapon
		...
		new /datum/stack_recipe("lampshade", /obj/item/lampshade, 1, time = 1, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("plastic net", /obj/item/material/fishing_net, 25, time = 1 MINUTE, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
...
/datum/material/cardboard/generate_recipes()
	..()
	recipes += list(
		new /datum/stack_recipe("box", /obj/item/storage/box, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("donut box", /obj/item/storage/box/donut/empty, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("egg box", /obj/item/storage/fancy/egg_box, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("light tubes box", /obj/item/storage/box/lights/tubes, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("light bulbs box", /obj/item/storage/box/lights/bulbs, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("mouse traps box", /obj/item/storage/box/mousetraps, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		...
		new /datum/stack_recipe_list("folders",list(
			new /datum/stack_recipe("blue folder", /obj/item/folder/blue, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
			new /datum/stack_recipe("grey folder", /obj/item/folder, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
			new /datum/stack_recipe("red folder", /obj/item/folder/red, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
			new /datum/stack_recipe("white folder", /obj/item/folder/white, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
			new /datum/stack_recipe("yellow folder", /obj/item/folder/yellow, recycle_material = "[name]") // CHOMPEdit - Removal of obj/item/weapon
		))
	)
