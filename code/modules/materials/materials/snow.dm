...
/datum/material/snow/generate_recipes()
	recipes = list(
		new /datum/stack_recipe("snowball", /obj/item/material/snow/snowball, 1, time = 10, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
...
/datum/material/snowbrick/generate_recipes()
	recipes = list(
		...
		new /datum/stack_recipe("[display_name] stool", /obj/item/stool, one_per_turf = 1, on_floor = 1, supplied_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		...
		new /datum/stack_recipe("[display_name] ashtray", /obj/item/material/ashtray, 2, one_per_turf = 1, on_floor = 1, supplied_material = "[name]") // CHOMPEdit - Removal of obj/item/weapon
	)