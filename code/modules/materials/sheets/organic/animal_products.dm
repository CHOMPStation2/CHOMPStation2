...
/datum/material/fur/generate_recipes()
	recipes = list(
		...
		new /datum/stack_recipe("bedsheet", /obj/item/bedsheet/craftable, 10, time = 30 SECONDS, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		...
		new /datum/stack_recipe("belt pouch", /obj/item/storage/belt/fannypack/white/craftable, 25, time = 1 MINUTE, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("pouch, small", /obj/item/storage/pouch/small, 10, time = 20 SECONDS, pass_stack_color = FALSE, recycle_material = "[name]"), //vorestation Add // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("pouch, ammo", /obj/item/storage/pouch/ammo, 10, time = 20 SECONDS, pass_stack_color = FALSE, recycle_material = "[name]"), //vorestation Add // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("pouch, tools", /obj/item/storage/pouch/eng_tool, 10, time = 20 SECONDS, pass_stack_color = FALSE, recycle_material = "[name]"), //vorestation Add // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("pouch, parts", /obj/item/storage/pouch/eng_parts, 10, time = 20 SECONDS, pass_stack_color = FALSE, recycle_material = "[name]"), //vorestation Add // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("pouch, supplies", /obj/item/storage/pouch/eng_supply, 10, time = 20 SECONDS, pass_stack_color = FALSE, recycle_material = "[name]"), //vorestation Add // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("pouch, medical", /obj/item/storage/pouch/medical, 10, time = 20 SECONDS, pass_stack_color = FALSE, recycle_material = "[name]"), //vorestation Add // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("pouch, flare", /obj/item/storage/pouch/flares, 10, time = 20 SECONDS, pass_stack_color = FALSE, recycle_material = "[name]"), //vorestation Add // CHOMPEdit - Removal of obj/item/weapon
		...
		new /datum/stack_recipe("satchel", /obj/item/storage/backpack/satchel/craftable, 30, time = 1 MINUTE, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
		new /datum/stack_recipe("backpack", /obj/item/storage/backpack/craftable, 30, time = 1 MINUTE, pass_stack_color = TRUE, recycle_material = "[name]"), // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/bedsheet/craftable // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/clothing/under/pants/baggy/white/craftable
	name = "handmade pants"
/obj/item/storage/belt/fannypack/white/craftable // CHOMPEdit - Removal of obj/item/weapon
	name = "handmade fannypack"
/obj/item/storage/backpack/satchel/craftable // CHOMPEdit - Removal of obj/item/weapon
	name = "handmade satchel"
	icon_state = "satchel_white"
	desc = "A handmade satchel, made for holding your things!"
/obj/item/storage/backpack/craftable // CHOMPEdit - Removal of obj/item/weapon
