...
/obj/item/sample/New(var/newloc, var/atom/supplied) // CHOMPEdit - Removal of obj/item/weapon
	..(newloc)
	if(supplied)
		copy_evidence(supplied)
		name = "[initial(name)] (\the [supplied])"

/obj/item/sample/print/New(var/newloc, var/atom/supplied) // CHOMPEdit - Removal of obj/item/weapon
	..(newloc, supplied)
	if(evidence && evidence.len)
		icon_state = "fingerprint1"

/obj/item/sample/proc/copy_evidence(var/atom/supplied) // CHOMPEdit - Removal of obj/item/weapon
	if(supplied.suit_fibers && supplied.suit_fibers.len)
		evidence = supplied.suit_fibers.Copy()
		supplied.suit_fibers.Cut()

/obj/item/sample/proc/merge_evidence(var/obj/item/sample/supplied, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/sample/print/merge_evidence(var/obj/item/sample/supplied, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!supplied.evidence || !supplied.evidence.len)
		return 0
...
/obj/item/sample/attackby(var/obj/O, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(O.type == src.type)
		user.unEquip(O)
...
/obj/item/sample/fibers // CHOMPEdit - Removal of obj/item/weapon
	name = "fiber bag"
	desc = "Used to hold fiber evidence for the detective."
	icon_state = "fiberbag"

/obj/item/sample/print // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/sample/print/attack_self(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(evidence && evidence.len)
		return
	if(!ishuman(user))
		return
...
/obj/item/sample/print/attack(var/mob/living/M, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/sample/print/copy_evidence(var/atom/supplied) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/forensics/sample_kit // CHOMPEdit - Removal of obj/item/weapon
	...
	var/evidence_path = /obj/item/sample/fibers // CHOMPEdit - Removal of obj/item/weapon

/obj/item/forensics/sample_kit/proc/can_take_sample(var/mob/user, var/atom/supplied) // CHOMPEdit - Removal of obj/item/weapon
	return (supplied.suit_fibers && supplied.suit_fibers.len)

/obj/item/forensics/sample_kit/proc/take_sample(var/mob/user, var/atom/supplied) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/sample/S = new evidence_path(get_turf(user), supplied) // CHOMPEdit - Removal of obj/item/weapon
	to_chat(user, "<span class='notice'>You transfer [S.evidence.len] [S.evidence.len > 1 ? "[evidence_type]s" : "[evidence_type]"] to \the [S].</span>")

/obj/item/forensics/sample_kit/afterattack(var/atom/A, var/mob/user, var/proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!proximity)
		return
...
/obj/item/forensics/sample_kit/powder // CHOMPEdit - Removal of obj/item/weapon
	...
	evidence_path = /obj/item/sample/print // CHOMPEdit - Removal of obj/item/weapon

/obj/item/forensics/sample_kit/powder/can_take_sample(var/mob/user, var/atom/supplied) // CHOMPEdit - Removal of obj/item/weapon
