...
/obj/item/detective_scanner/attack(mob/living/carbon/human/M as mob, mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	if (!ishuman(M))
	...
	if(reveal_fingerprints)
		if((!( istype(M.dna, /datum/dna) ) || M.gloves))
			...
			var/obj/item/sample/print/P = new /obj/item/sample/print(user.loc) // CHOMPEdit - Removal of obj/item/weapon
			P.attack(M, user)
...
/obj/item/detective_scanner/afterattack(atom/A as obj|turf, mob/user, proximity) // CHOMPEdit - Removal of obj/item/device
	if(!proximity) return
	if(ismob(A))
		return
...
*/
	...
	if(istype(A,/obj/item/sample/print)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/detective_scanner/proc/add_data(atom/A as mob|obj|turf|area) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/detective_scanner/verb/examine_data() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/detective_scanner/proc/display_data(var/mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/detective_scanner/verb/wipe() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/detective_scanner/advanced // CHOMPEdit - Removal of obj/item/device
