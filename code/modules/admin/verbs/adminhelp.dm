...
/client/verb/adminhelp(msg as text)
	...
	//YW EDIT START
	SERVER_TOOLS_RELAY_BROADCAST("ADMINHELP: FROM: [key_name(src)] - MSG: **[strip_html_properly(original_msg)]** - Heard by [admins.len-admin_number_afk] NON-AFK staff members.")
	//YW EDIT END
	return
