...
/client/proc/simple_DPS()
	...
	if(isliving(usr))
		...
		if(istype(I, /obj/item/gun)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/gun/G = I // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/projectile/P

			if(istype(I, /obj/item/gun/energy)) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/gun/energy/energy_gun = G // CHOMPEdit - Removal of obj/item/weapon
				P = new energy_gun.projectile_type()

			else if(istype(I, /obj/item/gun/projectile)) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/gun/projectile/projectile_gun = G // CHOMPEdit - Removal of obj/item/weapon
...
/client/proc/makepAI()
	...
	if(!choice)
		return 0
	var/obj/item/paicard/typeb/card = new(T) // CHOMPEdit - Removal of obj/item/device
...
/client/proc/cmd_admin_grantfullaccess(var/mob/M in mob_list)
	...
	if (istype(M, /mob/living/carbon/human))
		...
		if (H.wear_id)
			var/obj/item/card/id/id = H.wear_id // CHOMPEdit - Removal of obj/item/weapon
			if(istype(H.wear_id, /obj/item/pda)) // CHOMPEdit - Removal of obj/item/device
				var/obj/item/pda/pda = H.wear_id // CHOMPEdit - Removal of obj/item/device
				id = pda.id
			id.icon_state = "gold"
			id.access = get_all_accesses().Copy()
		else
			var/obj/item/card/id/id = new/obj/item/card/id(M); // CHOMPEdit - Removal of obj/item/weapon
			id.icon_state = "gold"
			id.access = get_all_accesses().Copy()
...
/client/proc/cmd_admin_areatest()
	...
	for(var/obj/item/radio/intercom/I in machines) // CHOMPEdit - Removal of obj/item/device
...
/client/proc/startSinglo()
	...
	for(var/obj/machinery/power/rad_collector/Rad in machines)
		if(Rad.anchored)
			if(!Rad.P)
				var/obj/item/tank/phoron/Phoron = new/obj/item/tank/phoron(Rad) // CHOMPEdit - Removal of obj/item/weapon
