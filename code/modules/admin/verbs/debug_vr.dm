/datum/admins/proc/quick_nif()
	...
	if(H.species.flags & NO_SCAN)
		var/obj/item/nif/S = /obj/item/nif/bioadap // CHOMPEdit - Removal of obj/item/device
		input_NIF = initial(S.name)
		new /obj/item/nif/bioadap(H) // CHOMPEdit - Removal of obj/item/device
	else
		var/list/NIF_types = typesof(/obj/item/nif) // CHOMPEdit - Removal of obj/item/device
		var/list/NIFs = list()

		for(var/NIF_type in NIF_types)
			var/obj/item/nif/S = NIF_type // CHOMPEdit - Removal of obj/item/device
		...
		if(chosen_NIF)
			...
			new /obj/item/nif(H) // CHOMPEdit - Removal of obj/item/device
