...
//Regular jobs
	...
	//JOBBAN'S INNARDS
		...
		H.equip_to_slot_or_del( new /obj/item/reagent_containers/food/snacks/cookie(H), slot_l_hand ) // CHOMPEdit - Removal of obj/item/weapon
		if(!(istype(H.l_hand,/obj/item/reagent_containers/food/snacks/cookie))) // CHOMPEdit - Removal of obj/item/weapon
			H.equip_to_slot_or_del( new /obj/item/reagent_containers/food/snacks/cookie(H), slot_r_hand ) // CHOMPEdit - Removal of obj/item/weapon
			if(!(istype(H.r_hand,/obj/item/reagent_containers/food/snacks/cookie))) // CHOMPEdit - Removal of obj/item/weapon
		...
		if(!istype(H))
			to_chat(usr, "<span class='filter_adminlog'>This can only be used on instances of type /mob/living/carbon/human</span>")
			return
		if(!istype(H.l_ear, /obj/item/radio/headset) && !istype(H.r_ear, /obj/item/radio/headset)) // CHOMPEdit - Removal of obj/item/device
		...
		if (istype(fax, /obj/item/paper)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/paper/P = fax // CHOMPEdit - Removal of obj/item/weapon
			P.show_content(usr,1)
		else if (istype(fax, /obj/item/photo)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/photo/H = fax // CHOMPEdit - Removal of obj/item/weapon
			H.show(usr)
		else if (istype(fax, /obj/item/paper_bundle)) // CHOMPEdit - Removal of obj/item/weapon
			//having multiple people turning pages on a paper_bundle can cause issues
			//open a browse window listing the contents instead
			var/data = ""
			var/obj/item/paper_bundle/B = fax // CHOMPEdit - Removal of obj/item/weapon
		...
		var/obj/item/paper_bundle/bundle = locate(href_list["paper_bundle"]) // CHOMPEdit - Removal of obj/item/weapon

		if (!bundle) return

		if (istype(bundle.pages[page], /obj/item/paper)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/paper/P = bundle.pages[page] // CHOMPEdit - Removal of obj/item/weapon
			P.show_content(src.owner, 1)
		else if (istype(bundle.pages[page], /obj/item/photo)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/photo/H = bundle.pages[page] // CHOMPEdit - Removal of obj/item/weapon
			H.show(src.owner)
		return
		...
		var/obj/item/paper/admin/P = new /obj/item/paper/admin( null ) //hopefully the null loc won't cause trouble for us // CHOMPEdit - Removal of obj/item/weapon
		faxreply = P
		...
		for(var/dirty_path in dirty_paths)
			...
			if(!path)
				...
				removed_paths += dirty_path
				continue
			else if(ispath(path, /obj/item/gun/energy/pulse_rifle)) // CHOMPEdit - Removal of obj/item/weapon
				if(!check_rights(R_FUN,0))
					removed_paths += dirty_path
					continue
			else if(ispath(path, /obj/item/melee/energy/blade))//Not an item one should be able to spawn./N // CHOMPEdit - Removal of obj/item/weapon
				if(!check_rights(R_FUN,0))
					removed_paths += dirty_path
					continue
...
/mob/living/carbon/human/can_centcom_reply()
	return istype(l_ear, /obj/item/radio/headset) || istype(r_ear, /obj/item/radio/headset) // CHOMPEdit - Removal of obj/item/device
