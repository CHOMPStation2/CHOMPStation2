...
/datum/admins/var/obj/item/paper/admin/faxreply // var to hold fax replies in // CHOMPEdit - Removal of obj/item/weapon

/datum/admins/proc/faxCallback(var/obj/item/paper/admin/P, var/obj/machinery/photocopier/faxmachine/destination) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(shouldStamp)
		...
		if(!P.stamped)
			P.stamped = new
		P.stamped += /obj/item/stamp/centcomm // CHOMPEdit - Removal of obj/item/weapon
