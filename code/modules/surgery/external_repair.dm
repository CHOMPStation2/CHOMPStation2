...
/datum/surgery_step/repairflesh/scan_injury
	...
	allowed_tools = list(
	/obj/item/autopsy_scanner = 100, // CHOMPEdit - Removal of obj/item/weapon
	/obj/item/analyzer = 10 // CHOMPEdit - Removal of obj/item/device
	)
...
/datum/surgery_step/repairflesh/repair_burns
	...
	/obj/item/tape_roll = 30, // CHOMPEdit - Removal of obj/item/weapon
...
/datum/surgery_step/repairflesh/repair_burns/begin_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	if(istype(tool, /obj/item/tape_roll) || istype(tool, /obj/item/taperoll)) // CHOMPEdit - Removal of obj/item/weapon
	...
	else if(istype(tool, /obj/item/surgical/hemostat) || istype(tool, /obj/item/surgical/FixOVein)) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/surgery_step/repairflesh/repair_brute
	...
	/obj/item/tape_roll = 40, // CHOMPEdit - Removal of obj/item/weapon
	/obj/item/taperoll = 10
	)
...
/datum/surgery_step/repairflesh/repair_brute/begin_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	"<span class='notice'>You begin taping up [target]'s [affected] with \the [tool].</span>")
		...
		affected.jostle_bone(10)
	else if(istype(tool, /obj/item/surgical/FixOVein) || istype(tool, /obj/item/surgical/bonesetter)) // CHOMPEdit - Removal of obj/item/weapon
