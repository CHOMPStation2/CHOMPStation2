...
/datum/surgery_step/generic/ripper/can_use(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/surgical/scalpel/ripper/tool) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/surgery_step/generic/ripper/tear_vessel
	...
	allowed_tools = list(
	/obj/item/surgical/scalpel/ripper = 100 // CHOMPEdit - Removal of obj/item/weapon
	)
