...
/datum/surgery_step/brainstem/mend_vessels
	...
	priority = 1
	allowed_tools = list(
		/obj/item/surgical/FixOVein = 100, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/stack/cable_coil = 40,
		/obj/item/assembly/mousetrap = 5) // CHOMPEdit - Removal of obj/item/device
...
/datum/surgery_step/brainstem/drill_vertebrae
	...
	allowed_tools = list(
		/obj/item/surgical/surgicaldrill = 100, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/melee/changeling/arm_blade = 15, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/pickaxe = 5 // CHOMPEdit - Removal of obj/item/weapon
	)
...
/datum/surgery_step/brainstem/clean_chips
	...
	allowed_tools = list(
		/obj/item/surgical/hemostat = 100, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/melee/changeling/claw = 40) //Surprisingly, claws are kind of okay at picking things out. // CHOMPEdit - Removal of obj/item/weapon
...
/datum/surgery_step/brainstem/mend_vertebrae
	...
	allowed_tools = list(
		/obj/item/surgical/bonegel = 100, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/stack/nanopaste = 50,
		/obj/item/tape_roll = 5) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/surgery_step/brainstem/realign_tissue
	...
	allowed_tools = list(
		/obj/item/surgical/hemostat = 100, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/melee/changeling/claw = 20) //Claws. Good for digging, not so much for moving. // CHOMPEdit - Removal of obj/item/weapon
