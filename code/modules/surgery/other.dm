...
/datum/surgery_step/treat_necrosis
	...
	priority = 2
	allowed_tools = list(
		/obj/item/reagent_containers/dropper = 100, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/reagent_containers/glass/bottle = 75, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/reagent_containers/glass/beaker = 75, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/reagent_containers/spray = 50, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/reagent_containers/glass/bucket = 50, // CHOMPEdit - Removal of obj/item/weapon
	)
...
/datum/surgery_step/treat_necrosis/can_use(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	if (!istype(tool, /obj/item/reagent_containers)) // CHOMPEdit - Removal of obj/item/weapon
		return 0

	var/obj/item/reagent_containers/container = tool // CHOMPEdit - Removal of obj/item/weapon
...
/datum/surgery_step/hardsuit
	...
	allowed_tools = list(
		/obj/item/weldingtool = 80, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/surgical/circular_saw = 60, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/pickaxe/plasmacutter = 100 // CHOMPEdit - Removal of obj/item/weapon
		)
	req_open = 0
...
/datum/surgery_step/hardsuit/can_use(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	if(!istype(target))
		return 0
	if(istype(tool,/obj/item/weldingtool)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/weldingtool/welder = tool // CHOMPEdit - Removal of obj/item/weapon
		if(!welder.isOn() || !welder.remove_fuel(1,user))
			return 0
	return (target_zone == BP_TORSO) && ((istype(target.back, /obj/item/rig) && !(target.back.canremove)) || (istype(target.belt, /obj/item/rig) && !(target.belt.canremove))) // CHOMPEdit - Removal of obj/item/weapon

/datum/surgery_step/hardsuit/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	var/obj/item/rig/rig = target.back // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(rig))
		rig = target.belt
		if(!istype(rig))
			return
...
/datum/surgery_step/dehusk/structinitial
	...
	allowed_tools = list(
		/obj/item/surgical/bioregen = 100 // CHOMPEdit - Removal of obj/item/weapon
	)
...
/datum/surgery_step/dehusk/structfinish
	...
	allowed_tools = list(
		...
		/obj/item/surgical/FixOVein = 30 // CHOMPEdit - Removal of obj/item/weapon
	)
	min_duration = 60 //CHOMPedit
	max_duration = 60 //CHOMPedit
...
/datum/surgery_step/dehusk/structfinish/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	if(istype(tool,/obj/item/surgical/bioregen)) // CHOMPEdit - Removal of obj/item/weapon
	...
	else if(istype(tool,/obj/item/surgical/FixOVein)) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/surgery_step/internal/detoxify
	...
	blood_level = 1
	allowed_tools = list(/obj/item/surgical/bioregen=100) // CHOMPEdit - Removal of obj/item/weapon
	min_duration = 40 //CHOMPedit
	max_duration = 40 //CHOMPedit
