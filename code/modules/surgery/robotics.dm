...
/datum/surgery_step/robotics/unscrew_hatch
	...
	allowed_tools = list(
		/obj/item/coin = 50, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/material/knife = 50 // CHOMPEdit - Removal of obj/item/weapon
	)
...
/datum/surgery_step/robotics/open_hatch
	...
	allowed_tools = list(
		...
		/obj/item/material/kitchen/utensil = 50 // CHOMPEdit - Removal of obj/item/weapon
	)
...
/datum/surgery_step/robotics/repair_brute
	...
	allowed_tools = list(
		/obj/item/weldingtool = 100, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/pickaxe/plasmacutter = 50 // CHOMPEdit - Removal of obj/item/weapon
	)
...
/datum/surgery_step/robotics/detatch_organ_robotic
	...
	allowed_tools = list(
	/obj/item/multitool = 100 // CHOMPEdit - Removal of obj/item/device
	)
...
/datum/surgery_step/robotics/install_mmi
	...
	allowed_tools = list(
	/obj/item/mmi = 100 // CHOMPEdit - Removal of obj/item/device
	)
...
/datum/surgery_step/robotics/install_mmi/can_use(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	var/obj/item/mmi/M = tool // CHOMPEdit - Removal of obj/item/device
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/install_nymph
	...
	allowed_tools = list(
	/obj/item/holder/diona = 100 // CHOMPEdit - Removal of obj/item/weapon
	)
...
/datum/surgery_step/robotics/install_nymph/can_use(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	var/obj/item/holder/diona/N = tool // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
