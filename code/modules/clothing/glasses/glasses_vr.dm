...
//Prescription kit
/obj/item/glasses_kit // CHOMPEdit - Removal of obj/item/device
...
/obj/item/glasses_kit/afterattack(var/target, var/mob/living/carbon/human/user, var/proximity) // CHOMPEdit - Removal of obj/item/device
	if(!proximity)
		return
	if(!istype(user))
		return
