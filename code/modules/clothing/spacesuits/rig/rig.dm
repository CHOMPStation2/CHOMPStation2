...
/obj/item/rig // CHOMPEdit - Removal of obj/item/weapon
	...
	var/cell_type =  /obj/item/cell/high // CHOMPEdit - Removal of obj/item/weapon
	var/air_type =   /obj/item/tank/oxygen // CHOMPEdit - Removal of obj/item/weapon


	//Component/device holders.
	var/obj/item/tank/air_supply                       // Air tank, if any. // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/cell/cell                             // Power supply, if any. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	...
	if(glove_type)
		...
		verbs |= /obj/item/rig/proc/toggle_gauntlets // CHOMPEdit - Removal of obj/item/weapon
	if(helm_type)
		helmet = new helm_type(src)
		verbs |= /obj/item/rig/proc/toggle_helmet // CHOMPEdit - Removal of obj/item/weapon
	if(boot_type)
		boots = new boot_type(src)
		verbs |= /obj/item/rig/proc/toggle_boots // CHOMPEdit - Removal of obj/item/weapon
	if(chest_type)
		chest = new chest_type(src)
		if(allowed)
			chest.allowed = allowed
		verbs |= /obj/item/rig/proc/toggle_chest // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/Destroy() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(wearer)
...
/obj/item/rig/Moved(old_loc, direction, forced) // CHOMPEdit - Removal of obj/item/weapon
	if(ismob(loc))
...
/obj/item/rig/get_worn_icon_file(var/body_type,var/slot_name,var/default_icon,var/inhands) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/proc/suit_is_deployed() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/proc/update_airtight(var/obj/item/piece, var/seal = 0) // CHOMPEdit - Removal of obj/item/weapon
	if(seal == 1)
...
/obj/item/rig/proc/reset() // CHOMPEdit - Removal of obj/item/weapon
	offline = 2
	canremove = TRUE
...
/obj/item/rig/proc/cut_suit() // CHOMPEdit - Removal of obj/item/weapon
	offline = 2
	canremove = TRUE
...
/obj/item/rig/proc/toggle_seals(var/mob/living/carbon/human/M,var/instant) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/proc/update_component_sealed() // CHOMPEdit - Removal of obj/item/weapon
	for(var/obj/item/piece in list(helmet,boots,gloves,chest))
		if(canremove)
			update_airtight(piece, 0) // Unseal
		else
...
/obj/item/rig/ui_action_click() // CHOMPEdit - Removal of obj/item/weapon
	toggle_cooling(usr)

/obj/item/rig/proc/toggle_cooling(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(cooling_on)
		turn_cooling_off(user)
	else
		turn_cooling_on(user)

/obj/item/rig/proc/turn_cooling_on(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!cell)
		return
	if(cell.charge <= 0)
...
/obj/item/rig/proc/turn_cooling_off(var/mob/user, var/failed) // CHOMPEdit - Removal of obj/item/weapon
	if(failed)
...
/obj/item/rig/proc/get_environment_temperature() // CHOMPEdit - Removal of obj/item/weapon
	if (ishuman(loc))
...
/obj/item/rig/proc/attached_to_user(mob/M) // CHOMPEdit - Removal of obj/item/weapon
	if (!ishuman(M))
		return 0
...
/obj/item/rig/proc/coolingProcess() // CHOMPEdit - Removal of obj/item/weapon
	if (!cooling_on || !cell)
		return
...
/obj/item/rig/process() // CHOMPEdit - Removal of obj/item/weapon
	// Not on a mob...?
	if(!ismob(loc))
	...
	if(!istype(wearer) || loc != wearer || (wearer.back != src && wearer.belt != src) || canremove || !cell || cell.charge <= 0)
		...
		if(offline)
			...
			if(!istype(src,/obj/item/rig/protean))	//CHOMPEdit - Stupid snowflake protean special check for rig assimilation code // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/proc/check_power_cost(var/mob/living/user, var/cost, var/use_unconcious, var/obj/item/rig_module/mod, var/user_is_ai) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/update_icon(var/update_mob_icon) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/proc/check_suit_access(var/mob/living/carbon/human/user, var/do_message = TRUE) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/proc/notify_ai(var/message) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/equipped(mob/living/carbon/human/M) // CHOMPEdit - Removal of obj/item/weapon
	..()

	if(istype(M.back, /obj/item/rig) && istype(M.belt, /obj/item/rig)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/proc/toggle_piece(var/piece, var/mob/living/carbon/human/H, var/deploy_mode, var/forced = FALSE) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/proc/deploy(mob/M,var/sealed) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/dropped(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..()
	for(var/piece in list("helmet","gauntlets","chest","boots"))
...
//Todo
/obj/item/rig/proc/malfunction() // CHOMPEdit - Removal of obj/item/weapon
	return 0

/obj/item/rig/emp_act(severity_class) // CHOMPEdit - Removal of obj/item/weapon
	//set malfunctioning
...
/obj/item/rig/proc/shock(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/proc/take_hit(damage, source, is_emp=0) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/proc/malfunction_check(var/mob/living/carbon/human/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/proc/ai_can_move_suit(var/mob/user, var/check_user_module = 0, var/check_for_ai = 0) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/proc/force_rest(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!ai_can_move_suit(user, check_user_module = 1))
		return
	wearer.lay_down()
	to_chat(user, "<span class='notice'>\The [wearer] is now [wearer.resting ? "resting" : "getting up"].</span>")

/obj/item/rig/proc/forced_move(var/direction, var/mob/user, var/ai_moving = TRUE) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/get_rig() // CHOMPEdit - Removal of obj/item/weapon
	return src

/mob/living/carbon/human/get_rig()
	if(istype(back, /obj/item/rig)) // CHOMPEdit - Removal of obj/item/weapon
		return back
	else if(istype(belt, /obj/item/rig)) // CHOMPEdit - Removal of obj/item/weapon
		return belt
	else
		return null
