...
/obj/item/rig_module/datajack/accepts_item(var/obj/item/input_device, var/mob/living/user)
	...
	if(istype(input_device,/obj/item/disk/tech_disk)) // CHOMPEdit - Removal of obj/item/weapon
		to_chat(user, "You slot the disk into [src].")
		var/obj/item/disk/tech_disk/disk = input_device // CHOMPEdit - Removal of obj/item/weapon
		if(disk.stored)
