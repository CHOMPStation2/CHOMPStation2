...
/obj/item/rig_module/proc/installed(var/obj/item/rig/new_holder) // CHOMPEdit - Removal of obj/item/weapon
	holder = new_holder
	return
...
/mob/living/carbon/human/Stat()
	...
	if(. && istype(back,/obj/item/rig)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/rig/R = back // CHOMPEdit - Removal of obj/item/weapon
		SetupStat(R)

	else if(. && istype(belt,/obj/item/rig)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/rig/R = belt // CHOMPEdit - Removal of obj/item/weapon
		SetupStat(R)

/mob/proc/SetupStat(var/obj/item/rig/R) // CHOMPEdit - Removal of obj/item/weapon
