/obj/item/clothing/head/helmet/space/void/refurb/sleeping_slug
	name = "sleeping slug crew voidsuit helmet"
...
/obj/item/clothing/suit/space/void/refurb/sleeping_slug
	name = "sleeping slug crew voidsuit"
...
/obj/item/clothing/head/helmet/space/void/refurb/engineering/sleeping_slug
	name = "sleeping slug engineering voidsuit helmet"
...
/obj/item/clothing/suit/space/void/refurb/engineering/sleeping_slug
	name = "sleeping slug engineering voidsuit"
	desc = "A refurbished early contact era voidsuit of human design. These things aren't especially good against modern weapons but they're sturdy, incredibly easy to come by, and there are lots of spare parts for repairs. This one in particular must be several decades old, but the insulation and radiation proofing are top-notch. The chestplate has a simple gear logo on it."

/obj/item/clothing/head/helmet/space/void/refurb/medical/sleeping_slug
	name = "sleeping slug medical voidsuit helmet"
	camera_networks = list(NETWORK_SLEEPING_SLUG_HELMETS)

/obj/item/clothing/head/helmet/space/void/refurb/medical/alt/sleeping_slug
	name = "sleeping slug medical voidsuit bubble helmet"
	camera_networks = list(NETWORK_SLEEPING_SLUG_HELMETS)

/obj/item/clothing/suit/space/void/refurb/medical/sleeping_slug
	name = "sleeping slug medical voidsuit"
...
/obj/item/clothing/head/helmet/space/void/refurb/pilot/alt/sleeping_slug
	name = "sleeping slug pilot voidsuit helmet"
	camera_networks = list(NETWORK_SLEEPING_SLUG_HELMETS)

/obj/item/clothing/suit/space/void/refurb/pilot/sleeping_slug
	name = "sleeping slug pilot voidsuit"

/obj/item/clothing/head/helmet/space/void/refurb/research/sleeping_slug
	name = "sleeping slug scientific voidsuit helmet"
	camera_networks = list(NETWORK_SLEEPING_SLUG_HELMETS)

/obj/item/clothing/head/helmet/space/void/refurb/research/alt/sleeping_slug
	name = "sleeping slug scientific voidsuit bubble helmet"
	camera_networks = list(NETWORK_SLEEPING_SLUG_HELMETS)

/obj/item/clothing/suit/space/void/refurb/research/sleeping_slug
	name = "sleeping slug scientific voidsuit"
