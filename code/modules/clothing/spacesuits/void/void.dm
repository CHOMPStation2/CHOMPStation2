...
/obj/item/clothing/suit/space/void
	...
	slowdown = 0.5
	armor = list(melee = 30, bullet = 5, laser = 20,energy = 5, bomb = 35, bio = 100, rad = 20)
	allowed = list(/obj/item/flashlight,/obj/item/tank,/obj/item/suit_cooling_unit,/obj/item/storage/backpack) //CHOMPedit: backpack // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	...
	var/obj/item/tank/tank = null              // Deployable tank, if any. // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/suit_cooling_unit/cooler = null// Cooling unit, for FBPs.  Cannot be installed alongside a tank. // CHOMPEdit - Removal of obj/item/device
...
/obj/item/clothing/suit/space/void/attackby(obj/item/W as obj, mob/user as mob)
	...
	if(istype(W,/obj/item/clothing/accessory) || istype(W, /obj/item/hand_labeler)) // CHOMPEdit - Removal of obj/item/weapon
		return ..()
	...
	if(W.has_tool_quality(TOOL_SCREWDRIVER))
		...
		if(tank)
		...
		else if(istype(W,/obj/item/tank/phoron)) // CHOMPEdit - Removal of obj/item/weapon
			...
			tank = W
		return
	else if(istype(W,/obj/item/suit_cooling_unit)) // CHOMPEdit - Removal of obj/item/device
		if(cooler)
