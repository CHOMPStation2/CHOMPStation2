...
/obj/item/clothing/gloves
	...
	var/wired = 0
	var/obj/item/cell/cell = 0 // CHOMPEdit - Removal of obj/item/weapon
...
/*/obj/item/clothing/gloves/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(W.has_tool_quality(TOOL_WIRECUTTER) || istype(W, /obj/item/scalpel)) // CHOMPEdit - Removal of obj/item/weapon
		if (clipped)
