...
/obj/item/clothing/shoes/orange
	name = "orange shoes"
	icon_state = "orange"
	var/obj/item/handcuffs/chained = null // CHOMPEdit - Removal of obj/item/weapon

/obj/item/clothing/shoes/orange/proc/attach_cuffs(var/obj/item/handcuffs/cuffs, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if (chained) return
...
/obj/item/clothing/shoes/orange/attackby(H as obj, mob/user as mob)
	..()
	if (istype(H, /obj/item/handcuffs)) // CHOMPEdit - Removal of obj/item/weapon
		attach_cuffs(H, user)
