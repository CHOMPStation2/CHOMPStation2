...
//**Chameleon Backpack**
//**********************
/obj/item/storage/backpack/chameleon // CHOMPEdit - Removal of obj/item/weapon
	name = "backpack"
	icon_state = "backpack"
...
/obj/item/storage/backpack/chameleon/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(!clothing_choices)
		var/blocked = list(src.type, /obj/item/storage/backpack/satchel/withwallet) // CHOMPEdit - Removal of obj/item/weapon
		clothing_choices = generate_chameleon_choices(/obj/item/storage/backpack, blocked) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/storage/backpack/chameleon/emp_act(severity) //Because we don't have psych for all slots right now but still want a downside to EMP.  In this case your cover's blown. // CHOMPEdit - Removal of obj/item/weapon
	name = "backpack"
...
/obj/item/storage/backpack/chameleon/verb/change(picked in clothing_choices) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/belt/chameleon // CHOMPEdit - Removal of obj/item/weapon
	name = "belt"
...
/obj/item/storage/belt/chameleon/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(!clothing_choices)
		clothing_choices = generate_chameleon_choices(/obj/item/storage/belt, list(src.type)) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/storage/belt/chameleon/emp_act(severity) //Because we don't have psych for all slots right now but still want a downside to EMP.  In this case your cover's blown. // CHOMPEdit - Removal of obj/item/weapon
	name = "belt"
...
/obj/item/storage/belt/chameleon/verb/change(picked in clothing_choices) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/chameleon/New() // CHOMPEdit - Removal of obj/item/weapon
	..()

	if(!gun_choices)
		gun_choices = list()
		for(var/gun_type in typesof(/obj/item/gun/) - src.type) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/gun/G = gun_type // CHOMPEdit - Removal of obj/item/weapon
			src.gun_choices[initial(G.name)] = gun_type
	return

/obj/item/gun/energy/chameleon/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/chameleon/emp_act(severity) // CHOMPEdit - Removal of obj/item/weapon
	name = "desert eagle"
...
/obj/item/gun/energy/chameleon/disguise(var/newtype) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/gun/copy = ..() // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/gun/G = copy // CHOMPEdit - Removal of obj/item/weapon
	if(istype(G))
...
/obj/item/gun/energy/chameleon/verb/change(picked in gun_choices) // CHOMPEdit - Removal of obj/item/weapon
