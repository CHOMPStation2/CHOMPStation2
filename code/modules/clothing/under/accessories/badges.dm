...
/obj/item/clothing/accessory/badge/holo/attackby(var/obj/item/O as obj, var/mob/user as mob)
	if(istype(O, /obj/item/card/id) || istype(O, /obj/item/pda)) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device

		var/obj/item/card/id/id_card = null // CHOMPEdit - Removal of obj/item/weapon

		if(istype(O, /obj/item/card/id)) // CHOMPEdit - Removal of obj/item/weapon
			id_card = O
		else
			var/obj/item/pda/pda = O // CHOMPEdit - Removal of obj/item/device
			id_card = pda.id
