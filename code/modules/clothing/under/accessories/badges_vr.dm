/obj/item/clothing/accessory/dosimeter
	...
	slot_flags = SLOT_TIE
	var/obj/item/dosimeter_film/current_film = null // CHOMPEdit - Removal of obj/item/weapon

/obj/item/clothing/accessory/dosimeter/New()
	..()
	current_film = new /obj/item/dosimeter_film(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/clothing/accessory/dosimeter/attackby(obj/item/I, mob/user)
	if(istype(I, /obj/item/dosimeter_film)) // CHOMPEdit - Removal of obj/item/weapon
		if(!current_film)
			user.drop_item()
			I.loc = src
			current_film = I
...
/obj/item/dosimeter_film // CHOMPEdit - Removal of obj/item/weapon
	name = "dosimeter film"
...
/obj/item/dosimeter_film/proc/update_state(var/tostate) // CHOMPEdit - Removal of obj/item/weapon
	icon_state = tostate
	update_icon()

/obj/item/paper/dosimeter_manual // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/box/dosimeter // CHOMPEdit - Removal of obj/item/weapon
	name = "dosimeter case"
	...
	storage_slots = 5
	can_hold = list(/obj/item/paper/dosimeter_manual, /obj/item/clothing/accessory/dosimeter, /obj/item/dosimeter_film) // CHOMPEdit - Removal of obj/item/weapon
	max_storage_space = (ITEMSIZE_COST_SMALL * 4) + (ITEMSIZE_COST_TINY * 1)
	w_class = ITEMSIZE_SMALL

/obj/item/storage/box/dosimeter/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	new /obj/item/paper/dosimeter_manual(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/clothing/accessory/dosimeter(src)
	new /obj/item/dosimeter_film(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/dosimeter_film(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/dosimeter_film(src) // CHOMPEdit - Removal of obj/item/weapon
