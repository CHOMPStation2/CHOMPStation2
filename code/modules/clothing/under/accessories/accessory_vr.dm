...
/obj/item/clothing/accessory/collar/shock/bluespace/attackby(var/obj/item/component, mob/user as mob)
	if (component.has_tool_quality(TOOL_WRENCH))
		...
		qdel(src)
		return
	if (!istype(component,/obj/item/assembly/signaler)) // CHOMPEdit - Removal of obj/item/device
		..()
		return
...
/obj/item/clothing/accessory/holster/machete
	...
	concealed_holster = 0
	can_hold = list(/obj/item/material/knife/machete, /obj/item/kinetic_crusher/machete) // CHOMPEdit - Removal of obj/item/weapon
