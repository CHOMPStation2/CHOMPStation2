...
/obj/machinery/gateway/centeraway/mcguffin
	...
	calibrated = 0
	var/mcguffin_type = /obj/item/mcguffin/brass //you should be able to change the var to be whatever kind of path you like, so maybe you can use other things on it sometimes // CHOMPEdit - Removal of obj/item/device
	var/key //holds a ref to the key we spawned

/obj/machinery/gateway/centeraway/mcguffin/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mcguffin/brass // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mcguffin/digest_act(var/atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/device
	return FALSE
