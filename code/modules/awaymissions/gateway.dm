...
/obj/machinery/gateway/centerstation/Bumped(atom/movable/M as mob|obj)
	...
	if(awaygate.calibrated)
		...
		if(istype(M, /obj/item/uav)) // CHOMPEdit - Removal of obj/item/device
			var/obj/item/uav/L = M // CHOMPEdit - Removal of obj/item/device
			L.power_down()
...
/obj/machinery/gateway/centerstation/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/device
...
/obj/machinery/gateway/centeraway/Bumped(atom/movable/M as mob|obj)
	...
	if(istype(M, /mob/living/carbon))
		for(var/obj/item/implant/exile/E in M)//Checking that there is an exile implant in the contents // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/gateway/centeraway/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	if(istype(W,/obj/item/multitool)) // CHOMPEdit - Removal of obj/item/device
