	...
	25;"viscerator", \ */ //VORESTATION AI TEMPORARY REMOVAL
		...
		if("treasure")
			...
			if(prob(33))
				...
				for(var/coin_type in typesof(/obj/item/coin)) // CHOMPEdit - Removal of obj/item/weapon
				...
				var/amount = rand(2,6)
				var/list/possible_spawns = list()
				for(var/cash_type in subtypesof(/obj/item/spacecash)) // CHOMPEdit - Removal of obj/item/weapon
		...
		if("clothes")
			...
			if(prob(33))
				...
				new /obj/item/storage/box/syndie_kit/chameleon(C) // CHOMPEdit - Removal of obj/item/weapon
			else
...
//CHOMPedit end.
		...
		if("spacesuit")
			...
			if(prob(25))
				...
				new /obj/item/tank/oxygen/red(C) // CHOMPEdit - Removal of obj/item/weapon
		...
		if("health")
			...
			if(prob(50))
				new /obj/item/storage/firstaid/regular(C) // CHOMPEdit - Removal of obj/item/weapon
			if(prob(50))
				new /obj/item/storage/firstaid/fire(C) // CHOMPEdit - Removal of obj/item/weapon
			if(prob(50))
				new /obj/item/storage/firstaid/o2(C) // CHOMPEdit - Removal of obj/item/weapon
			if(prob(50))
				new /obj/item/storage/firstaid/toxin(C) // CHOMPEdit - Removal of obj/item/weapon
			if(prob(25))
				new /obj/item/storage/firstaid/combat(C) // CHOMPEdit - Removal of obj/item/weapon
			if(prob(25))
				new /obj/item/storage/firstaid/adv(C) // CHOMPEdit - Removal of obj/item/weapon
			if(prob(25))
				new /obj/item/storage/firstaid/experimental(C) //CHOMP Add // CHOMPEdit - Removal of obj/item/weapon
		if("snacks")
		...
		if("engineering")
			...
			if(prob(33))
				new /obj/item/storage/toolbox/electrical(C) // CHOMPEdit - Removal of obj/item/weapon
			else if(prob(50))
				new /obj/item/storage/toolbox/mechanical(C) // CHOMPEdit - Removal of obj/item/weapon
			...
			if(prob(25))
				new /obj/item/cell(C) // CHOMPEdit - Removal of obj/item/weapon
		...
		if("mimic")
			...
			new /obj/item/storage/toolbox/electrical(C) //Placeholder to prevent errors. //VORESTATION AI TEMPORARY EDIT // CHOMPEdit - Removal of obj/item/weapon
		if("viscerator")
			//more tomb guardians!
