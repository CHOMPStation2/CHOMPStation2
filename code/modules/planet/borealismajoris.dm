...
/datum/weather/borealis2/rain/process_effects()
	...
	for(var/mob/living/L in living_mob_list)
		if(L.z in holder.our_planet.expected_z_levels)
			...
			if(istype(L.get_active_hand(), /obj/item/melee/umbrella)) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/melee/umbrella/U = L.get_active_hand() // CHOMPEdit - Removal of obj/item/weapon
				if(U.open)
					if(show_message)
						to_chat(L, "<span class='notice'>Rain patters softly onto your umbrella</span>")
					continue
			else if(istype(L.get_inactive_hand(), /obj/item/melee/umbrella)) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/melee/umbrella/U = L.get_inactive_hand() // CHOMPEdit - Removal of obj/item/weapon
				if(U.open)
					if(show_message)
						to_chat(L, "<span class='notice'>Rain patters softly onto your umbrella</span>")
					continue
...
/datum/weather/borealis2/hail/process_effects()
	...
	for(var/mob/living/carbon/human/H in living_mob_list)
		if(H.z in holder.our_planet.expected_z_levels)
			...
			if(istype(H.get_active_hand(), /obj/item/melee/umbrella)) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/melee/umbrella/U = H.get_active_hand() // CHOMPEdit - Removal of obj/item/weapon
				if(U.open)
					if(show_message)
						to_chat(H, "<span class='notice'>Hail patters gently onto your umbrella.</span>")
					continue
			else if(istype(H.get_inactive_hand(), /obj/item/melee/umbrella)) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/melee/umbrella/U = H.get_inactive_hand() // CHOMPEdit - Removal of obj/item/weapon
				if(U.open)
					if(show_message)
						to_chat(H, "<span class='notice'>Hail patters gently onto your umbrella.</span>")
					continue
