...
/obj/item/organ/process()
	...
	if(istype(loc,/obj/item/mmi)) // CHOMPEdit - Removal of obj/item/device
		return
	if(preserved)
		return
...
/obj/item/organ/proc/bitten(mob/user)
	...
	var/obj/item/reagent_containers/food/snacks/organ/O = new(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
	O.name = name
	O.icon = icon
...
/obj/item/organ/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/organ/proc/butcher(var/obj/item/O, var/mob/living/user, var/atom/newtarget)
	...
	if(istype(newmeat, /obj/item/reagent_containers/food/snacks/meat)) // CHOMPEdit - Removal of obj/item/weapon
