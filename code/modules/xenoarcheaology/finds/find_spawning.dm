...
/obj/item/archaeological_find/New(loc, var/new_item_type) // CHOMPEdit - Removal of obj/item/weapon
	if(new_item_type)
	...
	var/additional_desc = ""
	var/obj/item/new_item // CHOMPEdit - Removal of obj/item/weapon
	var/source_material = ""
	...
	switch(find_type)
		if(ARCHAEO_BOWL)
			item_type = "bowl"
			if(prob(33))
				new_item = new /obj/item/reagent_containers/glass/replenishing(src.loc) // CHOMPEdit - Removal of obj/item/weapon
				LAZYSET(new_item.origin_tech, TECH_ARCANE, 1)
			else
				new_item = new /obj/item/reagent_containers/glass/beaker(src.loc) // CHOMPEdit - Removal of obj/item/weapon
		...
		if(ARCHAEO_CUTLERY)
			...
			if(prob(25))
				new_item = new /obj/item/material/kitchen/utensil/fork(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			else if(prob(50))
				new_item = new /obj/item/material/knife(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			else
				new_item = new /obj/item/material/kitchen/utensil/spoon(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			if(prob(60))
				LAZYSET(new_item.origin_tech, TECH_ARCANE, 1)
		...
		if(ARCHAEO_STATUETTE)
			...
			if(prob(25))
				new_item = new /obj/item/vampiric(src.loc) // CHOMPEdit - Removal of obj/item/weapon
				LAZYSET(new_item.origin_tech, TECH_ARCANE, 1)
		...
		if(ARCHAEO_COIN)
			...
			var/chance = 8
			for(var/type in typesof(/obj/item/coin)) // CHOMPEdit - Removal of obj/item/weapon
				if(prob(chance))
		...
		if(ARCHAEO_HANDCUFFS)
			item_type = "handcuffs"
			new_item = new /obj/item/handcuffs(src.loc) // CHOMPEdit - Removal of obj/item/weapon
		...
		if(ARCHAEO_BEARTRAP)
			...
			apply_prefix = FALSE
			new_item = new /obj/item/beartrap(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			if(prob(40))
				new_item.color = rgb(rand(0,255),rand(0,255),rand(0,255))
		...
		if(ARCHAEO_LIGHTER)
			...
			new_item = new /obj/item/flame/lighter(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			additional_desc = "There is a tiny device attached."
			if(prob(30))
				apply_image_decorations = TRUE
		if(ARCHAEO_BOX)
			item_type = "box"
			new_item = new /obj/item/storage/box(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			new_item.icon = 'icons/obj/xenoarchaeology.dmi'
			new_item.icon_state = "box"
			var/obj/item/storage/box/new_box = new_item // CHOMPEdit - Removal of obj/item/weapon
		...
		if(ARCHAEO_GASTANK)
			item_type = "[pick("cylinder","tank","chamber")]"
			if(prob(25))
				new_item = new /obj/item/tank/air(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			else if(prob(50))
				new_item = new /obj/item/tank/anesthetic(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			else
				new_item = new /obj/item/tank/phoron(src.loc) // CHOMPEdit - Removal of obj/item/weapon
		...
		if(ARCHAEO_TOOL)
			item_type = "tool"
			if(prob(25))
				new_item = new /obj/item/tool/wrench(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			else if(prob(25))
				new_item = new /obj/item/tool/crowbar(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			else
				new_item = new /obj/item/tool/screwdriver(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			if(prob(40))
				new_item.color = rgb(rand(0,255),rand(0,255),rand(0,255))
				apply_image_decorations = TRUE
			additional_desc = "[pick("It doesn't look safe.",\
		...
		if(ARCHAEO_PEN)
			if(prob(75))
				new_item = new /obj/item/pen(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			else
				new_item = new /obj/item/pen/reagent/sleepy(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			if(prob(30))
				icon = 'icons/obj/xenoarchaeology.dmi'
				icon_state = "pen1"
				LAZYSET(new_item.origin_tech, TECH_ARCANE, 1)
		...
		if(ARCHAEO_CRYSTAL)
			...
			if(prob(10))
				apply_image_decorations = TRUE
			if(prob(25))
				new_item = new /obj/item/soulstone(src.loc) // CHOMPEdit - Removal of obj/item/device
				new_item.icon = 'icons/obj/xenoarchaeology.dmi'
		...
		if(ARCHAEO_CULTBLADE)
			//cultblade
			apply_prefix = FALSE
			new_item = new /obj/item/melee/cultblade(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			apply_material_decorations = FALSE
			apply_image_decorations = FALSE
		if(ARCHAEO_TELEBEACON)
			new_item = new /obj/item/radio/beacon(src.loc) // CHOMPEdit - Removal of obj/item/device
			talkative = FALSE
			new_item.icon = 'icons/obj/xenoarchaeology.dmi'
		...
		if(ARCHAEO_CLAYMORE)
			apply_prefix = FALSE
			new_item = new /obj/item/material/sword(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			new_item.force = 10
		...
		if(ARCHAEO_SHARD)
			if(prob(50))
				new_item = new /obj/item/material/shard(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			else
				new_item = new /obj/item/material/shard/phoron(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			apply_prefix = FALSE
			apply_image_decorations = FALSE
			apply_material_decorations = FALSE
		if(ARCHAEO_RODS)
		...
		if(ARCHAEO_STOCKPARTS)
			if(prob(30))
				become_anomalous = TRUE
			var/list/possible_spawns = typesof(/obj/item/stock_parts) // CHOMPEdit - Removal of obj/item/weapon
			possible_spawns -= /obj/item/stock_parts // CHOMPEdit - Removal of obj/item/weapon
			possible_spawns -= /obj/item/stock_parts/subspace // CHOMPEdit - Removal of obj/item/weapon
		...
		if(ARCHAEO_KATANA)
			apply_prefix = FALSE
			new_item = new /obj/item/material/sword/katana(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			new_item.force = 10
		...
		if(ARCHAEO_LASER)
			...
			/obj/item/gun/energy/captain/xenoarch) // CHOMPEdit - Removal of obj/item/weapon
			if(spawn_type)
				var/obj/item/gun/energy/new_gun = new spawn_type(src.loc) // CHOMPEdit - Removal of obj/item/weapon
				new_item = new_gun
		...
		if(ARCHAEO_GUN)
			//revolver
			var/obj/item/gun/projectile/new_gun = new /obj/item/gun/projectile/revolver(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			new_item = new_gun
		...
		if(ARCHAEO_FOSSIL)
			//fossil bone/skull
			//new_item = new /obj/item/fossil/base(src.loc) // CHOMPEdit - Removal of obj/item/weapon

			//the replacement item propogation isn't working, and it's messy code anyway so just do it here
			var/list/candidates = list(/obj/item/fossil/bone = 9,/obj/item/fossil/skull = 3, // CHOMPEdit - Removal of obj/item/weapon
		...
		if(ARCHAEO_SHELL)
			//fossil shell
			new_item = new /obj/item/fossil/shell(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			apply_prefix = FALSE
		...
		if(ARCHAEO_PLANT)
			//fossil plant
			new_item = new /obj/item/fossil/plant(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			item_type = new_item.name
		...
		if(ARCHAEO_ALIEN_BOAT)
			...
			if(prob(30))
				new /obj/item/oar(src.loc, new_boat_mat) // CHOMPEdit - Removal of obj/item/weapon
			var/new_type = pick(alien_stuff)
		...
		if(ARCHAEO_IMPERION_CIRCUIT)
			...
			apply_prefix = FALSE
			apply_image_decorations = FALSE
			var/possible_circuits = subtypesof(/obj/item/circuitboard/mecha/imperion) // CHOMPEdit - Removal of obj/item/weapon
		...
		if(ARCHAEO_TELECUBE)
			...
			if(prob(25))
				apply_material_decorations = FALSE
			new_item = new /obj/item/telecube/randomized(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			item_type = new_item.name

		if(ARCHAEO_BATTERY)
			// Battery!
			var/new_path = pick(subtypesof(/obj/item/cell)) // CHOMPEdit - Removal of obj/item/weapon
		...
		if(ARCHAEO_SYRINGE)
			...
			if(prob(25))
				apply_material_decorations = FALSE
			new_item = new /obj/item/reagent_containers/syringe(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/reagent_containers/syringe/S = new_item // CHOMPEdit - Removal of obj/item/weapon
		...
		if(ARCHAEO_CLUB)
			...
			new_item = new /obj/item/material/twohanded/baseballbat(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			new_item.name = pick("great-club","club","billyclub","mace","tenderizer","maul","bat")
			item_type = new_item.name

	if(istype(new_item, /obj/item/material)) // CHOMPEdit - Removal of obj/item/weapon
		...
		var/obj/item/material/MW = new_item // CHOMPEdit - Removal of obj/item/weapon
		MW.applies_material_colour = TRUE
		MW.set_material(new_item_mat)
		if(istype(MW, /obj/item/material/twohanded)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/material/twohanded/TH = MW // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/archaeological_find/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	if(src.is_anomalous())
