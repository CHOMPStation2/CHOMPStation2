/obj/item/rocksliver // CHOMPEdit - Removal of obj/item/weapon
	name = "rock sliver"
...
/obj/item/rocksliver/New() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/core_sampler // CHOMPEdit - Removal of obj/item/device
	...
	var/obj/item/evidencebag/filled_bag // CHOMPEdit - Removal of obj/item/weapon

/obj/item/core_sampler/examine(var/mob/user) // CHOMPEdit - Removal of obj/item/device
	. = ..()
...
/obj/item/core_sampler/attackby(var/obj/item/I, var/mob/living/user) // CHOMPEdit - Removal of obj/item/device
	if(istype(I, /obj/item/evidencebag)) // CHOMPEdit - Removal of obj/item/weapon
		if(I.contents.len)
...
/obj/item/core_sampler/proc/sample_item(var/item_to_sample, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	...
	else if(istype(item_to_sample, /obj/item/ore)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/ore/O = item_to_sample // CHOMPEdit - Removal of obj/item/weapon
	...
	if(geo_data)
		if(filled_bag)
			...
			filled_bag = new /obj/item/evidencebag(src) // CHOMPEdit - Removal of obj/item/weapon
			...
			var/obj/item/rocksliver/R = new(filled_bag) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/core_sampler/attack_self(var/mob/living/user) // CHOMPEdit - Removal of obj/item/device
	if(filled_bag)
