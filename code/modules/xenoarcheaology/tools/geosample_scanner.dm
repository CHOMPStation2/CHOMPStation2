/obj/machinery/radiocarbon_spectrometer
	...
	//var/obj/item/reagent_containers/glass/coolant_container // CHOMPEdit - Removal of obj/item/weapon
	var/scanning = 0
	var/report_num = 0
	//
...
/obj/machinery/radiocarbon_spectrometer/attackby(var/obj/I as obj, var/mob/user as mob)
	if(scanning)
		...
		if(istype(I, /obj/item/reagent_containers/glass)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/reagent_containers/glass/G = I // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/radiocarbon_spectrometer/proc/complete_scan()
	...
	if(scanned_item)
		//create report
		var/obj/item/paper/P = new(src) // CHOMPEdit - Removal of obj/item/weapon
		...
		switch(scanned_item.type)
			if(/obj/item/ore) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/ore/O = scanned_item // CHOMPEdit - Removal of obj/item/weapon
				if(O.geologic_data)
					G = O.geologic_data

			if(/obj/item/rocksliver) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/rocksliver/O = scanned_item // CHOMPEdit - Removal of obj/item/weapon
				if(O.geological_data)
					G = O.geological_data

			if(/obj/item/archaeological_find) // CHOMPEdit - Removal of obj/item/weapon
				data = " - Mundane object (archaic xenos origins)<br>"

				var/obj/item/archaeological_find/A = scanned_item // CHOMPEdit - Removal of obj/item/weapon
				if(A.talking_atom)
