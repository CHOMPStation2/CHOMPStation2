...
/obj/item/anobattery/advanced // CHOMPEdit - Removal of obj/item/weapon
	name = "advanced anomaly battery"
	capacity = 3000

/*
/obj/item/anobattery/New() // CHOMPEdit - Removal of obj/item/weapon
	battery_effect = new()
*/

/obj/item/anobattery/proc/UpdateSprite() // CHOMPEdit - Removal of obj/item/weapon
	var/p = (stored_charge/capacity)*100
	p = min(p, 100)
	icon_state = "anobattery[round(p,25)]"

/obj/item/anobattery/proc/use_power(var/amount) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/anodevice // CHOMPEdit - Removal of obj/item/weapon
	...
	var/last_process = 0
	var/obj/item/anobattery/inserted_battery // CHOMPEdit - Removal of obj/item/weapon
	var/turf/archived_loc
	var/energy_consumed_on_touch = 100

/obj/item/anodevice/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	START_PROCESSING(SSobj, src)

/obj/item/anodevice/attackby(var/obj/I as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(I, /obj/item/anobattery)) // CHOMPEdit - Removal of obj/item/weapon
		if(!inserted_battery)
...
/obj/item/anodevice/attack_self(var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	return tgui_interact(user)

/obj/item/anodevice/tgui_state(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return GLOB.tgui_inventory_state

/obj/item/anodevice/tgui_interact(mob/user, datum/tgui/ui) // CHOMPEdit - Removal of obj/item/weapon
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "XenoarchHandheldPowerUtilizer", name)
		ui.open()

/obj/item/anodevice/tgui_data(mob/user, datum/tgui/ui, datum/tgui_state/state) // CHOMPEdit - Removal of obj/item/weapon
	var/list/data = ..()
...
/obj/item/anodevice/tgui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state) // CHOMPEdit - Removal of obj/item/weapon
	if(..())
		return TRUE
...
/obj/item/anodevice/process() // CHOMPEdit - Removal of obj/item/weapon
	if(activated)
		if(inserted_battery && inserted_battery.battery_effect && (inserted_battery.stored_charge > 0) )
...
/obj/item/anodevice/proc/shutdown_emission() // CHOMPEdit - Removal of obj/item/weapon
	if(activated)
		activated = 0
		if(inserted_battery?.battery_effect?.activated)
			inserted_battery.battery_effect.ToggleActivate(1)

/obj/item/anodevice/proc/UpdateSprite() // CHOMPEdit - Removal of obj/item/weapon
	if(!inserted_battery)
		icon_state = "anodev"
		return
...
/obj/item/anodevice/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	STOP_PROCESSING(SSobj, src)
	..()

/obj/item/anodevice/attack(mob/living/M as mob, mob/living/user as mob, def_zone) // CHOMPEdit - Removal of obj/item/weapon
	if (!istype(M))
		return
