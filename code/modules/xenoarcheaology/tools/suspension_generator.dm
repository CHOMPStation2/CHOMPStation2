/obj/machinery/suspension_gen
	...
	var/obj/item/card/id/auth_card // CHOMPEdit - Removal of obj/item/weapon
	var/locked = 1
	var/power_use = 5
	...
	if(!locked && !suspension_field && default_deconstruction_screwdriver(user, W))
		...
		if(panel_open)
			if(cell)
				...
				icon_state = "suspension"
	else if(istype(W, /obj/item/card)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/card/I = W // CHOMPEdit - Removal of obj/item/weapon
		if(!auth_card)
...
/obj/machinery/suspension_gen/proc/attempt_unlock(var/obj/item/card/C, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!panel_open)
		if(istype(C, /obj/item/card/emag)) // CHOMPEdit - Removal of obj/item/weapon
			C.resolve_attackby(src, user)
		else if(istype(C, /obj/item/card/id) && check_access(C)) // CHOMPEdit - Removal of obj/item/weapon
			locked = 0
		if(!locked)
			return 1
...
/obj/machinery/suspension_gen/proc/activate()
	...
	for(var/obj/item/I in T) // CHOMPEdit - Removal of obj/item/weapon
