...
/datum/artifact_effect/vampire/DoEffectAura()
	...
	if(charges >= 10)
		charges -= 10
		var/manifestation = pick(/obj/item/soulstone, /mob/living/simple_mob/faithless/cult/strong, /mob/living/simple_mob/creature/cult/strong, /mob/living/simple_mob/animal/space/bats/cult/strong) // CHOMPEdit - Removal of obj/item/device
