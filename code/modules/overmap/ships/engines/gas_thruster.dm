...
/obj/machinery/atmospherics/unary/engine
	...
	// maximum_component_parts = list(/obj/item/stock_parts = 6)//don't want too many, let upgraded component shine // CHOMPEdit - Removal of obj/item/weapon
	// uncreated_component_parts = list(/obj/item/stock_parts/power/apc/buildable = 1) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/atmospherics/unary/engine/RefreshParts()
	...
	var/bin_upgrade = 5 * CLAMP(total_component_rating_of_type(/obj/item/stock_parts/matter_bin), 0, 6)//5 litre per rank // CHOMPEdit - Removal of obj/item/weapon
	...
	var/energy_upgrade = CLAMP(total_component_rating_of_type(/obj/item/stock_parts/capacitor), 0.1, 6) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/circuitboard/unary_atmos/engine //why don't we move this elsewhere? // CHOMPEdit - Removal of obj/item/weapon
...
// 	uncreated_component_parts = list(/obj/item/stock_parts/power/terminal/buildable = 1) // CHOMPEdit - Removal of obj/item/weapon
