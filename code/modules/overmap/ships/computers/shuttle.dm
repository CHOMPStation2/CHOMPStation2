...
/obj/machinery/computer/shuttle_control/explore
	...
	circuit = /obj/item/circuitboard/shuttle_console/explore // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/shuttle_control/explore/shuttlerich_tgui_data(var/datum/shuttle/autodock/overmap/shuttle)
	...
	if(istype(shuttle))
		...
		for(var/obj/structure/fuel_port/FP in shuttle.fuel_ports) //loop through fuel ports
			var/obj/item/tank/fuel_tank = locate() in FP // CHOMPEdit - Removal of obj/item/weapon
			if(fuel_tank)
