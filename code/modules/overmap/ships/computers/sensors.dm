/obj/machinery/computer/ship/sensors
	...
	light_color = "#77fff8"
	circuit = /obj/item/circuitboard/sensors // CHOMPEdit - Removal of obj/item/weapon
	extra_view = 4
	...
	switch(action)
		...
		if("scan")
			...
			if(istype(O) && !QDELETED(O) && (O in view(7,linked)))
				new/obj/item/paper/(get_turf(src), O.get_scan_data(usr), "paper (Sensor Scan - [O])") // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/shipsensors/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
