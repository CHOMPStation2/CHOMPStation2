/obj/item/analyzer/xeno_analyzer // CHOMPEdit - Removal of obj/item/device
	name = "exotic biological analyzer"
	desc = "A device to investigate the genetic data of a biological target."
	var/form_title
	var/last_data

/obj/item/analyzer/xeno_analyzer/proc/print_report_verb() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/analyzer/xeno_analyzer/Topic(href, href_list) // CHOMPEdit - Removal of obj/item/device
	if(..())
		return
	if(href_list["print"])
		print_report(usr)

/obj/item/analyzer/xeno_analyzer/proc/print_report(var/mob/living/user) // CHOMPEdit - Removal of obj/item/device
	if(!last_data)
...
/obj/item/analyzer/xeno_analyzer/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	print_report(user)
	return 0

/obj/item/analyzer/xeno_analyzer/afterattack(var/target, mob/user, flag) // CHOMPEdit - Removal of obj/item/device
	if(!flag) return
