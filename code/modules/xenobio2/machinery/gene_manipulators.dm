...
*/
/obj/item/disk/xenobio // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/disk/xenobio/attack_self(var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(genes.len)
...
/obj/item/storage/box/xenobiodisk // CHOMPEdit - Removal of obj/item/weapon
	name = "biological disk box"
	desc = "A box of biological data disks, apparently."

/obj/item/storage/box/xenobiodisk/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	for(var/i = 0 to 7)
		new /obj/item/disk/xenobio(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/xenobio
	...
	var/obj/item/disk/xenobio/loaded_disk //Currently loaded data disk. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/xenobio/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(default_deconstruction_screwdriver(user, W))
		return
	if(default_deconstruction_crowbar(user, W))
		return
	if(istype(W,/obj/item/disk/xenobio)) // CHOMPEdit - Removal of obj/item/weapon
		if(loaded_disk)
			to_chat(user, "There is already a data disk loaded.")
			return
		else
			var/obj/item/disk/xenobio/B = W // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/xenobio/extractor
	...
	circuit = /obj/item/circuitboard/bioproddestanalyzer // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/xenobio/extractor/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/xenobio/editor
	...
	icon_state = "cellold0"
	disk_needs_genes = 1
	circuit = /obj/item/circuitboard/biobombarder // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/xenobio/editor/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/circuitboard/bioproddestanalyzer // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/circuitboard/biobombarder // CHOMPEdit - Removal of obj/item/weapon
