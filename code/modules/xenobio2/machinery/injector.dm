...
/obj/machinery/xenobio2/manualinjector
	...
	var/obj/item/reagent_containers/glass/beaker // CHOMPEdit - Removal of obj/item/weapon
	var/obj/machinery/computer/xenobio2/computer

	circuit = /obj/item/circuitboard/xenobioinjectormachine // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/xenobio2/manualinjector/Initialize()
	...
	reagents = R
	R.my_atom = src
	beaker = new /obj/item/reagent_containers/glass/beaker(src) // CHOMPEdit - Removal of obj/item/weapon
	default_apply_parts()
...
/obj/machinery/xenobio2/manualinjector/proc/eject_beaker()
	if(beaker)
		var/obj/item/reagent_containers/glass/beaker/B = beaker // CHOMPEdit - Removal of obj/item/weapon
		B.loc = loc
		beaker = null
...
/obj/machinery/xenobio2/manualinjector/attackby(var/obj/item/W, var/mob/user)
	...
	if(istype(W, /obj/item/reagent_containers/glass/beaker)) // CHOMPEdit - Removal of obj/item/weapon
		beaker = W
	...
	if(istype(W, /obj/item/multitool)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/multitool/P = W // CHOMPEdit - Removal of obj/item/device
		if(P.connectable)
...
/obj/item/circuitboard/xenobioinjectormachine // CHOMPEdit - Removal of obj/item/weapon
