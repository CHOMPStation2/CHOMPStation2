...
/obj/item/entrepreneur/crystal_ball // CHOMPEdit - Removal of obj/item/weapon

/obj/item/entrepreneur/horoscope // CHOMPEdit - Removal of obj/item/weapon
	name = "horoscope book"
	icon = 'icons/obj/entrepreneur.dmi'
...
/obj/item/entrepreneur/horoscope/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/entrepreneur/horoscope/attack_self(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/entrepreneur/dentist_mirror // CHOMPEdit - Removal of obj/item/weapon
	name = "dental mirror"
	icon = 'icons/obj/entrepreneur.dmi'
	icon_state = "mirror"
...
/obj/item/entrepreneur/dentist_mirror/attack(mob/M, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/entrepreneur/dentist_probe // CHOMPEdit - Removal of obj/item/weapon
	name = "dental probe"
	icon = 'icons/obj/entrepreneur.dmi'
	icon_state = "probe"
...
/obj/item/entrepreneur/dentist_probe/attack(mob/M, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(user.a_intent == I_HELP)	//A tad messy, but this should stop people from smacking their patients in surgery
...
/obj/item/entrepreneur/dentist_sickle // CHOMPEdit - Removal of obj/item/weapon
	name = "dental sickle"
	icon = 'icons/obj/entrepreneur.dmi'
	icon_state = "sickle"
...
/obj/item/entrepreneur/dentist_sickle/attack(mob/M, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(user.a_intent == I_HELP)	//A tad messy, but this should stop people from smacking their patients in surgery
...
/obj/item/entrepreneur/dentist_scaler // CHOMPEdit - Removal of obj/item/weapon
	name = "dental scaler"
	icon = 'icons/obj/entrepreneur.dmi'
	icon_state = "scaler"
...
/obj/item/entrepreneur/dentist_scaler/attack(mob/M, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(user.a_intent == I_HELP)	//A tad messy, but this should stop people from smacking their patients in surgery
...
/obj/item/bedsheet/pillow/exercise // CHOMPEdit - Removal of obj/item/weapon
	name = "exercise mat"
	desc = "A thick, flexible but tough mat designed for people to exercise on."
	icon = 'icons/obj/entrepreneur.dmi'
	icon_state = "exercise_mat"

/obj/item/bedsheet/pillow/exercise/attackby(var/obj/item/component, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/entrepreneur/dumbbell // CHOMPEdit - Removal of obj/item/weapon
	name = "dumbbell"
	desc = "A small but heavy pair of weights connected by a bar, desgined to be held in one hand."
	icon = 'icons/obj/entrepreneur.dmi'
	icon_state = "dumbbell"

/obj/item/entrepreneur/dumbbell/attack_self(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/entrepreneur/emf // CHOMPEdit - Removal of obj/item/weapon
	name = "EMF scanner"
...
/obj/item/entrepreneur/emf/attack_self(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!last_used)
		emf = rand(1,100)
...
/obj/item/entrepreneur/emf/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	switch(emf)
		if(-1000 to 20)
			icon_state = "emf-0"
		if(20 to 40)
...
/obj/item/entrepreneur/spirit_board // CHOMPEdit - Removal of obj/item/weapon
	name = "spirit board"
...
/obj/item/entrepreneur/spirit_board/attackby(obj/item/reagent_containers/food/drinks/W as obj, mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(user))
		return 0
	if(!istype(W))
...
/obj/item/entrepreneur/spirit_board/AltClick(mob/living/carbon/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/entrepreneur/spirit_board/attack_ghost(var/mob/observer/dead/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!ghost_enabled)
		return
...
/obj/item/entrepreneur/crystal // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/entrepreneur/crystal/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/glass/bottle/essential_oil // CHOMPEdit - Removal of obj/item/weapon
	name = "essential oils"
...
/obj/item/entrepreneur/magnifying_glass // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/entrepreneur/magnifying_glass/afterattack(atom/T, mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!T.desc)
		return
...
/obj/item/tvcamera/streamer // CHOMPEdit - Removal of obj/item/device
	name = "streamer camera drone"
	channel = "Virgo Live Stream"

/obj/item/camera/selfie // CHOMPEdit - Removal of obj/item/device
	name = "selfie stick"
...
/obj/item/storage/box/fortune_teller // CHOMPEdit - Removal of obj/item/weapon
	name = "fortune teller kit"
	desc = "A kit containing everything that a fortune teller needs."
	icon = 'icons/obj/entrepreneur.dmi'
	icon_state = "fortune_teller"
	starts_with = list(/obj/item/entrepreneur/horoscope, /obj/item/deck/tarot, /obj/item/entrepreneur/crystal_ball, /obj/item/ticket_printer/train) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device

/obj/item/storage/box/dentist // CHOMPEdit - Removal of obj/item/weapon
	name = "dentist kit"
	desc = "A kit containing everything that a dentist needs."
	icon = 'icons/obj/entrepreneur.dmi'
	icon_state = "dentist"
	starts_with = list(/obj/item/entrepreneur/dentist_mirror, /obj/item/entrepreneur/dentist_probe, /obj/item/entrepreneur/dentist_sickle, /obj/item/entrepreneur/dentist_scaler, /obj/item/flashlight/pen, /obj/item/ticket_printer/train) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device

/obj/item/storage/box/fitness_trainer // CHOMPEdit - Removal of obj/item/weapon
	name = "exercise kit"
	desc = "A kit containing everything that a fitness trainer needs."
	icon = 'icons/obj/entrepreneur.dmi'
	icon_state = "fitness_trainer"
	starts_with = list(/obj/item/bedsheet/pillow/exercise, /obj/item/entrepreneur/dumbbell, /obj/item/entrepreneur/dumbbell, /obj/item/reagent_containers/food/snacks/candy/proteinbar, /obj/item/ticket_printer/train) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device

/obj/item/storage/box/yoga_teacher // CHOMPEdit - Removal of obj/item/weapon
	name = "yoga kit"
	desc = "A kit containing everything that a yoga teacher needs."
	icon = 'icons/obj/entrepreneur.dmi'
	icon_state = "yoga_teacher"
	starts_with = list(/obj/item/bedsheet/pillow/exercise, /obj/item/bedsheet/pillow/exercise, /obj/item/reagent_containers/food/snacks/fruitbar, /obj/item/ticket_printer/train) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device

/obj/item/storage/box/paranormal_investigator // CHOMPEdit - Removal of obj/item/weapon
	...
	starts_with = list(/obj/item/entrepreneur/emf, /obj/item/entrepreneur/spirit_board, /obj/item/reagent_containers/food/drinks/glass2/shot, /obj/item/ticket_printer/train) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device

/obj/item/storage/box/spirit_healer // CHOMPEdit - Removal of obj/item/weapon
	name = "exercise kit"
	desc = "A kit containing everything that a spirit healer needs."
	icon = 'icons/obj/entrepreneur.dmi'
	icon_state = "spirit_healer"
	starts_with = list(/obj/item/entrepreneur/crystal, /obj/item/entrepreneur/crystal, /obj/item/entrepreneur/crystal, /obj/item/entrepreneur/crystal, /obj/item/entrepreneur/crystal, /obj/item/reagent_containers/glass/bottle/essential_oil, /obj/item/ticket_printer/train) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device

/obj/item/storage/box/private_investigator // CHOMPEdit - Removal of obj/item/weapon
	name = "investigator kit"
	desc = "A kit containing everything that a private eye needs."
	icon = 'icons/obj/entrepreneur.dmi'
	icon_state = "private_investigator"
	starts_with = list(/obj/item/taperecorder, /obj/item/tape, /obj/item/tape, /obj/item/camera, /obj/item/sticky_pad, /obj/item/entrepreneur/magnifying_glass, /obj/item/ticket_printer/train) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device

/obj/item/storage/box/stylist // CHOMPEdit - Removal of obj/item/weapon
	name = "stylist kit"
	desc = "A kit containing everything that a stylist needs."
	icon = 'icons/obj/entrepreneur.dmi'
	icon_state = "stylist"
	starts_with = list(/obj/item/makeover, /obj/item/lipstick/random, /obj/item/nailpolish,  /obj/item/nailpolish_remover, /obj/item/haircomb, /obj/item/clothing/head/hairnet, /obj/item/ticket_printer/train) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
