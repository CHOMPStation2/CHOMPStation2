/obj/item/melee/baton/slime // CHOMPEdit - Removal of obj/item/weapon
	name = "slimebaton"
...
/obj/item/melee/baton/slime/attack(mob/living/L, mob/user, hit_zone) // CHOMPEdit - Removal of obj/item/weapon
	...
	..()
/obj/item/melee/baton/slime/loaded/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	bcell = new/obj/item/cell/device(src) // CHOMPEdit - Removal of obj/item/weapon
	update_icon()
	return ..()

// Research borg's version
/obj/item/melee/baton/slime/robot // CHOMPEdit - Removal of obj/item/weapon
	hitcost = 200
	use_external_power = TRUE

// Xeno stun gun + projectile
/obj/item/gun/energy/taser/xeno // CHOMPEdit - Removal of obj/item/weapon
	name = "xeno taser gun"
...
/obj/item/gun/energy/taser/xeno/robot // Borg version // CHOMPEdit - Removal of obj/item/weapon
	self_recharge = 1
	use_external_power = 1
	recharge_time = 3
/*
VORESTATION REMOVAL
/obj/item/gun/energy/taser/xeno/sec //NT's corner-cutting option for their on-station security. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/taser/xeno/sec/robot //Cyborg variant of the security xeno-taser. // CHOMPEdit - Removal of obj/item/weapon
	self_recharge = 1
	use_external_power = 1
	recharge_time = 3
*/
