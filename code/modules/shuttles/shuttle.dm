...
/datum/shuttle/proc/perform_shuttle_move(var/obj/effect/shuttle_landmark/destination, var/list/turf_translation)
	...
	for(var/area/A in shuttle_area)
		...
		//CHOMPEdit Begin
		for(var/obj/item/radio/intercom/I in A) // CHOMPEdit - Removal of obj/item/device
			radios |= I
		//CHOMPEdit End
	...
	//CHOMPEdit Begin
	for(var/obj/item/radio/intercom/I in radios) // CHOMPEdit - Removal of obj/item/device
		if(istype(I))
