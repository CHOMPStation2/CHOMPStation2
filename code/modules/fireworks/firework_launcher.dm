/obj/machinery/firework_launcher
	...
	circuit = /obj/item/circuitboard/firework_launcher // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/firework_star/loaded_star // CHOMPEdit - Removal of obj/item/weapon
	var/last_launch
...
/obj/machinery/firework_launcher/RefreshParts()
	...
	var/rating = 0
	for(var/obj/item/stock_parts/micro_laser/laser in component_parts) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/firework_launcher/attackby(var/obj/item/O, var/mob/user)
	...
	if(istype(O, /obj/item/firework_star)) // CHOMPEdit - Removal of obj/item/weapon
		if(loaded_star)
...
/obj/machinery/firework_launcher/attack_hand(mob/user)				// Maybe this proc could be better as entirely its own proc, called from attack_hand, but also I don't really see the point
	...
	if(WH.firework_override && istype(loaded_star, /obj/item/firework_star/weather))			// Enable weather-based events to not be ruined // CHOMPEdit - Removal of obj/item/weapon
