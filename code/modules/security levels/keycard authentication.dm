/obj/machinery/keycard_auth
	...
	circuit = /obj/item/circuitboard/keycard_auth // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/keycard_auth/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(W.has_tool_quality(TOOL_SCREWDRIVER))
		...
		if(do_after(user, 10 * W.toolspeed))
			...
			var/obj/item/circuitboard/M = new circuit(A) // CHOMPEdit - Removal of obj/item/weapon
