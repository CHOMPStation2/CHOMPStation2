/obj/item/gun/energy/mouseray // CHOMPEdit - Removal of obj/item/weapon
	name = "mouse ray"
...
/obj/item/gun/energy/mouseray/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(tf_allow_select)
		pick_type()

/obj/item/gun/energy/mouseray/proc/pick_type() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/mouseray/Fire(atom/target, mob/living/user, clickparams, pointblank, reflex) // CHOMPEdit - Removal of obj/item/weapon
	if(world.time < cooldown)
		to_chat(usr, "<span class='warning'>\The [src] isn't ready yet.</span>")
		return
	. = ..()

/obj/item/gun/energy/mouseray/Fire_userless(atom/target) // CHOMPEdit - Removal of obj/item/weapon
	if(world.time < cooldown)
		return
	. = ..()

/obj/item/gun/energy/mouseray/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/gun/energy/mouseray/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(charge_meter)
...
/obj/item/gun/energy/mouseray/medical		//This just changes people back, it can't TF people into anything without shenanigans // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/mouseray/medical/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/gun/energy/mouseray/admin		//NEVER GIVE THIS TO ANYONE // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/mouseray/metamorphosis/advanced // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/mouseray/metamorphosis/advanced/random // CHOMPEdit - Removal of obj/item/weapon
	name = "unstable metamorphosis ray"
	tf_allow_select = FALSE

/obj/item/gun/energy/mouseray/metamorphosis/advanced/random/Fire(atom/target, mob/living/user, clickparams, pointblank, reflex) // CHOMPEdit - Removal of obj/item/weapon
	if(world.time < cooldown)
		to_chat(usr, "<span class='warning'>\The [src] isn't ready yet.</span>")
		return
...
/obj/item/gun/energy/mouseray/woof // CHOMPEdit - Removal of obj/item/weapon
	name = "woof ray"
	tf_type = /mob/living/simple_mob/vore/woof

/obj/item/gun/energy/mouseray/corgi // CHOMPEdit - Removal of obj/item/weapon
	name = "corgi ray"
	tf_type = /mob/living/simple_mob/animal/passive/dog/corgi

/obj/item/gun/energy/mouseray/cat // CHOMPEdit - Removal of obj/item/weapon
	name = "cat ray"
	tf_type = /mob/living/simple_mob/animal/passive/cat

/obj/item/gun/energy/mouseray/chicken // CHOMPEdit - Removal of obj/item/weapon
	name = "chicken ray"
	tf_type = /mob/living/simple_mob/animal/passive/chicken

/obj/item/gun/energy/mouseray/lizard // CHOMPEdit - Removal of obj/item/weapon
	name = "lizard ray"
	tf_type = /mob/living/simple_mob/animal/passive/lizard

/obj/item/gun/energy/mouseray/rabbit // CHOMPEdit - Removal of obj/item/weapon
	name = "rabbit ray"
	tf_type = /mob/living/simple_mob/vore/rabbit

/obj/item/gun/energy/mouseray/fennec // CHOMPEdit - Removal of obj/item/weapon
	name = "fennec ray"
	tf_type = /mob/living/simple_mob/animal/passive/fennec

/obj/item/gun/energy/mouseray/monkey // CHOMPEdit - Removal of obj/item/weapon
	name = "monkey ray"
	tf_type = /mob/living/carbon/human/monkey

/obj/item/gun/energy/mouseray/wolpin // CHOMPEdit - Removal of obj/item/weapon
	name = "wolpin ray"
	tf_type = /mob/living/carbon/human/wolpin

/obj/item/gun/energy/mouseray/otie // CHOMPEdit - Removal of obj/item/weapon
	name = "otie ray"
	tf_type = /mob/living/simple_mob/vore/otie

/obj/item/gun/energy/mouseray/direwolf // CHOMPEdit - Removal of obj/item/weapon
	name = "dire wolf ray"
	tf_type = /mob/living/simple_mob/vore/wolf/direwolf

/obj/item/gun/energy/mouseray/giantrat // CHOMPEdit - Removal of obj/item/weapon
	name = "giant rat ray"
	tf_type = /mob/living/simple_mob/vore/aggressive/rat

/obj/item/gun/energy/mouseray/redpanda // CHOMPEdit - Removal of obj/item/weapon
	name = "red panda ray"
	tf_type = /mob/living/simple_mob/vore/redpanda

/obj/item/gun/energy/mouseray/catslug // CHOMPEdit - Removal of obj/item/weapon
	name = "catslug ray"
	tf_type = /mob/living/simple_mob/vore/alienanimals/catslug

/obj/item/gun/energy/mouseray/teppi // CHOMPEdit - Removal of obj/item/weapon
	name = "teppi ray"
...
/obj/random/mouseray/item_to_spawn()
	return pick(prob(300);/obj/item/gun/energy/mouseray, // CHOMPEdit - Removal of obj/item/weapon
