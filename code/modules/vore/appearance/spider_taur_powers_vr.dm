/obj/item/clothing/suit/straight_jacket/web/ // CHOMPEDIT : Make the web bindings a subtype of the straight jacket
...
/obj/item/clothing/suit/straight_jacket/web/get_worn_icon_file(var/body_type,var/slot_name,var/default_icon,var/inhands) // CHOMPEDIT : Make the web bindings a subtype of the straight jacket
...
/mob/living/proc/weaveWebBindings()
	...
	if(nutrition >= 30) //This isn't a huge problem. This is so you can bind people up.
		...
		spawn(30) //5 seconds to weave the bindings~
			var/obj/item/clothing/suit/straight_jacket/web/bindings = new() //This sprite is amazing, I must say. // CHOMPEDIT : Make the web bindings a subtype of the straight jacket
