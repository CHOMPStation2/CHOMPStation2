...
/obj/item/slow_sizegun // CHOMPEdit - Removal of obj/item/device
...
/obj/item/slow_sizegun/update_icon() // CHOMPEdit - Removal of obj/item/device
	icon_state = "[base_icon_state]-[sizeshift_mode]"

	if(busy)
		icon_state = "[icon_state]-active"

/obj/item/slow_sizegun/proc/should_stop(var/mob/living/target, var/mob/living/user, var/active_hand) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/slow_sizegun/afterattack(atom/target, mob/user, proximity_flag) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/slow_sizegun/attack_self(mob/living/user) // CHOMPEdit - Removal of obj/item/device
	if(busy)
		busy = !busy
	else
...
/obj/item/slow_sizegun/proc/draw_box(atom/A, box_size, client/C) // CHOMPEdit - Removal of obj/item/device
	. = list()
...
/obj/item/slow_sizegun/proc/draw_line(atom/A, line_dir, line_pixel_x, line_pixel_y, client/C) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/slow_sizegun/proc/delete_box(list/box_segments, client/C) // CHOMPEdit - Removal of obj/item/device
	for(var/i in box_segments)
		C.images -= i
		qdel(i)

/obj/item/slow_sizegun/proc/color_box(list/box_segments, new_color, new_time) // CHOMPEdit - Removal of obj/item/device
	for(var/i in box_segments)
		animate(i, color = new_color, time = new_time)

//Alt click to activate size trading

/obj/item/slow_sizegun/AltClick(mob/user) // CHOMPEdit - Removal of obj/item/device
	if (trading == 0)
		trading = 1
