...
/obj/item/gun/energy/sizegun/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	verbs += /obj/item/gun/energy/sizegun/proc/select_size // CHOMPEdit - Removal of obj/item/weapon
	verbs += /obj/item/gun/energy/sizegun/proc/spin_dial // CHOMPEdit - Removal of obj/item/weapon

/obj/item/gun/energy/sizegun/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	select_size()

/obj/item/gun/energy/sizegun/proc/spin_dial() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/sizegun/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	var/obj/item/projectile/beam/sizelaser/G = .
	if(istype(G))
		G.set_size = size_set_to

/obj/item/gun/energy/sizegun/proc/select_size() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/sizegun/update_icon(var/ignore_inhands) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/sizegun/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	. += "<span class='info'>It is currently set at [size_set_to*100]%</span>"

/obj/item/gun/energy/sizegun/admin // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/sizegun/admin/abductor // CHOMPEdit - Removal of obj/item/weapon
	name = "alien size gun"
...
/obj/item/gun/energy/sizegun/admin/select_size() // CHOMPEdit - Removal of obj/item/weapon
	set name = "Select Size"
	set category = "Object"
	set src in view(1)
...
/obj/item/gun/energy/sizegun/afterattack(atom/A, mob/living/user, adjacent, params) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/sizegun/attack(atom/A, mob/living/user, adjacent, params) // CHOMPEdit - Removal of obj/item/weapon
	if(backfire)
		if(prob(50))
			to_chat(user, "<span class='notice'>\The [src] backfires and consumes its entire charge!</span>")
			Fire(user, user)
...
/obj/item/gun/energy/sizegun/attackby(var/obj/item/A as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/sizegun/backfire // CHOMPEdit - Removal of obj/item/weapon
	name = "unstable size gun"
	backfire = 1

/obj/item/gun/energy/sizegun/mounted // CHOMPEdit - Removal of obj/item/weapon
