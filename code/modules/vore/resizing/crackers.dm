...
/obj/item/cracker  // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/cracker/attack(atom/A, mob/living/user, adjacent, params)  // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/paper/cracker_joke/J = new(spawnloc)  // CHOMPEdit - Removal of obj/item/weapon
	J.info = joke
	qdel(src)

/obj/item/cracker/Initialize() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/cracker/shrinking // CHOMPEdit - Removal of obj/item/weapon
	name = "shrinking bluespace cracker"
	prizes = list("shrinking")

/obj/item/cracker/growing // CHOMPEdit - Removal of obj/item/weapon
	name = "growing bluespace cracker"
	prizes = list("growing")

/obj/item/cracker/invisibility // CHOMPEdit - Removal of obj/item/weapon
	name = "cloaking bluespace cracker"
	prizes = list("invisibility")

/obj/item/cracker/drugged // CHOMPEdit - Removal of obj/item/weapon
	name = "psychedelic bluespace cracker"
	prizes = list("drugged")

/obj/item/cracker/knockover // CHOMPEdit - Removal of obj/item/weapon
	name = "forceful bluespace cracker"
	prizes = list("knocked over")

/obj/item/cracker/vore // CHOMPEdit - Removal of obj/item/weapon
	name = "teleporting bluespace cracker"
	prizes = list("teleport")

/obj/item/cracker/money // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/cracker_joke // CHOMPEdit - Removal of obj/item/weapon
	name = "joke"
	icon_state = "joke"

/obj/item/paper/cracker_joke/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	return
