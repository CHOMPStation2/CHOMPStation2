...
/obj/item/holder/micro/Initialize(mapload, mob/held) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/holder/micro/make_worn_icon(var/body_type,var/slot_name,var/inhands,var/default_icon,var/default_layer,var/icon/clip_mask = null) // CHOMPEdit - Removal of obj/item/weapon
	var/mob/living/carbon/human/H = held_mob
