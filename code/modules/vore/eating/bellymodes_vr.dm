...
/obj/belly/proc/handle_digesting_item(obj/item/I, touchable_amount) //CHOMPEdit
	...
	if(contaminates || istype(I, /obj/item/card/id)) // CHOMPEdit - Removal of obj/item/weapon
	...
	switch(item_digest_mode)
		if(IM_HOLD)
			items_preserved |= I
		if(IM_DIGEST_FOOD)
			if(istype(I,/obj/item/reagent_containers/food) || istype(I, /obj/item/organ)) // CHOMPEdit - Removal of obj/item/weapon
