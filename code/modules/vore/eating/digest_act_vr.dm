...
/obj/item/proc/digest_act(atom/movable/item_storage = null, touchable_amount, splashing = 0) //CHOMPEdit
	...
	if(istype(item_storage, /obj/item/dogborg/sleeper)) // CHOMPEdit - Removal of obj/item/device
		if(istype(src, /obj/item/pda)) // CHOMPEdit - Removal of obj/item/device
			var/obj/item/pda/P = src // CHOMPEdit - Removal of obj/item/device
			if(P.id)
				P.id = null
		...
		for(var/obj/item/O in contents)
			if(istype(O, /obj/item/storage/internal)) //Dump contents from dummy pockets. // CHOMPEdit - Removal of obj/item/weapon
	...
	if(digest_stage <= 0)
		...
		//CHOMPEdit End
			...
			if(istype(src, /obj/item/reagent_containers/food)) // CHOMPEdit - Removal of obj/item/weapon
				...
				if(istype(src,/obj/item/reagent_containers/food/snacks)) // CHOMPEdit - Removal of obj/item/weapon
					var/obj/item/reagent_containers/food/snacks/goodmeal = src //What a typecast // CHOMPEdit - Removal of obj/item/weapon
...
/////////////
/obj/item/hand_tele/digest_act(var/atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/weapon
	return FALSE
/obj/item/aicard/digest_act(var/atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/device
	return FALSE
/obj/item/paicard/digest_act(var/atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/device
	return FALSE
/obj/item/gun/digest_act(var/atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/weapon
	return FALSE
/obj/item/pinpointer/digest_act(var/atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/weapon
	return FALSE
/obj/item/areaeditor/blueprints/digest_act(var/atom/movable/item_storage = null)
	return FALSE
/obj/item/disk/nuclear/digest_act(var/atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/weapon
	return FALSE
/obj/item/perfect_tele_beacon/digest_act(var/atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/card/id/digest_act(atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/weapon
...
/*obj/item/reagent_containers/food/digest_act(atom/movable/item_storage = null) //CHOMPEdit: Included in main proc above. // CHOMPEdit - Removal of obj/item/weapon
	if(isbelly(item_storage))
...
/obj/item/holder/digest_act(atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/digest_act(atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/rawnutrition/digest_act(atom/movable/item_storage = null) //CHOMPAdd // CHOMPEdit - Removal of obj/item/weapon
	if(isbelly(item_storage))
		var/obj/belly/B = item_storage
...
/////////////
/obj/item/mmi/digital/posibrain/digest_act(atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/device
