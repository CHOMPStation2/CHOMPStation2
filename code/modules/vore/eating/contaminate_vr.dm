...
//////////////
/obj/item/card/id/gurgle_contaminate(var/atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/weapon
	digest_act(item_storage) //Contamination and digestion does same thing to these
	return TRUE

/obj/item/pda/gurgle_contaminate(var/atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/device
	return FALSE

/obj/item/reagent_containers/food/gurgle_contaminate(var/atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/weapon
	return FALSE

/obj/item/storage/vore_egg/gurgle_contaminate(var/atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/weapon
	return FALSE

/obj/item/holder/gurgle_contaminate(var/atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/weapon
	if(isbelly(loc))
...
/obj/item/cell/gurgle_contaminate(var/atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/weapon
	if(!gurgled)
	//Don't make them wet, just drain
		var/obj/item/cell/C = src // CHOMPEdit - Removal of obj/item/weapon
		C.charge = 0
	return TRUE

/obj/item/storage/box/gurgle_contaminate(var/atom/movable/item_storage = null) // CHOMPEdit - Removal of obj/item/weapon
	if((. = ..()))
		name = "soggy [cleanname]"
		desc = "This soggy box is about to fall apart any time."

//Storages that contaminate contents
/obj/item/storage/backpack/gurgle_contaminate(var/atom/movable/item_storage = null, var/contamination_flavor = "Generic", var/contamination_color = "green") // CHOMPEdit - Removal of obj/item/weapon
	if(contents)
		for(var/obj/item/O in contents)
			O.gurgle_contaminate(item_storage, contamination_flavor, contamination_color)
	..()

/obj/item/storage/belt/gurgle_contaminate(var/atom/movable/item_storage = null, var/contamination_flavor = "Generic", var/contamination_color = "green") // CHOMPEdit - Removal of obj/item/weapon
	if(contents)
		for(var/obj/item/O in contents)
			O.gurgle_contaminate(item_storage, contamination_flavor, contamination_color)
	..()
