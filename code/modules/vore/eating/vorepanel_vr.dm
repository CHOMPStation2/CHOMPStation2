...
>>>>>>> 295ae0f235... fix belly text sanity (#16215)
				...
				if("im_digest")
					...
					if(new_message)
						host.vore_selected.set_messages(new_message,"im_digest", limit = MAX_MESSAGE_LEN / 2)
				...
				if("im_hold")
					...
					if(new_message)
						host.vore_selected.set_messages(new_message,"im_hold", limit = MAX_MESSAGE_LEN / 2)
				...
				if("im_holdabsorbed")
					...
					if(new_message)
						host.vore_selected.set_messages(new_message,"im_holdabsorbed", limit = MAX_MESSAGE_LEN / 2)
				...
				if("im_absorb")
					...
					if(new_message)
						host.vore_selected.set_messages(new_message,"im_absorb", limit = MAX_MESSAGE_LEN / 2)
				...
				if("im_heal")
					...
					if(new_message)
						host.vore_selected.set_messages(new_message,"im_heal", limit = MAX_MESSAGE_LEN / 2)
				...
				if("im_drain")
					...
					if(new_message)
						host.vore_selected.set_messages(new_message,"im_drain", limit = MAX_MESSAGE_LEN / 2)
				...
				if("im_steal")
					...
					if(new_message)
						host.vore_selected.set_messages(new_message,"im_steal", limit = MAX_MESSAGE_LEN / 2)
				...
				if("im_egg")
					...
					if(new_message)
						host.vore_selected.set_messages(new_message,"im_egg", limit = MAX_MESSAGE_LEN / 2)
				...
				if("im_shrink")
					...
					if(new_message)
						host.vore_selected.set_messages(new_message,"im_shrink", limit = MAX_MESSAGE_LEN / 2)
				...
				if("im_grow")
					...
					if(new_message)
						host.vore_selected.set_messages(new_message,"im_grow", limit = MAX_MESSAGE_LEN / 2)
				...
				if("im_unabsorb")
					...
					if(new_message)
						host.vore_selected.set_messages(new_message,"im_unabsorb", limit = MAX_MESSAGE_LEN / 2)
