...
/mob/living/proc/escapeOOC()
	...
	if(isbelly(loc))
		...
		if(istype(src, /mob/living/simple_mob/vore/morph/dominated_prey))
			...
			return
		var/obj/belly/B = loc
		var/confirm = tgui_alert(src, "Please feel free to use this button at any time you are uncomfortable and in a belly. Consent is important.", "Confirmation", list("Okay", "Cancel")) //CHOMPedit
