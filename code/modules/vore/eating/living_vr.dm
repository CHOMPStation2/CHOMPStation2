...
/mob/living/proc/lick(mob/living/tasted in living_mobs_in_view(1, TRUE)) //CHOMPEdit
	...
	if(tasted == src) //CHOMPEdit Start
		visible_message("<span class='vwarning'>[src] licks themself!</span>","<span class='vwarning'>You lick yourself. You taste rather like [tasted.get_taste_message()].</span>")
		balloon_alert_visible("Licks themself!", "Tastes like [tasted.get_taste_message()]")
	else
		visible_message("<span class='vwarning'>[src] licks [tasted]!</span>","<span class='vwarning'>You lick [tasted]. They taste rather like [tasted.get_taste_message()].</span>")
