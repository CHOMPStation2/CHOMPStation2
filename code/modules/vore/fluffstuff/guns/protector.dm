...
/obj/item/weapon/gun/energy/protector
	...
	desc = "The HI-98a 'Protector' is the first firearm custom-designed for Nanotrasen by Hephaestus Industries. It features a powerful stun mode, and \
	...
	description_fluff = "The first 'commission' from Hephaestus Industries for NanoTrasen, this gun has a wireless connection to the computer's datacore to ensure it can't be used without authorization from heads of staff who have raised the alert level. Until then, *click*!"
