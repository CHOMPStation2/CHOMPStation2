...
/obj/item/implant/reagent_generator/tempest // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/implanter/reagent_generator/tempest // CHOMPEdit - Removal of obj/item/weapon
	implant_type = /obj/item/implant/reagent_generator/tempest // CHOMPEdit - Removal of obj/item/weapon


//Hottokeeki: Belle Day
/obj/item/implant/reagent_generator/belle // CHOMPEdit - Removal of obj/item/weapon
	generated_reagents = list("milk" = 2)
	reagent_name = "milk"
	usable_volume = 5000
...
/obj/item/implanter/reagent_generator/belle // CHOMPEdit - Removal of obj/item/weapon
	implant_type = /obj/item/implant/reagent_generator/belle // CHOMPEdit - Removal of obj/item/weapon

//Gowst: Eldi Moljir
//Eldi iz coolest elf-dorf.
/obj/item/implant/reagent_generator/eldi // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/implanter/reagent_generator/eldi // CHOMPEdit - Removal of obj/item/weapon
	implant_type = /obj/item/implant/reagent_generator/eldi // CHOMPEdit - Removal of obj/item/weapon

//Vorrarkul: Theodora Lindt
/obj/item/implant/reagent_generator/vorrarkul // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/implanter/reagent_generator/vorrarkul // CHOMPEdit - Removal of obj/item/weapon
	implant_type = /obj/item/implant/reagent_generator/vorrarkul // CHOMPEdit - Removal of obj/item/weapon

//Lycanthorph: Savannah Dixon
/obj/item/implant/reagent_generator/savannah // CHOMPEdit - Removal of obj/item/weapon
	generated_reagents = list("milk" = 2)
	reagent_name = "milk"
	usable_volume = 1000
...
/obj/item/implanter/reagent_generator/savannah // CHOMPEdit - Removal of obj/item/weapon
	implant_type = /obj/item/implant/reagent_generator/savannah // CHOMPEdit - Removal of obj/item/weapon

//SpoopyLizz: Roiz Lizden
//I made this! Woo!
//implant
//--------------------
/obj/item/implant/reagent_generator/roiz // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/implant/reagent_generator/roiz/post_implant(mob/living/carbon/source) // CHOMPEdit - Removal of obj/item/weapon
	START_PROCESSING(SSobj, src)
	to_chat(source, "<span class='notice'>You implant [source] with \the [src].</span>")
	add_verb(source,assigned_proc) //CHOMPEdit TGPanel
	return 1

/obj/item/implanter/reagent_generator/roiz // CHOMPEdit - Removal of obj/item/weapon
	implant_type = /obj/item/implant/reagent_generator/roiz // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/carbon/human/proc/use_reagent_implant_roiz()
	...
	var/obj/item/implant/reagent_generator/roiz/rimplant // CHOMPEdit - Removal of obj/item/weapon
	...
	if (rimplant)
		...
		new /obj/item/reagent_containers/food/snacks/egg/roiz(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/implant/reagent_generator/jasmine // CHOMPEdit - Removal of obj/item/weapon
	name = "egg laying implant"
	desc = "This is an implant that allows the user to lay eggs."
	generated_reagents = list("egg" = 2)
	usable_volume = 500
...
/obj/item/implant/reagent_generator/jasmine/post_implant(mob/living/carbon/source) // CHOMPEdit - Removal of obj/item/weapon
	START_PROCESSING(SSobj, src)
	to_chat(source, "<span class='notice'>You implant [source] with \the [src].</span>")
	add_verb(source,assigned_proc) //CHOMPEdit TGPanel
	return 1

/obj/item/implanter/reagent_generator/jasmine // CHOMPEdit - Removal of obj/item/weapon
	implant_type = /obj/item/implant/reagent_generator/jasmine // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/carbon/human/proc/use_reagent_implant_jasmine()
	...
	var/obj/item/implant/reagent_generator/jasmine/rimplant // CHOMPEdit - Removal of obj/item/weapon
	for(var/obj/item/organ/external/E in organs)
		for(var/obj/item/implant/I in E.implants) // CHOMPEdit - Removal of obj/item/weapon
			if(istype(I, /obj/item/implant/reagent_generator)) // CHOMPEdit - Removal of obj/item/weapon
				rimplant = I
...
//Draycu: Schae Yonra
/obj/item/implant/reagent_generator/yonra // CHOMPEdit - Removal of obj/item/weapon
	name = "egg laying implant"
	desc = "This is an implant that allows the user to lay eggs."
	generated_reagents = list("egg" = 2)
	usable_volume = 500
...
/obj/item/implant/reagent_generator/yonra/post_implant(mob/living/carbon/source) // CHOMPEdit - Removal of obj/item/weapon
	START_PROCESSING(SSobj, src)
	to_chat(source, "<span class='notice'>You implant [source] with \the [src].</span>")
	add_verb(source,assigned_proc) //CHOMPEdit TGPanel
	return 1

/obj/item/implanter/reagent_generator/yonra // CHOMPEdit - Removal of obj/item/weapon
	implant_type = /obj/item/implant/reagent_generator/yonra // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/carbon/human/proc/use_reagent_implant_yonra()
	...
	var/obj/item/implant/reagent_generator/yonra/rimplant // CHOMPEdit - Removal of obj/item/weapon
	for(var/obj/item/organ/external/E in organs)
		for(var/obj/item/implant/I in E.implants) // CHOMPEdit - Removal of obj/item/weapon
			if(istype(I, /obj/item/implant/reagent_generator)) // CHOMPEdit - Removal of obj/item/weapon
				rimplant = I
	...
	if (rimplant)
		...
		new /obj/item/reagent_containers/food/snacks/egg/teshari(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/egg/teshari // CHOMPEdit - Removal of obj/item/weapon
	name = "teshari egg"
...
/obj/item/reagent_containers/food/snacks/egg/teshari/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	reagents.add_reagent("egg", 10)
	bitesize = 2

/obj/item/reagent_containers/food/snacks/egg/teshari/tesh2 // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "tesh_egg_2"

//Konabird: Rischi
/obj/item/implant/reagent_generator/rischi // CHOMPEdit - Removal of obj/item/weapon
	name = "egg laying implant"
	desc = "This is an implant that allows the user to lay eggs."
	generated_reagents = list("egg" = 2)
...
/obj/item/implant/reagent_generator/rischi/post_implant(mob/living/carbon/source) // CHOMPEdit - Removal of obj/item/weapon
	START_PROCESSING(SSobj, src)
	to_chat(source, "<span class='notice'>You implant [source] with \the [src].</span>")
	add_verb(source,assigned_proc) //CHOMPEdit TGPanel
	return 1

/obj/item/implanter/reagent_generator/rischi // CHOMPEdit - Removal of obj/item/weapon
	implant_type = /obj/item/implant/reagent_generator/rischi // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/carbon/human/proc/use_reagent_implant_rischi()
	...
	var/obj/item/implant/reagent_generator/rischi/rimplant // CHOMPEdit - Removal of obj/item/weapon
	for(var/obj/item/organ/external/E in organs)
		for(var/obj/item/implant/I in E.implants) // CHOMPEdit - Removal of obj/item/weapon
			if(istype(I, /obj/item/implant/reagent_generator)) // CHOMPEdit - Removal of obj/item/weapon
				rimplant = I
	...
	if (rimplant)
		...
		new /obj/item/reagent_containers/food/snacks/egg/teshari/tesh2(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
...
/*
/obj/item/implant/reagent_generator/pumila_nectar //Bugged. Two implants at once messes things up. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/implanter/reagent_generator/pumila_nectar // CHOMPEdit - Removal of obj/item/weapon
	implant_type = /obj/item/implant/reagent_generator/pumila_nectar // CHOMPEdit - Removal of obj/item/weapon
*/
//Egg item
//-------------
/obj/item/reagent_containers/food/snacks/egg/roiz // CHOMPEdit - Removal of obj/item/weapon
	name = "lizard egg"
...
/obj/item/reagent_containers/food/snacks/egg/roiz/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	reagents.add_reagent("egg", 9)
	bitesize = 2

/obj/item/reagent_containers/food/snacks/egg/roiz/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/friedegg/roiz // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/friedegg/roiz/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	reagents.add_reagent("protein", 9)
	bitesize = 2

/obj/item/reagent_containers/food/snacks/boiledegg/roiz // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/boiledegg/roiz/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	reagents.add_reagent("protein", 6)
	bitesize = 2

/obj/item/reagent_containers/food/snacks/chocolateegg/roiz // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/chocolateegg/roiz/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/implant/reagent_generator/evian // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/implant/reagent_generator/evian/post_implant(mob/living/carbon/source) // CHOMPEdit - Removal of obj/item/weapon
	START_PROCESSING(SSobj, src)
	to_chat(source, "<span class='notice'>You implant [source] with \the [src].</span>")
	add_verb(source,assigned_proc) //CHOMPEdit TGPanel
	return 1

/obj/item/implanter/reagent_generator/evian // CHOMPEdit - Removal of obj/item/weapon
	implant_type = /obj/item/implant/reagent_generator/evian // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/carbon/human/proc/use_reagent_implant_evian()
	...
	var/obj/item/implant/reagent_generator/evian/rimplant // CHOMPEdit - Removal of obj/item/weapon
	for(var/obj/item/organ/external/E in organs)
		for(var/obj/item/implant/I in E.implants) // CHOMPEdit - Removal of obj/item/weapon
			if(istype(I, /obj/item/implant/reagent_generator)) // CHOMPEdit - Removal of obj/item/weapon
				rimplant = I
	...
	if (rimplant)
		...
		new /obj/item/reagent_containers/food/snacks/egg/roiz/evian(get_turf(src)) //Roiz/evian so it gets all the functionality // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/egg/roiz/evian // CHOMPEdit - Removal of obj/item/weapon
	name = "dragon egg"
	desc = "A quite large dragon egg!"
	icon_state = "egg_roiz_yellow"


/obj/item/reagent_containers/food/snacks/egg/roiz/evian/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype( W, /obj/item/pen/crayon)) //No coloring these ones! // CHOMPEdit - Removal of obj/item/weapon
		return
	else
		..()
