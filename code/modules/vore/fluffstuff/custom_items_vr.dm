...
/* TEMPLATE
//ckey:Character Name
/obj/item/fluff/charactername // CHOMPEdit - Removal of obj/item/weapon
	name = ""
	desc = ""
...
/obj/item/modkit_conversion // CHOMPEdit - Removal of obj/item/device
	...
	//Conversion proc
/obj/item/modkit_conversion/afterattack(obj/O, mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	var/cost
	var/to_type
	var/keycheck
	...
	if(skip_content_check && transfer_contents)
		...
		if(istype(N,/obj/item/gun/projectile/)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/gun/projectile/NN = N // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/gun/projectile/OO = O // CHOMPEdit - Removal of obj/item/weapon
			NN.magazine_type = OO.magazine_type
			NN.ammo_magazine = OO.ammo_magazine
		if(istype(N,/obj/item/gun/energy/)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/gun/energy/NE = N // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/gun/energy/OE = O // CHOMPEdit - Removal of obj/item/weapon
			NE.cell_type = OE.cell_type
	else
		if(istype(N,/obj/item/gun/projectile/)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/gun/projectile/NM = N // CHOMPEdit - Removal of obj/item/weapon
			NM.contents = list()
			NM.magazine_type = null
			NM.ammo_magazine = null
		if(istype(N,/obj/item/gun/energy/)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/gun/energy/NO = N // CHOMPEdit - Removal of obj/item/weapon
			NO.contents = list()
			NO.cell_type = null
...
//DEBUG ITEM
/obj/item/modkit_conversion/fluff/debug_gunkit // CHOMPEdit - Removal of obj/item/device
	...
	from_helmet = /obj/item/gun/energy/laser // CHOMPEdit - Removal of obj/item/weapon
	to_helmet = /obj/item/gun/energy/retro // CHOMPEdit - Removal of obj/item/weapon
//DEBUG ITEM ENDS

//JoanRisu:Joan Risu
/obj/item/flame/lighter/zippo/fluff/joan // CHOMPEdit - Removal of obj/item/weapon
...
//JoanRisu:Joan Risu
/obj/item/sword/fluff/joanaria // CHOMPEdit - Removal of obj/item/weapon
	name = "Aria"
...
/obj/item/sword/fluff/joanaria/handle_shield(mob/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, var/attack_text = "the attack") // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/knife/tacknife/combatknife/fluff/katarina // CHOMPEdit - Removal of obj/item/weapon
	name = "tactical Knife"
	desc = "A tactical knife with a small butterly engraved on the blade."

/obj/item/material/knife/tacknife/combatknife/fluff/katarina/handle_shield(mob/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, var/attack_text = "the attack") // CHOMPEdit - Removal of obj/item/weapon
...
//JoanRisu:Joan Risu
/obj/item/card/id/centcom/station/fluff/joanbadge // CHOMPEdit - Removal of obj/item/weapon
	name = "Faded Badge"
...
/obj/item/card/id/centcom/station/fluff/joanbadge/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(isliving(user))
...
/obj/item/card/id/centcom/station/fluff/joanbadge/attack(mob/living/carbon/human/M, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(isliving(user))
...
//JoanRisu:Joan Risu
/obj/item/pda/heads/hos/joanpda // CHOMPEdit - Removal of obj/item/device
	icon = 'icons/vore/custom_items_vr.dmi'
	icon_state = "pda-joan"

//Vorrarkul:Lucina Dakarim
/obj/item/pda/heads/cmo/fluff/lucinapda // CHOMPEdit - Removal of obj/item/device
	icon = 'icons/vore/custom_items_vr.dmi'
	icon_state = "pda-lucina"

//john.wayne9392:Harmony Prechtl
/obj/item/modkit_conversion/fluff/harmonyspace // CHOMPEdit - Removal of obj/item/device
...
//john.wayne9392:Harmony Prechtl
/obj/item/modkit_conversion/fluff/harmonysuit // CHOMPEdit - Removal of obj/item/device
...
//scree:Scree
/obj/item/modkit_conversion/fluff/screekit // CHOMPEdit - Removal of obj/item/device
...
//General Use
/obj/item/flag // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flag/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(isliving(user))
...
/obj/item/flag/attack(mob/living/carbon/human/M, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(isliving(user))
		user.visible_message("<span class='warning'>[user] invades [M]'s personal space, thrusting [src] into their face insistently.</span>","<span class='warning'>You invade [M]'s personal space, thrusting [src] into their face insistently.</span>")


/obj/item/flag/federation // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flag/xcom // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flag/advent // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/radio/headset/fluff/zodiacshadow // CHOMPEdit - Removal of obj/item/device
	name = "Nehi's 'phones"
...
/obj/item/melee/fluff/holochain // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/fluff/id_kit_mime/afterattack(obj/O, mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	var/new_icon = "mime"
	if(istype(O,/obj/item/card/id) && O.icon_state != new_icon) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/card/id/centcom/station/fluff/aronai // CHOMPEdit - Removal of obj/item/weapon
	registered_name = "CONFIGURE ME"
	assignment = "CC Medical"
	var/configured = 0

/obj/item/card/id/centcom/station/fluff/aronai/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(configured)
		return ..()
...
/obj/item/storage/backpack/satchel/fluff/swat43bag // CHOMPEdit - Removal of obj/item/weapon
...
//SilencedMP5A5:Serdykov Antoz
/obj/item/modkit_conversion/fluff/serdykit // CHOMPEdit - Removal of obj/item/device
...
/obj/item/paper/khcrystal_manual // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/box/khcrystal // CHOMPEdit - Removal of obj/item/weapon
	...
	storage_slots = 2
	can_hold = list(/obj/item/paper/khcrystal_manual, /obj/item/clothing/accessory/collar/khcrystal) // CHOMPEdit - Removal of obj/item/weapon
	max_storage_space = ITEMSIZE_COST_SMALL * 2
	w_class = ITEMSIZE_SMALL

/obj/item/storage/box/khcrystal/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	new /obj/item/paper/khcrystal_manual(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/clothing/accessory/collar/khcrystal(src)

/obj/item/cane/fluff // CHOMPEdit - Removal of obj/item/weapon
	name = "cane"
...
/obj/item/fluff/id_kit_ivy // CHOMPEdit - Removal of obj/item/device
	name = "Holo-ID reprinter"
	desc = "Stick your ID in one end and it'll print a new ID out the other!"
	icon = 'icons/obj/bureaucracy.dmi'
	icon_state = "labeler1"

/obj/item/fluff/id_kit_ivy/afterattack(obj/O, mob/user as mob) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/reagent_containers/hypospray/vial/tempest // CHOMPEdit - Removal of obj/item/weapon
...
//WickedTempest: Chakat Tempest
/obj/item/storage/backpack/saddlebag/tempest // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/backpack/saddlebag/tempest/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	soundloop = new(list(src), FALSE)
	return ..()

/obj/item/storage/backpack/saddlebag/tempest/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	QDEL_NULL(soundloop)
	return ..()

/obj/item/storage/backpack/saddlebag/tempest/ui_action_click() // CHOMPEdit - Removal of obj/item/weapon
	ambulance = !(ambulance)
	if(ambulance)
		START_PROCESSING(SSobj, src)
...
/obj/item/storage/backpack/saddlebag/tempest/process() // CHOMPEdit - Removal of obj/item/weapon
	if(!ambulance)
		STOP_PROCESSING(SSobj, src)
		return
...
/obj/item/fluff/dragor_dot // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/fluff/dragor_dot/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/backpack/messenger/black/fluff/briana // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/bible/fluff/amina // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/card/id/event/fluff/amaya // CHOMPEdit - Removal of obj/item/weapon
	registered_name = "CONFIGURE ME"
...
/obj/item/card/id/fluff/xennith // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/fluff/injector //Injectors. Custom item used to explain wild changes in a mob's body or chemistry. // CHOMPEdit - Removal of obj/item/weapon
	name = "Injector"
	desc = "Some type of injector."
	icon = 'icons/obj/items.dmi'
	icon_state = "dnainjector"

/obj/item/fluff/injector/monkey // CHOMPEdit - Removal of obj/item/weapon
	name = "Lesser Form Injector"
	desc = "Turn the user into their lesser, more primal form."

/obj/item/fluff/injector/monkey/attack(mob/living/M, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/fluff/injector/numb_bite // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/fluff/injector/numb_bite/attack(mob/living/M, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/twohanded/fluff //Twohanded fluff items. // CHOMPEdit - Removal of obj/item/weapon
	name = "fluff."
...
/obj/item/material/twohanded/fluff/New(var/newloc) // CHOMPEdit - Removal of obj/item/weapon
	..(newloc," ") //See materials_vr_dmi for more information as to why this is a blank space.

//jacknoir413:Areax Third
/obj/item/melee/baton/fluff/stunstaff // CHOMPEdit - Removal of obj/item/weapon
	name = "Electrostaff"
...
/obj/item/melee/baton/fluff/stunstaff/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	bcell = new/obj/item/cell/device/weapon(src) // CHOMPEdit - Removal of obj/item/weapon
	update_icon()
	return

/obj/item/melee/baton/fluff/stunstaff/update_held_icon() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/melee/baton/fluff/stunstaff/handle_shield(mob/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, var/attack_text = "the attack") // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/melee/baton/fluff/stunstaff/update_icon() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/melee/baton/fluff/stunstaff/dropped() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(wielded)
		wielded = 0
		spawn(0)
...
/obj/item/melee/baton/fluff/stunstaff/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/backpack/fluff/stunstaff // CHOMPEdit - Removal of obj/item/weapon
	...
	can_hold = list(/obj/item/melee/baton/fluff/stunstaff) // CHOMPEdit - Removal of obj/item/weapon

	w_class = ITEMSIZE_HUGE
	max_w_class = ITEMSIZE_HUGE
	max_storage_space = 16

/obj/item/storage/backpack/fluff/stunstaff/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	new /obj/item/melee/baton/fluff/stunstaff(src) // CHOMPEdit - Removal of obj/item/weapon


/*
 * Awoo Sword
 */
/obj/item/melee/fluffstuff // CHOMPEdit - Removal of obj/item/weapon
	var/active = 0
	var/active_force
...
/obj/item/melee/fluffstuff/proc/activate(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(active)
		return
	active = 1
...
/obj/item/melee/fluffstuff/proc/deactivate(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!active)
		return
	playsound(src, 'sound/weapons/sparkle.ogg', 50, 1)
	active = 0
...
/obj/item/melee/fluffstuff/attack_self(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if (active)
...
/obj/item/melee/fluffstuff/wolfgirlsword // CHOMPEdit - Removal of obj/item/weapon
	...
	allowed = list(/obj/item/shield/fluff/wolfgirlshield) // CHOMPEdit - Removal of obj/item/weapon
	damtype = HALLOSS

/obj/item/melee/fluffstuff/wolfgirlsword/dropped(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(!istype(loc,/mob))
		deactivate(user)

/obj/item/melee/fluffstuff/wolfgirlsword/activate(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!active)
...
/obj/item/melee/fluffstuff/wolfgirlsword/deactivate(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(active)
...
//SilencedMP5A5 - Serdykov Antoz
/obj/item/modkit_conversion/hasd // CHOMPEdit - Removal of obj/item/device
...
/obj/item/borg/upgrade/modkit/chassis_mod/kai/install(obj/item/gun/energy/kinetic_accelerator/KA, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	KA.desc = chassis_desc
	KA.icon = chassis_icon_file
	..()
/obj/item/borg/upgrade/modkit/chassis_mod/kai/uninstall(obj/item/gun/energy/kinetic_accelerator/KA) // CHOMPEdit - Removal of obj/item/weapon
	KA.desc = initial(KA.desc)
	KA.icon = initial(KA.icon)
	..()

//ArgobargSoup:Lynn Shady
/obj/item/flashlight/pen/fluff/lynn // CHOMPEdit - Removal of obj/item/device
...
//lm40 - Kenzie Houser
/obj/item/reagent_containers/hypospray/vial/kenzie // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/flask/vacuumflask/fluff/viktor // CHOMPEdit - Removal of obj/item/weapon
	name = "flask of expensive alcohol"
	desc = "A standard vacuum-flask filled with good and expensive drink."

/obj/item/reagent_containers/food/drinks/flask/vacuumflask/fluff/viktor/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/rig/nikki/attackby(obj/item/W, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/nikki/mob_can_equip(var/mob/living/carbon/human/M, slot, disable_warning = 0) // Feel free to (try to) put Nikki's hat on! The necklace though is a flat-out no-go. // CHOMPEdit - Removal of obj/item/weapon
	if(..())
		if (M.ckey == "ryumi")
			return 1
...
//Rboys2 - Clara Mali
/obj/item/reagent_containers/food/drinks/glass2/fluff/claraflask // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/glass2/fluff/claraflask/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("tea", 40)
	reagents.add_reagent("milk", 20)

/obj/item/reagent_containers/food/drinks/glass2/fluff/claraflask/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
	name = initial(name)
	desc = initial(desc)

/*Begin CHOMP Removal //Vitoras: Verie
/obj/item/fluff/verie // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/fluff/verie/attack_self(mob/living/carbon/human/user) // CHOMPEdit - Removal of obj/item/weapon
	if (istype(user))
...
// Astra - // Astra
/obj/item/material/knife/ritual/fluff/astra // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/fancy/fluff/charlotte // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/fancy/fluff/charlotte/New() // CHOMPEdit - Removal of obj/item/weapon
	if(!open_state)
...
/obj/item/storage/fancy/fluff/charlotte/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	cut_overlays()
	if(open)
...
/obj/item/storage/fancy/fluff/charlotte/open(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(open)
		return
	open = TRUE
	update_icon()
...
/obj/item/storage/fancy/fluff/charlotte/close(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	open = FALSE
	update_icon()
	..()

//Ashling - Antoinette deKaultieste
/obj/item/material/knife/machete/hatchet/unathiknife/fluff/antoinette // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/glass/bottle/poppy // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/clothing/accessory/storage/ritualharness/fluff/antoinette/Initialize()
	...
	hold.can_hold = list(/obj/item/material/knife, /obj/item/reagent_containers/glass/bottle) // CHOMPEdit - Removal of obj/item/weapon

	new /obj/item/material/knife/machete/hatchet/unathiknife/fluff/antoinette(hold) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/reagent_containers/glass/bottle/poppy(hold) // CHOMPEdit - Removal of obj/item/weapon

//Hunterbirk - Amaryll
//This is a 'technical item' which basically is meant to represent rippiing things up with bare claws.
/obj/item/surgical/scalpel/amaryll_claws // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/stamp/fluff/jade_horror // CHOMPEdit - Removal of obj/item/weapon
...
//Coolcrow420 - M41l
/obj/item/implant/language/fluff/m41l // CHOMPEdit - Removal of obj/item/weapon
	name = "dusty hard drive"
	desc = "A hard drive containing knowledge of various languages."

/obj/item/implant/language/fluff/m41l/post_implant(mob/M) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/sword/fluff/revolver // CHOMPEdit - Removal of obj/item/weapon
	name = "Catnip"
...
/obj/item/dice/loaded/ceph // CHOMPEdit - Removal of obj/item/weapon
	name = "engraved d6"
...
/obj/item/dice/loaded/ceph/rollDice(mob/user, silent) // CHOMPEdit - Removal of obj/item/weapon
	..()
	icon_state = "ceph_d6[result]"

/obj/item/dice/loaded/ceph/New() // CHOMPEdit - Removal of obj/item/weapon
