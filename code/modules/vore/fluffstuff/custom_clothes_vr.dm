...
//				/obj/item/device/detective_scanner,
	...
	armor = list(melee = 0, bullet = 0, laser = 0, energy = 0, bomb = 0, bio = 10, rad = 0) //CHOMPEdit: Changed armor values to match security armor vest.
	var/unbuttoned = 0
...
/obj/item/clothing/suit/storage/fluff/fedcoat/fedeng
	...
	icon_state = "fedeng"
	item_state = "fedeng"
	armor = list(melee = 0, bullet = 0, laser = 0, energy = 10, bomb = 0, bio = 10, rad = 0)
