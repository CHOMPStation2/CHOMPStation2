...
/datum/design_techweb/mechfab/ripley/chassis
	...
	materials = list(MAT_STEEL = MATERIAL_COST(7.5))

/datum/design_techweb/mechfab/ripley/torso
	name = "Ripley Torso"
	id = "ripley_torso"
	build_path = /obj/item/mecha_parts/part/ripley_torso
	materials = list(MAT_STEEL = MATERIAL_COST(15), MAT_GLASS = MATERIAL_COST(5.625))
...
/datum/design_techweb/mechfab/ripley/left_leg
	...
	materials = list(MAT_STEEL = MATERIAL_COST(11.25))
...
/datum/design_techweb/mechfab/odysseus/head
	...
	materials = list(MAT_STEEL = MATERIAL_COST(0.75), MAT_GLASS = MATERIAL_COST(3.75))
...
/datum/design_techweb/mechfab/gygax/chassis/serenity
	...
	materials = list(MAT_STEEL = MATERIAL_COST(9.375), MAT_PHORON = MATERIAL_COST(2))
...
/datum/design_techweb/mechfab/gygax/torso
	...
	materials = list(MAT_STEEL = MATERIAL_COST(18.75), MAT_GLASS = MATERIAL_COST(7.5))

/datum/design_techweb/mechfab/gygax/head
	name = "Gygax Head"
	id = "gygax_head"
	build_path = /obj/item/mecha_parts/part/gygax_head
	materials = list(MAT_STEEL = MATERIAL_COST(7.5), MAT_GLASS = MATERIAL_COST(3.75))
...
/datum/design_techweb/mechfab/gygax/left_leg
	...
	materials = list(MAT_STEEL = MATERIAL_COST(13.125))
...
/datum/design_techweb/mechfab/gygax/armour
	...
	materials = list(MAT_STEEL = MATERIAL_COST(18.75), MAT_DIAMOND = MATERIAL_COST(3.75))
...
/datum/design_techweb/mechfab/durand/durand_main
	...
	id = "durand_main"
	// req_tech = list(TECH_DATA = 4)
	materials = list(MAT_GLASS = MATERIAL_COST(1), MAT_GRAPHITE = 1250)
...
/datum/design_techweb/mechfab/durand/chassis
	...
	materials = list(MAT_STEEL = MATERIAL_COST(9.375), MAT_PLASTEEL = MATERIAL_COST(10))

/datum/design_techweb/mechfab/durand/torso
	name = "Durand Torso"
	id = "durand_torso"
	build_path = /obj/item/mecha_parts/part/durand_torso
	materials = list(MAT_STEEL = MATERIAL_COST(20.625), MAT_PLASTEEL = MATERIAL_COST(7.5), MAT_SILVER = MATERIAL_COST(3.75))

/datum/design_techweb/mechfab/durand/head
	name = "Durand Head"
	id = "durand_head"
	build_path = /obj/item/mecha_parts/part/durand_head
	materials = list(MAT_STEEL = MATERIAL_COST(9.375), MAT_GLASS = MATERIAL_COST(3.75), MAT_SILVER = MATERIAL_COST(1.125))

/datum/design_techweb/mechfab/durand/left_arm
	name = "Durand Left Arm"
	id = "durand_left_arm"
	build_path = /obj/item/mecha_parts/part/durand_left_arm
	materials = list(MAT_STEEL = MATERIAL_COST(13.125), MAT_SILVER = MATERIAL_COST(1.125))
...
/datum/design_techweb/mechfab/durand/left_leg
	...
	materials = list(MAT_STEEL = MATERIAL_COST(15), MAT_SILVER = MATERIAL_COST(1.125))
...
/datum/design_techweb/mechfab/durand/armour
	...
	materials = list(MAT_STEEL = MATERIAL_COST(13.75), MAT_PLASTEEL = MATERIAL_COST(5), MAT_URANIUM = MATERIAL_COST(3.75))
...
/datum/design_techweb/mechfab/janusmodule
	...
	id = "janus_module"
	// req_tech = list(TECH_MATERIAL = 7, TECH_BLUESPACE = 5, TECH_MAGNET = 6, TECH_PHORON = 3, TECH_ARCANE = 1, TECH_PRECURSOR = 2)
	materials = list(MAT_DURASTEEL = MATERIAL_COST(1.5), MAT_MORPHIUM = MATERIAL_COST(1), MAT_METALHYDROGEN = MATERIAL_COST(3), MAT_URANIUM = MATERIAL_COST(3), MAT_VERDANTIUM = MATERIAL_COST(0.75))
...
/datum/design_techweb/mechfab/janus/chassis
	...
	materials = list(MAT_DURASTEEL = MATERIAL_COST(9.5), MAT_MORPHIUM = MATERIAL_COST(5.25), MAT_PLASTEEL = MATERIAL_COST(2.75), MAT_LEAD = MATERIAL_COST(1.25))
...
/datum/design_techweb/mechfab/janus/torso
	...
	materials = list(MAT_STEEL = MATERIAL_COST(15), MAT_DURASTEEL = MATERIAL_COST(4), MAT_MORPHIUM = MATERIAL_COST(5), MAT_GOLD = MATERIAL_COST(2.5), MAT_VERDANTIUM = MATERIAL_COST(2.5))

/datum/design_techweb/mechfab/janus/head
	name = "Imperion Head"
	id = "janus_head"
	build_path = /obj/item/mecha_parts/part/janus_head
	materials = list(MAT_STEEL = MATERIAL_COST(15), MAT_DURASTEEL = MATERIAL_COST(1), MAT_MORPHIUM = MATERIAL_COST(3), MAT_GOLD = MATERIAL_COST(2.5))
...
/datum/design_techweb/mechfab/janus/left_arm
	...
	materials = list(MAT_STEEL = MATERIAL_COST(15), MAT_METALHYDROGEN = MATERIAL_COST(1.5), MAT_DURASTEEL = MATERIAL_COST(1), MAT_MORPHIUM = MATERIAL_COST(1.5), MAT_GOLD = MATERIAL_COST(2.5), MAT_DIAMOND = MATERIAL_COST(3.5))
...
/datum/design_techweb/mechfab/janus/left_leg
	...
	materials = list(MAT_STEEL = MATERIAL_COST(15), MAT_METALHYDROGEN = MATERIAL_COST(1.5), MAT_DURASTEEL = MATERIAL_COST(1), MAT_MORPHIUM = MATERIAL_COST(1.5), MAT_GOLD = MATERIAL_COST(2.5), MAT_URANIUM = MATERIAL_COST(3.5))
...
/datum/design_techweb/mechfab/janus/phase_coil
	...
	materials = list(MAT_SUPERMATTER = MATERIAL_COST(1), MAT_PLASTEEL = MATERIAL_COST(30), MAT_URANIUM = MATERIAL_COST(1.625), MAT_DURASTEEL = MATERIAL_COST(1), MAT_MORPHIUM = MATERIAL_COST(1.5), MAT_GOLD = MATERIAL_COST(2.5), MAT_VERDANTIUM = MATERIAL_COST(2.5), MAT_DIAMOND = MATERIAL_COST(5), MAT_LEAD = MATERIAL_COST(7.5))
...
/datum/design_techweb/mechfab/pinnace/chassis
	...
	materials = list(MAT_STEEL = MATERIAL_COST(12.5), MAT_GLASS = MATERIAL_COST(5), MAT_PLASTEEL = MATERIAL_COST(5))

/datum/design_techweb/mechfab/pinnace/core
	name = "Pinnace Core"
	id = "pinnace_core"
	build_path = /obj/item/mecha_parts/fighter/part/pinnace_core
	materials = list(MAT_STEEL = MATERIAL_COST(12.5), MAT_GLASS = MATERIAL_COST(3.5), MAT_PLASTEEL = MATERIAL_COST(3.5))
...
/datum/design_techweb/mechfab/pinnace/cockpit
	...
	materials = list(MAT_STEEL = MATERIAL_COST(1.25), MAT_PLASTEEL = MATERIAL_COST(1.25), MAT_GLASS = MATERIAL_COST(3.75), MAT_PLASTIC = MATERIAL_COST(1.25))
...
/datum/design_techweb/mechfab/pinnace/main_engine
	...
	materials = list(MAT_STEEL = MATERIAL_COST(7.5), MAT_PLASTEEL = MATERIAL_COST(2.5))
...
/datum/design_techweb/mechfab/pinnace/left_engine
	...
	materials = list(MAT_STEEL = MATERIAL_COST(5), MAT_PLASTEEL = MATERIAL_COST(1.25))
...
/datum/design_techweb/mechfab/pinnace/left_wing
	...
	materials = list(MAT_STEEL = MATERIAL_COST(3.5), MAT_PLASTIC = MATERIAL_COST(1.5), MAT_PLASTEEL = MATERIAL_COST(2.5))
...
/datum/design_techweb/mechfab/baron/chassis
	...
	materials = list(MAT_STEEL = MATERIAL_COST(18.75), MAT_GLASS = MATERIAL_COST(7.5), MAT_PLASTEEL = MATERIAL_COST(7.5))
...
/datum/design_techweb/mechfab/baron/cockpit
	...
	materials = list(MAT_STEEL = MATERIAL_COST(2.5), MAT_PLASTEEL = MATERIAL_COST(2.5), MAT_GLASS = MATERIAL_COST(5), MAT_PLASTIC = MATERIAL_COST(2.5))
...
/datum/design_techweb/mechfab/baron/main_engine
	...
	materials = list(MAT_STEEL = MATERIAL_COST(12.5), MAT_PLASTEEL = MATERIAL_COST(5))
...
/datum/design_techweb/mechfab/baron/left_engine
	...
	materials = list(MAT_STEEL = MATERIAL_COST(10), MAT_PLASTEEL = MATERIAL_COST(2.5))
...
/datum/design_techweb/mechfab/baron/left_wing
	...
	materials = list(MAT_STEEL = MATERIAL_COST(7.5), MAT_PLASTIC = MATERIAL_COST(3), MAT_PLASTEEL = MATERIAL_COST(5))
...
/datum/design_techweb/mechfab/exointernal/light_armor
	...
	materials = list(MAT_STEEL = MATERIAL_COST(2.5), MAT_PLASTIC = MATERIAL_COST(1.5))
...
/datum/design_techweb/mechfab/exointernal/reinf_armor
	...
	materials = list(MAT_STEEL = MATERIAL_COST(10), MAT_PLASTEEL = MATERIAL_COST(5))
...
/datum/design_techweb/mechfab/exointernal/gygax_armor
	...
	materials = list(MAT_STEEL = MATERIAL_COST(20), MAT_DIAMOND = MATERIAL_COST(4))
...
/datum/design_techweb/mechfab/exointernal/darkgygax_armor
	...
	materials = list(MAT_PLASTEEL = MATERIAL_COST(10), MAT_DIAMOND = MATERIAL_COST(5), MAT_GRAPHITE = 20000)
...
/datum/design_techweb/mechfab/exointernal/durand_armour
	...
	//req_tech = list(TECH_MATERIAL = 5, TECH_ENGINEERING = 4, TECH_COMBAT = 2)
	materials = list(MAT_STEEL = MATERIAL_COST(20), MAT_PLASTEEL = MATERIAL_COST(4.7625), MAT_URANIUM = MATERIAL_COST(4))
...
/datum/design_techweb/mechfab/exointernal/marauder_armour
	...
	materials = list(MAT_DURASTEEL = MATERIAL_COST(20), MAT_GRAPHITE = 8000, MAT_OSMIUM = MATERIAL_COST(4))
...
/datum/design_techweb/mechfab/exointernal/phazon_armour
	...
	materials = list(MAT_MORPHIUM = MATERIAL_COST(20), MAT_DURASTEEL = MATERIAL_COST(4), MAT_OSMIUM = MATERIAL_COST(4))
...
/datum/design_techweb/mechfab/exointernal/durable_hull
	...
	//req_tech = list(TECH_MATERIAL = 2, TECH_ENGINEERING = 2)
	materials = list(MAT_STEEL = MATERIAL_COST(4), MAT_PLASTEEL = MATERIAL_COST(2.5))
...
/datum/design_techweb/mechfab/exointernal/reinf_gas
	...
	//req_tech = list(TECH_MATERIAL = 4, TECH_ENGINEERING = 4)
	materials = list(MAT_STEEL = MATERIAL_COST(4), MAT_PLASTEEL = MATERIAL_COST(4), MAT_GRAPHITE = 1000)
...
/datum/design_techweb/mechfab/exointernal/stan_electric
	...
	materials = list(MAT_STEEL = MATERIAL_COST(2.5), MAT_PLASTIC = MATERIAL_COST(0.5))
...
/datum/design_techweb/mechfab/exointernal/efficient_electric
	...
	materials = list(MAT_STEEL = MATERIAL_COST(2.5), MAT_PLASTIC = MATERIAL_COST(1.5), MAT_SILVER = MATERIAL_COST(1.5))
...
/datum/design_techweb/mechfab/exointernal/hispeed_actuator
	...
	materials = list(MAT_PLASTEEL = MATERIAL_COST(5), MAT_OSMIUM = MATERIAL_COST(1.5), MAT_GOLD = MATERIAL_COST(2.5))
...
/datum/design_techweb/mechfab/vehicle/spacebike_chassis
	...
	materials = list(MAT_STEEL = MATERIAL_COST(6), MAT_SILVER = MATERIAL_COST(1.5), MAT_PHORON = MATERIAL_COST(1.5), MAT_OSMIUM = MATERIAL_COST(0.5))
...
/datum/design_techweb/mechfab/vehicle/quadbike_chassis
	...
	materials = list(MAT_STEEL = MATERIAL_COST(7.5), MAT_SILVER = MATERIAL_COST(1.5), MAT_PLASTIC = MATERIAL_COST(1.5), MAT_OSMIUM = MATERIAL_COST(0.5))
...
/datum/design_techweb/mechfab/vehicle/snowmobile_chassis
	...
	//req_tech = list(TECH_MATERIAL = 5, TECH_ENGINEERING = 6, TECH_MAGNET = 3, TECH_POWER = 2)
	materials = list(MAT_STEEL = MATERIAL_COST(6), MAT_SILVER = MATERIAL_COST(1.5), MAT_PLASTIC = MATERIAL_COST(1.5), MAT_OSMIUM = MATERIAL_COST(0.5))
...
/datum/design_techweb/mechfab/vehicle/basic //I'm going to just count this as a vehicle...
	...
	materials = list(MAT_STEEL = MATERIAL_COST(5), MAT_GLASS = MATERIAL_COST(3), MAT_SILVER = MATERIAL_COST(2))
...
/datum/design_techweb/mechfab/gopher/torso
	...
	materials = list(MAT_STEEL = MATERIAL_COST(7.5), MAT_GLASS = MATERIAL_COST(2.625))
...
/datum/design_techweb/mechfab/weasel/tri_leg
	...
	materials = list(MAT_STEEL = MATERIAL_COST(13.75))
