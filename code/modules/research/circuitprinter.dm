...
/obj/machinery/r_n_d/circuit_imprinter
	...
	flags = OPENCONTAINER
	circuit = /obj/item/circuitboard/circuit_imprinter // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/r_n_d/circuit_imprinter/RefreshParts()
	var/T = 0
	for(var/obj/item/reagent_containers/glass/G in component_parts) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/r_n_d/circuit_imprinter/dismantle()
	for(var/obj/I in component_parts)
		if(istype(I, /obj/item/reagent_containers/glass/beaker)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/r_n_d/circuit_imprinter/attackby(var/obj/item/O as obj, var/mob/user as mob)
	...
	if(default_part_replacement(user, O))
		return
	if(istype(O, /obj/item/gripper/no_use/loader)) // CHOMPEdit - Removal of obj/item/weapon
