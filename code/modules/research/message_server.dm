...
/obj/machinery/message_server/attackby(obj/item/O as obj, mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if (active && !(stat & (BROKEN|NOPOWER)) && (spamfilter_limit < MESSAGE_SERVER_DEFAULT_SPAM_LIMIT*2) && \
		istype(O,/obj/item/circuitboard/message_monitor)) // CHOMPEdit - Removal of obj/item/weapon
