...
/obj/machinery/r_n_d/destructive_analyzer
	...
	var/obj/item/loaded_item = null // CHOMPEdit - Removal of obj/item/weapon
	var/decon_mod = 0
	circuit = /obj/item/circuitboard/destructive_analyzer // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/r_n_d/destructive_analyzer/RefreshParts()
	var/T = 0
	for(var/obj/item/stock_parts/S in component_parts) // CHOMPEdit - Removal of obj/item/weapon
		T += S.rating
	T *= 0.1
...
/obj/machinery/r_n_d/destructive_analyzer/MouseDrop_T(atom/dropping, mob/living/user)
	if(istype(dropping, /obj/item/storage/part_replacer)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/storage/part_replacer/replacer = dropping // CHOMPEdit - Removal of obj/item/weapon
