...
/obj/item/projectile/Bump(atom/A)
	...
	if(ismob(A))
		...
		if(istype(A, /mob/living))
			...
			var/obj/item/grab/G = locate() in M // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/projectile/proc/launch_from_gun(atom/target, target_zone, mob/user, params, angle_override, forced_spread, obj/item/gun/launcher) // CHOMPEdit - Removal of obj/item/weapon
