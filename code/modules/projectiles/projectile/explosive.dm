...
/obj/item/projectile/bullet/srmrocket_he
	name ="SRM-8 HE Rocket"
	desc = "Boom"
	icon = 'icons/obj/grenade.dmi'
	icon_state = "missile"
	damage = 40
	stun = 4 // Explosion effect does not seem to stun the targets. Added, followed by suggestion.
	weaken = 2
	does_spin = 0
...
/obj/item/projectile/bullet/srmrocket_at
	name ="SRM-8 AT Rocket"
	desc = "Bang"
	icon = 'icons/obj/grenade.dmi'
	icon_state = "missile"
	damage = 100
