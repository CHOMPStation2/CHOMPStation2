	...
	if(istype(M, /mob/living) && M.stat != DEAD)
		...
		if(istype(M, /mob/living/silicon/robot))
			...
			for(var/obj/item/W in M)
				if(istype(W, /obj/item/implant))	//TODO: Carn. give implants a dropped() or something // CHOMPEdit - Removal of obj/item/weapon
					qdel(W)
					continue
		...
		switch(randomize)
			if("robot")
				...
				Robot.mmi = new /obj/item/mmi(new_mob) // CHOMPEdit - Removal of obj/item/device
