...
/obj/item/projectile/beam/lasertag/blue/on_hit(var/atom/target, var/blocked = 0)
	if(ishuman(target))
		...
		if(istype(M.wear_suit, /obj/item/clothing/suit/redtag))
			...
			if(istype(M.l_hand, /obj/item/laserdome_hyperball)) // CHOMPEdit - Removal of obj/item/weapon
				M.unEquip(M.l_hand)
			if(istype(M.r_hand, /obj/item/laserdome_hyperball)) // CHOMPEdit - Removal of obj/item/weapon
				M.unEquip(M.r_hand)
			// CHOMPEdit End
	return 1
...
/obj/item/projectile/beam/energy_net/proc/do_net(var/mob/M)
	var/obj/item/energy_net/net = new (get_turf(M)) // CHOMPEdit - Removal of obj/item/weapon
	net.throw_impact(M)
