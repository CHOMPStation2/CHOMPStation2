 ...
 * Practice Rifle
 */
/obj/item/gun/projectile/shotgun/pump/rifle/practice // For target practice // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/shotgun/pump/rifle/ceremonial/attackby(var/obj/item/A as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(sawn_off)
		to_chat(user, "<span class='warning'>The [src] is already shortened!</span>")
		return
	if(istype(A, /obj/item/surgical/circular_saw) || istype(A, /obj/item/melee/energy) || istype(A, /obj/item/pickaxe/plasmacutter) && w_class != ITEMSIZE_NORMAL) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/shotgun/pump/rifle/ui_action_click() // CHOMPEdit - Removal of obj/item/weapon
	scope()

/obj/item/gun/projectile/shotgun/pump/rifle/verb/scope() // CHOMPEdit - Removal of obj/item/weapon
	set category = "Object"
	set name = "Use Scope"
	set popup_menu = 1