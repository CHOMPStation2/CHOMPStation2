...
/obj/item/gun/projectile/dartgun // CHOMPEdit - Removal of obj/item/weapon
	...
	var/container_type = /obj/item/reagent_containers/glass/beaker // CHOMPEdit - Removal of obj/item/weapon
	var/list/starting_chems = null

/obj/item/gun/projectile/dartgun/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(starting_chems)
...
/obj/item/gun/projectile/dartgun/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(!ammo_magazine)
...
/obj/item/gun/projectile/dartgun/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	var/obj/item/projectile/bullet/chemdart/dart = .
	if(istype(dart))
		fill_dart(dart)

/obj/item/gun/projectile/dartgun/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(beakers.len)
		. += "<span class='notice'>[src] contains:</span>"
		for(var/obj/item/reagent_containers/glass/beaker/B in beakers) // CHOMPEdit - Removal of obj/item/weapon
			if(B.reagents && B.reagents.reagent_list.len)
				for(var/datum/reagent/R in B.reagents.reagent_list)
					. += "<span class='notice'>[R.volume] units of [R.name]</span>"

/obj/item/gun/projectile/dartgun/attackby(obj/item/I as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(I, /obj/item/reagent_containers/glass)) // CHOMPEdit - Removal of obj/item/weapon
		...
		if(beakers.len >= max_beakers)
			...
			return
		var/obj/item/reagent_containers/glass/beaker/B = I // CHOMPEdit - Removal of obj/item/weapon
		user.drop_item()
		B.loc = src
		beakers += B
...
/obj/item/gun/projectile/dartgun/proc/fill_dart(var/obj/item/projectile/bullet/chemdart/dart) // CHOMPEdit - Removal of obj/item/weapon
	if(mixing.len)
		var/mix_amount = dart.reagent_amount/mixing.len
		for(var/obj/item/reagent_containers/glass/beaker/B in mixing) // CHOMPEdit - Removal of obj/item/weapon
			B.reagents.trans_to_obj(dart, mix_amount)

/obj/item/gun/projectile/dartgun/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/dartgun/proc/check_beaker_mixing(var/obj/item/B) // CHOMPEdit - Removal of obj/item/weapon
	if(!mixing || !beakers)
		return 0
...
/obj/item/gun/projectile/dartgun/Topic(href, href_list) // CHOMPEdit - Removal of obj/item/weapon
	if(..()) return 1
	...
	if(href_list["stop_mix"])
		...
		if(index <= beakers.len)
			if(beakers[index])
				var/obj/item/reagent_containers/glass/beaker/B = beakers[index] // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/dartgun/research // CHOMPEdit - Removal of obj/item/weapon
