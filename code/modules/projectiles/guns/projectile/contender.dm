...
/obj/item/gun/projectile/contender/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(chambered)
...
/obj/item/gun/projectile/contender/load_ammo(var/obj/item/A, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!retracted_bolt)
