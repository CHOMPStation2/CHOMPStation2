 ...
 * Daka SMG (Code Base)
 */
/obj/item/gun/projectile/automatic //This should never be spawned in, it is just here because of code necessities. // CHOMPEdit - Removal of obj/item/weapon
	name = "daka SMG"
...
/obj/item/gun/projectile/automatic/advanced_smg/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(ammo_magazine)
...
/obj/item/gun/projectile/automatic/sts35/update_icon(var/ignore_inhands) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/gun/projectile/automatic/pdw/update_icon(var/ignore_inhands) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(ammo_magazine)
		icon_state = "pdw"
	else
...
/obj/item/gun/projectile/automatic/z8 // CHOMPEdit - Removal of obj/item/weapon
	...
	var/use_launcher = 0
	var/obj/item/gun/launcher/grenade/underslung/launcher // CHOMPEdit - Removal of obj/item/weapon

/obj/item/gun/projectile/automatic/z8/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	launcher = new(src)

/obj/item/gun/projectile/automatic/z8/attackby(obj/item/I, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if((istype(I, /obj/item/grenade))) // CHOMPEdit - Removal of obj/item/weapon
		launcher.load(I, user)
	else
		..()

/obj/item/gun/projectile/automatic/z8/attack_hand(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(user.get_inactive_hand() == src && use_launcher)
		launcher.unload(user)
	else
		..()

/obj/item/gun/projectile/automatic/z8/Fire(atom/target, mob/living/user, params, pointblank=0, reflex=0) // CHOMPEdit - Removal of obj/item/weapon
	if(use_launcher)
...
/obj/item/gun/projectile/automatic/z8/update_icon(var/ignore_inhands) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(ammo_magazine)
...
/obj/item/gun/projectile/automatic/z8/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(launcher.chambered)
...
/obj/item/gun/projectile/automatic/l6_saw/special_check(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(cover_open)
		to_chat(user, "<span class='warning'>[src]'s cover is open! Close it before firing!</span>")
		return 0
	return ..()

/obj/item/gun/projectile/automatic/l6_saw/proc/toggle_cover(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	cover_open = !cover_open
	to_chat(user, "<span class='notice'>You [cover_open ? "open" : "close"] [src]'s cover.</span>")
	update_icon()
	update_held_icon()

/obj/item/gun/projectile/automatic/l6_saw/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(cover_open)
		toggle_cover(user) //close the cover
	else
		return ..() //once closed, behave like normal

/obj/item/gun/projectile/automatic/l6_saw/attack_hand(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!cover_open && user.get_inactive_hand() == src)
		toggle_cover(user) //open the cover
	else
		return ..() //once open, behave like normal

/obj/item/gun/projectile/automatic/l6_saw/update_icon() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/automatic/l6_saw/load_ammo(var/obj/item/A, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!cover_open)
		to_chat(user, "<span class='warning'>You need to open the cover to load [src].</span>")
		return
	..()

/obj/item/gun/projectile/automatic/l6_saw/unload_ammo(mob/user, var/allow_dump=1) // CHOMPEdit - Removal of obj/item/weapon
	if(!cover_open)
...
/obj/item/gun/projectile/automatic/as24/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(ammo_magazine)
		icon_state = "ashot"
	else
...
/obj/item/gun/projectile/automatic/mini_uzi/equipped() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	is_picked_up = TRUE
	update_transform()

/obj/item/gun/projectile/automatic/mini_uzi/pickup() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	is_picked_up = TRUE
	update_transform()

/obj/item/gun/projectile/automatic/mini_uzi/dropped() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	is_picked_up = FALSE
	update_transform()
...
/obj/item/gun/projectile/automatic/p90/update_icon() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/automatic/tommygun/update_icon() // CHOMPEdit - Removal of obj/item/weapon
 ...
 * Bullpup Rifle
 */
/obj/item/gun/projectile/automatic/bullpup // Admin abuse assault rifle. ToDo: Make this less shit. Maybe remove its autofire, and make it spawn with only 10 rounds at start. // CHOMPEdit - Removal of obj/item/weapon
	name = "bullpup rifle"
...
/obj/item/gun/projectile/automatic/bullpup/update_icon(var/ignore_inhands) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(istype(ammo_magazine,/obj/item/ammo_magazine/m762))
		icon_state = "bullpup-small"
...
/obj/item/gun/projectile/automatic/combatsmg/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(ammo_magazine)
		icon_state = "combatsmg"
	else
