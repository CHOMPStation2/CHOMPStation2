...
/obj/item/gun/projectile/revolver/verb/spin_cylinder() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/revolver/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
	if(chamber_offset)
		chamber_offset--
		return
	return ..()

/obj/item/gun/projectile/revolver/load_ammo(var/obj/item/A, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	chamber_offset = 0
	return ..()
...
/obj/item/gun/projectile/revolver/detective/verb/rename_gun() // CHOMPEdit - Removal of obj/item/weapon
	set name = "Name Gun"
	set category = "Object"
...
/obj/item/gun/projectile/revolver/detective45/verb/rename_gun() // CHOMPEdit - Removal of obj/item/weapon
	set name = "Name Gun"
	set category = "Object"
...
/obj/item/gun/projectile/revolver/detective45/verb/reskin_gun() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/revolver/deckard/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(loaded.len)
...
/obj/item/gun/projectile/revolver/deckard/load_ammo(var/obj/item/A, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/revolver/lemat/New() // CHOMPEdit - Removal of obj/item/weapon
	for(var/i in 1 to secondary_max_shells)
		secondary_loaded += new secondary_ammo_type(src)
	..()

/obj/item/gun/projectile/revolver/lemat/verb/swap_firingmode() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/revolver/lemat/spin_cylinder() // CHOMPEdit - Removal of obj/item/weapon
	set name = "Spin cylinder"
	set desc = "Fun when you're bored out of your skull."
	set category = "Object"
...
/obj/item/gun/projectile/revolver/lemat/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(secondary_loaded)
		var/to_print
...
/obj/item/gun/projectile/revolver/consul/proc/update_charge() // CHOMPEdit - Removal of obj/item/weapon
	cut_overlays()
	if(loaded.len==0)
...
/obj/item/gun/projectile/revolver/consul/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	update_charge()
