//-----------------------Tranq Gun----------------------------------
/obj/item/gun/projectile/dartgun/tranq // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/dartgun/tranq/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(!ammo_magazine)
		icon_state = "tranqgun"
		return 1
...
/obj/item/projectile/bullet/chemdart/on_hit(var/atom/target, var/blocked = 0, var/def_zone = null)
	..()
	if(blocked < 2)
		if(istype(target, /obj/item/reagent_containers/food) || istype(target, /obj/item/slime_extract)) // CHOMPEdit - Removal of obj/item/weapon
