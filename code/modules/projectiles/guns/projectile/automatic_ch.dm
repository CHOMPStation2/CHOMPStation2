...
/obj/item/gun/projectile/automatic/p90/update_icon() // Code for visually updating the item depending on current magazine capacity. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/automatic/fal/update_icon(var/ignore_inhands) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(ammo_magazine)
