...
/obj/item/gun/projectile/heavysniper/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(bolt_open)
		icon_state = "heavysniper-open"
	else
		icon_state = "heavysniper"

/obj/item/gun/projectile/heavysniper/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/heavysniper/special_check(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(bolt_open)
		to_chat(user, "<span class='warning'>You can't fire [src] while the bolt is open!</span>")
		return 0
	return ..()

/obj/item/gun/projectile/heavysniper/load_ammo(var/obj/item/A, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!bolt_open)
		return
	..()

/obj/item/gun/projectile/heavysniper/unload_ammo(mob/user, var/allow_dump=1) // CHOMPEdit - Removal of obj/item/weapon
	if(!bolt_open)
		return
	..()

/obj/item/gun/projectile/heavysniper/ui_action_click() // CHOMPEdit - Removal of obj/item/weapon
	scope()

/obj/item/gun/projectile/heavysniper/verb/scope() // CHOMPEdit - Removal of obj/item/weapon
	set category = "Object"
	set name = "Use Scope"
	set popup_menu = 1
...
/obj/item/gun/projectile/SVD/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(ammo_magazine)
		icon_state = "SVD"
	else
...
/obj/item/gun/projectile/SVD/ui_action_click() // CHOMPEdit - Removal of obj/item/weapon
	scope()

/obj/item/gun/projectile/SVD/verb/scope() // CHOMPEdit - Removal of obj/item/weapon
	set category = "Object"
	set name = "Use Scope"
	set popup_menu = 1
