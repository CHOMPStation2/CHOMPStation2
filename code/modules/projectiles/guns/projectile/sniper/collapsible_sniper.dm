...
/obj/item/gun/projectile/heavysniper/collapsible/verb/take_down() // CHOMPEdit - Removal of obj/item/weapon
	set category = "Object"
...
/obj/item/gun/projectile/heavysniper/proc/collapse_rifle(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/sniper_rifle_part/proc/update_build()
	switch(part_count)
		...
		if(3)
			var/obj/item/gun/projectile/heavysniper/collapsible/gun = new (get_turf(src), 0) // CHOMPEdit - Removal of obj/item/weapon
