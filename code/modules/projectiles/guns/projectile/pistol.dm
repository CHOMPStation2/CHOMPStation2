...
/obj/item/gun/projectile/colt/detective/verb/rename_gun() // CHOMPEdit - Removal of obj/item/weapon
	set name = "Name Gun"
	set category = "Object"
...
/obj/item/gun/projectile/colt/detective/verb/reskin_gun() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/sec/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(ammo_magazine)
		icon_state = "secguncomp"
	else
...
/obj/item/gun/projectile/sec/wood/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(ammo_magazine)
		icon_state = "secgundark"
	else
...
/obj/item/gun/projectile/silenced/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(ammo_magazine)
		icon_state = "silenced_pistol"
	else
...
/obj/item/gun/projectile/deagle/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(ammo_magazine)
		icon_state = "[initial(icon_state)]"
	else
...
/obj/item/gun/projectile/deagle/gold // CHOMPEdit - Removal of obj/item/weapon
	desc = "A gold plated gun folded over a million times by superior Tajaran gunsmiths. Uses .44 rounds."
	icon_state = "deagleg"
	item_state = "deagleg"

/obj/item/gun/projectile/deagle/camo // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/gyropistol/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(ammo_magazine)
...
/obj/item/gun/projectile/pistol/attack_hand(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/pistol/attackby(obj/item/I as obj, mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(I, /obj/item/silencer)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/pistol/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(ammo_magazine)
		if(silenced)
			icon_state = "pistol-s"
		else
...
/obj/item/gun/projectile/aps/attack_hand(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(user.get_inactive_hand() == src)
		if(silenced)
			if(!user.item_is_in_hands(src))
				..()
...
/obj/item/gun/projectile/aps/attackby(obj/item/I as obj, mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(I, /obj/item/silencer)) // CHOMPEdit - Removal of obj/item/weapon
		if(!user.item_is_in_hands(src))	//if we're not in his hands
			to_chat(user, "<span class='notice'>You'll need [src] in your hands to do that.</span>")
			return
...
/obj/item/gun/projectile/aps/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(ammo_magazine)
		if(silenced)
			icon_state = "aps-s"
		else
...
/obj/item/gun/projectile/pirate/New() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/luger/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(ammo_magazine)
		icon_state = "[initial(icon_state)]"
	else
...
/obj/item/gun/projectile/luger/brown // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/p92x/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(ammo_magazine)
		icon_state = "[initial(icon_state)]"
	else
...
/obj/item/gun/projectile/p92x/brown // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "p92xb"
...
/obj/item/gun/projectile/giskard/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/gun/projectile/giskard/olivaw // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/giskard/olivaw/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(ammo_magazine && ammo_magazine.stored_ammo.len)
		icon_state = "olivawcivil"
	else
...
/obj/item/gun/projectile/makarov/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(ammo_magazine)
		icon_state = "Makarov"
	else
...
/obj/item/gun/projectile/n99/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(ammo_magazine)
		icon_state = "n99"
	else
		icon_state = "n99-e"

/obj/item/gun/projectile/n80 // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "n80"

/obj/item/gun/projectile/n80/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(ammo_magazine)
		icon_state = "n80"
	else
		icon_state = "n80-e"
...
/obj/item/gun/projectile/ecureuil/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(ammo_magazine)
		icon_state = "ecureuil"
	else
...
/obj/item/gun/projectile/ecureuil/tac/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(ammo_magazine)
		icon_state = "tac_ecureuil"
	else
...
/obj/item/gun/projectile/ecureuil/tac2/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(ammo_magazine)
...
/obj/item/gun/projectile/lamia/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	cut_overlays()
	if(!ammo_magazine)
		return
