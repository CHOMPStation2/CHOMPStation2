...
/obj/item/gun/projectile/handle_post_fire(mob/user, atom/target, var/pointblank=0, var/reflex=0) // CHOMPEdit - Removal of obj/item/weapon
	if(fire_anim)
		flick(fire_anim, src)
...
/obj/item/gun/projectile/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(manual_chamber)
		if(do_after(user,4))
			bolt_handle(user)
...
/obj/item/gun/projectile/proc/bolt_handle(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/proc/bolt_toggle(var/manual) // CHOMPEdit - Removal of obj/item/weapon
	if(!bolt_open)
...
/obj/item/gun/projectile/process_chambered() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
	if(!manual_chamber)
		//get the next casing
		if(loaded.len)
...
/obj/item/gun/projectile/proc/chamber_bullet() // CHOMPEdit - Removal of obj/item/weapon
	if(chambered)
		return 0
...
/obj/item/gun/projectile/load_ammo(var/obj/item/A, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	...
	else if(istype(A, /obj/item/storage)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/storage/storage = A // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/afterattack(atom/A, mob/living/user, adjacent, params) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/proc/afteratt(atom/A, mob/living/user, adjacent, params) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/special_check(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(..())
		if(manual_chamber)
...
/obj/item/gun/projectile/unload_ammo(mob/user, var/allow_dump=1) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/handle_click_empty(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if (user)
...
/obj/item/gun/projectile/New(loc, var/starts_loaded = 1) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(manual_chamber)
		verbs |= /obj/item/gun/projectile/verb/change_firemode // CHOMPEdit - Removal of obj/item/weapon
	update_icon()

/obj/item/gun/projectile/verb/change_firemode() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/process_accuracy(obj/projectile, mob/living/user, atom/target, var/burst, var/held_twohanded) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/gun/projectile/pirate/process_accuracy(obj/projectile, mob/living/user, atom/target, var/burst, var/held_twohanded) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	var/obj/item/projectile/bullet/P = projectile
	if(!istype(P))
		return
...
/obj/item/gun/projectile/revolver/lemat/process_accuracy(obj/projectile, mob/living/user, atom/target, var/burst, var/held_twohanded) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	var/obj/item/projectile/bullet/P = projectile
