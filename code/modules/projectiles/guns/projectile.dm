...
/obj/item/gun/projectile/handle_post_fire() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(chambered)
		chambered.expend()
		process_chambered()

/obj/item/gun/projectile/handle_click_empty() // CHOMPEdit - Removal of obj/item/weapon
	..()
	process_chambered()

/obj/item/gun/projectile/proc/process_chambered() // CHOMPEdit - Removal of obj/item/weapon
	if (!chambered) return
...
/obj/item/gun/projectile/proc/load_ammo(var/obj/item/A, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/proc/unload_ammo(mob/user, var/allow_dump=1) // CHOMPEdit - Removal of obj/item/weapon
	if(ammo_magazine)
...
/obj/item/gun/projectile/attackby(var/obj/item/A as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
	load_ammo(A, user)
...
/obj/item/gun/projectile/attack_hand(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(user.get_inactive_hand() == src)
		unload_ammo(user, allow_dump=0)
	else
		return ..()

/obj/item/gun/projectile/afterattack(atom/A, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/gun/projectile/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(ammo_magazine)
		. += "It has \a [ammo_magazine] loaded."
	. += "It has [getAmmo()] round\s remaining."

/obj/item/gun/projectile/proc/getAmmo() // CHOMPEdit - Removal of obj/item/weapon
	var/bullets = 0
	if(loaded)
		bullets += loaded.len
...
/obj/item/gun/projectile/verb/unload_gun() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/has_ammo_counter() // CHOMPEdit - Removal of obj/item/weapon
	return TRUE

/obj/item/gun/projectile/get_ammo_type() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/get_ammo_count() // CHOMPEdit - Removal of obj/item/weapon
