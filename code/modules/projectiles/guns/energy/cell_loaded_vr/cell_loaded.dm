// The Gun //
/obj/item/gun/projectile/cell_loaded //this one can load both medical and security cells! for ERT/admin use. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/cell_loaded/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/cell_loaded/proc/update_charge() // CHOMPEdit - Removal of obj/item/weapon
	charge_left = 0
	max_charge = 0
...
/obj/item/gun/projectile/cell_loaded/proc/switch_to(obj/item/ammo_casing/microbattery/new_batt) // CHOMPEdit - Removal of obj/item/weapon
	if(ishuman(loc))
...
/obj/item/gun/projectile/cell_loaded/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!chambered)
		return
	...
	for(var/index in 1 to stored_ammo.len)
		...
		if(chambered != next_batt && !istype(next_batt, chambered.type))
			...
			break
/*
/obj/item/gun/projectile/cell_loaded/special_check(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!chambered)
		return
	...
	return TRUE
*/
/obj/item/gun/projectile/cell_loaded/load_ammo(var/obj/item/A, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(ammo_magazine && ammo_magazine.stored_ammo.len)
		switch_to(ammo_magazine.stored_ammo[1])

/obj/item/gun/projectile/cell_loaded/unload_ammo(mob/user, var/allow_dump=1) // CHOMPEdit - Removal of obj/item/weapon
	chambered = null
	return ..()

/obj/item/gun/projectile/cell_loaded/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	update_charge()
...
/obj/item/ammo_magazine/cell_mag/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	...
	update_icon()
	if(istype(loc, /obj/item/gun/projectile/cell_loaded)) // Update the HUD if we're in a gun + have a user. Not that one should be able to reload the mag while it's in a gun, but just in caaaaase. // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/gun/projectile/cell_loaded/cell_load = loc // CHOMPEdit - Removal of obj/item/weapon
...
// The Pack //
/obj/item/storage/secure/briefcase/nsfw_pack_hybrid // CHOMPEdit - Removal of obj/item/weapon
	name = "hybrid cell-loaded gun kit"
	desc = "A storage case for a multi-purpose handgun. Variety hour!"
	w_class = ITEMSIZE_NORMAL
	max_w_class = ITEMSIZE_NORMAL
	can_hold = list(/obj/item/gun/projectile/cell_loaded,/obj/item/ammo_magazine/cell_mag,/obj/item/ammo_casing/microbattery) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/storage/secure/briefcase/nsfw_pack_hybrid/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	new /obj/item/gun/projectile/cell_loaded(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/secure/briefcase/nsfw_pack_hybrid_combat // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/secure/briefcase/nsfw_pack_hybrid_combat/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	new /obj/item/gun/projectile/cell_loaded(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/ammo_magazine/cell_mag/advanced(src)
...
/*
/obj/item/gun/projectile/cell_loaded/get_ammo_type() // CHOMPEdit - Removal of obj/item/weapon
	if(!projectile_type)
...
*/
/obj/item/gun/projectile/cell_loaded/get_ammo_count() // CHOMPEdit - Removal of obj/item/weapon
	if(!chambered)
