...
/obj/item/gun/projectile/multi_cannon // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/projectile/multi_cannon/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	cut_overlays()
...
/obj/item/gun/projectile/multi_cannon/load_ammo() // CHOMPEdit - Removal of obj/item/weapon
	.=..()
	consume_next_projectile()
	update_icon()

/obj/item/gun/projectile/multi_cannon/unload_ammo(mob/user, var/allow_dump=1) // CHOMPEdit - Removal of obj/item/weapon
	.=..()
	update_icon()
	chambered = null

/obj/item/gun/projectile/multi_cannon/get_ammo_count() // Custom handling for the Curabitur. // CHOMPEdit - Removal of obj/item/weapon
	if(istype(chambered, /obj/item/ammo_casing/macrobattery))
		...
		CRASH("/obj/item/gun/projectile/multi_cannon/get_ammo_count() was called from [src] but did not have a valid magazine loaded, somehow! Chambered is currently [chambered].") // CHOMPEdit - Removal of obj/item/weapon
