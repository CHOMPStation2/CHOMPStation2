...
/obj/item/gun/projectile/cell_loaded/medical/cmo // CHOMPEdit - Removal of obj/item/weapon
...
// The Pack //
/obj/item/storage/secure/briefcase/nerd_pack_med // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper NERD \'Medigun\' kit"
	desc = "A storage case for a multi-purpose healing gun. Variety hour!"
	icon_state = "medbriefcase"
	w_class = ITEMSIZE_NORMAL
	max_w_class = ITEMSIZE_NORMAL
	can_hold = list(/obj/item/gun/projectile/cell_loaded/medical,/obj/item/ammo_magazine/cell_mag/medical,/obj/item/ammo_casing/microbattery/medical) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/storage/secure/briefcase/nerd_pack_med/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	new /obj/item/gun/projectile/cell_loaded/medical(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/secure/briefcase/nerd_pack_cmo // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/secure/briefcase/nerd_pack_cmo/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	new /obj/item/gun/projectile/cell_loaded/medical/cmo(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/ammo_magazine/cell_mag/medical(src)
	new /obj/item/ammo_casing/microbattery/medical/brute(src)
	new /obj/item/ammo_casing/microbattery/medical/burn(src)
	new /obj/item/ammo_casing/microbattery/medical/stabilize(src)
