// The Gun //
/obj/item/gun/projectile/cell_loaded/combat // CHOMPEdit - Removal of obj/item/weapon
...
// The Pack //
/obj/item/storage/secure/briefcase/nsfw_pack // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper HI-102b \'NSCW\' gun kit"
	desc = "A storage case for a multi-purpose handgun. Variety hour!"
	w_class = ITEMSIZE_NORMAL
	max_w_class = ITEMSIZE_NORMAL
	can_hold = list(/obj/item/gun/projectile/cell_loaded/combat,/obj/item/ammo_magazine/cell_mag/combat,/obj/item/ammo_casing/microbattery/combat) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/storage/secure/briefcase/nsfw_pack/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	new /obj/item/gun/projectile/cell_loaded/combat(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/secure/briefcase/nsfw_pack_hos/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	new /obj/item/gun/projectile/cell_loaded/combat(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/ammo_magazine/cell_mag/combat(src)
	new /obj/item/ammo_magazine/cell_mag/combat(src)
