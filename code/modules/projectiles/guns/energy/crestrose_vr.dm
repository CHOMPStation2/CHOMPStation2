/obj/item/gun/projectile/automatic/fluff/crestrose // CHOMPEdit - Removal of obj/item/weapon
	name = "Crescent Rose"
...
/obj/item/gun/projectile/automatic/fluff/crestrose/switch_firemodes(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(..())
		update_icon()
		update_held_icon()


/obj/item/gun/projectile/automatic/fluff/crestrose/handle_shield(mob/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, var/attack_text = "the attack") // CHOMPEdit - Removal of obj/item/weapon
