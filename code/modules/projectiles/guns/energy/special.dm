...
/obj/item/gun/energy/ionrifle/emp_act(severity) // CHOMPEdit - Removal of obj/item/weapon
	..(max(severity, 4)) //so it doesn't EMP itself, I guess

/obj/item/gun/energy/ionrifle/empty // CHOMPEdit - Removal of obj/item/weapon
	cell_type = null
...
/obj/item/gun/energy/decloner // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/floragun // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/stock_parts/micro_laser/emitter // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/floragun/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	emitter = new(src)

/obj/item/gun/energy/floragun/examine(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(Adjacent(user))
		. += "It has [emitter ? emitter : "no micro laser"] installed."

/obj/item/gun/energy/floragun/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/floragun/afterattack(obj/target, mob/user, adjacent_flag) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/floragun/verb/select_gene() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/floragun/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/gun/energy/meteorgun // CHOMPEdit - Removal of obj/item/weapon
	name = "meteor gun"
	...
	cell_type = /obj/item/cell/potato // CHOMPEdit - Removal of obj/item/weapon
	charge_cost = 100
	self_recharge = 1
	recharge_time = 5 //Time it takes for shots to recharge (in ticks)
	charge_meter = 0

/obj/item/gun/energy/meteorgun/pen // CHOMPEdit - Removal of obj/item/weapon
	name = "meteor pen"
...
/obj/item/gun/energy/staff // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/staff/special_check(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/staff/handle_click_empty(mob/user = null) // CHOMPEdit - Removal of obj/item/weapon
	if (user)
...
/*
/obj/item/gun/energy/staff/animate // CHOMPEdit - Removal of obj/item/weapon
	...
	charge_cost = 240
*/
/obj/item/gun/energy/staff/focus // CHOMPEdit - Removal of obj/item/weapon
	name = "mental focus"
...
/obj/item/gun/energy/dakkalaser // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/maghowitzer // CHOMPEdit - Removal of obj/item/weapon
	...
	accept_cell_type = /obj/item/cell // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/maghowitzer/proc/pick_random_target(var/turf/T) // CHOMPEdit - Removal of obj/item/weapon
	var/foundmob = FALSE
	var/foundmobs = list()
...
/obj/item/gun/energy/maghowitzer/attack(atom/A, mob/living/user, def_zone) // CHOMPEdit - Removal of obj/item/weapon
	if(power_cycle)
...
/obj/item/gun/energy/maghowitzer/afterattack(atom/A, mob/living/user, adjacent, params) // CHOMPEdit - Removal of obj/item/weapon
	if(power_cycle)
		to_chat(user, "<span class='notice'>\The [src] is already powering up!</span>")
		return 0
