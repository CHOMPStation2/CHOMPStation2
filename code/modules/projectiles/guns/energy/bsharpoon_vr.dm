...
/obj/item/bluespace_harpoon // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/stock_parts/scanning_module/scanmod // CHOMPEdit - Removal of obj/item/weapon
	var/dropnoms_active = TRUE

/obj/item/bluespace_harpoon/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	scanmod = new(src)
	update_fail_chance()

/obj/item/bluespace_harpoon/examine(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/bluespace_harpoon/proc/update_fail_chance() // CHOMPEdit - Removal of obj/item/weapon
	if(scanmod)
...
/obj/item/bluespace_harpoon/attackby(var/obj/item/I, var/mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(user))
		return
	...
	if(I.has_tool_quality(TOOL_SCREWDRIVER))
		...
		scanmod = null
		update_fail_chance()
	else if(istype(I, /obj/item/stock_parts/scanning_module)) // CHOMPEdit - Removal of obj/item/weapon
		if(scanmod)
...
/obj/item/bluespace_harpoon/afterattack(atom/A, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/bluespace_harpoon/attack_self(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	return chande_fire_mode(user)

/obj/item/bluespace_harpoon/verb/chande_fire_mode(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/bluespace_harpoon/verb/chande_dropnom_mode(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/bluespace_harpoon/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(transforming)
		switch(mode)
			if(0)
