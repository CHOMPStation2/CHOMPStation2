...
/obj/item/gun/energy/laser/equipped() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	is_picked_up = TRUE
	update_transform()

/obj/item/gun/energy/laser/pickup() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	is_picked_up = TRUE
	update_transform()

/obj/item/gun/energy/laser/dropped() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(!istype(loc,/mob/living))
		is_picked_up = FALSE
	update_transform()

/obj/item/gun/energy/laser/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if((!(type == /obj/item/gun/energy/laser)) && !is64x32_override) // CHOMPEdit - Removal of obj/item/weapon
		is64x32 = FALSE
...
/obj/item/gun/energy/laser/update_transform() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(is64x32)
		if(is_picked_up)
...
/obj/item/gun/energy/laser/vepr // CHOMPEdit - Removal of obj/item/weapon
	name = "WKHM 'Vepr'"
	...
	is64x32_override = TRUE
	accept_cell_type = /obj/item/cell/vepr // CHOMPEdit - Removal of obj/item/weapon
	cell_type = /obj/item/cell/vepr // CHOMPEdit - Removal of obj/item/weapon
	origin_tech = list(TECH_POWER = 4, TECH_COMBAT = 6, TECH_MAGNET = 4, TECH_ILLEGAL = 4)

/obj/item/cell/vepr // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/tommylaser // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/zip // CHOMPEdit - Removal of obj/item/weapon
	name = "Zip-Las"
...
/obj/item/gun/energy/vepr/plasma // CHOMPEdit - Removal of obj/item/weapon
