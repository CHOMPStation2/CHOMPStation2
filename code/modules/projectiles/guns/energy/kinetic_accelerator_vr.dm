...
/obj/item/gun/energy/kinetic_accelerator // CHOMPEdit - Removal of obj/item/weapon
	...
	cell_type = /obj/item/cell/device/weapon/empproof // CHOMPEdit - Removal of obj/item/weapon
	item_flags = NONE
	charge_meter = FALSE
...
/obj/item/gun/energy/kinetic_accelerator/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
	if(overheat)
		return
	. = ..()
	if(.)
...
/obj/item/gun/energy/kinetic_accelerator/handle_post_fire(mob/user, atom/target, pointblank, reflex) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	attempt_reload()
...
/obj/item/gun/energy/kinetic_accelerator/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(max_mod_capacity)
...
/obj/item/gun/energy/kinetic_accelerator/Exited(atom/movable/AM) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if((AM in modkits) && istype(AM, /obj/item/borg/upgrade/modkit))
		var/obj/item/borg/upgrade/modkit/M = AM
		M.uninstall(src, FALSE)

/obj/item/gun/energy/kinetic_accelerator/attackby(obj/item/I, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/kinetic_accelerator/proc/get_remaining_mod_capacity() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/kinetic_accelerator/proc/get_modkits() // CHOMPEdit - Removal of obj/item/weapon
	. = list()
	for(var/A in modkits)
		. += A

/obj/item/gun/energy/kinetic_accelerator/proc/modify_projectile(obj/item/projectile/kinetic/K) // CHOMPEdit - Removal of obj/item/weapon
	K.kinetic_gun = src //do something special on-hit, easy!
	for(var/A in get_modkits())
		var/obj/item/borg/upgrade/modkit/M = A
		M.modify_projectile(K)

/obj/item/gun/energy/kinetic_accelerator/cyborg // CHOMPEdit - Removal of obj/item/weapon
	holds_charge = TRUE
	unique_frequency = TRUE

/obj/item/gun/energy/kinetic_accelerator/cyborg/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	for(var/obj/item/borg/upgrade/modkit/M in modkits)
		M.uninstall(src)
	return ..()

/obj/item/gun/energy/kinetic_accelerator/premiumka/cyborg // CHOMPEdit - Removal of obj/item/weapon
	holds_charge = TRUE
	unique_frequency = TRUE

/obj/item/gun/energy/kinetic_accelerator/premiumka/cyborg/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	for(var/obj/item/borg/upgrade/modkit/M in modkits)
		M.uninstall(src)
	return ..()

/obj/item/gun/energy/kinetic_accelerator/minebot // CHOMPEdit - Removal of obj/item/weapon
	// trigger_guard = TRIGGER_GUARD_ALLOW_ALL
	overheat_time = 20
	holds_charge = TRUE
	unique_frequency = TRUE

/obj/item/gun/energy/kinetic_accelerator/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(!holds_charge)
		empty()
	AddElement(/datum/element/conflict_checking, CONFLICT_ELEMENT_KA)

/obj/item/gun/energy/kinetic_accelerator/equipped(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(power_supply.charge < charge_cost)
		attempt_reload()

/obj/item/gun/energy/kinetic_accelerator/dropped(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/gun/energy/kinetic_accelerator/proc/empty_if_not_held() // CHOMPEdit - Removal of obj/item/weapon
	if(!ismob(loc) && !istype(loc, /obj/item/integrated_circuit))
		empty()

/obj/item/gun/energy/kinetic_accelerator/proc/empty() // CHOMPEdit - Removal of obj/item/weapon
	if(power_supply)
		power_supply.use(power_supply.charge)
		update_icon()

/obj/item/gun/energy/kinetic_accelerator/proc/attempt_reload(recharge_time) // CHOMPEdit - Removal of obj/item/weapon
	if(!power_supply)
		return
	if(overheat)
		return
...
/obj/item/gun/energy/kinetic_accelerator/emp_act(severity) // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/gun/energy/kinetic_accelerator/proc/reload() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/kinetic_accelerator/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	cut_overlays()
...
/obj/item/projectile/kinetic
	...
	var/obj/item/gun/energy/kinetic_accelerator/kinetic_gun // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/borg/upgrade/modkit/attackby(obj/item/A, mob/user)
	if(istype(A, /obj/item/gun/energy/kinetic_accelerator)) // CHOMPEdit - Removal of obj/item/weapon
		install(A, user)
	else
		..()
...
/obj/item/borg/upgrade/modkit/afterInstall(mob/living/silicon/robot/R)
	for(var/obj/item/gun/energy/kinetic_accelerator/H in R.module.modules) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/borg/upgrade/modkit/proc/install(obj/item/gun/energy/kinetic_accelerator/KA, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = TRUE
...
/obj/item/borg/upgrade/modkit/proc/uninstall(obj/item/gun/energy/kinetic_accelerator/KA, forcemove = TRUE) // CHOMPEdit - Removal of obj/item/weapon
	KA.modkits -= src
	if(forcemove)
...
/obj/item/borg/upgrade/modkit/proc/projectile_prehit(obj/item/projectile/kinetic/K, atom/target, obj/item/gun/energy/kinetic_accelerator/KA) // CHOMPEdit - Removal of obj/item/weapon
//use this one for effects you want to trigger before mods that do damage
/obj/item/borg/upgrade/modkit/proc/projectile_strike_predamage(obj/item/projectile/kinetic/K, turf/target_turf, atom/target, obj/item/gun/energy/kinetic_accelerator/KA) // CHOMPEdit - Removal of obj/item/weapon
//and this one for things that don't need to trigger before other damage-dealing mods
/obj/item/borg/upgrade/modkit/proc/projectile_strike(obj/item/projectile/kinetic/K, turf/target_turf, atom/target, obj/item/gun/energy/kinetic_accelerator/KA) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/borg/upgrade/modkit/cooldown/install(obj/item/gun/energy/kinetic_accelerator/KA, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(.)
...
/obj/item/borg/upgrade/modkit/cooldown/uninstall(obj/item/gun/energy/kinetic_accelerator/KA) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/borg/upgrade/modkit/aoe/install(obj/item/gun/energy/kinetic_accelerator/KA, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(.)
...
/obj/item/borg/upgrade/modkit/aoe/uninstall(obj/item/gun/energy/kinetic_accelerator/KA) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/borg/upgrade/modkit/aoe/projectile_strike(obj/item/projectile/kinetic/K, turf/target_turf, atom/target, obj/item/gun/energy/kinetic_accelerator/KA) // CHOMPEdit - Removal of obj/item/weapon
	if(stats_stolen)
		return
...
/obj/item/borg/upgrade/modkit/cooldown/repeater/projectile_strike_predamage(obj/item/projectile/kinetic/K, turf/target_turf, atom/target, obj/item/gun/energy/kinetic_accelerator/KA) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/borg/upgrade/modkit/lifesteal/projectile_prehit(obj/item/projectile/kinetic/K, atom/target, obj/item/gun/energy/kinetic_accelerator/KA) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/borg/upgrade/modkit/resonator_blasts/projectile_strike(obj/item/projectile/kinetic/K, turf/target_turf, atom/target, obj/item/gun/energy/kinetic_accelerator/KA) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/borg/upgrade/modkit/bounty/projectile_prehit(obj/item/projectile/kinetic/K, atom/target, obj/item/gun/energy/kinetic_accelerator/KA) // CHOMPEdit - Removal of obj/item/weapon
	if(isliving(target))
		var/mob/living/L = target
...
/obj/item/borg/upgrade/modkit/bounty/projectile_strike(obj/item/projectile/kinetic/K, turf/target_turf, atom/target, obj/item/gun/energy/kinetic_accelerator/KA) // CHOMPEdit - Removal of obj/item/weapon
	if(isliving(target))
		var/mob/living/L = target
...
/obj/item/borg/upgrade/modkit/trigger_guard/install(obj/item/gun/energy/kinetic_accelerator/KA, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(.)
		KA.trigger_guard = TRIGGER_GUARD_ALLOW_ALL
/obj/item/borg/upgrade/modkit/trigger_guard/uninstall(obj/item/gun/energy/kinetic_accelerator/KA) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/borg/upgrade/modkit/chassis_mod/install(obj/item/gun/energy/kinetic_accelerator/KA, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(.)
		KA.icon_state = chassis_icon
		KA.name = chassis_name

/obj/item/borg/upgrade/modkit/chassis_mod/uninstall(obj/item/gun/energy/kinetic_accelerator/KA) // CHOMPEdit - Removal of obj/item/weapon
