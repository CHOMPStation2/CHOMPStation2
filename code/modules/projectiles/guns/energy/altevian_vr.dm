/obj/item/gun/energy/altevian // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/altevian/large // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/ratminer // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/projectile/beam/ratminer/proc/strike_thing(var/atom/A)
	...
	for(var/T in RANGE_TURFS(2, target_turf) - target_turf)
		if(ismineralturf(T))
			...
			M.GetDrilled(TRUE)
	if(firer)
		var/obj/item/storage/bag/ore/orebag = locate(/obj/item/storage/bag/ore) in firer // CHOMPEdit - Removal of obj/item/weapon
		if(orebag)
