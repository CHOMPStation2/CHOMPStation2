...
/obj/item/gun/energy/soapenergy/gauss // CHOMPEdit - Removal of obj/item/weapon
	name = "gauss pistol"
...
/obj/item/gun/energy/soapenergy/gaussrifle // CHOMPEdit - Removal of obj/item/weapon
	name = "gauss rifle"
	icon = 'icons/obj/gun_yw.dmi'
