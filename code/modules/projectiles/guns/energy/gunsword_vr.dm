/obj/item/gun/energy/gun/fluff/gunsword // CHOMPEdit - Removal of obj/item/weapon
	name = "Sword Buster"
	...
	cell_type = /obj/item/cell/device/weapon/gunsword // CHOMPEdit - Removal of obj/item/weapon
...
// -----------------gunsword battery--------------------------
/obj/item/cell/device/weapon/gunsword // CHOMPEdit - Removal of obj/item/weapon
	name = "Buster Cell"
...
/obj/item/cell/device/weapon/gunsword/proc/activate(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(active)
		return
	icon_state = "gsaber"
	item_state = "gsaber"
...
/obj/item/cell/device/weapon/gunsword/proc/deactivate(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!active)
		return
...
/obj/item/cell/device/weapon/gunsword/attack_self(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/cell/device/weapon/gunsword/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	cut_overlays()