// For general use
/obj/item/gun/energy/imperial // CHOMPEdit - Removal of obj/item/weapon
...
/*
//-----------------------G44 Energy Variant--------------------
/obj/item/gun/energy/gun/burst/g44e // CHOMPEdit - Removal of obj/item/weapon
...
//////////////////// Eris Ported Guns ////////////////////
//HoP gun
/obj/item/gun/energy/gun/martin // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/gun/martin/proc/update_mode() // CHOMPEdit - Removal of obj/item/weapon
	var/datum/firemode/current_mode = firemodes[sel_mode]
	switch(current_mode.name)
		if("stun") add_overlay("taser_pdw")
		if("lethal") add_overlay("lazer_pdw")

/obj/item/gun/energy/gun/martin/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	cut_overlays()
	update_mode()

//Gun Locking Mechanism
/obj/item/gun/energy/locked // CHOMPEdit - Removal of obj/item/weapon
	req_access = list(access_armory) //for toggling safety
	var/locked = 1
	var/lockable = 1

/obj/item/gun/energy/locked/attackby(obj/item/I, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/locked/emag_act(var/remaining_charges,var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(lockable)
		locked = !locked
		to_chat(user, "<span class='warning'>You [locked ? "enable" : "disable"] the safety lock on \the [src]!</span>")

/obj/item/gun/energy/locked/special_check(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(locked)
...
/obj/item/gun/energy/locked/frontier // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/locked/frontier/unload_ammo(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(recharging)
		return
	recharging = 1
	update_icon()
...
/obj/item/gun/energy/locked/frontier/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(recharging)
...
/obj/item/gun/energy/locked/frontier/emp_act(severity) // CHOMPEdit - Removal of obj/item/weapon
	return ..(severity+2)

/obj/item/gun/energy/locked/frontier/ex_act() //|rugged| // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/gun/energy/locked/frontier/unlocked // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/locked/frontier/carbine/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(recharging)
...
/obj/item/gun/energy/locked/frontier/carbine/unlocked // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/locked/frontier/holdout/unlocked // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/locked/frontier/rifle // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/locked/frontier/rifle/ui_action_click() // CHOMPEdit - Removal of obj/item/weapon
	scope()

/obj/item/gun/energy/locked/frontier/rifle/verb/scope() // CHOMPEdit - Removal of obj/item/weapon
	set category = "Object"
	set name = "Use Scope"
	set popup_menu = 1
...
/obj/item/gun/energy/locked/frontier/rifle/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(recharging)
		icon_state = "[modifystate]_pump"
		update_held_icon()
		return
...
/obj/item/gun/energy/locked/frontier/rifle/unlocked // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/locked/frontier/handbow // CHOMPEdit - Removal of obj/item/weapon
	name = "phaser handbow"
...
/obj/item/gun/energy/locked/frontier/handbow/unlocked // CHOMPEdit - Removal of obj/item/weapon
