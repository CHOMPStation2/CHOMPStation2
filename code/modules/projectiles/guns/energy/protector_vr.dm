// -------------- Protector -------------
/obj/item/gun/energy/gun/protector // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/gun/protector/special_check(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/gun/protector/ui_action_click(mob/user, actiontype) // CHOMPEdit - Removal of obj/item/weapon
	gun_light_on = !gun_light_on
	playsound(src, 'sound/weapons/empty.ogg', 40, TRUE)
	update_brightness(user)
	update_icon()

/obj/item/gun/energy/gun/protector/proc/update_brightness(mob/user = null) // CHOMPEdit - Removal of obj/item/weapon
	if(gun_light_on)
		set_light(brightness_on)
	else
		set_light(0)

/obj/item/gun/energy/gun/protector/emag_act(var/remaining_charges,var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(!emagged)
		emagged = TRUE
...
/obj/item/gun/energy/gun/protector/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	cut_overlays()
	var/ratio = 0
...
/obj/item/gun/energy/gun/protector/unlocked // CHOMPEdit - Removal of obj/item/weapon
	emagged = TRUE
	name = "small energy gun"
...
/obj/item/gun/energy/gun/protector/pilotgun/locked/attackby(obj/item/I, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/gun/protector/pilotgun/locked/emag_act(var/remaining_charges,var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return ..()

/obj/item/gun/energy/gun/protector/pilotgun/locked/special_check(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(locked)
