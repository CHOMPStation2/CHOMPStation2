/obj/item/gun/launcher/pneumatic // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/tank/tank = null                // Tank of gas for use in firing the cannon. // CHOMPEdit - Removal of obj/item/weapon

	var/obj/item/storage/item_storage // CHOMPEdit - Removal of obj/item/weapon
	var/pressure_setting = 10                           // Percentage of the gas in the tank used to fire the projectile.
	var/possible_pressure_amounts = list(5,10,20,25,50) // Possible pressure settings.
	var/force_divisor = 400                             // Force equates to speed. Speed/5 equates to a damage multiplier for whoever you hit.
	                                                    // For reference, a fully pressurized oxy tank at 50% gas release firing a health
	                                                    // analyzer with a force_divisor of 10 hit with a damage multiplier of 3000+.
/obj/item/gun/launcher/pneumatic/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/gun/launcher/pneumatic/verb/set_pressure() //set amount of tank pressure. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/launcher/pneumatic/proc/eject_tank(mob/user) //Remove the tank. // CHOMPEdit - Removal of obj/item/weapon
	if(!tank)
...
/obj/item/gun/launcher/pneumatic/proc/unload_hopper(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/launcher/pneumatic/attack_hand(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(user.get_inactive_hand() == src)
		unload_hopper(user)
	else
		return ..()

/obj/item/gun/launcher/pneumatic/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!tank && istype(W,/obj/item/tank)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/launcher/pneumatic/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	eject_tank(user)

/obj/item/gun/launcher/pneumatic/consume_next_projectile(mob/user=null) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/launcher/pneumatic/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/gun/launcher/pneumatic/update_release_force(obj/item/projectile) // CHOMPEdit - Removal of obj/item/weapon
	if(tank)
...
/obj/item/gun/launcher/pneumatic/handle_post_fire() // CHOMPEdit - Removal of obj/item/weapon
	if(tank)
...
/obj/item/gun/launcher/pneumatic/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(tank)
...
/obj/item/cannonframe // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/cannonframe/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "pneumatic[buildstate]"

/obj/item/cannonframe/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	switch(buildstate)
		if(1)
...
/obj/item/cannonframe/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W,/obj/item/pipe))
		...
		if(buildstate == 2)
			...
			return
	else if(istype(W,/obj/item/transfer_valve)) // CHOMPEdit - Removal of obj/item/device
		if(buildstate == 4)
			user.drop_from_inventory(W)
			qdel(W)
		...
		if(buildstate == 5)
			if(T.remove_fuel(0,user))
				...
				new /obj/item/gun/launcher/pneumatic(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
				qdel(src)
		return
	else
		..()
