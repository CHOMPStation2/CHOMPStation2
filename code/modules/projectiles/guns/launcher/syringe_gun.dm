/obj/item/syringe_cartridge // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/reagent_containers/syringe/syringe // CHOMPEdit - Removal of obj/item/weapon

/obj/item/syringe_cartridge/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	underlays.Cut()
	if(syringe)
		underlays += image(syringe.icon, src, syringe.icon_state)
		underlays += syringe.filling

/obj/item/syringe_cartridge/attackby(obj/item/I, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(I, /obj/item/reagent_containers/syringe)) // CHOMPEdit - Removal of obj/item/weapon
		syringe = I
...
/obj/item/syringe_cartridge/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(syringe)
...
/obj/item/syringe_cartridge/proc/prime() // CHOMPEdit - Removal of obj/item/weapon
	//the icon state will revert back when update_icon() is called from throw_impact()
	icon_state = icon_flight
	underlays.Cut()

/obj/item/syringe_cartridge/throw_impact(atom/hit_atom, var/speed) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/launcher/syringe // CHOMPEdit - Removal of obj/item/weapon
	name = "syringe gun"
	...
	var/list/darts = list()
	var/max_darts = 1
	var/obj/item/syringe_cartridge/next // CHOMPEdit - Removal of obj/item/weapon

/obj/item/gun/launcher/syringe/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
	if(next)
		next.prime()
		return next
	return null

/obj/item/gun/launcher/syringe/handle_post_fire() // CHOMPEdit - Removal of obj/item/weapon
	..()
	darts -= next
	next = null

/obj/item/gun/launcher/syringe/attack_self(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(next)
...
/obj/item/gun/launcher/syringe/attack_hand(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(user.get_inactive_hand() == src)
		...
		if(next)
			...
			return
		var/obj/item/syringe_cartridge/C = darts[1] // CHOMPEdit - Removal of obj/item/weapon
		darts -= C
		user.put_in_hands(C)
...
/obj/item/gun/launcher/syringe/attackby(var/obj/item/A as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(A, /obj/item/syringe_cartridge)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/syringe_cartridge/C = A // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/launcher/syringe/rapid // CHOMPEdit - Removal of obj/item/weapon
