...
/obj/item/arrow // CHOMPEdit - Removal of obj/item/weapon
	name = "bolt"
...
/obj/item/arrow/proc/removed() //Helper for metal rods falling apart. // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/spike // CHOMPEdit - Removal of obj/item/weapon
	name = "alloy spike"
...
/obj/item/arrow/quill // CHOMPEdit - Removal of obj/item/weapon
	name = "alien quill"
...
/obj/item/arrow/rod // CHOMPEdit - Removal of obj/item/weapon
	name = "metal rod"
	desc = "Don't cry for me, Orithena."
	icon_state = "metal-rod"

/obj/item/arrow/rod/removed(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(throwforce == 15) // The rod has been superheated - we don't want it to be useable when removed from the bow.
		to_chat(user , "[src] shatters into a scattering of overstressed metal shards as it leaves the crossbow.")
		var/obj/item/material/shard/shrapnel/S = new() // CHOMPEdit - Removal of obj/item/weapon
		S.loc = get_turf(src)
		qdel(src)
...
/obj/item/gun/launcher/crossbow // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/cell/cell = null    // Used for firing superheated rods. // CHOMPEdit - Removal of obj/item/weapon
	var/current_user                        // Used to check if the crossbow has changed hands since being drawn.
	w_class = ITEMSIZE_HUGE //CHOMP Edit.

/obj/item/gun/launcher/crossbow/update_release_force() // CHOMPEdit - Removal of obj/item/weapon
	release_force = tension*release_speed

/obj/item/gun/launcher/crossbow/consume_next_projectile(mob/user=null) // CHOMPEdit - Removal of obj/item/weapon
	if(tension <= 0)
		to_chat(user, "<span class='warning'>\The [src] is not drawn back!</span>")
		return null
	return bolt

/obj/item/gun/launcher/crossbow/handle_post_fire(mob/user, atom/target) // CHOMPEdit - Removal of obj/item/weapon
	bolt = null
	tension = 0
	update_icon()
	..()

/obj/item/gun/launcher/crossbow/attack_self(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(tension)
		if(bolt)
			user.visible_message("[user] relaxes the tension on [src]'s string and removes [bolt].","You relax the tension on [src]'s string and remove [bolt].")
			bolt.loc = get_turf(src)
			var/obj/item/arrow/A = bolt // CHOMPEdit - Removal of obj/item/weapon
			bolt = null
			A.removed(user)
		else
...
/obj/item/gun/launcher/crossbow/proc/draw(var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/launcher/crossbow/proc/increase_tension(var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon

	if(!bolt || !tension || current_user != user) //Arrow has been fired, bow has been relaxed or user has changed.
		return


/obj/item/gun/launcher/crossbow/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!bolt)
		if (istype(W,/obj/item/arrow)) // CHOMPEdit - Removal of obj/item/weapon
			...
			if (R.use(1))
				bolt = new /obj/item/arrow/rod(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/launcher/crossbow/proc/superheat_rod(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!user || !cell || !bolt) return
	if(cell.charge < 500) return
	if(bolt.throwforce >= 15) return
	if(!istype(bolt,/obj/item/arrow/rod)) return // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/launcher/crossbow/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(tension > 1)
...
/obj/item/crossbowframe // CHOMPEdit - Removal of obj/item/weapon
	name = "crossbow frame"
...
/obj/item/crossbowframe/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "crossbowframe[buildstate]"

/obj/item/crossbowframe/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	switch(buildstate)
		if(1)
...
/obj/item/crossbowframe/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W,/obj/item/stack/rods))
		...
		if(buildstate == 1)
			var/obj/item/weldingtool/T = W.get_welder() // CHOMPEdit - Removal of obj/item/weapon
		...
		if(buildstate == 5)
			...
			playsound(src, W.usesound, 50, 1)
			new /obj/item/gun/launcher/crossbow(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
			qdel(src)
		return
	else
		..()
