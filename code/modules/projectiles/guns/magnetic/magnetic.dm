...
/obj/item/gun/magnetic // CHOMPEdit - Removal of obj/item/weapon
...
//	one_handed_penalty = 15
	...
	var/obj/item/cell/cell                              // Currently installed powercell. // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/stock_parts/capacitor/capacitor        // Installed capacitor. Higher rating == faster charge between shots. Set to a path to spawn with one of that type. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/magnetic/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/gun/magnetic/Destroy() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/magnetic/get_cell() // CHOMPEdit - Removal of obj/item/weapon
	return cell

/obj/item/gun/magnetic/process() // CHOMPEdit - Removal of obj/item/weapon
	if(capacitor)
		if(cell)
...
/obj/item/gun/magnetic/proc/update_state() // CHOMPEdit - Removal of obj/item/weapon
	var/newstate = 0
...
/obj/item/gun/magnetic/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	cut_overlays()
	if(state & ICON_CELL)
...
/obj/item/gun/magnetic/proc/show_ammo() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/magnetic/examine(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/gun/magnetic/attackby(var/obj/item/thing, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon

	if(removable_components)
		if(istype(thing, /obj/item/cell)) // CHOMPEdit - Removal of obj/item/weapon
			if(cell)
		...
		if(istype(thing, /obj/item/stock_parts/capacitor)) // CHOMPEdit - Removal of obj/item/weapon
			if(capacitor)
...
/obj/item/gun/magnetic/attack_hand(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/magnetic/proc/check_ammo() // CHOMPEdit - Removal of obj/item/weapon
	return loaded

/obj/item/gun/magnetic/proc/use_ammo() // CHOMPEdit - Removal of obj/item/weapon
	qdel(loaded)
	loaded = null

/obj/item/gun/magnetic/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/magnetic/fuelrod // CHOMPEdit - Removal of obj/item/weapon
	...
	load_type = /obj/item/fuel_assembly // CHOMPEdit - Removal of obj/item/weapon
	projectile_type = /obj/item/projectile/bullet/magnetic/fuelrod

	power_cost = 500

/obj/item/gun/magnetic/fuelrod/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
	if(!check_ammo() || !capacitor || capacitor.charge < power_cost)
		return

	if(loaded) //Safety.
		if(istype(loaded, /obj/item/fuel_assembly)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/fuel_assembly/rod = loaded // CHOMPEdit - Removal of obj/item/weapon
			//CHOMPEdit Begin
...
/obj/item/gun/magnetic/fuelrod/proc/blitzed(var/turf/T, var/mob/living/carbon/M, var/max_range, var/banglet)					// Added a new proc called 'bang' that takes a location and a person to be banged. // CHOMPEdit - Removal of obj/item/weapon
	...
	if(ishuman(M))
		...
		if (E && E.damage >= E.min_bruised_damage)
			...
			if(!banglet && !(istype(src , /obj/item/grenade/flashbang/clusterbang))) // CHOMPEdit - Removal of obj/item/weapon
...
//CHOMPEdit End
/obj/item/gun/magnetic/fuelrod/New() // CHOMPEdit - Removal of obj/item/weapon
	cell = new /obj/item/cell/high // CHOMPEdit - Removal of obj/item/weapon
	capacitor = new /obj/item/stock_parts/capacitor // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
