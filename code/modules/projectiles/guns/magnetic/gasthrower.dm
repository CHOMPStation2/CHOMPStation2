/obj/item/gun/magnetic/gasthrower // CHOMPEdit - Removal of obj/item/weapon
	...
	load_type = /obj/item/tank // CHOMPEdit - Removal of obj/item/weapon
	projectile_type = /obj/item/projectile/scatter/flamethrower

	power_cost = 250

/obj/item/gun/magnetic/gasthrower/check_ammo() // CHOMPEdit - Removal of obj/item/weapon
	if(!loaded || !istype(loaded, load_type))
		return 0

	var/obj/item/tank/Tank = loaded // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/magnetic/gasthrower/use_ammo() // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/tank/Tank = loaded // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/magnetic/gasthrower/show_ammo(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()

	if(loaded)
		var/obj/item/tank/T = loaded // CHOMPEdit - Removal of obj/item/weapon
