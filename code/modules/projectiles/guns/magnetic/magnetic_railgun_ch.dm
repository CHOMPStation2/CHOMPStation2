...
/obj/item/gun/magnetic/railgun/equipped() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	is_picked_up = TRUE
	update_transform()

/obj/item/gun/magnetic/railgun/pickup() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	is_picked_up = TRUE
	update_transform()

/obj/item/gun/magnetic/railgun/dropped() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	is_picked_up = FALSE
	update_transform()

/obj/item/gun/magnetic/railgun/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if((!(type == /obj/item/gun/magnetic/railgun)) && !is64x32_override) // CHOMPEdit - Removal of obj/item/weapon
		is64x32 = FALSE
...
/obj/item/gun/magnetic/railgun/update_transform() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(is64x32)
		if(is_picked_up)
