/obj/item/gun/magnetic/matfed // CHOMPEdit - Removal of obj/item/weapon
	power_cost = 750
	load_type = list(/obj/item/stack/material, /obj/item/ore) // CHOMPEdit - Removal of obj/item/weapon
	...
	var/ammo_material
	var/obj/item/stock_parts/manipulator/manipulator    // Installed manipulator. Mostly for Phoron Bore, higher rating == less mats consumed upon firing. Set to a path to spawn with one of that type. // CHOMPEdit - Removal of obj/item/weapon
	var/rating_modifier = 0 // rating of installed capacitor + manipulator
	var/loading = FALSE

/obj/item/gun/magnetic/matfed/proc/update_rating_mod() // CHOMPEdit - Removal of obj/item/weapon
	if(capacitor && manipulator)
		rating_modifier = capacitor.get_rating() + manipulator.get_rating()
	else
		rating_modifier = FALSE

/obj/item/gun/magnetic/matfed/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/gun/magnetic/matfed/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	QDEL_NULL(manipulator)
	. = ..()

/obj/item/gun/magnetic/matfed/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(manipulator)
...
/obj/item/gun/magnetic/matfed/update_icon() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/magnetic/matfed/attack_hand(var/mob/user) // It doesn't keep a loaded item inside. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/magnetic/matfed/check_ammo() // CHOMPEdit - Removal of obj/item/weapon
	if(mat_storage - mat_cost >= 0)
		return TRUE
	return FALSE

/obj/item/gun/magnetic/matfed/use_ammo() // CHOMPEdit - Removal of obj/item/weapon
	mat_storage -= mat_cost

/obj/item/gun/magnetic/matfed/show_ammo() // CHOMPEdit - Removal of obj/item/weapon
	if(mat_storage)
...
/obj/item/gun/magnetic/matfed/attackby(var/obj/item/thing, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	update_rating_mod()
	if(removable_components)
		...
		if(istype(thing, /obj/item/stock_parts/manipulator)) // CHOMPEdit - Removal of obj/item/weapon
			if(manipulator)
...
/obj/item/gun/magnetic/matfed/phoronbore/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/magnetic/matfed/phoronbore/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(rating_modifier)
...
/obj/item/gun/magnetic/matfed/phoronbore/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	soundloop = new(list(src), 0)

/obj/item/gun/magnetic/matfed/phoronbore/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	QDEL_NULL(soundloop)
	. = ..()

/obj/item/gun/magnetic/matfed/phoronbore/ui_action_click() // CHOMPEdit - Removal of obj/item/weapon
	toggle_generator(usr)

/obj/item/gun/magnetic/matfed/phoronbore/process() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/magnetic/matfed/phoronbore/proc/generator_generate() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/magnetic/matfed/phoronbore/proc/toggle_generator(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!generator_state && !mat_storage)
...
/obj/item/gun/magnetic/matfed/phoronbore/loaded // CHOMPEdit - Removal of obj/item/weapon
	cell = /obj/item/cell/apc // CHOMPEdit - Removal of obj/item/weapon
	capacitor = /obj/item/stock_parts/capacitor // CHOMPEdit - Removal of obj/item/weapon
