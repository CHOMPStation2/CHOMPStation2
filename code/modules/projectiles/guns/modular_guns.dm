...
/obj/item/gun/energy/modular // CHOMPEdit - Removal of obj/item/weapon
	name = "modular weapon"
	desc = "You shouldn't be seeing this. Contact your local time-police station."
	icon_state = "mod_pistol"
	cell_type = /obj/item/cell/device/weapon // CHOMPEdit - Removal of obj/item/weapon
	charge_cost = 120
...
/obj/item/gun/energy/modular/New() //Initialize our components. // CHOMPEdit - Removal of obj/item/weapon
	..()
	guncomponents = list()
	guncomponents += new /obj/item/stock_parts/capacitor // CHOMPEdit - Removal of obj/item/weapon
	guncomponents += new /obj/item/stock_parts/micro_laser // CHOMPEdit - Removal of obj/item/weapon
	guncomponents += new /obj/item/stock_parts/manipulator // CHOMPEdit - Removal of obj/item/weapon
	CheckParts()
	FireModeModify()

/obj/item/gun/energy/modular/CheckParts() //What parts do we have inside us, and how good are they? // CHOMPEdit - Removal of obj/item/weapon
	..()
	capacitor_rating = 0
	laser_rating = 0
	manipulator_rating = 0
	for(var/obj/item/stock_parts/capacitor/CA in guncomponents) // CHOMPEdit - Removal of obj/item/weapon
		capacitor_rating += CA.rating
	for(var/obj/item/stock_parts/micro_laser/ML in guncomponents) // CHOMPEdit - Removal of obj/item/weapon
		laser_rating += ML.rating
	for(var/obj/item/stock_parts/manipulator/MA in guncomponents) // CHOMPEdit - Removal of obj/item/weapon
		manipulator_rating += MA.rating
	FireModeModify()

/obj/item/gun/energy/modular/attackby(obj/item/O, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(guncomponents.len >= max_components) //We have too many componenets and can't fit more.
		...
		return
	if(istype(O, /obj/item/stock_parts/capacitor) && capacitor_rating == 5) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/modular/proc/FireModeModify() //Check our laser, manipulator, and capacitor ratings, adjust stun and lethal firemodes depending on laser / manipulator rating and burst size depending on capacitors. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/modular/load_ammo(var/obj/item/C, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/modular/pistol // CHOMPEdit - Removal of obj/item/weapon
	name = "modular pistol"
	icon_state = "mod_pistol"
	max_components = 6
...
/obj/item/gun/energy/modular/carbine // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/modular/cannon // CHOMPEdit - Removal of obj/item/weapon
	name = "modular cannon"
	icon_state = "mod_cannon"
	max_components = 14
	desc = "Say hello, to my little friend!"
	one_handed_penalty = 4 //dual wielding = no.
	cell_type = /obj/item/cell //We're bigger. We can use much larger power cells. // CHOMPEdit - Removal of obj/item/weapon
