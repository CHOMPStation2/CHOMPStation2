...
/obj/item/gun/launcher/spikethrower // CHOMPEdit - Removal of obj/item/weapon
	name = "spike thrower"
...
/obj/item/gun/launcher/spikethrower/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	START_PROCESSING(SSobj, src)
	last_regen = world.time

/obj/item/gun/launcher/spikethrower/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	STOP_PROCESSING(SSobj, src)
	..()

/obj/item/gun/launcher/spikethrower/process() // CHOMPEdit - Removal of obj/item/weapon
	if(spikes < max_spikes && world.time > last_regen + spike_gen_time)
		spikes++
		last_regen = world.time
		update_icon()

/obj/item/gun/launcher/spikethrower/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	. += "It has [spikes] spike\s remaining."

/obj/item/gun/launcher/spikethrower/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "spikethrower[spikes]"

/obj/item/gun/launcher/spikethrower/update_release_force() // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/gun/launcher/spikethrower/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
	if(spikes < 1) return null
	spikes--
	return new /obj/item/spike(src) // CHOMPEdit - Removal of obj/item/weapon

/*
 * Vox Darkmatter Cannon
 */
/obj/item/gun/energy/darkmatter // CHOMPEdit - Removal of obj/item/weapon
 ...
 * Vox Sonic Cannon
 */
/obj/item/gun/energy/sonic // CHOMPEdit - Removal of obj/item/weapon
	name = "soundcannon"
