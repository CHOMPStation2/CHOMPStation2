/obj/item/gun/energy // CHOMPEdit - Removal of obj/item/weapon
	...
	var/accept_cell_type = /obj/item/cell/device // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/New() // CHOMPEdit - Removal of obj/item/weapon
	...
	if(self_recharge)
		power_supply = new /obj/item/cell/device/weapon(src) // CHOMPEdit - Removal of obj/item/weapon
...
//CHOMPEdit Start
/obj/item/gun/energy/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	update_icon()
//CHOMPEdit End

/obj/item/gun/energy/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	if(self_recharge)
		STOP_PROCESSING(SSobj, src)
	return ..()

/obj/item/gun/energy/get_cell() // CHOMPEdit - Removal of obj/item/weapon
	return power_supply

/obj/item/gun/energy/process() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/attackby(var/obj/item/A as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()

/obj/item/gun/energy/switch_firemodes(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(..())
		update_icon()

/obj/item/gun/energy/emp_act(severity) // CHOMPEdit - Removal of obj/item/weapon
	..()
	update_icon()

/obj/item/gun/energy/consume_next_projectile() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/proc/load_ammo(var/obj/item/C, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(C, /obj/item/cell)) // CHOMPEdit - Removal of obj/item/weapon
		if(self_recharge || battery_lock)
			to_chat(user, "<span class='notice'>[src] does not have a battery port.</span>")
			return
		if(istype(C, accept_cell_type))
			var/obj/item/cell/P = C // CHOMPEdit - Removal of obj/item/weapon
			if(power_supply)
...
/obj/item/gun/energy/proc/unload_ammo(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(self_recharge || battery_lock)
		to_chat(user, "<span class='notice'>[src] does not have a battery port.</span>")
		return
	if(power_supply)
...
/obj/item/gun/energy/attack_hand(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(user.get_inactive_hand() == src)
		unload_ammo(user)
	else
		return ..()

/obj/item/gun/energy/proc/get_external_power_supply() // CHOMPEdit - Removal of obj/item/weapon
	if(isrobot(src.loc))
	...
	if(istype(src.loc, /obj/item/rig_module))
		...
		if(module.holder && module.holder.wearer)
			...
			if(istype(H) && H.get_rig())
				var/obj/item/rig/suit = H.get_rig() // CHOMPEdit - Removal of obj/item/weapon
				if(istype(suit))
					return suit.cell
	return null

/obj/item/gun/energy/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(shot_counter)
		if(power_supply)
			if(charge_cost)
...
/obj/item/gun/energy/update_icon(var/ignore_inhands) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/proc/start_recharge() // CHOMPEdit - Removal of obj/item/weapon
	if(power_supply == null)
		power_supply = new /obj/item/cell/device/weapon(src) // CHOMPEdit - Removal of obj/item/weapon
	self_recharge = 1
	START_PROCESSING(SSobj, src)
...
/obj/item/gun/energy/get_description_interaction() // CHOMPEdit - Removal of obj/item/weapon
...
// TGMC AMMO HUD
/obj/item/gun/energy/has_ammo_counter() // CHOMPEdit - Removal of obj/item/weapon
	return TRUE

/obj/item/gun/energy/get_ammo_type() // CHOMPEdit - Removal of obj/item/weapon
	if(!projectile_type)
...
/obj/item/gun/energy/get_ammo_count() // CHOMPEdit - Removal of obj/item/weapon
	if(!power_supply)
		return 0
	else
