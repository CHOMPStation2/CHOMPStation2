...
/obj/item/gun/proc/get_dna(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/verb/give_dna() // CHOMPEdit - Removal of obj/item/weapon
	set name = "Give DNA"
	set category = "Object"
	set src in usr
	get_dna(usr)

/obj/item/gun/proc/clear_dna(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	var/mob/living/M = user
	if(!attached_lock.controller_lock)
...
/obj/item/gun/verb/remove_dna() // CHOMPEdit - Removal of obj/item/weapon
	set name = "Remove DNA"
	set category = "Object"
	set src in usr
	clear_dna(usr)

/obj/item/gun/proc/toggledna(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	var/mob/living/M = user
...
/obj/item/gun/verb/allow_dna() // CHOMPEdit - Removal of obj/item/weapon
	set name = "Toggle DNA Samples Allowance"
	set category = "Object"
	set src in usr
	toggledna(usr)

/obj/item/gun/proc/authorized_user(mob/user) // CHOMPEdit - Removal of obj/item/weapon
