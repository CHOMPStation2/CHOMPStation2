...
/obj/vehicle/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(mechanical)
		...
		else if(istype(W, /obj/item/cell) && !cell && open) // CHOMPEdit - Removal of obj/item/weapon
			insert_cell(W, user)
...
/obj/vehicle/proc/insert_cell(var/obj/item/cell/C, var/mob/living/carbon/human/H) // CHOMPEdit - Removal of obj/item/weapon
	if(!mechanical)
		return
	if(cell)
		return
