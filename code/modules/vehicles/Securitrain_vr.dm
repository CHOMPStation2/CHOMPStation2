...
/obj/vehicle/train/security/engine
	...
	active_engines = 1
	var/obj/item/key/key // CHOMPEdit - Removal of obj/item/weapon
	var/key_type = /obj/item/key/security // CHOMPEdit - Removal of obj/item/weapon
	var/siren = 0 //This is for eventually getting the siren sprite to work.

/obj/item/key/security // CHOMPEdit - Removal of obj/item/weapon
...
/obj/vehicle/train/security/trolley/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(open && istype(W, /obj/item/tool/wirecutters)) // CHOMPEdit - Removal of obj/item/weapon
		passenger_allowed = !passenger_allowed
		user.visible_message("<span class='notice'>[user] [passenger_allowed ? "cuts" : "mends"] a cable in [src].</span>","<span class='notice'>You [passenger_allowed ? "cut" : "mend"] the load limiter cable.</span>")
	else
		..()

/obj/vehicle/train/security/engine/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/vehicle/train/security/trolley/insert_cell(var/obj/item/cell/C, var/mob/living/carbon/human/H) // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/vehicle/train/security/engine/insert_cell(var/obj/item/cell/C, var/mob/living/carbon/human/H) // CHOMPEdit - Removal of obj/item/weapon
	..()
	update_stats()
