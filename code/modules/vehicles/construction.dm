...
/obj/item/vehicle_assembly // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/vehicle_assembly/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	icon_state = "[initial(icon_state)][build_stage]"
	update_icon()

/obj/item/vehicle_assembly/proc/increase_step(var/new_name = null) // CHOMPEdit - Removal of obj/item/weapon
	build_stage++
	if(new_name)
		name = new_name
	icon_state = "[initial(icon_state)][build_stage]"
...
/obj/item/vehicle_assembly/quadbike // CHOMPEdit - Removal of obj/item/weapon
	name = "all terrain vehicle assembly"
	desc = "The frame of an ATV."
	icon_state = "quad-frame"
	pixel_x = -16

/obj/item/vehicle_assembly/quadbike/attackby(var/obj/item/W as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
	...
	switch(build_stage)
		...
		if(1)
			if(istype(W, /obj/item/stock_parts/console_screen)) // CHOMPEdit - Removal of obj/item/weapon
				user.drop_item()
				qdel(W)
		...
		if(2)
			if(istype(W, /obj/item/stock_parts/spring)) // CHOMPEdit - Removal of obj/item/weapon
				user.drop_item()
				qdel(W)
			...
			if(istype(W, /obj/item/stack/material/steel))
				...
				if(do_after(user, 80) && build_stage == 2)
					if(S.use(5))
						var/obj/item/vehicle_assembly/quadtrailer/Trailer = new(src) // CHOMPEdit - Removal of obj/item/weapon
		...
		if(5)
			if(istype(W, /obj/item/stock_parts/motor)) // CHOMPEdit - Removal of obj/item/weapon
				user.drop_item()
				qdel(W)
...
/obj/item/vehicle_assembly/quadtrailer // CHOMPEdit - Removal of obj/item/weapon
	name = "all terrain trailer"
	desc = "The frame of a small trailer."
	icon_state = "quadtrailer-frame"
	pixel_x = -16

/obj/item/vehicle_assembly/quadtrailer/attackby(var/obj/item/W as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()

	switch(build_stage)
		if(0)
			if(istype(W, /obj/item/vehicle_assembly/quadbike)) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/vehicle_assembly/quadbike/Q = W // CHOMPEdit - Removal of obj/item/weapon
				if(Q.build_stage > 2)
...
/obj/item/vehicle_assembly/spacebike // CHOMPEdit - Removal of obj/item/weapon
	name = "vehicle assembly"
	desc = "The frame of some vehicle."
...
/obj/item/vehicle_assembly/spacebike/attackby(var/obj/item/W as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	switch(build_stage)
		if(0)
			if(istype(W, /obj/item/tank/jetpack) || istype(W, /obj/item/borg/upgrade/advanced/jetpack)) // CHOMPEdit - Removal of obj/item/weapon
				user.drop_item()
				qdel(W)
				increase_step()
...
/obj/item/vehicle_assembly/snowmobile // CHOMPEdit - Removal of obj/item/weapon
	name = "snowmobile assembly"
	desc = "The frame of a snowmobile."
	icon = 'icons/obj/vehicles.dmi'
	icon_state = "snowmobile-frame"

/obj/item/vehicle_assembly/snowmobile/attackby(var/obj/item/W as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	switch(build_stage)
		if(0)
			if(istype(W, /obj/item/stack/material/steel))
				var/obj/item/stack/material/steel/S = W
