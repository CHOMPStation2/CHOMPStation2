...
/obj/item/oar // CHOMPEdit - Removal of obj/item/weapon
	name = "oar"
...
/obj/item/oar/sifwood/New(newloc, material_name) // CHOMPEdit - Removal of obj/item/weapon
	..(newloc, MAT_SIFWOOD)

/obj/item/oar/New(newloc, material_name) // CHOMPEdit - Removal of obj/item/weapon
	..(newloc)
	if(!material_name)
		material_name = "wood"
