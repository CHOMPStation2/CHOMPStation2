...
/obj/vehicle/train/engine/quadbike //It's a train engine, so it can tow trailers.
	...
	active_engines = 1
	key_type = /obj/item/key/quadbike // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/key/quadbike // CHOMPEdit - Removal of obj/item/weapon
	name = "key"
...
/obj/vehicle/train/engine/quadbike/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/multitool) && open) // CHOMPEdit - Removal of obj/item/device
...
/obj/vehicle/train/trolley/trailer/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/multitool) && open) // CHOMPEdit - Removal of obj/item/device
		var/new_paint = input(usr, "Please select paint color.", "Paint Color", paint_color) as color|null
		if(new_paint)
			paint_color = new_paint
