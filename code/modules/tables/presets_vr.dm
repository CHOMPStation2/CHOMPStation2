...
/obj/structure/table/darkglass/dismantle(obj/item/tool/wrench/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/table/fancyblack/dismantle(obj/item/tool/wrench/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	to_chat(user, "<span class='warning'>You cannot dismantle \the [src].</span>")
	return
