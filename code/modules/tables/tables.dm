...
/obj/structure/table/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(health < maxhealth && W.has_tool_quality(TOOL_WELDER))
		var/obj/item/weldingtool/F = W.get_welder() // CHOMPEdit - Removal of obj/item/weapon
		if(F.welding)
...
/obj/structure/table/proc/remove_reinforced(obj/item/S, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	reinforced = common_material_remove(user, reinforced, 40 * S.toolspeed, "reinforcements", "screws", S.usesound)

/obj/structure/table/proc/remove_material(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
// Returns a list of /obj/item/material/shard objects that were created as a result of this table's breakage. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/table/proc/break_to_parts(full_return = 0)
	...
	var/obj/item/material/shard/S = null // CHOMPEdit - Removal of obj/item/weapon
	if(reinforced)
