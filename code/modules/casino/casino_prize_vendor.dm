...
/obj/machinery/casino_prize_dispenser/Initialize(mapload)
	...
	item_list["Gear"] = list(
		CASINO_PRIZE("Experimental Welder", /obj/item/weldingtool/experimental, 1, 250, "gear"),
		CASINO_PRIZE("Alien Belt", /obj/item/storage/belt/utility/alien/full, 1, 750, "gear"),
