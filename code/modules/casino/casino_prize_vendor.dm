...
/obj/machinery/casino_prize_dispenser/Initialize()
	...
	item_list["Implants and Genemods"] = list(
		...
		//CASINO_PRIZE("Genemod: Remote view", /obj/item/dnainjector/set_trait/remote_view, 1, 1000, "implants"), //CHOMPEDIT: Commented out due to remote_view not being a genetrait
