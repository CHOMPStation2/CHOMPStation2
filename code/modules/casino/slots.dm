...
/obj/machinery/slot_machine/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(busy)
...
/obj/machinery/slot_machine/proc/insert_chip(var/obj/item/spacecasinocash/cashmoney, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if (ispowered == 0)
		return
	if (isbroken)
		return
	...
	spawn(delaytime)
		...
		if(platinumwin) // Did they win the platinum chip?
			new /obj/item/casino_platinum_chip(src.loc) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/station_slot_machine/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(busy)
		to_chat(user,"<span class='notice'>The slot machine is currently running.</span> ")
		return
	if(W.has_tool_quality(TOOL_WRENCH))
	...
	if(istype(W, /obj/item/spacecash)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/spacecash/C = W // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/station_slot_machine/proc/insert_cash(var/obj/item/spacecash/cashmoney, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if (ispowered == 0)
		return
	if (isbroken)
		return
