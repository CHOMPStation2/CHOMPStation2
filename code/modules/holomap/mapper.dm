...
/obj/item/mapping_unit/deathsquad // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mapping_unit/operative // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mapping_unit/ert // CHOMPEdit - Removal of obj/item/device
	...
	prefix_update_rig = list(
		"/obj/item/rig/ert" = "ertc", // CHOMPEdit - Removal of obj/item/weapon
		"/obj/item/rig/ert/security" = "erts", // CHOMPEdit - Removal of obj/item/weapon
		"/obj/item/rig/ert/engineer" = "erte", // CHOMPEdit - Removal of obj/item/weapon
		"/obj/item/rig/ert/medical" = "ertm" // CHOMPEdit - Removal of obj/item/weapon
	)

/obj/item/mapping_unit/Initialize() // CHOMPEdit - Removal of obj/item/device
	. = ..()
...
/obj/item/mapping_unit/Destroy() // CHOMPEdit - Removal of obj/item/device
	mapping_units -= src
...
/obj/item/mapping_unit/dropped(mob/dropper) // CHOMPEdit - Removal of obj/item/device
	if(loc != dropper) // Not just a juggle
		hide_device()

/obj/item/mapping_unit/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mapping_unit/attack_hand(mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mapping_unit/attackby(obj/W, mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mapping_unit/proc/first_run(mob/user) // CHOMPEdit - Removal of obj/item/device
	hud_datum = new(user.hud_used, src)
	hud_item = hud_datum.screenobjs[1]

/obj/item/mapping_unit/proc/show_device(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(!hud_datum)
		first_run(user)
	else
		hud_datum.apply_to_hud(user.hud_used)

/obj/item/mapping_unit/proc/start_updates() // CHOMPEdit - Removal of obj/item/device
	mapping_units += src
	updating = TRUE
...
/obj/item/mapping_unit/proc/stop_updates() // CHOMPEdit - Removal of obj/item/device
	mapping_units -= src
...
/obj/item/mapping_unit/proc/hide_device() // CHOMPEdit - Removal of obj/item/device
	hud_datum?.unapply_to_hud()

/obj/item/mapping_unit/proc/last_run() // CHOMPEdit - Removal of obj/item/device
	stop_updates()
...
/obj/item/mapping_unit/process() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mapping_unit/proc/update_holomap() // CHOMPEdit - Removal of obj/item/device
	...
	for(var/obj/item/mapping_unit/HC as anything in mapping_units) // CHOMPEdit - Removal of obj/item/device
	...
	// Marker beacon items
	for(var/obj/item/holomap_beacon/HB as anything in mapping_beacons) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mapping_unit/proc/update_marker() // CHOMPEdit - Removal of obj/item/device
	...
	if (prefix_update_rig)
		if(ishuman(loc))
			var/mob/living/carbon/human/H = loc
			var/obj/item/rig = H.get_rig() // CHOMPEdit - Removal of obj/item/weapon
			if(rig && ("[rig.type]" in prefix_update_rig))
				marker_prefix = prefix_update_rig["[rig.type]"]
				return

/obj/item/mapping_unit/proc/handle_marker(var/atom/movable/marker,var/TU_x,var/TU_y) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/holomap_beacon // CHOMPEdit - Removal of obj/item/device
	name = "holomap beacon"
...
/obj/item/holomap_beacon/Initialize() // CHOMPEdit - Removal of obj/item/device
	. = ..()
...
/obj/item/holomap_beacon/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(!in_list)
		in_list = TRUE
		mapping_beacons += src
	else
...
/obj/item/holomap_beacon/Destroy() // CHOMPEdit - Removal of obj/item/device
	if(in_list)
		mapping_beacons -= src
	return ..()

/obj/item/holomap_beacon/deathsquad // CHOMPEdit - Removal of obj/item/device
	name = "deathsquad holomap beacon"
	icon_state = "holochip_ds"
	mapper_filter = HOLOMAP_FILTER_DEATHSQUAD

/obj/item/holomap_beacon/operative // CHOMPEdit - Removal of obj/item/device
	name = "operative holomap beacon"
	icon_state = "holochip_op"
	mapper_filter = HOLOMAP_FILTER_NUKEOPS

/obj/item/holomap_beacon/ert // CHOMPEdit - Removal of obj/item/device
