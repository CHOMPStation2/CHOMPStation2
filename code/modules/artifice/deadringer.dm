/obj/item/deadringer // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/deadringer/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	START_PROCESSING(SSobj, src)

/obj/item/deadringer/Destroy() //just in case some smartass tries to stay invisible by destroying the watch // CHOMPEdit - Removal of obj/item/weapon
	reveal()
	STOP_PROCESSING(SSobj, src)
	..()

/obj/item/deadringer/dropped() // CHOMPEdit - Removal of obj/item/weapon
	if(timer > 20)
		reveal()
		watchowner = null
	return

/obj/item/deadringer/attack_self(var/mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/deadringer/proc/deathprevent() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/deadringer/proc/reveal() // CHOMPEdit - Removal of obj/item/weapon
	if(watchowner)
		watchowner.alpha = 255
		playsound(src, 'sound/effects/uncloak.ogg', 35, 1, -1)
	return

/obj/item/deadringer/proc/makeacorpse(var/mob/living/carbon/human/H) // CHOMPEdit - Removal of obj/item/weapon
	if(H.isSynthetic())
		return
	...
	if(H.get_equipped_item(slot_belt))
		corpse.equip_to_slot_or_del(new /obj/item/storage/belt/chameleon/changeling(corpse), slot_belt) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(H.get_equipped_item(slot_back))
		corpse.equip_to_slot_or_del(new /obj/item/storage/backpack/chameleon/changeling(corpse), slot_back) // CHOMPEdit - Removal of obj/item/weapon
