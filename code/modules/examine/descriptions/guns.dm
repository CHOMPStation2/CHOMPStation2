/obj/item/gun/proc/describe_firepower() // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/projectile/P
	if(istype(src, /obj/item/gun/energy)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/gun/energy/energy_gun = src // CHOMPEdit - Removal of obj/item/weapon
		P = new energy_gun.projectile_type()
	else if(istype(src, /obj/item/gun/projectile/shotgun/pump)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/gun/projectile/shotgun/pump/projectile_gun = src // CHOMPEdit - Removal of obj/item/weapon
		if(isnull(projectile_gun.chambered) || isnull(projectile_gun.chambered.BB))
			...
			P = ammo.BB
	else if(istype(src, /obj/item/gun/projectile)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/gun/projectile/projectile_gun = src // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/proc/describe_proj_penetration() // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/projectile/P
	if(istype(src, /obj/item/gun/energy)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/gun/energy/energy_gun = src // CHOMPEdit - Removal of obj/item/weapon
		P = new energy_gun.projectile_type()
...
/obj/item/gun/proc/describe_firerate() // CHOMPEdit - Removal of obj/item/weapon
	switch(fire_delay)
		if(0)
			return "no delay"
		if(1 to 4)
...
/obj/item/gun/get_description_info() // CHOMPEdit - Removal of obj/item/weapon
	var/is_loaded
	var/non_lethal
	var/non_lethal_list = list(/obj/item/gun/energy/medigun,/obj/item/gun/energy/mouseray,/obj/item/gun/energy/temperature,/obj/item/gun/energy/sizegun,/obj/item/gun/projectile/shotgun/pump/toy,/obj/item/gun/projectile/revolver/toy,/obj/item/gun/projectile/pistol/toy,/obj/item/gun/projectile/automatic/toy) // CHOMPEdit - Removal of obj/item/weapon
	var/less_lethal
	var/less_lethal_list = list(/obj/item/gun/energy/taser,/obj/item/gun/energy/stunrevolver,/obj/item/gun/energy/plasmastun,/obj/item/gun/energy/bfgtaser) // CHOMPEdit - Removal of obj/item/weapon
	var/weapon_stats = description_info + "\
	<br>"
	if(istype(src, /obj/item/gun/energy)) // CHOMPEdit - Removal of obj/item/weapon
		is_loaded = LAZYLEN(src.contents)
	if(istype(src, /obj/item/gun/projectile/shotgun/pump)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/gun/projectile/shotgun/pump/shotgun = src // CHOMPEdit - Removal of obj/item/weapon
		if(isnull(shotgun.chambered) || isnull(shotgun.chambered.BB))
			is_loaded = null
		else
			is_loaded = shotgun.chambered
	if(istype(src, /obj/item/gun/projectile)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/gun/projectile/projectile_gun = src // CHOMPEdit - Removal of obj/item/weapon
		var/ammo
		if(projectile_gun.ammo_magazine)
