...
/obj/item/gun/energy/gun/taser // CHOMPEdit - Removal of obj/item/weapon
	description_info = "This is an energy weapon.  To fire the weapon, ensure your intent is *not* set to 'help', have your gun mode set to 'fire', \
	then click where you want to fire.  Most energy weapons can fire through windows harmlessly. To recharge this weapon, use a weapon recharger."
...
/obj/item/gun/energy/chameleon/change(picked in gun_choices) //Making the gun change its help text to match the weapon's help text. // CHOMPEdit - Removal of obj/item/weapon
	..(picked)
...
//*******
/*
/obj/item/melee/baton/proc/describe_agonypower() // CHOMPEdit - Removal of obj/item/weapon
	switch(agonyforce)
		if(1 to 20)
...
/obj/item/melee/baton/get_description_info() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
