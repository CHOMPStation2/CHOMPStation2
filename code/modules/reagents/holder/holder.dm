<<<<<<< HEAD:code/modules/reagents/Chemistry-Holder.dm
...
/datum/reagents/proc/splash_turf(var/turf/T, var/amount = null, var/multiplier = 1, var/copy = 0)
	...
	if (total_volume <= 0)
		qdel(src)
||||||| parent of 828f6a31bb... Merge pull request #10179 from VOREStation/upstream-merge-8013:code/modules/reagents/Chemistry-Holder.dm
#define PROCESS_REACTION_ITER 5 //when processing a reaction, iterate this many times
...
/datum/reagents/proc/splash_turf(var/turf/T, var/amount = null, var/multiplier = 1, var/copy = 0)
	...
	if (total_volume <= 0)
		qdel(src)
>>>>>>> 828f6a31bb... Merge pull request #10179 from VOREStation/upstream-merge-8013:code/modules/reagents/holder/holder.dm
