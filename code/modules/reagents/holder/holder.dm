...
/datum/reagents/proc/splash_turf(var/turf/T, var/amount = null, var/multiplier = 1, var/copy = 0)
	...
	if (total_volume <= 0)
		qdel(src)
||||||| parent of b383e17875... Merge pull request #10243 from ShadowLarkens/personal_crafting:code/modules/reagents/holder/holder.dm
#define PROCESS_REACTION_ITER 5 //when processing a reaction, iterate this many times
...
/datum/reagents/proc/conditional_update(atom/A)
	...
	for(var/datum/reagent/reagent as anything in cached_reagents)
		reagent.on_update(A)
	update_total()
>>>>>>> b383e17875... Merge pull request #10243 from ShadowLarkens/personal_crafting:code/modules/reagents/holder/holder.dm
