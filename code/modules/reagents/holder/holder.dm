...
/datum/reagents/proc/conditional_update(atom/A)
	...
	for(var/datum/reagent/reagent as anything in cached_reagents)
		reagent.on_update(A)
	update_total()
||||||| parent of 5953ecba37... Merge pull request #10971 from VOREStation/Arokha/4runtimefixes
#define PROCESS_REACTION_ITER 5 //when processing a reaction, iterate this many times
...
/datum/reagents/proc/conditional_update(atom/A)
	...
	for(var/datum/reagent/reagent as anything in cached_reagents)
		reagent.on_update(A)
	update_total()
>>>>>>> 5953ecba37... Merge pull request #10971 from VOREStation/Arokha/4runtimefixes
