...
/obj/machinery/reagentgrinder/Initialize()
	. = ..()
	beaker = new /obj/item/reagent_containers/glass/beaker/large(src) // CHOMPEdit - Removal of obj/item/weapon
	default_apply_parts()
...
/obj/machinery/reagentgrinder/attackby(var/obj/item/O as obj, var/mob/user as mob)
	...
	if(istype(O,/obj/item/storage/bag/plants)) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(istype(O,/obj/item/gripper)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/gripper/B = O	//B, for Borg. // CHOMPEdit - Removal of obj/item/weapon
		if(!B.wrapped)
...
/obj/machinery/reagentgrinder/proc/replace_beaker(mob/living/user, obj/item/reagent_containers/new_beaker) // CHOMPEdit - Removal of obj/item/weapon
	if(!user)
		return FALSE
	if(beaker)
		if(!user.incapacitated() && Adjacent(user))
