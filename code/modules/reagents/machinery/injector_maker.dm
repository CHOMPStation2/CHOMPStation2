/obj/machinery/injector_maker
	...
	circuit = /obj/item/circuitboard/injector_maker // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/reagent_containers/beaker = null // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/injector_maker/attackby(var/obj/item/O as obj, var/mob/user as mob)
	...
	if(istype(O,/obj/item/reagent_containers/glass) || \
		...
		istype(O,/obj/item/reagent_containers/food/drinks/shaker)) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(istype(O,/obj/item/reagent_containers/hypospray/autoinjector/empty)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/reagent_containers/hypospray/autoinjector/empty/E = O // CHOMPEdit - Removal of obj/item/weapon
		...
		qdel(E)
		update_icon()
	if(istype(O,/obj/item/reagent_containers/hypospray/autoinjector/biginjector/empty)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/reagent_containers/hypospray/autoinjector/biginjector/empty/E = O // CHOMPEdit - Removal of obj/item/weapon
				...
				switch(material)
					...
					if("use injectors")
						if(!src.count_small_injector)
							...
							src.count_small_injector = src.count_small_injector - 1
				var/obj/item/reagent_containers/hypospray/autoinjector/empty/P = new(loc) // CHOMPEdit - Removal of obj/item/weapon
				...
				switch(material)
					...
					if("use injectors")
						if(!src.count_large_injector)
							...
							src.count_large_injector = src.count_large_injector - 1
				var/obj/item/reagent_containers/hypospray/autoinjector/biginjector/empty/P = new(loc) // CHOMPEdit - Removal of obj/item/weapon
				beaker.reagents.trans_to_obj(P, amount_per_injector)
				P.update_icon()
				if(new_name)
					P.name = new_name
