/obj/machinery/chem_master
	...
	icon_state = "mixer0"
	circuit = /obj/item/circuitboard/chem_master // CHOMPEdit - Removal of obj/item/weapon
	use_power = USE_POWER_IDLE
	idle_power_usage = 20
	var/obj/item/reagent_containers/beaker = null // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/storage/pill_bottle/loaded_pill_bottle = null // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/chem_master/attackby(var/obj/item/B as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon

	if(istype(B, /obj/item/reagent_containers/glass) || istype(B, /obj/item/reagent_containers/food)) // CHOMPEdit - Removal of obj/item/weapon
	...
	else if(istype(B, /obj/item/storage/pill_bottle)) // CHOMPEdit - Removal of obj/item/weapon
		...
		if(TGUI_MODAL_ANSWER)
			...
			switch(id)
				...
				if("create_condi_pack")
					...
					var/obj/item/reagent_containers/pill/P = new(loc) // CHOMPEdit - Removal of obj/item/weapon
					P.name = "[answer] pack"
				...
				if("create_patch")
					...
					while(count--)
						...
						var/obj/item/reagent_containers/pill/patch/P = new(loc) // CHOMPEdit - Removal of obj/item/weapon
						P.name = "[answer] patch"
						P.pixel_x = rand(-7, 7) // random position
						P.pixel_y = rand(-7, 7)
				...
				if("create_bottle")
					...
					while(count--)
						if(reagents.total_volume <= 0)
							...
							return
						var/obj/item/reagent_containers/glass/bottle/P = new(loc) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/chem_master/tgui_act(action, params, datum/tgui/ui, datum/tgui_state/state)
	...
	switch(action)
		...
		if("create_condi_bottle")
			if(!condi || !reagents.total_volume)
				return
			var/obj/item/reagent_containers/food/condiment/P = new(loc) // CHOMPEdit - Removal of obj/item/weapon
