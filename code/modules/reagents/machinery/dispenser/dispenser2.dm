/obj/machinery/chemical_dispenser
	...
	var/obj/item/reagent_containers/container = null // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/chemical_dispenser/proc/add_cartridge(obj/item/reagent_containers/chem_disp_cartridge/C, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(C))
		if(user)
...
/obj/machinery/chemical_dispenser/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(W.has_tool_quality(TOOL_WRENCH))
	...
	else if(istype(W, /obj/item/reagent_containers/chem_disp_cartridge)) // CHOMPEdit - Removal of obj/item/weapon
	...
	else if(istype(W, /obj/item/reagent_containers/glass) || istype(W, /obj/item/reagent_containers/food)) // CHOMPEdit - Removal of obj/item/weapon
		if(container)
		...
		if(!accept_drinking && istype(RC,/obj/item/reagent_containers/food)) // CHOMPEdit - Removal of obj/item/weapon
