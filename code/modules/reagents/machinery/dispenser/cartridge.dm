...
/obj/item/reagent_containers/chem_disp_cartridge/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(spawn_reagent)
...
/obj/item/reagent_containers/chem_disp_cartridge/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/chem_disp_cartridge/verb/verb_set_label(L as text) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/chem_disp_cartridge/proc/setLabel(L, mob/user = null) // CHOMPEdit - Removal of obj/item/weapon
	if(L)
		if(user)
...
/obj/item/reagent_containers/chem_disp_cartridge/attack_self() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if (is_open_container())
...
/obj/item/reagent_containers/chem_disp_cartridge/afterattack(obj/target, mob/user , flag) // CHOMPEdit - Removal of obj/item/weapon
