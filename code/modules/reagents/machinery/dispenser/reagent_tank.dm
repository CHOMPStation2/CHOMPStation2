...
/obj/structure/reagent_dispensers/cookingoil/proc/explode()
	...
	qdel(src)
||||||| parent of cb0b7d4e88... Merge pull request #11529 from GhostActual/wall-dispenser-fixes
/obj/structure/reagent_dispensers
	name = "Dispenser"
	desc = "..."
	icon = 'icons/obj/chemical_tanks.dmi'
...
/obj/structure/reagent_dispensers/cookingoil/proc/explode()
	...
	visible_message(span("danger", "The [src] bursts open, spreading oil all over the area."))
	qdel(src)
>>>>>>> cb0b7d4e88... Merge pull request #11529 from GhostActual/wall-dispenser-fixes
