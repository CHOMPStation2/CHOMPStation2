...
/obj/structure/reagent_dispensers/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	return
...
/obj/structure/reagent_dispensers/fueltank
	...
	amount_per_transfer_from_this = 10
	var/modded = 0
	var/obj/item/assembly_holder/rig = null // CHOMPEdit - Removal of obj/item/device
...
/obj/structure/reagent_dispensers/fueltank/barrel/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/reagent_dispensers/fueltank/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	...
	if (istype(W,/obj/item/assembly_holder)) // CHOMPEdit - Removal of obj/item/device
		...
		if(do_after(user, 20))
			...
			var/obj/item/assembly_holder/H = W // CHOMPEdit - Removal of obj/item/device
			if (istype(H.a_left,/obj/item/assembly/igniter) || istype(H.a_right,/obj/item/assembly/igniter)) // CHOMPEdit - Removal of obj/item/device
...
/obj/structure/reagent_dispensers/water_cooler/attackby(obj/item/I as obj, mob/user as mob)
	if(I.has_tool_quality(TOOL_WRENCH))
		...
		if(bottle)
			...
			if(do_after(user, 20) && bottle)
				...
				var/obj/item/reagent_containers/glass/cooler_bottle/G = new /obj/item/reagent_containers/glass/cooler_bottle( src.loc ) // CHOMPEdit - Removal of obj/item/weapon
				for(var/datum/reagent/R in reagents.reagent_list)
	...
	if(I.has_tool_quality(TOOL_SCREWDRIVER))
		if(cupholder)
			...
			if(cups)
				for(var/i = 0 to cups)
					new /obj/item/reagent_containers/food/drinks/sillycup(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			cups = 0
			cupholder = 0
			update_icon()
			return
	...
	if(istype(I, /obj/item/reagent_containers/glass/cooler_bottle)) // CHOMPEdit - Removal of obj/item/weapon
		src.add_fingerprint(user)
		if(!bottle)
			if(anchored)
				var/obj/item/reagent_containers/glass/cooler_bottle/G = I // CHOMPEdit - Removal of obj/item/weapon
