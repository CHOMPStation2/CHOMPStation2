...
/obj/item/reagent_containers/verb/set_APTFT() //set amount_per_transfer_from_this // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/reagent_containers/afterattack(obj/target, mob/user, flag) // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/reagent_containers/proc/reagentlist() // For attack logs // CHOMPEdit - Removal of obj/item/weapon
	if(reagents)
		return reagents.get_reagents()
	return "No reagent holder"

/obj/item/reagent_containers/proc/standard_dispenser_refill(var/mob/user, var/obj/structure/reagent_dispensers/target) // This goes into afterattack // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(target))
		return 0
...
/obj/item/reagent_containers/proc/standard_splash_mob(var/mob/user, var/mob/target) // This goes into afterattack // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(target))
		return
...
/obj/item/reagent_containers/proc/self_feed_message(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	// to_chat(user, "<span class='notice'>You eat \the [src]</span>")
	balloon_alert(user, "You eat \the [src]") // CHOMPEdit - Changed to balloon alert

/obj/item/reagent_containers/proc/other_feed_message_start(var/mob/user, var/mob/target) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/proc/other_feed_message_finish(var/mob/user, var/mob/target) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/proc/feed_sound(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/reagent_containers/proc/standard_feed_mob(var/mob/user, var/mob/target) // This goes into attack // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/proc/standard_pour_into(var/mob/user, var/atom/target) // This goes into afterattack and yes, it's atom-level // CHOMPEdit - Removal of obj/item/weapon
