...
/obj/item/reagent_containers/pill/patch // CHOMPEdit - Removal of obj/item/weapon
	name = "patch"
	desc = "A patch."
...
/obj/item/reagent_containers/pill/patch/attack(mob/M as mob, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
