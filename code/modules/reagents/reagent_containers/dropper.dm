...
/obj/item/reagent_containers/dropper/examine(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/dropper/afterattack(var/obj/target, var/mob/user, var/proximity) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(reagents.total_volume)
		...
		if(!target.is_open_container() && !ismob(target) && !istype(target, /obj/item/reagent_containers/food) && !istype(target, /obj/item/clothing/mask/smokable/cigarette)) //You can inject humans and food but you cant remove the shit. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/dropper/on_reagent_change() // CHOMPEdit - Removal of obj/item/weapon
	update_icon()

/obj/item/reagent_containers/dropper/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(reagents.total_volume)
		icon_state = "dropper1"
	else
		icon_state = "dropper0"

/obj/item/reagent_containers/dropper/industrial // CHOMPEdit - Removal of obj/item/weapon
