...
/decl/chemical_reaction/distilling/on_reaction(var/datum/reagents/holder, var/created_volume)
	if(istype(holder.my_atom, /obj/item/reagent_containers/glass/distilling)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/reagent_containers/glass/distilling/D = holder.my_atom // CHOMPEdit - Removal of obj/item/weapon
