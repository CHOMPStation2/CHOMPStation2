...
/datum/reagent/ethanol/touch_obj(var/obj/O)
	...
	if(istype(O, /obj/item/paper)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/paper/paperaffected = O // CHOMPEdit - Removal of obj/item/weapon
	...
	if(istype(O, /obj/item/book)) // CHOMPEdit - Removal of obj/item/weapon
		if(volume < 5)
			return
		if(istype(O, /obj/item/book/tome)) // CHOMPEdit - Removal of obj/item/weapon
			to_chat(usr, "<span class='notice'>The solution does nothing. Whatever this is, it isn't normal ink.</span>")
			return
		var/obj/item/book/affectedbook = O // CHOMPEdit - Removal of obj/item/weapon
