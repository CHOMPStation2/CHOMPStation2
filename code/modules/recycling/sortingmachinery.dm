...
/obj/item/packageWrap/afterattack(var/obj/target as obj, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!proximity) return
	if(!istype(target))	//this really shouldn't be necessary (but it is).	-Pete
		return
	if(istype(target, /obj/item/smallDelivery) || istype(target,/obj/structure/bigDelivery) \
	|| istype(target, /obj/item/gift) || istype(target, /obj/item/evidencebag)) // CHOMPEdit - Removal of obj/item/weapon
		return
	if(target.anchored)
		return
	...
	if (istype(target, /obj/item) && !(istype(target, /obj/item/storage) && !istype(target,/obj/item/storage/box))) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/packageWrap/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/destTagger/tgui_state(mob/user) // CHOMPEdit - Removal of obj/item/device
	return GLOB.tgui_inventory_state

/obj/item/destTagger/tgui_interact(mob/user, datum/tgui/ui) // CHOMPEdit - Removal of obj/item/device
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "DestinationTagger", name)
		ui.open()

/obj/item/destTagger/tgui_static_data(mob/user) // CHOMPEdit - Removal of obj/item/device
	var/list/data = ..()
...
/obj/item/destTagger/tgui_data(mob/user, datum/tgui/ui) // CHOMPEdit - Removal of obj/item/device
	var/list/data = ..()
...
/obj/item/destTagger/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	tgui_interact(user)

/obj/item/destTagger/tgui_act(action, params) // CHOMPEdit - Removal of obj/item/device
	if(..())
		return TRUE
	add_fingerprint(usr)
	switch(action)
