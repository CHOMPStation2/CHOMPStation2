...
/obj/machinery/disposal/attackby(var/obj/item/I, var/mob/user)
	...
	if(istype(I, /obj/item/melee/energy/blade)) // CHOMPEdit - Removal of obj/item/weapon
		to_chat(user, "You can't place that item inside the disposal unit.")
		return

	if(istype(I, /obj/item/storage/bag/trash)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/storage/bag/trash/T = I // CHOMPEdit - Removal of obj/item/weapon
	...
	if(istype(I, /obj/item/material/ashtray)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/material/ashtray/A = I // CHOMPEdit - Removal of obj/item/weapon
		if(A.contents.len > 0)
	...
	user.drop_item()
	if(I)
		if(istype(I, /obj/item/holder/micro)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/disposal/hitby(atom/movable/AM)
	...
	if((istype(AM, /obj/item) || istype(AM, /mob/living)) && !istype(AM, /obj/item/projectile))
		if(prob(75))
			AM.forceMove(src)
			if(istype(AM, /obj/item/holder/micro) || istype(AM, /mob/living)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/disposalpipe/tagger/attackby(var/obj/item/I, var/mob/user)
	...
	if(istype(I, /obj/item/destTagger)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/destTagger/O = I // CHOMPEdit - Removal of obj/item/device
