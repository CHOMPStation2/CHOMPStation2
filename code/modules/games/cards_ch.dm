...
/obj/item/deck/casino // CHOMPEdit - Removal of obj/item/weapon
	w_class = ITEMSIZE_SMALL
	icon = 'icons/obj/playing_cards_ch.dmi'
	cooldown = 0 // to prevent spam shuffle

/obj/item/deck/holder/casino //WIP In future do a cool holder // CHOMPEdit - Removal of obj/item/weapon
	name = "card box"
	desc = "A small leather case to show how classy you are compared to everyone else."
	icon = 'icons/obj/playing_cards_ch.dmi'
	icon_state = "card_holder"

/obj/item/deck/cards/casino // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/deck/cards/casino/New() // CHOMPEdit - Removal of obj/item/weapon
