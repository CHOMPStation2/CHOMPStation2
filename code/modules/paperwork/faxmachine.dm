...
/obj/machinery/photocopier/faxmachine
	...
	circuit = /obj/item/circuitboard/fax // CHOMPEdit - Removal of obj/item/weapon

	var/obj/item/card/id/scan = null // CHOMPEdit - Removal of obj/item/weapon
...
*/
	...
	if(istype(copyitem, /obj/item/paper_bundle)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/paper_bundle/B = copyitem // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/photocopier/faxmachine/attackby(obj/item/O as obj, mob/user as mob)
	if(istype(O, /obj/item/card/id) && !scan) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/photocopier/faxmachine/proc/receivefax(var/obj/item/incoming)
	...
	if (istype(incoming, /obj/item/paper)) // CHOMPEdit - Removal of obj/item/weapon
		copy(incoming)
	else if (istype(incoming, /obj/item/photo)) // CHOMPEdit - Removal of obj/item/weapon
		photocopy(incoming)
	else if (istype(incoming, /obj/item/paper_bundle)) // CHOMPEdit - Removal of obj/item/weapon
		bundlecopy(incoming)
	else
		return 0
...
/obj/machinery/photocopier/faxmachine/proc/make_summary(obj/item/sent)
	if(istype(sent, /obj/item/paper)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/paper/P = sent // CHOMPEdit - Removal of obj/item/weapon
		return P.info
	if(istype(sent, /obj/item/paper_bundle)) // CHOMPEdit - Removal of obj/item/weapon
		. = ""
		var/obj/item/paper_bundle/B = sent // CHOMPEdit - Removal of obj/item/weapon
		for(var/i in 1 to B.pages.len)
			var/obj/item/paper/P = B.pages[i] // CHOMPEdit - Removal of obj/item/weapon
