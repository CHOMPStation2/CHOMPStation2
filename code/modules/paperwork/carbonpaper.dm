/obj/item/paper/carbon // CHOMPEdit - Removal of obj/item/weapon
	name = "paper"
...
/obj/item/paper/carbon/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(iscopy)
		if(info)
...
/obj/item/paper/carbon/verb/removecopy() // CHOMPEdit - Removal of obj/item/weapon
	set name = "Remove carbon-copy"
	set category = "Object"
	set src in usr

	if (copied == 0)
		var/obj/item/paper/carbon/c = src // CHOMPEdit - Removal of obj/item/weapon
		var/copycontents = html_decode(c.info)
		var/obj/item/paper/carbon/copy = new /obj/item/paper/carbon (usr.loc) // CHOMPEdit - Removal of obj/item/weapon
		// <font>
