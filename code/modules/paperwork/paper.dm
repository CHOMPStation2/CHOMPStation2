...
/obj/item/paper/card // CHOMPEdit - Removal of obj/item/weapon
	name = "blank card"
	desc = "A gift card with space to write on the cover."
	icon_state = "greetingcard"
	slot_flags = null //no fun allowed!!!!

/obj/item/paper/card/AltClick() //No fun allowed // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/paper/card/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	return
...
/obj/item/paper/card/Initialize() //ChompEDIT New --> Initialize // CHOMPEdit - Removal of obj/item/weapon
	..()
	pixel_y = rand(-8, 8)
	pixel_x = rand(-9, 9)
	stamps = null
...
/obj/item/paper/alien // CHOMPEdit - Removal of obj/item/weapon
	name = "alien tablet"
	desc = "It looks highly advanced"
	icon = 'icons/obj/abductor.dmi'
	icon_state = "alienpaper"

/obj/item/paper/alien/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(info)
		icon_state = "alienpaper_words"
	else
		icon_state = "alienpaper"

/obj/item/paper/alien/burnpaper() // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/paper/alien/AltClick() // No airplanes for me. // CHOMPEdit - Removal of obj/item/weapon
	return


/obj/item/paper/Initialize(mapload, var/text, var/title) // CHOMPEdit - Removal of obj/item/weapon
    . = ..()
...
/obj/item/paper/Initialize(var/newloc, var/text, var/title) //ChompEDIT New --> Initialize // CHOMPEdit - Removal of obj/item/weapon
	..()
	pixel_y = rand(-8, 8)
	pixel_x = rand(-9, 9)
	stamps = ""
...
/obj/item/paper/update_icon() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/proc/update_space(var/new_text) // CHOMPEdit - Removal of obj/item/weapon
	if(!new_text)
		return

	free_space -= length(strip_html_properly(new_text))

/obj/item/paper/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/paper/proc/show_content(var/mob/user, var/forceshow=0) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/verb/rename() // CHOMPEdit - Removal of obj/item/weapon
	...
	// We check loc one level up, so we can rename in clipboards and such. See also: /obj/item/photo/rename() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/attack_self(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/attack_ai(var/mob/living/silicon/ai/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	var/dist
...
/obj/item/paper/attack(mob/living/carbon/M as mob, mob/living/carbon/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/proc/set_content(text,title) // CHOMPEdit - Removal of obj/item/weapon
	if(title)
		name = title
...
/obj/item/paper/proc/addtofield(var/id, var/text, var/links = 0) // CHOMPEdit - Removal of obj/item/weapon
	var/locid = 0
	var/laststart = 1
	var/textindex = 1
...
/obj/item/paper/proc/updateinfolinks() // CHOMPEdit - Removal of obj/item/weapon
	info_links = info
	var/i = 0
	for(i=1,i<=fields,i++)
...
/obj/item/paper/proc/clearpaper() // CHOMPEdit - Removal of obj/item/weapon
	info = null
	stamps = null
...
/obj/item/paper/proc/get_signature(var/obj/item/pen/P, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(P && istype(P, /obj/item/pen)) // CHOMPEdit - Removal of obj/item/weapon
		return P.get_signature(user)
	return (user && user.real_name) ? user.real_name : "Anonymous"

/obj/item/paper/proc/parsepencode(var/t, var/obj/item/pen/P, mob/user as mob, var/iscrayon = 0) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/proc/burnpaper(obj/item/flame/P, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	var/class = "warning"
	var/datum/gender/TU = gender_datums[user.get_visible_gender()]

	if(P.lit && !user.restrained())
		if(istype(P, /obj/item/flame/lighter/zippo)) // CHOMPEdit - Removal of obj/item/weapon
			class = "rose"
...
/obj/item/paper/Topic(href, href_list) // CHOMPEdit - Removal of obj/item/weapon
	..()
	...
	if(href_list["write"])
		...
		if(!istype(i, /obj/item/pen)) // CHOMPEdit - Removal of obj/item/weapon
			...
			if(istype(M) && M.back && istype(M.back,/obj/item/rig)) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/rig/r = M.back // CHOMPEdit - Removal of obj/item/weapon
		...
		if(istype(i, /obj/item/pen/crayon)) // CHOMPEdit - Removal of obj/item/weapon
			iscrayon = 1


		// if paper is not in usr, then it must be near them, or in a clipboard or folder, which must be in or near usr
		if(istype(loc, /obj/item/clipboard) || istype(loc, /obj/structure/noticeboard) || istype(loc, /obj/item/folder)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/get_worn_icon_state(var/slot_name) // CHOMPEdit - Removal of obj/item/weapon
	if(slot_name == slot_head_str)
		return "paper" //Gross, but required for now.
	return ..()

/obj/item/paper/attackby(obj/item/P as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
	var/clown = 0
	...
	if(istype(P, /obj/item/tape_roll)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/tape_roll/tape = P // CHOMPEdit - Removal of obj/item/weapon
		tape.stick(src, user)
		return

	if(istype(P, /obj/item/clipboard)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/clipboard/CB = P // CHOMPEdit - Removal of obj/item/weapon
		if(src.loc == user)
			user.drop_from_inventory(src)
		src.loc = CB
		CB.toppaper = src
	...
	if(istype(P, /obj/item/folder)) // CHOMPEdit - Removal of obj/item/weapon
		if(src.loc == user)
			user.drop_from_inventory(src)
		src.loc = P
		P.update_icon()
	...
	if(istype(P, /obj/item/paper) || istype(P, /obj/item/photo)) // CHOMPEdit - Removal of obj/item/weapon
		if (istype(P, /obj/item/paper/carbon)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/paper/carbon/C = P // CHOMPEdit - Removal of obj/item/weapon
			if (!C.iscopy && !C.copied)
				to_chat(user, "<span class='notice'>Take off the carbon copy first.</span>")
				add_fingerprint(user)
				return
		var/obj/item/paper_bundle/B = new(src.loc) // CHOMPEdit - Removal of obj/item/weapon
	...
	else if(istype(P, /obj/item/pen)) // CHOMPEdit - Removal of obj/item/weapon
		if(icon_state == "scrap")
			to_chat(usr, "<span class='warning'>\The [src] is too crumpled to write on.</span>")
			return

		var/obj/item/pen/robopen/RP = P // CHOMPEdit - Removal of obj/item/weapon
	...
	else if(istype(P, /obj/item/stamp) || istype(P, /obj/item/clothing/gloves/ring/seal)) // CHOMPEdit - Removal of obj/item/weapon
		if(istype(P, /obj/item/stamp)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/stamp/the_stamp = P // CHOMPEdit - Removal of obj/item/weapon
			...
			if(the_stamp.stamptext)
				...
				stamps += (stamps=="" ? "<HR>" : "<BR>") + "<i>This paper has been stamped with the [the_stamp.name].</i>"
		if((!in_range(src, usr) && loc != user && !( istype(loc, /obj/item/clipboard) ) && loc.loc != user && user.get_active_hand() != P)) // CHOMPEdit - Removal of obj/item/weapon
			return
		var/image/stampoverlay = image('icons/obj/bureaucracy.dmi')
		var/x, y
		if(istype(P, /obj/item/stamp/captain) || istype(P, /obj/item/stamp/centcomm)) // CHOMPEdit - Removal of obj/item/weapon
			x = rand(-2, 0)
			y = rand(-1, 2)
		else
			x = rand(-2, 2)
		...
		if(istype(P, /obj/item/stamp/clown)) // CHOMPEdit - Removal of obj/item/weapon
			if(!clown)
	...
	else if(istype(P, /obj/item/flame)) // CHOMPEdit - Removal of obj/item/weapon
		burnpaper(P, user)
 ...
 * Premade paper
 */
/obj/item/paper/Court // CHOMPEdit - Removal of obj/item/weapon
	name = "Judgement"
	info = "For crimes against the station, the offender is sentenced to:<BR>\n<BR>\n"

/obj/item/paper/Toxin // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/courtroom // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/hydroponics // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/djstation // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/flag // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "flag_neutral"
	item_state = "paper"
	anchored = TRUE

/obj/item/paper/jobs // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/photograph // CHOMPEdit - Removal of obj/item/weapon
	name = "photo"
	icon_state = "photo"
	var/photo_id = 0.0
	item_state = "paper"

/obj/item/paper/sop // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/crumpled/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/paper/crumpled/bloody // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "scrap_bloodied"

/obj/item/paper/crumpled/bloody/CrashedMedShuttle // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/shieldgen // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/manifest // CHOMPEdit - Removal of obj/item/weapon
