...
/obj/item/hand_labeler/attack() // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/hand_labeler/afterattack(atom/A, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!proximity)
		return
	...
	if(isobserver(A))
		...
		return
	if(istype(A, /obj/item/reagent_containers/glass)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/hand_labeler/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	mode = !mode
