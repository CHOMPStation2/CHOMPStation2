...
/obj/item/photo/New() // CHOMPEdit - Removal of obj/item/weapon
	id = photo_count++



/obj/item/photo/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	user.examinate(src)

/obj/item/photo/attackby(obj/item/P as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/photo/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/photo/proc/show(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/photo/verb/rename() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/photo_album // CHOMPEdit - Removal of obj/item/weapon
	...
	can_hold = list(/obj/item/photo) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/storage/photo_album/MouseDrop(obj/over_object as obj) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/camera/verb/change_size() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/camera/attack(mob/living/carbon/human/M as mob, mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	return

/obj/item/camera/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	on = !on
	if(on)
...
/obj/item/camera/attackby(obj/item/I as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	if(istype(I, /obj/item/camera_film)) // CHOMPEdit - Removal of obj/item/device
		if(pictures_left)
...
/obj/item/camera/proc/get_icon(list/turfs, turf/center) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/camera/proc/get_mobs(turf/the_turf as turf) // CHOMPEdit - Removal of obj/item/device
	var/mob_detail
...
/obj/item/camera/afterattack(atom/target as mob|obj|turf|area, mob/user as mob, flag) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/camera/proc/can_capture_turf(turf/T, mob/user) // CHOMPEdit - Removal of obj/item/device
	var/viewer = user
...
/obj/item/camera/proc/captureimage(atom/target, mob/user, flag) // CHOMPEdit - Removal of obj/item/device
	...
	var/obj/item/photo/p = createpicture(target, user, turfs, mobs, flag) // CHOMPEdit - Removal of obj/item/weapon

	printpicture(user, p)

/obj/item/camera/proc/createpicture(atom/target, mob/user, list/turfs, mobs, flag) // CHOMPEdit - Removal of obj/item/device
	...
	var/obj/item/photo/p = new() // CHOMPEdit - Removal of obj/item/weapon
	p.name = "photo"
	p.icon = ic
	p.tiny = pc
	p.img = photoimage
...
/obj/item/camera/proc/printpicture(mob/user, obj/item/photo/p) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	p.loc = user.loc
	if(!user.get_inactive_hand())
		user.put_in_inactive_hand(p)

/obj/item/photo/proc/copy(var/copy_id = 0) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/photo/p = new/obj/item/photo() // CHOMPEdit - Removal of obj/item/weapon
