/obj/item/sticky_pad
	...
	var/written_text
	var/written_by
	var/paper_type = /obj/item/paper/sticky // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/sticky_pad/attackby(var/obj/item/thing, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(thing, /obj/item/pen)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/sticky_pad/attack_hand(var/mob/user)
	var/obj/item/paper/paper = new paper_type(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/sticky // CHOMPEdit - Removal of obj/item/weapon
	name = "sticky note"
...
/obj/item/paper/sticky/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	AddComponent(/datum/component/recursive_move)
	RegisterSignal(src, COMSIG_OBSERVER_MOVED, /obj/item/paper/sticky/proc/reset_persistence_tracking) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/paper/sticky/proc/reset_persistence_tracking() // CHOMPEdit - Removal of obj/item/weapon
	SSpersistence.forget_value(src, /datum/persistent/paper/sticky)
	pixel_x = 0
	pixel_y = 0

/obj/item/paper/sticky/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	reset_persistence_tracking()
	UnregisterSignal(src, COMSIG_OBSERVER_MOVED)
	. = ..()

/obj/item/paper/sticky/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(icon_state != "scrap")
		icon_state = info ? "paper_words" : "paper"

// Copied from duct tape.
/obj/item/paper/sticky/attack_hand() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(!istype(loc, /turf))
		reset_persistence_tracking()

/obj/item/paper/sticky/afterattack(var/A, var/mob/user, var/flag, var/params) // CHOMPEdit - Removal of obj/item/weapon
