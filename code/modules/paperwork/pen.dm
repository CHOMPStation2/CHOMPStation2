...
/obj/item/pen/attack_self(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/pen/AltClick(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	to_chat(user, "<span class='notice'>Click.</span>")
	playsound(src, 'sound/items/penclick.ogg', 50, 1)
	return

/obj/item/pen/multi/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(++selectedColor > 3)
		selectedColor = 1
...
/obj/item/pen/reagent // CHOMPEdit - Removal of obj/item/weapon
	flags = OPENCONTAINER
	origin_tech = list(TECH_MATERIAL = 2, TECH_ILLEGAL = 5)

/obj/item/pen/reagent/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	create_reagents(30)

/obj/item/pen/reagent/attack(mob/living/M as mob, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
 ...
 * Blade Pens
 */
/obj/item/pen/blade // CHOMPEdit - Removal of obj/item/weapon
	desc = "It's a normal black ink pen."
...
/obj/item/pen/blade/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	active_icon_state = "[icon_state]-x"
	default_icon_state = icon_state

/obj/item/pen/blade/AltClick(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(active)
		deactivate(user)
	else
...
/obj/item/pen/blade/proc/activate(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(active)
		return
	active = 1
...
/obj/item/pen/blade/proc/deactivate(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!active)
		return
...
/obj/item/pen/blade/blue // CHOMPEdit - Removal of obj/item/weapon
	desc = "It's a normal blue ink pen."
	icon_state = "pen_blue"
	colour = "blue"

/obj/item/pen/blade/red // CHOMPEdit - Removal of obj/item/weapon
	desc = "It's a normal red ink pen."
	icon_state = "pen_red"
	colour = "red"

/obj/item/pen/blade/fountain // CHOMPEdit - Removal of obj/item/weapon
	desc = "A well made fountain pen, with a faux wood body."
	icon_state = "pen_fountain"
 ...
 * Sleepy Pens
 */
/obj/item/pen/reagent/sleepy // CHOMPEdit - Removal of obj/item/weapon
	desc = "It's a black ink pen with a sharp point and a carefully engraved \"Waffle Co.\""
	origin_tech = list(TECH_MATERIAL = 2, TECH_ILLEGAL = 5)

/obj/item/pen/reagent/sleepy/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/pen/reagent/paralysis/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/pen/chameleon/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	/*
...
/obj/item/pen/proc/get_signature(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return (user && user.real_name) ? user.real_name : "Anonymous"

/obj/item/pen/chameleon/get_signature(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return signature ? signature : "Anonymous"

/obj/item/pen/chameleon/verb/set_colour() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/pen/crayon/New() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/pen/crayon/marker/New() // CHOMPEdit - Removal of obj/item/weapon
