...
/obj/machinery/papershredder
	...
	power_channel = EQUIP
	circuit = /obj/item/circuitboard/papershredder // CHOMPEdit - Removal of obj/item/weapon
	var/max_paper = 10
	var/paperamount = 0
	var/list/shred_amounts = list(
		/obj/item/photo = 1, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/shreddedp = 1, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/paper = 1, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/newspaper = 3, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/card/id = 3, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/paper_bundle = 3, // CHOMPEdit - Removal of obj/item/weapon
		)
		...
		if(paper_result)
			...
			if(paperamount > max_paper)
				...
				for(var/i=(paperamount-max_paper);i>0;i--)
					var/obj/item/shreddedp/SP = get_shredded_paper() // CHOMPEdit - Removal of obj/item/weapon
					SP.loc = get_turf(src)
...
/obj/machinery/papershredder/proc/empty_bin(var/mob/living/user, var/obj/item/storage/empty_into) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/papershredder/proc/get_shredded_paper()
	if(!paperamount)
		return
	paperamount--
	return new /obj/item/shreddedp(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shreddedp // CHOMPEdit - Removal of obj/item/weapon
	name = "shredded paper"
...
/obj/item/shreddedp/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	pixel_x = rand(-5,5)
	pixel_y = rand(-5,5)
	if(prob(65)) color = pick("#BABABA","#7F7F7F")

/obj/item/shreddedp/attackby(var/obj/item/W as obj, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/flame/lighter)) // CHOMPEdit - Removal of obj/item/weapon
		burnpaper(W, user)
	else
		..()

/obj/item/shreddedp/proc/burnpaper(var/obj/item/flame/lighter/P, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shreddedp/proc/FireBurn() // CHOMPEdit - Removal of obj/item/weapon
