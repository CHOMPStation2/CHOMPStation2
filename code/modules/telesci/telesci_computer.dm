/obj/machinery/computer/telescience
	...
	circuit = /obj/item/circuitboard/telesci_console // CHOMPEdit - Removal of obj/item/weapon
	var/sending = 1
	...
	var/obj/item/gps/inserted_gps // CHOMPEdit - Removal of obj/item/device
	var/overmap_range = 3
...
/obj/machinery/computer/telescience/Initialize()
	...
	for(var/i = 1; i <= starting_crystals; i++)
		crystals += new /obj/item/bluespace_crystal/artificial(src) // starting crystals // CHOMPEdit - Removal of obj/item/weapon

/obj/machinery/computer/telescience/attackby(obj/item/W, mob/user, params)
	if(istype(W, /obj/item/bluespace_crystal)) // CHOMPEdit - Removal of obj/item/weapon
		...
		updateDialog()
	else if(istype(W, /obj/item/gps)) // CHOMPEdit - Removal of obj/item/device
		if(!inserted_gps)
			inserted_gps = W
			user.unEquip(W)
			W.forceMove(src)
