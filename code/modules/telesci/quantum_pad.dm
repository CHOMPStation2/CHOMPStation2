/obj/machinery/power/quantumpad
	...
	circuit = /obj/item/circuitboard/quantumpad // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/power/quantumpad/attackby(obj/item/I, mob/user, params)
	...
	if(istype(I, /obj/item/multitool)) // CHOMPEdit - Removal of obj/item/device
		...
		if(panel_open)
			var/obj/item/multitool/M = I // CHOMPEdit - Removal of obj/item/device
			M.connectable = src
	...
	if(istype(I, /obj/item/quantum_pad_booster)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/quantum_pad_booster/booster = I // CHOMPEdit - Removal of obj/item/device
