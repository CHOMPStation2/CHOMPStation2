/obj/machinery/appliance/cooker/oven
	...
	circuit = /obj/item/circuitboard/oven // CHOMPEdit - Removal of obj/item/weapon
	...
	light_y = 4
	max_contents = 5
	container_type = /obj/item/reagent_containers/cooking_container/oven // CHOMPEdit - Removal of obj/item/weapon
	...
	output_options = list(
		"Pizza" = /obj/item/reagent_containers/food/snacks/variable/pizza, // CHOMPEdit - Removal of obj/item/weapon
		"Bread" = /obj/item/reagent_containers/food/snacks/variable/bread, // CHOMPEdit - Removal of obj/item/weapon
		"Pie" = /obj/item/reagent_containers/food/snacks/variable/pie, // CHOMPEdit - Removal of obj/item/weapon
		"Cake" = /obj/item/reagent_containers/food/snacks/variable/cake, // CHOMPEdit - Removal of obj/item/weapon
		"Hot Pocket" = /obj/item/reagent_containers/food/snacks/variable/pocket, // CHOMPEdit - Removal of obj/item/weapon
		"Kebab" = /obj/item/reagent_containers/food/snacks/variable/kebab, // CHOMPEdit - Removal of obj/item/weapon
		"Waffles" = /obj/item/reagent_containers/food/snacks/variable/waffles, // CHOMPEdit - Removal of obj/item/weapon
		"Cookie" = /obj/item/reagent_containers/food/snacks/variable/cookie, // CHOMPEdit - Removal of obj/item/weapon
		"Donut" = /obj/item/reagent_containers/food/snacks/variable/donut, // CHOMPEdit - Removal of obj/item/weapon
		)
...
/obj/machinery/appliance/cooker/oven/proc/manip(var/obj/item/I)
	...
	if(I.has_tool_quality(TOOL_CROWBAR) || I.has_tool_quality(TOOL_SCREWDRIVER) || istype(I, /obj/item/storage/part_replacer)) // CHOMPEdit - Removal of obj/item/weapon
		return TRUE
	else
		return FALSE
