/obj/machinery/appliance/mixer/cereal
	...
	circuit = /obj/item/circuitboard/cerealmaker // CHOMPEdit - Removal of obj/item/weapon

	output_options = list(
		"Cereal" = /obj/item/reagent_containers/food/snacks/variable/cereal // CHOMPEdit - Removal of obj/item/weapon
	)
...
/*
/obj/machinery/appliance/mixer/cereal/change_product_strings(var/obj/item/reagent_containers/food/snacks/product, var/datum/cooking_item/CI) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	product.name = "box of [CI.object.name] cereal"

/obj/machinery/appliance/mixer/cereal/change_product_appearance(var/obj/item/reagent_containers/food/snacks/product) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/appliance/mixer/cereal/combination_cook(var/datum/cooking_item/CI)
	...
	for(var/obj/item/I in CI.container)
		if (istype(I, /obj/item/reagent_containers/food/snacks/variable/cereal)) // CHOMPEdit - Removal of obj/item/weapon
