...
/obj/machinery/appliance/proc/can_insert(var/obj/item/I, var/mob/user)
	...
	var/obj/item/reagent_containers/food/snacks/check = I // CHOMPEdit - Removal of obj/item/weapon
	if(istype(check) && islist(check.cooked) && (cook_type in check.cooked))
		...
		return 0
	else if(istype(check, /obj/item/reagent_containers/glass)) // CHOMPEdit - Removal of obj/item/weapon
		to_chat(user, "<span class='warning'>That would probably break [src].</span>")
		return 0
	else if(istype(check, /obj/item/disk/nuclear)) // CHOMPEdit - Removal of obj/item/weapon
		to_chat(user, "<span class='warning'>You can't cook that.</span>")
		return 0
	else if(I.has_tool_quality(TOOL_CROWBAR) || I.has_tool_quality(TOOL_SCREWDRIVER) || istype(I, /obj/item/storage/part_replacer)) // You can't cook tools, dummy. // CHOMPEdit - Removal of obj/item/weapon
		return 0
	else if(!istype(check) &&  !istype(check, /obj/item/holder)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/appliance/attackby(var/obj/item/I, var/mob/user)
	...
	if(istype(I, /obj/item/gripper)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/gripper/GR = I // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/appliance/proc/add_content(var/obj/item/I, var/mob/user)
	...
	if (istype(I, /obj/item/reagent_containers/cooking_container) && CI == 1) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/reagent_containers/cooking_container/CC = I // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/appliance/proc/do_cooking_tick(var/datum/cooking_item/CI)
	...
	// Gotta hurt.
	for(var/obj/item/holder/H in CI.container.contents) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/appliance/proc/finish_cooking(var/datum/cooking_item/CI)
	...
	if (recipe)
		...
		for(var/obj/item/reagent_containers/food/snacks/R as anything in results) // CHOMPEdit - Removal of obj/item/weapon
	...
	for (var/obj/item/reagent_containers/food/snacks/S in CI.container) // CHOMPEdit - Removal of obj/item/weapon
		S.cook()
...
/obj/machinery/appliance/proc/combination_cook(var/datum/cooking_item/CI)
	...
	for (var/obj/item/I in CI.container)
		var/obj/item/reagent_containers/food/snacks/S // CHOMPEdit - Removal of obj/item/weapon
		if (istype(I, /obj/item/holder)) // CHOMPEdit - Removal of obj/item/weapon
			S = create_mob_food(I, CI)
		else if (istype(I, /obj/item/reagent_containers/food/snacks)) // CHOMPEdit - Removal of obj/item/weapon
			S = I
	...
	var/obj/item/reagent_containers/food/snacks/result = new cook_path(CI.container) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/appliance/proc/modify_cook(var/obj/item/input, var/datum/cooking_item/CI)
	var/obj/item/reagent_containers/food/snacks/result // CHOMPEdit - Removal of obj/item/weapon
	if (istype(input, /obj/item/holder)) // CHOMPEdit - Removal of obj/item/weapon
		result = create_mob_food(input, CI)
	else if (istype(input, /obj/item/reagent_containers/food/snacks)) // CHOMPEdit - Removal of obj/item/weapon
		result = input
	else
		//Nonviable item
		return
...
/obj/machinery/appliance/proc/burn_food(var/datum/cooking_item/CI)
	...
	CI.burned = 1
	CI.container.clear()
	new /obj/item/reagent_containers/food/snacks/badrecipe(CI.container) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/appliance/proc/eject(var/datum/cooking_item/CI, var/mob/user = null)
	...
	else if(istype(thing, /obj/item/reagent_containers/cooking_container)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/reagent_containers/cooking_container/cc = thing // CHOMPEdit - Removal of obj/item/weapon
		cc.do_empty()
		delete = 0
	else
		thing.forceMove(get_turf(src))
...
/obj/machinery/appliance/proc/change_product_strings(var/obj/item/reagent_containers/food/snacks/product, var/datum/cooking_item/CI) // CHOMPEdit - Removal of obj/item/weapon
	product.name = "[cook_type] [product.name]"
	product.desc = "[product.desc]\nIt has been [cook_type]."


/obj/machinery/appliance/proc/change_product_appearance(var/obj/item/reagent_containers/food/snacks/product, var/datum/cooking_item/CI) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/appliance/proc/create_mob_food(var/obj/item/holder/H, var/datum/cooking_item/CI) // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/reagent_containers/food/snacks/variable/mob/result = new /obj/item/reagent_containers/food/snacks/variable/mob(CI.container) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/cooking_item
	...
	var/result_type = 0
	var/obj/item/reagent_containers/cooking_container/container = null // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/appliance/RefreshParts()
	...
	for(var/obj/item/stock_parts/P in src.component_parts) // CHOMPEdit - Removal of obj/item/weapon
		if(istype(P, /obj/item/stock_parts/scanning_module)) // CHOMPEdit - Removal of obj/item/weapon
		...
		else if(istype(P, /obj/item/stock_parts/capacitor)) // CHOMPEdit - Removal of obj/item/weapon
