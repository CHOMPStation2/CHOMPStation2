/obj/machinery/appliance/cooker/fryer
	...
	circuit = /obj/item/circuitboard/fryer // CHOMPEdit - Removal of obj/item/weapon
	appliancetype = FRYER
	...
	max_contents = 2
	container_type = /obj/item/reagent_containers/cooking_container/fryer // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/appliance/cooker/fryer/attackby(var/obj/item/I, var/mob/user)
	...
	if(default_part_replacement(user, I))
		return
	if(istype(I, /obj/item/reagent_containers/glass) && I.reagents) // CHOMPEdit - Removal of obj/item/weapon
