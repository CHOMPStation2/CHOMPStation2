/obj/machinery/microwave
	...
	circuit = /obj/item/circuitboard/microwave // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/microwave/Initialize()
	...
	if(!available_recipes)
		...
		// impure carbon. ~Z
		acceptable_items |= /obj/item/holder // CHOMPEdit - Removal of obj/item/weapon
		acceptable_items |= /obj/item/reagent_containers/food/snacks/grown // CHOMPEdit - Removal of obj/item/weapon
		acceptable_items |= /obj/item/soulstone // CHOMPEdit - Removal of obj/item/device
		acceptable_items |= /obj/item/fuel_assembly/supermatter // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/microwave/proc/get_items_list()
	...
	for(var/obj/O in cookingContents())
		...
		if(istype(O,/obj/item/reagent_containers/food/snacks/egg)) // CHOMPEdit - Removal of obj/item/weapon
			items_measures[display_name] = "egg"
			items_measures_p[display_name] = "eggs"
		if(istype(O,/obj/item/reagent_containers/food/snacks/tofu)) // CHOMPEdit - Removal of obj/item/weapon
			items_measures[display_name] = "tofu chunk"
			items_measures_p[display_name] = "tofu chunks"
		if(istype(O,/obj/item/reagent_containers/food/snacks/meat)) //any meat // CHOMPEdit - Removal of obj/item/weapon
			items_measures[display_name] = "slab of meat"
			items_measures_p[display_name] = "slabs of meat"
		if(istype(O,/obj/item/reagent_containers/food/snacks/donkpocket)) // CHOMPEdit - Removal of obj/item/weapon
			display_name = "Turnovers"
			items_measures[display_name] = "turnover"
			items_measures_p[display_name] = "turnovers"
		if(istype(O,/obj/item/reagent_containers/food/snacks/carpmeat)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/microwave/proc/cook()
	...
	for(var/obj/item/reagent_containers/food/snacks/S in cooked_items) // CHOMPEdit - Removal of obj/item/weapon
		reagents.trans_to_holder(S.reagents, total/cooked_items.len)

	for(var/obj/item/reagent_containers/food/snacks/S in cookingContents()) // CHOMPEdit - Removal of obj/item/weapon
		S.cook()
...
/obj/machinery/microwave/proc/fail()
	var/obj/item/reagent_containers/food/snacks/badrecipe/ffuu = new(src) // CHOMPEdit - Removal of obj/item/weapon
	var/amount = 0
	for (var/obj/O in cookingContents() - ffuu)
		...
		if(istype(O, /obj/item/holder)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/holder/H = O // CHOMPEdit - Removal of obj/item/weapon
			if(H.held_mob)
				qdel(H.held_mob)
		qdel(O)
	src.reagents.clear_reagents()
...
/obj/machinery/microwave/advanced // specifically for complex recipes
	...
	icon_state = "mw"
	circuit = /obj/item/circuitboard/microwave/advanced // CHOMPEdit - Removal of obj/item/weapon
...
/datum/recipe/splat/make_food(obj/container)
	for(var/obj/item/holder/H in container) // CHOMPEdit - Removal of obj/item/weapon
		if(H.held_mob)
