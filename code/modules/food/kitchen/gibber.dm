...
/obj/machinery/gibber/proc/startgibbing(mob/user as mob)
	...
	var/slab_type = occupant.meat_type ? occupant.meat_type : /obj/item/reagent_containers/food/snacks/meat // CHOMPEdit - Removal of obj/item/weapon
	...
	for(var/i=1 to slab_count)
		var/obj/item/reagent_containers/food/snacks/meat/new_meat = new slab_type(src, rand(3,8)) // CHOMPEdit - Removal of obj/item/weapon
		if(istype(new_meat))
