...
/obj/machinery/icecream_vat/attackby(var/obj/item/O as obj, var/mob/user as mob)
	...
	if(default_part_replacement(user, O))
		return
	if(istype(O, /obj/item/reagent_containers/food/snacks/icecream)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/reagent_containers/food/snacks/icecream/I = O // CHOMPEdit - Removal of obj/item/weapon
		if(!I.ice_creamed)
...
/obj/machinery/icecream_vat/Topic(href, href_list)
	...
	if(href_list["cone"])
		...
		if(product_types[dispense_cone] >= 1)
			...
			var/obj/item/reagent_containers/food/snacks/icecream/I = new(src.loc) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/icecream/New() // CHOMPEdit - Removal of obj/item/weapon
	create_reagents(20)
	reagents.add_reagent("nutriment", 5)

/obj/item/reagent_containers/food/snacks/icecream/proc/add_ice_cream(var/flavour_name) // CHOMPEdit - Removal of obj/item/weapon
