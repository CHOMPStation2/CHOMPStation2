...
/obj/machinery/smartfridge/attackby(var/obj/item/O as obj, var/mob/user as mob)
	...
	if(istype(O, /obj/item/multitool) || O.has_tool_quality(TOOL_WIRECUTTER)) // CHOMPEdit - Removal of obj/item/device
		if(panel_open)
			attack_hand(user)
		return
	...
	else if(istype(O, /obj/item/storage/bag)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/storage/bag/P = O // CHOMPEdit - Removal of obj/item/weapon
		var/plants_loaded = 0
	...
	else if(istype(O, /obj/item/gripper)) // Grippers. ~Mechoid. // CHOMPEdit - Removal of obj/item/weapon
