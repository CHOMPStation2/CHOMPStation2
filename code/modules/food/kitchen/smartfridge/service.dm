...
/obj/machinery/smartfridge/drinks/accept_check(var/obj/item/O as obj)
	if(istype(O,/obj/item/reagent_containers/glass) || istype(O,/obj/item/reagent_containers/food/drinks) || istype(O,/obj/item/reagent_containers/food/condiment)) // CHOMPEdit - Removal of obj/item/weapon
		return 1
	return 0
...
/obj/machinery/smartfridge/produce/accept_check(var/obj/item/O as obj)
	if(istype(O,/obj/item/reagent_containers/food/snacks/grown/) || istype(O,/obj/item/seeds/)) // CHOMPEdit - Removal of obj/item/weapon
		return 1
	return 0
