...
/obj/machinery/smartfridge/hitby(var/atom/movable/A, speed)
	...
	if(accept_check(A) && A.thrower)
		...
		var/obj/item/card/id/thrower_id // CHOMPEdit - Removal of obj/item/weapon
		if(ismob(A.thrower))
			var/mob/T = A.thrower
...
/obj/machinery/smartfridge/chemistry/chemvator/accept_check(var/obj/item/O as obj)
	if(istype(O,/obj/item/storage/pill_bottle) || istype(O,/obj/item/reagent_containers) || istype(O,/obj/item/reagent_containers/glass/)) // CHOMPEdit - Removal of obj/item/weapon
		return 1
	return 0
