...
/datum/recipe
	...
	var/list/items			// Example: = list(/obj/item/tool/crowbar, /obj/item/welder) // place /foo/bar before /foo // CHOMPEdit - Removal of obj/item/weapon
	...
	var/result				// Example: = /obj/item/reagent_containers/food/snacks/donut/normal // CHOMPEdit - Removal of obj/item/weapon
...
/datum/recipe/proc/check_fruit(var/obj/container, var/exact = FALSE)
	...
	if(fruit && fruit.len)
		...
		for(var/obj/item/reagent_containers/food/snacks/grown/G in container) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/recipe/proc/check_coating(var/obj/O, var/exact = FALSE)
	if(!istype(O,/obj/item/reagent_containers/food/snacks)) // CHOMPEdit - Removal of obj/item/weapon
		return TRUE //Only snacks can be battered

	if (coating == -1)
		return TRUE //-1 value doesnt care

	var/obj/item/reagent_containers/food/snacks/S = O // CHOMPEdit - Removal of obj/item/weapon
	if (!S.coating)
		if (!coating)
			return TRUE
		return FALSE
...
/datum/recipe/proc/make_food(var/obj/container as obj)
	if(!result)
		...
		else if(istype(container, /obj/item/reagent_containers/cooking_container)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/reagent_containers/cooking_container/CC = container // CHOMPEdit - Removal of obj/item/weapon
			CC.clear()
