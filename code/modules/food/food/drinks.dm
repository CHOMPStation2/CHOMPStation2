...
/// Drinks.
////////////////////////////////////////////////////////////////////////////////
/obj/item/reagent_containers/food/drinks // CHOMPEdit - Removal of obj/item/weapon
	name = "drink"
	desc = "yummy"
...
/obj/item/reagent_containers/food/drinks/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if (prob(cant_chance))
		cant_open = 1

/obj/item/reagent_containers/food/drinks/on_reagent_change() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/Destroy() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/MouseDrop_T(mob/living/M, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/proc/On_Consume(var/mob/living/M, var/mob/user, var/changed = FALSE) // CHOMPEdit - Removal of obj/item/weapon
	if(!user)
		user = M
...
/obj/item/reagent_containers/food/drinks/on_rag_wipe(var/obj/item/reagent_containers/glass/rag/R) // CHOMPEdit - Removal of obj/item/weapon
	clean_blood()

/obj/item/reagent_containers/food/drinks/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!is_open_container())
		open(user)

/obj/item/reagent_containers/food/drinks/proc/open(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!cant_open)
...
/obj/item/reagent_containers/food/drinks/attack(mob/M as mob, mob/user as mob, def_zone) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/afterattack(obj/target, mob/user, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!proximity) return
...
/obj/item/reagent_containers/food/drinks/standard_feed_mob(var/mob/user, var/mob/target) // CHOMPEdit - Removal of obj/item/weapon
	if(!is_open_container())
...
/obj/item/reagent_containers/food/drinks/standard_dispenser_refill(var/mob/user, var/obj/structure/reagent_dispensers/target) // CHOMPEdit - Removal of obj/item/weapon
	if(!is_open_container())
		to_chat(user, "<span class='notice'>You need to open [src]!</span>")
		return 1
	return ..()

/obj/item/reagent_containers/food/drinks/standard_pour_into(var/mob/user, var/atom/target) // CHOMPEdit - Removal of obj/item/weapon
	if(!is_open_container())
		to_chat(user, "<span class='notice'>You need to open [src]!</span>")
		return 1
	return ..()

/obj/item/reagent_containers/food/drinks/self_feed_message(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/feed_sound(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	playsound(src, 'sound/items/drink.ogg', rand(10, 50), 1)

/obj/item/reagent_containers/food/drinks/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(Adjacent(user))
		if(cant_open)
...
/obj/item/reagent_containers/food/drinks/golden_cup // CHOMPEdit - Removal of obj/item/weapon
	desc = "A golden cup"
	name = "golden cup"
...
/obj/item/reagent_containers/food/drinks/golden_cup/on_reagent_change() // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/reagent_containers/food/drinks/milk // CHOMPEdit - Removal of obj/item/weapon
	name = "milk carton"
...
/obj/item/reagent_containers/food/drinks/milk/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("milk", 50)

/obj/item/reagent_containers/food/drinks/soymilk // CHOMPEdit - Removal of obj/item/weapon
	name = "soymilk carton"
...
/obj/item/reagent_containers/food/drinks/soymilk/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("soymilk", 50)

/obj/item/reagent_containers/food/drinks/smallmilk // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/smallmilk/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("milk", 30)

/obj/item/reagent_containers/food/drinks/smallchocmilk // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/smallchocmilk/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/drinks/coffee/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/drinks/tea/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("tea", 30)

/obj/item/reagent_containers/food/drinks/decaf_tea // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/decaf_tea/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("teadecaf", 30)

/obj/item/reagent_containers/food/drinks/ice // CHOMPEdit - Removal of obj/item/weapon
	name = "cup of ice"
	desc = "Careful, cold ice, do not chew."
	icon_state = "ice"
	center_of_mass_x = 15 //CHOMPEdit
	center_of_mass_y= 10 //CHOMPEdit
/obj/item/reagent_containers/food/drinks/ice/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/drinks/h_chocolate/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("hot_coco", 30)

/obj/item/reagent_containers/food/drinks/greentea // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/greentea/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("greentea", 30)

/obj/item/reagent_containers/food/drinks/chaitea // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/chaitea/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("chaitea", 30)

/obj/item/reagent_containers/food/drinks/decaf // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/decaf/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/drinks/dry_ramen/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("dry_ramen", 30)

/obj/item/reagent_containers/food/drinks/sillycup // CHOMPEdit - Removal of obj/item/weapon
	name = "paper cup"
...
/obj/item/reagent_containers/food/drinks/sillycup/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()

/obj/item/reagent_containers/food/drinks/sillycup/on_reagent_change() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(reagents.total_volume)
...
/obj/item/reagent_containers/food/drinks/sillycup/MouseDrop(obj/over_object as obj) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/shaker/on_reagent_change() // CHOMPEdit - Removal of obj/item/weapon
	..()

/obj/item/reagent_containers/food/drinks/teapot // CHOMPEdit - Removal of obj/item/weapon
	name = "teapot"
...
/obj/item/reagent_containers/food/drinks/teapot/on_reagent_change() // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/reagent_containers/food/drinks/flask/on_reagent_change() // CHOMPEdit - Removal of obj/item/weapon
	..()

/obj/item/reagent_containers/food/drinks/flask/shiny // CHOMPEdit - Removal of obj/item/weapon
	name = "shiny flask"
	desc = "A shiny metal flask. It appears to have a Greek symbol inscribed on it."
	icon_state = "shinyflask"

/obj/item/reagent_containers/food/drinks/flask/lithium // CHOMPEdit - Removal of obj/item/weapon
	name = "lithium flask"
	desc = "A flask with a Lithium Atom symbol on it."
	icon_state = "lithiumflask"

/obj/item/reagent_containers/food/drinks/flask/detflask // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/flask/vacuumflask // CHOMPEdit - Removal of obj/item/weapon
	name = "vacuum flask"
