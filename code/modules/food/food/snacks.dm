...
/obj/item/reagent_containers/food/snacks/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(nutriment_amt)
		reagents.add_reagent("nutriment",(nutriment_amt*2),nutriment_desc)

//Placeholder for effect that trigger on eating that aren't tied to reagents.
/obj/item/reagent_containers/food/snacks/proc/On_Consume(var/mob/living/M) // CHOMPEdit - Removal of obj/item/weapon
	if(!usr) // what
		usr = M
...
/obj/item/reagent_containers/food/snacks/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/attack(mob/living/M as mob, mob/living/user as mob, def_zone) //CHOMPEdit // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(Adjacent(user))
		if(food_inserted_micros && food_inserted_micros.len)
...
/obj/item/reagent_containers/food/snacks/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W,/obj/item/storage)) // CHOMPEdit - Removal of obj/item/weapon
		. = ..() // -> item/attackby()
		return

	// Eating with forks
	if(istype(W,/obj/item/material/kitchen/utensil)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/material/kitchen/utensil/U = W // CHOMPEdit - Removal of obj/item/weapon
		U.load_food(user, src)
		return

	if(food_can_insert_micro && istype(W, /obj/item/holder)) // CHOMPEdit - Removal of obj/item/weapon
		if(!(istype(W, /obj/item/holder/micro) || istype(W, /obj/item/holder/mouse))) // CHOMPEdit - Removal of obj/item/weapon
			. = ..()
			return
	...
	if (is_sliceable())
		...
		var/can_slice_here = isturf(src.loc) && ((locate(/obj/structure/table) in src.loc) || (locate(/obj/machinery/optable) in src.loc) || (locate(/obj/item/tray) in src.loc)) // CHOMPEdit - Removal of obj/item/weapon
		var/hide_item = !has_edge(W) || !can_slice_here

		if (hide_item)
			if (W.w_class >= src.w_class || is_robot_module(W) || istype(W, /obj/item/holder)) // CHOMPEdit - Removal of obj/item/weapon
				return
	...
	// CHOMPEdit End - A long list of to_chat to balloon_alert
			...
			for(var/i=1 to (slices_num-slices_lost))
				...
				if(food_inserted_micros && food_inserted_micros.len && istype(slice, /obj/item/reagent_containers/food/snacks)) // CHOMPEdit - Removal of obj/item/weapon
					var/obj/item/reagent_containers/food/snacks/S = slice // CHOMPEdit - Removal of obj/item/weapon
					for(var/mob/living/F in food_inserted_micros)
						F.forceMove(S)
...
/obj/item/reagent_containers/food/snacks/MouseDrop_T(mob/living/M, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/proc/is_sliceable() // CHOMPEdit - Removal of obj/item/weapon
	return (slices_num && slice_path && slices_num > 0)

/obj/item/reagent_containers/food/snacks/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	if(contents)
...
/obj/item/reagent_containers/food/snacks/proc/unpackage(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	package = FALSE
...
/obj/item/reagent_containers/food/snacks/proc/uncan(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	canned = FALSE
...
/// FOOD END
////////////////////////////////////////////////////////////////////////////////
/obj/item/reagent_containers/food/snacks/attack_generic(var/mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
...
///obj/item/reagent_containers/food/snacks/xenoburger				//Identification path for the object. // CHOMPEdit - Removal of obj/item/weapon
//	name = "Xenoburger"														//Name that displays in the UI.
//	desc = "Smells caustic. Tastes like heresy."							//Duh
//	icon_state = "xburger"													//Refers to an icon in food.dmi
//	nutriment_amt = 2														//How much nutriment to add.
//	bitesize = 3															//This is the amount each bite consumes.
///obj/item/reagent_containers/food/snacks/xenoburger/Initialize()	//Don't mess with this. (We use Initialize now instead of New()) // CHOMPEdit - Removal of obj/item/weapon
//	. = ..()																//Same here.
...
/obj/item/reagent_containers/food/snacks/aesirsalad // CHOMPEdit - Removal of obj/item/weapon
	name = "Aesir salad"
...
/obj/item/reagent_containers/food/snacks/aesirsalad/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/candy/donor/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/candy_corn/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 2)

/obj/item/reagent_containers/food/snacks/chocolatebar //not a vending item // CHOMPEdit - Removal of obj/item/weapon
	name = "Chocolate Bar"
...
/obj/item/reagent_containers/food/snacks/chocolatebar/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 2)
...
/obj/item/reagent_containers/food/snacks/chocolateegg/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 2)
	reagents.add_reagent("coco", 2)
...
/obj/item/reagent_containers/food/snacks/donut/plain/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/donut/plain/jelly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
...
/obj/item/reagent_containers/food/snacks/donut/pink/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
...
/obj/item/reagent_containers/food/snacks/donut/pink/jelly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
	reagents.add_reagent("berryjuice", 5)
...
/obj/item/reagent_containers/food/snacks/donut/purple/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
...
/obj/item/reagent_containers/food/snacks/donut/purple/jelly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
	reagents.add_reagent("berryjuice", 5)
...
/obj/item/reagent_containers/food/snacks/donut/green/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
...
/obj/item/reagent_containers/food/snacks/donut/green/jelly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
	reagents.add_reagent("berryjuice", 5)
...
/obj/item/reagent_containers/food/snacks/donut/beige/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
...
/obj/item/reagent_containers/food/snacks/donut/beige/jelly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
	reagents.add_reagent("berryjuice", 5)
...
/obj/item/reagent_containers/food/snacks/donut/choc/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
...
/obj/item/reagent_containers/food/snacks/donut/choc/jelly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
	reagents.add_reagent("berryjuice", 5)
	reagents.add_reagent("chocolate", 5)
...
/obj/item/reagent_containers/food/snacks/donut/blue/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
...
/obj/item/reagent_containers/food/snacks/donut/blue/jelly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
	reagents.add_reagent("berryjuice", 5)
...
/obj/item/reagent_containers/food/snacks/donut/yellow/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
...
/obj/item/reagent_containers/food/snacks/donut/yellow/jelly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
	reagents.add_reagent("berryjuice", 5)
...
/obj/item/reagent_containers/food/snacks/donut/olive/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
...
/obj/item/reagent_containers/food/snacks/donut/olive/jelly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
	reagents.add_reagent("berryjuice", 5)
...
/obj/item/reagent_containers/food/snacks/donut/homer/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
...
/obj/item/reagent_containers/food/snacks/donut/homer/jelly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
	reagents.add_reagent("sprinkles", 1)
	reagents.add_reagent("berryjuice", 5)
...
/obj/item/reagent_containers/food/snacks/donut/choc_sprinkles/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
	reagents.add_reagent("sprinkles", 1)
...
/obj/item/reagent_containers/food/snacks/donut/choc_sprinkles/jelly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
	reagents.add_reagent("sprinkles", 1)
	reagents.add_reagent("berryjuice", 5)
...
/obj/item/reagent_containers/food/snacks/donut/meat // CHOMPEdit - Removal of obj/item/weapon
	name = "meat donut"
	icon_state = "donut_meat"
	desc = "This donut has ... meat? Is it made of meat?!"
	overlay_state = "donut_meat_inbox"
/obj/item/reagent_containers/food/snacks/donut/meat/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3, nutriment_desc)

/obj/item/reagent_containers/food/snacks/donut/laugh // CHOMPEdit - Removal of obj/item/weapon
	name = "laugh donut"
	icon_state = "donut_laugh"
	desc = "Try not to laugh."
	overlay_state = "donut_laugh_inbox"
/obj/item/reagent_containers/food/snacks/donut/laugh/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)

/obj/item/reagent_containers/food/snacks/donut/laugh/jelly // CHOMPEdit - Removal of obj/item/weapon
	name = "laugh jelly donut"
	icon_state = "jelly_laugh"
	desc = "Try not to be jelly."
/obj/item/reagent_containers/food/snacks/donut/laugh/jelly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 3, nutriment_desc)
	reagents.add_reagent("berryjuice", 5)
...
/obj/item/reagent_containers/food/snacks/donut/chaos/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sprinkles", 1)
	switch(rand(1,10))
		if(1)
...
/obj/item/reagent_containers/food/snacks/donut/plain/jelly/poisonberry // CHOMPEdit - Removal of obj/item/weapon
	filling_color = "#ED1169"

/obj/item/reagent_containers/food/snacks/donut/plain/jelly/poisonberry/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("poisonberryjuice", 5)

/obj/item/reagent_containers/food/snacks/donut/plain/jelly/slimejelly // CHOMPEdit - Removal of obj/item/weapon
	filling_color = "#ED1169"

/obj/item/reagent_containers/food/snacks/donut/plain/jelly/slimejelly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/donut/plain/jelly/cherryjelly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/egg/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("egg", 3)

/obj/item/reagent_containers/food/snacks/egg/afterattack(obj/O as obj, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/egg/throw_impact(atom/hit_atom) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/egg/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype( W, /obj/item/pen/crayon )) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/pen/crayon/C = W // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/egg/blue // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "egg-blue"

/obj/item/reagent_containers/food/snacks/egg/green // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "egg-green"

/obj/item/reagent_containers/food/snacks/egg/mime // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "egg-mime"

/obj/item/reagent_containers/food/snacks/egg/orange // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "egg-orange"

/obj/item/reagent_containers/food/snacks/egg/purple // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "egg-purple"

/obj/item/reagent_containers/food/snacks/egg/rainbow // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "egg-rainbow"

/obj/item/reagent_containers/food/snacks/egg/red // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "egg-red"

/obj/item/reagent_containers/food/snacks/egg/yellow // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/friedegg/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/boiledegg/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)

/obj/item/reagent_containers/food/snacks/organ // CHOMPEdit - Removal of obj/item/weapon
	name = "organ"
...
/obj/item/reagent_containers/food/snacks/organ/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/carpmeat/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/carpmeat/fish/sif // CHOMPEdit - Removal of obj/item/weapon
	desc = "A fillet of sivian fish meat."
	filling_color = "#2c2cff"
	color = "#2c2cff"

/obj/item/reagent_containers/food/snacks/carpmeat/ray // CHOMPEdit - Removal of obj/item/weapon
	desc = "A fillet of space ray meat."
	toxin_type = "stoxin"

/obj/item/reagent_containers/food/snacks/carpmeat/gnat // CHOMPEdit - Removal of obj/item/weapon
	desc = "A paltry sample of space-gnat meat. It looks pretty stringy and unpleasant, honestly."
	toxin_amount = 1

/obj/item/reagent_containers/food/snacks/carpmeat/shark // CHOMPEdit - Removal of obj/item/weapon
	desc = "A fillet of space shark meat. It looks rather tough and chewy."
	toxin_amount = 5

/obj/item/reagent_containers/food/snacks/crab_legs // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/crab_legs/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/fishfingers/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("seafood", 4)

/obj/item/reagent_containers/food/snacks/zestfish // CHOMPEdit - Removal of obj/item/weapon
	name = "Zesty Fish"
...
/obj/item/reagent_containers/food/snacks/zestfish/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("seafood", 4)

/obj/item/reagent_containers/food/snacks/mushroomslice // CHOMPEdit - Removal of obj/item/weapon
	name = "mushroom slice"
...
/obj/item/reagent_containers/food/snacks/mushroomslice/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/meatball/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)
...
/obj/item/reagent_containers/food/snacks/sausage/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)
...
/obj/item/reagent_containers/food/snacks/donkpocket/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)

/obj/item/reagent_containers/food/snacks/donkpocket/proc/heat() // CHOMPEdit - Removal of obj/item/weapon
	warm = 1
...
/obj/item/reagent_containers/food/snacks/donkpocket/proc/cooltime() // CHOMPEdit - Removal of obj/item/weapon
	if (src.warm)
		spawn(420 SECONDS)
			if(!src?.reagents)
				return
...
/obj/item/reagent_containers/food/snacks/donkpocket/spicy // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/donkpocket/teriyaki // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/donkpocket/pizza // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/donkpocket/honk // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/donkpocket/berry // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/donkpocket/gondola // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/donkpocket/dankpocket // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/donkpocket/sinpocket // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/donkpocket/sinpocket/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(has_been_heated)
...
/obj/item/reagent_containers/food/snacks/brainburger/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)
...
/obj/item/reagent_containers/food/snacks/human // CHOMPEdit - Removal of obj/item/weapon
	var/hname = ""
	var/job = null
...
/obj/item/reagent_containers/food/snacks/human/burger/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)
...
/obj/item/reagent_containers/food/snacks/cheeseburger/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)
...
/obj/item/reagent_containers/food/snacks/monkeyburger/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)
...
/obj/item/reagent_containers/food/snacks/fishburger/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)
...
/obj/item/reagent_containers/food/snacks/xenoburger/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/omelette/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 8)
...
/obj/item/reagent_containers/food/snacks/pie/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("banana",5)

/obj/item/reagent_containers/food/snacks/pie/throw_impact(atom/hit_atom) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/berryclafoutis/berry/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("berryjuice", 5)

/obj/item/reagent_containers/food/snacks/berryclafoutis/poison/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("poisonberryjuice", 5)
...
/obj/item/reagent_containers/food/snacks/soylentgreen/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/meatpie/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 10)
...
/obj/item/reagent_containers/food/snacks/amanita_pie // CHOMPEdit - Removal of obj/item/weapon
	name = "amanita pie"
...
/obj/item/reagent_containers/food/snacks/amanita_pie/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/plump_pie/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(prob(10))
...
/obj/item/reagent_containers/food/snacks/xemeatpie/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 10)
...
/obj/item/reagent_containers/food/snacks/wingfangchu/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)

/obj/item/reagent_containers/food/snacks/human/kabob // CHOMPEdit - Removal of obj/item/weapon
	name = "-kabob"
	icon_state = "kabob"
...
/obj/item/reagent_containers/food/snacks/human/kabob/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 8)
...
/obj/item/reagent_containers/food/snacks/monkeykabob/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 8)
...
/obj/item/reagent_containers/food/snacks/cubancarp/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)
	reagents.add_reagent("capsaicin", 3)
...
/obj/item/reagent_containers/food/snacks/popcorn/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	unpopped = rand(1,10)

/obj/item/reagent_containers/food/snacks/popcorn/On_Consume() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/fries/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("oil", 1.2)//This is mainly for the benefit of adminspawning

/obj/item/reagent_containers/food/snacks/onionrings // CHOMPEdit - Removal of obj/item/weapon
	name = "onion rings"
...
/obj/item/reagent_containers/food/snacks/microfries // CHOMPEdit - Removal of obj/item/weapon
	name = "micro fries"
...
/obj/item/reagent_containers/food/snacks/ovenfries // CHOMPEdit - Removal of obj/item/weapon
	name = "oven fries"
...
/obj/item/reagent_containers/food/snacks/carrotfries/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/cheesyfries/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)

/obj/item/reagent_containers/food/snacks/chilicheesefries // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/chilicheesefries/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)
	reagents.add_reagent("capsaicin", 2)

/obj/item/reagent_containers/food/snacks/blackpudding // CHOMPEdit - Removal of obj/item/weapon
	name = "Black Pudding"
...
/obj/item/reagent_containers/food/snacks/blackpudding/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)
...
/obj/item/reagent_containers/food/snacks/badrecipe/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/meatsteak/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)
	reagents.add_reagent("sodiumchloride", 1)
	reagents.add_reagent("blackpepper", 1)

/obj/item/reagent_containers/food/snacks/spacylibertyduff // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/spacylibertyduff/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("psilocybin", 6)

/obj/item/reagent_containers/food/snacks/amanitajelly // CHOMPEdit - Removal of obj/item/weapon
	name = "Amanita Jelly"
...
/obj/item/reagent_containers/food/snacks/amanitajelly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/monkeycube/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 10)

/obj/item/reagent_containers/food/snacks/monkeycube/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(wrapped)
		Unwrap(user)

/obj/item/reagent_containers/food/snacks/monkeycube/proc/Expand() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/monkeycube/proc/Unwrap(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "monkeycube"
	desc = "Just add water!"
...
/obj/item/reagent_containers/food/snacks/monkeycube/On_Consume(var/mob/M) // CHOMPEdit - Removal of obj/item/weapon
	if(ishuman(M))
		var/mob/living/carbon/human/H = M
...
/obj/item/reagent_containers/food/snacks/monkeycube/on_reagent_change() // CHOMPEdit - Removal of obj/item/weapon
	if(reagents.has_reagent("water"))
		Expand()

/obj/item/reagent_containers/food/snacks/monkeycube/wrapped // CHOMPEdit - Removal of obj/item/weapon
	desc = "Still wrapped in some paper."
	icon_state = "monkeycubewrap"
	flags = 0
	wrapped = 1

/obj/item/reagent_containers/food/snacks/monkeycube/farwacube // CHOMPEdit - Removal of obj/item/weapon
	name = "farwa cube"
	monkey_type = "Farwa"

/obj/item/reagent_containers/food/snacks/monkeycube/wrapped/farwacube // CHOMPEdit - Removal of obj/item/weapon
	name = "farwa cube"
	monkey_type = "Farwa"

/obj/item/reagent_containers/food/snacks/monkeycube/stokcube // CHOMPEdit - Removal of obj/item/weapon
	name = "stok cube"
	monkey_type = "Stok"

/obj/item/reagent_containers/food/snacks/monkeycube/wrapped/stokcube // CHOMPEdit - Removal of obj/item/weapon
	name = "stok cube"
	monkey_type = "Stok"

/obj/item/reagent_containers/food/snacks/monkeycube/neaeracube // CHOMPEdit - Removal of obj/item/weapon
	name = "neaera cube"
	monkey_type = "Neaera"

/obj/item/reagent_containers/food/snacks/monkeycube/wrapped/neaeracube // CHOMPEdit - Removal of obj/item/weapon
	name = "neaera cube"
	monkey_type = "Neaera"
...
/obj/item/reagent_containers/food/snacks/bigbiteburger/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 10)
...
/obj/item/reagent_containers/food/snacks/enchiladas/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)
...
/obj/item/reagent_containers/food/snacks/monkeysdelight/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 10)
	reagents.add_reagent("banana", 5)
	reagents.add_reagent("blackpepper", 1)
...
/obj/item/reagent_containers/food/snacks/baguette/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("blackpepper", 1)
	reagents.add_reagent("sodiumchloride", 1)
...
/obj/item/reagent_containers/food/snacks/fishandchips/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)
...
/obj/item/reagent_containers/food/snacks/rofflewaffles/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/jelliedtoast/cherry/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("cherryjelly", 5)

/obj/item/reagent_containers/food/snacks/jelliedtoast/slime/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("slimejelly", 5)
...
/obj/item/reagent_containers/food/snacks/cheesetoast // CHOMPEdit - Removal of obj/item/weapon
	name = "Cheesy Toast"
...
/obj/item/reagent_containers/food/snacks/jellyburger/slime/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("slimejelly", 5)

/obj/item/reagent_containers/food/snacks/jellyburger/cherry/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("cherryjelly", 5)
...
/obj/item/reagent_containers/food/snacks/kudzudonburi // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/kudzudonburi/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)
...
/obj/item/reagent_containers/food/snacks/pastatomato/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/meatballspagetti/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)
...
/obj/item/reagent_containers/food/snacks/spesslaw/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)
...
/obj/item/reagent_containers/food/snacks/superbiteburger/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 25)

/obj/item/reagent_containers/food/snacks/caramelapple // CHOMPEdit - Removal of obj/item/weapon
	name = "Caramel Apple"
...
/obj/item/reagent_containers/food/snacks/sandwich/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)

/obj/item/reagent_containers/food/snacks/clubsandwich // CHOMPEdit - Removal of obj/item/weapon
	name = "Club Sandwich"
...
/obj/item/reagent_containers/food/snacks/toastedsandwich/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)
...
/obj/item/reagent_containers/food/snacks/grilledcheese/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)
...
/obj/item/reagent_containers/food/snacks/jellysandwich/slime/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("slimejelly", 5)

/obj/item/reagent_containers/food/snacks/jellysandwich/cherry/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("cherryjelly", 5)

/obj/item/reagent_containers/food/snacks/jellysandwich/peanutbutter // CHOMPEdit - Removal of obj/item/weapon
	desc = "You wish you had some peanut butter to go with this... Oh wait!"
	icon_state = "pbandj"

/obj/item/reagent_containers/food/snacks/jellysandwich/peanutbutter/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("peanutbutter", 5)

// End Sandwiches //////////////////////////////////////////////

/obj/item/reagent_containers/food/snacks/boiledslimecore // CHOMPEdit - Removal of obj/item/weapon
	name = "Boiled Slime Core"
	desc = "A boiled red thing."
	icon_state = "boiledslimecore"
	bitesize = 3

/obj/item/reagent_containers/food/snacks/boiledslimecore/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("slimejelly", 5)
...
/obj/item/reagent_containers/food/snacks/plumphelmetbiscuit/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(prob(10))
...
/obj/item/reagent_containers/food/snacks/chawanmushi/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/validsalad/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)
...
/obj/item/reagent_containers/food/snacks/appletart/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/meatballsoup/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 8)
...
/obj/item/reagent_containers/food/snacks/slimesoup/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("slimejelly", 5)
...
/obj/item/reagent_containers/food/snacks/bloodsoup/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)
...
/obj/item/reagent_containers/food/snacks/clownstears/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("banana", 5)
	reagents.add_reagent("water", 10)
...
/obj/item/reagent_containers/food/snacks/vegetablesoup/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/nettlesoup/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("water", 5)
	reagents.add_reagent("tricordrazine", 5)
...
/obj/item/reagent_containers/food/snacks/mysterysoup/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/wishsoup/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("water", 10)
	if(prob(25))
...
/obj/item/reagent_containers/food/snacks/tomatosoup/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/mushroomsoup/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/beetsoup/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	name = pick(list("borsch","bortsch","borstch","borsh","borshch","borscht"))
	reagents.add_reagent("beet_soup", 10)

/obj/item/reagent_containers/food/snacks/soup/onion // CHOMPEdit - Removal of obj/item/weapon
	name = "onion soup"
...
/obj/item/reagent_containers/food/snacks/soup/onion/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("onion_soup", 10)

/obj/item/reagent_containers/food/snacks/chickennoodlesoup // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/chickennoodlesoup/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/stew/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)
	reagents.add_reagent("tomatojuice", 5)
	reagents.add_reagent("imidazoline", 5)
...
/obj/item/reagent_containers/food/snacks/bearstew // CHOMPEdit - Removal of obj/item/weapon
	name = "bear stew"
	gender = PLURAL
...
/obj/item/reagent_containers/food/snacks/bearstew/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)
	reagents.add_reagent("hyperzine", 5)
	reagents.add_reagent("tomatojuice", 5)
...
/obj/item/reagent_containers/food/snacks/hotchili/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)
	reagents.add_reagent("capsaicin", 3)
	reagents.add_reagent("tomatojuice", 2)
...
/obj/item/reagent_containers/food/snacks/coldchili/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)
	reagents.add_reagent("frostoil", 3)
	reagents.add_reagent("tomatojuice", 2)
...
/obj/item/reagent_containers/food/snacks/bearchili // CHOMPEdit - Removal of obj/item/weapon
	name = "bear chili"
	gender = PLURAL
...
/obj/item/reagent_containers/food/snacks/bearchili/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)
	reagents.add_reagent("capsaicin", 3)
	reagents.add_reagent("tomatojuice", 2)
...
/obj/item/reagent_containers/food/snacks/sliceable // CHOMPEdit - Removal of obj/item/weapon
 ...
 *  reagents.
 */
/obj/item/reagent_containers/food/snacks/slice // CHOMPEdit - Removal of obj/item/weapon
 ...
 */
/obj/item/reagent_containers/food/snacks/slice/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(filled)
		var/obj/item/reagent_containers/food/snacks/whole = new whole_path() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/meatbread // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/slice/meatbread // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/sliceable/meatbread/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/slice/meatbread // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 16 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/meatbread // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/xenomeatbread // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/slice/xenomeatbread // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/sliceable/xenomeatbread/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 20)
...
/obj/item/reagent_containers/food/snacks/slice/xenomeatbread // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 13 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/xenomeatbread // CHOMPEdit - Removal of obj/item/weapon


/obj/item/reagent_containers/food/snacks/slice/xenomeatbread/filled // CHOMPEdit - Removal of obj/item/weapon
	filled = TRUE
...
/obj/item/reagent_containers/food/snacks/sliceable/bananabread // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/slice/bananabread // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/sliceable/bananabread/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/slice/bananabread // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 8 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/bananabread // CHOMPEdit - Removal of obj/item/weapon

/obj/item/reagent_containers/food/snacks/slice/bananabread/filled // CHOMPEdit - Removal of obj/item/weapon
	filled = TRUE
...
/obj/item/reagent_containers/food/snacks/sliceable/tofubread // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/slice/tofubread // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/slice/tofubread // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 13 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/tofubread // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/slice/bread // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 4 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/bread // CHOMPEdit - Removal of obj/item/weapon

/obj/item/reagent_containers/food/snacks/slice/bread/filled // CHOMPEdit - Removal of obj/item/weapon
	filled = TRUE
...
/obj/item/reagent_containers/food/snacks/sliceable/creamcheesebread // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/slice/creamcheesebread // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/sliceable/creamcheesebread/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/slice/creamcheesebread // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 14 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/creamcheesebread // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/carrotcake // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/slice/carrotcake // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/sliceable/carrotcake/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/slice/carrotcake // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 14 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/carrotcake // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/braincake // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/slice/braincake // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/sliceable/braincake/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 25)
...
/obj/item/reagent_containers/food/snacks/slice/braincake // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 12 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/braincake // CHOMPEdit - Removal of obj/item/weapon

/obj/item/reagent_containers/food/snacks/slice/braincake/filled // CHOMPEdit - Removal of obj/item/weapon
	filled = TRUE
...
/obj/item/reagent_containers/food/snacks/sliceable/cheesecake // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/slice/cheesecake // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/sliceable/cheesecake/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 15)
...
/obj/item/reagent_containers/food/snacks/slice/cheesecake // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 14 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/cheesecake // CHOMPEdit - Removal of obj/item/weapon

/obj/item/reagent_containers/food/snacks/slice/cheesecake/filled // CHOMPEdit - Removal of obj/item/weapon
	filled = TRUE

/obj/item/reagent_containers/food/snacks/sliceable/peanutcake // CHOMPEdit - Removal of obj/item/weapon
	name = "Peanut Cake"
	desc = "DANGEROUSLY nutty. Sometimes literally."
	icon_state = "peanutcake"
	slice_path = /obj/item/reagent_containers/food/snacks/slice/peanutcake // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/sliceable/peanutcake/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 5)

/obj/item/reagent_containers/food/snacks/slice/peanutcake // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 14 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/peanutcake // CHOMPEdit - Removal of obj/item/weapon

/obj/item/reagent_containers/food/snacks/slice/peanutcake/filled // CHOMPEdit - Removal of obj/item/weapon
	filled = TRUE
...
/obj/item/reagent_containers/food/snacks/sliceable/plaincake // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/slice/plaincake // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/slice/plaincake // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 14 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/plaincake // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/orangecake // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/slice/orangecake // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/slice/orangecake // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 14 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/orangecake // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/limecake // CHOMPEdit - Removal of obj/item/weapon
	...
	icon_state = "limecake"
	slice_path = /obj/item/reagent_containers/food/snacks/slice/limecake // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/slice/limecake // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 14 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/limecake // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/lemoncake // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/slice/lemoncake // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/slice/lemoncake // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 14 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/lemoncake // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/chocolatecake // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/slice/chocolatecake // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/slice/chocolatecake // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 14 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/chocolatecake // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/cheesewheel // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/cheesewedge // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/sliceable/cheesewheel/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 10)
...
/obj/item/reagent_containers/food/snacks/sliceable/birthdaycake // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/slice/birthdaycake // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/sliceable/birthdaycake/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/slice/birthdaycake // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 14 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/birthdaycake // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/bread // CHOMPEdit - Removal of obj/item/weapon
	...
	icon_state = "bread"
	slice_path = /obj/item/reagent_containers/food/snacks/slice/bread // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/sliceable/applecake // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/slice/applecake // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/slice/applecake // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 14 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/applecake // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/pumpkinpie // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/slice/pumpkinpie // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
...
/obj/item/reagent_containers/food/snacks/slice/pumpkinpie // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 12 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/pumpkinpie // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/grilled_carp // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/grilled_carp_slice // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 6
	trash = /obj/item/trash/snacktray

/obj/item/reagent_containers/food/snacks/sliceable/grilled_carp/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("seafood", 12)

/obj/item/reagent_containers/food/snacks/grilled_carp_slice // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/keylimepie // CHOMPEdit - Removal of obj/item/weapon
	name = "key lime pie"
	desc = "A tart, sweet dessert. What's a key lime, anyway?"
	icon_state = "keylimepie"
	slice_path = /obj/item/reagent_containers/food/snacks/keylimepieslice // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
	filling_color = "#F5B951"
	nutriment_amt = 16
...
/obj/item/reagent_containers/food/snacks/sliceable/keylimepie/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)

/obj/item/reagent_containers/food/snacks/keylimepieslice // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/quiche // CHOMPEdit - Removal of obj/item/weapon
	name = "quiche"
	desc = "Real men eat this, contrary to popular belief."
	icon_state = "quiche"
	slice_path = /obj/item/reagent_containers/food/snacks/quicheslice // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
	filling_color = "#F5B951"
	nutriment_amt = 10
...
/obj/item/reagent_containers/food/snacks/sliceable/quiche/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 10)

/obj/item/reagent_containers/food/snacks/quicheslice // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/quicheslice/filled/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 1)

/obj/item/reagent_containers/food/snacks/sliceable/brownies // CHOMPEdit - Removal of obj/item/weapon
	name = "brownies"
	gender = PLURAL
	desc = "Halfway to fudge, or halfway to cake? Who cares!"
	icon_state = "brownies"
	slice_path = /obj/item/reagent_containers/food/snacks/browniesslice // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 4
...
/obj/item/reagent_containers/food/snacks/sliceable/brownies/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)

/obj/item/reagent_containers/food/snacks/browniesslice // CHOMPEdit - Removal of obj/item/weapon
	name = "brownie"
...
/obj/item/reagent_containers/food/snacks/browniesslice/filled/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 1)

/obj/item/reagent_containers/food/snacks/sliceable/cosmicbrownies // CHOMPEdit - Removal of obj/item/weapon
	name = "cosmic brownies"
	gender = PLURAL
	desc = "Like, ultra-trippy. Brownies HAVE no gender, man." //Except I had to add one!
	icon_state = "cosmicbrownies"
	slice_path = /obj/item/reagent_containers/food/snacks/cosmicbrowniesslice // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 4
	trash = /obj/item/trash/brownies
	filling_color = "#301301"
	nutriment_amt = 8
...
/obj/item/reagent_containers/food/snacks/sliceable/cosmicbrownies/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)
...
/obj/item/reagent_containers/food/snacks/cosmicbrowniesslice // CHOMPEdit - Removal of obj/item/weapon
	name = "cosmic brownie"
...
/obj/item/reagent_containers/food/snacks/cosmicbrowniesslice/filled // CHOMPEdit - Removal of obj/item/weapon
	nutriment_amt = 1

/obj/item/reagent_containers/food/snacks/cosmicbrowniesslice/filled/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 1)

/obj/item/reagent_containers/food/snacks/lasagna // CHOMPEdit - Removal of obj/item/weapon
	name = "lasagna"
...
/obj/item/reagent_containers/food/snacks/lasagna/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2) //For meaty things.

/obj/item/reagent_containers/food/snacks/gigapuddi // CHOMPEdit - Removal of obj/item/weapon
	name = "Astro-Pudding"
...
/obj/item/reagent_containers/food/snacks/gigapuddi/happy // CHOMPEdit - Removal of obj/item/weapon
	desc = "A crème caramel of astronomical size, made with extra love."
	icon = 'icons/obj/food.dmi'
	icon_state = "happypuddi"

/obj/item/reagent_containers/food/snacks/gigapuddi/anger // CHOMPEdit - Removal of obj/item/weapon
	desc = "A crème caramel of astronomical size, made with extra hate."
	icon_state = "angerpuddi"

/obj/item/reagent_containers/food/snacks/sliceable/buchedenoel // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper Buche de Noel"
	desc = "Yule love it!"
	icon = 'icons/obj/food.dmi'
	icon_state = "buche"
	slice_path = /obj/item/reagent_containers/food/snacks/bucheslice // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 5
	w_class = 2
	nutriment_amt = 20
...
/obj/item/reagent_containers/food/snacks/sliceable/buchedenoel/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 9)
	reagents.add_reagent("coco", 5)

/obj/item/reagent_containers/food/snacks/bucheslice // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/turkey // CHOMPEdit - Removal of obj/item/weapon
	name = "turkey"
	desc = "Tastes like chicken."
	icon = 'icons/obj/food.dmi'
	icon_state = "turkey"
	slice_path = /obj/item/reagent_containers/food/snacks/turkeyslice // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 6
	w_class = 2
	nutriment_amt = 20
...
/obj/item/reagent_containers/food/snacks/sliceable/turkey/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("blackpepper", 1)
	reagents.add_reagent("sodiumchloride", 1)
	reagents.add_reagent("cookingoil", 1)

/obj/item/reagent_containers/food/snacks/turkeyslice // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/suppermatter // CHOMPEdit - Removal of obj/item/weapon
	name = "suppermatter"
	desc = "Extremely dense and powerful food."
	slice_path = /obj/item/reagent_containers/food/snacks/suppermattershard // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 10
	icon = 'icons/obj/food.dmi'
...
/obj/item/reagent_containers/food/snacks/sliceable/suppermatter/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	set_light(1.4,2,"#FFFF00")

/obj/item/reagent_containers/food/snacks/suppermattershard // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/suppermattershard/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	set_light(1.4,1.4,"#FFFF00")

/obj/item/reagent_containers/food/snacks/sliceable/excitingsuppermatter // CHOMPEdit - Removal of obj/item/weapon
	name = "exciting suppermatter"
	desc = "Extremely dense, powerful and exciting food!"
	slice_path = /obj/item/reagent_containers/food/snacks/excitingsuppermattershard // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 10
	icon = 'icons/obj/food.dmi'
...
/obj/item/reagent_containers/food/snacks/sliceable/excitingsuppermatter/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	set_light(1.4,2,"#FF0000")

/obj/item/reagent_containers/food/snacks/excitingsuppermattershard // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/excitingsuppermattershard/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/sliceable/pizza/margherita // CHOMPEdit - Removal of obj/item/weapon
	name = "Margherita"
	desc = "The golden standard of pizzas."
	icon_state = "pizzamargherita"
	slice_path = /obj/item/reagent_containers/food/snacks/slice/margherita // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 6
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 11 //CHOMPEdit
...
/obj/item/reagent_containers/food/snacks/sliceable/pizza/margherita/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 5)
...
/obj/item/reagent_containers/food/snacks/slice/margherita // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 13 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/pizza/margherita // CHOMPEdit - Removal of obj/item/weapon

/obj/item/reagent_containers/food/snacks/slice/margherita/filled // CHOMPEdit - Removal of obj/item/weapon
	filled = TRUE

/obj/item/reagent_containers/food/snacks/sliceable/pizza/pineapple // CHOMPEdit - Removal of obj/item/weapon
	name = "ham & pineapple pizza"
	desc = "One of the most debated pizzas in existence."
	icon_state = "pineapple_pizza"
	slice_path = /obj/item/reagent_containers/food/snacks/pineappleslice // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 6
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 11 //CHOMPEdit
...
/obj/item/reagent_containers/food/snacks/sliceable/pizza/pineapple/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)
	reagents.add_reagent("cheese", 5)
	reagents.add_reagent("tomatojuice", 6)

/obj/item/reagent_containers/food/snacks/pineappleslice // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/pizza/meatpizza // CHOMPEdit - Removal of obj/item/weapon
	name = "Meatpizza"
	desc = "A pizza with meat topping."
	icon_state = "meatpizza"
	slice_path = /obj/item/reagent_containers/food/snacks/slice/meatpizza // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 6
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 11 //CHOMPEdit
...
/obj/item/reagent_containers/food/snacks/sliceable/pizza/meatpizza/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/slice/meatpizza // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 13 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/pizza/meatpizza // CHOMPEdit - Removal of obj/item/weapon

/obj/item/reagent_containers/food/snacks/slice/meatpizza/filled // CHOMPEdit - Removal of obj/item/weapon
	filled = TRUE

/obj/item/reagent_containers/food/snacks/sliceable/pizza/mushroompizza // CHOMPEdit - Removal of obj/item/weapon
	name = "Mushroompizza"
	desc = "Very special pizza."
	icon_state = "mushroompizza"
	slice_path = /obj/item/reagent_containers/food/snacks/slice/mushroompizza // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 6
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 11 //CHOMPEdit
...
/obj/item/reagent_containers/food/snacks/sliceable/pizza/mushroompizza/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 5)
...
/obj/item/reagent_containers/food/snacks/slice/mushroompizza // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 13 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/pizza/mushroompizza // CHOMPEdit - Removal of obj/item/weapon

/obj/item/reagent_containers/food/snacks/slice/mushroompizza/filled // CHOMPEdit - Removal of obj/item/weapon
	filled = TRUE

/obj/item/reagent_containers/food/snacks/sliceable/pizza/vegetablepizza // CHOMPEdit - Removal of obj/item/weapon
	name = "Vegetable pizza"
	desc = "No one of Tomato Sapiens were harmed during making this pizza."
	icon_state = "vegetablepizza"
	slice_path = /obj/item/reagent_containers/food/snacks/slice/vegetablepizza // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 6
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 11 //CHOMPEdit
...
/obj/item/reagent_containers/food/snacks/sliceable/pizza/vegetablepizza/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 5)
	reagents.add_reagent("tomatojuice", 6)
...
/obj/item/reagent_containers/food/snacks/slice/vegetablepizza // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 13 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/pizza/vegetablepizza // CHOMPEdit - Removal of obj/item/weapon

/obj/item/reagent_containers/food/snacks/slice/vegetablepizza/filled // CHOMPEdit - Removal of obj/item/weapon
	filled = TRUE

/obj/item/reagent_containers/food/snacks/sliceable/pizza/crunch // CHOMPEdit - Removal of obj/item/weapon
	name = "pizza crunch"
	...
	slice_path = /obj/item/reagent_containers/food/snacks/pizzacrunchslice // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 6
	nutriment_amt = 25
...
/obj/item/reagent_containers/food/snacks/pizzacrunchslice // CHOMPEdit - Removal of obj/item/weapon
	name = "pizza crunch"
...
/obj/item/reagent_containers/food/snacks/sliceable/pizza/oldpizza // CHOMPEdit - Removal of obj/item/weapon
	name = "moldy pizza"
	desc = "This pizza might actually be alive.  There's mold all over."
	icon_state = "oldpizza"
	slice_path = /obj/item/reagent_containers/food/snacks/slice/oldpizza // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 6
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 11 //CHOMPEdit
...
/obj/item/reagent_containers/food/snacks/sliceable/pizza/oldpizza/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 5)
	reagents.add_reagent("tomatojuice", 6)
	reagents.add_reagent("mold", 8)

/obj/item/reagent_containers/food/snacks/slice/oldpizza // CHOMPEdit - Removal of obj/item/weapon
	...
	center_of_mass_x = 16 //CHOMPEdit
	center_of_mass_y= 13 //CHOMPEdit
	whole_path = /obj/item/reagent_containers/food/snacks/sliceable/pizza/oldpizza // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/pizzabox
	...
	var/obj/item/reagent_containers/food/snacks/sliceable/pizza/pizza // Content pizza // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/pizzabox/attackby( obj/item/I as obj, mob/user as mob )
	...
	if( istype(I, /obj/item/reagent_containers/food/snacks/sliceable/pizza/) ) // Long ass fucking object name // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/pizzabox/margherita/Initialize()
	pizza = new /obj/item/reagent_containers/food/snacks/sliceable/pizza/margherita(src) // CHOMPEdit - Removal of obj/item/weapon
	boxtag = "Margherita Deluxe"
	. = ..()

/obj/item/pizzabox/vegetable/Initialize()
	pizza = new /obj/item/reagent_containers/food/snacks/sliceable/pizza/vegetablepizza(src) // CHOMPEdit - Removal of obj/item/weapon
	boxtag = "Gourmet Vegatable"
	. = ..()

/obj/item/pizzabox/mushroom/Initialize()
	pizza = new /obj/item/reagent_containers/food/snacks/sliceable/pizza/mushroompizza(src) // CHOMPEdit - Removal of obj/item/weapon
	boxtag = "Mushroom Special"
	. = ..()

/obj/item/pizzabox/meat/Initialize()
	pizza = new /obj/item/reagent_containers/food/snacks/sliceable/pizza/meatpizza(src) // CHOMPEdit - Removal of obj/item/weapon
	boxtag = "Meatlover's Supreme"
	. = ..()

/obj/item/pizzabox/pineapple/Initialize()
	pizza = new /obj/item/reagent_containers/food/snacks/sliceable/pizza/pineapple(src) // CHOMPEdit - Removal of obj/item/weapon
	boxtag = "Hawaiian Sunrise"
	. = ..()

/obj/item/pizzabox/old/Initialize()
	pizza = new /obj/item/reagent_containers/food/snacks/sliceable/pizza/oldpizza(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/dionaroast/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/dough/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 1)

// Dough + rolling pin = flat dough
/obj/item/reagent_containers/food/snacks/dough/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W,/obj/item/material/kitchen/rollingpin)) // CHOMPEdit - Removal of obj/item/weapon
		new /obj/item/reagent_containers/food/snacks/sliceable/flatdough(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sliceable/flatdough // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/doughslice // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 3
	nutriment_amt = 3
...
/obj/item/reagent_containers/food/snacks/sliceable/flatdough/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 1)
...
/obj/item/reagent_containers/food/snacks/doughslice // CHOMPEdit - Removal of obj/item/weapon
	...
	slice_path = /obj/item/reagent_containers/food/snacks/spagetti // CHOMPEdit - Removal of obj/item/weapon
	slices_num = 1
	bitesize = 2
	center_of_mass_x = 17 //CHOMPEdit
...
/obj/item/reagent_containers/food/snacks/bun/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	// Bun + meatball = burger
	if(istype(W,/obj/item/reagent_containers/food/snacks/meatball)) // CHOMPEdit - Removal of obj/item/weapon
		new /obj/item/reagent_containers/food/snacks/monkeyburger(src) // CHOMPEdit - Removal of obj/item/weapon
		to_chat(user, "You make a burger.")
		qdel(W)
		qdel(src)

	// Bun + cutlet = hamburger
	else if(istype(W,/obj/item/reagent_containers/food/snacks/cutlet)) // CHOMPEdit - Removal of obj/item/weapon
		new /obj/item/reagent_containers/food/snacks/monkeyburger(src) // CHOMPEdit - Removal of obj/item/weapon
		to_chat(user, "You make a burger.")
		qdel(W)
		qdel(src)
	...
	// Bun + sausage = hotdog
	else if(istype(W,/obj/item/reagent_containers/food/snacks/sausage)) // CHOMPEdit - Removal of obj/item/weapon
		new /obj/item/reagent_containers/food/snacks/hotdog(src) // CHOMPEdit - Removal of obj/item/weapon
		to_chat(user, "You make a hotdog.")
		qdel(W)
		qdel(src)

// Burger + cheese wedge = cheeseburger
/obj/item/reagent_containers/food/snacks/monkeyburger/attackby(obj/item/reagent_containers/food/snacks/cheesewedge/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W))// && !istype(src,/obj/item/reagent_containers/food/snacks/cheesewedge)) // CHOMPEdit - Removal of obj/item/weapon
		new /obj/item/reagent_containers/food/snacks/cheeseburger(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/human/burger/attackby(obj/item/reagent_containers/food/snacks/cheesewedge/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W))
		new /obj/item/reagent_containers/food/snacks/cheeseburger(src) // CHOMPEdit - Removal of obj/item/weapon
		to_chat(user, "You make a cheeseburger.")
		qdel(W)
...
/obj/item/reagent_containers/food/snacks/taco/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)
...
/obj/item/reagent_containers/food/snacks/rawcutlet/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 1)
...
/obj/item/reagent_containers/food/snacks/cutlet/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)
...
/obj/item/reagent_containers/food/snacks/rawmeatball/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)

/obj/item/reagent_containers/food/snacks/hotdog // CHOMPEdit - Removal of obj/item/weapon
	name = "hotdog"
...
/obj/item/reagent_containers/food/snacks/hotdog/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)

///obj/item/reagent_containers/food/snacks/hotdog/old (Commented out on 4/23/2021 to make room for ancient hotdog) // CHOMPEdit - Removal of obj/item/weapon
//	name = "old hotdog"
//	desc = "Covered in mold.  You're not gonna eat that, are you?"
//
///obj/item/reagent_containers/food/snacks/hotdog/old/Initialize() // CHOMPEdit - Removal of obj/item/weapon
//	. = ..()
//	reagents.add_reagent("mold", 6)

/obj/item/reagent_containers/food/snacks/flatbread // CHOMPEdit - Removal of obj/item/weapon
	name = "flatbread"
...
/obj/item/reagent_containers/food/snacks/grown/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(seed && seed.kitchen_tag && seed.kitchen_tag == "potato" && istype(W,/obj/item/material/knife)) // CHOMPEdit - Removal of obj/item/weapon
		new /obj/item/reagent_containers/food/snacks/rawsticks(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
		to_chat(user, "<span class='notice'>You cut the potato.</span>")
		qdel(src)
	else if(seed && seed.kitchen_tag && seed.kitchen_tag == "sunflower" && istype(W,/obj/item/material/knife)) // CHOMPEdit - Removal of obj/item/weapon
		new /obj/item/reagent_containers/food/snacks/rawsunflower(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/frostbelle // CHOMPEdit - Removal of obj/item/weapon
	name = "frostbelle bud"
...
/obj/item/reagent_containers/food/snacks/frostbelle/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/bellefritter // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/bellefritter/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/liquidfood/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/liquidprotein/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/liquidvitamin/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/meatcube // CHOMPEdit - Removal of obj/item/weapon
	name = "cubed meat"
...
/obj/item/reagent_containers/food/snacks/meatcube/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 15)
...
/obj/item/reagent_containers/food/snacks/unajerky/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. =..()
	reagents.add_reagent("protein", 8)
	reagents.add_reagent("capsaicin", 2)

/obj/item/reagent_containers/food/snacks/sashimi // CHOMPEdit - Removal of obj/item/weapon
	name = "sashimi"
...
/obj/item/reagent_containers/food/snacks/sashimi/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)

/obj/item/reagent_containers/food/snacks/benedict // CHOMPEdit - Removal of obj/item/weapon
	name = "eggs benedict"
...
/obj/item/reagent_containers/food/snacks/benedict/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)

/obj/item/reagent_containers/food/snacks/beans // CHOMPEdit - Removal of obj/item/weapon
	name = "baked beans"
...
/obj/item/reagent_containers/food/snacks/beans/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/berrymuffin/berry/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("berryjuice", 3)

/obj/item/reagent_containers/food/snacks/berrymuffin/poison/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("poisonberryjuice", 3)

/obj/item/reagent_containers/food/snacks/ghostmuffin // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/ghostmuffin/berry/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("berryjuice", 3)

/obj/item/reagent_containers/food/snacks/ghostmuffin/poison/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("poisonberryjuice", 3)

/obj/item/reagent_containers/food/snacks/devilledegg // CHOMPEdit - Removal of obj/item/weapon
	name = "devilled eggs"
...
/obj/item/reagent_containers/food/snacks/devilledegg/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("capsaicin", 2)
...
/obj/item/reagent_containers/food/snacks/flowerchildsalad // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/rosesalad/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("stoxin", 2)

/obj/item/reagent_containers/food/snacks/eggbowl // CHOMPEdit - Removal of obj/item/weapon
	name = "egg bowl"
...
/obj/item/reagent_containers/food/snacks/eggbowl/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)
...
/obj/item/reagent_containers/food/snacks/cubannachos // CHOMPEdit - Removal of obj/item/weapon
	name = "cuban nachos"
...
/obj/item/reagent_containers/food/snacks/cubannachos/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("capsaicin", 4)

/obj/item/reagent_containers/food/snacks/curryrice // CHOMPEdit - Removal of obj/item/weapon
	name = "curry rice"
...
/obj/item/reagent_containers/food/snacks/curryrice/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("capsaicin", 4)

/obj/item/reagent_containers/food/snacks/piginblanket // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/piginblanket/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)
...
/obj/item/reagent_containers/food/snacks/wormsickly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/worm/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/wormdeluxe/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("fishbait", 30)
	reagents.add_reagent("protein",  10)

/obj/item/reagent_containers/food/snacks/siffruit // CHOMPEdit - Removal of obj/item/weapon
	name = "pulsing fruit"
...
/obj/item/reagent_containers/food/snacks/siffruit/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sifsap", 2)

/obj/item/reagent_containers/food/snacks/siffruit/afterattack(obj/O as obj, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(O,/obj/machinery/microwave))
		return ..()
	if(!(proximity && O.is_open_container()))
		return
...
/obj/item/reagent_containers/food/snacks/bagelcheese/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)
...
/obj/item/reagent_containers/food/snacks/bageleverything // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/bageleverything/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("phoron", 5)
	reagents.add_reagent("defective_nanites", 5)

/obj/item/reagent_containers/food/snacks/bageltwo // CHOMPEdit - Removal of obj/item/weapon
	name = "two bagels"
	desc = "Noo! ...Two bagels!"
	icon_state = "bagelplain"

/obj/item/reagent_containers/food/snacks/bageltwo/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	..()
	spawn_bagels()
	spawn_bagels()
	return INITIALIZE_HINT_QDEL

/obj/item/reagent_containers/food/snacks/bageltwo/proc/spawn_bagels() // CHOMPEdit - Removal of obj/item/weapon
	var/build_path = /obj/item/reagent_containers/food/snacks/bagelplain // CHOMPEdit - Removal of obj/item/weapon
	var/atom/A = new build_path(get_turf(src))
	if(pixel_x || pixel_y)
		A.pixel_x = pixel_x
		A.pixel_y = pixel_y

/obj/item/reagent_containers/food/snacks/macncheese // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/afterattack(obj/O as obj, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(O.is_open_container() && O.reagents && !(istype(O, /obj/item/reagent_containers/food)) && proximity) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/proc/apply_coating(var/datum/reagent/nutriment/coating/C, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if (coating)
...
/obj/item/reagent_containers/food/snacks/proc/cook() // CHOMPEdit - Removal of obj/item/weapon
	if (coating)
...
/obj/item/reagent_containers/food/snacks/proc/on_consume(var/mob/eater, var/mob/feeder = null) // CHOMPEdit - Removal of obj/item/weapon
	if(!reagents.total_volume)
...
/obj/item/reagent_containers/food/snacks/sausage/battered // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sausage/battered/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)
	reagents.add_reagent("batter", 1.7)
	reagents.add_reagent("oil", 1.5)

/obj/item/reagent_containers/food/snacks/jalapeno_poppers // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/jalapeno_poppers/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("batter", 2)
	reagents.add_reagent("oil", 2)

/obj/item/reagent_containers/food/snacks/mouseburger // CHOMPEdit - Removal of obj/item/weapon
	name = "mouse burger"
...
/obj/item/reagent_containers/food/snacks/mouseburger/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)
...
/obj/item/reagent_containers/food/snacks/chickenkatsu/Initialize() // CHOMPEdit - Removal of obj/item/weapon
		. = ..()
		reagents.add_reagent("protein", 6)
...
/obj/item/reagent_containers/food/snacks/sliceable/pizza/crunch/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("batter", 6.5)
	coating = reagents.get_reagent("batter")
	reagents.add_reagent("oil", 4)

/obj/item/reagent_containers/food/snacks/funnelcake // CHOMPEdit - Removal of obj/item/weapon
	name = "funnel cake"
...
/obj/item/reagent_containers/food/snacks/funnelcake/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("batter", 10)
	reagents.add_reagent("sugar", 5)
...
/obj/item/reagent_containers/food/snacks/spreads/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("triglyceride", 20)
	reagents.add_reagent("sodiumchloride",1)

/obj/item/reagent_containers/food/snacks/rawcutlet/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W,/obj/item/material/knife)) // CHOMPEdit - Removal of obj/item/weapon
		new /obj/item/reagent_containers/food/snacks/rawbacon(src) // CHOMPEdit - Removal of obj/item/weapon
		new /obj/item/reagent_containers/food/snacks/rawbacon(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/rawbacon/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/bacon/microwave // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/bacon/oven // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/bacon/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 0.33)
	reagents.add_reagent("triglyceride", 1)

/obj/item/reagent_containers/food/snacks/bacon_stick // CHOMPEdit - Removal of obj/item/weapon
	name = "eggpop"
	desc = "A bacon wrapped boiled egg, conveniently skewered on a wooden stick."
	icon_state = "bacon_stick"
	trash = /obj/item/trash/stick

/obj/item/reagent_containers/food/snacks/bacon_stick/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)
	reagents.add_reagent("egg", 1)

/obj/item/reagent_containers/food/snacks/chilied_eggs // CHOMPEdit - Removal of obj/item/weapon
	name = "Redeemed eggs"
...
/obj/item/reagent_containers/food/snacks/chilied_eggs/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("egg", 6)
	reagents.add_reagent("protein", 2)

/obj/item/reagent_containers/food/snacks/bacon_and_eggs // CHOMPEdit - Removal of obj/item/weapon
	name = "bacon and eggs"
	desc = "A piece of bacon and two fried eggs."
	icon_state = "bacon_and_eggs"
	trash = /obj/item/trash/plate

/obj/item/reagent_containers/food/snacks/bacon_and_eggs/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)
	reagents.add_reagent("egg", 1)

/obj/item/reagent_containers/food/snacks/sweet_and_sour // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sweet_and_sour/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)
...
/obj/item/reagent_containers/food/snacks/corn_dog/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)

/obj/item/reagent_containers/food/snacks/truffle // CHOMPEdit - Removal of obj/item/weapon
	name = "chocolate truffle"
...
/obj/item/reagent_containers/food/snacks/truffle/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("coco", 6)

/obj/item/reagent_containers/food/snacks/truffle/random // CHOMPEdit - Removal of obj/item/weapon
	name = "mystery chocolate truffle"
	desc = "Rich bite-sized chocolate with a mystery filling!"

/obj/item/reagent_containers/food/snacks/truffle/random/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/bacon_flatbread // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/bacon_flatbread/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 5)

/obj/item/reagent_containers/food/snacks/meat_pocket // CHOMPEdit - Removal of obj/item/weapon
	name = "meat pocket"
...
/obj/item/reagent_containers/food/snacks/meat_pocket/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)

/obj/item/reagent_containers/food/snacks/fish_taco // CHOMPEdit - Removal of obj/item/weapon
	name = "fish taco"
...
/obj/item/reagent_containers/food/snacks/fish_taco/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("seafood",3)

/obj/item/reagent_containers/food/snacks/nt_muffin // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/nt_muffin/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein",5)
...
/obj/item/reagent_containers/food/snacks/pineapple_ring/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("pineapplejuice",3)


/obj/item/reagent_containers/food/snacks/burger/bacon // CHOMPEdit - Removal of obj/item/weapon
	name = "bacon burger"
...
/obj/item/reagent_containers/food/snacks/burger/bacon/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)

/obj/item/reagent_containers/food/snacks/blt // CHOMPEdit - Removal of obj/item/weapon
	name = "BLT"
...
/obj/item/reagent_containers/food/snacks/blt/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)

/obj/item/reagent_containers/food/snacks/porkbowl // CHOMPEdit - Removal of obj/item/weapon
	name = "pork bowl"
...
/obj/item/reagent_containers/food/snacks/porkbowl/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/loadedbakedpotato/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)

/obj/item/reagent_containers/food/snacks/bangersandmash // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/bangersandmash/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)

/obj/item/reagent_containers/food/snacks/cheesymash // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/cheesymash/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)
...
/obj/item/reagent_containers/food/snacks/pancakes // CHOMPEdit - Removal of obj/item/weapon
	name = "pancakes"
...
/obj/item/reagent_containers/food/snacks/pancakes/berry // CHOMPEdit - Removal of obj/item/weapon
	name = "berry pancakes"
...
/obj/item/reagent_containers/food/snacks/nugget // CHOMPEdit - Removal of obj/item/weapon
	name = "chicken nugget"
	icon_state = "nugget_lump"
	bitesize = 3

/obj/item/reagent_containers/food/snacks/nugget/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/icecreamsandwich // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/honeybun/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("honey", 3)

// Moved /bun/attackby() from /code/modules/food/food/snacks.dm
/obj/item/reagent_containers/food/snacks/bun/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/reagent_containers/food/snacks/result = null // CHOMPEdit - Removal of obj/item/weapon
	// Bun + meatball = burger
	if(istype(W,/obj/item/reagent_containers/food/snacks/meatball)) // CHOMPEdit - Removal of obj/item/weapon
		result = new /obj/item/reagent_containers/food/snacks/monkeyburger(src) // CHOMPEdit - Removal of obj/item/weapon
		to_chat(user, "You make a burger.")
		qdel(W)
		qdel(src)
	...
	// Bun + sausage = hotdog
		...
		result = new /obj/item/reagent_containers/food/snacks/hotdog(src) // CHOMPEdit - Removal of obj/item/weapon
		to_chat(user, "You make a hotdog.")
		qdel(W)
		qdel(src)

	// Bun + mouse = mouseburger
	else if(istype(W,/obj/item/reagent_containers/food/snacks/variable/mob)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/reagent_containers/food/snacks/variable/mob/MF = W // CHOMPEdit - Removal of obj/item/weapon

		switch (MF.kitchen_tag)
			if ("rodent")
				result = new /obj/item/reagent_containers/food/snacks/mouseburger(src) // CHOMPEdit - Removal of obj/item/weapon
...
///obj/item/reagent_containers/food/snacks/chip // CHOMPEdit - Removal of obj/item/weapon
//	name = "chip"
...
///obj/item/reagent_containers/food/snacks/chip/on_consume(mob/M as mob) // CHOMPEdit - Removal of obj/item/weapon
//	if(reagents && reagents.total_volume)
...
/obj/item/reagent_containers/food/snacks/nacho // CHOMPEdit - Removal of obj/item/weapon
	name = "chip"
	desc = "A portion sized chip good for dipping."
	icon_state = "chip"
	bitesize = 1
...
/obj/item/reagent_containers/food/snacks/chip/salsa // CHOMPEdit - Removal of obj/item/weapon
	name = "salsa chip"
	desc = "A portion sized chip good for dipping. This one has salsa on it."
	icon_state = "chip_salsa"

/obj/item/reagent_containers/food/snacks/chip/guac // CHOMPEdit - Removal of obj/item/weapon
	name = "guac chip"
	desc = "A portion sized chip good for dipping. This one has guac on it."
	icon_state = "chip_guac"

/obj/item/reagent_containers/food/snacks/chip/cheese // CHOMPEdit - Removal of obj/item/weapon
	name = "cheese chip"
	desc = "A portion sized chip good for dipping. This one has cheese sauce on it."
	icon_state = "chip_cheese"

/obj/item/reagent_containers/food/snacks/chip/nacho // CHOMPEdit - Removal of obj/item/weapon
	name = "nacho chip"
	desc = "A nacho ship stray from a plate of cheesy nachos."
	icon_state = "nacho"
	nutriment_desc = list("nacho chips" = 1)

/obj/item/reagent_containers/food/snacks/chip/nacho/salsa // CHOMPEdit - Removal of obj/item/weapon
	name = "nacho chip"
	desc = "A nacho ship stray from a plate of cheesy nachos. This one has salsa on it."
	icon_state = "nacho_salsa"

/obj/item/reagent_containers/food/snacks/chip/nacho/guac // CHOMPEdit - Removal of obj/item/weapon
	name = "nacho chip"
	desc = "A nacho ship stray from a plate of cheesy nachos. This one has guac on it."
	icon_state = "nacho_guac"

/obj/item/reagent_containers/food/snacks/chip/nacho/cheese // CHOMPEdit - Removal of obj/item/weapon
	name = "nacho chip"
...
/obj/item/reagent_containers/food/snacks/chipplate // CHOMPEdit - Removal of obj/item/weapon
	...
	var/vendingobject = /obj/item/reagent_containers/food/snacks/chip // CHOMPEdit - Removal of obj/item/weapon
	nutriment_desc = list("tortilla chips" = 10)
	bitesize = 1
	nutriment_amt = 10

/obj/item/reagent_containers/food/snacks/chipplate/attack_hand(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/reagent_containers/food/snacks/returningitem = new vendingobject(loc) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/chipplate/MouseDrop(mob/user) //Dropping the chip onto the user // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/chipplate/nachos // CHOMPEdit - Removal of obj/item/weapon
	name = "basket of nachos"
	desc = "A very cheesy basket of nacho."
	icon_state = "nachos"
	trash = /obj/item/trash/chipbasket
	vendingobject = /obj/item/reagent_containers/food/snacks/chip/nacho // CHOMPEdit - Removal of obj/item/weapon
	nutriment_desc = list("tortilla chips" = 10)
	bitesize = 1
...
/obj/item/reagent_containers/food/snacks/dip // CHOMPEdit - Removal of obj/item/weapon
	name = "queso dip"
	desc = "A simple, cheesy dip consisting of tomatos, cheese, and spices."
	var/nachotrans = /obj/item/reagent_containers/food/snacks/chip/nacho/cheese // CHOMPEdit - Removal of obj/item/weapon
	var/chiptrans = /obj/item/reagent_containers/food/snacks/chip/cheese // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/dip/attackby(obj/item/reagent_containers/food/snacks/item as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	var/obj/item/reagent_containers/food/snacks/returningitem // CHOMPEdit - Removal of obj/item/weapon
	if(istype(item,/obj/item/reagent_containers/food/snacks/chip/nacho) && item.icon_state == "chip_nacho") // CHOMPEdit - Removal of obj/item/weapon
		returningitem = new nachotrans(src)
	else if (istype(item,/obj/item/reagent_containers/food/snacks/chip) && (item.icon_state == "chip" || item.icon_state == "chip_half")) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/dip/salsa // CHOMPEdit - Removal of obj/item/weapon
	name = "salsa dip"
	desc = "Traditional Sol chunky salsa dip containing tomatos, peppers, and spices."
	nachotrans = /obj/item/reagent_containers/food/snacks/chip/nacho/salsa // CHOMPEdit - Removal of obj/item/weapon
	chiptrans = /obj/item/reagent_containers/food/snacks/chip/salsa // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "dip_salsa"
	nutriment_desc = list("salsa" = 20)
	nutriment_amt = 20

/obj/item/reagent_containers/food/snacks/dip/guac // CHOMPEdit - Removal of obj/item/weapon
	name = "guac dip"
	...
	nachotrans = /obj/item/reagent_containers/food/snacks/chip/nacho/guac // CHOMPEdit - Removal of obj/item/weapon
	chiptrans = /obj/item/reagent_containers/food/snacks/chip/guac // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "dip_guac"
...
/obj/item/reagent_containers/food/snacks/fuegoburrito // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/fuegoburrito/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("capsaicin", 4)
...
/obj/item/reagent_containers/food/snacks/meatburrito/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)
...
/obj/item/reagent_containers/food/snacks/cheeseburrito/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)
...
/obj/item/reagent_containers/food/snacks/eggroll/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)

/obj/item/reagent_containers/food/snacks/burrito // CHOMPEdit - Removal of obj/item/weapon
	name = "chilli burrito"
...
/obj/item/reagent_containers/food/snacks/burrito/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)

/obj/item/reagent_containers/food/snacks/burrito_spicy // CHOMPEdit - Removal of obj/item/weapon
	name = "spicy burrito"
...
/obj/item/reagent_containers/food/snacks/burrito_spicy/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)

/obj/item/reagent_containers/food/snacks/burrito_cheese // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/burrito_cheese/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)

/obj/item/reagent_containers/food/snacks/burrito_cheese_spicy // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/burrito_cheese_spicy/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)

/obj/item/reagent_containers/food/snacks/burrito_vegan // CHOMPEdit - Removal of obj/item/weapon
	name = "vegan burrito"
...
/obj/item/reagent_containers/food/snacks/burrito_vegan/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("tofu", 6)

/obj/item/reagent_containers/food/snacks/breakfast_wrap // CHOMPEdit - Removal of obj/item/weapon
	name = "breakfast wrap"
...
/obj/item/reagent_containers/food/snacks/burrito_mystery // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/burrito_hell // CHOMPEdit - Removal of obj/item/weapon
	name = "el diablo"
...
/obj/item/reagent_containers/food/snacks/burrito_hell/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/hatchling_suprise // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/hatchling_suprise/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("egg", 2)
	reagents.add_reagent("protein", 4)

/obj/item/reagent_containers/food/snacks/red_sun_special // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/red_sun_special/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)

/obj/item/reagent_containers/food/snacks/riztizkzi_sea // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/riztizkzi_sea/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("egg", 4)

/obj/item/reagent_containers/food/snacks/father_breakfast // CHOMPEdit - Removal of obj/item/weapon
	name = "breakfast of champions"
	desc = "A sausage and an omelette on top of a grilled steak."
	icon_state = "father_breakfast"
	trash = /obj/item/trash/plate

/obj/item/reagent_containers/food/snacks/father_breakfast/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("egg", 4)
	reagents.add_reagent("protein", 6)

/obj/item/reagent_containers/food/snacks/stuffed_meatball // CHOMPEdit - Removal of obj/item/weapon
	name = "stuffed meatball" //YES
	desc = "A meatball loaded with cheese."
	icon_state = "stuffed_meatball"
	trash = /obj/item/trash/small_bowl

/obj/item/reagent_containers/food/snacks/stuffed_meatball/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)

/obj/item/reagent_containers/food/snacks/egg_pancake // CHOMPEdit - Removal of obj/item/weapon
	name = "meat pancake"
...
/obj/item/reagent_containers/food/snacks/egg_pancake/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)
	reagents.add_reagent("egg", 2)

/obj/item/reagent_containers/food/snacks/redcurry // CHOMPEdit - Removal of obj/item/weapon
	name = "red curry"
	gender = PLURAL
...
/obj/item/reagent_containers/food/snacks/redcurry/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 7)

/obj/item/reagent_containers/food/snacks/greencurry // CHOMPEdit - Removal of obj/item/weapon
	name = "green curry"
	gender = PLURAL
...
/obj/item/reagent_containers/food/snacks/greencurry/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 1)
	reagents.add_reagent("capsaicin", 2)

/obj/item/reagent_containers/food/snacks/yellowcurry // CHOMPEdit - Removal of obj/item/weapon
	name = "yellow curry"
	gender = PLURAL
...
/obj/item/reagent_containers/food/snacks/yellowcurry/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)

/obj/item/reagent_containers/food/snacks/bearburger // CHOMPEdit - Removal of obj/item/weapon
	name = "bearburger"
...
/obj/item/reagent_containers/food/snacks/bearburger/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4) //So spawned burgers will not be empty I guess?

/obj/item/reagent_containers/food/snacks/bibimbap // CHOMPEdit - Removal of obj/item/weapon
	name = "bibimbap bowl"
...
/obj/item/reagent_containers/food/snacks/bibimbap/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 10)

/obj/item/reagent_containers/food/snacks/lomein // CHOMPEdit - Removal of obj/item/weapon
	name = "lo mein"
	gender = PLURAL
...
/obj/item/reagent_containers/food/snacks/lomein/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)

/obj/item/reagent_containers/food/snacks/friedrice // CHOMPEdit - Removal of obj/item/weapon
	name = "fried rice"
	gender = PLURAL
...
/obj/item/reagent_containers/food/snacks/chickenfillet // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/chickenfillet/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 8)

/obj/item/reagent_containers/food/snacks/friedmushroom // CHOMPEdit - Removal of obj/item/weapon
	name = "fried mushroom"
...
/obj/item/reagent_containers/food/snacks/friedmushroom/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)

/obj/item/reagent_containers/food/snacks/pisanggoreng // CHOMPEdit - Removal of obj/item/weapon
	name = "pisang goreng"
	gender = PLURAL
...
/obj/item/reagent_containers/food/snacks/pisanggoreng/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 1)

/obj/item/reagent_containers/food/snacks/meatbun // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/meatbun/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)
...
/obj/item/reagent_containers/food/snacks/spicedmeatbun/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)
...
/obj/item/reagent_containers/food/snacks/chickenmomo // CHOMPEdit - Removal of obj/item/weapon
	name = "chicken momo"
	gender = PLURAL
...
/obj/item/reagent_containers/food/snacks/chickenmomo/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)

/obj/item/reagent_containers/food/snacks/veggiemomo // CHOMPEdit - Removal of obj/item/weapon
	name = "veggie momo"
	gender = PLURAL
...
/obj/item/reagent_containers/food/snacks/veggiemomo/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 2)

/obj/item/reagent_containers/food/snacks/risotto // CHOMPEdit - Removal of obj/item/weapon
	name = "risotto"
	gender = PLURAL
...
/obj/item/reagent_containers/food/snacks/risotto/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 1)

/obj/item/reagent_containers/food/snacks/risottoballs // CHOMPEdit - Removal of obj/item/weapon
	name = "risotto balls"
	gender = PLURAL
...
/obj/item/reagent_containers/food/snacks/poachedegg/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 3)
	reagents.add_reagent("blackpepper", 1)

/obj/item/reagent_containers/food/snacks/ribplate // CHOMPEdit - Removal of obj/item/weapon
	name = "plate of ribs"
...
/obj/item/reagent_containers/food/snacks/ribplate/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)
...
/obj/item/reagent_containers/food/snacks/omurice // CHOMPEdit - Removal of obj/item/weapon
	name = "omelette rice"
...
/obj/item/reagent_containers/food/snacks/omurice/heart // CHOMPEdit - Removal of obj/item/weapon
	icon = 'icons/obj/food.dmi'
	icon_state = "omuriceheart"

/obj/item/reagent_containers/food/snacks/omurice/face // CHOMPEdit - Removal of obj/item/weapon
	icon = 'icons/obj/food.dmi'
	icon_state = "omuriceface"

/obj/item/reagent_containers/food/snacks/cinnamonbun // CHOMPEdit - Removal of obj/item/weapon
	name = "cinnamon bun"
...
/obj/item/reagent_containers/food/snacks/mint // CHOMPEdit - Removal of obj/item/weapon
	name = "mint"
...
/obj/item/reagent_containers/food/snacks/mint/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/storage/box/admints // CHOMPEdit - Removal of obj/item/weapon
	...
	w_class = 1
	starts_with = list(/obj/item/reagent_containers/food/snacks/mint/admints = 6) // CHOMPEdit - Removal of obj/item/weapon
	can_hold = list(/obj/item/reagent_containers/food/snacks/mint/admints) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/candy/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 3)

/obj/item/reagent_containers/food/snacks/namagashi // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/namagashi/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 2)
...
/obj/item/reagent_containers/food/snacks/candy/proteinbar/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)
...
/obj/item/reagent_containers/food/snacks/candy/gummy/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 5)
...
/obj/item/reagent_containers/food/snacks/fruitbar/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 4)
...
/obj/item/reagent_containers/food/snacks/cb01/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/cb02/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 1)
...
/obj/item/reagent_containers/food/snacks/cb03/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 1)
...
/obj/item/reagent_containers/food/snacks/cb04/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 1)
...
/obj/item/reagent_containers/food/snacks/cb05/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 3)
...
/obj/item/reagent_containers/food/snacks/cb06/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 1)
...
/obj/item/reagent_containers/food/snacks/cb07/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 1)
...
/obj/item/reagent_containers/food/snacks/cb08/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 2)
...
/obj/item/reagent_containers/food/snacks/cb09/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 1)
...
/obj/item/reagent_containers/food/snacks/cb10/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 1)
	reagents.add_reagent("protein", 1)
	reagents.add_reagent("peanutoil", 1)
...
/obj/item/reagent_containers/food/snacks/chips/snv // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sosjerky/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. =..()
	reagents.add_reagent("protein", 8)
...
/obj/item/reagent_containers/food/snacks/tuna/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)
...
/obj/item/reagent_containers/food/snacks/squid // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/squid/true/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)

/obj/item/reagent_containers/food/snacks/croutons // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/salo/true/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 8)

/obj/item/reagent_containers/food/snacks/driedfish // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper Vobla"
	icon = 'icons/obj/food_snacks.dmi'
...
/obj/item/reagent_containers/food/snacks/driedfish/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	.=..()
	reagents.add_reagent("protein", 4)
...
///obj/item/reagent_containers/food/snacks/spacetwinkie (Commented out to replace with packaged version 04/14/2021) // CHOMPEdit - Removal of obj/item/weapon
...
//	bitesize = 2
//
///obj/item/reagent_containers/food/snacks/spacetwinkie/Initialize() // CHOMPEdit - Removal of obj/item/weapon
//	. = ..()
//	reagents.add_reagent("sugar", 4)
...
/obj/item/reagent_containers/food/snacks/syndicake // CHOMPEdit - Removal of obj/item/weapon
	name = "Syndi-Cakes"
	icon = 'icons/obj/food_snacks.dmi'
...
/obj/item/reagent_containers/food/snacks/syndicake/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("doctorsdelight", 5)

////////////////////sol_vend (Mars Mart)////////////////////////////////////////////////////

/obj/item/reagent_containers/food/snacks/triton // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/saturn // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/jupiter // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/pluto // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/mars // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/venus // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/venus/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	.=..()
	reagents.add_reagent("capsaicin", 5)

/obj/item/reagent_containers/food/snacks/sun_snax // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/sun_snax/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	.=..()
	reagents.add_reagent("capsaicin", 6)

/obj/item/reagent_containers/food/snacks/oort // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/oort/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	.=..()
	reagents.add_reagent("frostoil",5)

/obj/item/reagent_containers/food/snacks/pretzels // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/hakarl // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/dorayaki // CHOMPEdit - Removal of obj/item/weapon
	name = "dorayaki"
	icon = 'icons/obj/food_snacks.dmi'
	icon_state = "dorayaki"
...
/obj/item/reagent_containers/food/snacks/daifuku // CHOMPEdit - Removal of obj/item/weapon
	name = "daifuku"
	icon = 'icons/obj/food_snacks.dmi'
	icon_state = "daifuku"
...
/obj/item/reagent_containers/food/snacks/weebonuts/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	.=..()
	reagents.add_reagent("capsaicin",1)

/obj/item/reagent_containers/food/snacks/wasabi_peas // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/wasabi_peas/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	.=..()
	reagents.add_reagent("capsaicin",1)

/obj/item/reagent_containers/food/snacks/chocobanana // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/chocobanana/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	.=..()
	reagents.add_reagent("sprinkles", 10)

/obj/item/reagent_containers/food/snacks/goma_dango // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/hanami_dango // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/old // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/old/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	.=..()
...
/obj/item/reagent_containers/food/snacks/old/pizza // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper Pizza!"
	desc = "It's so stale you could probably cut something with the cheese."
	icon_state = "ancient_pizza"

/obj/item/reagent_containers/food/snacks/old/burger // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper Giga Burger!"
	desc = "At some point in time this probably looked delicious."
	icon_state = "ancient_burger"

/obj/item/reagent_containers/food/snacks/old/horseburger // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/old/fries // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/old/taco // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper Taco!"
...
/obj/item/reagent_containers/food/snacks/canned // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/canned/beef // CHOMPEdit - Removal of obj/item/weapon
	name = "canned beef"
	icon_state = "beef"
...
/obj/item/reagent_containers/food/snacks/canned/beef/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	.=..()
	reagents.add_reagent("protein", 4)
	reagents.add_reagent("sodiumchloride", 2)

/obj/item/reagent_containers/food/snacks/canned/beans // CHOMPEdit - Removal of obj/item/weapon
	name = "baked beans"
	icon_state = "beans"
...
/obj/item/reagent_containers/food/snacks/canned/beans/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	.=..()
	reagents.add_reagent("bean_protein", 5)
	reagents.add_reagent("tomatojuice", 5)

/obj/item/reagent_containers/food/snacks/canned/tomato // CHOMPEdit - Removal of obj/item/weapon
	name = "tomato soup"
	icon_state = "tomato"
...
/obj/item/reagent_containers/food/snacks/canned/tomato/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	.=..()
	reagents.add_reagent("tomato_soup", 12)

/obj/item/reagent_containers/food/snacks/canned/spinach // CHOMPEdit - Removal of obj/item/weapon
	name = "spinach"
	icon_state = "spinach"
...
/obj/item/reagent_containers/food/snacks/canned/spinach/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	.=..()
...
/obj/item/reagent_containers/food/snacks/canned/caviar // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/canned/caviar/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("seafood", 5)

/obj/item/reagent_containers/food/snacks/canned/caviar/true // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/canned/caviar/true/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("seafood", 4)
	reagents.add_reagent("carpotoxin", 1)

/obj/item/reagent_containers/food/snacks/canned/maps // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper MAPS"
	icon_state = "maps"
...
/obj/item/reagent_containers/food/snacks/canned/maps/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 6)
	reagents.add_reagent("sodiumchloride", 2)

/obj/item/reagent_containers/food/snacks/canned/appleberry // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/canned/appleberry/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("milk", 8)
	reagents.add_reagent("sugar", 5)

/obj/item/reagent_containers/food/snacks/canned/ntbeans // CHOMPEdit - Removal of obj/item/weapon
	name = "baked beans"
	icon_state = "ntbeans"
...
/obj/item/reagent_containers/food/snacks/canned/ntbeans/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("bean_protein", 6)
	reagents.add_reagent("protein", 2)

/obj/item/reagent_containers/food/snacks/canned/brainzsnax // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/canned/brainzsnax/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent(brainmeat, 10)

/obj/item/reagent_containers/food/snacks/canned/brainzsnax/red // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/packaged // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/packaged/spacetwinkie/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 4)

/obj/item/reagent_containers/food/snacks/packaged/genration // CHOMPEdit - Removal of obj/item/weapon
	name = "generic ration"
...
/obj/item/reagent_containers/food/snacks/packaged/meatration // CHOMPEdit - Removal of obj/item/weapon
	name = "meat ration"
...
/obj/item/reagent_containers/food/snacks/packaged/meatration/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("protein", 4)

/obj/item/reagent_containers/food/snacks/packaged/vegration // CHOMPEdit - Removal of obj/item/weapon
	name = "veggie ration"
...
/obj/item/reagent_containers/food/snacks/packaged/sweetration // CHOMPEdit - Removal of obj/item/weapon
	name = "desert ration"
...
/obj/item/reagent_containers/food/snacks/packaged/sweetration/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sugar", 6)

/obj/item/reagent_containers/food/snacks/packaged/vendburger // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/packaged/vendburger/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sodiumchloride", 1)

/obj/item/reagent_containers/food/snacks/packaged/vendhotdog // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/packaged/vendhotdog/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sodiumchloride", 1)

/obj/item/reagent_containers/food/snacks/packaged/vendburrito // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/packaged/vendburrito/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("sodiumchloride", 1)
