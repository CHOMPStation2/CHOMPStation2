...
/obj/item/reagent_containers/food/verb/change_name() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/proc/handle_name_change(var/mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if ((center_of_mass_x || center_of_mass_y) && !pixel_x && !pixel_y) //CHOMPEdit
		src.pixel_x = rand(-6.0, 6) //Randomizes postion
		src.pixel_y = rand(-6.0, 6)

/obj/item/reagent_containers/food/afterattack(atom/A, mob/user, proximity, params) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/container_resist(mob/living/M) // CHOMPEdit - Removal of obj/item/weapon
