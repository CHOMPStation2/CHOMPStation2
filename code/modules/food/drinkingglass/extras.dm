/obj/item/reagent_containers/food/drinks/glass2/attackby(obj/item/I as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(istype(I, /obj/item/glass_extra)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/glass_extra/GE = I // CHOMPEdit - Removal of obj/item/weapon
		if(can_add_extra(GE))
			extras += GE
		...
		if(!rim_pos)
			...
			return
		var/obj/item/reagent_containers/food/snacks/fruit_slice/FS = I // CHOMPEdit - Removal of obj/item/weapon
		extras += FS
...
/obj/item/reagent_containers/food/drinks/glass2/attack_hand(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/glass_extra/stick // CHOMPEdit - Removal of obj/item/weapon
	name = "stick"
...
/obj/item/glass_extra/straw // CHOMPEdit - Removal of obj/item/weapon
	name = "straw"
	desc = "This goes in a glass."
...
/obj/item/glass_extra/straw/afterattack(atom/target, mob/user, proximity_flag, click_parameters) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/glass_extra/straw/proc/sipp_mob(mob/living/victim, mob/user, reagent_type = "nutriment") // CHOMPEdit - Removal of obj/item/weapon
	if(victim.health <= 0)
