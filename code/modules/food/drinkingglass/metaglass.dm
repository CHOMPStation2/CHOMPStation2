/obj/item/reagent_containers/food/drinks/metaglass // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/metaglass/metapint // CHOMPEdit - Removal of obj/item/weapon
	name = "metamorphic pint glass"
	desc = "This glass changes shape and form depending on the drink inside... fancy!"
	icon_state = "pglass_empty"
	volume = 60

/obj/item/reagent_containers/food/drinks/metaglass/on_reagent_change() // CHOMPEdit - Removal of obj/item/weapon
	if (reagents.reagent_list.len > 0)
		...
		if(type == /obj/item/reagent_containers/food/drinks/metaglass/metapint) // CHOMPEdit - Removal of obj/item/weapon
			icon_state = "pglass_empty"
			name = "metamorphic pint glass"
			desc = "This glass changes shape and form depending on the drink inside... fancy!"
			center_of_mass_x = 16 //CHOMPEdit
