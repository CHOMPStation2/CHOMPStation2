...
/obj/item/reagent_containers/food/drinks/glass2 // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/glass2/examine(mob/M as mob) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()

	for(var/I in extras)
		if(istype(I, /obj/item/glass_extra)) // CHOMPEdit - Removal of obj/item/weapon
			. += "There is \a [I] in \the [src]."
		else if(istype(I, /obj/item/reagent_containers/food/snacks/fruit_slice)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/glass2/proc/has_ice() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/glass2/proc/has_fizz() // CHOMPEdit - Removal of obj/item/weapon
	if(reagents.reagent_list.len > 0)
		var/datum/reagent/R = reagents.get_master_reagent()
...
/obj/item/reagent_containers/food/drinks/glass2/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	icon_state = base_icon

/obj/item/reagent_containers/food/drinks/glass2/on_reagent_change() // CHOMPEdit - Removal of obj/item/weapon
	..()
	update_icon()

/obj/item/reagent_containers/food/drinks/glass2/proc/can_add_extra(obj/item/glass_extra/GE) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/glass2/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	underlays.Cut()
	...
	for(var/item in extras)
		if(istype(item, /obj/item/glass_extra)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/glass_extra/GE = item // CHOMPEdit - Removal of obj/item/weapon
			var/image/I = image(icon, src, "[base_icon]_[GE.glass_addition][side]") //VOREStation Edit
			if(GE.glass_color)
				I.color = GE.glass_color
			underlays += I
		else if(istype(item, /obj/item/reagent_containers/food/snacks/fruit_slice)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/FS = item
...
/obj/item/reagent_containers/food/drinks/glass2/afterattack(var/obj/target, var/mob/user, var/proximity) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/drinks/glass2/standard_feed_mob(var/mob/user, var/mob/target) // CHOMPEdit - Removal of obj/item/weapon
