...
/datum/custom_item/proc/apply_to_item(var/obj/item/item)
	...
	if(istype(item, /obj/item/kit)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/kit/K = item // CHOMPEdit - Removal of obj/item/device
...
/proc/equip_custom_items(mob/living/carbon/human/M)
	...
	for(var/datum/custom_item/citem in key_list)
		...
		var/obj/item/card/id/current_id = M.wear_id // CHOMPEdit - Removal of obj/item/weapon
		...
		if(citem.item_path == /obj/item/card/id && istype(current_id)) //Set earlier. // CHOMPEdit - Removal of obj/item/weapon
			existing_item = M.wear_id
		else if(citem.item_path == /obj/item/pda) // CHOMPEdit - Removal of obj/item/device
			existing_item = locate(/obj/item/pda) in M.contents // CHOMPEdit - Removal of obj/item/device
		else if(citem.item_path == /obj/item/storage/backpack) // CHOMPEdit - Removal of obj/item/weapon
			existing_item = locate(/obj/item/storage/backpack) in M.contents // CHOMPEdit - Removal of obj/item/weapon
