...
/obj/machinery/seed_storage/attackby(var/obj/item/O as obj, var/mob/user as mob)
	if (istype(O, /obj/item/seeds) && !lockdown)
		...
		return
	else if (istype(O, /obj/item/storage/bag/plants) && !lockdown) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/storage/P = O // CHOMPEdit - Removal of obj/item/weapon
		var/loaded = 0
	...
	else if((O.has_tool_quality(TOOL_WIRECUTTER) || istype(O, /obj/item/multitool)) && panel_open) // CHOMPEdit - Removal of obj/item/device
		wires.Interact(user)
...
/obj/machinery/seed_storage/proc/add(var/obj/item/seeds/O as obj, var/contraband = 0)
	...
	else if(istype(O.loc,/obj/item/storage)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/storage/S = O.loc // CHOMPEdit - Removal of obj/item/weapon
