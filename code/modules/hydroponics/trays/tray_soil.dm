...
/obj/machinery/portable_atmospherics/hydroponics/soil/attackby(var/obj/item/O as obj, var/mob/user as mob)
	if(istype(O,/obj/item/tank)) // CHOMPEdit - Removal of obj/item/weapon
		return
	if(istype(O,/obj/item/shovel)) // CHOMPEdit - Removal of obj/item/weapon
		if(!seed)
...
/obj/machinery/portable_atmospherics/hydroponics/soil/attackby(obj/item/O, mob/user)
	if(istype(O, /obj/item/shovel) && user.a_intent == I_HURT) // CHOMPEdit - Removal of obj/item/weapon
