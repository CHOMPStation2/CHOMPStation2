...
/obj/machinery/portable_atmospherics/hydroponics/attackby(var/obj/item/O as obj, var/mob/user as mob)
	...
	if(O.has_tool_quality(TOOL_WIRECUTTER) || istype(O, /obj/item/surgical/scalpel)) // CHOMPEdit - Removal of obj/item/weapon
	...
	else if(istype(O, /obj/item/reagent_containers/syringe)) // CHOMPEdit - Removal of obj/item/weapon

		var/obj/item/reagent_containers/syringe/S = O // CHOMPEdit - Removal of obj/item/weapon
	...
	else if (istype(O, /obj/item/material/minihoe))  // The minihoe // CHOMPEdit - Removal of obj/item/weapon
		...
		var/obj/item/storage/bag/plants/S = O // CHOMPEdit - Removal of obj/item/weapon
		for (var/obj/item/reagent_containers/food/snacks/grown/G in locate(user.x,user.y,user.z)) // CHOMPEdit - Removal of obj/item/weapon
			if(!S.can_be_inserted(G))
				return
			S.handle_item_insertion(G, 1)

	else if ( istype(O, /obj/item/plantspray) ) // CHOMPEdit - Removal of obj/item/weapon

		var/obj/item/plantspray/spray = O // CHOMPEdit - Removal of obj/item/weapon
		user.remove_from_mob(O)
	...
	else if(istype(O,/obj/item/multitool)) // CHOMPEdit - Removal of obj/item/device
		if(!anchored)
