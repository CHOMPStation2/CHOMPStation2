//Grown foods.
/obj/item/reagent_containers/food/snacks/grown // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/grown/Initialize(var/mapload, var/planttype) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/grown/proc/update_desc() // CHOMPEdit - Removal of obj/item/weapon
	if(!seed)
		return
...
/obj/item/reagent_containers/food/snacks/grown/update_icon() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/grown/Crossed(var/mob/living/M) // CHOMPEdit - Removal of obj/item/weapon
	if(M.is_incorporeal())
		return
...
/obj/item/reagent_containers/food/snacks/grown/throw_impact(atom/hit_atom) // CHOMPEdit - Removal of obj/item/weapon
	if(seed) seed.thrown_at(src,hit_atom)
	..()

/obj/item/reagent_containers/food/snacks/grown/attackby(var/obj/item/W, var/mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(seed)
		if(seed.get_trait(TRAIT_PRODUCES_POWER) && istype(W, /obj/item/stack/cable_coil))
			...
			if(C.use(5))
				...
				var/obj/item/cell/potato/pocell = new /obj/item/cell/potato(get_turf(user)) // CHOMPEdit - Removal of obj/item/weapon
		...
		if(W.sharp)
			...
			if(seed.chems)
				...
				if(!isnull(seed.chems["carrotjuice"]))
					to_chat(user, "<span class='filter_notice'>You slice \the [src] into sticks.</span>")
					new /obj/item/reagent_containers/food/snacks/carrotfries(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
					qdel(src)
					return

				if(!isnull(seed.chems["pineapplejuice"]))
					to_chat(user, "<span class='filter_notice'>You slice \the [src] into rings.</span>")
					new /obj/item/reagent_containers/food/snacks/pineapple_ring(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
					qdel(src)
					return

				if(!isnull(seed.chems["soymilk"]))
					to_chat(user, "<span class='filter_notice'>You roughly chop up \the [src].</span>")
					new /obj/item/reagent_containers/food/snacks/soydope(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
					qdel(src)
					return
				...
				if(seed.get_trait(TRAIT_FLESH_COLOUR))
					...
					for(var/i=1; i<=slices; i++)
						var/obj/item/reagent_containers/food/snacks/fruit_slice/F = new(get_turf(src),seed) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/grown/apply_hit_effect(mob/living/target, mob/living/user, var/hit_zone) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/grown/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/grown/pickup(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(!seed)
		return
	if(seed.get_trait(TRAIT_STINGS))
...
/obj/item/reagent_containers/food/snacks/grown/mushroom/libertycap // CHOMPEdit - Removal of obj/item/weapon
	plantname = "libertycap"

/obj/item/reagent_containers/food/snacks/grown/ambrosiavulgaris // CHOMPEdit - Removal of obj/item/weapon
	plantname = "ambrosia"

/obj/item/reagent_containers/food/snacks/fruit_slice // CHOMPEdit - Removal of obj/item/weapon
	name = "fruit slice"
...
/obj/item/reagent_containers/food/snacks/fruit_slice/New(var/newloc, var/datum/seed/S) // CHOMPEdit - Removal of obj/item/weapon
	..(newloc)
