...
/obj/machinery/beehive/attackby(var/obj/item/I, var/mob/user)
	if(I.has_tool_quality(TOOL_CROWBAR))
		...
		update_icon()
		return
	else if(istype(I, /obj/item/analyzer/plant_analyzer)) // CHOMPEdit - Removal of obj/item/device
...
/obj/machinery/honey_extractor/attackby(var/obj/item/I, var/mob/user)
	...
	else if(istype(I, /obj/item/reagent_containers/glass)) // CHOMPEdit - Removal of obj/item/weapon
		if(!honey)
