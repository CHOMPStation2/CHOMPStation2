...
/obj/item/nailpolish // CHOMPEdit - Removal of obj/item/weapon
	name = "nail polish"
...
/obj/item/nailpolish/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/nailpolish/proc/set_colour(var/_colour) // CHOMPEdit - Removal of obj/item/weapon
	colour = _colour
	desc = "<font color='[colour]'>Nail polish,</font> " + initial(desc)
	update_icon()

/obj/item/nailpolish/attack_self(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	open = !open
	to_chat(user, SPAN_NOTICE("You [open ? "open" : "close"] \the [src]."))
	update_icon()

/obj/item/nailpolish/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/nailpolish/attack(var/mob/user, var/mob/living/carbon/human/target) // CHOMPEdit - Removal of obj/item/weapon
	if(!open)
		return
...
/obj/item/nailpolish_remover // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/nailpolish_remover/attack_self(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	open = !open
	to_chat(user, SPAN_NOTICE("You [open ? "open" : "close"] \the [src]."))
	update_icon()

/obj/item/nailpolish_remover/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	icon_state = "[initial(icon_state)][open ? "-open" : ""]"

/obj/item/nailpolish_remover/attack(var/mob/user, var/mob/living/carbon/human/target) // CHOMPEdit - Removal of obj/item/weapon
	if(!open)
		return
