...
/obj/item/integrated_circuit/tgui_host(mob/user)
	if(istype(loc, /obj/item/electronic_assembly)) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/integrated_circuit/tgui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state)
	...
	switch(action)
		...
		if("wire", "pin_name", "pin_data", "pin_unwire")
			if(istype(held_item, /obj/item/multitool) && allow_multitool) // CHOMPEdit - Removal of obj/item/device
				var/obj/item/multitool/M = held_item // CHOMPEdit - Removal of obj/item/device
				switch(action)
					if("pin_name")
						M.wire(pin, usr)
					if("pin_data")
			...
			else if(istype(held_item, /obj/item/integrated_electronics/wirer)) // CHOMPEdit - Removal of obj/item/device
				var/obj/item/integrated_electronics/wirer/wirer = held_item // CHOMPEdit - Removal of obj/item/device
				if(linked)
					wirer.wire(linked, usr)
				else if(pin)
					wirer.wire(pin, usr)

			else if(istype(held_item, /obj/item/integrated_electronics/debugger)) // CHOMPEdit - Removal of obj/item/device
				var/obj/item/integrated_electronics/debugger/debugger = held_item // CHOMPEdit - Removal of obj/item/device
				if(pin)
...
/obj/item/integrated_circuit/proc/remove(mob/user)
	var/obj/item/electronic_assembly/A = assembly // CHOMPEdit - Removal of obj/item/device
	if(!A)
	...
	if(!removable)
		...
		return
	var/obj/item/electronic_assembly/ea = loc // CHOMPEdit - Removal of obj/item/device
