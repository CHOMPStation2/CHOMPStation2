...
/obj/item/integrated_electronics/detailer/Initialize() // CHOMPEdit - Removal of obj/item/device
	update_icon()
	return ..()

/obj/item/integrated_electronics/detailer/update_icon() // CHOMPEdit - Removal of obj/item/device
	cut_overlays()
...
/obj/item/integrated_electronics/detailer/tgui_state(mob/user) // CHOMPEdit - Removal of obj/item/device
	return GLOB.tgui_inventory_state

/obj/item/integrated_electronics/detailer/tgui_interact(mob/user, datum/tgui/ui, datum/tgui/parent_ui) // CHOMPEdit - Removal of obj/item/device
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "ICDetailer", name)
		ui.open()

/obj/item/integrated_electronics/detailer/tgui_data(mob/user, datum/tgui/ui, datum/tgui_state/state) // CHOMPEdit - Removal of obj/item/device
	var/list/data = ..()
	data["detail_color"] = detail_color
	data["color_list"] = color_list
	return data

/obj/item/integrated_electronics/detailer/tgui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state) // CHOMPEdit - Removal of obj/item/device
	if(..())
		return TRUE
...
/obj/item/integrated_electronics/detailer/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
	tgui_interact(user)
