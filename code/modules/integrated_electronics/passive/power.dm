...
/obj/item/integrated_circuit/passive/power/metabolic_siphon/handle_passive_energy()
	...
	if(assembly && istype(assembly, /obj/item/electronic_assembly/implant)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/electronic_assembly/implant/implant_assembly = assembly // CHOMPEdit - Removal of obj/item/device
