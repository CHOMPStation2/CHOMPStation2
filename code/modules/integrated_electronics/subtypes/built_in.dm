...
/obj/item/integrated_circuit/built_in/device_output/do_work()
	if(istype(assembly, /obj/item/electronic_assembly/device)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/electronic_assembly/device/device = assembly // CHOMPEdit - Removal of obj/item/device
		device.holder.pulse()
