...
/datum/event2/event/pda_spam/event_tick()
	...
	for(var/obj/item/pda/check_pda in sortAtom(PDAs)) // CHOMPEdit - Removal of obj/item/device
...
/datum/event2/event/pda_spam/proc/send_spam(obj/item/pda/P, sender, message) // CHOMPEdit - Removal of obj/item/device
