...
/obj/item/book/codex // Vorestation Edits throughout this object. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/book/codex/Initialize() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/book/codex/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!tree)
		tree = codex_tree_keys["[root_type]"]
		if(!tree)
			tree = new(src, root_type)
...
/obj/item/book/codex/lore/vir // Vorestation Edits throughout this object. // CHOMPEdit - Removal of obj/item/weapon
	name = "The Traveler's Guide to Human Space: Borealis Edition" //YW Edit
	desc = "Contains useful information about the world around you.  It seems to have been written for travelers to the Borealis system, human or not. It also \
	has the words 'Don't Panic' in small, friendly letters on the cover." //YW Edit
	icon_state = "codex"
...
/obj/item/book/codex/lore/robutt // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/book/codex/lore/news // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/book/codex/corp_regs // CHOMPEdit - Removal of obj/item/weapon
