...
/obj/machinery/power/port_gen/pacman2
	...
	power_gen = 4500
	circuit = /obj/item/circuitboard/pacman2 // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/tank/phoron/P = null // CHOMPEdit - Removal of obj/item/weapon
	var/emagged = 0
	var/heat = 0
/*
	process()
...
*/
	...
	attackby(var/obj/item/O as obj, var/mob/user as mob)
		if(istype(O, /obj/item/tank/phoron)) // CHOMPEdit - Removal of obj/item/weapon
			if(P)
