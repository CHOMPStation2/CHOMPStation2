...
/obj/item/smes_coil/weak // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/power/smes/buildable/outpost_substation/Initialize()
	. = ..()
	component_parts += new /obj/item/smes_coil/weak(src) // CHOMPEdit - Removal of obj/item/weapon
	recalc_coils()
...
/obj/machinery/power/smes/buildable/power_shuttle/Initialize()
	. = ..()
	component_parts += new /obj/item/smes_coil/super_io(src) // CHOMPEdit - Removal of obj/item/weapon
	component_parts += new /obj/item/smes_coil/super_io(src) // CHOMPEdit - Removal of obj/item/weapon
	component_parts += new /obj/item/smes_coil(src) // CHOMPEdit - Removal of obj/item/weapon
	recalc_coils()
...
/obj/machinery/power/smes/buildable/proc/recalc_coils()
	if ((cur_coils <= max_coils) && (cur_coils >= 1))
		...
		input_level_max = 0
		output_level_max = 0
		for(var/obj/item/smes_coil/C in component_parts) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/power/smes/buildable/attackby(var/obj/item/W as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	...
	if (..())
		...
		else if(istype(W, /obj/item/smes_coil)) // CHOMPEdit - Removal of obj/item/weapon
