...
/obj/item/circuitboard/tesla_coil // CHOMPEdit - Removal of obj/item/weapon
	name = T_BOARD("tesla coil")
	build_path = /obj/machinery/power/tesla_coil
	board_type = new /datum/frame/frame_types/machine
	origin_tech = list(TECH_MAGNET = 2, TECH_POWER = 4)
	req_components = list(/obj/item/stock_parts/capacitor = 1) // CHOMPEdit - Removal of obj/item/weapon

/datum/design/circuit/tesla_coil
	name = "Machine Design (Tesla Coil Board)"
	desc = "The circuit board for a tesla coil."
	id = "tesla_coil"
	build_path = /obj/item/circuitboard/tesla_coil // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/circuitboard/grounding_rod // CHOMPEdit - Removal of obj/item/weapon
...
/datum/category_item/autolathe/engineering/grounding_rod
	...
	path = /obj/item/circuitboard/grounding_rod // CHOMPEdit - Removal of obj/item/weapon

// SPECIAL BOARDS BELOW

/obj/item/circuitboard/tesla_coil/attackby(obj/item/I as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
