...
/obj/machinery/power/solar/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/solar_assembly/attackby(var/obj/item/W, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if (!isturf(loc))
		return 0
	if(!anchored)
	...
	if(!tracker)
		if(istype(W, /obj/item/tracker_electronics)) // CHOMPEdit - Removal of obj/item/weapon
			tracker = 1
			user.drop_item()
			qdel(W)
		...
		if(W.has_tool_quality(TOOL_CROWBAR))
			new /obj/item/tracker_electronics(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			tracker = 0
	...
	if(I.has_tool_quality(TOOL_SCREWDRIVER))
		...
		if(do_after(user, 20))
			if (src.stat & BROKEN)
				...
				new /obj/item/material/shard( src.loc ) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/circuitboard/solar_control/M = new /obj/item/circuitboard/solar_control( A ) // CHOMPEdit - Removal of obj/item/weapon
