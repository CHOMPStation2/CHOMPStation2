...
/obj/item/am_shielding_container // CHOMPEdit - Removal of obj/item/device
...
/obj/item/am_shielding_container/attackby(var/obj/item/I, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	if(istype(I, /obj/item/multitool) && istype(src.loc,/turf)) // CHOMPEdit - Removal of obj/item/device
