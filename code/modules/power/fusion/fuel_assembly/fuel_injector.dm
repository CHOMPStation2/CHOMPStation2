...
/obj/machinery/fusion_fuel_injector
	...
	circuit = /obj/item/circuitboard/fusion_injector // CHOMPEdit - Removal of obj/item/weapon

	var/fuel_usage = 30
	var/id_tag
	var/injecting = 0
	var/obj/item/fuel_assembly/cur_assembly // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/fusion_fuel_injector/attackby(obj/item/W, mob/user)
	...
	if(istype(W, /obj/item/fuel_assembly)) // CHOMPEdit - Removal of obj/item/weapon

		if(injecting)
			to_chat(user, "<span class='warning'>Shut \the [src] off before playing with the fuel rod!</span>")
			return
		//CHOMPEdit Begin
		if(istype(W,/obj/item/fuel_assembly/blitz)) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(W.has_tool_quality(TOOL_WRENCH) || W.has_tool_quality(TOOL_SCREWDRIVER) || W.has_tool_quality(TOOL_CROWBAR) || istype(W, /obj/item/storage/part_replacer)) // CHOMPEdit - Removal of obj/item/weapon
		if(injecting)
