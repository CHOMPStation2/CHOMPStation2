/obj/item/circuitboard/fusion_core_control // CHOMPEdit - Removal of obj/item/weapon
	name = "circuit board (fusion core controller)"
	build_path = /obj/machinery/computer/fusion_core_control
	origin_tech = list(TECH_DATA = 4, TECH_ENGINEERING = 4)

/obj/item/circuitboard/fusion_fuel_compressor // CHOMPEdit - Removal of obj/item/weapon
	...
	req_components = list(
							/obj/item/stock_parts/manipulator/nano = 2, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/stock_parts/matter_bin/super = 2, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/stock_parts/console_screen = 1, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/stack/cable_coil = 5
							)

/obj/item/circuitboard/fusion_fuel_control // CHOMPEdit - Removal of obj/item/weapon
	name = "circuit board (fusion fuel controller)"
	build_path = /obj/machinery/computer/fusion_fuel_control
	origin_tech = list(TECH_DATA = 4, TECH_ENGINEERING = 4)

/obj/item/circuitboard/gyrotron_control // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/circuitboard/fusion_core // CHOMPEdit - Removal of obj/item/weapon
	...
	req_components = list(
							/obj/item/stock_parts/manipulator/nano = 2, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/stock_parts/micro_laser/high = 1, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/stock_parts/console_screen = 1, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/stack/cable_coil = 5
							)
...
/obj/item/circuitboard/fusion_injector // CHOMPEdit - Removal of obj/item/weapon
	...
	req_components = list(
							/obj/item/stock_parts/manipulator/nano = 2, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/stock_parts/scanning_module/adv = 1, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/stock_parts/matter_bin/super = 1, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/stock_parts/console_screen = 1, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/stack/cable_coil = 5
							)
...
/obj/item/circuitboard/gyrotron // CHOMPEdit - Removal of obj/item/weapon
	...
	req_components = list(
							/obj/item/stock_parts/scanning_module/adv = 1, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/stock_parts/micro_laser/high = 3, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/stock_parts/capacitor/adv = 1 // CHOMPEdit - Removal of obj/item/weapon
							)

/datum/design/circuit/fusion
	name = "fusion core control console"
	id = "fusion_core_control"
	build_path = /obj/item/circuitboard/fusion_core_control // CHOMPEdit - Removal of obj/item/weapon
	sort_string = "LAAAD"
...
/datum/design/circuit/fusion/fuel_compressor
	...
	build_path = /obj/item/circuitboard/fusion_fuel_compressor // CHOMPEdit - Removal of obj/item/weapon
	sort_string = "LAAAE"

/datum/design/circuit/fusion/fuel_control
	name = "fusion fuel control console"
	id = "fusion_fuel_control"
	build_path = /obj/item/circuitboard/fusion_fuel_control // CHOMPEdit - Removal of obj/item/weapon
	sort_string = "LAAAF"

/datum/design/circuit/fusion/gyrotron_control
	name = "gyrotron control console"
	id = "gyrotron_control"
	build_path = /obj/item/circuitboard/gyrotron_control // CHOMPEdit - Removal of obj/item/weapon
	sort_string = "LAAAG"

/datum/design/circuit/fusion/core
	name = "fusion core"
	id = "fusion_core"
	build_path = /obj/item/circuitboard/fusion_core // CHOMPEdit - Removal of obj/item/weapon
	sort_string = "LAAAH"

/datum/design/circuit/fusion/injector
	name = "fusion fuel injector"
	id = "fusion_injector"
	build_path = /obj/item/circuitboard/fusion_injector // CHOMPEdit - Removal of obj/item/weapon
	sort_string = "LAAAI"
