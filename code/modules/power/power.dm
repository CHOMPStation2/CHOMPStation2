...
/obj/machinery/power/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/power/default_unfasten_wrench(var/mob/user, var/obj/item/W, var/time = 20) // CHOMPEdit - Removal of obj/item/weapon
	if((. = ..()))
		if(anchored)
			connect_to_network()
		else
...
/proc/electrocute_mob(mob/living/M as mob, var/power_source, var/obj/source, var/siemens_coeff = 1.0)
	...
	if(istype(power_source,/datum/powernet))
		PN = power_source
	else if(istype(power_source,/obj/item/cell)) // CHOMPEdit - Removal of obj/item/weapon
		cell = power_source
