...
/obj/machinery/compressor
	...
	circuit = /obj/item/circuitboard/machine/power_compressor // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/power/turbine
	...
	anchored = TRUE
	density = TRUE
	circuit = /obj/item/circuitboard/machine/power_turbine // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/turbine_computer
	...
	circuit = /obj/item/circuitboard/turbine_control // CHOMPEdit - Removal of obj/item/weapon
	var/obj/machinery/compressor/compressor
	var/list/obj/machinery/door/blast/doors
	var/id = 0
	var/door_status = 0

/obj/item/circuitboard/machine/power_compressor // CHOMPEdit - Removal of obj/item/weapon
	name = T_BOARD("power compressor")
	build_path = /obj/machinery/compressor
	board_type = new /datum/frame/frame_types/machine
	origin_tech = list(TECH_MATERIAL = 4, TECH_POWER = 2)
	req_components = list(/obj/item/stack/cable_coil = 5, /obj/item/stock_parts/manipulator = 6) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/circuitboard/machine/power_turbine // CHOMPEdit - Removal of obj/item/weapon
	name = T_BOARD("power turbine")
	build_path = /obj/machinery/power/turbine
	board_type = new /datum/frame/frame_types/machine
	origin_tech = list(TECH_ENGINEERING = 2, TECH_POWER = 4)
	req_components = list(/obj/item/stack/cable_coil = 5, /obj/item/stock_parts/capacitor = 6) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/compressor/attackby(obj/item/W, mob/user)
	...
	if(default_deconstruction_crowbar(user, W))
		return
	if(istype(W, /obj/item/multitool)) // CHOMPEdit - Removal of obj/item/device
...
/obj/machinery/compressor/default_unfasten_wrench(var/mob/user, var/obj/item/W, var/time = 20) // CHOMPEdit - Removal of obj/item/weapon
	if((. = ..()))
		turbine = null
		if(anchored)
			inturf = get_step(src, dir)
...
/obj/machinery/power/turbine/default_unfasten_wrench(var/mob/user, var/obj/item/W, var/time = 20) // CHOMPEdit - Removal of obj/item/weapon
	if((. = ..()))
		compressor = null
		if(anchored)
			outturf = get_step(src, dir)
