// The lighting system
//
// consists of light fixtures (/obj/machinery/light) and light tube/bulb items (/obj/item/light) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/light_construct/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	src.add_fingerprint(user)
	if(istype(W, /obj/item/cell/emergency_light)) // CHOMPEdit - Removal of obj/item/weapon
		if(!cell_connectors)
...
/obj/machinery/light
	...
	var/obj/item/light/installed_light //What light is currently in the socket! Updated in new() // CHOMPEdit - Removal of obj/item/weapon
	...
	var/flickering = 0
	var/light_type = /obj/item/light/tube		// the type of light item // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/cell/emergency_light/cell // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/light/small
	...
	light_type = /obj/item/light/bulb // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/light/flamp
	...
	layer = OBJ_LAYER
	desc = "A floor lamp."
	light_type = /obj/item/light/bulb/large // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/light/flamp/Initialize(mapload, obj/machinery/light_construct/construct = null)
	...
	if(construct)
		...
		if(start_with_cell && !no_emergency)
			cell = new/obj/item/cell/emergency_light(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/light/small/emergency
	light_type = /obj/item/light/bulb/red // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/light/spot
	name = "spotlight"
	light_type = /obj/item/light/tube/large // CHOMPEdit - Removal of obj/item/weapon
	shows_alerts = FALSE	//VOREStation Edit
...
/obj/machinery/light/Initialize(mapload, obj/machinery/light_construct/construct = null)
	...
	if(construct)
		...
		if(start_with_cell && !no_emergency)
			cell = new/obj/item/cell/emergency_light(src) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/light/L = get_light_type_instance(light_type) //This is fine, but old code. // CHOMPEdit - Removal of obj/item/weapon
		update_from_bulb(L)
...
/obj/machinery/light/proc/reset_alert()
	...
	current_alert = null
	var/obj/item/light/L = installed_light //This ensures any special bulbs will stay special! // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/light/proc/get_fitting_name()
	var/obj/item/light/L = light_type // CHOMPEdit - Removal of obj/item/weapon
	return initial(L.name)

/obj/machinery/light/proc/update_from_bulb(obj/item/light/L) // CHOMPEdit - Removal of obj/item/weapon
	status = L.status
...
/obj/machinery/light/proc/insert_bulb(obj/item/light/L) // CHOMPEdit - Removal of obj/item/weapon
	update_from_bulb(L)
	installed_light = L
...
/obj/machinery/light/attackby(obj/item/W, mob/user)
	...
	//Light replacer code
	if(istype(W, /obj/item/lightreplacer)) //These will never be modified, so it's fine to use old code. // CHOMPEdit - Removal of obj/item/device
		var/obj/item/lightreplacer/LR = W // CHOMPEdit - Removal of obj/item/device
		if(isliving(user))
	...
	if(istype(W, /obj/item/light)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/light/flamp/attackby(obj/item/W, mob/user)
	...
	if(!lamp_shade)
		if(istype(W, /obj/item/lampshade)) // CHOMPEdit - Removal of obj/item/weapon
			lamp_shade = 1
			qdel(W)
			update_icon()
			return
		...
		if(W.has_tool_quality(TOOL_SCREWDRIVER))
			...
			lamp_shade = 0
			new /obj/item/lampshade(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			update_icon()
			return
...
/obj/item/light/tube/large // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/light/bulb/large // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/light/throw_impact(atom/hit_atom) // CHOMPEdit - Removal of obj/item/weapon
	..()
	shatter()

/obj/item/light/bulb/red // CHOMPEdit - Removal of obj/item/weapon
	brightness_range = 4
	color = "#da0205"
	brightness_color = "#da0205"
	init_brightness_range = 4

/obj/item/light/bulb/fire // CHOMPEdit - Removal of obj/item/weapon
	name = "fire bulb"
...
/obj/item/light/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	switch(status)
		if(LIGHT_OK)
...
/obj/item/light/New(atom/newloc, obj/machinery/light/fixture = null) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(fixture)
...
/obj/item/light/attackby(var/obj/item/I, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..()
	...
	if(istype(I,/obj/item/multitool)) // CHOMPEdit - Removal of obj/item/device
		...
		var/obj/item/reagent_containers/syringe/S = I // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/light/afterattack(atom/target, mob/user, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!proximity) return
...
/obj/item/light/proc/shatter() // CHOMPEdit - Removal of obj/item/weapon
	if(status == LIGHT_OK || status == LIGHT_BURNED)
...
//Lamp Shade
/obj/item/lampshade // CHOMPEdit - Removal of obj/item/weapon
	name = "lamp shade"
