...
/obj/machinery/power/smes/batteryrack/proc/add_parts()
	...
	component_parts += new /obj/item/circuitboard/batteryrack // CHOMPEdit - Removal of obj/item/weapon
	component_parts += new /obj/item/stock_parts/capacitor				// Capacitors: Maximal I/O // CHOMPEdit - Removal of obj/item/weapon
	component_parts += new /obj/item/stock_parts/capacitor // CHOMPEdit - Removal of obj/item/weapon
	component_parts += new /obj/item/stock_parts/capacitor // CHOMPEdit - Removal of obj/item/weapon
	component_parts += new /obj/item/stock_parts/matter_bin				// Matter Bin: Max. amount of cells. // CHOMPEdit - Removal of obj/item/weapon

/obj/machinery/power/smes/batteryrack/RefreshParts()
	var/capacitor_efficiency = 0
	var/maxcells = 0
	for(var/obj/item/stock_parts/capacitor/CP in component_parts) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/power/smes/batteryrack/Destroy()
	for(var/obj/item/cell/C in internal_cells) // CHOMPEdit - Removal of obj/item/weapon
		qdel(C)
	internal_cells = null
	return ..()
...
/obj/machinery/power/smes/batteryrack/add_charge(var/amount)
	...
	if(equalise)
		...
		var/obj/item/cell/CL = get_least_charged_cell() // CHOMPEdit - Removal of obj/item/weapon
		if(!CL)
			return
...
/obj/machinery/power/smes/batteryrack/remove_charge(var/amount)
	...
	if(equalise)
		...
		var/obj/item/cell/CL = get_most_charged_cell() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/power/smes/batteryrack/proc/get_most_charged_cell()
	var/obj/item/cell/CL = null // CHOMPEdit - Removal of obj/item/weapon
	for(var/obj/item/cell/C in internal_cells) // CHOMPEdit - Removal of obj/item/weapon
		if(CL == null)
			CL = C
...
/obj/machinery/power/smes/batteryrack/proc/insert_cell(var/obj/item/cell/C, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(C))
		return 0
...
/obj/machinery/power/smes/batteryrack/process()
	...
	if(equalise)
		var/obj/item/cell/least = get_least_charged_cell() // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/cell/most = get_most_charged_cell() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/power/smes/batteryrack/attackby(var/obj/item/W as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/cell)) // ID Card, try to insert it. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/power/smes/batteryrack/tgui_act(action, list/params)
	...
	switch(action)
		...
		if("ejectcell")
			...
			for(var/obj/item/cell/CL in internal_cells) // CHOMPEdit - Removal of obj/item/weapon
