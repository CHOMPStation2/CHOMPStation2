...
/mob/proc/death(gibbed,deathmessage="seizes up and falls limp...")
	...
	if(src.loc && istype(loc,/obj/belly) || istype(loc,/obj/item/dogborg/sleeper) || istype(loc, /obj/item/clothing/shoes)) deathmessage = "no message" //VOREStation Add - Prevents death messages from inside mobs - CHOMPEdit: Added in-shoe as well // CHOMPEdit - Removal of obj/item/device
	facing_dir = null
