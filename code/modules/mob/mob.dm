...
||||||| parent of f1417f9455... Merge pull request #11560 from VOREStation/upstream-merge-8247
/mob/Destroy()//This makes sure that mobs withGLOB.clients/keys are not just deleted from the game.
	mob_list -= src
	dead_mob_list -= src
	living_mob_list -= src
...
/mob/proc/grab_ghost(force)
	if(mind)
		return mind.grab_ghost(force = force)
>>>>>>> f1417f9455... Merge pull request #11560 from VOREStation/upstream-merge-8247
