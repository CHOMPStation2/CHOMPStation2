...
/mob/proc/yank_out_object()
	...
	var/obj/item/selection = tgui_input_list(usr, "What do you want to yank out?", "Embedded objects", valid_objects) // CHOMPEdit - Removal of obj/item/weapon
	...
	for(var/obj/item/O in pinned) // CHOMPEdit - Removal of obj/item/weapon
		if(O == selection)
			pinned -= O
		if(!pinned.len)
			anchored = FALSE
