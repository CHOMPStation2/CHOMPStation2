...
/mob/living/carbon/human/assess_perp(var/obj/access_obj, var/check_access, var/auth_weapons, var/check_records, var/check_arrest)
	...
	if(id && istype(id, /obj/item/card/id/syndicate)) // CHOMPEdit - Removal of obj/item/weapon
		threatcount -= 2
	// A proper	CentCom id is hard currency.
	else if(id && istype(id, /obj/item/card/id/centcom)) // CHOMPEdit - Removal of obj/item/weapon
		return SAFE_PERP
	...
	if(auth_weapons && !access_obj.allowed(src))
		if(istype(l_hand, /obj/item/gun) || istype(l_hand, /obj/item/melee) && !istype(l_hand, /obj/item/gun/energy/floragun) && !istype(l_hand, /obj/item/gun/energy/sizegun) && !istype(l_hand, /obj/item/gun/launcher/confetti_cannon) && !istype(l_hand, /obj/item/gun/energy/lasertag)) //CHOMP Edit: Specific guns to the exclusion list. // CHOMPEdit - Removal of obj/item/weapon
			threatcount += 4

		if(istype(r_hand, /obj/item/gun) || istype(r_hand, /obj/item/melee)) // CHOMPEdit - Removal of obj/item/weapon
			threatcount += 4

		if(istype(belt, /obj/item/gun) || istype(belt, /obj/item/melee)) // CHOMPEdit - Removal of obj/item/weapon
			threatcount += 2
