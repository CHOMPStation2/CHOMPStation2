...
/mob/proc/say_understands(var/mob/other, var/datum/language/speaking = null)
	...
	if(speaking.flags & NONVERBAL)
		...
		if(istype(other.loc, /obj/item/holder)) // CHOMPEdit - Removal of obj/item/weapon
			if(istype(src.loc, /obj/item/holder)) // CHOMPEdit - Removal of obj/item/weapon
				if(!(other.loc in view(src.loc.loc)))
					return FALSE
			else if(!(other.loc in view(src)))
				return FALSE
		else if(istype(src.loc, /obj/item/holder)) // CHOMPEdit - Removal of obj/item/weapon
