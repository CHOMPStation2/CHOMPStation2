/obj/item/grab/proc/inspect_organ(mob/living/carbon/human/H, mob/user, var/target_zone) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/grab/proc/jointlock(mob/living/carbon/human/target, mob/attacker, var/target_zone) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/grab/proc/attack_eye(mob/living/carbon/human/target, mob/living/carbon/human/attacker) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(attacker))
		return
...
/obj/item/grab/proc/headbutt(mob/living/carbon/human/target, mob/living/carbon/human/attacker) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(attacker))
		return
	if(target.lying)
		return
...
/obj/item/grab/proc/dislocate(mob/living/carbon/human/target, mob/living/attacker, var/target_zone) // CHOMPEdit - Removal of obj/item/weapon
	if(state < GRAB_NECK)
		to_chat(attacker, "<span class='warning'>You require a better grab to do this.</span>")
		return
...
/obj/item/grab/proc/pin_down(mob/target, mob/attacker) // CHOMPEdit - Removal of obj/item/weapon
	if(state < GRAB_AGGRESSIVE)
		to_chat(attacker, "<span class='warning'>You require a better grab to do this.</span>")
		return
	if(force_down)
...
/obj/item/grab/proc/apply_pinning(mob/target, mob/attacker) // CHOMPEdit - Removal of obj/item/weapon
	force_down = 1
	target.Weaken(3)
	target.lying = 1
...
/obj/item/grab/proc/devour(mob/target, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	var/can_eat
