/mob/living/Life()
	...
	for(var/obj/item/grab/G in src) // CHOMPEdit - Removal of obj/item/weapon
		G.process()
...
/mob/living/proc/handle_darksight()
	...
	//Snowflake treatment of potential locations
		...
		brightness = 1
	else if(istype(loc,/obj/item/holder)) //Poor carried teshari and whatnot should adjust appropriately // CHOMPEdit - Removal of obj/item/weapon
