...
/mob/living/bullet_act(var/obj/item/projectile/P, var/def_zone)
	...
	if(istype(get_active_hand(),/obj/item/assembly/signaler)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/assembly/signaler/signaler = get_active_hand() // CHOMPEdit - Removal of obj/item/device
