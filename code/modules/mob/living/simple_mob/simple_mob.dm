...
/mob/living/simple_mob
	...
	var/obj/item/card/id/myid// An ID card if they have one to give them access to stuff. // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/simple_mob/Initialize()
	...
	if(ID_provided) //VOREStation Edit
		myid = new /obj/item/card/id(src) // CHOMPEdit - Removal of obj/item/weapon
