/mob/living/simple_mob
	...
	var/obj/item/radio/headset/mob_radio		//Adminbus headset for simplemob shenanigans. // CHOMPEdit - Removal of obj/item/device
	does_spin = FALSE
...
/mob/living/simple_mob/handle_message_mode(message_mode, message, verb, used_radios, speaking, alt_name)
	...
	if(message_mode)
		if(message_mode == "intercom")
			for(var/obj/item/radio/intercom/I in view(1, null)) // CHOMPEdit - Removal of obj/item/device
				I.talk_into(src,message,message_mode,verb,speaking)
				used_radios += I
		if(message_mode == "headset")
			if(mob_radio && istype(mob_radio,/obj/item/radio/headset)) // CHOMPEdit - Removal of obj/item/device
