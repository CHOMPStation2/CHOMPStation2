...
/mob/living/simple_mob/attack_hand(mob/living/L)
	...
	switch(L.a_intent)
		...
		if(I_GRAB)
			...
			var/obj/item/grab/G = new /obj/item/grab(L, src) // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/simple_mob/hit_with_weapon(obj/item/O, mob/living/user, var/effective_force, var/hit_zone)
	...
	if(O.damtype == HALLOSS)
		effective_force = 0
	if(supernatural && istype(O,/obj/item/nullrod)) // CHOMPEdit - Removal of obj/item/weapon
		effective_force *= 2
		purge = 3
