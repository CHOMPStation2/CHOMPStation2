...
/mob/living/simple_mob/slime/xenobio
	...
	var/split_amount = 5 //CHOMPedit, was 4, now 5.  Amount of children we will normally have. Half of that for dead adult slimes. Is NOT carried across generations.
