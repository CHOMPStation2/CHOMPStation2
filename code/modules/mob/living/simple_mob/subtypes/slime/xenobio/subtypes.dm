...
/mob/living/simple_mob/slime/xenobio/dark_purple/attackby(var/obj/item/W, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/simple_mob/slime/xenobio/oil/attackby(obj/item/W, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W) && W.force && W.damtype == BURN)
