...
//Miasma Cloud "Item"
/obj/item/grenade/chem_grenade/miasma // CHOMPEdit - Removal of obj/item/weapon
	name = "Miasma Bomb"
	desc = "You probably shouldn't be able to see this."
	stage = 2
	path = 1

/obj/item/grenade/chem_grenade/miasma/Initialize(mapload) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/mob/living/simple_mob/humanoid/possessed/Destroy()
	...
	*/
	...
	new /obj/item/grenade/chem_grenade/miasma(droploc) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rig/eva/old // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/simple_mob/humanoid/possessed/industrial
	...
	loot_list = list(/obj/item/rig/industrial/old = 100) // CHOMPEdit - Removal of obj/item/weapon
	armor = list(melee = 60, bullet = 50, laser = 30,energy = 15, bomb = 30, bio = 100, rad = 100)

/obj/item/rig/industrial/old // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/simple_mob/humanoid/possessed/merc
	...
	icon_state = "merc-rig"
	loot_list = list(/obj/item/rig/merc/old = 100) // CHOMPEdit - Removal of obj/item/weapon
	armor = list(melee = 80, bullet = 65, laser = 50, energy = 15, bomb = 80, bio = 100, rad = 60)

/obj/item/rig/merc/old // CHOMPEdit - Removal of obj/item/weapon
