...
/obj/item/holder/mouse/attack_self(var/mob/U) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/holder/mouse/attack_self(mob/living/carbon/user) // CHOMPEdit - Removal of obj/item/weapon
