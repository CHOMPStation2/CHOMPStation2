...
/mob/living/simple_mob/animal/passive/mouse/New()
	...
	if (body_color != "rat")
		...
		holder_type = /obj/item/holder/mouse/rat // CHOMPEdit - Removal of obj/item/weapon
	if (body_color == "operative")
		holder_type = /obj/item/holder/mouse/operative // CHOMPEdit - Removal of obj/item/weapon
	if (body_color == "brown")
		holder_type = /obj/item/holder/mouse/brown // CHOMPEdit - Removal of obj/item/weapon
	if (body_color == "gray")
		holder_type = /obj/item/holder/mouse/gray // CHOMPEdit - Removal of obj/item/weapon
	if (body_color == "white")
		holder_type = /obj/item/holder/mouse/white // CHOMPEdit - Removal of obj/item/weapon
	if (body_color == "black")
		holder_type = /obj/item/holder/mouse/black // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/simple_mob/animal/passive/mouse/verb/set_mouse_colour()
	...
	holder_type = text2path("/obj/item/holder/mouse/[new_mouse_colour]") // CHOMPEdit - Removal of obj/item/weapon
