/mob/living/simple_mob/animal/passive/dog
	...
	meat_amount = 3
	meat_type = /obj/item/reagent_containers/food/snacks/meat/corgi // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/simple_mob/animal/passive/dog/corgi
	...
	icon_living = "corgi"
	icon_dead = "corgi_dead"
	holder_type = /obj/item/holder/corgi // CHOMPEdit - Removal of obj/item/weapon
	...
	if(!stat && !resting && !buckled)
		...
		if(turns_since_scan > 5)
			...
			if( !movement_target || !(movement_target.loc in oview(src, 3)) )
				movement_target = null
				for(var/obj/item/reagent_containers/food/snacks/S in oview(src,3)) // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/simple_mob/animal/passive/dog/corgi/Lisa
	...
	var/turns_since_scan = 0
	var/puppies = 0
	holder_type = /obj/item/holder/lisa // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/simple_mob/animal/passive/dog/corgi/narsian
	...
	makes_dirt = FALSE
	holder_type = /obj/item/holder/narsian // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/simple_mob/animal/passive/dog/void_puppy
	...
	holder_type = /obj/item/holder/void_puppy // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/simple_mob/animal/passive/dog/bullterrier
	...
	icon_rest = null
	holder_type = /obj/item/holder/bullterrier // CHOMPEdit - Removal of obj/item/weapon
