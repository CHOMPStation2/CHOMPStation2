...
/mob/living/simple_mob/animal/passive/bird/parrot
	...
	var/obj/item/radio/headset/my_headset = null // CHOMPEdit - Removal of obj/item/device
...
/mob/living/simple_mob/animal/passive/bird/parrot/handle_message_mode(message_mode, message, verb, used_radios, whispering)
	..()
	if(message_mode)
		if(my_headset && istype(my_headset, /obj/item/radio)) // CHOMPEdit - Removal of obj/item/device
...
/mob/living/simple_mob/animal/passive/bird/parrot/attackby(obj/item/I, mob/user)
	if(istype(I, /obj/item/radio/headset)) // CHOMPEdit - Removal of obj/item/device
		give_headset(I, user)
		return
	return ..()
...
/mob/living/simple_mob/animal/passive/bird/parrot/proc/give_headset(obj/item/radio/headset/new_headset, mob/living/user) // CHOMPEdit - Removal of obj/item/device
...
/mob/living/simple_mob/animal/passive/bird/parrot/poly
	...
	my_headset = /obj/item/radio/headset/headset_eng // CHOMPEdit - Removal of obj/item/device
...
/mob/living/simple_mob/animal/passive/bird/parrot/poly/ultimate
	my_headset = /obj/item/radio/headset/omni // CHOMPEdit - Removal of obj/item/device
