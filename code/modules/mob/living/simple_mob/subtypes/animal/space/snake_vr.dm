	...
	if(!stat && !resting && !buckled)
		...
		if(turns_since_scan > 5)
			...
			if( !movement_target || !(movement_target.loc in oview(src, 3)) )
				movement_target = null
				for(var/obj/item/reagent_containers/food/snacks/snakesnack/S in oview(src,3)) // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/simple_mob/animal/passive/snake/python/noodle/attackby(var/obj/item/O, var/mob/user)
	if(istype(O, /obj/item/reagent_containers/food/snacks/snakesnack)) // CHOMPEdit - Removal of obj/item/weapon
 ...
 */
/obj/item/reagent_containers/food/snacks/snakesnack // CHOMPEdit - Removal of obj/item/weapon
	name = "sugar mouse"
...
/obj/item/reagent_containers/food/snacks/snakesnack/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(!snack_colour)
...
/obj/item/storage/box/snakesnackbox // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/box/snakesnackbox/New() // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/reagent_containers/food/snacks/snakesnack(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/reagent_containers/food/snacks/snakesnack(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/reagent_containers/food/snacks/snakesnack(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/reagent_containers/food/snacks/snakesnack(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/reagent_containers/food/snacks/snakesnack(src) // CHOMPEdit - Removal of obj/item/weapon
