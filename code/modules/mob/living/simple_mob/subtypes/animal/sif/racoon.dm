...
/mob/living/simple_mob/animal/sif/sakimm
	...
	var/list/friend_loot_list = list(/obj/item/coin)	// What will make this animal non-hostile if held? // CHOMPEdit - Removal of obj/item/weapon
...
/datum/ai_holder/simple_mob/intentional/sakimm
	...
	var/list/steal_loot_list = list(/obj/item/coin, /obj/item/gun, /obj/item/fossil, /obj/item/stack/material, /obj/item/material, /obj/item/reagent_containers/food/snacks, /obj/item/clothing/head, /obj/item/reagent_containers/glass, /obj/item/flashlight, /obj/item/stack/medical, /obj/item/seeds, /obj/item/spacecash) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
...
/datum/ai_holder/simple_mob/intentional/sakimm/pre_melee_attack(atom/A)
	if(isliving(A))
		...
		var/obj/item/I = A
		if(istype(I, /obj/item/reagent_containers/food/snacks))	// If we can't pick it up, or it's edible, go to harm. // CHOMPEdit - Removal of obj/item/weapon
			holder.a_intent = I_HURT
		else
