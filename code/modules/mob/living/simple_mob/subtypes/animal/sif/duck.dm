...
/mob/living/simple_mob/animal/sif/duck
	...
	tame_items = list(
	/obj/item/reagent_containers/food/snacks/sliceable/bread = 90, // CHOMPEdit - Removal of obj/item/weapon
	/obj/item/reagent_containers/food/snacks/slice/bread = 25 // CHOMPEdit - Removal of obj/item/weapon
	)
