...
/mob/living/simple_mob/vore/pitcher_plant/death()
	...
	anchored = 0
	if(fruit)
		new /obj/item/reagent_containers/food/snacks/pitcher_fruit(get_turf(src)) // CHOMPEdit - Removal of obj/item/weapon
		fruit = FALSE
...
/mob/living/simple_mob/vore/pitcher_plant/attack_hand(mob/living/user)
	if(user.a_intent == I_HELP)
		if(fruit)
			...
			var/obj/F = new /obj/item/reagent_containers/food/snacks/pitcher_fruit(get_turf(user)) //Drops at the user's feet if put_in_hands fails // CHOMPEdit - Removal of obj/item/weapon
			fruit = FALSE
			user.put_in_hands(F)
		else
...
/mob/living/simple_mob/vore/pitcher_plant/attackby(obj/item/O, mob/user)
	if(istype(O, /obj/item/reagent_containers/food/snacks/meat)) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(istype(O, /obj/item/newspaper)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/pitcher_fruit //As much as I want to tie hydroponics harvest code to the mob, this is simpler (albeit kinda hacky). // CHOMPEdit - Removal of obj/item/weapon
	name = "squishy fruit"
...
/obj/item/reagent_containers/food/snacks/pitcher_fruit/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/reagent_containers/food/snacks/pitcher_fruit/afterattack(obj/O as obj, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/pitcher_fruit/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
