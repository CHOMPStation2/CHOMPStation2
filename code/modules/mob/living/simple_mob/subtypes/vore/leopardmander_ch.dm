...
/mob/living/simple_mob/vore/leopardmander/exotic/init_vore()
	...
	B.belly_fullscreen = "VBO_maw13"
	B.emote_time = 5 //Short emote time, since they wont spend long here!
	...
	B.autotransferwait = 10
	B.autotransferlocation = "stomach"
	B.escapetime = 2 SECONDS
	B.escapechance = 75
	...
	B.vore_sound = "Tauric Swallow"
	B.release_sound = "Pred Escape"
	B.mode_flags = DM_FLAG_NUMBING | DM_FLAG_THICKBELLY
	B.fancy_vore = 1
	B.vore_verb = "slurp"
