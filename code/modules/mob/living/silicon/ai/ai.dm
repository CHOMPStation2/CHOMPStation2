...
/mob/living/silicon/ai
	...
	var/obj/item/pda/ai/aiPDA = null // CHOMPEdit - Removal of obj/item/device
	var/obj/item/communicator/aiCommunicator = null // CHOMPEdit - Removal of obj/item/device
	var/obj/item/multitool/aiMulti = null // CHOMPEdit - Removal of obj/item/device
	var/obj/item/radio/headset/heads/ai_integrated/aiRadio = null // CHOMPEdit - Removal of obj/item/device
...
/mob/living/silicon/ai/New(loc, var/datum/ai_laws/L, var/obj/item/mmi/B, var/safety = 0) // CHOMPEdit - Removal of obj/item/device
	announcement = new()
	...
	if(!is_dummy)
		aiPDA = new/obj/item/pda/ai(src) // CHOMPEdit - Removal of obj/item/device
	SetName(pickedName)
	anchored = TRUE
	canmove = 0
	density = TRUE
	...
	if(!is_dummy)
		aiCommunicator = new /obj/item/communicator/integrated(src) // CHOMPEdit - Removal of obj/item/device
	...
	aiCamera = new/obj/item/camera/siliconcam/ai_camera(src) // CHOMPEdit - Removal of obj/item/device
...
/mob/living/silicon/ai/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/silicon/ai/handle_track(message, verb = "says", mob/speaker = null, speaker_name, hard_to_hear)
	...
	if(ishuman(speaker))
		...
		if(H.wear_mask && istype(H.wear_mask,/obj/item/clothing/mask/gas/voice))
			...
			if(I && !(I.name != speaker_name && I.wear_id && istype(I.wear_id,/obj/item/card/id/syndicate))) // CHOMPEdit - Removal of obj/item/weapon
				impersonating = I
