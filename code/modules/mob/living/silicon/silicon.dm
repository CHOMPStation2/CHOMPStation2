...
/mob/living/silicon/verb/pose()
	...
	pose =  strip_html_simple(tgui_input_text(usr, "This is [src]. It is...", "Pose", null)) //CHOMPEdit: less strict sanitization
...
/mob/living/silicon/verb/set_flavor()
	...
	flavor_text =  strip_html_simple(tgui_input_text(usr, "Please enter your new flavour text.", "Flavour text", null)) //CHOMPEdit: less strict sanitization
