...
/obj/item/portable_destructive_analyzer // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/loaded_item	//What is currently inside the analyzer. // CHOMPEdit - Removal of obj/item/weapon

/obj/item/portable_destructive_analyzer/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	files = new /datum/research/techonly(src) //Setup the research data holder.

/obj/item/portable_destructive_analyzer/attack_self(user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/portable_destructive_analyzer/afterattack(var/atom/target, var/mob/living/user, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!target)
		return
	if(!proximity)
		return
...
/obj/item/portable_scanner // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/portable_scanner/afterattack(var/atom/target, var/mob/living/user, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!target)
		return
	if(!proximity)
		return
...
/obj/item/card/robot //This is not a child of id cards, as to avoid dumb typechecks on computers. // CHOMPEdit - Removal of obj/item/weapon
	...
	var/dummy_card = null
	var/dummy_card_type = /obj/item/card/id/science/roboticist/dummy_cyborg // CHOMPEdit - Removal of obj/item/weapon

/obj/item/card/robot/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	dummy_card = new dummy_card_type(src)

/obj/item/card/robot/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	qdel(dummy_card)
	dummy_card = null
	..()

/obj/item/card/robot/GetID() // CHOMPEdit - Removal of obj/item/weapon
	return dummy_card

/obj/item/card/robot/syndi // CHOMPEdit - Removal of obj/item/weapon
	dummy_card_type = /obj/item/card/id/syndicate/dummy_cyborg // CHOMPEdit - Removal of obj/item/weapon

/obj/item/card/id/science/roboticist/dummy_cyborg // CHOMPEdit - Removal of obj/item/weapon
	access = list(access_robotics)

/obj/item/card/id/syndicate/dummy_cyborg/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	access |= access_robotics

//A harvest item for serviceborgs.
/obj/item/robot_harvester // CHOMPEdit - Removal of obj/item/weapon
	name = "auto harvester"
	desc = "A hand-held harvest tool that resembles a sickle.  It uses energy to cut plant matter very efficently."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "autoharvester"

/obj/item/robot_harvester/afterattack(var/atom/target, var/mob/living/user, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!target)
		return
	if(!proximity)
		return
...
/obj/item/tray/robotray // CHOMPEdit - Removal of obj/item/weapon
	name = "RoboTray"
	desc = "An autoloading tray specialized for carrying refreshments."

/obj/item/tray/robotray/afterattack(atom/target, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!proximity)
		return
	if ( !target )
		return
	...
	if ( istype(target,/obj/item))
		...
		for(var/obj/item/reagent_containers/food/I in pickup) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/pen/robopen // CHOMPEdit - Removal of obj/item/weapon
	desc = "A black ink printing attachment with a paper naming mode."
	name = "Printing Pen"
	var/mode = 1

/obj/item/pen/robopen/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/pen/robopen/proc/RenamePaper(mob/user, obj/item/paper/paper) // CHOMPEdit - Removal of obj/item/weapon
	if ( !user || !paper )
		return
...
/obj/item/form_printer // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/form_printer/attack(mob/living/carbon/M as mob, mob/living/carbon/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/form_printer/afterattack(atom/target as mob|obj|turf|area, mob/living/user as mob|obj, flag, params) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/form_printer/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	deploy_paper()

/obj/item/form_printer/proc/deploy_paper() // CHOMPEdit - Removal of obj/item/weapon
	...
	switch(choice)
		if("Paper")
			...
			spawn(22)
				...
				new /obj/item/paper(T) // CHOMPEdit - Removal of obj/item/weapon
		if ("Form")
			...
			spawn(22)
				...
				new /obj/item/paper(T, content[1], content[2]) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/form_printer/proc/print_form() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/form_printer/proc/select_form(paperid, name) // CHOMPEdit - Removal of obj/item/weapon
	var/content = ""
	var/revision = ""
	switch(paperid)
		//Command forms, COM-0
...
/obj/item/form_printer/proc/create_form(paperid, name, content, revision) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/inflatable_dispenser // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/inflatable_dispenser/robot // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/inflatable_dispenser/examine(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	. += "It has [stored_walls] wall segment\s and [stored_doors] door segment\s stored."
	. += "It is set to deploy [mode ? "doors" : "walls"]"

/obj/item/inflatable_dispenser/attack_self() // CHOMPEdit - Removal of obj/item/weapon
	mode = !mode
	to_chat(usr, "<span class='filter_notice'>You set \the [src] to deploy [mode ? "doors" : "walls"].</span>")

/obj/item/inflatable_dispenser/afterattack(var/atom/A, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..(A, user)
	if(!user)
		return
	if(!user.Adjacent(A))
...
/obj/item/inflatable_dispenser/proc/try_deploy_inflatable(var/turf/T, var/mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/inflatable_dispenser/proc/pick_up(var/obj/A, var/mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
