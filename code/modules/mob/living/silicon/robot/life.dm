...
/mob/living/silicon/robot/proc/update_items()
	if(client)
		...
		for(var/obj/I in contents)
			if(I && !(istype(I,/obj/item/cell) || istype(I,/obj/item/radio)  || istype(I,/obj/machinery/camera) || istype(I,/obj/item/mmi))) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
				client.screen += I
	if(module_state_1)
