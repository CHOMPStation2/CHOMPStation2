/obj/item/melee/dogborg/jaws // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/melee/dogborg/jaws/big // CHOMPEdit - Removal of obj/item/weapon
	name = "combat jaws"
	icon_state = "jaws"
...
/obj/item/melee/dogborg/jaws/small // CHOMPEdit - Removal of obj/item/weapon
	name = "puppy jaws"
...
/obj/item/melee/dogborg/jaws/small/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
// Baton chompers
/obj/item/melee/borg_combat_shocker // CHOMPEdit - Removal of obj/item/weapon
	name = "combat shocker"
	icon = 'icons/mob/dogborg_vr.dmi'
...
/obj/item/melee/borg_combat_shocker/apply_hit_effect(mob/living/target, mob/living/user, var/hit_zone) // CHOMPEdit - Removal of obj/item/weapon
	if(isrobot(target))
		return ..()
...
/obj/item/boop_module // CHOMPEdit - Removal of obj/item/device
	name = "boop module"
	icon = 'icons/mob/dogborg_vr.dmi'
	icon_state = "nose"
...
/obj/item/boop_module/New() // CHOMPEdit - Removal of obj/item/device
	..()
	flags |= NOBLUDGEON //No more attack messages

/obj/item/boop_module/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/boop_module/afterattack(obj/O, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/device
	if(!proximity)
		return
	if (user.stat)
		return
...
//Delivery
/*
/obj/item/storage/bag/borgdelivery // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/robot/hound // CHOMPEdit - Removal of obj/item/weapon
	name = "paws of life"
	icon = 'icons/mob/dogborg_vr.dmi'
...
/obj/item/shockpaddles/robot/hound/jumper // CHOMPEdit - Removal of obj/item/weapon
	name = "jumper paws"
	desc = "Zappy paws. For rebooting a full body prostetic."
	use_on_synthetic = 1

/obj/item/reagent_containers/borghypo/hound // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/borghypo/hound/process() //Recharges in smaller steps and uses the water reserves as well. // CHOMPEdit - Removal of obj/item/weapon
	if(isrobot(loc))
		var/mob/living/silicon/robot/R = loc
		if(R && R.cell)
...
/obj/item/reagent_containers/borghypo/hound/lost // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/borghypo/hound/trauma // CHOMPEdit - Removal of obj/item/weapon
	name = "Hound hypospray"
	desc = "An advanced chemical synthesizer and injection system utilizing carrier's reserves."
...
//Tongue stuff
/obj/item/robot_tongue // CHOMPEdit - Removal of obj/item/device
...
/obj/item/robot_tongue/New() // CHOMPEdit - Removal of obj/item/device
	..()
	flags |= NOBLUDGEON //No more attack messages

/obj/item/robot_tongue/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
	var/mob/living/silicon/robot/R = user
	if(R.emagged || R.emag_items)
		emagged = !emagged
		if(emagged)
...
/obj/item/robot_tongue/afterattack(atom/target, mob/user, proximity) // CHOMPEdit - Removal of obj/item/device
	if(!proximity)
		return
	...
	//CHOMPADD End
		...
		if(istype(target,/obj/item/trash))
			...
			return
		if(istype(target,/obj/item/reagent_containers/food)) // CHOMPEdit - Removal of obj/item/weapon
			...
			busy = 0 //CHOMPAdd prevents abuse
			return
		if(istype(target,/obj/item/cell)) // CHOMPEdit - Removal of obj/item/weapon
			...
			if(do_after (user, 50))
				...
				var/mob/living/silicon/robot/R = user
				var/obj/item/cell/C = target // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/taser/mounted/cyborg/ertgun //Not a taser, but it's being used as a base so it takes energy and actually works. // CHOMPEdit - Removal of obj/item/weapon
	name = "disabler"
...
/obj/item/melee/combat_borgblade // CHOMPEdit - Removal of obj/item/weapon
	name = "energy blade"
	icon = 'icons/mob/dogborg_vr.dmi'
...
/obj/item/lightreplacer/dogborg // CHOMPEdit - Removal of obj/item/device
	name = "light replacer"
...
/obj/item/lightreplacer/dogborg/attack_self(mob/user)//Recharger refill is so last season. Now we recycle without magic! // CHOMPEdit - Removal of obj/item/device
...
/obj/item/dogborg/pounce // CHOMPEdit - Removal of obj/item/weapon
	name = "pounce"
	icon = 'icons/mob/dogborg_vr.dmi'
	icon_state = "pounce"
...
/obj/item/dogborg/pounce/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	flags |= NOBLUDGEON

/obj/item/dogborg/pounce/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	var/mob/living/silicon/robot/R = user
	R.leap(bluespace)
...
/obj/item/reagent_containers/glass/beaker/large/borg // CHOMPEdit - Removal of obj/item/weapon
	var/mob/living/silicon/robot/R
	var/last_robot_loc

/obj/item/reagent_containers/glass/beaker/large/borg/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	R = loc.loc
	RegisterSignal(src, COMSIG_OBSERVER_MOVED, PROC_REF(check_loc))

/obj/item/reagent_containers/glass/beaker/large/borg/proc/check_loc(atom/movable/mover, atom/old_loc, atom/new_loc) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/glass/beaker/large/borg/Destroy() // CHOMPEdit - Removal of obj/item/weapon
