...
//Sleeper
/obj/item/dogborg/sleeper // CHOMPEdit - Removal of obj/item/device
	name = "Sleeper Belly"
	...
	var/obj/item/healthanalyzer/med_analyzer = null // CHOMPEdit - Removal of obj/item/device
	var/ore_storage = FALSE //CHOMPAdd
	var/max_ore_storage = 500 //CHOMPAdd
	var/current_capacity = 0 //CHOMPAdd

/obj/item/dogborg/sleeper/New() // CHOMPEdit - Removal of obj/item/device
	..()
	flags |= NOBLUDGEON //No more attack messages
	files = new /datum/research/techonly(src)
	med_analyzer = new /obj/item/healthanalyzer // CHOMPEdit - Removal of obj/item/device

/obj/item/dogborg/sleeper/Destroy() // CHOMPEdit - Removal of obj/item/device
	go_out()
	..()

/obj/item/dogborg/sleeper/Exit(atom/movable/O) // CHOMPEdit - Removal of obj/item/device
	return 0

/obj/item/dogborg/sleeper/return_air() // CHOMPEdit - Removal of obj/item/device
	return return_air_for_internal_lifeform()

/obj/item/dogborg/sleeper/return_air_for_internal_lifeform() // CHOMPEdit - Removal of obj/item/device
	var/datum/gas_mixture/belly_air/air = new(1000)
	return air

/obj/item/dogborg/sleeper/afterattack(var/atom/movable/target, mob/living/silicon/user, proximity) // CHOMPEdit - Removal of obj/item/device
	hound = loc
	if(!istype(target))
		return
	if(!proximity)
...
/obj/item/dogborg/sleeper/proc/ingest_atom(var/atom/ingesting) // CHOMPEdit - Removal of obj/item/device
	...
	if (isliving(ingesting))
		...
		if (is_type_in_list(to_eat, item_vore_blacklist))
			return
		if (istype(to_eat, /obj/item/holder)) //just in case // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/holder/micro = ingesting // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/dogborg/sleeper/proc/ingest_living(var/mob/living/victim, var/obj/belly/belly) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/dogborg/sleeper/proc/go_out() // CHOMPEdit - Removal of obj/item/device
	hound = src.loc
	items_preserved.Cut()
	cleaning = 0
...
/obj/item/dogborg/sleeper/proc/vore_ingest_all() // CHOMPEdit - Removal of obj/item/device
	hound = src.loc
...
/obj/item/dogborg/sleeper/proc/drain(var/amt = 3) //Slightly reduced cost (before, it was always injecting inaprov) // CHOMPEdit - Removal of obj/item/device
	hound = src.loc
	if(istype(hound,/obj/item/robot_module)) // CHOMPEdit - Removal of obj/item/weapon
		hound = hound.loc
	hound.cell.charge = hound.cell.charge - amt

/obj/item/dogborg/sleeper/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(..())
		return
	sleeperUI(user)

/obj/item/dogborg/sleeper/proc/sleeperUI(mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/dogborg/sleeper/Topic(href, href_list) // CHOMPEdit - Removal of obj/item/device
	if(..() || usr == patient)
		return
	usr.set_machine(src)
...
/obj/item/dogborg/sleeper/proc/inject_chem(mob/user, chem) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/dogborg/sleeper/proc/update_patient() // CHOMPEdit - Removal of obj/item/device
	hound = src.loc
...
//Gurgleborg process
/obj/item/dogborg/sleeper/proc/clean_cycle() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/dogborg/sleeper/process() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/dogborg/sleeper/K9 //The K9 portabrig // CHOMPEdit - Removal of obj/item/device
	name = "Brig-Belly"
...
/obj/item/dogborg/sleeper/compactor //Janihound gut. // CHOMPEdit - Removal of obj/item/device
...
/obj/item/dogborg/sleeper/compactor/analyzer //sci-borg gut. // CHOMPEdit - Removal of obj/item/device
...
/obj/item/dogborg/sleeper/compactor/decompiler // CHOMPEdit - Removal of obj/item/device
	...
	recycles = TRUE
/*
/obj/item/dogborg/sleeper/compactor/delivery //Unfinished and unimplemented, still testing. // CHOMPEdit - Removal of obj/item/device
	name = "Cargo Belly"
	...
	recycles = FALSE
*/
/obj/item/dogborg/sleeper/compactor/supply //Miner borg belly // CHOMPEdit - Removal of obj/item/device
	name = "Supply Storage"
...
/obj/item/dogborg/sleeper/compactor/supply/Entered(atom/movable/thing, atom/OldLoc) // CHOMPEdit - Removal of obj/item/device
	. = ..()
	if(istype(thing, /obj/item/ore)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/ore/ore = thing // CHOMPEdit - Removal of obj/item/weapon
		stored_ore[ore.material]++
		current_capacity++
		qdel(ore)

/obj/structure/ore_box/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/dogborg/sleeper/compactor/supply)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/dogborg/sleeper/compactor/supply/S = W // CHOMPEdit - Removal of obj/item/device
...
//CHOMPAdd START
/obj/item/dogborg/sleeper/command //Command borg belly //CHOMP addition // CHOMPEdit - Removal of obj/item/device
...
/obj/item/dogborg/sleeper/compactor/brewer // CHOMPEdit - Removal of obj/item/device
	name = "Brew Belly"
...
/obj/item/dogborg/sleeper/compactor/generic // CHOMPEdit - Removal of obj/item/device
	name = "Internal Cache"
...
/obj/item/dogborg/sleeper/compactor/brewer/inject_chem(mob/user, chem) //CHOMP Addition Start // CHOMPEdit - Removal of obj/item/device
	if(patient && patient.reagents)
		if(chem in injection_chems + "inaprovaline")
...
/obj/item/dogborg/sleeper/compactor/honkborg // CHOMPEdit - Removal of obj/item/device
...
/obj/item/dogborg/sleeper/K9/ert // CHOMPEdit - Removal of obj/item/device
	name = "Emergency Storage"
	desc = "A mounted 'emergency containment cell'."
	icon_state = "sleeperert"
	injection_chems = list("inaprovaline", "tramadol") // short list

/obj/item/dogborg/sleeper/trauma //Trauma borg belly // CHOMPEdit - Removal of obj/item/device
	name = "Recovery Belly"
...
/obj/item/dogborg/sleeper/lost // CHOMPEdit - Removal of obj/item/device
...
/obj/item/dogborg/sleeper/syndie // CHOMPEdit - Removal of obj/item/device
...
/obj/item/dogborg/sleeper/K9/syndie // CHOMPEdit - Removal of obj/item/device
	name = "Cell-Belly"
	desc = "A mounted portable cell that holds anyone you wish for processing or 'processing'."
	icon_state = "sleepersyndiebrig"
	digest_multiplier = 3

/obj/item/dogborg/sleeper/compactor/syndie // CHOMPEdit - Removal of obj/item/device
