...
/hook/startup/proc/robot_modules_vr()
	robot_modules["Medihound"] = /obj/item/robot_module/robot/medihound // CHOMPEdit - Removal of obj/item/weapon
	robot_modules["K9"] = /obj/item/robot_module/robot/knine // CHOMPEdit - Removal of obj/item/weapon
	robot_modules["ERT"] = /obj/item/robot_module/robot/ert // CHOMPEdit - Removal of obj/item/weapon
	robot_modules["Janihound"] = /obj/item/robot_module/robot/scrubpup // CHOMPEdit - Removal of obj/item/weapon
	robot_modules["Sci-borg"] = /obj/item/robot_module/robot/science // CHOMPEdit - Removal of obj/item/weapon
	robot_modules["Pupdozer"] = /obj/item/robot_module/robot/engiedog // CHOMPEdit - Removal of obj/item/weapon
	return 1
*/

/obj/item/robot_module/robot/booze // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/robot_module/robot/booze/New(var/mob/living/silicon/robot/R) // CHOMPEdit - Removal of obj/item/weapon
	...
	//src.modules += new /obj/item/storage/bag/plants(src) // CHOMPEdit - Removal of obj/item/weapon
	...
	src.modules += new /obj/item/dogborg/jaws/small(src) // CHOMPEdit - Removal of obj/item/weapon
	src.modules += new /obj/item/dogborg/boop_module(src) // CHOMPEdit - Removal of obj/item/device
	src.modules += new /obj/item/dogborg/sleeper/compactor/brewer(src) // CHOMPEdit - Removal of obj/item/device
	src.modules += new /obj/item/reagent_containers/glass/beaker(src)//For holding the ALCOHOL // CHOMPEdit - Removal of obj/item/weapon
	...
	*/
	...
	var/obj/item/dogborg/tongue/T = new /obj/item/dogborg/tongue(src) // CHOMPEdit - Removal of obj/item/device
	T.water = water
	src.modules += T


	src.modules += new /obj/item/tray/robotray(src) // CHOMPEdit - Removal of obj/item/weapon
	src.modules += new /obj/item/reagent_containers/borghypo/service/booze(src) // CHOMPEdit - Removal of obj/item/weapon
	src.emag = new /obj/item/reagent_containers/food/drinks/bottle/small/beer(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/robot_module/robot/booze/respawn_consumable(var/mob/living/silicon/robot/R, var/amount) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/reagent_containers/food/condiment/enzyme/E = locate() in src.modules // CHOMPEdit - Removal of obj/item/weapon
	E.reagents.add_reagent("enzyme", 2 * amount)
	if(src.emag)
		var/obj/item/reagent_containers/food/drinks/bottle/small/beer/B = src.emag // CHOMPEdit - Removal of obj/item/weapon
		B.reagents.add_reagent("beer2", 2 * amount)

//BORGHYPO
/obj/item/reagent_containers/borghypo/service/booze // CHOMPEdit - Removal of obj/item/weapon
...
//SLEEPER "Brewer"
/obj/item/dogborg/sleeper/compactor/brewer //Boozehound gut. // CHOMPEdit - Removal of obj/item/device
	name = "Brew Belly"
...
/obj/item/dogborg/sleeper/compactor/brewer/inject_chem(mob/user, chem) // CHOMPEdit - Removal of obj/item/device
