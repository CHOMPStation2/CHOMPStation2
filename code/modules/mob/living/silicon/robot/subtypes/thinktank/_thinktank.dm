...
/mob/living/silicon/robot/platform
	...
	cell =        /obj/item/cell/mech // CHOMPEdit - Removal of obj/item/weapon
	idcard_type = /obj/item/card/id/platform // CHOMPEdit - Removal of obj/item/weapon
	module =      /obj/item/robot_module/robot/platform // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/silicon/robot/platform/Initialize(var/mapload)
	. = ..()
	if(!mmi)
		mmi = new /obj/item/mmi/digital/robot(src) // CHOMPEdit - Removal of obj/item/device
...
/mob/living/silicon/robot/platform/examine(mob/user, distance)
	...
	if(distance <= 3)
		...
		if(recharging)
			var/obj/item/cell/recharging_atom = recharging.resolve() // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/silicon/robot/platform/init()
	. = ..()
	if(ispath(module, /obj/item/robot_module)) // CHOMPEdit - Removal of obj/item/weapon
