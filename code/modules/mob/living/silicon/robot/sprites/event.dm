...
/datum/robot_sprite/dogborg/lost/do_equipment_glamour(var/obj/item/robot_module/module) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/robot_sprite/dogborg/tall/lost/handle_extra_icon_updates(var/mob/living/silicon/robot/ourborg)
	if(has_laser_sprite && istype(ourborg.module_active, /obj/item/gun/energy/retro/mounted)) // CHOMPEdit - Removal of obj/item/weapon
