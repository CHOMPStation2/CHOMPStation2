...
/datum/robot_sprite/dogborg/surgical/get_belly_overlay(var/mob/living/silicon/robot/ourborg)
	if(has_sleeper_light_indicator)
		...
		return ..()
*/
/datum/robot_sprite/dogborg/surgical/do_equipment_glamour(var/obj/item/robot_module/module) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/robot_sprite/dogborg/tall/surgical/do_equipment_glamour(var/obj/item/robot_module/module) // CHOMPEdit - Removal of obj/item/weapon
	if(!has_custom_equipment_sprites)
		return
...
/datum/robot_sprite/dogborg/crisis/get_belly_overlay(var/mob/living/silicon/robot/ourborg)
	if(has_sleeper_light_indicator)
		...
		return ..()
*/
/datum/robot_sprite/dogborg/crisis/do_equipment_glamour(var/obj/item/robot_module/module) // CHOMPEdit - Removal of obj/item/weapon
	if(!has_custom_equipment_sprites)
		return
...
/datum/robot_sprite/dogborg/tall/crisis/do_equipment_glamour(var/obj/item/robot_module/module) // CHOMPEdit - Removal of obj/item/weapon
	if(!has_custom_equipment_sprites)
		return
