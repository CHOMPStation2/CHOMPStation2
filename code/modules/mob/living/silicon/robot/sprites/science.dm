...
/datum/robot_sprite/dogborg/science/do_equipment_glamour(var/obj/item/robot_module/module) // CHOMPEdit - Removal of obj/item/weapon
	if(!has_custom_equipment_sprites)
		return

	..()

	var/obj/item/shockpaddles/robot/jumper/J = locate() in module.modules // CHOMPEdit - Removal of obj/item/weapon
	if(J)
		J.name = "jumper paws"
...
/datum/robot_sprite/dogborg/tall/science/handle_extra_icon_updates(var/mob/living/silicon/robot/ourborg)
	if(has_taser_sprite && istype(ourborg.module_active, /obj/item/gun/energy/taser/xeno/robot)) // CHOMPEdit - Removal of obj/item/weapon
		ourborg.add_overlay("[sprite_icon_state]-taser")

/datum/robot_sprite/dogborg/tall/science/do_equipment_glamour(var/obj/item/robot_module/module) // CHOMPEdit - Removal of obj/item/weapon
	if(!has_custom_equipment_sprites)
		return
	..()
