...
/datum/robot_sprite/proc/do_equipment_glamour(var/obj/item/robot_module/module) // CHOMPEdit - Removal of obj/item/weapon
	return
...
*/
/datum/robot_sprite/dogborg/do_equipment_glamour(var/obj/item/robot_module/module) // CHOMPEdit - Removal of obj/item/weapon
	if(!has_custom_equipment_sprites)
		return

	var/obj/item/tool/crowbar/cyborg/C = locate() in module.modules // CHOMPEdit - Removal of obj/item/weapon
	if(C)
		C.name = "puppy jaws"
