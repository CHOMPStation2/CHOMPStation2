//Simple borg hand.
//Limited use.
/obj/item/gripper // CHOMPEdit - Removal of obj/item/weapon
	...
	var/list/can_hold = list(
		...
		/obj/item/airlock_electronics, // CHOMPEdit - Removal of obj/item/weapon
		...
		/obj/item/bluespace_crystal //Chomp EDIT // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gripper/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(wrapped)
		. += "<span class='notice'>\The [src] is holding \the [wrapped].</span>"
		. += wrapped.examine(user)

/obj/item/gripper/CtrlClick(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	drop_item()
	return

/obj/item/gripper/AltClick(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	drop_item()
	return

/obj/item/gripper/omni // CHOMPEdit - Removal of obj/item/weapon
	name = "omni gripper"
...
/obj/item/gripper/miner // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gripper/security // CHOMPEdit - Removal of obj/item/weapon
	...
	/obj/item/paper_bundle, // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gripper/paperwork // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gripper/medical // CHOMPEdit - Removal of obj/item/weapon
	name = "medical gripper"
	desc = "A simple grasping tool for medical work."

	can_hold = list(
		/obj/item/reagent_containers/glass, // CHOMPEdit - Removal of obj/item/weapon
		...
		/obj/item/nif,       //Chompedit Add Nif handling // CHOMPEdit - Removal of obj/item/device
		/obj/item/stack/material/phoron,
		/obj/item/tank/anesthetic, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/disk/body_record //Vorestation Edit: this lets you get an empty sleeve or help someone else // CHOMPEdit - Removal of obj/item/weapon
		)

/obj/item/gripper/research //A general usage gripper, used for toxins/robotics/xenobio/etc // CHOMPEdit - Removal of obj/item/weapon
	...
	can_hold = list(
		...
		/obj/item/flash, //to build borgs, // CHOMPEdit - Removal of obj/item/device
		/obj/item/disk, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/circuitboard, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/reagent_containers/glass, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/assembly/prox_sensor, // CHOMPEdit - Removal of obj/item/device
		/obj/item/healthanalyzer, //to build medibots, // CHOMPEdit - Removal of obj/item/device
		/obj/item/slime_cube,
		/obj/item/slime_crystal,
		/obj/item/disposable_teleporter/slime, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/slimepotion,
		/obj/item/slime_extract,
		/obj/item/reagent_containers/food/snacks/monkeycube // CHOMPEdit - Removal of obj/item/weapon
		)

/obj/item/gripper/circuit // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gripper/service //Used to handle food, drinks, and seeds. // CHOMPEdit - Removal of obj/item/weapon
	...
	can_hold = list(
		...
		/obj/item/seeds,
		/obj/item/grown, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/trash,
		/obj/item/reagent_containers/cooking_container // CHOMPEdit - Removal of obj/item/weapon
		)

/obj/item/gripper/gravekeeper	//Used for handling grave things, flowers, etc. // CHOMPEdit - Removal of obj/item/weapon
	name = "grave gripper"
	icon_state = "gripper"
	...
	can_hold = list(
		/obj/item/seeds,
		/obj/item/grown, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/material/gravemarker // CHOMPEdit - Removal of obj/item/weapon
		)

/obj/item/gripper/no_use/organ // CHOMPEdit - Removal of obj/item/weapon
	name = "organ gripper"
	...
	can_hold = list(
		/obj/item/organ,
		/obj/item/nif //NIFs can be slapped in during surgery // CHOMPEdit - Removal of obj/item/device
		)

/obj/item/gripper/no_use/organ/Entered(var/atom/movable/AM) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gripper/no_use/organ/Exited(var/atom/movable/AM) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(AM, /obj/item/organ))
		var/obj/item/organ/O = AM
		O.preserved = 0
		for(var/obj/item/organ/organ in O)
...
/obj/item/gripper/no_use/organ/robotics // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gripper/no_use/mech // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gripper/no_use //Used when you want to hold and put items in other things, but not able to 'use' the item // CHOMPEdit - Removal of obj/item/weapon

/obj/item/gripper/no_use/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/gripper/no_use/loader //This is used to disallow building with metal. // CHOMPEdit - Removal of obj/item/weapon
	name = "sheet loader"
...
/obj/item/gripper/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(wrapped)
		return wrapped.attack_self(user)
	return ..()

/obj/item/gripper/attackby(var/obj/item/O, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gripper/verb/drop_gripper_item() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gripper/proc/drop_item() // CHOMPEdit - Removal of obj/item/weapon
	if(!wrapped)
...
/obj/item/gripper/proc/drop_item_nm() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gripper/attack(mob/living/carbon/M as mob, mob/living/carbon/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gripper/afterattack(var/atom/target, var/mob/living/user, proximity, params) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/matter_decompiler // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/matter_decompiler/attack(mob/living/carbon/M as mob, mob/living/carbon/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/matter_decompiler/afterattack(atom/target as mob|obj|turf|area, mob/living/user as mob|obj, proximity, params) // CHOMPEdit - Removal of obj/item/weapon
	...
	for(var/obj/W in T)
		...
		if(istype(W,/obj/item/trash/cigbutt))
			...
			if(plastic)
				plastic.add_charge(2000)
		else if(istype(W,/obj/item/light)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/light/L = W // CHOMPEdit - Removal of obj/item/weapon
			...
			if(metal)
				metal.add_charge(1000)
		else if(istype(W,/obj/item/material/shard/shrapnel)) // CHOMPEdit - Removal of obj/item/weapon
			if(metal)
				metal.add_charge(1000)
		else if(istype(W,/obj/item/material/shard)) // CHOMPEdit - Removal of obj/item/weapon
			if(glass)
				glass.add_charge(1000)
		else if(istype(W,/obj/item/reagent_containers/food/snacks/grown)) // CHOMPEdit - Removal of obj/item/weapon
			if(wood)
...
/mob/living/silicon/robot/drone/installed_modules()
	...
	if(!module)
		module = new /obj/item/robot_module/drone(src) // CHOMPEdit - Removal of obj/item/weapon
	...
	for (var/O in module.modules)
		...
		if((istype(O,/obj/item) || istype(O,/obj/item)) && !(istype(O,/obj/item/stack/cable_coil))) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
			tools += module_string
		else
