...
/obj/item/robot_module/robot/exploration/New(var/mob/living/silicon/robot/R) // CHOMPEdit - Removal of obj/item/weapon
	...
	src.modules += new /obj/item/gun/energy/locked/phasegun/unlocked/mounted/cyborg(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/dogborg/sleeper/exploration //No need to inherit from the brig one, we cna direclty make a proper new one // CHOMPEdit - Removal of obj/item/device
	name = "Store-Belly"
