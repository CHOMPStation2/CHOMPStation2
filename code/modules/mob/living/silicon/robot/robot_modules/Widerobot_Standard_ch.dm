...
/hook/startup/proc/Modular_Borg_init_standardhound()
	//robot_modules["Honk-Hound"] = /obj/item/robot_module/robot/clerical/honkborg - done in station_vr modular chomp for ordering reasons // CHOMPEdit - Removal of obj/item/weapon
	robot_module_types += "Standard-Hound" //Add ourselves to global
	return 1

/obj/item/robot_module/robot/standard/hound // CHOMPEdit - Removal of obj/item/weapon
	name = "Standard-Hound"
	sprites = list(
...
/obj/item/robot_module/robot/standard/hound/New(var/mob/living/silicon/robot/R) // CHOMPEdit - Removal of obj/item/weapon
	..()
