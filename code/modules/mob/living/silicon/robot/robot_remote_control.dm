...
/mob/living/silicon/robot/ai_shell/Initialize()
	...
	mmi = new /obj/item/mmi/inert/ai_remote(src) // CHOMPEdit - Removal of obj/item/device
	post_mmi_setup()
	return ..()

// Call after inserting or instantiating an MMI.
/mob/living/silicon/robot/proc/post_mmi_setup()
	if(istype(mmi, /obj/item/mmi/inert/ai_remote)) // CHOMPEdit - Removal of obj/item/device
		make_shell()
...
/mob/living/silicon/robot/proc/make_shell()
	...
	rbPDA = new /obj/item/pda/ai/shell(src) // CHOMPEdit - Removal of obj/item/device
	setup_PDA()
