/mob/living/silicon/robot/proc/photosync()
	var/obj/item/camera/siliconcam/master_cam = connected_ai ? connected_ai.aiCamera : null // CHOMPEdit - Removal of obj/item/device
	if (!master_cam)
		return
	...
	for(var/obj/item/photo/borg_photo in aiCamera.aipictures) // CHOMPEdit - Removal of obj/item/weapon
		var/copied = 0
		for(var/obj/item/photo/ai_photo in master_cam.aipictures) // CHOMPEdit - Removal of obj/item/weapon
