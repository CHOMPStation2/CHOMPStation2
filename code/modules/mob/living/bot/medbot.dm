...
/mob/living/bot/medbot
	...
	//Healing vars
	var/obj/item/reagent_containers/glass/reagent_glass = null //Can be set to draw from this for reagents. // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/bot/medbot/explode()
	...
	new /obj/item/storage/firstaid(Tsec) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/assembly/prox_sensor(Tsec) // CHOMPEdit - Removal of obj/item/device
	new /obj/item/healthanalyzer(Tsec) // CHOMPEdit - Removal of obj/item/device
	if (prob(50))
...
/obj/item/storage/firstaid/attackby(var/obj/item/robot_parts/S, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/firstaid_arm_assembly/A = new /obj/item/firstaid_arm_assembly // CHOMPEdit - Removal of obj/item/weapon
	if(istype(src, /obj/item/storage/firstaid/fire)) // CHOMPEdit - Removal of obj/item/weapon
		A.skin = "ointment"
	else if(istype(src, /obj/item/storage/firstaid/toxin)) // CHOMPEdit - Removal of obj/item/weapon
		A.skin = "tox"
	else if(istype(src, /obj/item/storage/firstaid/o2)) // CHOMPEdit - Removal of obj/item/weapon
		A.skin = "o2"
...
/obj/item/storage/firstaid/attackby(var/obj/item/organ/external/S, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/firstaid_arm_assembly // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/firstaid_arm_assembly/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(skin)
		add_overlay("kit_skin_[src.skin]")

/obj/item/firstaid_arm_assembly/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(istype(W, /obj/item/pen)) // CHOMPEdit - Removal of obj/item/weapon
		...
		switch(build_step)
			if(0)
				if(istype(W, /obj/item/healthanalyzer)) // CHOMPEdit - Removal of obj/item/device
					user.drop_item()
					qdel(W)
					build_step++
