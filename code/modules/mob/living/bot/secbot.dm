...
/mob/living/bot/secbot
	...
	var/used_weapon	= /obj/item/melee/baton	//Weapon used by the bot // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/bot/secbot/slime
	...
	used_weapon = /obj/item/melee/baton/slime // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/bot/secbot/UnarmedAttack(var/mob/M, var/proximity)
	...
	if(ishuman(M))
		...
		if(!cuff)
			...
			if(do_mob(src, H, 60))
				if(!H.handcuffed)
					if(istype(H.back, /obj/item/rig) && istype(H.gloves,/obj/item/clothing/gloves/gauntlets/rig)) // CHOMPEdit - Removal of obj/item/weapon
						H.handcuffed = new /obj/item/handcuffs/cable(H) // Better to be cable cuffed than stun-locked // CHOMPEdit - Removal of obj/item/weapon
					else
						H.handcuffed = new /obj/item/handcuffs(H) // CHOMPEdit - Removal of obj/item/weapon
					H.update_handcuffed()
			busy = FALSE
...
/mob/living/bot/secbot/explode()
	...
	var/obj/item/secbot_assembly/Sa = new /obj/item/secbot_assembly(Tsec) // CHOMPEdit - Removal of obj/item/weapon
	Sa.build_step = 1
...
/obj/item/clothing/head/helmet/attackby(var/obj/item/assembly/signaler/S, mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	..()
	if(!issignaler(S))
		..()
		return
	...
	if(S.secured)
		qdel(S)
		var/obj/item/secbot_assembly/A = new /obj/item/secbot_assembly // CHOMPEdit - Removal of obj/item/weapon
		user.put_in_hands(A)
...
/obj/item/secbot_assembly // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/secbot_assembly/attackby(var/obj/item/W, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..()
	...
	else if(istype(W, /obj/item/melee/baton) && build_step == 3) // CHOMPEdit - Removal of obj/item/weapon
		user.drop_item()
		to_chat(user, "You complete the Securitron! Beep boop.")
		if(istype(W, /obj/item/melee/baton/slime)) // CHOMPEdit - Removal of obj/item/weapon
