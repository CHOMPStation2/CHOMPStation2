var/list/department_radio_keys = list(
	...
	":a" = "Explorer",	".y" = "Explorer",	//VOREStation Edit //CHOMP keep explo
	":y" = "Talon",		".a" = "Talon", //VOREStation Add, //CHOMP keep explo
	":g" = "Casino",	".g" = "Casino",
	...
	":V" = "Service",		".V" = "Service",
	":P" = "AI Private",	".P" = "AI Private",
	":A" = "Explorer",	".Y" = "Explorer", //CHOMP keep explo
	":Y" = "Talon",		".A" = "Talon", //VOREStation Add, //CHOMP keep explo
	":G" = "Casino",	".G" = "Casino",
	...
	":ф" = "Explorer",    ".н" = "Explorer", //CHOMP keep explo
	":н" = "Talon",        ".ф" = "Talon", //VOREStation Add //CHOMP keep explo
	":п" = "Casino",	".п" = "Casino",
)
