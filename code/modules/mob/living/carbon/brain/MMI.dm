...
/obj/item/mmi // CHOMPEdit - Removal of obj/item/device
	...
	var/obj/item/radio/headset/mmi_radio/radio = null//Let's give it a radio. // CHOMPEdit - Removal of obj/item/device

/obj/item/mmi/New() // CHOMPEdit - Removal of obj/item/device
	radio = new(src)//Spawns a radio inside the MMI.

/obj/item/mmi/verb/toggle_radio() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mmi/attackby(var/obj/item/O as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	...
	if((istype(O,/obj/item/card/id)||istype(O,/obj/item/pda)) && brainmob) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
		if(allowed(user))
			locked = !locked
...
/obj/item/mmi/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	if(!brainmob)
...
/obj/item/mmi/proc/transfer_identity(var/mob/living/carbon/human/H)//Same deal as the regular brain proc. Used for human-->robot people. // CHOMPEdit - Removal of obj/item/device
	brainmob = new(src)
...
/obj/item/mmi/relaymove(var/mob/user, var/direction) // CHOMPEdit - Removal of obj/item/device
	if(user.stat || user.stunned)
		return
	var/obj/item/rig/rig = src.get_rig() // CHOMPEdit - Removal of obj/item/weapon
	if(rig)
		if(istype(rig,/obj/item/rig)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/mmi/radio_enabled // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mmi/emp_act(severity) // CHOMPEdit - Removal of obj/item/device
	if(!brainmob)
		return
	else
		switch(severity)
...
/obj/item/mmi/digital // CHOMPEdit - Removal of obj/item/device
	var/searching = 0
...
/obj/item/mmi/digital/New() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mmi/digital/attackby(var/obj/item/O as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mmi/digital/examine(mob/user) // CHOMPEdit - Removal of obj/item/device
	. = ..()
...
/obj/item/mmi/digital/emp_act(severity) // CHOMPEdit - Removal of obj/item/device
	if(!src.brainmob)
		return
	else
		switch(severity)
...
/obj/item/mmi/digital/transfer_identity(var/mob/living/carbon/H) // CHOMPEdit - Removal of obj/item/device
	brainmob.dna = H.dna
...
/obj/item/mmi/digital/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mmi/digital/proc/request_player() // CHOMPEdit - Removal of obj/item/device
	if(!ghost_query_type)
		return
	searching = 1
...
/obj/item/mmi/digital/proc/reset_search() //We give the players sixty seconds to decide, then reset the timer. // CHOMPEdit - Removal of obj/item/device
	if(src.brainmob && src.brainmob.key)
		return
...
/obj/item/mmi/digital/proc/transfer_personality(var/mob/candidate) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mmi/digital/robot // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mmi/digital/robot/New() // CHOMPEdit - Removal of obj/item/device
	..()
	src.brainmob.name = "[pick(list("ADA","DOS","GNU","MAC","WIN","NJS","SKS","DRD","IOS","CRM","IBM","TEX","LVM","BSD",))]-[rand(1000, 9999)]"
	src.brainmob.real_name = src.brainmob.name

/obj/item/mmi/digital/robot/transfer_identity(var/mob/living/carbon/H) // CHOMPEdit - Removal of obj/item/device
	..()
	if(brainmob.mind)
...
/obj/item/mmi/digital/posibrain/request_player() // CHOMPEdit - Removal of obj/item/device
	icon_state = "posibrain-searching"
	..()


/obj/item/mmi/digital/posibrain/transfer_identity(var/mob/living/carbon/H) // CHOMPEdit - Removal of obj/item/device
	..()
	if(brainmob.mind)
...
/obj/item/mmi/digital/posibrain/transfer_personality(var/mob/candidate) // CHOMPEdit - Removal of obj/item/device
	..()
	icon_state = "posibrain-occupied"

/obj/item/mmi/digital/posibrain/reset_search() //We give the players sixty seconds to decide, then reset the timer. // CHOMPEdit - Removal of obj/item/device
	..()
	icon_state = "posibrain"

/obj/item/mmi/digital/posibrain/New() // CHOMPEdit - Removal of obj/item/device
	..()
	src.brainmob.name = "[pick(list("PBU","HIU","SINA","ARMA","OSI"))]-[rand(100, 999)]"
	src.brainmob.real_name = src.brainmob.name

// This type shouldn't care about brainmobs.
/obj/item/mmi/inert // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mmi/inert/ai_remote // CHOMPEdit - Removal of obj/item/device
