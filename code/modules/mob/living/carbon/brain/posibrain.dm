...
/obj/item/mmi/digital/posibrain/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mmi/digital/posibrain/proc/request_player() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mmi/digital/posibrain/proc/question(var/client/C) // CHOMPEdit - Removal of obj/item/device
	spawn(0)
		if(!C)	return
...
/obj/item/mmi/digital/posibrain/proc/transfer_personality(var/mob/candidate) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mmi/digital/posibrain/proc/reset_search() //We give the players sixty seconds to decide, then reset the timer. // CHOMPEdit - Removal of obj/item/device
...
/obj/item/mmi/digital/posibrain/emp_act(severity) // CHOMPEdit - Removal of obj/item/device
	if(!src.brainmob)
		return
	else
		switch(severity)
