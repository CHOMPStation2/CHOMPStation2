/datum/species/shadekin
	...
	species_component = list(/datum/component/shadekin/full, /datum/component/radiation_effects/chomp_shadekin) //CHOMPEdit: Enabling full shadekin & no-power radiation component.
