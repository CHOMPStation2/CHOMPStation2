/datum/species
	...
	holder_type = /obj/item/holder/micro //This allows you to pick up crew // CHOMPEdit - Removal of obj/item/weapon
	min_age = 18
	descriptors = list()
...
/datum/species/create_organs(var/mob/living/carbon/human/H)
	if(H.nif)
		...
		/*var/obj/item/nif/nif = new type(H,durability,nif_savedata) // CHOMPEdit - Removal of obj/item/device
