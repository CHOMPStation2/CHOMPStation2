/datum/species/sergal
	...
	wikilink="[config.wikiurl]Sergal"
...
/datum/species/nevrean
	...
	wikilink="[config.wikiurl]Nevrean"
...
/datum/species/hi_zoxxen
	...
	wikilink="[config.wikiurl]Zorren"
...
//	gluttonous = 1
	...
	wikilink="[config.wikiurl]Vulpkanin"
...
/datum/species/xenohybrid
	...
	wikilink="[config.wikiurl]Xenomorph-Hybrid"
...
/datum/species/unathi
	...
	inherent_verbs = list(/mob/living/proc/shred_limb)
	descriptors = list()
	wikilink="[config.wikiurl]Unathi"
...
/datum/species/tajaran
	...
	wikilink="[config.wikiurl]Tajaran"
...
/datum/species/skrell
	...
	reagent_tag = null
	assisted_langs = list(LANGUAGE_EAL, LANGUAGE_ROOTLOCAL, LANGUAGE_ROOTGLOBAL, LANGUAGE_VOX)
	wikilink="[config.wikiurl]Skrell"
...
/datum/species/zaddat
	...
	gluttonous = 0
	descriptors = list()
	wikilink="[config.wikiurl]Zaddat"
...
/datum/species/teshari
	...
	gluttonous = 0
	descriptors = list()
	wikilink="[config.wikiurl]Teshari"
...
/datum/species/shapeshifter/promethean
	spawn_flags = SPECIES_CAN_JOIN
	wikilink="[config.wikiurl]Promethean"
...
datum/species/harpy
	...
	wikilink="[config.wikiurl]Rapala"
