...
/datum/trait/negative/lightweight
	...
	excludes = list(/datum/trait/negative/lightweight_light, /datum/trait/positive/heavyweight) //CHOMPedit
...
/datum/trait/negative/lightweight_light
	...
	excludes = list(/datum/trait/negative/lightweight, /datum/trait/positive/heavyweight) //CHOMPedit Take with heavy weight and downsides are canceled out
	custom_only = FALSE
