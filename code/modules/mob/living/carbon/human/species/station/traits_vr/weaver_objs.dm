...
/obj/effect/weaversilk/attackby(var/obj/item/W, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/bed/double/weaversilk_nest/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
