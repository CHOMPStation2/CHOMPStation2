	...
	if (BITTEST(hud_updateflag, BACKUP_HUD))
		...
		for(var/obj/item/organ/external/E in organs)
			for(var/obj/item/implant/I in E.implants) // CHOMPEdit - Removal of obj/item/weapon
				if(I.implanted && istype(I,/obj/item/implant/backup)) // CHOMPEdit - Removal of obj/item/weapon
					var/obj/item/implant/backup/B = I // CHOMPEdit - Removal of obj/item/weapon
					if(!mind)
