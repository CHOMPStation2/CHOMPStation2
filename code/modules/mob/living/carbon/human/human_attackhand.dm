...
/mob/living/carbon/human/attack_hand(mob/living/M as mob)
	...
	switch(M.a_intent)
		...
		if(I_GRAB)
			if(M == src || anchored)
				return 0
			for(var/obj/item/grab/G in src.grabbed_by) // CHOMPEdit - Removal of obj/item/weapon
				if(G.assailant == M)
			...
			var/obj/item/grab/G = new /obj/item/grab(M, src) // CHOMPEdit - Removal of obj/item/weapon
			if(buckled)
		...
		if(I_HURT)
			...
			if(M.zone_sel.selecting == "mouth" && wear_mask && istype(wear_mask, /obj/item/grenade)) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/grenade/G = wear_mask // CHOMPEdit - Removal of obj/item/weapon
				if(!G.active)
...
/mob/living/carbon/human/proc/grab_joint(var/mob/living/user, var/def_zone)
	var/has_grab = 0
	for(var/obj/item/grab/G in list(user.l_hand, user.r_hand)) // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/carbon/human/proc/break_all_grabs(mob/living/carbon/user)
	...
	if(istype(l_hand, /obj/item/grab)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/grab/lgrab = l_hand // CHOMPEdit - Removal of obj/item/weapon
		if(lgrab.affecting)
	...
	if(istype(r_hand, /obj/item/grab)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/grab/rgrab = r_hand // CHOMPEdit - Removal of obj/item/weapon
		if(rgrab.affecting)
