...
/mob/living/carbon/human/GetVoice()
	var/voice_sub
	if(istype(get_rig(),/obj/item/rig)) // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/carbon/human/handle_message_mode(message_mode, list/message_pieces, verb, used_radios)
	switch(message_mode)
		if("intercom")
			if(!restrained())
				for(var/obj/item/radio/intercom/I in view(1)) // CHOMPEdit - Removal of obj/item/device
...
/mob/living/carbon/human/binarycheck()
	. = FALSE
	var/obj/item/radio/headset/R = null // CHOMPEdit - Removal of obj/item/device
