/mob/living/carbon/human/proc/handle_strip(var/slot_to_strip,var/mob/living/user)
	...
	if(!istype(held) || is_robot_module(held))
		...
		if(is_robot_module(held) && istype(held, /obj/item/gripper)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/gripper/G = held // CHOMPEdit - Removal of obj/item/weapon
			if(istype(G.wrapped))
				stripping = FALSE
		//CHOMPEdit End
	else
		var/obj/item/holder/holder = held // CHOMPEdit - Removal of obj/item/weapon
		if(istype(holder) && src == holder.held_mob)
			stripping = TRUE
		else
			var/obj/item/grab/grab = held // CHOMPEdit - Removal of obj/item/weapon
	...
	else if(!istype(held, /obj/item/gripper)) //CHOMPEdit - Let borg grippers put stuff on. // CHOMPEdit - Removal of obj/item/weapon
		if(slot_to_strip == slot_wear_mask && istype(held, /obj/item/grenade)) // CHOMPEdit - Removal of obj/item/weapon
	...
	//CHOMPEdit Start - Let borg grippers put stuff on.
		...
		var/obj/item/gripper/G = held // CHOMPEdit - Removal of obj/item/weapon
		if(slot_to_strip == slot_wear_mask && istype(G.wrapped, /obj/item/grenade)) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(!stripping)
		if(user.get_active_hand() != held)
			return
		var/obj/item/holder/mobheld = held // CHOMPEdit - Removal of obj/item/weapon
	...
	if(stripping)
		...
		unEquip(target_slot)
	//CHOMPEdit Start - Let borg grippers put stuff on.
	else if(is_robot_module(held) && istype(held, /obj/item/gripper)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/gripper/G = held // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/carbon/human/proc/toggle_internals(var/mob/living/user)
	if(internal)
		...
		if(istype(back, /obj/item/tank)) // CHOMPEdit - Removal of obj/item/weapon
			internal = back
		else if(istype(s_store, /obj/item/tank)) // CHOMPEdit - Removal of obj/item/weapon
			internal = s_store
		else if(istype(belt, /obj/item/tank)) // CHOMPEdit - Removal of obj/item/weapon
			internal = belt
