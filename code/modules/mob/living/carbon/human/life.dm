...
/mob/living/carbon/human/get_breath_from_internal(volume_needed=BREATH_VOLUME)
	if(internal)
		...
		var/obj/item/tank/rig_supply // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/carbon/human/handle_regular_status_updates()
	...
	if(stat == DEAD)	//DEAD. BROWN BREAD. SWIMMING WITH THE SPESS CARP
		...
		if(istype(back,/obj/item/rig)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/rig/O = back // CHOMPEdit - Removal of obj/item/weapon
		...
		if(CONFIG_GET(flag/welder_vision)) // CHOMPEdit
			...
			if(species.short_sighted)
				...
				if(!found_welder && istype(head, /obj/item/clothing/head/welding))
					...
					if(!O.up)
						found_welder = 1
				if(!found_welder && istype(back, /obj/item/rig)) // CHOMPEdit - Removal of obj/item/weapon
					var/obj/item/rig/O = back // CHOMPEdit - Removal of obj/item/weapon
					if(O.helmet && O.helmet == head && (O.helmet.body_parts_covered & EYES))
...
End Chomp edit */
	...
	if (  BITTEST(hud_updateflag, IMPLOYAL_HUD) \
	   ...
	   || BITTEST(hud_updateflag, IMPTRACK_HUD))
		...
		for(var/obj/item/implant/I in src) // CHOMPEdit - Removal of obj/item/weapon
			if(I.implanted)
				if(!I.malfunction)
					if(istype(I,/obj/item/implant/tracking)) // CHOMPEdit - Removal of obj/item/weapon
						holder1.icon_state = "hud_imp_tracking"
					if(istype(I,/obj/item/implant/loyalty)) // CHOMPEdit - Removal of obj/item/weapon
						holder2.icon_state = "hud_imp_loyal"
					if(istype(I,/obj/item/implant/chem)) // CHOMPEdit - Removal of obj/item/weapon
