...
/datum/mob_descriptor/proc/get_comparative_value_descriptor(var/my_value, var/mob/observer, var/mob/me)
	...
	var/datum/gender/my_gender = GLOB.gender_datums[me.get_gender()] // CHOMPEdit - Globals
	var/datum/gender/other_gender = GLOB.gender_datums[observer.get_gender()] // CHOMPEdit - Globals
