...
/obj/item/slime_extract/attackby(obj/item/O as obj, mob/user as mob)
	if(istype(O, /obj/item/slimesteroid2)) // CHOMPEdit - Removal of obj/item/weapon
		if(enhanced == 1)
...
/obj/item/slimepotion2 // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/egg/slime // CHOMPEdit - Removal of obj/item/weapon
	name = "slime egg"
...
/obj/item/reagent_containers/food/snacks/egg/slime/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reagents.add_reagent("nutriment", 4)
	reagents.add_reagent("slimejelly", 1)
	addtimer(CALLBACK(src, PROC_REF(Grow)), rand(120 SECONDS, 150 SECONDS))

/obj/item/reagent_containers/food/snacks/egg/slime/proc/Grow() // CHOMPEdit - Removal of obj/item/weapon
	grown = 1
	icon_state = "slime egg-grown"
	START_PROCESSING(SSobj, src)
	return

/obj/item/reagent_containers/food/snacks/egg/slime/proc/Hatch() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/egg/slime/process() // CHOMPEdit - Removal of obj/item/weapon
	var/turf/location = get_turf(src)
	var/datum/gas_mixture/environment = location.return_air()
	if (environment.phoron > MOLES_PHORON_VISIBLE)//phoron exposure causes the egg to hatch
		src.Hatch()

/obj/item/reagent_containers/food/snacks/egg/slime/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
