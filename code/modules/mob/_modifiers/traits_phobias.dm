...
/datum/modifier/trait/phobia/trypanophobe/should_fear()
	...
	for(var/atom/thing in view(5, holder)) // See haemophobia for why this is 5.
		...
		if(istype(thing, /obj/item/reagent_containers/syringe)) // CHOMPEdit - Removal of obj/item/weapon
			fear_amount += 4
		...
		if(istype(thing, /obj/item/reagent_containers/hypospray)) // CHOMPEdit - Removal of obj/item/weapon
			fear_amount += 2 //Needle doesn't look as intimidating.

		if(istype(thing, /obj/item/reagent_containers/hypospray/autoinjector)) //Don't know if I need to define autoinjectors too. Meh. // CHOMPEdit - Removal of obj/item/weapon
			fear_amount += 3

		if(istype(thing, /obj/item/rig_module/chem_dispenser))
			fear_amount += 5

		if(istype(thing, /obj/item/storage/box/syringes)) // CHOMPEdit - Removal of obj/item/weapon
			fear_amount += 2
		...
		if(istype(thing, /obj/item/implanter)) // CHOMPEdit - Removal of obj/item/weapon
			fear_amount += 8 //Very big needle.

		if(istype(thing, /obj/item/gun/launcher/syringe)) // CHOMPEdit - Removal of obj/item/weapon
			fear_amount += 6
		...
		if(isliving(thing))
			...
			if(istype(L, /mob/living/carbon/human))
				...
				if(H.l_hand && istype(H.l_hand, /obj/item/reagent_containers/syringe) || H.r_hand && istype(H.r_hand, /obj/item/reagent_containers/syringe)) // CHOMPEdit - Removal of obj/item/weapon
					fear_amount += 10

				if(H.l_ear && istype(H.l_ear, /obj/item/reagent_containers/syringe) || H.r_ear && istype(H.r_ear, /obj/item/reagent_containers/syringe)) // CHOMPEdit - Removal of obj/item/weapon
					fear_amount +=10
