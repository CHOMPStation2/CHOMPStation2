...
/datum/modifier/crusher_mark/New(var/new_holder, var/new_origin)
    ...
    if(isliving(new_origin))
        ...
        var/obj/item/kinetic_crusher/to_sync // CHOMPEdit - Removal of obj/item/weapon
        if(istype(origin.get_active_hand(), /obj/item/kinetic_crusher)) // CHOMPEdit - Removal of obj/item/weapon
            to_sync = origin.get_active_hand()
        else if (istype(origin.get_inactive_hand(), /obj/item/kinetic_crusher)) // CHOMPEdit - Removal of obj/item/weapon
