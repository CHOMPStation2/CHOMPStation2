/obj/machinery/computer/curer
	...
	icon_screen = "dna"
	circuit = /obj/item/circuitboard/curefab // CHOMPEdit - Removal of obj/item/weapon
	var/curing
	var/virusing
...
/obj/machinery/computer/curer/attackby(var/obj/I as obj, var/mob/user as mob)
	if(istype(I,/obj/item/reagent_containers)) // CHOMPEdit - Removal of obj/item/weapon
		...
		if(!container)
			...
			I.loc = src
		return
	if(istype(I,/obj/item/virusdish)) // CHOMPEdit - Removal of obj/item/weapon
		if(virusing)
			to_chat(user, "<b>The pathogen materializer is still recharging..</b>")
			return
		var/obj/item/reagent_containers/glass/beaker/product = new(src.loc) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/curer/proc/createcure(var/obj/item/reagent_containers/container) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/reagent_containers/glass/beaker/product = new(src.loc) // CHOMPEdit - Removal of obj/item/weapon
