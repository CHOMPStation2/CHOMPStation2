/obj/machinery/disease2/isolator/
	...
	var/obj/item/reagent_containers/syringe/sample = null // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/disease2/isolator/attackby(var/obj/O as obj, var/mob/user)
	...
	else if(!istype(O,/obj/item/reagent_containers/syringe)) return // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/disease2/isolator/process()
	if (isolating > 0)
		...
		if (isolating == 0)
			if (virus2)
				var/obj/item/virusdish/d = new /obj/item/virusdish(src.loc) // CHOMPEdit - Removal of obj/item/weapon
