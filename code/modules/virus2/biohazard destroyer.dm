/obj/machinery/disease2/biodestroyer
	...
	var/list/accepts = list(/obj/item/clothing,/obj/item/virusdish/,/obj/item/cureimplanter,/obj/item/diseasedisk,/obj/item/reagent_containers) // CHOMPEdit - Removal of obj/item/weapon
	density = TRUE
	anchored = TRUE
