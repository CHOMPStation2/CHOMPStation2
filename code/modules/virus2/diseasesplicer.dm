/obj/machinery/computer/diseasesplicer
	...
	var/analysed = 0
	var/obj/item/virusdish/dish = null // CHOMPEdit - Removal of obj/item/weapon
	var/burning = 0
	var/splicing = 0
	var/scanning = 0
...
/obj/machinery/computer/diseasesplicer/attackby(var/obj/item/I as obj, var/mob/user as mob)
	...
	if(istype(I,/obj/item/diseasedisk)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/diseasesplicer/process()
	...
	if(burning)
		burning -= 1
		if(!burning)
			var/obj/item/diseasedisk/d = new /obj/item/diseasedisk(src.loc) // CHOMPEdit - Removal of obj/item/weapon
			d.analysed = analysed
			if(analysed)
				if(memorybank)
