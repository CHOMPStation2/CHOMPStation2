...
/datum/data/pda
	...
	var/obj/item/pda/pda	// if this is null, and the app is running code, something's gone wrong // CHOMPEdit - Removal of obj/item/device
...
/datum/data/pda/utility/scanmode/New(obj/item/cartridge/C) // CHOMPEdit - Removal of obj/item/weapon
	..(C)
