/obj/item/radio/integrated
	...
	var/obj/item/pda/hostpda = null // CHOMPEdit - Removal of obj/item/device
	...
	on = 0 //Are we currently active??  // CHOMPEdit - Removal of obj/item/weapon
	var/menu_message = ""

/obj/item/radio/integrated/New()
	..()
	if(istype(loc.loc, /obj/item/pda)) // CHOMPEdit - Removal of obj/item/device
		hostpda = loc.loc
	if(bot_filter)
		spawn(5)
...
/obj/item/radio/integrated/signal
	frequency = 1457  // CHOMPEdit - Removal of obj/item/weapon
	var/code = 30.0
	// var/last_transmission  // CHOMPEdit - Removal of obj/item/weapon
	// var/datum/radio_frequency/radio_connection // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/radio/integrated/signal/set_frequency(new_frequency)  // CHOMPEdit - Removal of obj/item/weapon
	radio_controller.remove_object(src, frequency)
