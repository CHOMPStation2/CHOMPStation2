...
/datum/data/pda/messenger_plugin/proc/user_act(mob/user as mob, obj/item/pda/P) // CHOMPEdit - Removal of obj/item/device


/datum/data/pda/messenger_plugin/virus
	name = "*Send Virus*"

/datum/data/pda/messenger_plugin/virus/user_act(mob/user as mob, obj/item/pda/P) // CHOMPEdit - Removal of obj/item/device
...
/datum/data/pda/messenger_plugin/virus/clown/user_act(mob/user as mob, obj/item/pda/P) // CHOMPEdit - Removal of obj/item/device
	. = ..(user, P)
	if(.)
...
/datum/data/pda/messenger_plugin/virus/mime/user_act(mob/user as mob, obj/item/pda/P) // CHOMPEdit - Removal of obj/item/device
	. = ..(user, P)
	if(.)
		user.show_message("<span class='notice'>Virus sent!</span>", 1)
...
/datum/data/pda/messenger_plugin/virus/detonate/user_act(mob/user as mob, obj/item/pda/P) // CHOMPEdit - Removal of obj/item/device
	. = ..(user, P)
	if(.)
		var/difficulty = 0
...
/datum/data/pda/messenger_plugin/virus/frame/user_act(mob/user, obj/item/pda/P) // CHOMPEdit - Removal of obj/item/device
	. = ..(user, P)
	if(.)
		...
		if(!P.hidden_uplink)
			var/obj/item/uplink/hidden/uplink = new(P) // CHOMPEdit - Removal of obj/item/device
