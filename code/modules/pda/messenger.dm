...
/datum/data/pda/app/messenger/update_ui(mob/user as mob, list/data)
	...
	if(active_conversation)
		...
		var/convopdas[0]
		var/pdas[0]
		for(var/obj/item/device/pda/P as anything in GLOB.PDAs) // CHOMPEdit - Globals
...
/datum/data/pda/app/messenger/proc/create_message(var/mob/living/U, var/obj/item/device/pda/P)
	...
	if(GLOB.message_servers) // CHOMPEdit - Globals
		for(var/obj/machinery/message_server/MS as anything in GLOB.message_servers) // CHOMPEdit - Globals
...
/datum/data/pda/app/messenger/multicast/receive_message(list/data, ref)
	...
	for(var/obj/item/device/pda/pda in GLOB.PDAs) // CHOMPEdit - Globals
