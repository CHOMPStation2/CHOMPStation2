...
/obj/item/blobcore_chunk // CHOMPEdit - Removal of obj/item/weapon
	name = "core chunk"
...
/obj/item/blobcore_chunk/is_open_container() // CHOMPEdit - Removal of obj/item/weapon
	return 1

/obj/item/blobcore_chunk/New(var/atom/newloc, var/datum/blob_type/parentblob = null) // CHOMPEdit - Removal of obj/item/weapon
	..(newloc)

	create_reagents(120)
	setup_blobtype(parentblob)

/obj/item/blobcore_chunk/Destroy() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/blobcore_chunk/proc/setup_blobtype(var/datum/blob_type/parentblob = null) // CHOMPEdit - Removal of obj/item/weapon
	if(!parentblob)
...
/obj/item/blobcore_chunk/proc/call_chunk_unique() // CHOMPEdit - Removal of obj/item/weapon
	if(blob_type)
		blob_type.chunk_unique(src, args)
	return

/obj/item/blobcore_chunk/proc/get_carrier(var/atom/target) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/blobcore_chunk/blob_act(obj/structure/blob/B) // CHOMPEdit - Removal of obj/item/weapon
	if(B.overmind && !blob_type)
		setup_blobtype(B.overmind.blob_type)

	return

/obj/item/blobcore_chunk/attack_self(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/blobcore_chunk/process() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/blobcore_chunk/AltClick(mob/living/carbon/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/blobcore_chunk/proc/regen(var/newfaction = null) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(blob_type))
		if(newfaction)
...
/decl/chemical_reaction/instant/blob_reconstitution/can_happen(var/datum/reagents/holder)
	if(holder.my_atom && istype(holder.my_atom, /obj/item/blobcore_chunk)) // CHOMPEdit - Removal of obj/item/weapon
		return ..()
	return FALSE

/decl/chemical_reaction/instant/blob_reconstitution/on_reaction(var/datum/reagents/holder)
	var/obj/item/blobcore_chunk/chunk = holder.my_atom // CHOMPEdit - Removal of obj/item/weapon
