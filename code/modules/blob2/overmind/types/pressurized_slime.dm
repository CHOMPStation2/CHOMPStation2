...
/datum/blob_type/pressurized_slime/on_chunk_tick(obj/item/blobcore_chunk/B) // CHOMPEdit - Removal of obj/item/weapon
	wet_surroundings(B, 10)

/datum/blob_type/pressurized_slime/on_chunk_use(obj/item/blobcore_chunk/B, mob/living/user)	// Drenches you in water. // CHOMPEdit - Removal of obj/item/weapon
	if(user)
		user.ExtinguishMob()
