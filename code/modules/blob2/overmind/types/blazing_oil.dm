...
/datum/blob_type/blazing_oil/on_chunk_tick(obj/item/blobcore_chunk/B) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/blob_type/blazing_oil/on_chunk_use(obj/item/blobcore_chunk/B, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
