...
/datum/blob_type/proc/on_chunk_tick(obj/item/blobcore_chunk/B) // CHOMPEdit - Removal of obj/item/weapon
	return

// Blob core chunk use in-hand.
/datum/blob_type/proc/on_chunk_use(obj/item/blobcore_chunk/B, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return

// Proc that is unique to the blob type.
/datum/blob_type/proc/chunk_unique(obj/item/blobcore_chunk/B, var/list/extra_args = null) // CHOMPEdit - Removal of obj/item/weapon
	return

// Set up the blob type for the chunk.
/datum/blob_type/proc/chunk_setup(obj/item/blobcore_chunk/B) // CHOMPEdit - Removal of obj/item/weapon
	return
