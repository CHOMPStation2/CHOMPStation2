...
/obj/machinery/mining/drill
	...
	circuit = /obj/item/circuitboard/miningdrill // CHOMPEdit - Removal of obj/item/weapon
	var/braces_needed = 2
	...
	var/obj/item/radio/intercom/faultreporter // CHOMPEdit - Removal of obj/item/device
	var/drill_range = 5
	var/offset = 2
	...
	var/list/ore_types_uncommon = list(
		MAT_MARBLE = /obj/item/ore/marble, // CHOMPEdit - Removal of obj/item/weapon
		...
		MAT_LEAD = /obj/item/ore/lead // CHOMPEdit - Removal of obj/item/weapon
		)
	...
	var/list/ore_types_rare = list(
		...
		MAT_VERDANTIUM = /obj/item/ore/verdantium // CHOMPEdit - Removal of obj/item/weapon
		)
...
/obj/machinery/mining/drill/Initialize()
	...
	if(ispath(cell))
		cell = new cell(src)
	default_apply_parts()
	faultreporter = new /obj/item/radio/intercom{channels=list("Supply")}(null) // CHOMPEdit - Removal of obj/item/device
...
/obj/machinery/mining/drill/loaded
	cell = /obj/item/cell/high // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/mining/drill/attackby(obj/item/O as obj, mob/user as mob)
	if(!active)
		if(istype(O, /obj/item/multitool)) // CHOMPEdit - Removal of obj/item/device
	...
	if(istype(O, /obj/item/cell)) // CHOMPEdit - Removal of obj/item/weapon
		if(cell)
...
/obj/machinery/mining/drill/RefreshParts()
	...
	for(var/obj/item/stock_parts/P in component_parts) // CHOMPEdit - Removal of obj/item/weapon
		if(istype(P, /obj/item/stock_parts/micro_laser)) // CHOMPEdit - Removal of obj/item/weapon
		...
		if(istype(P, /obj/item/stock_parts/capacitor)) // CHOMPEdit - Removal of obj/item/weapon
			charge_use -= 10 * P.rating
	cell = locate(/obj/item/cell) in src // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/mining/brace
	...
	circuit = /obj/item/circuitboard/miningdrillbrace // CHOMPEdit - Removal of obj/item/weapon
	var/brace_tier = 1
...
/obj/machinery/mining/brace/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
