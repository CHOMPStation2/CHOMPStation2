...
/obj/machinery/mineral/equipment_vendor
	...
	circuit = /obj/item/circuitboard/mining_equipment_vendor // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/card/id/inserted_id // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/mineral/equipment_vendor/Initialize(mapload)
	...
	prize_list["Gear"] = list(
		// TODO EQUIPMENT("Advanced Scanner",	/obj/item/t_scanner/adv_mining_scanner,										800), // CHOMPEdit - Removal of obj/item/device
		// TODO EQUIPMENT("Explorer's Webbing",	/obj/item/storage/belt/mining,														500),
		EQUIPMENT("Defense Equipment - Plasteel Machete",		/obj/item/material/knife/machete,							500), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Defense Equipment - Razor Drone Deployer",	/obj/item/grenade/spawnergrenade/manhacks/station/locked,	1000), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Defense Equipment - Sentry Drone Deployer",	/obj/item/grenade/spawnergrenade/ward,						1500), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Defense Equipment - Smoke Bomb",				/obj/item/grenade/smokebomb,									100), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Hybrid Equipment - Proto-Kinetic Dagger",	/obj/item/kinetic_crusher/machete/dagger,					500), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Hybrid Equipment - Proto-Kinetic Machete",	/obj/item/kinetic_crusher/machete,							1000), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Durasteel Fishing Rod",						/obj/item/material/fishing_rod/modern/strong,				7500), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Titanium Fishing Rod",						/obj/item/material/fishing_rod/modern,						1000), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Fishing Net",								/obj/item/material/fishing_net,								500), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Fulton Beacon",								/obj/item/fulton_core,												500),
		EQUIPMENT("Geiger Counter",								/obj/item/geiger,											750), // CHOMPEdit - Removal of obj/item/device
		EQUIPMENT("GPS Device",									/obj/item/gps/mining,										100), // CHOMPEdit - Removal of obj/item/device
		...
		EQUIPMENT("Mini-Translocator",							/obj/item/perfect_tele/one_beacon,							1200), // CHOMPEdit - Removal of obj/item/device
		EQUIPMENT("Survival Equipment - Insulated Poncho",		/obj/random/thermalponcho,											750),
		EQUIPMENT("Mining Satchel of Holding",					/obj/item/storage/bag/ore/holding,							1500), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Advanced Ore Scanner",						/obj/item/mining_scanner/advanced,							500), // CHOMPEdit - Removal of obj/item/weapon
	)
	prize_list["Consumables"] = list(
		...
		EQUIPMENT("Injector (L) - Glucose",	/obj/item/reagent_containers/hypospray/autoinjector/biginjector/glucose,	500), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Injector (L) - Panacea",	/obj/item/reagent_containers/hypospray/autoinjector/biginjector/purity,	500), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Injector (L) - Trauma",	/obj/item/reagent_containers/hypospray/autoinjector/biginjector/brute,	500), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Nanopaste Tube",			/obj/item/stack/nanopaste,														1000),
		EQUIPMENT("Point Transfer Card",	/obj/item/card/mining_point_card,										500), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Shelter Capsule",		/obj/item/survivalcapsule,												500), // CHOMPEdit - Removal of obj/item/device
		EQUIPMENT("Burn Medipen",			/obj/item/reagent_containers/hypospray/autoinjector/burn,				250), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Detox Medipen",			/obj/item/reagent_containers/hypospray/autoinjector/detox,				250), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Oxy Medipen",			/obj/item/reagent_containers/hypospray/autoinjector/oxy,					250), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Trauma Medipen",			/obj/item/reagent_containers/hypospray/autoinjector/trauma,				250), // CHOMPEdit - Removal of obj/item/weapon
	)
	prize_list["Kinetic Accelerator"] = list(
		EQUIPMENT("Kinetic Accelerator",		/obj/item/gun/energy/kinetic_accelerator,				900), // CHOMPEdit - Removal of obj/item/weapon
		...
		EQUIPMENT("Premium Kinetic Accelerator",/obj/item/gun/energy/kinetic_accelerator/premiumka,		12000), // CHOMPEdit - Removal of obj/item/weapon
	)
	prize_list["Digging Tools"] = list(
		EQUIPMENT("Diamond Pickaxe",	/obj/item/pickaxe/diamond,				2000), //CHOMPstation re-addition // CHOMPEdit - Removal of obj/item/weapon
		// EQUIPMENT("Kinetic Crusher",	/obj/item/twohanded/required/kinetic_crusher,	750),
		EQUIPMENT("Resonator",			/obj/item/resonator,							900),
		EQUIPMENT("Silver Pickaxe",		/obj/item/pickaxe/silver,				1200), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Super Resonator",	/obj/item/resonator/upgraded,					2500),
		EQUIPMENT("Explosive Excavation Kit - Plastic Charge",/obj/item/plastique/seismic/locked,	1500), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Industrial Equipment - Phoron Bore",		/obj/item/gun/magnetic/matfed/phoronbore/loaded,			3000), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Industrial Equipment - Inducer",			/obj/item/inducer,						3500), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Industrial Equipment - Sheet-Snatcher",	/obj/item/storage/bag/sheetsnatcher,		500), // CHOMPEdit - Removal of obj/item/weapon
	)
	prize_list["Hardsuit"] = list(
		EQUIPMENT("Hardsuit - Control Module",				/obj/item/rig/industrial/vendor,			2000), // CHOMPEdit - Removal of obj/item/weapon
	...
	prize_list["Miscellaneous"] = list(
		EQUIPMENT("Absinthe",					/obj/item/reagent_containers/food/drinks/bottle/absinthe,	125), // CHOMPEdit - Removal of obj/item/weapon
		...
		EQUIPMENT("Laser Pointer",				/obj/item/laser_pointer,										900), // CHOMPEdit - Removal of obj/item/device
		EQUIPMENT("Luxury Shelter Capsule",		/obj/item/survivalcapsule/luxury,							3100), // CHOMPEdit - Removal of obj/item/device
		EQUIPMENT("Bar Shelter Capsule",		/obj/item/survivalcapsule/luxurybar,							10000), // CHOMPEdit - Removal of obj/item/device
		EQUIPMENT("Plush Toy",					/obj/random/plushie,												300),
		EQUIPMENT("Soap",						/obj/item/soap/nanotrasen,									200), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Thalers - 100",				/obj/item/spacecash/c100,									1000), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Thalers - 1000",				/obj/item/spacecash/c1000,									10000), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Umbrella",					/obj/item/melee/umbrella/random,								200), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Whiskey",					/obj/item/reagent_containers/food/drinks/bottle/whiskey,		125), // CHOMPEdit - Removal of obj/item/weapon
		EQUIPMENT("Mining PSG Upgrade Disk",	/obj/item/borg/upgrade/shield_upgrade,								2500),
	//CHOMPedit Start
		EQUIPMENT("Mining PSG", 				/obj/item/personal_shield_generator/belt/mining/loaded,      2000), // CHOMPEdit - Removal of obj/item/device
	//CHOMPedit End
	)
...
/obj/machinery/mineral/equipment_vendor/proc/get_points(obj/item/card/id/target) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(target))
		return 0
	return target.mining_points

/obj/machinery/mineral/equipment_vendor/proc/remove_points(obj/item/card/id/target, amt) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/mineral/equipment_vendor/proc/redeem_voucher(obj/item/mining_voucher/voucher, mob/redeemer)
	...
	switch(selection)
		if("Kinetic Accelerator")
			new /obj/item/gun/energy/kinetic_accelerator(drop_location) // CHOMPEdit - Removal of obj/item/weapon
		if("Resonator")
	...
	//VOREStation Edit End
		...
		// if("Advanced Scanner")
		// 	new /obj/item/t_scanner/adv_mining_scanner(drop_location) // CHOMPEdit - Removal of obj/item/device
		// if("Crusher")
