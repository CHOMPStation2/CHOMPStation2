...
/obj/item/survivalcapsule/proc/get_template() // CHOMPEdit - Removal of obj/item/device
	if(template)
		return
...
/obj/item/survivalcapsule/Destroy() // CHOMPEdit - Removal of obj/item/device
	template = null // without this, capsules would be one use. per round.
	. = ..()

/obj/item/survivalcapsule/examine(mob/user) // CHOMPEdit - Removal of obj/item/device
	. = ..()
	if(!template)
		get_template()
	if(template)
...
/obj/item/survivalcapsule/attack_self() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/survivalcapsule/luxury // CHOMPEdit - Removal of obj/item/device
...
/obj/item/survivalcapsule/luxurybar // CHOMPEdit - Removal of obj/item/device
...
/obj/item/survivalcapsule/military // CHOMPEdit - Removal of obj/item/device
...
/obj/item/survivalcapsule/escapepod // CHOMPEdit - Removal of obj/item/device
...
/obj/item/survivalcapsule/popcabin // CHOMPEdit - Removal of obj/item/device
	name = "pop-out cabin shelter capsule"
	desc = "A cozy cabin; crammed into a survival capsule."
	template_id = "shelter_cab"

/obj/item/survivalcapsule/dropship // CHOMPEdit - Removal of obj/item/device
...
/obj/item/survivalcapsule/tabiranth // CHOMPEdit - Removal of obj/item/device
...
/obj/machinery/button/remote/airlock/survival_pod/attack_hand(obj/item/W, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/table/survival_pod/dismantle(obj/item/tool/wrench/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
//Computer
/obj/item/gps/computer // CHOMPEdit - Removal of obj/item/device
	name = "pod computer"
...
/obj/item/gps/computer/attackby(obj/item/I, mob/living/user) // CHOMPEdit - Removal of obj/item/device
	if(I.has_tool_quality(TOOL_WRENCH))
		user.visible_message("<span class='warning'>[user] disassembles [src].</span>",
			"<span class='notice'>You start to disassemble [src]...</span>", "You hear clanking and banging noises.")
		if(do_after(user,4 SECONDS,src))
			new /obj/item/gps(loc) // CHOMPEdit - Removal of obj/item/device
			qdel(src)
			return TRUE

	return FALSE

/obj/item/gps/computer/attack_hand(mob/user) // CHOMPEdit - Removal of obj/item/device
	attack_self(user)
