...
/obj/item/cataloguer/proc/draw_box(atom/A, box_size, client/C) // CHOMPEdit - Removal of obj/item/device
	. = list()
...
/obj/item/cataloguer/proc/draw_line(atom/A, line_dir, line_pixel_x, line_pixel_y, client/C) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/cataloguer/proc/delete_box(list/box_segments, client/C) // CHOMPEdit - Removal of obj/item/device
	for(var/i in box_segments)
		C.images -= i
		qdel(i)

/obj/item/cataloguer/proc/color_box(list/box_segments, new_color, new_time) // CHOMPEdit - Removal of obj/item/device
	for(var/i in box_segments)
