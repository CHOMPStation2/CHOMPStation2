...
/obj/item/cataloguer/debug // CHOMPEdit - Removal of obj/item/device
...
/obj/item/cataloguer/Initialize() // CHOMPEdit - Removal of obj/item/device
	GLOB.all_cataloguers += src
	return ..()

/obj/item/cataloguer/Destroy() // CHOMPEdit - Removal of obj/item/device
	GLOB.all_cataloguers -= src
	displayed_data = null
	return ..()

/obj/item/cataloguer/update_icon() // CHOMPEdit - Removal of obj/item/device
	if(busy)
		icon_state = "[initial(icon_state)]_active"
	else
		icon_state = initial(icon_state)

/obj/item/cataloguer/afterattack(atom/target, mob/user, proximity_flag) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/cataloguer/proc/catalogue_object(atom/target, mob/living/user) // CHOMPEdit - Removal of obj/item/device
	...
	if(points_gained)
		...
		if(contributers.len)
			for(var/mob/M in contributers)
				...
				var/obj/item/cataloguer/other_cataloguer = locate() in things // If someone has two or more scanners this only adds points to one. // CHOMPEdit - Removal of obj/item/device
				if(other_cataloguer)
...
/obj/item/cataloguer/AltClick(mob/user) // CHOMPEdit - Removal of obj/item/device
	pulse_scan(user)
...
/obj/item/cataloguer/proc/pulse_scan(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(busy)
...
/obj/item/cataloguer/proc/adjust_points(amount) // CHOMPEdit - Removal of obj/item/device
	points_stored = max(0, points_stored += amount)

/obj/item/cataloguer/attack_self(mob/living/user) // CHOMPEdit - Removal of obj/item/device
	interact(user)

/obj/item/cataloguer/interact(mob/user) // CHOMPEdit - Removal of obj/item/device
	var/list/dat = list()
...
/obj/item/cataloguer/Topic(href, href_list) // CHOMPEdit - Removal of obj/item/device
	if(..())
...
/obj/item/cataloguer/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	if(istype(W, /obj/item/card/id) && !busy) // CHOMPEdit - Removal of obj/item/weapon
		busy = TRUE
		var/obj/item/card/id/ID = W // CHOMPEdit - Removal of obj/item/weapon
		if(points_stored)
...
/obj/item/cataloguer/compact/update_icon() // CHOMPEdit - Removal of obj/item/device
	if(busy)
		icon_state = "[initial(icon_state)]_s"
	else
		icon_state = initial(icon_state)

/obj/item/cataloguer/compact/ui_action_click() // CHOMPEdit - Removal of obj/item/device
	toggle()

/obj/item/cataloguer/compact/verb/toggle() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/cataloguer/compact/afterattack(atom/target, mob/user, proximity_flag) // CHOMPEdit - Removal of obj/item/device
	if(!deployed)
		to_chat(user, span("warning", "\The [src] is closed."))
		return
	return ..()

/obj/item/cataloguer/compact/pulse_scan(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(!deployed)
		to_chat(user, span("warning", "\The [src] is closed."))
		return
	return ..()
