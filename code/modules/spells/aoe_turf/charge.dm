...
/spell/aoe_turf/charge/proc/cast_charge(var/atom/target)
	...
	if(istype(target, /obj/item/grab)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/grab/G = target // CHOMPEdit - Removal of obj/item/weapon
		if(G.affecting)
			var/mob/M = G.affecting
			charged_item = mob_charge(M)

	if(istype(target, /obj/item/spellbook/oneuse)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/spellbook/oneuse/I = target // CHOMPEdit - Removal of obj/item/weapon
		if(prob(50))
