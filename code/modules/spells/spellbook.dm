...
/obj/item/spellbook/attack_self(mob/user = usr) // CHOMPEdit - Removal of obj/item/weapon
	if(!user)
		return
...
/obj/item/spellbook/Topic(href, href_list) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
//							temp = "You have learned curse of the horseman."
						if("mentalfocus")
							...
							new /obj/item/gun/energy/staff/focus(get_turf(H)) // CHOMPEdit - Removal of obj/item/weapon
							temp = "An artefact that channels the will of the user into destructive bolts of force."
							max_uses--
						if("soulstone")
							feedback_add_details("wizard_spell_learned","SS") //please do not change the abbreviation to keep data processing consistent. Add a unique id to any new spells
							new /obj/item/storage/belt/soulstone/full(get_turf(H)) // CHOMPEdit - Removal of obj/item/weapon
						...
						if("scrying")
							...
							new /obj/item/scrying(get_turf(H)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spellbook/oneuse // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spellbook/oneuse/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	name += spellname

/obj/item/spellbook/oneuse/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spellbook/oneuse/proc/recoil(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	user.visible_message("<span class='warning'>[src] glows in a black light!</span>")

/obj/item/spellbook/oneuse/proc/onlearned(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	used = 1
	user.visible_message("<span class='caution'>[src] glows dark for a second!</span>")

/obj/item/spellbook/oneuse/attackby() // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/spellbook/oneuse/fireball // CHOMPEdit - Removal of obj/item/weapon
	spell = /spell/targeted/projectile/dumbfire/fireball
	spellname = "fireball"
	icon_state ="bookfireball"
	desc = "This book feels warm to the touch."

/obj/item/spellbook/oneuse/fireball/recoil(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/spellbook/oneuse/smoke/recoil(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
	to_chat(user, "<span class='caution'>Your stomach rumbles...</span>")
	if(user.nutrition)
		user.adjust_nutrition(-200)

/obj/item/spellbook/oneuse/blind // CHOMPEdit - Removal of obj/item/weapon
	spell = /spell/targeted/genetic/blind
	spellname = "blind"
	icon_state ="bookblind"
	desc = "This book looks blurry, no matter how you look at it."

/obj/item/spellbook/oneuse/blind/recoil(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
	to_chat(user, "<span class='warning'>You go blind!</span>")
	user.Blind(10)

/obj/item/spellbook/oneuse/mindswap // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spellbook/oneuse/mindswap/onlearned() // CHOMPEdit - Removal of obj/item/weapon
	spellname = pick("fireball","smoke","blind","forcewall","knock","horses","charge")
	icon_state = "book[spellname]"
	name = "spellbook of [spellname]" //Note, desc doesn't change by design
	..()

/obj/item/spellbook/oneuse/mindswap/recoil(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/spellbook/oneuse/forcewall // CHOMPEdit - Removal of obj/item/weapon
	spell = /spell/aoe_turf/conjure/forcewall
	spellname = "forcewall"
	icon_state ="bookforcewall"
	desc = "This book has a dedication to mimes everywhere inside the front cover."

/obj/item/spellbook/oneuse/forcewall/recoil(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/spellbook/oneuse/knock // CHOMPEdit - Removal of obj/item/weapon
	spell = /spell/aoe_turf/knock
	spellname = "knock"
	icon_state ="bookknock"
	desc = "This book is hard to hold closed properly."

/obj/item/spellbook/oneuse/knock/recoil(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
	to_chat(user, "<span class='warning'>You're knocked down!</span>")
	user.Weaken(20)

/obj/item/spellbook/oneuse/horsemask // CHOMPEdit - Removal of obj/item/weapon
	spell = /spell/targeted/equip_item/horsemask
	spellname = "horses"
	icon_state ="bookhorses"
	desc = "This book is more horse than your mind has room for."

/obj/item/spellbook/oneuse/horsemask/recoil(mob/living/carbon/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spellbook/oneuse/charge // CHOMPEdit - Removal of obj/item/weapon
	spell = /spell/aoe_turf/charge
	spellname = "charging"
	icon_state ="bookcharge"
	desc = "This book is made of 100% post-consumer wizard."

/obj/item/spellbook/oneuse/charge/recoil(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
