...
/obj/machinery/telepad_phoronics/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/reagent_containers)) // CHOMPEdit - Removal of obj/item/weapon
		user.drop_item()
		W.loc = src.loc
	else if(istype(W, /obj/item/tool/wrench)) // CHOMPEdit - Removal of obj/item/weapon
		var/word = "tighten"
	...
	else if(istype(W, /obj/item/tool/screwdriver) && !src.anchored) // CHOMPEdit - Removal of obj/item/weapon
		user << "You fold the telepad."
		new /obj/item/phoronics_telepad(src.loc) // CHOMPEdit - Removal of obj/item/weapon
		del(src)
	else
		return ..()

/obj/item/phoronics_telepad // CHOMPEdit - Removal of obj/item/weapon
	name = "telepad"
	desc = "A bluespace telepad used for teleporting objects to and from a location."
	icon = 'icons/phoronics.dmi'
...
/*/datum/design/item/phoronics_telepad
	...
	build_path = /obj/item/phoronics_telepad */ // CHOMPEdit - Removal of obj/item/weapon
