...
/datum/reagent/phororeagent
	...
	proc/initial_reaction(var/obj/item/reagent_containers/container, var/turf/T, var/volume, var/message) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/glass/beaker/lovepotion // CHOMPEdit - Removal of obj/item/weapon
...
/datum/reagent/phororeagent/nasty/touch_turf(var/turf/T, var/volume)
	...
	for(var/mob/living/carbon/human/H in viewers(T, 2))
		...
		if(distTo < dist && (istype(H.l_hand, /obj/item/reagent_containers) || \ // CHOMPEdit - Removal of obj/item/weapon
				 istype(H.r_hand, /obj/item/reagent_containers))) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/reagent/phororeagent/nasty/initial_reaction(var/obj/item/reagent_containers/container, var/turf/T, var/volume, var/message) // CHOMPEdit - Removal of obj/item/weapon
	for(var/mob/living/carbon/human/H in viewers(T, 7))
...
/datum/reagent/phororeagent/sapoformator/touch_turf(var/turf/T, var/volume)
	...
	if(volume >= 25)
		...
		soapfoam.start()
		sleep(50)
		var/list/soaps = typesof(/obj/item/soap)// - /obj/item/soap/fluff/azare_siraj_1 // CHOMPEdit - Removal of obj/item/weapon
		var/soap_type = pick(soaps)
		var/obj/item/soap/S = new soap_type() // CHOMPEdit - Removal of obj/item/weapon
		S.loc = T
		if(volume >= 50)
			volume -= 50
			var/list/tiles = list()
...
/datum/reagent/phororeagent/energized_phoron/initial_reaction(var/obj/item/reagent_containers/container, var/turf/T, var/volume, var/message) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/reagent/phororeagent/obscuritol/initial_reaction(var/obj/item/reagent_containers/container, var/turf/T, var/volume, var/message) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/reagent/phororeagent/gaseous/initial_reaction(var/obj/item/reagent_containers/container, var/turf/T, var/volume, var/message) // CHOMPEdit - Removal of obj/item/weapon
