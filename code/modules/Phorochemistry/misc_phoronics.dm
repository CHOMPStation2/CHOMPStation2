...
/datum/chemical_reaction/brownies
	...
	on_reaction(var/datum/reagents/holder, var/created_volume)
		for(var/i = 0; i < 3; i++)
			new /obj/item/reagent_containers/food/snacks/brownies(get_turf(holder.my_atom)) // CHOMPEdit - Removal of obj/item/weapon
		return

/obj/item/reagent_containers/food/snacks/brownies // CHOMPEdit - Removal of obj/item/weapon
	name = "Brownies"
	icon_state = "waffles"
...
/obj/item/induromol // CHOMPEdit - Removal of obj/item/weapon
