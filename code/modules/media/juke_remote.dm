/obj/item/juke_remote // CHOMPEdit - Removal of obj/item/device
...
/*
/obj/item/juke_remote/Initialize() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	flags |= NOBLUDGEON
*/
// Pairing
/obj/item/juke_remote/proc/pair_juke(obj/machinery/media/jukebox/juke, mob/user) // CHOMPEdit - Removal of obj/item/device
	if(paired_juke)
...
/obj/item/juke_remote/proc/unpair_juke(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(!paired_juke)
...
/obj/item/juke_remote/afterattack(atom/target, mob/user, proximity_flag, click_parameters) // CHOMPEdit - Removal of obj/item/device
	if(istype(target, /obj/machinery/media/jukebox))
		pair_juke(target, user)
		return
	return ..()

/obj/item/juke_remote/verb/reset() // CHOMPEdit - Removal of obj/item/device
...
// Deploying
/obj/item/juke_remote/Moved(atom/old_loc, direction, forced) // CHOMPEdit - Removal of obj/item/device
	. = ..()
	if(paired_juke && !anchored && isturf(loc))
		anchor()

/obj/item/juke_remote/attack_hand(mob/living/user) // CHOMPEdit - Removal of obj/item/device
	if(anchored)
		unanchor()
	return ..()

/obj/item/juke_remote/proc/anchor() // CHOMPEdit - Removal of obj/item/device
	if(anchored)
		return
	anchored = TRUE
	if(attach_area())
...
/obj/item/juke_remote/proc/unanchor() // CHOMPEdit - Removal of obj/item/device
	detach_area()
	anchored = FALSE
...
// Area handling
/obj/item/juke_remote/proc/attach_area() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/juke_remote/proc/detach_area() // CHOMPEdit - Removal of obj/item/device
...
// Music handling
/obj/item/juke_remote/proc/update_music() // CHOMPEdit - Removal of obj/item/device
