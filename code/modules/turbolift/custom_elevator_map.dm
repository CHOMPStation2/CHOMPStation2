// Map object.
/obj/service_elevator_map_holder
...
/obj/service_elevator_map_holder/Destroy()
	turbolifts -= src
	return ..()

/obj/service_elevator_map_holder/New()
	turbolifts += src
	..()

/obj/service_elevator_map_holder/initialize()

	// Create our system controller.
	var/datum/service_elevator/lift = new()
