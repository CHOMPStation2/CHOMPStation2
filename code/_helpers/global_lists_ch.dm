...
var/global/list/vr_mob_tf_options = list(
	...
	//"Shadekin" = /mob/living/simple_mob/shadekin, //ChompEDIT - This is the base type and causes bugs when used. Instead use below...
	"Red-eyed Shadekin" = /mob/living/simple_mob/shadekin/red, //ChompEDIT
	"Blue-eyed Shadekin" = /mob/living/simple_mob/shadekin/blue, //ChompEDIT
	"Purple-eyed Shadekin" = /mob/living/simple_mob/shadekin/purple, //ChompEDIT
	"Green-eyed Shadekin" = /mob/living/simple_mob/shadekin/green, //ChompEDIT
	"Yellow-eyed Shadekin" = /mob/living/simple_mob/shadekin/yellow, //ChompEDIT
