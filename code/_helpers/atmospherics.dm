...
/obj/item/tank/atmosanalyze(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flamethrower/atmosanalyze(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
