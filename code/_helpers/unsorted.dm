...
/mob/proc/fully_replace_character_name(var/oldname,var/newname)
	...
	if(oldname)
		...
		for(var/A in searching)
			if( search_id && istype(A,/obj/item/card/id) ) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/card/id/ID = A // CHOMPEdit - Removal of obj/item/weapon
			...
			else if( search_pda && istype(A,/obj/item/pda) ) // CHOMPEdit - Removal of obj/item/device
				var/obj/item/pda/PDA = A // CHOMPEdit - Removal of obj/item/device
...
/obj/item/tool/transforming) // CHOMPEdit - Removal of obj/item/weapon
...
/proc/is_wire_tool(obj/item/I)
	if(istype(I, /obj/item/multitool) || I.has_tool_quality(TOOL_WIRECUTTER)) // CHOMPEdit - Removal of obj/item/device
		return TRUE
	if(istype(I, /obj/item/assembly/signaler)) // CHOMPEdit - Removal of obj/item/device
		return TRUE
	return

/proc/is_hot(obj/item/W as obj)
	switch(W.type)
		if(/obj/item/weldingtool) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/weldingtool/WT = W // CHOMPEdit - Removal of obj/item/weapon
			if(WT.isOn())
				return 3800
			else
				return 0
		if(/obj/item/tool/transforming) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/tool/transforming/TT = W // CHOMPEdit - Removal of obj/item/weapon
			if(TT.possible_tooltypes[TT.current_tooltype] == TOOL_WELDER)
				return 3800
			else
				return 0
		if(/obj/item/flame/lighter) // CHOMPEdit - Removal of obj/item/weapon
			if(W:lit)
				return 1500
			else
				return 0
		if(/obj/item/flame/match) // CHOMPEdit - Removal of obj/item/weapon
			if(W:lit)
				return 1000
			else
				return 0
		if(/obj/item/clothing/mask/smokable/cigarette)
			if(W:lit)
				...
				return 0
		if(/obj/item/pickaxe/plasmacutter) // CHOMPEdit - Removal of obj/item/weapon
			return 3800
		if(/obj/item/melee/energy) // CHOMPEdit - Removal of obj/item/weapon
			return 3500
		else
			return 0
...
// CHOMPEdit Start - Removal of weapons
...
var/list/WALLITEMS = list(
	/obj/machinery/power/apc, /obj/machinery/alarm, /obj/item/radio/intercom, /obj/structure/frame, // CHOMPEdit - Removal of obj/item/device
	...
	/obj/item/storage/secure/safe, /obj/machinery/door_timer, /obj/machinery/flasher, /obj/machinery/keycard_auth, // CHOMPEdit - Removal of obj/item/weapon
	...
	/obj/machinery/computer/guestpass, /obj/item/geiger/wall, /obj/machinery/button/windowtint, /obj/machinery/computer/id_restorer,	//CHOMPEdit // CHOMPEdit - Removal of obj/item/device
...
/proc/make_types_fancy(var/list/types)
	...
	for(var/type in types)
		...
		var/static/list/TYPES_SHORTCUTS = list(
			...
			/obj/item/radio/headset = "HEADSET", // CHOMPEdit - Removal of obj/item/device
			/obj/item/clothing/head/helmet/space = "SPESSHELMET",
			/obj/item/book/manual = "MANUAL", // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/reagent_containers/food/drinks = "DRINK", // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/reagent_containers/food = "FOOD", // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/reagent_containers = "REAGENT_CONTAINERS", // CHOMPEdit - Removal of obj/item/weapon
