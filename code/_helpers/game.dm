...
/proc/get_mobs_in_radio_ranges(var/list/obj/item/radio/radios) // CHOMPEdit - Removal of obj/item/device

	//set background = 1 //CHOMPEdit
	. = list()
	// Returns a list of mobs who can hear any of the radios given in @radios
	for(var/obj/item/radio/R as anything in radios) // CHOMPEdit - Removal of obj/item/device
		if(get_turf(R))
...
/mob/living/silicon/robot/can_hear_radio(var/list/hearturfs)
	...
	var/obj/item/radio/borg/R = hearturfs[T] // this should be an assoc list of turf-to-radio // CHOMPEdit - Removal of obj/item/device
