...
// Computer Hardware
#define  PART_CPU  		/obj/item/computer_hardware/processor_unit				// CPU. Without it the computer won't run. Better CPUs can run more programs at once. // CHOMPEdit - Removal of obj/item/weapon
#define  PART_NETWORK  	/obj/item/computer_hardware/network_card					// Network Card component of this computer. Allows connection to NTNet // CHOMPEdit - Removal of obj/item/weapon
#define  PART_HDD 		/obj/item/computer_hardware/hard_drive					// Hard Drive component of this computer. Stores programs and files. // CHOMPEdit - Removal of obj/item/weapon

// Optional hardware (improves functionality, but is not critical for computer to work in most cases)
#define  PART_BATTERY  	/obj/item/computer_hardware/battery_module				// An internal power source for this computer. Can be recharged. // CHOMPEdit - Removal of obj/item/weapon
#define  PART_CARD  	/obj/item/computer_hardware/card_slot				// ID Card slot component of this computer. Mostly for HoP modification console that needs ID slot for modification. // CHOMPEdit - Removal of obj/item/weapon
#define  PART_PRINTER  	/obj/item/computer_hardware/nano_printer					// Nano Printer component of this computer, for your everyday paperwork needs. // CHOMPEdit - Removal of obj/item/weapon
//#define  PART_DRIVE  	/obj/item/computer_hardware/hard_drive/portable			// Portable data storage // CHOMPEdit - Removal of obj/item/weapon
//#define  PART_AI  		/obj/item/computer_hardware/ai_slot						// AI slot, an intellicard housing that allows modifications of AIs. // CHOMPEdit - Removal of obj/item/weapon
#define  PART_TESLA  	/obj/item/computer_hardware/tesla_link					// Tesla Link, Allows remote charging from nearest APC. // CHOMPEdit - Removal of obj/item/weapon
//#define  PART_SCANNER  	/obj/item/computer_hardware/scanner						// One of several optional scanner attachments. // CHOMPEdit - Removal of obj/item/weapon
