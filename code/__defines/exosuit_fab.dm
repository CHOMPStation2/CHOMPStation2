...
/// Module is compatible with Pinnace Fighter models // CHOMPedit: Buildable fighters.
...
/// Module is compatible with "Fighters" Fighter models - Pinnace, Baron // CHOMPedit: Buildable fighters.
