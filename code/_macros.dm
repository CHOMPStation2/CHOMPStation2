...
#define to_chat(target, message) target << message //No, fuck your fucking garbage ass VChat lag my server asscrack fucking bullshit go shove that shit right back up your fucking asshole you little motherfucking cunt
// #define to_chat to_chat_filename=__FILE__;to_chat_line=__LINE__;to_chat_src=src;__to_chat
#define bicon(target) "\icon[target]"
