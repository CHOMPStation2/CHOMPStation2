...
/obj/item/proc/can_contaminate()
	...
	if(flags & PHORONGUARD)
		return 0
	else if(istype(src,/obj/item/storage/backpack)) // CHOMPEdit - Removal of obj/item/weapon
...
//	if(istype(back,/obj/item/storage/backpack)) // CHOMPEdit - Removal of obj/item/weapon
//		back.contaminate()
