// Specific types
/datum/mini_hud/rig
	var/obj/item/rig/owner_rig // CHOMPEdit - Removal of obj/item/weapon
...
/datum/mini_hud/rig/New(var/datum/hud/other, var/obj/item/rig/owner) // CHOMPEdit - Removal of obj/item/weapon
	owner_rig = owner
	power = new ()
	health = new ()
	air = new ()
...
/datum/mini_hud/rig/process()
	...
	var/obj/item/cell/rigcell = owner_rig.cell // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/tank/rigtank = owner_rig.air_supply // CHOMPEdit - Removal of obj/item/weapon
...
/datum/mini_hud/mech/process()
	...
	var/obj/item/cell/mechcell = owner_mech.cell // CHOMPEdit - Removal of obj/item/weapon
...
/obj/screen/rig/airtoggle/Click()
	...
	if(!istype(user) || user.stat || user.incapacitated())
		return
	var/obj/item/rig/owner_rig = master // CHOMPEdit - Removal of obj/item/weapon
