...
/obj/screen/close/Click()
	if(master)
		if(istype(master, /obj/item/storage)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/storage/S = master // CHOMPEdit - Removal of obj/item/weapon
			S.close(usr)
	return 1
...
/obj/screen/grab/Click()
	var/obj/item/grab/G = master // CHOMPEdit - Removal of obj/item/weapon
	G.s_click(src)
	return 1
				...
				if(!C.stat && !C.stunned && !C.paralysis && !C.restrained())
					if(C.internal)
						...
						if(no_mask)
							...
							var/obj/item/rig/Rig = C.get_rig() // CHOMPEdit - Removal of obj/item/weapon
							if(Rig)
							...
							for(var/i=1, i<tankcheck.len+1, ++i)
								if(istype(tankcheck[i], /obj/item/tank)) // CHOMPEdit - Removal of obj/item/weapon
									var/obj/item/tank/t = tankcheck[i] // CHOMPEdit - Removal of obj/item/weapon
...
/obj/screen/movable/mapper_holder
	...
	var/obj/item/mapping_unit/owner // CHOMPEdit - Removal of obj/item/device
...
/obj/screen/ammo/proc/add_hud(var/mob/living/user, var/obj/item/gun/G) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/screen/ammo/proc/update_hud(var/mob/living/user, var/obj/item/gun/G) // CHOMPEdit - Removal of obj/item/weapon
