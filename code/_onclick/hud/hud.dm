...
/datum/hud/proc/add_ammo_hud(mob/living/user, obj/item/gun/G) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/hud/proc/remove_ammo_hud(mob/living/user, obj/item/gun/G) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/hud/proc/update_ammo_hud(mob/living/user, obj/item/gun/G) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/screen/ammo/ammo_hud = ammo_hud_list[G]
	ammo_hud?.update_hud(user, G)
