...
/datum/antagonist/traitor/infiltrator/equip(var/mob/living/carbon/human/traitor_mob)
	...
	if(istype(traitor_mob) || istype(traitor_mob, /mob/living/silicon/ai))
		var/obj/item/radio/headset/R // CHOMPEdit - Removal of obj/item/device
		R = locate(/obj/item/radio/headset) in traitor_mob.contents // CHOMPEdit - Removal of obj/item/device
		if(!R)
			...
			var/obj/item/encryptionkey/syndicate/encrypt_key = new(null) // CHOMPEdit - Removal of obj/item/device
