...
/datum/antagonist/traitor/proc/spawn_uplink(var/mob/living/carbon/human/traitor_mob)
	...
	if(traitor_mob.client.prefs.uplinklocation == "Headset")
		R = locate(/obj/item/radio) in traitor_mob.contents // CHOMPEdit - Removal of obj/item/device
		if(!R)
			R = locate(/obj/item/pda) in traitor_mob.contents // CHOMPEdit - Removal of obj/item/device
	...
	if(istype(R,/obj/item/radio)) // CHOMPEdit - Removal of obj/item/device
		// generate list of radio freqs
		var/obj/item/radio/target_radio = R // CHOMPEdit - Removal of obj/item/device
		...
		var/obj/item/uplink/hidden/T = new(R, traitor_mob.mind) // CHOMPEdit - Removal of obj/item/device
	...
	else if (istype(R, /obj/item/pda)) // CHOMPEdit - Removal of obj/item/device
		// generate a passcode if the uplink is hidden in a PDA
		var/pda_pass = "[rand(100,999)] [pick("Alpha","Bravo","Delta","Omega")]"
		var/obj/item/uplink/hidden/T = new(R, traitor_mob.mind) // CHOMPEdit - Removal of obj/item/device
		R.hidden_uplink = T
		var/obj/item/pda/P = R // CHOMPEdit - Removal of obj/item/device
