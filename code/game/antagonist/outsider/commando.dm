...
/datum/antagonist/deathsquad/mercenary/equip(var/mob/living/carbon/human/player)
	...
	player.equip_to_slot_or_del(new /obj/item/gun/projectile/silenced(player), slot_belt) // CHOMPEdit - Removal of obj/item/weapon
	...
	player.equip_to_slot_or_del(new /obj/item/storage/box(player), slot_in_backpack) // CHOMPEdit - Removal of obj/item/weapon
	player.equip_to_slot_or_del(new /obj/item/ammo_magazine/clip/c45(player), slot_in_backpack)
	player.equip_to_slot_or_del(new /obj/item/rig/merc(player), slot_back) // CHOMPEdit - Removal of obj/item/weapon
