...
/datum/antagonist/ninja/equip(var/mob/living/carbon/human/player)
	...
	var/obj/item/radio/R = new /obj/item/radio/headset(player) // CHOMPEdit - Removal of obj/item/device
	player.equip_to_slot_or_del(R, slot_l_ear)
	player.equip_to_slot_or_del(new /obj/item/clothing/under/color/black(player), slot_w_uniform)
	player.equip_to_slot_or_del(new /obj/item/flashlight(player), slot_belt) // CHOMPEdit - Removal of obj/item/device
	create_id("Infiltrator", player)

	var/obj/item/rig/light/ninja/ninjasuit = new(get_turf(player)) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(istype(player.back,/obj/item/rig)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/rig/rig = player.back // CHOMPEdit - Removal of obj/item/weapon
		if(rig.air_supply)
