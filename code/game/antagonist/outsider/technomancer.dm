...
/datum/antagonist/technomancer/equip(var/mob/living/carbon/human/technomancer_mob)
	...
	technomancer_mob.equip_to_slot_or_del(new /obj/item/disposable_teleporter/free(technomancer_mob), slot_r_store) // CHOMPEdit - Removal of obj/item/weapon
	technomancer_mob.equip_to_slot_or_del(new /obj/item/technomancer_catalog(technomancer_mob), slot_l_store) // CHOMPEdit - Removal of obj/item/weapon
	technomancer_mob.equip_to_slot_or_del(new /obj/item/radio/headset(technomancer_mob), slot_l_ear) // CHOMPEdit - Removal of obj/item/device
	var/obj/item/technomancer_core/core = new /obj/item/technomancer_core(technomancer_mob) // CHOMPEdit - Removal of obj/item/weapon
	technomancer_mob.equip_to_slot_or_del(core, slot_back)
	technomancer_belongings.Add(core) // So it can be Tracked.
	technomancer_mob.equip_to_slot_or_del(new /obj/item/flashlight(technomancer_mob), slot_belt) // CHOMPEdit - Removal of obj/item/device
...
/datum/antagonist/technomancer/proc/equip_apprentice(var/mob/living/carbon/human/technomancer_mob)
	...
	var/obj/item/technomancer_catalog/apprentice/catalog = new /obj/item/technomancer_catalog/apprentice() // CHOMPEdit - Removal of obj/item/weapon
...
/datum/antagonist/technomancer/print_player_summary()
	..()
	for(var/obj/item/technomancer_core/core in technomancer_belongings) // CHOMPEdit - Removal of obj/item/weapon
		if(core.wearer)
...
/datum/antagonist/technomancer/print_player_full(var/datum/mind/player)
	...
	var/obj/item/technomancer_core/core // CHOMPEdit - Removal of obj/item/weapon
	if(player.original)
