...
/datum/antagonist/deathsquad/equip(var/mob/living/carbon/human/player)
	...
	if (player.mind == leader)
		player.equip_to_slot_or_del(new /obj/item/pinpointer(player), slot_l_store) // CHOMPEdit - Removal of obj/item/weapon
		player.equip_to_slot_or_del(new /obj/item/disk/nuclear(player), slot_r_store) // CHOMPEdit - Removal of obj/item/weapon
	else
		player.equip_to_slot_or_del(new /obj/item/plastique(player), slot_l_store) // CHOMPEdit - Removal of obj/item/weapon
	player.equip_to_slot_or_del(new /obj/item/gun/projectile/revolver/mateba(player), slot_belt) // CHOMPEdit - Removal of obj/item/weapon
	player.equip_to_slot_or_del(new /obj/item/gun/energy/pulse_rifle(player), slot_r_hand) // CHOMPEdit - Removal of obj/item/weapon
	player.equip_to_slot_or_del(new /obj/item/rig/ert/assetprotection(player), slot_back) // CHOMPEdit - Removal of obj/item/weapon
	player.equip_to_slot_or_del(new /obj/item/melee/energy/sword(player), slot_s_store) // CHOMPEdit - Removal of obj/item/weapon
//	player.implant_loyalty()

	var/obj/item/card/id/id = create_id("Asset Protection", player) // CHOMPEdit - Removal of obj/item/weapon
	if(id)
