...
/obj/machinery/clonepod
	...
	density = TRUE
	anchored = TRUE
	circuit = /obj/item/circuitboard/clonepod // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/clonepod/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(isnull(occupant))
	...
	if(istype(W, /obj/item/card/id)||istype(W, /obj/item/pda)) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	...
	else if(istype(W,/obj/item/reagent_containers/glass)) // CHOMPEdit - Removal of obj/item/weapon
		...
		var/obj/item/multitool/M = W // CHOMPEdit - Removal of obj/item/device
		M.connecting = src
...
/obj/machinery/clonepod/RefreshParts()
	...
	speed_coeff = 0
	efficiency = 0
	for(var/obj/item/stock_parts/scanning_module/S in component_parts) // CHOMPEdit - Removal of obj/item/weapon
		efficiency += S.rating
	for(var/obj/item/stock_parts/manipulator/P in component_parts) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/clonepod/proc/get_biomass()
	...
	if(LAZYLEN(containers))
		for(var/obj/item/reagent_containers/glass/G in containers) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/implant/health // CHOMPEdit - Removal of obj/item/weapon
	name = "health implant"
	known_implant = TRUE
	var/healthstring = ""

/obj/item/implant/health/proc/sensehealth() // CHOMPEdit - Removal of obj/item/weapon
	if(!implanted)
		return "ERROR"
	else
...
/obj/item/disk/data // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/disk/data/proc/initializeDisk() // CHOMPEdit - Removal of obj/item/weapon
	buf = new
	buf.dna=new

/obj/item/disk/data/demo // CHOMPEdit - Removal of obj/item/weapon
	name = "data disk - 'God Emperor of Mankind'"
	read_only = 1

/obj/item/disk/data/demo/New() // CHOMPEdit - Removal of obj/item/weapon
	initializeDisk()
...
/obj/item/disk/data/monkey // CHOMPEdit - Removal of obj/item/weapon
	name = "data disk - 'Mr. Muggles'"
	read_only = 1

/obj/item/disk/data/monkey/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	initializeDisk()
...
/obj/item/disk/data/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	var/diskcolor = pick(0,1,2)
	icon_state = "datadisk[diskcolor]"

/obj/item/disk/data/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	read_only = !read_only
	to_chat(user, "You flip the write-protect tab to [read_only ? "protected" : "unprotected"].")

/obj/item/disk/data/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/storage/box/disks/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	new /obj/item/disk/data(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/disk/data(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/disk/data(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/disk/data(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/disk/data(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/Cloning // CHOMPEdit - Removal of obj/item/weapon
