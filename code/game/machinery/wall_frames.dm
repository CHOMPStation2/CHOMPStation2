...
/obj/item/frame/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/frame/attack_self(mob/user as mob)
	...
	if(istype(src.loc, /obj/item/gripper)) //Typical gripper shenanigans // CHOMPEdit - Removal of obj/item/weapon
		user.drop_item()
	qdel(src)
