...
/obj/machinery/telecomms/receiver
	...
	machinetype = 1
	produces_heat = 0
	circuit = /obj/item/circuitboard/telecomms/receiver // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/telecomms/receiver/proc/link_radio(var/obj/item/radio/R) // CHOMPEdit - Removal of obj/item/device
	if(!istype(R))
		return
...
/obj/machinery/telecomms/receiver/proc/check_receive_level(datum/signal/signal)
	...
	if(signal.transmission_method == TRANSMISSION_BLUESPACE)
		var/obj/item/radio/R = signal.data["radio"] // CHOMPEdit - Removal of obj/item/device
...
/obj/machinery/telecomms/hub
	...
	machinetype = 7
	circuit = /obj/item/circuitboard/telecomms/hub // CHOMPEdit - Removal of obj/item/weapon
	long_range_link = 1
	netspeed = 40
...
/obj/machinery/telecomms/relay
	...
	machinetype = 8
	produces_heat = 0
	circuit = /obj/item/circuitboard/telecomms/relay // CHOMPEdit - Removal of obj/item/weapon
	netspeed = 5
	long_range_link = 1
	var/broadcasting = 1
	var/receiving = 1
...
/obj/machinery/telecomms/bus
	...
	machinetype = 2
	circuit = /obj/item/circuitboard/telecomms/bus // CHOMPEdit - Removal of obj/item/weapon
	netspeed = 40
...
/obj/machinery/telecomms/processor
	...
	machinetype = 3
	delay = 5
	circuit = /obj/item/circuitboard/telecomms/processor // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/telecomms/server
	...
	machinetype = 4
	circuit = /obj/item/circuitboard/telecomms/server // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/radio/headset/server_radio = null // CHOMPEdit - Removal of obj/item/device
