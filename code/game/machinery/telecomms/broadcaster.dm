...
/obj/machinery/telecomms/broadcaster
	...
	produces_heat = 0
	delay = 7
	circuit = /obj/item/circuitboard/telecomms/broadcaster // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/telecomms/broadcaster/proc/link_radio(var/obj/item/radio/R) // CHOMPEdit - Removal of obj/item/device
	if(!istype(R))
		return
...
/obj/machinery/telecomms/broadcaster/receive_information(datum/signal/signal, obj/machinery/telecomms/machine_from)
	...
	if(signal.data["message"])
		...
		for(var/datum/weakref/wr in linked_radios_weakrefs)
			var/obj/item/radio/R = wr.resolve() // CHOMPEdit - Removal of obj/item/device
			if(istype(R))
...
/obj/machinery/telecomms/allinone/proc/link_radio(var/obj/item/radio/R) // CHOMPEdit - Removal of obj/item/device
	if(!istype(R))
		return
	linked_radios_weakrefs |= WEAKREF(R)
...
/proc/Broadcast_Message(var/datum/radio_frequency/connection, var/mob/M,
						var/vmask, var/list/vmessage_pieces, var/obj/item/radio/radio, // CHOMPEdit - Removal of obj/item/device
  ...
  /* ###### Prepare the radio connection ###### */
	...
	var/list/obj/item/radio/radios = list() // CHOMPEdit - Removal of obj/item/device

	for(var/obj/item/radio/R in forced_radios) // CHOMPEdit - Removal of obj/item/device
	...
	if(data == DATA_INTERCOM)
		...
		for (var/obj/item/radio/intercom/R in connection.devices["[RADIO_CHAT]"]) // CHOMPEdit - Removal of obj/item/device
	...
	// --- Broadcast only to intercoms and station-bounced radios ---
		...
		for (var/obj/item/radio/R in connection.devices["[RADIO_CHAT]"]) // CHOMPEdit - Removal of obj/item/device

			if(istype(R, /obj/item/radio/headset) && !R.adhoc_fallback) // CHOMPEdit - Removal of obj/item/device
				continue
	...
	// --- Broadcast to antag radios! ---
		...
		for(var/antag_freq in ANTAG_FREQS)
			...
			for (var/obj/item/radio/R in antag_connection.devices["[RADIO_CHAT]"]) // CHOMPEdit - Removal of obj/item/device
  ...
  /* ###### Prepare the radio connection ###### */
	...
	// --- Broadcast only to intercoms and station-bounced radios ---
		...
		for (var/obj/item/radio/R in connection.devices["[RADIO_CHAT]"]) // CHOMPEdit - Removal of obj/item/device
			...
			if(istype(R, /obj/item/radio/headset)) // CHOMPEdit - Removal of obj/item/device
				continue
			var/turf/position = get_turf(R)
			if(position && position.z == level)
				receive |= R.send_hear(display_freq)
  ...
  /* ###### Begin formatting and sending the message ###### */
	if(length(heard_normal) || length(heard_garbled) || length(heard_gibberish))
	  ...
	  /* --- Some miscellaneous variables to format the string output --- */
		...
		var/obj/item/radio/headset/radio = new // CHOMPEdit - Removal of obj/item/device
