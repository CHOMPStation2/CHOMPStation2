...
/obj/machinery/partslathe
	...
	circuit = /obj/item/circuitboard/partslathe // CHOMPEdit - Removal of obj/item/weapon
	anchored = TRUE
	density = TRUE
	...
	var/obj/item/circuitboard/copy_board // Inserted board // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/partslathe/RefreshParts()
	var/mb_rating = 0
	for(var/obj/item/stock_parts/matter_bin/M in component_parts) // CHOMPEdit - Removal of obj/item/weapon
		mb_rating += M.rating
...
/obj/machinery/partslathe/attackby(var/obj/item/O as obj, var/mob/user as mob)
	...
	if(panel_open)
		...
		return
	if(istype(O, /obj/item/circuitboard)) // CHOMPEdit - Removal of obj/item/weapon
		if(copy_board)
...
/obj/machinery/partslathe/proc/update_recipe_list()
	if(!partslathe_recipies)
		...
		var/list/paths = subtypesof(/obj/item/stock_parts) // CHOMPEdit - Removal of obj/item/weapon
		for(var/type in paths)
			var/obj/item/stock_parts/I = new type() // CHOMPEdit - Removal of obj/item/weapon
