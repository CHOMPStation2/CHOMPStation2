...
/datum/file/program/card_comp
	...
	var/obj/item/card/id/reader = null // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/card/id/writer = null // CHOMPEdit - Removal of obj/item/weapon
...
/datum/file/program/card_comp/Topic(href, list/href_list)
	...
	if("insert" in href_list)
		var/obj/item/card/card = usr.get_active_hand() // CHOMPEdit - Removal of obj/item/weapon
	...
	if("print" in href_list)
		...
		printing = 1
		sleep(50)
		var/obj/item/paper/P = new /obj/item/paper( computer.loc ) // CHOMPEdit - Removal of obj/item/weapon
