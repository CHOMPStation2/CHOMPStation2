/obj/machinery/camera
	...
	var/invuln = 0
	var/bugged = 0
	var/obj/item/camera_assembly/assembly = null // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/camera/attackby(obj/item/W as obj, mob/living/user as mob)
	...
	// OTHER
	else if (can_use() && (istype(W, /obj/item/paper) || istype(W, /obj/item/pda)) && isliving(user)) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
		var/mob/living/U = user
		var/obj/item/paper/X = null // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/pda/P = null // CHOMPEdit - Removal of obj/item/device
	...
	else if (istype(W, /obj/item/camera_bug)) // CHOMPEdit - Removal of obj/item/weapon
		if (!src.can_use())
...
/obj/machinery/camera/proc/weld(var/obj/item/weldingtool/WT, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	WT = WT.get_welder()
