/obj/item/camera_assembly // CHOMPEdit - Removal of obj/item/weapon
	...
	var/list/obj/item/possible_upgrades = list(/obj/item/assembly/prox_sensor, /obj/item/stack/material/osmium, /obj/item/stock_parts/scanning_module) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
...
/obj/item/camera_assembly/attackby(obj/item/W as obj, mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/camera_assembly/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(anchored)
		icon_state = "camera1"
	else
		icon_state = "cameracase"

/obj/item/camera_assembly/attack_hand(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!anchored)
		..()

/obj/item/camera_assembly/proc/weld(var/obj/item/weldingtool/WT, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	WT = WT.get_welder()
