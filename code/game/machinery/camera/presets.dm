...
/obj/machinery/camera/proc/isXRay()
	var/obj/item/stock_parts/scanning_module/O = locate(/obj/item/stock_parts/scanning_module) in assembly.upgrades // CHOMPEdit - Removal of obj/item/weapon
	if (O && O.rating >= 2)
		return O
	return null

/obj/machinery/camera/proc/isMotion()
	var/O = locate(/obj/item/assembly/prox_sensor) in assembly.upgrades // CHOMPEdit - Removal of obj/item/device
	return O
...
/obj/machinery/camera/proc/upgradeXRay()
	assembly.upgrades.Add(new /obj/item/stock_parts/scanning_module/adv(assembly)) // CHOMPEdit - Removal of obj/item/weapon
	setPowerUsage()
	update_coverage()
...
/obj/machinery/camera/proc/upgradeMotion()
	if(!isturf(loc))
		return //nooooo
	assembly.upgrades.Add(new /obj/item/assembly/prox_sensor(assembly)) // CHOMPEdit - Removal of obj/item/device
	setPowerUsage()
