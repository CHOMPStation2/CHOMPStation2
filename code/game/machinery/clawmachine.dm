...
/obj/machinery/clawmachine/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(busy)
...
/obj/machinery/clawmachine/proc/insert_cash(var/obj/item/spacecash/cashmoney, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if (ispowered == 0)
		return
	if (isbroken)
		return
