...
/obj/machinery/biogenerator
	...
	density = TRUE
	anchored = TRUE
	circuit = /obj/item/circuitboard/biogenerator // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/biogenerator/Initialize()
	...
	beaker = new /obj/item/reagent_containers/glass/bottle(src) // CHOMPEdit - Removal of obj/item/weapon
	default_apply_parts()
	...
	item_list["Food Items"] = list(
		...
		BIOGEN_ITEM("Slab of meat", /obj/item/reagent_containers/food/snacks/meat, 1, 50), // CHOMPEdit - Removal of obj/item/weapon
		BIOGEN_ITEM("Slabs of meat x5", /obj/item/reagent_containers/food/snacks/meat, 5, 250), // CHOMPEdit - Removal of obj/item/weapon
	)
	item_list["Cooking Ingredients"] = list(
		...
		BIOGEN_ITEM("Nutri-spread", /obj/item/reagent_containers/food/snacks/spreads, 1, 30), // CHOMPEdit - Removal of obj/item/weapon
		BIOGEN_ITEM("Nutri-spread x5", /obj/item/reagent_containers/food/snacks/spreads, 5, 120), // CHOMPEdit - Removal of obj/item/weapon
	)
	item_list["Gardening Nutrients"] = list(
		BIOGEN_ITEM("E-Z-Nutrient", /obj/item/reagent_containers/glass/bottle/eznutrient, 1, 60), // CHOMPEdit - Removal of obj/item/weapon
		BIOGEN_ITEM("E-Z-Nutrient x5", /obj/item/reagent_containers/glass/bottle/eznutrient, 5, 300), // CHOMPEdit - Removal of obj/item/weapon
		BIOGEN_ITEM("Left 4 Zed", /obj/item/reagent_containers/glass/bottle/left4zed, 1, 120), // CHOMPEdit - Removal of obj/item/weapon
		BIOGEN_ITEM("Left 4 Zed x5", /obj/item/reagent_containers/glass/bottle/left4zed, 5, 600), // CHOMPEdit - Removal of obj/item/weapon
		BIOGEN_ITEM("Robust Harvest", /obj/item/reagent_containers/glass/bottle/robustharvest, 1, 150), // CHOMPEdit - Removal of obj/item/weapon
		BIOGEN_ITEM("Robust Harvest x5", /obj/item/reagent_containers/glass/bottle/robustharvest, 5, 750), // CHOMPEdit - Removal of obj/item/weapon
	)
	item_list["Leather Products"] = list(
		BIOGEN_ITEM("Wallet", /obj/item/storage/wallet, 1, 100), // CHOMPEdit - Removal of obj/item/weapon
		BIOGEN_ITEM("Botanical gloves", /obj/item/clothing/gloves/botanic_leather, 1, 250),
		BIOGEN_ITEM("Plant bag", /obj/item/storage/bag/plants, 1, 320), // CHOMPEdit - Removal of obj/item/weapon
		BIOGEN_ITEM("Large plant bag", /obj/item/storage/bag/plants/large, 1, 640), // CHOMPEdit - Removal of obj/item/weapon
		BIOGEN_ITEM("Utility belt", /obj/item/storage/belt/utility, 1, 300), // CHOMPEdit - Removal of obj/item/weapon
		BIOGEN_ITEM("Leather Satchel", /obj/item/storage/backpack/satchel, 1, 400), // CHOMPEdit - Removal of obj/item/weapon
		BIOGEN_ITEM("Cash Bag", /obj/item/storage/bag/cash, 1, 400), // CHOMPEdit - Removal of obj/item/weapon
		BIOGEN_ITEM("Chemistry Bag", /obj/item/storage/bag/chemistry, 1, 400), // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/biogenerator/attackby(var/obj/item/O as obj, var/mob/user as mob)
	...
	if(default_unfasten_wrench(user, O, 40))
		return
	if(istype(O, /obj/item/reagent_containers/glass)) // CHOMPEdit - Removal of obj/item/weapon
		if(beaker)
	...
	else if(istype(O, /obj/item/storage/bag/plants)) // CHOMPEdit - Removal of obj/item/weapon
		var/i = 0
		for(var/obj/item/reagent_containers/food/snacks/grown/G in contents) // CHOMPEdit - Removal of obj/item/weapon
			i++
		if(i >= 10)
			to_chat(user, "<span class='notice'>\The [src] is already full! Activate it.</span>")
		else
			for(var/obj/item/reagent_containers/food/snacks/grown/G in O.contents) // CHOMPEdit - Removal of obj/item/weapon
				G.loc = src
				i++
				if(i >= 10)
	...
	else if(!istype(O, /obj/item/reagent_containers/food/snacks/grown)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/biogenerator/proc/activate()
	...
	if(processing)
		...
		return
	var/S = 0
	for(var/obj/item/reagent_containers/food/snacks/grown/I in contents) // CHOMPEdit - Removal of obj/item/weapon
		S += 5
...
/obj/machinery/biogenerator/RefreshParts()
	...
	for(var/obj/item/stock_parts/P in component_parts) // CHOMPEdit - Removal of obj/item/weapon
		if(istype(P, /obj/item/stock_parts/matter_bin)) // CHOMPEdit - Removal of obj/item/weapon
			bin_rating += P.rating
		if(istype(P, /obj/item/stock_parts/manipulator)) // CHOMPEdit - Removal of obj/item/weapon
			man_rating += P.rating
