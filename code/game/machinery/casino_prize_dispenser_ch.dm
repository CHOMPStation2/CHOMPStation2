...
/obj/machinery/casino_prize_dispenser/process() //Might not need this, but just to be safe for now
	if(stat & (BROKEN|NOPOWER))
		return
||||||| parent of 737c473e4b... [MIRROR] :siffet: (#11584):code/modules/casino/casino_prize_vendor.dm
...
/obj/machinery/casino_prize_dispenser/process() //Might not need this, but just to be safe for now
	if(stat & (BROKEN|NOPOWER))
		return
>>>>>>> 737c473e4b... [MIRROR] :siffet: (#11584):code/modules/casino/casino_prize_vendor.dm
