...
/obj/machinery/iv_drip/var/obj/item/reagent_containers/beaker = null // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/iv_drip/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(attached && beaker)
		...
		if(mode)
			if(beaker.volume > 0)
				...
				if(istype(beaker, /obj/item/reagent_containers/blood)) // CHOMPEdit - Removal of obj/item/weapon
