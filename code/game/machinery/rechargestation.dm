/obj/machinery/recharge_station
	...
	anchored = TRUE
	unacidable = TRUE
	circuit = /obj/item/circuitboard/recharge_station // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/recharge_station/proc/process_occupant()
	...
	//VOREStation Add End
		...
		if(H.wearing_rig) // stepping into a borg charger to charge your rig and fix your shit
			var/obj/item/rig/wornrig = H.get_rig() // CHOMPEdit - Removal of obj/item/weapon
			if(wornrig) // just to make sure
				...
				if(wornrig.cell)
					var/obj/item/cell/rigcell = wornrig.cell // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/recharge_station/attackby(var/obj/item/O as obj, var/mob/user as mob)
	if(!occupant)
		...
		if(default_part_replacement(user, O))
			return
		if (istype(O, /obj/item/grab) && get_dist(src,user)<2) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/recharge_station/RefreshParts()
	...
	for(var/obj/item/stock_parts/P in component_parts) // CHOMPEdit - Removal of obj/item/weapon
		...
		if(istype(P, /obj/item/stock_parts/manipulator)) // CHOMPEdit - Removal of obj/item/weapon
			man_rating += P.rating
	cell = locate(/obj/item/cell) in component_parts // CHOMPEdit - Removal of obj/item/weapon
