...
/obj/machinery/computer/message_monitor
	...
	light_color = "#00b000"
	var/hack_icon = "error"
	circuit = /obj/item/circuitboard/message_monitor // CHOMPEdit - Removal of obj/item/weapon
	//Server linked to.
	...
	var/obj/item/pda/customrecepient = null // CHOMPEdit - Removal of obj/item/device
	var/customjob		= "Admin"
	var/custommessage 	= "This is a test, please ignore."
	var/list/temp = null

/obj/machinery/computer/message_monitor/attackby(obj/item/O as obj, mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/message_monitor/emag_act(var/remaining_charges, var/mob/user)
	...
	if(!emag && operable())
		if(!isnull(linkedServer))
			...
			spark_system.start()
			var/obj/item/paper/monitorkey/MK = new/obj/item/paper/monitorkey // CHOMPEdit - Removal of obj/item/weapon
			MK.loc = loc
...
/obj/machinery/computer/message_monitor/tgui_data(mob/user)
	...
	if(linkedServer && auth)
		...
		var/list/obj/item/pda/sendPDAs = list() // CHOMPEdit - Removal of obj/item/device
...
/obj/machinery/computer/message_monitor/tgui_act(action, params)
	...
	switch(action)
		...
		if("set_recipient")
			var/ref = params["val"]
			var/obj/item/pda/P = locate(ref) // CHOMPEdit - Removal of obj/item/device
		...
		if("send_message")
			...
			var/obj/item/pda/PDARec = null // CHOMPEdit - Removal of obj/item/device
			for(var/obj/item/pda/P in PDAs) // CHOMPEdit - Removal of obj/item/device
				if(!P.owner || P.hidden)
					continue
				var/datum/data/pda/app/messenger/M = P.find_program(/datum/data/pda/app/messenger)
...
/obj/item/paper/monitorkey // CHOMPEdit - Removal of obj/item/weapon
	name = "Monitor Decryption Key"

/obj/item/paper/monitorkey/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	..()
	return INITIALIZE_HINT_LATELOAD

/obj/item/paper/monitorkey/LateInitialize() // CHOMPEdit - Removal of obj/item/weapon
	if(message_servers)
