/obj/machinery/computer/arcade
	...
	var/list/prizes = list(	/obj/item/storage/box/snappops					= 2, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/toy/blink										= 2,
							/obj/item/clothing/under/syndicate/tacticool			= 2,
							/obj/item/toy/sword										= 2,
							/obj/item/storage/box/capguntoy					= 2, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/gun/projectile/revolver/toy/crossbow	= 2, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/clothing/suit/syndicatefake					= 2,
							/obj/item/storage/fancy/crayons					= 2, // CHOMPEdit - Removal of obj/item/weapon
							/obj/item/toy/spinningtoy								= 2,
							/obj/random/mech_toy									= 1,
							/obj/item/reagent_containers/spray/waterflower	= 1, // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/arcade/Initialize()
	...
	if(!circuit)
		var/choice = pick(subtypesof(/obj/item/circuitboard/arcade) - /obj/item/circuitboard/arcade/clawmachine) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/circuitboard/CB = new choice() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/arcade/battle
	...
	icon_state = "arcade2"
	icon_screen = "battler"
	circuit = /obj/item/circuitboard/arcade/battle // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/arcade/orion_trail
	...
	icon_state = "arcade1"
	icon_screen = "orion"
	circuit = /obj/item/circuitboard/arcade/orion_trail // CHOMPEdit - Removal of obj/item/weapon
				...
				if(prob(success))
					...
					if(prob(success*5))
						...
						if(emagged)
							...
							var/obj/item/handcuffs/C = new(src.loc) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/arcade/orion_trail/proc/win()
	...
	if(emagged)
		new /obj/item/orion_ship(src.loc) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/orion_ship // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/orion_ship/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/orion_ship/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(active)
		return
...
/obj/machinery/computer/arcade/clawmachine
	...
	icon_keyboard = null
	icon_screen = null
	circuit = /obj/item/circuitboard/arcade/clawmachine // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/arcade/clawmachine/attackby(obj/item/I as obj, mob/user as mob)
	...
	if(gamepaid == 0 && vendor_account && !vendor_account.suspended)
		var/paid = 0
		var/obj/item/card/id/W = I.GetID() // CHOMPEdit - Removal of obj/item/weapon
		if(W) //for IDs and PDAs and wallets with IDs
			paid = pay_with_card(W,I)
		else if(istype(I, /obj/item/spacecash/ewallet)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/spacecash/ewallet/C = I // CHOMPEdit - Removal of obj/item/weapon
			paid = pay_with_ewallet(C)
		else if(istype(I, /obj/item/spacecash)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/spacecash/C = I // CHOMPEdit - Removal of obj/item/weapon
...
////// Cash
/obj/machinery/computer/arcade/clawmachine/proc/pay_with_cash(var/obj/item/spacecash/cashmoney, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!emagged)
		...
		if(istype(cashmoney, /obj/item/spacecash)) // CHOMPEdit - Removal of obj/item/weapon
...
///// Ewallet
/obj/machinery/computer/arcade/clawmachine/proc/pay_with_ewallet(var/obj/item/spacecash/ewallet/wallet) // CHOMPEdit - Removal of obj/item/weapon
	if(!emagged)
...
///// ID
/obj/machinery/computer/arcade/clawmachine/proc/pay_with_card(var/obj/item/card/id/I, var/obj/item/ID_container) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/arcade/clawmachine/proc/clawvend() /// True to a real claw machine, it's NEARLY impossible to win.
	...
	if(prob(winprob)) /// YEAH.
		if(!emagged)
			...
			emagged = 0
			winscreen = "You won...?"
			var/obj/item/grenade/G = new /obj/item/grenade/explosive(get_turf(src)) /// YEAAAAAAAAAAAAAAAAAAH!!!!!!!!!! // CHOMPEdit - Removal of obj/item/weapon
			G.activate()
