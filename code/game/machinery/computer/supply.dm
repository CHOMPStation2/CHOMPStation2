...
/obj/machinery/computer/supplycomp
	...
	icon_screen = "request"
	circuit = /obj/item/circuitboard/supplycomp // CHOMPEdit - Removal of obj/item/weapon
	var/authorization = 0
	var/temp = null
...
/obj/machinery/computer/supplycomp/control
	...
	circuit = /obj/item/circuitboard/supplycomp/control // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/supplycomp/tgui_act(action, params)
	...
	switch(action)
		...
		if("request_crate_multi")
			...
			var/obj/item/paper/reqform = new /obj/item/paper(loc) // CHOMPEdit - Removal of obj/item/weapon
