...
/obj/machinery/computer/prisoner
	...
	circuit = /obj/item/circuitboard/prisoner // CHOMPEdit - Removal of obj/item/weapon
	var/id = 0.0
	var/temp = null
	var/status = 0
	var/timeleft = 60
...
/obj/machinery/computer/prisoner/tgui_data(mob/user)
	...
	if(screen)
		for(var/obj/item/implant/chem/C in GLOB.all_chem_implants) // CHOMPEdit - Removal of obj/item/weapon
		...
		for(var/obj/item/implant/tracking/track in GLOB.all_tracking_implants) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/prisoner/tgui_act(action, list/params)
	...
	switch(action)
		if("inject")
			var/obj/item/implant/I = locate(params["imp"]) // CHOMPEdit - Removal of obj/item/weapon
			if(I)
