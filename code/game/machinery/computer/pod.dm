...
/obj/machinery/computer/pod
	...
	light_color = "#00b000"
	circuit = /obj/item/circuitboard/pod // CHOMPEdit - Removal of obj/item/weapon
	var/id = 1.0
	...
	if(I.has_tool_quality(TOOL_SCREWDRIVER))
		...
		if(do_after(user, 20))
			if(stat & BROKEN)
				...
				new /obj/item/material/shard( loc ) // CHOMPEdit - Removal of obj/item/weapon

				//generate appropriate circuitboard. Accounts for /pod/old computer types
				var/obj/item/circuitboard/pod/M = null // CHOMPEdit - Removal of obj/item/weapon
				if(istype(src, /obj/machinery/computer/pod/old))
					M = new /obj/item/circuitboard/olddoor( A ) // CHOMPEdit - Removal of obj/item/weapon
					if(istype(src, /obj/machinery/computer/pod/old/syndicate))
						M = new /obj/item/circuitboard/syndicatedoor( A ) // CHOMPEdit - Removal of obj/item/weapon
					if(istype(src, /obj/machinery/computer/pod/old/swf))
						M = new /obj/item/circuitboard/swfdoor( A ) // CHOMPEdit - Removal of obj/item/weapon
				else //it's not an old computer. Generate standard pod circuitboard.
					M = new /obj/item/circuitboard/pod( A ) // CHOMPEdit - Removal of obj/item/weapon
