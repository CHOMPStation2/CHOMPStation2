...
//Guest pass ////////////////////////////////
/////////////////////////////////////////////
/obj/item/card/id/guest // CHOMPEdit - Removal of obj/item/weapon
	name = "guest pass"
...
/obj/item/card/id/guest/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/card/id/guest/GetAccess() // CHOMPEdit - Removal of obj/item/weapon
	if(world.time > expiration_time)
		return access
	else
		return temp_access

/obj/item/card/id/guest/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(world.time < expiration_time)
...
/obj/item/card/id/guest/read() // CHOMPEdit - Removal of obj/item/weapon
	if(!Adjacent(usr))
...
/obj/item/card/id/guest/attack_self(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/card/id/guest/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	START_PROCESSING(SSobj, src)
	update_icon()

/obj/item/card/id/guest/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	STOP_PROCESSING(SSobj, src)
	return ..()

/obj/item/card/id/guest/process() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/guestpass
	...
	icon_screen = "pass"
	density = FALSE
	circuit = /obj/item/circuitboard/guestpass // CHOMPEdit - Removal of obj/item/weapon

	var/obj/item/card/id/giver // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/guestpass/attackby(obj/I, mob/user)
	if(istype(I, /obj/item/card/id/guest)) // CHOMPEdit - Removal of obj/item/weapon
	...
	switch(action)
		...
		if("issue")
			if(giver)
				...
				var/obj/item/card/id/guest/pass = new(src.loc) // CHOMPEdit - Removal of obj/item/weapon
