...
/obj/machinery/computer/secure_data//TODO:SANITY
	...
	circuit = /obj/item/circuitboard/secure_data // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/secure_data/attackby(var/obj/item/O, var/mob/user)
	if(istype(O, /obj/item/card/id) && !scan && user.unEquip(O)) // CHOMPEdit - Removal of obj/item/weapon
		O.loc = src
		scan = O
...
/obj/machinery/computer/secure_data/proc/print_finish()
	var/obj/item/paper/P = new(loc) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/secure_data/proc/get_photo(var/mob/user)
	if(istype(user.get_active_hand(), /obj/item/photo)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/photo/photo = user.get_active_hand() // CHOMPEdit - Removal of obj/item/weapon
		return photo.img
