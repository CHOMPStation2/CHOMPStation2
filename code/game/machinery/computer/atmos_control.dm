/obj/item/circuitboard/atmoscontrol // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/atmoscontrol
	...
	density = TRUE
	anchored = TRUE
	circuit = /obj/item/circuitboard/atmoscontrol // CHOMPEdit - Removal of obj/item/weapon
