...
/obj/machinery/computer/attackby(I as obj, user as mob)
	if(computer_deconstruction_screwdriver(user, I))
		...
		if(istype(I,/obj/item/gripper)) //Behold, Grippers and their horribleness. If ..() is called by any computers' attackby() now or in the future, this should let grippers work with them appropriately. // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/gripper/B = I	//B, for Borg. // CHOMPEdit - Removal of obj/item/weapon
			if(!B.wrapped)
