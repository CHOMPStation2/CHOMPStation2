/obj/machinery/computer/aifixer
	...
	circuit = /obj/item/circuitboard/aifixer // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/aifixer/attackby(obj/item/I, mob/living/user)
	if(I.has_tool_quality(TOOL_SCREWDRIVER))
		if(occupier)
			...
			return
	if(istype(I, /obj/item/aicard)) // CHOMPEdit - Removal of obj/item/device
		if(stat & (NOPOWER|BROKEN))
		...
		var/obj/item/aicard/card = I // CHOMPEdit - Removal of obj/item/device
		if(occupier)
