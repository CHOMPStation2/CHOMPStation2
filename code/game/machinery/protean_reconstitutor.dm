/obj/machinery/protean_reconstitutor
	...
	var/obj/item/mmi/digital/posibrain/nano/protean_brain = null	//only allow protean brains, no midround upgrades to bypass the whitelist! // CHOMPEdit - Removal of obj/item/device
	...
	//component vars
	circuit = /obj/item/circuitboard/protean_reconstitutor // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/protean_reconstitutor/attackby(obj/item/W as obj, mob/user as mob)
	...
	if(istype(W,/obj/item/mmi/digital/posibrain/nano)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/mmi/digital/posibrain/nano/NB = W // CHOMPEdit - Removal of obj/item/device
...
/obj/machinery/protean_reconstitutor/attack_hand(mob/user as mob)
	...
	if(!protean_brain.brainmob.client)
		...
		var/obj/item/nif/protean/new_nif = new() // CHOMPEdit - Removal of obj/item/device
