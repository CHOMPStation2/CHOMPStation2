...
/obj/machinery/porta_turret
	...
	var/installation = /obj/item/gun/energy/gun		//the type of weapon installed // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/porta_turret/stationary
	ailock = TRUE
	lethal = TRUE
	installation = /obj/item/gun/energy/laser // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/porta_turret/ai_defense
	...
	installation = /obj/item/gun/energy/xray // For the armor pen. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/porta_turret/alien // The kind used on the UFO submap.
	...
	installation = /obj/item/gun/energy/alien // CHOMPEdit - Removal of obj/item/weapon
	enabled = TRUE
	lethal = TRUE
	ailock = TRUE
	check_all = TRUE
...
/obj/machinery/porta_turret/industrial
	...
	installation = /obj/item/gun/energy/locked/phasegun/unlocked // CHOMPEdit - Removal of obj/item/weapon
	health = 200
	maxhealth = 200
...
/obj/machinery/porta_turret/industrial/teleport_defense
	...
	req_one_access = list(access_heads)
	installation = /obj/item/gun/energy/gun/burst // CHOMPEdit - Removal of obj/item/weapon
	health = 250
	maxhealth = 250
...
/obj/machinery/porta_turret/lasertag
	...
	turret_type = "normal"
	req_one_access = list()
	installation = /obj/item/gun/energy/lasertag/omni // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/porta_turret/lasertag/red
	turret_type = "red"
	installation = /obj/item/gun/energy/lasertag/red // CHOMPEdit - Removal of obj/item/weapon
	check_weapons = TRUE // Used to target blue players

/obj/machinery/porta_turret/lasertag/blue
	turret_type = "blue"
	installation = /obj/item/gun/energy/lasertag/blue // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/porta_turret/proc/setup()
	var/obj/item/gun/energy/E = installation	//All energy-based weapons are applicable // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/porta_turret/proc/weapon_setup(var/guntype)
	switch(guntype)
		if(/obj/item/gun/energy/gun/burst) // CHOMPEdit - Removal of obj/item/weapon
			lethal_icon_color = "red"
			lethal_projectile = /obj/item/projectile/beam/burstlaser
			lethal_shot_sound = 'sound/weapons/Laser.ogg'
			shot_delay = 1 SECOND

		if(/obj/item/gun/energy/locked/phasegun/unlocked) // CHOMPEdit - Removal of obj/item/weapon
			icon_color = "orange"
			lethal_icon_color = "orange"
			lethal_projectile = /obj/item/projectile/energy/phase/heavy
			shot_delay = 1 SECOND

		if(/obj/item/gun/energy/gun) // CHOMPEdit - Removal of obj/item/weapon
			lethal_icon_color = "red"
			lethal_projectile = /obj/item/projectile/beam	//If it has, going to kill mode
			lethal_shot_sound = 'sound/weapons/Laser.ogg'

		if(/obj/item/gun/energy/gun/nuclear) // CHOMPEdit - Removal of obj/item/weapon
			lethal_icon_color = "red"
			lethal_projectile = /obj/item/projectile/beam	//If it has, going to kill mode
			lethal_shot_sound = 'sound/weapons/Laser.ogg'

		if(/obj/item/gun/energy/xray) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/porta_turret/attackby(obj/item/I, mob/user)
		...
		if(I.has_tool_quality(TOOL_CROWBAR))
			...
			if(do_after(user, 20))
				if(can_salvage && prob(70))
					...
					if(installation)
						var/obj/item/gun/energy/Gun = new installation(loc) // CHOMPEdit - Removal of obj/item/weapon
						Gun.power_supply.charge = gun_charge
						Gun.update_icon()
					if(prob(50))
						new /obj/item/stack/material/steel(loc, rand(1,4))
					if(prob(50))
						new /obj/item/assembly/prox_sensor(loc) // CHOMPEdit - Removal of obj/item/device
				else
	...
	else if(istype(I, /obj/item/card/id)||istype(I, /obj/item/pda)) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
...
/obj/machinery/porta_turret/proc/shootAt(var/mob/living/target)
	...
	var/def_zone
	var/obj/item/grab/G = locate() in target // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/porta_turret_construct/attackby(obj/item/I, mob/user)
	...
	switch(build_step)
		...
		if(2)
			if(I.has_tool_quality(TOOL_WRENCH))
				...
				var/obj/item/weldingtool/WT = I.get_welder() // CHOMPEdit - Removal of obj/item/weapon
				if(!WT.isOn())
					return
		...
		if(3)
			if(istype(I, /obj/item/gun/energy)) //the gun installation part // CHOMPEdit - Removal of obj/item/weapon

				if(isrobot(user))
					return
				var/obj/item/gun/energy/E = I //typecasts the item to an energy gun // CHOMPEdit - Removal of obj/item/weapon
				if(!user.unEquip(I))
	...
	if(istype(I, /obj/item/pen))	//you can rename turrets like bots! // CHOMPEdit - Removal of obj/item/weapon
