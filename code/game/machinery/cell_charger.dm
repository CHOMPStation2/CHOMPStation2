/obj/machinery/cell_charger
	...
	power_channel = EQUIP
	var/obj/item/cell/charging = null // CHOMPEdit - Removal of obj/item/weapon
	var/chargelevel = -1
...
/obj/machinery/cell_charger/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(stat & BROKEN)
		return

	if(istype(W, /obj/item/cell) && anchored) // CHOMPEdit - Removal of obj/item/weapon
