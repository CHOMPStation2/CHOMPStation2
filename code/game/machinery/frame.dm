...
/datum/frame/frame_types/conveyor
	name = "Conveyor"
	frame_class = FRAME_CLASS_MACHINE
	circuit = /obj/item/circuitboard/conveyor // CHOMPEdit - Removal of obj/item/weapon
...
/datum/frame/frame_types/mass_driver
	name = "Mass Driver"
	frame_class = FRAME_CLASS_MACHINE
	circuit = /obj/item/circuitboard/mass_driver // CHOMPEdit - Removal of obj/item/weapon
...
/datum/frame/frame_types/cell_charger
	...
	frame_class = FRAME_CLASS_MACHINE
	circuit = /obj/item/circuitboard/cell_charger // CHOMPEdit - Removal of obj/item/weapon
	frame_size = 3

/datum/frame/frame_types/grinder
	name = "Grinder"
	frame_class = FRAME_CLASS_MACHINE
	circuit = /obj/item/circuitboard/grinder // CHOMPEdit - Removal of obj/item/weapon
	frame_size = 3
...
/obj/structure/frame/attackby(obj/item/P as obj, mob/user as mob)
	...
	else if(istype(P, /obj/item/circuitboard) && need_circuit && !circuit) // CHOMPEdit - Removal of obj/item/weapon
		if(state == FRAME_PLACED && anchored)
			var/obj/item/circuitboard/B = P // CHOMPEdit - Removal of obj/item/weapon
		...
		if(state == FRAME_UNFASTENED)
			...
			if(frame_type.frame_class == FRAME_CLASS_MACHINE)
				...
				if(components.len == 0)
					...
					for(var/obj/item/W in components) // CHOMPEdit - Removal of obj/item/weapon
						W.forceMove(src.loc)
					check_components()
					update_desc()
					to_chat(user, desc)
