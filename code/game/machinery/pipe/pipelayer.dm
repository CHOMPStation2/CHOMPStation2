/obj/machinery/pipelayer
	...
	icon_state = "pipe_d"
	density = TRUE
	circuit = /obj/item/circuitboard/pipelayer // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/tool/wrench/W // Internal wrench used for wrenching down the pipes // CHOMPEdit - Removal of obj/item/weapon
	var/list/Pipes = list(
