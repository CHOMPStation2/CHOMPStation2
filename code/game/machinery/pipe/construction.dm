...
/obj/item/pipe/attackby(var/obj/item/W as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(W.has_tool_quality(TOOL_WRENCH))
		return wrench_act(user, W)
	return ..()

/obj/item/pipe/proc/wrench_act(var/mob/living/user, var/obj/item/tool/wrench/W) // CHOMPEdit - Removal of obj/item/weapon
	if(!isturf(loc))
		return TRUE
...
/obj/item/pipe_meter/attackby(var/obj/item/W as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(W.has_tool_quality(TOOL_WRENCH))
		return wrench_act(user, W)
	return ..()

/obj/item/pipe_meter/proc/wrench_act(var/mob/living/user, var/obj/item/tool/wrench/W) // CHOMPEdit - Removal of obj/item/weapon
