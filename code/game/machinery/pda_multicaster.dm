/obj/machinery/pda_multicaster
	...
	density = TRUE
	anchored = TRUE
	circuit = /obj/item/circuitboard/telecomms/pda_multicaster // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/pda_multicaster/New()
	..()
	internal_PDAs = list("command" = new /obj/item/pda/multicaster/command(src), // CHOMPEdit - Removal of obj/item/device
		"security" = new /obj/item/pda/multicaster/security(src), // CHOMPEdit - Removal of obj/item/device
		"engineering" = new /obj/item/pda/multicaster/engineering(src), // CHOMPEdit - Removal of obj/item/device
		"medical" = new /obj/item/pda/multicaster/medical(src), // CHOMPEdit - Removal of obj/item/device
		"research" = new /obj/item/pda/multicaster/research(src), // CHOMPEdit - Removal of obj/item/device
		"exploration" = new /obj/item/pda/multicaster/exploration(src), //VOREStation Add, // CHOMPEdit - Removal of obj/item/device
		"cargo" = new /obj/item/pda/multicaster/cargo(src), // CHOMPEdit - Removal of obj/item/device
		"civilian" = new /obj/item/pda/multicaster/civilian(src)) // CHOMPEdit - Removal of obj/item/device
...
/obj/machinery/pda_multicaster/proc/update_PDAs(var/turn_off)
	for(var/obj/item/pda/pda in contents) // CHOMPEdit - Removal of obj/item/device
