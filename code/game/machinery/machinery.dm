...
/obj/machinery/proc/default_apply_parts()
	var/obj/item/circuitboard/CB = circuit // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(CB))
		return
...
/obj/machinery/proc/default_use_hicell()
	var/obj/item/cell/C = locate(/obj/item/cell) in component_parts // CHOMPEdit - Removal of obj/item/weapon
	if(C)
		component_parts -= C
		qdel(C)
		C = new /obj/item/cell/high(src) // CHOMPEdit - Removal of obj/item/weapon
		component_parts += C
		RefreshParts()
		return C

/obj/machinery/proc/default_part_replacement(var/mob/user, var/obj/item/storage/part_replacer/R) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/proc/fall_apart(var/severity = 3, var/scatter = TRUE)
	...
	if(severity != 1)
		for(var/obj/item/card/id/I in contents) // CHOMPEdit - Removal of obj/item/weapon
			surviving_parts |= I
