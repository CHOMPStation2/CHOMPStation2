...
/obj/machinery/requests_console
	...
	circuit = /obj/item/circuitboard/request // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/requests_console/attackby(var/obj/item/O as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(istype(O, /obj/item/card/id)) // CHOMPEdit - Removal of obj/item/weapon
		...
		if(screen == RCS_MESSAUTH)
			var/obj/item/card/id/T = O // CHOMPEdit - Removal of obj/item/weapon
			msgVerified = text("<font color='green'><b>Verified by [T.registered_name] ([T.assignment])</b></font>")
			SStgui.update_uis(src)
		if(screen == RCS_ANNOUNCE)
			var/obj/item/card/id/ID = O // CHOMPEdit - Removal of obj/item/weapon
			...
			SStgui.update_uis(src)
	if(istype(O, /obj/item/stamp)) // CHOMPEdit - Removal of obj/item/weapon
		if(inoperable(MAINT)) return
		if(screen == RCS_MESSAUTH)
			var/obj/item/stamp/T = O // CHOMPEdit - Removal of obj/item/weapon
