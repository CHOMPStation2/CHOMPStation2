			...
			if(1)
				if(istype(P, /obj/item/stack/cable_coil))
					...
					if(P.has_tool_quality(TOOL_WRENCH))
						...
						qdel(src)
			if(2)
				if(istype(P, /obj/item/circuitboard)) // CHOMPEdit - Removal of obj/item/weapon
					var/obj/item/circuitboard/B = P // CHOMPEdit - Removal of obj/item/weapon
					if(B.board_type == "machine")
					//VOREStation Addition End
						if(istype(B, /obj/item/circuitboard/quantumpad) && istype(get_area(src), /area/shuttle)) // CHOMPEdit - Removal of obj/item/weapon
