/obj/machinery/washing_machine
	...
	circuit = /obj/item/circuitboard/washing // CHOMPEdit - Removal of obj/item/weapon
	var/state = 1
	//1 = empty, open door
	//2 = empty, closed door
	//3 = full, open door
...
/obj/machinery/washing_machine/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(istype(W,/obj/item/pen/crayon) || istype(W,/obj/item/stamp)) // CHOMPEdit - Removal of obj/item/weapon
		if(state in list(	1, 3, 6))
			if(!crayon)
				user.drop_item()
				crayon = W
	...
	else if(istype(W, /obj/item/clothing) || istype(W, /obj/item/bedsheet) || istype(W, /obj/item/stack/hairlesshide)) // CHOMPEdit - Removal of obj/item/weapon
		if(washing.len < 5)
