...
/obj/machinery/door/firedoor/attackby(obj/item/C as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	add_fingerprint(user)
			...
			if(do_after(user,30))
				if(blocked && density && hatch_open)
					...
					if (stat & BROKEN)
						...
						new/obj/item/circuitboard/airalarm(src.loc) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(C.pry == 1)
		...
		if(istype(C,/obj/item/material/twohanded/fireaxe)) // CHOMPEdit - Removal of obj/item/weapon
