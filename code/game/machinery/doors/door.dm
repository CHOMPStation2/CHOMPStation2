...
/obj/machinery/door/Bumped(atom/AM)
	...
	if(ismob(AM))
		...
		if(M.restrained() && !check_access(null))
			...
			bumpopen(M)
	if(istype(AM, /obj/item/uav)) // CHOMPEdit - Removal of obj/item/device
...
/obj/machinery/door/attackby(obj/item/I as obj, mob/user as mob)
	...
	if(istype(I))
		...
		if(health < maxhealth && I.has_tool_quality(TOOL_WELDER))
			...
			var/obj/item/weldingtool/welder = I.get_welder() // CHOMPEdit - Removal of obj/item/weapon
		...
		if(src.density && istype(I, /obj/item) && user.a_intent == I_HURT && !istype(I, /obj/item/card)) // CHOMPEdit - Removal of obj/item/weapon
