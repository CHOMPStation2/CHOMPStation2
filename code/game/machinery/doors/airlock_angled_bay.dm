...
/obj/machinery/door/airlock/angled_bay/centcom // CHOMPEdit - Typo Fix
	icon = 'icons/obj/doors/angled/centcom/door.dmi' // CHOMPEdit - Typo Fix
	fill_type = FILL_METAL // the only option

	base_icon = 'icons/obj/doors/angled/centcom/door.dmi' // CHOMPEdit - Typo Fix
	metal_fill_icon = 'icons/obj/doors/angled/centcom/fill_steel.dmi' // CHOMPEdit - Typo Fix
