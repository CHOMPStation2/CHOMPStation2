...
/obj/machinery/door/airlock/rcd_act(mob/living/user, obj/item/weapon/rcd/the_rcd, passed_mode)
	switch(passed_mode)
		if(RCD_DECONSTRUCT)
			...
			return TRUE
	return FALSE
||||||| parent of 489d5fc33c... Merge pull request #11594 from KillianKirilenko/kk-knockknock
//VOREStation Edit - Redone a lot of airlock things:
/*
- Specific department maintenance doors
- Named doors properly according to type
...
/obj/machinery/door/airlock/rcd_act(mob/living/user, obj/item/weapon/rcd/the_rcd, passed_mode)
	switch(passed_mode)
		if(RCD_DECONSTRUCT)
			...
			return TRUE
	return FALSE
>>>>>>> 489d5fc33c... Merge pull request #11594 from KillianKirilenko/kk-knockknock
