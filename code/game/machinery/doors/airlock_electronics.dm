...
/obj/item/airlock_electronics/emag_act(var/remaining_charges, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!emagged)
		emagged = 1
		to_chat(user, "<span class='notice'>You remove the access restrictions on [src]!</span>")
		return 1

/obj/item/airlock_electronics/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/airlock_electronics/Topic(href, href_list) // CHOMPEdit - Removal of obj/item/weapon
	..()
	...
	if (href_list["login"])
		if(emagged)
			...
			var/obj/item/card/id/id // CHOMPEdit - Removal of obj/item/weapon
			if(ishuman(usr))
...
/obj/item/airlock_electronics/proc/toggle_access(var/acc) // CHOMPEdit - Removal of obj/item/weapon
	if (acc == "all")
		conf_access = null
	else
...
/obj/item/airlock_electronics/proc/get_available_accesses(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/card/id/id // CHOMPEdit - Removal of obj/item/weapon
	if(ishuman(user))
...
/obj/item/airlock_electronics/secure // CHOMPEdit - Removal of obj/item/weapon
	name = "secure airlock electronics"
	desc = "designed to be somewhat more resistant to hacking than standard electronics."
	origin_tech = list(TECH_DATA = 2)
	secure = 1

/obj/item/airlock_electronics/secure/emag_act(var/remaining_charges, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
