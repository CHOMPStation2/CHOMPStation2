...
/obj/machinery/door/window/proc/shatter(var/display_message = 1)
	...
	var/obj/item/airlock_electronics/ae // CHOMPEdit - Removal of obj/item/weapon
	if(!electronics)
		ae = new/obj/item/airlock_electronics( src.loc ) // CHOMPEdit - Removal of obj/item/weapon
		if(LAZYLEN(req_access))
	...
	if(istype(I))
		...
		if (!density && I.has_tool_quality(TOOL_CROWBAR))
			...
			if (do_after(user,40 * I.toolspeed))
				...
				if(operating == -1)
					wa.electronics = new/obj/item/circuitboard/broken() // CHOMPEdit - Removal of obj/item/weapon
				else
					if(!electronics)
						wa.electronics = new/obj/item/airlock_electronics() // CHOMPEdit - Removal of obj/item/weapon
						if(LAZYLEN(req_access))
