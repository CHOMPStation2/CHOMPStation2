/obj/machinery/portable_atmospherics
	...
	var/obj/item/tank/holding // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/portable_atmospherics/attackby(var/obj/item/W as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if ((istype(W, /obj/item/tank) && !( src.destroyed ))) // CHOMPEdit - Removal of obj/item/weapon
		if (src.holding)
			return
		var/obj/item/tank/T = W // CHOMPEdit - Removal of obj/item/weapon
		user.drop_item()
		T.loc = src
		src.holding = T
		update_icon()
...
/obj/machinery/portable_atmospherics/powered/attackby(obj/item/I, mob/user)
	if(use_cell && istype(I, /obj/item/cell)) // CHOMPEdit - Removal of obj/item/weapon
		if(cell)
			to_chat(user, "There is already a power cell installed.")
			return

		var/obj/item/cell/C = I // CHOMPEdit - Removal of obj/item/weapon
