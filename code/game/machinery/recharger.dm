...
/obj/machinery/recharger/examine(mob/user)
	...
	if(get_dist(user, src) <= 5)
		...
		if(charging)
			var/obj/item/cell/C = charging.get_cell() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/recharger/proc/do_allowed_checks(obj/item/G, mob/user)
	...
	if(!powered())
		...
		return
	if(istype(G, /obj/item/gun/energy)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/gun/energy/E = G // CHOMPEdit - Removal of obj/item/weapon
		if(E.self_recharge)
	...
	if(istype(G, /obj/item/modular_computer))
		...
		if(!C.battery_module)
			...
			return
	if(istype(G, /obj/item/melee/baton)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/melee/baton/B = G // CHOMPEdit - Removal of obj/item/weapon
		if(B.use_external_power)
			to_chat(user, "<span class='notice'>\The [B] has no recharge port.</span>")
			return
	if(istype(G, /obj/item/flash)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/flash/F = G // CHOMPEdit - Removal of obj/item/device
		if(F.use_external_power)
			to_chat(user, "<span class='notice'>\The [F] has no recharge port.</span>")
			return
	if(istype(G, /obj/item/weldingtool/electric)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/weldingtool/electric/EW = G // CHOMPEdit - Removal of obj/item/weapon
		...
		if(maggy.stored_ammo.len < 1)
			...
			return
	else if(istype(G, /obj/item/gun/projectile/cell_loaded)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/gun/projectile/cell_loaded/gunny = G // CHOMPEdit - Removal of obj/item/weapon
	...
	if(istype(G, /obj/item/paicard)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/paicard/ourcard = G // CHOMPEdit - Removal of obj/item/device
...
/obj/machinery/recharger/MouseDrop_T(obj/item/G as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	var/allowed = 0
...
/obj/machinery/recharger/attackby(obj/item/G as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	var/allowed = 0
	for (var/allowed_type in allowed_devices)
		if(istype(G, allowed_type)) allowed = 1
...
/obj/machinery/recharger/process()
	...
	else if(istype(charging, /obj/item/paicard)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/paicard/pcard = charging // CHOMPEdit - Removal of obj/item/device
	...
	//VOREStation Edit End
		...
		else if(istype(charging, /obj/item/gun/projectile/cell_loaded)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/gun/projectile/cell_loaded/gunny = charging // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/recharger/RefreshParts()
	var/E = 0
	for(var/obj/item/stock_parts/capacitor/C in component_parts) // CHOMPEdit - Removal of obj/item/weapon
		E += C.rating
...
/obj/machinery/recharger/wallcharger
	...
	efficiency = 60000
	allowed_devices = list(/obj/item/gun/energy, /obj/item/gun/magnetic, /obj/item/melee/baton, /obj/item/flashlight, /obj/item/cell/device, /obj/item/ammo_casing/microbattery, /obj/item/ammo_magazine/cell_mag, /obj/item/gun/projectile/cell_loaded) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	icon_state_charged = "wrecharger2"
	icon_state_charging = "wrecharger1"
	icon_state_idle = "wrecharger0"
	portable = 0
	circuit = /obj/item/circuitboard/recharger/wrecharger // CHOMPEdit - Removal of obj/item/weapon
