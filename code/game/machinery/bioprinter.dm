...
/obj/machinery/organ_printer
	...
	var/obj/item/reagent_containers/container = null		// This is the beaker that holds all of the biomass // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/organ_printer/RefreshParts()
	...
	var/manip_rating = 0
	for(var/obj/item/stock_parts/manipulator/manip in component_parts) // CHOMPEdit - Removal of obj/item/weapon
...
// CIRCUITS
/obj/item/circuitboard/bioprinter // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/organ_printer/flesh
	...
	icon_state = "bioprinter"
	circuit = /obj/item/circuitboard/bioprinter // CHOMPEdit - Removal of obj/item/weapon

/obj/machinery/organ_printer/flesh/full/Initialize()
	. = ..()
	container = new /obj/item/reagent_containers/glass/bottle/biomass(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/organ_printer/flesh/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	// DNA sample from syringe.
	if(istype(W,/obj/item/reagent_containers/syringe))	//TODO: Make this actually empty the syringe // CHOMPEdit - Removal of obj/item/weapon
		...
		var/obj/item/reagent_containers/glass/G = W // CHOMPEdit - Removal of obj/item/weapon
		if(container)
...
/obj/item/circuitboard/roboprinter // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/organ_printer/robot
	...
	circuit = /obj/item/circuitboard/roboprinter // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/organ_printer/robot/attackby(var/obj/item/W, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/stack/material) && W.get_material_name() == matter_type)
		...
		return
	else if(istype(W,/obj/item/reagent_containers/syringe))	//TODO: Make this actuall empty the syringe // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/reagent_containers/syringe/S = W // CHOMPEdit - Removal of obj/item/weapon
		var/datum/reagent/blood/injected = locate() in S.reagents.reagent_list //Grab some blood
		if(injected && injected.data)
			loaded_dna = injected.data
