	...
	if(life_support)
		if(user.isSynthetic())
			if(voidsuit.cooler)
				...
				var/obj/item/life_support = new /obj/item/suit_cooling_unit(voidsuit) // CHOMPEdit - Removal of obj/item/device
			...
			if(voidsuit.tank)
				...
				var/tanktext = "/obj/item/tank/" + "[user.species?.breath_type]" // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/tank/tankpath = text2path(tanktext) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/gear_disp/ert/security_rig
	...
	to_spawn = list(/obj/item/rig/ert/security) // CHOMPEdit - Removal of obj/item/weapon

/datum/gear_disp/ert/medical_rig
	name = "Medical (Hardsuit)"
	to_spawn = list(/obj/item/rig/ert/medical) // CHOMPEdit - Removal of obj/item/weapon

/datum/gear_disp/ert/engineer_rig
	name = "Engineering (Hardsuit)"
	to_spawn = list(/obj/item/rig/ert/engineer) // CHOMPEdit - Removal of obj/item/weapon
/*
/datum/gear_disp/ert/commander_rig
	name = "Commander (Hardsuit)"
	to_spawn = list(/obj/item/rig/ert) // CHOMPEdit - Removal of obj/item/weapon
	amount = 1
*/
...
/datum/gear_disp/adventure_box/light
	name = "Flashlight"
	to_spawn = list(/obj/item/flashlight/maglight) // CHOMPEdit - Removal of obj/item/device
	amount = 2
