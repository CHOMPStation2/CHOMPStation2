...
/datum/feed_network/proc/SubmitArticle(var/msg, var/author, var/channel_name, var/obj/item/photo/photo, var/adminMessage = 0, var/message_type = "", var/title) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/feed_network/proc/alert_readers(var/annoncement)
	...
	// for (var/obj/item/pda/P in PDAs) // CHOMPEdit - Removal of obj/item/device
	// 	if(!P.owner)
	// 		continue
	// 	if(P.toff)
	// 		continue
	...
	// 	for(var/obj/item/pda/PDA in receiving_pdas) // CHOMPEdit - Removal of obj/item/device
...
/obj/machinery/newscaster
	...
	circuit = /obj/item/circuitboard/newscaster // CHOMPEdit - Removal of obj/item/weapon
	// TGUI
	var/list/temp = null
...
/datum/news_photo
	var/is_synth = 0
	var/obj/item/photo/photo = null // CHOMPEdit - Removal of obj/item/weapon

/datum/news_photo/New(var/obj/item/photo/p, var/synth) // CHOMPEdit - Removal of obj/item/weapon
	is_synth = synth
	photo = p
...
/obj/machinery/newscaster/proc/AttachPhoto(mob/user)
	...
	if(istype(user.get_active_hand(), /obj/item/photo)) // CHOMPEdit - Removal of obj/item/weapon
		...
		var/obj/item/photo/selection = tempAI.GetPicture() // CHOMPEdit - Removal of obj/item/weapon
		if(!selection)
			return
...
/obj/machinery/newscaster/proc/tgui_user_name(mob/user)
	if(ishuman(user))
		...
		var/obj/item/card/id/I = H.GetIdCard() // CHOMPEdit - Removal of obj/item/weapon
		if(I)
...
/obj/machinery/newscaster/proc/scan_user(mob/living/user)
	if(istype(user,/mob/living/carbon/human))                       //User is a human
		...
		var/obj/item/card/id/I = human_user.GetIdCard() // CHOMPEdit - Removal of obj/item/weapon
		if(I)
...
/obj/machinery/newscaster/proc/print_paper()
	...
	var/obj/item/newspaper/NEWSPAPER = new /obj/item/newspaper // CHOMPEdit - Removal of obj/item/weapon
	for(var/datum/feed_channel/FC in news_network.network_channels)
