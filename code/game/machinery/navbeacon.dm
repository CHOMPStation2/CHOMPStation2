...
GLOBAL_LIST_EMPTY(navbeacons) // no I don't like putting this in, but it will do for now // CHOMPEdit - Globals
...
/obj/machinery/navbeacon/New()
	...
	var/turf/T = loc
	hide(!T.is_plating())
	GLOB.navbeacons += src // CHOMPEdit - Globals
...
/obj/machinery/navbeacon/Destroy()
	GLOB.navbeacons.Remove(src) // CHOMPEdit - Globals
	..()
