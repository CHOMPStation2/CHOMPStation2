...
/obj/machinery/pointdefense_control
	...
	density = TRUE
	anchored = TRUE
	circuit = /obj/item/circuitboard/pointdefense_control // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/pointdefense
	...
	density = TRUE
	anchored = TRUE
	circuit = /obj/item/circuitboard/pointdefense // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/pointdefense/RefreshParts()
	...
	var/shootrate_divisor = total_component_rating_of_type(/obj/item/stock_parts/capacitor) // CHOMPEdit - Removal of obj/item/weapon

	charge_cooldown = 2 SECONDS / (shootrate_divisor ? shootrate_divisor : 1)

	//Calculate max shooting range
	var/killrange_multiplier = total_component_rating_of_type(/obj/item/stock_parts/capacitor) // CHOMPEdit - Removal of obj/item/weapon
	killrange_multiplier += 1.5 * total_component_rating_of_type(/obj/item/stock_parts/scanning_module) // CHOMPEdit - Removal of obj/item/weapon

	kill_range = 10 + 4 * killrange_multiplier

	var/rotation_divisor = total_component_rating_of_type(/obj/item/stock_parts/manipulator) // CHOMPEdit - Removal of obj/item/weapon
