...
//		return
		...
		return
	else if(panel_open && istype(W, /obj/item/multitool)) // CHOMPEdit - Removal of obj/item/device
...
/datum/frame/frame_types/doorbell_chime
	...
	frame_size = 3
	frame_style = "wall"
	circuit = /obj/item/circuitboard/doorbell_chime // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/circuitboard/doorbell_chime // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/button/doorbell/attackby(obj/item/W as obj, mob/user as mob)
	...
	if(default_deconstruction_screwdriver(user, W))
		return
	else if(panel_open && istype(W, /obj/item/pen)) // CHOMPEdit - Removal of obj/item/weapon
