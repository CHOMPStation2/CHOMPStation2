/obj/machinery/oxygen_pump
	...
	var/spawn_type = /obj/item/tank/emergency/oxygen/engi // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/oxygen_pump/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(W.has_tool_quality(TOOL_SCREWDRIVER))
		...
		//TO-DO: Open icon
	if(istype(W, /obj/item/tank) && (stat & MAINT)) // CHOMPEdit - Removal of obj/item/weapon
		if(tank)
			...
			src.add_fingerprint(user)
	if(istype(W, /obj/item/tank) && !stat) // CHOMPEdit - Removal of obj/item/weapon
