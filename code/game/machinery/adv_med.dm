...
/obj/machinery/bodyscanner
	...
	anchored = TRUE
	unacidable = TRUE
	circuit = /obj/item/circuitboard/body_scanner // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/bodyscanner/attackby(var/obj/item/G, user as mob)
	if(istype(G, /obj/item/grab)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/grab/H = G // CHOMPEdit - Removal of obj/item/weapon
		if(panel_open)
	...
	if(occupant && ishuman(occupant))
		...
		for(var/obj/item/organ/external/E in H.organs)
			...
			for(var/obj/thing in E.implants)
				...
				var/obj/item/implant/I = thing // CHOMPEdit - Removal of obj/item/weapon
			//VOREStation Block Edit Start
				var/obj/item/nif/N = thing // CHOMPEdit - Removal of obj/item/device
				if(istype(I))
...
/obj/machinery/bodyscanner/tgui_act(action, params)
	...
	switch(action)
		...
		if("print_p")
			...
			var/obj/item/paper/P = new /obj/item/paper(get_turf(target)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/bodyscanner/proc/generate_printing_text()
	...
	if(istype(occupant)) //is there REALLY someone in there?
		...
		for(var/obj/item/organ/external/e in occupant.organs)
			...
			var/unknown_body = 0
			for(var/obj/item/implant/I as anything in e.implants) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/nif/N = I //VOREStation Add: NIFs // CHOMPEdit - Removal of obj/item/device
...
/obj/machinery/body_scanconsole
	...
	anchored = TRUE
	unacidable = TRUE
	circuit = /obj/item/circuitboard/scanner_console // CHOMPEdit - Removal of obj/item/weapon
	var/printing = null
...
/obj/machinery/body_scanconsole/attackby(var/obj/item/I, var/mob/user)
	if(computer_deconstruction_screwdriver(user, I))
		return
	else if(istype(I, /obj/item/multitool)) //Did you want to link it? // CHOMPEdit - Removal of obj/item/device
		var/obj/item/multitool/P = I // CHOMPEdit - Removal of obj/item/device
		if(P.connectable)
