...
/obj/machinery/dna_scannernew
	...
	interact_offline = 1
	circuit = /obj/item/circuitboard/clonescanner // CHOMPEdit - Removal of obj/item/weapon
	var/locked = 0
...
/obj/machinery/dna_scannernew/RefreshParts()
	...
	damage_coeff = 0
	precision_coeff = 0
	for(var/obj/item/stock_parts/scanning_module/P in component_parts) // CHOMPEdit - Removal of obj/item/weapon
		scan_level += P.rating
	for(var/obj/item/stock_parts/manipulator/P in component_parts) // CHOMPEdit - Removal of obj/item/weapon
		precision_coeff = P.rating
	for(var/obj/item/stock_parts/micro_laser/P in component_parts) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/dna_scannernew/proc/eject_occupant()
	...
	for(var/obj/O in src)
		if((!istype(O,/obj/item/reagent_containers)) && (!istype(O,/obj/item/circuitboard/clonescanner)) && (!istype(O,/obj/item/stock_parts)) && (!istype(O,/obj/item/stack/cable_coil))) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/dna_scannernew/attackby(var/obj/item/item as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(item, /obj/item/reagent_containers/glass)) // CHOMPEdit - Removal of obj/item/weapon
		if(beaker)
	...
	else if(!istype(item, /obj/item/grab)) // CHOMPEdit - Removal of obj/item/weapon
		return
	var/obj/item/grab/G = item // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/scan_consolenew
	...
	icon_screen = "dna"
	density = TRUE
	circuit = /obj/item/circuitboard/scan_consolenew // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/disk/data/disk = null // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/scan_consolenew/attackby(obj/item/I as obj, mob/user as mob)
	if(istype(I, /obj/item/disk/data)) //INSERT SOME diskS // CHOMPEdit - Removal of obj/item/weapon
		if(!src.disk)
			user.drop_item()
			I.loc = src
			src.disk = I
...
/obj/machinery/computer/scan_consolenew/proc/setInjectorBlock(var/obj/item/dnainjector/I, var/blk, var/datum/dna2/record/buffer) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/computer/scan_consolenew/tgui_act(action, params)
	...
	////////////////////////////////////////////////////////
		...
		if("ejectBeaker")
			if(connected.beaker)
				var/obj/item/reagent_containers/glass/B = connected.beaker // CHOMPEdit - Removal of obj/item/weapon
				B.loc = connected.loc
...
/obj/machinery/computer/scan_consolenew/proc/create_injector(buffer_id, copy_buffer = FALSE)
	...
	var/obj/item/dnainjector/I = new() // CHOMPEdit - Removal of obj/item/weapon
	I.forceMove(loc)
	I.name += " ([buf.name])"
	if(copy_buffer)
		I.buf = buf.copy()
			...
			switch(id)
				if("createInjectorBlock")
					...
					if(buffer_id < 1 || buffer_id > length(buffers))
						return
					var/datum/dna2/record/buf = buffers[buffer_id]
					var/obj/item/dnainjector/I = create_injector(buffer_id) // CHOMPEdit - Removal of obj/item/weapon
