...
/obj/vehicle
	...
	var/obj/item/cell/cell //Our power source // CHOMPEdit - Removal of obj/item/weapon
	var/state = 0
	var/list/log = new
	var/last_message = 0
...
/obj/vehicle/proc/add_cell(var/obj/item/cell/C=null) // CHOMPEdit - Removal of obj/item/weapon
	if(C)
		C.forceMove(src)
		cell = C
		return
