...
/obj/item/technomancer_catalog // CHOMPEdit - Removal of obj/item/weapon
	name = "catalog"
...
/obj/item/technomancer_catalog/apprentice // CHOMPEdit - Removal of obj/item/weapon
	name = "apprentice's catalog"
	budget = 700
	max_budget = 700

/obj/item/technomancer_catalog/master //for badmins, I suppose // CHOMPEdit - Removal of obj/item/weapon
	name = "master's catalog"
	budget = 2000
	max_budget = 2000

//VOREStation Add
/obj/item/technomancer_catalog/universal // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_catalog/proc/bind_to_owner(var/mob/living/carbon/human/new_owner) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_catalog/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	set_up()
...
/obj/item/technomancer_catalog/proc/set_up() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_catalog/apprentice/set_up() // CHOMPEdit - Removal of obj/item/weapon
	..()
...
// code duplicating.
/obj/item/technomancer_catalog/proc/show_categories(var/category) // CHOMPEdit - Removal of obj/item/weapon
	if(category)
...
/obj/item/technomancer_catalog/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!user)
		return 0
	if(owner && user != owner)
...
/obj/item/technomancer_catalog/Topic(href, href_list) // CHOMPEdit - Removal of obj/item/weapon
	..()
	...
	if(loc == H || (in_range(src, H) && istype(loc, /turf)))
		...
		if(href_list["spell_choice"])
			...
			if(istype(H.back, /obj/item/technomancer_core)) // CHOMPEdit - Removal of obj/item/weapon
				core = H.back
...
/obj/item/technomancer_catalog/attackby(var/atom/movable/AM, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	...
	for(var/datum/technomancer/equipment/E in equipment_instances + assistance_instances)
		if(AM.type == E.obj_path) // We got a match.
			if(budget + E.cost > max_budget)
				...
				if(istype(AM, /obj/item/technomancer_core)) // CHOMPEdit - Removal of obj/item/weapon
					var/obj/item/technomancer_core/core = AM // CHOMPEdit - Removal of obj/item/weapon
					for(var/obj/spellbutton/spell in core.spells)
						for(var/datum/technomancer/spell/spell_datum in spell_instances)
							if(spell_datum.obj_path == spell.spellpath)
								budget += spell_datum.cost
