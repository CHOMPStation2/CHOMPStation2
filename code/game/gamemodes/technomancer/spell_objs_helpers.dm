...
/obj/item/spell/proc/is_ally(var/mob/living/L) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/proc/allowed_to_teleport() // CHOMPEdit - Removal of obj/item/weapon
	if(owner)
...
/obj/item/spell/proc/within_range(var/atom/target, var/max_range = 7) // Beyond 7 is off the screen. // CHOMPEdit - Removal of obj/item/weapon
	if(target in view(max_range, owner))
		return TRUE
	return FALSE

/obj/item/spell/proc/calculate_spell_power(var/amount) // CHOMPEdit - Removal of obj/item/weapon
	if(core)
		return round(amount * core.spell_power_modifier, 1)

// Returns a 'target' mob from a radius around T.
/obj/item/spell/proc/targeting_assist(var/turf/T, radius = 5) // CHOMPEdit - Removal of obj/item/weapon
