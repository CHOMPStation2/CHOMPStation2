...
/obj/item/spell/proc/on_use_cast(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return

// Proc: on_throw_cast()
// Parameters: 1 (hit_atom - the atom hit by the spell object)
// Description: Override this for throwing effects.
/obj/item/spell/proc/on_throw_cast(atom/hit_atom) // CHOMPEdit - Removal of obj/item/weapon
	return
...
/obj/item/spell/proc/on_ranged_cast(atom/hit_atom, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return
...
/obj/item/spell/proc/on_melee_cast(atom/hit_atom, mob/living/user, def_zone) // CHOMPEdit - Removal of obj/item/weapon
	return
...
/obj/item/spell/proc/on_combine_cast(obj/item/I, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return
...
/obj/item/spell/proc/on_innate_cast(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return
...
/obj/item/spell/proc/on_scepter_use_cast(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return
...
/obj/item/spell/proc/on_scepter_ranged_cast(atom/hit_atom, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return
...
/obj/item/spell/proc/pay_energy(var/amount) // CHOMPEdit - Removal of obj/item/weapon
	if(!core)
		return 0
...
/obj/item/spell/proc/give_energy(var/amount) // CHOMPEdit - Removal of obj/item/weapon
	if(!core)
		return 0
...
/obj/item/spell/proc/adjust_instability(var/amount) // CHOMPEdit - Removal of obj/item/weapon
	if(!owner || !core)
		return 0
...
/obj/item/spell/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(isliving(loc))
		owner = loc
	if(owner)
		...
		if(!core)
			...
			qdel(src)
			return
//		if(istype(/obj/item/technomancer_core, owner.back)) // CHOMPEdit - Removal of obj/item/weapon
//			core = owner.back
	update_icon()
...
/obj/item/spell/Destroy() // CHOMPEdit - Removal of obj/item/weapon
...
/mob/proc/unref_spell(var/obj/item/spell/the_spell) // CHOMPEdit - Removal of obj/item/weapon
	return

// Proc: update_icon()
// Parameters: 0
// Description: Applys an overlay if it is a passive spell.
/obj/item/spell/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(toggled)
...
/obj/item/spell/proc/run_checks() // CHOMPEdit - Removal of obj/item/weapon
	if(!owner)
		return 0
	if(!core)
		core = locate(/obj/item/technomancer_core) in owner // CHOMPEdit - Removal of obj/item/weapon
		if(!core)
...
/obj/item/spell/proc/check_for_scepter() // CHOMPEdit - Removal of obj/item/weapon
	if(!src || !owner) return 0
	if(owner.r_hand == src)
		if(istype(owner.l_hand, /obj/item/scepter)) // CHOMPEdit - Removal of obj/item/weapon
			return 1
	else
		if(istype(owner.r_hand, /obj/item/scepter)) // CHOMPEdit - Removal of obj/item/weapon
			return 1
	return 0
...
/obj/item/spell/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/spell)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/spell/spell = W // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/afterattack(atom/target, mob/user, proximity_flag, click_parameters) // CHOMPEdit - Removal of obj/item/weapon
	if(!run_checks())
		return
	if(!proximity_flag)
...
/obj/item/spell/dropped() // CHOMPEdit - Removal of obj/item/weapon
	spawn(1)
		if(src)
			qdel(src)
...
/obj/item/spell/throw_impact(atom/hit_atom) // CHOMPEdit - Removal of obj/item/weapon
	..()
