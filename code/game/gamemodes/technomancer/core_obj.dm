...
/obj/item/technomancer_core // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_core/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	START_PROCESSING(SSobj, src)

/obj/item/technomancer_core/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	dismiss_all_summons()
	STOP_PROCESSING(SSobj, src)
	return ..()

// Add the spell buttons to the HUD.
/obj/item/technomancer_core/equipped(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	wearer = user
...
/obj/item/technomancer_core/dropped(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/carbon/human/technomancer_pay_energy(amount)
	if(istype(back, /obj/item/technomancer_core)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/technomancer_core/TC = back // CHOMPEdit - Removal of obj/item/weapon
		return TC.pay_energy(amount)
	return 0

/obj/item/technomancer_core/proc/pay_energy(amount) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_core/proc/give_energy(amount) // CHOMPEdit - Removal of obj/item/weapon
	energy = min(energy + amount, max_energy)
	return 1

/obj/item/technomancer_core/process() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_core/proc/regenerate() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_core/proc/pay_dues() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_core/proc/maintain_summon_list() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_core/proc/dismiss_all_summons() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/spellbutton
	...
	var/spellpath = null
	var/obj/item/technomancer_core/core = null // CHOMPEdit - Removal of obj/item/weapon
...
/mob/living/carbon/human/Stat()
	...
	if(. && istype(back,/obj/item/technomancer_core)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/technomancer_core/core = back // CHOMPEdit - Removal of obj/item/weapon
		setup_technomancer_stat(core)

/mob/living/carbon/human/proc/setup_technomancer_stat(var/obj/item/technomancer_core/core) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_core/proc/add_spell(var/path, var/new_name, var/ability_icon_state) // CHOMPEdit - Removal of obj/item/weapon
	if(!path || !ispath(path))
...
/obj/item/technomancer_core/proc/remove_spell(var/obj/spellbutton/spell_to_remove) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_core/proc/remove_all_spells() // CHOMPEdit - Removal of obj/item/weapon
	for(var/obj/spellbutton/spell in spells)
		spells.Remove(spell)
		qdel(spell)

/obj/item/technomancer_core/proc/has_spell(var/datum/technomancer/spell_to_check) // CHOMPEdit - Removal of obj/item/weapon
	for(var/obj/spellbutton/spell in spells)
...
/mob/living/carbon/human/proc/wiz_energy_update_hud()
	if(client && hud_used)
		if(istype(back, /obj/item/technomancer_core)) //I reckon there's a better way of doing this. // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/technomancer_core/core = back // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_core/unstable // CHOMPEdit - Removal of obj/item/weapon
	name = "unstable core"
...
/obj/item/technomancer_core/unstable/regenerate() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_core/rapid // CHOMPEdit - Removal of obj/item/weapon
	name = "rapid core"
...
/obj/item/technomancer_core/bulky // CHOMPEdit - Removal of obj/item/weapon
	name = "bulky core"
...
/obj/item/technomancer_core/recycling // CHOMPEdit - Removal of obj/item/weapon
	name = "recycling core"
...
/obj/item/technomancer_core/recycling/pay_energy(amount) // CHOMPEdit - Removal of obj/item/weapon
	var/success = ..()
	if(success)
		if(prob(30))
...
/obj/item/technomancer_core/summoner // CHOMPEdit - Removal of obj/item/weapon
	name = "summoner core"
...
/obj/item/technomancer_core/summoner/pay_dues() // CHOMPEdit - Removal of obj/item/weapon
	if(summoned_mobs.len)
		pay_energy( round(summoned_mobs.len) )

// For those who hate instability.
/obj/item/technomancer_core/safety // CHOMPEdit - Removal of obj/item/weapon
	name = "safety core"
...
/obj/item/technomancer_core/overcharged // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_core/golem // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_core/verb/toggle_lock() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/technomancer_core/universal // CHOMPEdit - Removal of obj/item/weapon
	name = "universal core"
	desc = "A bewilderingly complex 'black box' that allows the wearer to accomplish amazing feats. \
