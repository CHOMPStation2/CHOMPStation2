/datum/technomancer/spell/control
	...
	cost = 100
	obj_path = /obj/item/spell/control // CHOMPEdit - Removal of obj/item/weapon
	ability_icon_state = "tech_control"
	category = UTILITY_SPELLS

/mob/living/carbon/human/proc/technomancer_control()
	place_spell_in_hand(/obj/item/spell/control) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/spell/control // CHOMPEdit - Removal of obj/item/weapon
	name = "control"
	icon_state = "control"
...
/obj/item/spell/control/proc/select(var/mob/living/L) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/control/proc/deselect(var/mob/living/L) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/control/proc/move_all(turf/T) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/control/proc/attack_all(mob/target) // CHOMPEdit - Removal of obj/item/weapon
	for(var/mob/living/L in controlled_mobs)
		if(!L.has_AI() || L.stat)
			deselect(L)
			continue
...
/obj/item/spell/control/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	control_overlay = image('icons/obj/spells.dmi',"controlled")
	return ..()

/obj/item/spell/control/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	for(var/mob/living/L in controlled_mobs)
		deselect(L)
	controlled_mobs = list()
	return ..()

/obj/item/spell/control/on_use_cast(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/control/on_ranged_cast(atom/hit_atom, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
