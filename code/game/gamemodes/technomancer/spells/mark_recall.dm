/datum/technomancer/spell/mark
	...
	cost = 25
	obj_path = /obj/item/spell/mark // CHOMPEdit - Removal of obj/item/weapon
...
//VOREStation Add End
/obj/item/spell/mark // CHOMPEdit - Removal of obj/item/weapon
	name = "mark"
	icon_state = "mark"
...
/obj/item/spell/mark/on_use_cast(var/mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/technomancer/spell/recall
	...
	cost = 25
	obj_path = /obj/item/spell/recall // CHOMPEdit - Removal of obj/item/weapon
	ability_icon_state = "tech_recall"
	category = UTILITY_SPELLS

/obj/item/spell/recall // CHOMPEdit - Removal of obj/item/weapon
	name = "recall"
	icon_state = "recall"
...
/obj/item/spell/recall/on_use_cast(var/mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(pay_energy(3000))
		...
		if(!istype(marker))
			...
			for(var/obj/item/grab/G in user.contents) // People the Technomancer is grabbing come along for the ride. // CHOMPEdit - Removal of obj/item/weapon
				if(G.affecting)
