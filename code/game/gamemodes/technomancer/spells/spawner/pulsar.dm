/datum/technomancer/spell/pulsar
	...
	cost = 100
	obj_path = /obj/item/spell/spawner/pulsar // CHOMPEdit - Removal of obj/item/weapon
	category = OFFENSIVE_SPELLS

/obj/item/spell/spawner/pulsar // CHOMPEdit - Removal of obj/item/weapon
	name = "pulsar"
...
/obj/item/spell/spawner/pulsar/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	set_light(3, 2, l_color = "#2ECCFA")

/obj/item/spell/spawner/pulsar/on_ranged_cast(atom/hit_atom, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(within_range(hit_atom) && pay_energy(4000))
		adjust_instability(8)
		..()

/obj/item/spell/spawner/pulsar/on_throw_cast(atom/hit_atom, mob/user) // CHOMPEdit - Removal of obj/item/weapon
