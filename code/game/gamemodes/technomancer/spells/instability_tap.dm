/datum/technomancer/spell/instability_tap
	...
	cost = 100
	obj_path = /obj/item/spell/instability_tap // CHOMPEdit - Removal of obj/item/weapon
	ability_icon_state = "tech_instabilitytap"
	category = UTILITY_SPELLS

/obj/item/spell/instability_tap // CHOMPEdit - Removal of obj/item/weapon
	name = "instability tap"
	desc = "Short term gain for long term consequences never end bad, right?"
	cast_methods = CAST_USE
	aspect = ASPECT_UNSTABLE

/obj/item/spell/instability_tap/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	set_light(3, 2, l_color = "#FA58F4")

/obj/item/spell/instability_tap/on_use_cast(mob/user) // CHOMPEdit - Removal of obj/item/weapon
