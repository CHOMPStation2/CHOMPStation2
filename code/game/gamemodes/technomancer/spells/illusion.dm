/datum/technomancer/spell/illusion
	...
	cost = 25
	obj_path = /obj/item/spell/illusion // CHOMPEdit - Removal of obj/item/weapon
	ability_icon_state = "tech_illusion"
	category = UTILITY_SPELLS

/obj/item/spell/illusion // CHOMPEdit - Removal of obj/item/weapon
	name = "illusion"
	icon_state = "illusion"
...
/obj/item/spell/illusion/on_ranged_cast(atom/hit_atom, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/illusion/on_use_cast(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(illusion)
...
/obj/item/spell/illusion/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	QDEL_NULL(illusion)
	copied = null
	return ..()

// Makes a tiny overlay of the thing the player has copied, so they can easily tell what they currently have.
/obj/item/spell/illusion/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	cut_overlays()
	if(copied)
