/datum/technomancer/spell/asphyxiation
	...
	cost = 140
	obj_path = /obj/item/spell/insert/asphyxiation // CHOMPEdit - Removal of obj/item/weapon

/obj/item/spell/insert/asphyxiation // CHOMPEdit - Removal of obj/item/weapon
	name = "asphyxiation"
	...
	light_color = "#FF5C5C"
	inserting = /obj/item/inserted_spell/asphyxiation // CHOMPEdit - Removal of obj/item/weapon

// maxHealth - getOxyLoss() - getToxLoss() - getFireLoss() - getBruteLoss() - getCloneLoss() - halloss

/obj/item/inserted_spell/asphyxiation/on_insert() // CHOMPEdit - Removal of obj/item/weapon
	spawn(1)
		if(ishuman(host))
...
/obj/item/inserted_spell/asphyxiation/on_expire() // CHOMPEdit - Removal of obj/item/weapon
	..()

// if((getOxyLoss() > (species.total_health/2)) || (health <= config.health_threshold_crit))

/obj/item/inserted_spell/asphyxiation/proc/predict_crit(var/pulses_remaining, var/mob/living/carbon/human/victim, var/previous_damage = 0) // CHOMPEdit - Removal of obj/item/weapon
