/datum/technomancer/spell/mend_burns
	...
	cost = 50
	obj_path = /obj/item/spell/insert/mend_burns // CHOMPEdit - Removal of obj/item/weapon
	ability_icon_state = "tech_mendburns"
	category = SUPPORT_SPELLS

/obj/item/spell/insert/mend_burns // CHOMPEdit - Removal of obj/item/weapon
	name = "mend burns"
	...
	light_color = "#FF5C5C"
	inserting = /obj/item/inserted_spell/mend_burns // CHOMPEdit - Removal of obj/item/weapon

/obj/item/inserted_spell/mend_burns/on_insert() // CHOMPEdit - Removal of obj/item/weapon
	spawn(1)
		if(ishuman(host))
