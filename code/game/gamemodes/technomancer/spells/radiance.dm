/datum/technomancer/spell/radiance
	...
	cost = 100
	obj_path = /obj/item/spell/radiance // CHOMPEdit - Removal of obj/item/weapon
	category = OFFENSIVE_SPELLS

/obj/item/spell/radiance // CHOMPEdit - Removal of obj/item/weapon
	name = "radiance"
...
/obj/item/spell/radiance/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	set_light(7, 4, l_color = "#D9D900")
	START_PROCESSING(SSobj, src)
	log_and_message_admins("has casted [src].")

/obj/item/spell/radiance/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	STOP_PROCESSING(SSobj, src)
	log_and_message_admins("has stopped maintaining [src].")
	return ..()

/obj/item/spell/radiance/process() // CHOMPEdit - Removal of obj/item/weapon
