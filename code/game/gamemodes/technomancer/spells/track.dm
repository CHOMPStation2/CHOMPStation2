/datum/technomancer/spell/track
	...
	cost = 25
	obj_path = /obj/item/spell/track // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/track // CHOMPEdit - Removal of obj/item/weapon
	name = "track"
	icon_state = "track"
...
/obj/item/spell/track/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	tracked = null
	tracking = 0
	return ..()

/obj/item/spell/track/on_use_cast(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(tracking)
		tracking = 0
...
/obj/item/spell/track/proc/track() // CHOMPEdit - Removal of obj/item/weapon
	if(!tracking)
		icon_state = "track"
		return
