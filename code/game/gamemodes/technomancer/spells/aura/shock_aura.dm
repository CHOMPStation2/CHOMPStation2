/datum/technomancer/spell/shock_aura
	...
	cost = 100
	obj_path = /obj/item/spell/aura/shock // CHOMPEdit - Removal of obj/item/weapon
	ability_icon_state = "tech_shockaura"
	category = OFFENSIVE_SPELLS

/obj/item/spell/aura/shock // CHOMPEdit - Removal of obj/item/weapon
	name = "electric aura"
...
/obj/item/spell/aura/shock/process() // CHOMPEdit - Removal of obj/item/weapon
	if(!pay_energy(500))
		qdel(src)
