/datum/technomancer/spell/warp_strike
	...
	cost = 100
	obj_path = /obj/item/spell/warp_strike // CHOMPEdit - Removal of obj/item/weapon
	ability_icon_state = "tech_warpstrike"
	category = OFFENSIVE_SPELLS

/obj/item/spell/warp_strike // CHOMPEdit - Removal of obj/item/weapon
	name = "warp strike"
...
/obj/item/spell/warp_strike/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	sparks = new /datum/effect/effect/system/spark_spread()
	sparks.set_up(5, 0, src)
	sparks.attach(loc)

/obj/item/spell/warp_strike/on_ranged_cast(atom/hit_atom, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(T)
		...
		var/list/blacklisted_items = list(
			...
			/obj/item/spell/warp_strike, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/spell/targeting_matrix // CHOMPEdit - Removal of obj/item/weapon
			)
		if(I)
