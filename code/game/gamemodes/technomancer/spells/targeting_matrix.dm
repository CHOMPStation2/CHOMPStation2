/datum/technomancer/spell/targeting_matrix
	...
	obj_path = /obj/item/spell/targeting_matrix // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/targeting_matrix/on_ranged_cast(atom/hit_atom, mob/user) // CHOMPEdit - Removal of obj/item/weapon
