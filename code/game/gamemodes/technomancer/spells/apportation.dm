/datum/technomancer/spell/apportation
	...
	cost = 25
	obj_path = /obj/item/spell/apportation // CHOMPEdit - Removal of obj/item/weapon
	category = UTILITY_SPELLS

/obj/item/spell/apportation // CHOMPEdit - Removal of obj/item/weapon
	name = "apportation"
...
/obj/item/spell/apportation/on_ranged_cast(atom/hit_atom, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(hit_atom, /atom/movable))
		...
		//Now let's try to teleport a living mob.
			...
			spawn(1 SECOND)
				...
				var/obj/item/grab/G = new(user,L) // CHOMPEdit - Removal of obj/item/weapon
