/datum/technomancer/spell/reflect
	...
	cost = 100
	obj_path = /obj/item/spell/reflect // CHOMPEdit - Removal of obj/item/weapon
	ability_icon_state = "tech_reflect"
	category = DEFENSIVE_SPELLS

/obj/item/spell/reflect // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/reflect/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/spell/reflect/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	if(owner)
		to_chat(owner, "<span class='danger'>Your shield expires!</span>")
	spark_system = null
	return ..()

/obj/item/spell/reflect/handle_shield(mob/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, var/attack_text = "the attack") // CHOMPEdit - Removal of obj/item/weapon
	...
	if(check_shield_arc(user, bad_arc, damage_source, attacker))
		...
		else if(istype(damage_source, /obj/item)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/W = damage_source // CHOMPEdit - Removal of obj/item/weapon
			if(attacker)
				W.attack(attacker)
