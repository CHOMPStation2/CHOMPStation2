...
/obj/item/spell/projectile/on_ranged_cast(atom/hit_atom, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/projectile/proc/make_projectile(obj/item/projectile/projectile_type, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/projectile/P = new projectile_type(get_turf(user))
	P.damage = calculate_spell_power(P.damage)
	return P

/obj/item/spell/projectile/proc/set_up(atom/hit_atom, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(spell_projectile)
