/datum/technomancer/spell/energy_siphon
	...
	cost = 100
	obj_path = /obj/item/spell/energy_siphon // CHOMPEdit - Removal of obj/item/weapon
	ability_icon_state = "tech_energysiphon"
	category = UTILITY_SPELLS

/obj/item/spell/energy_siphon // CHOMPEdit - Removal of obj/item/weapon
	name = "energy siphon"
...
/obj/item/spell/energy_siphon/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	START_PROCESSING(SSobj, src)

/obj/item/spell/energy_siphon/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	stop_siphoning()
	STOP_PROCESSING(SSobj, src)
	return ..()

/obj/item/spell/energy_siphon/process() // CHOMPEdit - Removal of obj/item/weapon
	if(!siphoning)
		return
	if(!pay_energy(100))
...
/obj/item/spell/energy_siphon/on_ranged_cast(atom/hit_atom, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/energy_siphon/proc/populate_siphon_list(atom/movable/target) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/energy_siphon/proc/stop_siphoning() // CHOMPEdit - Removal of obj/item/weapon
	siphoning = null
	things_to_siphon.Cut()
	update_icon()
...
/obj/item/spell/energy_siphon/proc/siphon(atom/movable/siphoning, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(round(flow_remaining))
		if(ishuman(siphoning))
			...
			if(istype(H.back, /obj/item/technomancer_core) && H != user) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/technomancer_core/their_core = H.back // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/energy_siphon/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(siphoning)
...
/obj/item/spell/energy_siphon/proc/create_lightning(mob/user, atom/source) // CHOMPEdit - Removal of obj/item/weapon
