...
/obj/item/spell/modifier/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	set_light(spell_light_range, spell_light_intensity, l_color = light_color)

/obj/item/spell/modifier/on_melee_cast(atom/hit_atom, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(hit_atom, /mob/living))
		return on_add_modifier(hit_atom)
	return FALSE

/obj/item/spell/modifier/on_ranged_cast(atom/hit_atom, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(hit_atom, /mob/living))
		return on_add_modifier(hit_atom)
	return FALSE


/obj/item/spell/modifier/proc/on_add_modifier(var/mob/living/L) // CHOMPEdit - Removal of obj/item/weapon
