/datum/technomancer/equipment/default_core
	...
	Spell Power: 100%"
	cost = 100
	obj_path = /obj/item/technomancer_core // CHOMPEdit - Removal of obj/item/weapon
...
/datum/technomancer/equipment/rapid_core
	...
	Spell Power: 100%"
	cost = 100
	obj_path = /obj/item/technomancer_core/rapid // CHOMPEdit - Removal of obj/item/weapon
...
/datum/technomancer/equipment/bulky_core
	...
	cost = 100
	obj_path = /obj/item/technomancer_core/bulky // CHOMPEdit - Removal of obj/item/weapon
...
/datum/technomancer/equipment/unstable
	...
	cost = 100
	obj_path = /obj/item/technomancer_core/unstable // CHOMPEdit - Removal of obj/item/weapon
...
/datum/technomancer/equipment/recycling
	...
	Spell Power: 100%"
	cost = 100
	obj_path = /obj/item/technomancer_core/recycling // CHOMPEdit - Removal of obj/item/weapon
...
/datum/technomancer/equipment/summoning
	...
	cost = 100
	obj_path = /obj/item/technomancer_core/summoner // CHOMPEdit - Removal of obj/item/weapon
...
/datum/technomancer/equipment/safety
	...
	cost = 100
	obj_path = /obj/item/technomancer_core/safety // CHOMPEdit - Removal of obj/item/weapon
...
/datum/technomancer/equipment/overcharged
	...
	cost = 100
	obj_path = /obj/item/technomancer_core/overcharged // CHOMPEdit - Removal of obj/item/weapon
...
/datum/technomancer/equipment/hypo_belt
	...
	cost = 50
	obj_path = /obj/item/storage/belt/medical/technomancer // CHOMPEdit - Removal of obj/item/weapon

/obj/item/storage/belt/medical/technomancer // CHOMPEdit - Removal of obj/item/weapon
	name = "hypo belt"
	desc = "A medical belt designed to carry autoinjectors and other medical equipment."

/obj/item/storage/belt/medical/technomancer/New() // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/reagent_containers/hypospray/autoinjector/biginjector/brute(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/reagent_containers/hypospray/autoinjector/biginjector/burn(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/reagent_containers/hypospray/autoinjector/biginjector/toxin(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/reagent_containers/hypospray/autoinjector/biginjector/oxy(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/reagent_containers/hypospray/autoinjector/biginjector/purity(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/reagent_containers/hypospray/autoinjector/biginjector/pain(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/reagent_containers/hypospray/autoinjector/biginjector/organ(src) // CHOMPEdit - Removal of obj/item/weapon
	new /obj/item/reagent_containers/hypospray/autoinjector/biginjector/combat(src) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/datum/technomancer/equipment/belt_of_holding
	...
	cost = 50
	obj_path = /obj/item/storage/belt/holding // CHOMPEdit - Removal of obj/item/weapon

/obj/item/storage/belt/holding // CHOMPEdit - Removal of obj/item/weapon
	name = "Belt of Holding"
...
/datum/technomancer/equipment/scepter
	...
	cost = 200
	obj_path = /obj/item/scepter // CHOMPEdit - Removal of obj/item/weapon

/obj/item/scepter // CHOMPEdit - Removal of obj/item/weapon
	name = "scepter of empowerment"
...
/obj/item/scepter/attack_self(mob/living/carbon/human/user) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/item_to_test = user.get_other_hand(src)
	if(istype(item_to_test, /obj/item/spell)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/spell/S = item_to_test // CHOMPEdit - Removal of obj/item/weapon
		S.on_scepter_use_cast(user)

/obj/item/scepter/afterattack(atom/target, mob/living/carbon/human/user, proximity_flag, click_parameters) // CHOMPEdit - Removal of obj/item/weapon
	if(proximity_flag)
		return ..()
	var/obj/item/item_to_test = user.get_other_hand(src)
	if(istype(item_to_test, /obj/item/spell)) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/technomancer/equipment/spyglass
	...
	cost = 100
	obj_path = /obj/item/binoculars/spyglass // CHOMPEdit - Removal of obj/item/device
