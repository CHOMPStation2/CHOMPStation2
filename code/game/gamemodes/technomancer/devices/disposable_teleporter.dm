/datum/technomancer/consumable/disposable_teleporter
	...
	cost = 50
	obj_path = /obj/item/disposable_teleporter // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/disposable_teleporter/free // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/disposable_teleporter/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	. += "[uses] uses remaining."

/obj/item/disposable_teleporter/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!uses)
