/datum/technomancer/consumable/hypo_brute
	...
	cost = 25
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/brute // CHOMPEdit - Removal of obj/item/weapon

/datum/technomancer/consumable/hypo_burn
	name = "Burn Hypo"
	desc = "A extended capacity hypo which can treat severe burns."
	cost = 25
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/burn // CHOMPEdit - Removal of obj/item/weapon

/datum/technomancer/consumable/hypo_tox
	name = "Toxin Hypo"
	desc = "A extended capacity hypo which can treat various toxins."
	cost = 25
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/toxin // CHOMPEdit - Removal of obj/item/weapon

/datum/technomancer/consumable/hypo_oxy
	name = "Oxy Hypo"
	desc = "A extended capacity hypo which can treat oxygen deprivation."
	cost = 25
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/oxy // CHOMPEdit - Removal of obj/item/weapon
...
/datum/technomancer/consumable/hypo_purity
	...
	cost = 25
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/purity // CHOMPEdit - Removal of obj/item/weapon

/datum/technomancer/consumable/hypo_pain
	name = "Pain Hypo"
	desc = "A extended capacity hypo which contains potent painkillers."
	cost = 25
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/pain // CHOMPEdit - Removal of obj/item/weapon

/datum/technomancer/consumable/hypo_organ
	name = "Organ Hypo"
	desc = "A extended capacity hypo which is designed to fix internal organ problems."
	cost = 50
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/organ // CHOMPEdit - Removal of obj/item/weapon
...
/datum/technomancer/consumable/hypo_combat
	...
	cost = 75
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/combat // CHOMPEdit - Removal of obj/item/weapon
