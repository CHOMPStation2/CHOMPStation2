/datum/technomancer/consumable/freedom_implant
	...
	cost = 50
	obj_path = /obj/item/storage/box/syndie_kit/imp_freedom // CHOMPEdit - Removal of obj/item/weapon

/datum/technomancer/consumable/explosive_implant
	name = "Explosive Implant"
	desc = "A hidden implant which will explode if it hears a passphrase."
	cost = 150
	obj_path = /obj/item/storage/box/syndie_kit/imp_explosive // CHOMPEdit - Removal of obj/item/weapon
