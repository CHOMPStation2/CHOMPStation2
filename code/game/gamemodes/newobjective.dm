...
datum
	objective
		...
		steal
			...
			captainslaser
				steal_target = /obj/item/gun/energy/captain // CHOMPEdit - Removal of obj/item/weapon
			...
			plasmatank
				steal_target = /obj/item/tank/plasma // CHOMPEdit - Removal of obj/item/weapon
			...
			*/
			...
			handtele
				steal_target = /obj/item/hand_tele // CHOMPEdit - Removal of obj/item/weapon
			...
			RCD
				steal_target = /obj/item/rcd // CHOMPEdit - Removal of obj/item/weapon
			...
			/*burger
				steal_target = /obj/item/reagent_containers/food/snacks/human/burger // CHOMPEdit - Removal of obj/item/weapon
			...
			jetpack
				steal_target = /obj/item/tank/jetpack/oxygen // CHOMPEdit - Removal of obj/item/weapon
			...
			nuke_disk
				steal_target = /obj/item/disk/nuclear // CHOMPEdit - Removal of obj/item/weapon
			...
			nuke_gun
				steal_target = /obj/item/gun/energy/gun/nuclear // CHOMPEdit - Removal of obj/item/weapon
			...
			diamond_drill
				steal_target = /obj/item/pickaxe/diamonddrill // CHOMPEdit - Removal of obj/item/weapon
			...
			boh
				steal_target = /obj/item/storage/backpack/holding // CHOMPEdit - Removal of obj/item/weapon
			...
			hyper_cell
				steal_target = /obj/item/cell/hyper // CHOMPEdit - Removal of obj/item/weapon
			...
			steal/implanter
				steal_target = /obj/item/implanter // CHOMPEdit - Removal of obj/item/weapon
			...
			*/
			...
			AI
				...
				check_completion()
					if(steal_target)
						for(var/obj/item/aicard/C in owner.current.get_contents()) // CHOMPEdit - Removal of obj/item/device
			...
			cash	//must be in credits - atm and coins don't count
				...
				check_completion()
					var/held_credits = 0
					for(var/obj/item/spacecash/M in owner.current.get_contents()) // CHOMPEdit - Removal of obj/item/weapon
			...
			check_completion()
				if(target && target.current)
					if(!owner.current||owner.current.stat==2)//If you're otherwise dead.
						return 0
					var/list/all_items = owner.current.get_contents()
					for(var/obj/item/organ/head/mmi in all_items) // CHOMPEdit - Removal of obj/item/weapon
		...
		debrain//I want braaaainssss
			...
			check_completion()
				...
				if(!owner.current||owner.current.stat==2)//If you're otherwise dead.
					return 0
				var/list/all_items = owner.current.get_contents()
				for(var/obj/item/mmi/mmi in all_items) // CHOMPEdit - Removal of obj/item/device
