...
/datum/game_mode/nuclear/proc/check_nuke_disks()
	for(var/obj/item/disk/nuclear/N in nuke_disks) // CHOMPEdit - Removal of obj/item/weapon
...
/datum/game_mode/nuclear/declare_completion()
	if(CONFIG_GET(flag/objectives_disabled)) // CHOMPEdit
		...
		return
	var/disk_rescued = 1
	for(var/obj/item/disk/nuclear/D in nuke_disks) // CHOMPEdit - Removal of obj/item/weapon
