...
/*			var/list/turf/simulated/floor/Floorlist = list()
			...
			var/obj/item/reagent_containers/food/snacks/chocolateegg/wrapped/Egg // CHOMPEdit - Removal of obj/item/weapon
			if( C )			Egg = new(C)
			else			Egg = new(F)
*/
/*			var/list/obj/containers = list()
			for(var/obj/item/storage/S in world) // CHOMPEdit - Removal of obj/item/weapon
