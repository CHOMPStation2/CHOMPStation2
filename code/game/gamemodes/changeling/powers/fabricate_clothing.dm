var/global/list/changeling_fabricated_clothing = list(
	...
	"back" = /obj/item/storage/backpack/chameleon/changeling, // CHOMPEdit - Removal of obj/item/weapon
	"belt" = /obj/item/storage/belt/chameleon/changeling, // CHOMPEdit - Removal of obj/item/weapon
	"wear_id" = /obj/item/card/id/syndicate/changeling // CHOMPEdit - Removal of obj/item/weapon
	)
...
/obj/item/storage/backpack/chameleon/changeling // CHOMPEdit - Removal of obj/item/weapon
	name = "backpack"
	icon_state = "backpack"
	item_icons = list(
...
/obj/item/storage/backpack/chameleon/changeling/emp_act() // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/storage/backpack/chameleon/changeling/verb/shred() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/belt/chameleon/changeling // CHOMPEdit - Removal of obj/item/weapon
	name = "waist pouch"
...
/obj/item/storage/belt/chameleon/changeling/emp_act() // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/storage/belt/chameleon/changeling/verb/shred() // CHOMPEdit - Removal of obj/item/weapon
	set name = "Shred Belt"
	set category = "Chameleon Items"
	if(ishuman(loc))
		var/mob/living/carbon/human/H = loc
...
/obj/item/card/id/syndicate/changeling // CHOMPEdit - Removal of obj/item/weapon
	name = "chitinous card"
...
/obj/item/card/id/syndicate/changeling/New(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
	registered_user = user

/obj/item/card/id/syndicate/changeling/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	access = null

/obj/item/card/id/syndicate/changeling/verb/shred() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/card/id/syndicate/changeling/Click() //Since we can't hold it in our hands, and attack_hand() doesn't work if it in inventory... // CHOMPEdit - Removal of obj/item/weapon
	if(!registered_user)
		registered_user = usr
		usr.set_id_info(src)
