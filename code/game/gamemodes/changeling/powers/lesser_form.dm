...
/mob/proc/changeling_lesser_form()
	...
	for(var/obj/item/implant/W in H) // CHOMPEdit - Removal of obj/item/weapon
		implants += W
	H.monkeyize()
...
/mob/proc/changeling_lesser_transform()
	...
	for (var/obj/item/implant/I in C) //Still preserving implants // CHOMPEdit - Removal of obj/item/weapon
		implants += I
	...
	O.set_stat(C.stat)
	for (var/obj/item/implant/I in implants) // CHOMPEdit - Removal of obj/item/weapon
		I.loc = O
		I.implanted = O
