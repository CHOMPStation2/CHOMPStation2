...
/obj/item/clothing/suit/space/changeling
	...
	allowed = list(/obj/item/flashlight, /obj/item/tank/emergency/oxygen, /obj/item/tank/oxygen) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
