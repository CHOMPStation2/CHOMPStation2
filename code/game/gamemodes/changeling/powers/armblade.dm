...
/mob/proc/changeling_arm_blade()
	...
	if(src.mind.changeling.recursive_enhancement)
		if(changeling_generic_weapon(/obj/item/melee/changeling/arm_blade/greater)) // CHOMPEdit - Removal of obj/item/weapon
			to_chat(src, "<span class='notice'>We prepare an extra sharp blade.</span>")
			return 1

	else
		if(changeling_generic_weapon(/obj/item/melee/changeling/arm_blade)) // CHOMPEdit - Removal of obj/item/weapon
			return 1
		return 0
...
/mob/proc/changeling_claw()
	...
	if(src.mind.changeling.recursive_enhancement)
		if(changeling_generic_weapon(/obj/item/melee/changeling/claw/greater, 1, 15)) // CHOMPEdit - Removal of obj/item/weapon
			to_chat(src, "<span class='notice'>We prepare an extra sharp claw.</span>")
			return 1

	else
		if(changeling_generic_weapon(/obj/item/melee/changeling/claw, 1, 15)) // CHOMPEdit - Removal of obj/item/weapon
			return 1
		return 0

/obj/item/melee/changeling // CHOMPEdit - Removal of obj/item/weapon
	name = "arm weapon"
...
/obj/item/melee/changeling/New(location) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/melee/changeling/dropped(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/melee/changeling/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	STOP_PROCESSING(SSobj, src)
	creator = null
	..()

/obj/item/melee/changeling/process()  //Stolen from ninja swords. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/melee/changeling/handle_shield(mob/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, var/attack_text = "the attack") // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/melee/changeling/unique_parry_check(mob/user, mob/attacker, atom/damage_source) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/melee/changeling/arm_blade // CHOMPEdit - Removal of obj/item/weapon
	name = "arm blade"
...
/obj/item/melee/changeling/arm_blade/greater // CHOMPEdit - Removal of obj/item/weapon
	name = "arm greatblade"
...
/obj/item/melee/changeling/claw // CHOMPEdit - Removal of obj/item/weapon
	name = "hand claw"
...
/obj/item/melee/changeling/claw/greater // CHOMPEdit - Removal of obj/item/weapon
	name = "hand greatclaw"
	force = 20
