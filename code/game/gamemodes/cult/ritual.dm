...
/obj/effect/rune/attackby(I as obj, user as mob)
	if(istype(I, /obj/item/book/tome) && iscultist(user)) // CHOMPEdit - Removal of obj/item/weapon
		to_chat(user, "You retrace your steps, carefully undoing the lines of the rune.")
		qdel(src)
		return
	else if(istype(I, /obj/item/nullrod)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/book/tome/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(!cultwords["travel"])
		runerandom()
...
/obj/item/book/tome/attack(mob/living/M as mob, mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/book/tome/attack_self(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	usr = user
...
/obj/item/book/tome/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(!iscultist(user))
...
/obj/item/book/tome/cultify() // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/book/tome/imbued //admin tome, spawns working runes without waiting // CHOMPEdit - Removal of obj/item/weapon
	w_class = ITEMSIZE_SMALL
	var/cultistsonly = 1
/obj/item/book/tome/imbued/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
