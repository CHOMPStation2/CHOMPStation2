...
/obj/item/soulstone/cultify() // CHOMPEdit - Removal of obj/item/device
	return

//////////////////////////////Capturing////////////////////////////////////////////////////////

/obj/item/soulstone/attack(mob/living/carbon/human/M as mob, mob/user as mob) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/soulstone/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/soulstone/Topic(href, href_list) // CHOMPEdit - Removal of obj/item/device
	var/mob/U = usr
...
/obj/structure/constructshell/attackby(obj/item/O as obj, mob/user as mob)
	if(istype(O, /obj/item/soulstone)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/soulstone/S = O; // CHOMPEdit - Removal of obj/item/device
		S.transfer_soul("CONSTRUCT",src,user)


////////////////////////////Proc for moving soul in and out off stone//////////////////////////////////////
/obj/item/soulstone/proc/transfer_human(var/mob/living/carbon/human/T,var/mob/U) // CHOMPEdit - Removal of obj/item/device
	if(!istype(T))
		return;
...
/obj/item/soulstone/proc/transfer_shade(var/mob/living/simple_mob/construct/shade/T,var/mob/U) // CHOMPEdit - Removal of obj/item/device
	if(!istype(T))
		return;
	if (T.stat == DEAD)
...
/obj/item/soulstone/proc/transfer_construct(var/obj/structure/constructshell/T,var/mob/U) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/soulstone/proc/transfer_soul(var/choice as text, var/target, var/mob/U as mob) // CHOMPEdit - Removal of obj/item/device
	switch(choice)
		if("VICTIM")
