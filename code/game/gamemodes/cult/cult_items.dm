...
/obj/item/melee/cultblade/cultify() // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/melee/cultblade/attack(mob/living/M, mob/living/user, var/target_zone) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/melee/cultblade/pickup(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!iscultist(user) && !istype(user, /mob/living/simple_mob/construct))
...
/obj/item/clothing/suit/cultrobes
	...
	allowed = list(/obj/item/book/tome,/obj/item/melee/cultblade) // CHOMPEdit - Removal of obj/item/weapon
	armor = list(melee = 50, bullet = 30, laser = 50, energy = 80, bomb = 25, bio = 10, rad = 0)
...
/obj/item/clothing/suit/space/cult
	...
	allowed = list(/obj/item/book/tome,/obj/item/melee/cultblade,/obj/item/tank/emergency/oxygen,/obj/item/suit_cooling_unit) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	slowdown = 0.5
	armor = list(melee = 60, bullet = 50, laser = 30, energy = 80, bomb = 30, bio = 30, rad = 30)
	siemens_coefficient = 0
