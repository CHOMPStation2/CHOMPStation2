...
/proc/findNullRod(var/atom/target)
	if(istype(target,/obj/item/nullrod)) // CHOMPEdit - Removal of obj/item/weapon
		return 1
...
/spell/aoe_turf/conjure/soulstone
	...
	summon_type = list(/obj/item/soulstone) // CHOMPEdit - Removal of obj/item/device
...
/spell/targeted/construct_advanced
	...
	var/obj/item/spell/construct/spell_obj = null //This is the var that determines what Technomancer-style spell is put into their hands. // CHOMPEdit - Removal of obj/item/weapon
...
/spell/targeted/construct_advanced/inversion_beam
	...
	spell_obj = /obj/item/spell/construct/projectile/inverted_beam // CHOMPEdit - Removal of obj/item/weapon
...
/spell/targeted/construct_advanced/mend_acolyte
	...
	spell_obj = /obj/item/spell/construct/mend_occult // CHOMPEdit - Removal of obj/item/weapon
...
/spell/targeted/construct_advanced/agonizing_sphere
	...
	hud_state = "const_harvest"
	spell_obj = /obj/item/spell/construct/spawner/agonizing_sphere // CHOMPEdit - Removal of obj/item/weapon
...
/spell/targeted/construct_advanced/slam
	...
	spell_obj = /obj/item/spell/construct/slam // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/construct //Energy costs are in units of blood, in the event a cultist gets one of these. // CHOMPEdit - Removal of obj/item/weapon
	name = "unholy energy"
...
/obj/item/spell/construct/New() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/construct/adjust_instability(var/amount) //The only drawback to the boons of the geometer is the use of a mortal's blood as fuel. Constructs have already paid that price long ago. // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/spell/construct/run_checks() // CHOMPEdit - Removal of obj/item/weapon
	if(owner)
...
/obj/item/spell/construct/pay_energy(var/amount) // CHOMPEdit - Removal of obj/item/weapon
	if(owner)
...
/obj/item/spell/construct/proc/pay_blood(var/amount) //If, for some reason, this is put into the hands of a cultist, by a talisnam or whatever. // CHOMPEdit - Removal of obj/item/weapon
	if(ishuman(owner))
...
/obj/item/spell/construct/afterattack(atom/target, mob/user, proximity_flag, click_parameters) //Not overriding it caused runtimes, because cooldown checked for core. // CHOMPEdit - Removal of obj/item/weapon
	if(!run_checks())
		return
	if(!proximity_flag)
		...
		if(istype(target, /obj/item/spell)) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/spell/spell = target // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/construct/projectile //This makes me angry, but we need the template, and we can't use it because special check overrides on the base. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/construct/projectile/on_ranged_cast(atom/hit_atom, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/construct/projectile/proc/make_projectile(obj/item/projectile/projectile_type, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/projectile/P = new projectile_type(get_turf(user))
	return P

/obj/item/spell/construct/projectile/proc/set_up(atom/hit_atom, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(spell_projectile)
...
/obj/item/spell/construct/spawner // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/construct/spawner/on_ranged_cast(atom/hit_atom, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/spell/construct/projectile/inverted_beam // CHOMPEdit - Removal of obj/item/weapon
	name = "inversion beam"
	icon_state = "generic"
...
/obj/item/spell/construct/spawner/agonizing_sphere // CHOMPEdit - Removal of obj/item/weapon
	name = "sphere of agony"
...
/obj/item/spell/construct/spawner/agonizing_sphere/on_ranged_cast(atom/hit_atom, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(within_range(hit_atom) && pay_energy(10))
		..()

/obj/item/spell/construct/spawner/agonizing_sphere/on_throw_cast(atom/hit_atom, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	pay_energy(5)
...
/obj/item/spell/construct/mend_occult // CHOMPEdit - Removal of obj/item/weapon
	name = "mend acolyte"
...
/obj/item/spell/construct/mend_occult/on_melee_cast(atom/hit_atom, mob/living/user, def_zone) // CHOMPEdit - Removal of obj/item/weapon
	if(isliving(hit_atom))
		var/mob/living/L = hit_atom
...
//Juggernaut Slam
/obj/item/spell/construct/slam // CHOMPEdit - Removal of obj/item/weapon
	name = "slam"
...
/obj/item/spell/construct/slam/on_melee_cast(atom/hit_atom, mob/living/user, def_zone) // CHOMPEdit - Removal of obj/item/weapon
