/obj/item/paper/talisman // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "paper_talisman"
	var/imbue = null
	var/uses = 0
	info = "<center><img src='talisman.png'></center><br/><br/>"

/obj/item/paper/talisman/attack_self(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(iscultist(user))
		var/delete = 1
...
/obj/item/paper/talisman/attack(mob/living/carbon/T as mob, mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(iscultist(user))
		if(imbue == "runestun")
			user.take_organ_damage(5, 0)
...
/obj/item/paper/talisman/proc/supply(var/key) // CHOMPEdit - Removal of obj/item/weapon
	if (!src.uses)
		qdel(src)
		return
...
/obj/item/paper/talisman/Topic(href, href_list) // CHOMPEdit - Removal of obj/item/weapon
	if(!src)	return
	...
	if (href_list["rune"])
		switch(href_list["rune"])
			if("newtome")
				var/obj/item/paper/talisman/T = new /obj/item/paper/talisman(get_turf(usr)) // CHOMPEdit - Removal of obj/item/weapon
				T.imbue = "newtome"
			if("teleport")
				var/obj/item/paper/talisman/T = new /obj/item/paper/talisman(get_turf(usr)) // CHOMPEdit - Removal of obj/item/weapon
			...
			if("armor")
				...
				T.imbue = "armor"
			if("soulstone")
				new /obj/item/soulstone(get_turf(usr)) // CHOMPEdit - Removal of obj/item/device
			if("construct")
...
/obj/item/paper/talisman/supply // CHOMPEdit - Removal of obj/item/weapon
	imbue = "supply"
	uses = 5
