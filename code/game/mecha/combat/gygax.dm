...
/obj/mecha/combat/gygax/dark/add_cell(var/obj/item/cell/C=null) // CHOMPEdit - Removal of obj/item/weapon
	if(C)
		C.forceMove(src)
		cell = C
		return
	cell = new /obj/item/cell/hyper(src) // CHOMPEdit - Removal of obj/item/weapon
