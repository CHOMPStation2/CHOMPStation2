...
/obj/mecha/combat/fighter
	...
	var/landing_gear_raised = FALSE //If our anti-space-drift is on. // CHOMPedit: Landing gear.
...
//Modified phazon code.  // CHOMPedit start: lots of modified code for landing gear.
...
/obj/mecha/combat/fighter/check_for_support()
	if (has_charge(step_energy_drain) && landing_gear_raised) // CHOMPedit end for landing gear.
		return 1
