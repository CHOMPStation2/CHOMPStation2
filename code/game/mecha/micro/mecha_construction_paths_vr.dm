...
/datum/construction/reversible/mecha/polecat
	...
	steps = list(
		...
		//12
		list("key"=/obj/item/circuitboard/mecha/polecat/targeting, // CHOMPEdit - Removal of obj/item/weapon
			"backkey"=IS_SCREWDRIVER,
		...
		//14
		list("key"=/obj/item/circuitboard/mecha/polecat/peripherals, // CHOMPEdit - Removal of obj/item/weapon
			"backkey"=IS_SCREWDRIVER,
		...
		//16
		list("key"=/obj/item/circuitboard/mecha/polecat/main, // CHOMPEdit - Removal of obj/item/weapon
			"backkey"=IS_SCREWDRIVER,
	...
	switch(index)
		...
		if(15)
			if(diff==FORWARD)
				...
				new /obj/item/circuitboard/mecha/polecat/main(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "polecat4"
		if(14)
			if(diff==FORWARD)
		...
		if(13)
			if(diff==FORWARD)
				...
				new /obj/item/circuitboard/mecha/polecat/peripherals(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "polecat6"
		if(12)
			if(diff==FORWARD)
		...
		if(11)
			if(diff==FORWARD)
				...
				new /obj/item/circuitboard/mecha/polecat/targeting(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "polecat8"
		if(10)
			if(diff==FORWARD)
...
/datum/construction/reversible/mecha/gopher
	...
	steps = list(
		...
		list("key"=IS_SCREWDRIVER,
			...
			"desc"="Peripherals control module is installed"),
		//8
		list("key"=/obj/item/circuitboard/mecha/gopher/peripherals, // CHOMPEdit - Removal of obj/item/weapon
			"backkey"=IS_SCREWDRIVER,
			"desc"="Central control module is secured"),
		//9
		list("key"=IS_SCREWDRIVER,
			...
			"desc"="Central control module is installed"),
		//10
		list("key"=/obj/item/circuitboard/mecha/gopher/main, // CHOMPEdit - Removal of obj/item/weapon
			"backkey"=IS_SCREWDRIVER,
			"desc"="The wiring is adjusted"),
		//11
		list("key"=IS_WIRECUTTER,
	...
	switch(index)
		...
		if(9)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the central control module from [holder].", "You remove the central computer mainboard from [holder].")
				new /obj/item/circuitboard/mecha/gopher/main(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "gopher4"
		if(8)
			if(diff==FORWARD)
				user.visible_message("[user] installs the peripherals control module into [holder].", "You install the peripherals control module into [holder].")
		...
		if(7)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the peripherals control module from [holder].", "You remove the peripherals control module from [holder].")
				new /obj/item/circuitboard/mecha/gopher/peripherals(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "gopher6"
		if(6)
			if(diff==FORWARD)
				user.visible_message("[user] installs internal armor layer to [holder].", "You install internal armor layer to [holder].")
...
/datum/construction/reversible/mecha/weasel
	...
	steps = list(
		...
		list("key"=IS_SCREWDRIVER,
			...
			"desc"="Targeting module is installed"),
		//12
		list("key"=/obj/item/circuitboard/mecha/weasel/targeting, // CHOMPEdit - Removal of obj/item/weapon
			"backkey"=IS_SCREWDRIVER,
			"desc"="Peripherals control module is secured"),
		//13
		list("key"=IS_SCREWDRIVER,
			...
			"desc"="Peripherals control module is installed"),
		//14
		list("key"=/obj/item/circuitboard/mecha/weasel/peripherals, // CHOMPEdit - Removal of obj/item/weapon
			"backkey"=IS_SCREWDRIVER,
			"desc"="Central control module is secured"),
		//15
		list("key"=IS_SCREWDRIVER,
			...
			"desc"="Central control module is installed"),
		//16
		list("key"=/obj/item/circuitboard/mecha/weasel/main, // CHOMPEdit - Removal of obj/item/weapon
			"backkey"=IS_SCREWDRIVER,
			"desc"="The wiring is adjusted"),
		//17
		list("key"=IS_WIRECUTTER,
	...
	switch(index)
		...
		if(15)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the central control module from [holder].", "You remove the central computer mainboard from [holder].")
				new /obj/item/circuitboard/mecha/weasel/main(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "weasel4"
		if(14)
			if(diff==FORWARD)
				user.visible_message("[user] installs the peripherals control module into [holder].", "You install the peripherals control module into [holder].")
		...
		if(13)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the peripherals control module from [holder].", "You remove the peripherals control module from [holder].")
				new /obj/item/circuitboard/mecha/weasel/peripherals(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "weasel6"
		if(12)
			if(diff==FORWARD)
				user.visible_message("[user] installs the weapon control module into [holder].", "You install the weapon control module into [holder].")
		...
		if(11)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the weapon control module from [holder].", "You remove the weapon control module from [holder].")
				new /obj/item/circuitboard/mecha/weasel/targeting(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "weasel8"
		if(10)
			if(diff==FORWARD)
				user.visible_message("[user] installs advanced scanner module to [holder].", "You install advanced scanner module to [holder].")
