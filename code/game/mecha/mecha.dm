...
/obj/mecha
	...
	var/obj/item/radio/radio = null // CHOMPEdit - Removal of obj/item/device
...
/obj/mecha/proc/add_cell(var/obj/item/cell/C=null) // CHOMPEdit - Removal of obj/item/weapon
	if(C)
		C.forceMove(src)
		cell = C
		return
	cell = new /obj/item/cell/mech(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/mecha/proc/dynattackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/mecha/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon

	if(istype(W, /obj/item/mmi)) // CHOMPEdit - Removal of obj/item/device
	...
	if(istype(W, /obj/item/robotanalyzer)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/robotanalyzer/RA = W // CHOMPEdit - Removal of obj/item/device
		RA.do_scan(src, user)
		return
	...
	if(istype(W, /obj/item/card/robot)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/card/robot/RoC = W // CHOMPEdit - Removal of obj/item/weapon
	...
	if(istype(W, /obj/item/card/id)||istype(W, /obj/item/pda)) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
		if(add_req_access || maint_access)
			if(internals_access_allowed(usr))
				var/obj/item/card/id/id_card // CHOMPEdit - Removal of obj/item/weapon
				if(istype(W, /obj/item/card/id)) // CHOMPEdit - Removal of obj/item/weapon
					id_card = W
				else
					var/obj/item/pda/pda = W // CHOMPEdit - Removal of obj/item/device
					id_card = pda.id
...
/obj/mecha/proc/mmi_move_inside(var/obj/item/mmi/mmi_as_oc as obj,mob/user as mob) // CHOMPEdit - Removal of obj/item/device
...
/obj/mecha/proc/mmi_moved_inside(var/obj/item/mmi/mmi_as_oc as obj,mob/user as mob) // CHOMPEdit - Removal of obj/item/device
...
/obj/mecha/proc/go_out() //Eject/Exit the mech. Yes this is for easier searching.
	...
	if(mob_container.forceMove(src.loc))//ejecting mob container
		...
		if(occupant.client && cloaked_selfimage)
			occupant.client.images -= cloaked_selfimage
		if(istype(mob_container, /obj/item/mmi)) // CHOMPEdit - Removal of obj/item/device
			var/obj/item/mmi/mmi = mob_container // CHOMPEdit - Removal of obj/item/device
			if(mmi.brainmob)
				occupant.loc = mmi
			mmi.mecha = null
			occupant.canmove = 0
...
/obj/mecha/check_access(obj/item/card/id/I, list/access_list) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(access_list))
		return 1
	if(!access_list.len) //no requirements
		return 1
	if(istype(I, /obj/item/pda)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/pda/pda = I // CHOMPEdit - Removal of obj/item/device
		I = pda.id
...
/obj/mecha/proc/output_access_dialog(obj/item/card/id/id_card, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/mecha/proc/output_maintenance_dialog(obj/item/card/id/id_card,mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!id_card || !user) return
