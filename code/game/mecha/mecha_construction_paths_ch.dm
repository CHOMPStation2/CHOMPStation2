...
/datum/construction/reversible/mecha/scarab
	...
	steps = list(
					...
					list("key"=IS_WELDER,
					 ...
					 //12
					 list("key"=/obj/item/circuitboard/mecha/scarab/targeting, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
					 ...
					 //14
					 list("key"=/obj/item/circuitboard/mecha/scarab/peripherals, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
					 ...
					 //16
					 list("key"=/obj/item/circuitboard/mecha/scarab/main, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
	...
	switch(index)
		...
		if(15)
			if(diff==FORWARD)
				...
				new /obj/item/circuitboard/mecha/scarab/main(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "scarab_wire2"
		if(14)
			if(diff==FORWARD)
		...
		if(13)
			if(diff==FORWARD)
				...
				new /obj/item/circuitboard/mecha/scarab/peripherals(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "scarab_chip1"
		if(12)
			if(diff==FORWARD)
		...
		if(11)
			if(diff==FORWARD)
				...
				new /obj/item/circuitboard/mecha/scarab/targeting(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "scarab_chip2"
		if(10)
			if(diff==FORWARD)
