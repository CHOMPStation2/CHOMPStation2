...
/datum/construction/reversible/mecha/ripley
	...
	steps = list(
					...
					//2
					 ...
					 //8
					 list("key"=/obj/item/circuitboard/mecha/ripley/peripherals, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
					 ...
					 //10
					 list("key"=/obj/item/circuitboard/mecha/ripley/main, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
	...
	switch(index)
		...
		if(9)
			if(diff==FORWARD)
				...
				new /obj/item/circuitboard/mecha/ripley/main(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "ripley4"
		if(8)
			if(diff==FORWARD)
		...
		if(7)
			if(diff==FORWARD)
				...
				new /obj/item/circuitboard/mecha/ripley/peripherals(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "ripley6"
		if(6)
			if(diff==FORWARD)
...
/datum/construction/reversible/mecha/gygax
	...
	steps = list(
					...
					list("key"=IS_WELDER,
					 ...
					 //8
					 list("key"=/obj/item/stock_parts/capacitor/adv, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
					 ...
					 //10
					 list("key"=/obj/item/stock_parts/scanning_module/adv, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
					 ...
					 //12
					 list("key"=/obj/item/circuitboard/mecha/gygax/targeting, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
					 		"desc"="Peripherals control module is secured"),
					 //13
					 list("key"=IS_SCREWDRIVER,
					 		...
					 		"desc"="Peripherals control module is installed"),
					 //14
					 list("key"=/obj/item/circuitboard/mecha/gygax/peripherals, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
					 		"desc"="Central control module is secured"),
					 //15
					 list("key"=IS_SCREWDRIVER,
					 		...
					 		"desc"="Central control module is installed"),
					 //16
					 list("key"=/obj/item/circuitboard/mecha/gygax/main, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
					 		"desc"="The wiring is adjusted"),
					 //17
					 list("key"=IS_WIRECUTTER,
	...
	switch(index)
		...
		if(15)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the central control module from [holder].", "You remove the central computer mainboard from [holder].")
				new /obj/item/circuitboard/mecha/gygax/main(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "gygax4"
		if(14)
			if(diff==FORWARD)
				user.visible_message("[user] installs the peripherals control module into [holder].", "You install the peripherals control module into [holder].")
		...
		if(13)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the peripherals control module from [holder].", "You remove the peripherals control module from [holder].")
				new /obj/item/circuitboard/mecha/gygax/peripherals(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "gygax6"
		if(12)
			if(diff==FORWARD)
		...
		if(11)
			if(diff==FORWARD)
				...
				new /obj/item/circuitboard/mecha/gygax/targeting(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "gygax8"
		if(10)
			if(diff==FORWARD)
		...
		if(9)
			if(diff==FORWARD)
				...
				new /obj/item/stock_parts/scanning_module/adv(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "gygax10"
		if(8)
			if(diff==FORWARD)
		...
		if(7)
			if(diff==FORWARD)
				...
				new /obj/item/stock_parts/capacitor/adv(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "gygax12"
		if(6)
			if(diff==FORWARD)
				user.visible_message("[user] installs internal armor layer to [holder].", "You install internal armor layer to [holder].")
...
/datum/construction/reversible/mecha/serenity
	...
	steps = list(
					...
					list("key"=IS_WELDER,
					 ...
					 //12
					 list("key"=/obj/item/circuitboard/mecha/gygax/medical, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
					 		"desc"="Peripherals control module is secured"),
					 //13
					 list("key"=IS_SCREWDRIVER,
	...
	switch(index)
		...
		if(11)
			if(diff==FORWARD)
				...
				new /obj/item/circuitboard/mecha/gygax/medical(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "gygax8"
		if(10)
			if(diff==FORWARD)
				user.visible_message("[user] installs advanced scanner module to [holder].", "You install advanced scanner module to [holder].")
	...
	steps = list(
					...
					list("key"=IS_WELDER,
					 ...
					 list("key"=IS_SCREWDRIVER,
					 		...
					 		"desc"="Targeting module is installed"),
					 //12
					 list("key"=/obj/item/circuitboard/mecha/durand/targeting, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
					 		"desc"="Peripherals control module is secured"),
					 //13
					 list("key"=IS_SCREWDRIVER,
					 		...
					 		"desc"="Peripherals control module is installed"),
					 //14
					 list("key"=/obj/item/circuitboard/mecha/durand/peripherals, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
					 		"desc"="Central control module is secured"),
					 //15
					 list("key"=IS_SCREWDRIVER,
					 		...
					 		"desc"="Central control module is installed"),
					 //16
					 list("key"=/obj/item/circuitboard/mecha/durand/main, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
					 		"desc"="The wiring is adjusted"),
					 //17
					 list("key"=IS_WIRECUTTER,
	...
	switch(index)
		...
		if(15)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the central control module from [holder].", "You remove the central computer mainboard from [holder].")
				new /obj/item/circuitboard/mecha/durand/main(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "durand4"
		if(14)
			if(diff==FORWARD)
				user.visible_message("[user] installs the peripherals control module into [holder].", "You install the peripherals control module into [holder].")
		...
		if(13)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the peripherals control module from [holder].", "You remove the peripherals control module from [holder].")
				new /obj/item/circuitboard/mecha/durand/peripherals(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "durand6"
		if(12)
			if(diff==FORWARD)
				user.visible_message("[user] installs the weapon control module into [holder].", "You install the weapon control module into [holder].")
		...
		if(11)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the weapon control module from [holder].", "You remove the weapon control module from [holder].")
				new /obj/item/circuitboard/mecha/durand/targeting(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "durand8"
		if(10)
			if(diff==FORWARD)
				user.visible_message("[user] installs advanced scanner module to [holder].", "You install advanced scanner module to [holder].")
	...
	steps = list(
					...
					//2
					 ...
					 list("key"=IS_SCREWDRIVER,
					 		...
					 		"desc"="Peripherals control module is installed"),
					 //8
					 list("key"=/obj/item/circuitboard/mecha/odysseus/peripherals, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
					 		"desc"="Central control module is secured"),
					 //9
					 list("key"=IS_SCREWDRIVER,
					 		...
					 		"desc"="Central control module is installed"),
					 //10
					 list("key"=/obj/item/circuitboard/mecha/odysseus/main, // CHOMPEdit - Removal of obj/item/weapon
					 		"backkey"=IS_SCREWDRIVER,
					 		"desc"="The wiring is adjusted"),
					 //11
					 list("key"=IS_WIRECUTTER,
	...
	switch(index)
		...
		if(9)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the central control module from [holder].", "You remove the central computer mainboard from [holder].")
				new /obj/item/circuitboard/mecha/odysseus/main(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "odysseus4"
		if(8)
			if(diff==FORWARD)
				user.visible_message("[user] installs the peripherals control module into [holder].", "You install the peripherals control module into [holder].")
		...
		if(7)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the peripherals control module from [holder].", "You remove the peripherals control module from [holder].")
				new /obj/item/circuitboard/mecha/odysseus/peripherals(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "odysseus6"
		if(6)
			if(diff==FORWARD)
				user.visible_message("[user] installs internal armor layer to [holder].", "You install internal armor layer to [holder].")
...
/datum/construction/reversible/mecha/phazon
	...
	steps = list(
					...
					//8
					list("key"=/obj/item/perfect_tele,  //Chompedit, change hand tele to translocator // CHOMPEdit - Removal of obj/item/device
							"backkey"=IS_SCREWDRIVER,
					...
					//10
					list("key"=/obj/item/smes_coil/super_capacity, // CHOMPEdit - Removal of obj/item/weapon
							"backkey"=IS_SCREWDRIVER,
							"desc"="Targeting module is secured"),
					//11
					list("key"=IS_SCREWDRIVER,
							...
							"desc"="Targeting module is installed"),
					//12
					list("key"=/obj/item/circuitboard/mecha/phazon/targeting, // CHOMPEdit - Removal of obj/item/weapon
							"backkey"=IS_SCREWDRIVER,
							"desc"="Peripherals control module is secured"),
					//13
					list("key"=IS_SCREWDRIVER,
							...
							"desc"="Peripherals control module is installed"),
					//14
					list("key"=/obj/item/circuitboard/mecha/phazon/peripherals, // CHOMPEdit - Removal of obj/item/weapon
							"backkey"=IS_SCREWDRIVER,
							"desc"="Central control module is secured"),
					//15
					list("key"=IS_SCREWDRIVER,
							...
							"desc"="Central control module is installed"),
					//16
					list("key"=/obj/item/circuitboard/mecha/phazon/main, // CHOMPEdit - Removal of obj/item/weapon
							"backkey"=IS_SCREWDRIVER,
							"desc"="The wiring is adjusted"),
					//17
					list("key"=IS_WIRECUTTER,
	...
	switch(index)
		...
		if(15)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the central control module from [holder].", "You remove the central computer mainboard from [holder].")
				new /obj/item/circuitboard/mecha/phazon/main(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "phazon4"
		if(14)
			if(diff==FORWARD)
				user.visible_message("[user] installs the peripherals control module into [holder].", "You install the peripherals control module into [holder].")
		...
		if(13)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the peripherals control module from [holder].", "You remove the peripherals control module from [holder].")
				new /obj/item/circuitboard/mecha/phazon/peripherals(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "phazon6"
		if(12)
			if(diff==FORWARD)
				user.visible_message("[user] installs the weapon control module into [holder].", "You install the weapon control module into [holder].")
		...
		if(11)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the weapon control module from [holder].", "You remove the weapon control module from [holder].")
				new /obj/item/circuitboard/mecha/phazon/targeting(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "phazon8"
		if(10)
			if(diff==FORWARD)
		...
		if(9)
			if(diff==FORWARD)
				...
				new /obj/item/smes_coil/super_capacity(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "phazon10"
		if(8)
			if(diff==FORWARD)
		...
		if(7)
			if(diff==FORWARD)
				...
				new /obj/item/hand_tele(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "phazon12"
		if(6)
			if(diff==FORWARD)
...
/datum/construction/reversible/mecha/janus
	...
	steps = list(
					...
					list("key"=IS_SCREWDRIVER,
							...
							"desc"="Targeting module is installed"),
					//14
					list("key"=/obj/item/circuitboard/mecha/imperion/targeting, // CHOMPEdit - Removal of obj/item/weapon
							"backkey"=IS_SCREWDRIVER,
							"desc"="Peripherals control module is secured"),
					//15
					list("key"=IS_SCREWDRIVER,
							...
							"desc"="Peripherals control module is installed"),
					//16
					list("key"=/obj/item/circuitboard/mecha/imperion/peripherals, // CHOMPEdit - Removal of obj/item/weapon
							"backkey"=IS_SCREWDRIVER,
							"desc"="Central control module is secured"),
					//17
					list("key"=IS_SCREWDRIVER,
							...
							"desc"="Central control module is installed"),
					//18
					list("key"=/obj/item/circuitboard/mecha/imperion/main, // CHOMPEdit - Removal of obj/item/weapon
							"backkey"=IS_SCREWDRIVER,
							"desc"="The wiring is adjusted"),
					//19
					list("key"=IS_WIRECUTTER,
	...
	switch(index)
		...
		if(17)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the central control module from [holder].", "You remove the central computer mainboard from [holder].")
				new /obj/item/circuitboard/mecha/imperion/main(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "janus4"
		if(16)
			if(diff==FORWARD)
				user.visible_message("[user] installs the peripherals control module into [holder].", "You install the peripherals control module into [holder].")
		...
		if(15)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the peripherals control module from [holder].", "You remove the peripherals control module from [holder].")
				new /obj/item/circuitboard/mecha/imperion/peripherals(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "janus6"
		if(14)
			if(diff==FORWARD)
				user.visible_message("[user] installs the weapon control module into [holder].", "You install the weapon control module into [holder].")
		...
		if(13)
			if(diff==FORWARD)
				...
				user.visible_message("[user] removes the weapon control module from [holder].", "You remove the weapon control module from [holder].")
				new /obj/item/circuitboard/mecha/imperion/targeting(get_turf(holder)) // CHOMPEdit - Removal of obj/item/weapon
				holder.icon_state = "janus8"
		if(12)
			if(diff==FORWARD)
