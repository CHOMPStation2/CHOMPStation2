...
/obj/item/mecha_parts/mecha_equipment/tool/syringe_gun/action(atom/movable/target)
	if(!action_checks(target))
		return
	if(istype(target,/obj/item/reagent_containers/syringe)) // CHOMPEdit - Removal of obj/item/weapon
		return load_syringe(target)
	if(istype(target,/obj/item/storage))//Loads syringes from boxes // CHOMPEdit - Removal of obj/item/weapon
		for(var/obj/item/reagent_containers/syringe/S in target.contents) // CHOMPEdit - Removal of obj/item/weapon
			load_syringe(S)
		return
	if(mode)
	...
	var/obj/item/reagent_containers/syringe/S = syringes[1] // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/mecha_parts/mecha_equipment/tool/syringe_gun/proc/load_syringe(obj/item/reagent_containers/syringe/S) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/mecha_parts/mecha_equipment/tool/powertool/medanalyzer
	...
	tooltype = /obj/item/healthanalyzer/advanced // CHOMPEdit - Removal of obj/item/device
