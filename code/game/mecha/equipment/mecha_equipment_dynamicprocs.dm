...
/obj/item/mecha_parts/mecha_equipment/proc/handle_melee_contact(var/obj/item/W, var/mob/living/user, var/inc_damage = 0) // CHOMPEdit - Removal of obj/item/weapon
	return max(0, inc_damage)
