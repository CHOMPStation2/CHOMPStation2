/obj/mecha/working/ripley
	...
	cargo_capacity = 10
	var/obj/item/mining_scanner/orescanner // vorestation addition // CHOMPEdit - Removal of obj/item/weapon
...
/obj/mecha/working/ripley/proc/collect_ore()
	if(locate(/obj/item/mecha_parts/mecha_equipment/tool/hydraulic_clamp) in equipment)
		...
		if(ore_box)
			for(var/obj/item/ore/ore in range(1, src)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/mecha/working/ripley/New()
	..()
	orescanner = new /obj/item/mining_scanner // CHOMPEdit - Removal of obj/item/weapon
