/obj/machinery/mecha_part_fabricator/pros
	...
	circuit = /obj/item/circuitboard/prosthetics // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/mecha_part_fabricator/pros/attackby(var/obj/item/I, var/mob/user)
	...
	if(istype(I,/obj/item/disk/limb)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/disk/limb/D = I // CHOMPEdit - Removal of obj/item/weapon
	...
	if(istype(I,/obj/item/disk/species)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/disk/species/D = I // CHOMPEdit - Removal of obj/item/weapon
