...
/*/datum/job/centcom_visitor //For Pleasure // You mean for admin abuse... -Ace
	...
	supervisors = "company officials and Corporate Regulations"
	selection_color = "#1D1D4F"
	idtype = /obj/item/card/id/centcom // CHOMPEdit - Removal of obj/item/weapon
	access = list()
	minimal_access = list()
	minimal_player_age = 14
	economic_modifier = 20
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_to_slot_or_del(new /obj/item/radio/headset/centcom(H), slot_l_ear) // CHOMPEdit - Removal of obj/item/device
		switch(H.backbag)
			if(2) H.equip_to_slot_or_del(new /obj/item/storage/backpack(H), slot_back) // CHOMPEdit - Removal of obj/item/weapon
			if(3) H.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel(H), slot_back) // CHOMPEdit - Removal of obj/item/weapon
			if(4) H.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel(H), slot_back) // CHOMPEdit - Removal of obj/item/weapon
		H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/centcom, slot_w_uniform)
		H.equip_to_slot_or_del(new /obj/item/pda/centcom(H), slot_belt) // CHOMPEdit - Removal of obj/item/device
