...
/obj/structure/kitchenspike/attackby(obj/item/grab/G as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(G, /obj/item/grab) || !ismob(G.affecting)) // CHOMPEdit - Removal of obj/item/weapon
		return
	if(occupied)
...
/obj/structure/kitchenspike/proc/spike(var/mob/living/victim)
	...
	if(istype(victim, /mob/living/carbon/human))
		...
		meat_type = /obj/item/reagent_containers/food/snacks/xenomeat // CHOMPEdit - Removal of obj/item/weapon
