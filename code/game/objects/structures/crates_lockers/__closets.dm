...
/obj/structure/closet
	...
	var/seal_tool = /obj/item/weldingtool	//Tool used to seal the closet, defaults to welder // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/closet/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(W.has_tool_quality(TOOL_WRENCH))
		...
		if(W.has_tool_quality(TOOL_WELDER))
			...
			qdel(src)
			return
		if(istype(W, /obj/item/storage/laundry_basket) && W.contents.len) // CHOMPEdit - Removal of obj/item/weapon
			var/obj/item/storage/laundry_basket/LB = W // CHOMPEdit - Removal of obj/item/weapon
		...
		if(istype(W, seal_tool))
			var/obj/item/S = W // CHOMPEdit - Removal of obj/item/weapon
			if(S.has_tool_quality(TOOL_WELDER))
				var/obj/item/weldingtool/WT = S.get_welder() // CHOMPEdit - Removal of obj/item/weapon
				if(!WT.remove_fuel(0,user))
					if(!WT.isOn())
						return
					else
