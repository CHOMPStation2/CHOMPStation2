...
/obj/structure/closet/syndicate/nuclear
	...
	/obj/item/gun/energy/gun = 5, // CHOMPEdit - Removal of obj/item/weapon
	/obj/item/pinpointer/nukeop = 5, // CHOMPEdit - Removal of obj/item/weapon
	/obj/item/pda/syndicate, // CHOMPEdit - Removal of obj/item/device
	/obj/item/radio/uplink) // CHOMPEdit - Removal of obj/item/device
...
/obj/structure/closet/syndicate/resources/Initialize()
	...
	if(!contents.len)
		...
		if(pickednum == 50)
			new /obj/item/tank/jetpack/carbondioxide(src) // CHOMPEdit - Removal of obj/item/weapon
