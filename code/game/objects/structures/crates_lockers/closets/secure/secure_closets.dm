...
/obj/structure/closet/secure_closet/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(W.has_tool_quality(TOOL_WRENCH))
		...
		if(istype(W, /obj/item/storage/laundry_basket)) // CHOMPEdit - Removal of obj/item/weapon
			return ..(W,user)
	...
	else if(istype(W,/obj/item/packageWrap) || W.has_tool_quality(TOOL_WELDER)) // CHOMPEdit - Removal of obj/item/weapon
		return ..(W,user)
	else
		togglelock(user)
