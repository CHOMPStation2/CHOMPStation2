...
/obj/structure/closet/l3closet/virology
	...
	starts_with = list(
		...
		/obj/item/tank/oxygen = 2) // CHOMP Block Edit End // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/closet/l3closet/scientist
	...
	starts_with = list(
		...
		/obj/item/clothing/mask/gas/clear = 2, //CHOMPEdit: Clear gas mask implementation
		/obj/item/tank/oxygen = 2, // CHOMP Block Edit End // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/storage/bag/xeno = 1) // CHOMPEdit - Removal of obj/item/weapon

/obj/structure/closet/l3closet/scientist/double
	starts_with = list(
		/obj/item/clothing/suit/bio_suit/scientist = 2, // CHOMP Block Edit Start
		/obj/item/clothing/head/bio_hood/scientist = 2,
		/obj/item/storage/bag/xeno = 2, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/clothing/mask/gas/clear = 2, //CHOMPEdit: Clear gas mask implementation
		/obj/item/tank/oxygen = 2, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/storage/bag/xeno = 2) // CHOMP Block Edit End // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/closet/l3closet/medical
	...
	starts_with = list(
		...
		/obj/item/tank/oxygen = 3) // CHOMP Block Edit End // CHOMPEdit - Removal of obj/item/weapon
