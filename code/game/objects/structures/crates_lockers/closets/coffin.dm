/obj/structure/closet/coffin
	...
	seal_tool = /obj/item/tool/screwdriver // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/closet/grave/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(src.opened)
