...
/obj/structure/displaycase/ex_act(severity)
	switch(severity)
		if (1)
			...
			if (occupied)
				new /obj/item/gun/energy/captain( src.loc ) // CHOMPEdit - Removal of obj/item/weapon
				occupied = 0
			qdel(src)
		if (2)
			if (prob(50))
...
/obj/structure/displaycase/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
