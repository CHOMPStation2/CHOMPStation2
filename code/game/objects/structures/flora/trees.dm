...
/obj/structure/flora/tree/attackby(var/obj/item/W, var/mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(can_harvest(W))
		..(W, user)
		return
...
/obj/structure/flora/tree/pine/xmas/presents
	...
	indestructable = TRUE
	var/gift_type = /obj/item/a_gift // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/flora/tree/sif
	...
	min_harvests = 0
	harvest_loot = list(
		/obj/item/reagent_containers/food/snacks/siffruit = 20, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/reagent_containers/food/snacks/grown/sif/sifpod = 5, // CHOMPEdit - Removal of obj/item/weapon
