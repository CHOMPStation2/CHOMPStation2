...
/obj/structure/trash_pile/sharkpile
	...
	var/list/alphapicks = list(
		/obj/item/storage/pill_bottle/happy = 1, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/storage/pill_bottle/zoom = 2, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/storage/pill_bottle/paracetamol = 3, // CHOMPEdit - Removal of obj/item/weapon
	...
	var/list/betapicks = list(
		/obj/item/storage/pill_bottle/happy = 3, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/storage/pill_bottle/zoom = 2, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/storage/pill_bottle/paracetamol = 1, // CHOMPEdit - Removal of obj/item/weapon
