...
/obj/structure/bed/chair/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/structure/bed/chair/office/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/bed/chair/wood/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W,/obj/item/stack) || W.has_tool_quality(TOOL_WIRECUTTER))
		return
	..()
