...
/obj/structure/bed/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	...
	else if(istype(W, /obj/item/disk) || (istype(W, /obj/item/toy/plushie))) // CHOMPEdit - Removal of obj/item/weapon
		user.drop_from_inventory(W, get_turf(src))
		W.pixel_x = 10 //make sure they reach the pillow
		W.pixel_y = -6
		if(istype(W, /obj/item/disk)) // CHOMPEdit - Removal of obj/item/weapon
			user.visible_message("<span class='notice'>[src] sleeps soundly. Sleep tight, disky.</span>")

	else if(istype(W, /obj/item/grab)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/bed/roller/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/roller/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/bed/alien/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return // No deconning.
...
/obj/structure/dirtybed/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(W.has_tool_quality(TOOL_WRENCH))
		playsound(src, W.usesound, 100, 1)
		if(anchored)
