...
/obj/structure/grille/attackby(obj/item/W as obj, mob/user as mob)
	if(!istype(W))
		return
	if(istype(W, /obj/item/rcd)) // To stop us from hitting the grille when building windows, because grilles don't let parent handle it properly. // CHOMPEdit - Removal of obj/item/weapon
		return FALSE
