...
/obj/machinery/door/blast/puzzle/attackby(obj/item/C as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(C, /obj/item)) // CHOMPEdit - Removal of obj/item/weapon
		...
		else if(istype(C, /obj/item/plastique)) // CHOMPEdit - Removal of obj/item/weapon
