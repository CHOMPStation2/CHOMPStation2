/obj/structure/medical_stand
	...
	//gas stuff
	var/obj/item/tank/tank // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/reagent_containers/beaker // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/medical_stand/update_icon()
	...
	if (tank)
		if (breather)
			...
			add_overlay("tube")
		if(istype(tank,/obj/item/tank/anesthetic)) // CHOMPEdit - Removal of obj/item/weapon
			add_overlay("tank_anest")
		else if(istype(tank,/obj/item/tank/nitrogen)) // CHOMPEdit - Removal of obj/item/weapon
			add_overlay("tank_nitro")
		else if(istype(tank,/obj/item/tank/oxygen)) // CHOMPEdit - Removal of obj/item/weapon
			add_overlay("tank_oxyg")
		else if(istype(tank,/obj/item/tank/phoron)) // CHOMPEdit - Removal of obj/item/weapon
			add_overlay("tank_plasma")
		//else if(istype(tank,/obj/item/tank/hydrogen)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/medical_stand/attackby(var/obj/item/W, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype (W, /obj/item/tool)) // CHOMPEdit - Removal of obj/item/weapon
		if (valve_opened)
	...
	else if(istype(W, /obj/item/tank)) // CHOMPEdit - Removal of obj/item/weapon
		if(tank)
	...
	else if (istype(W, /obj/item/reagent_containers)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/medical_stand/anesthetic
	spawn_type = /obj/item/tank/anesthetic // CHOMPEdit - Removal of obj/item/weapon
