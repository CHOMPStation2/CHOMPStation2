/obj/structure/extinguisher_cabinet
	...
	anchored = TRUE
	density = FALSE
	var/obj/item/extinguisher/has_extinguisher // CHOMPEdit - Removal of obj/item/weapon
	var/opened = 0
...
/obj/structure/extinguisher_cabinet/Initialize(var/mapload, var/dir, var/building = 0)
	...
	if(building)
		...
		has_extinguisher = new/obj/item/extinguisher(src) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/extinguisher_cabinet/attackby(obj/item/O, mob/user)
	if(isrobot(user))
		return
	if(istype(O, /obj/item/extinguisher)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/extinguisher_cabinet/update_icon()
	var/suffix = "empty"
	if(has_extinguisher)
		if(istype(has_extinguisher, /obj/item/extinguisher/mini)) // CHOMPEdit - Removal of obj/item/weapon
			suffix = "mini"
		if(istype(has_extinguisher, /obj/item/extinguisher/atmo)) // CHOMPEdit - Removal of obj/item/weapon
			suffix = "advanced"
		else
			suffix = "standard"
