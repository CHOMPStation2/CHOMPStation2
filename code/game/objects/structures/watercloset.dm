...
/obj/machinery/shower/attackby(obj/item/I as obj, mob/user as mob)
	if(I.type == /obj/item/analyzer) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/bikehorn/rubberducky // CHOMPEdit - Removal of obj/item/weapon
	name = "rubber ducky"
...
/obj/item/bikehorn/rubberducky/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(spam_flag == 0)
		spam_flag = 1
...
/obj/item/bikehorn/rubberducky/red // CHOMPEdit - Removal of obj/item/weapon
	name = "rubber ducky"
...
/obj/item/bikehorn/rubberducky/red/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(honk_count >= 3)
...
/obj/item/bikehorn/rubberducky/blue // CHOMPEdit - Removal of obj/item/weapon
	name = "rubber ducky"
...
/obj/item/bikehorn/rubberducky/blue/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(spam_flag == 0)
...
/obj/item/bikehorn/rubberducky/pink // CHOMPEdit - Removal of obj/item/weapon
	name = "rubber ducky"
...
/obj/item/bikehorn/rubberducky/pink/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(spam_flag == 0)
		if(!user.devourable)
...
/obj/item/bikehorn/rubberducky/pink/container_resist(var/mob/living/escapee) // CHOMPEdit - Removal of obj/item/weapon
	escapee.forceMove(get_turf(src))
	to_chat(escapee, "<span class='vnotice'>You managed to crawl out of the rubber ducky!</span>")

/obj/item/bikehorn/rubberducky/grey // CHOMPEdit - Removal of obj/item/weapon
	name = "rubber ducky"
...
/obj/item/bikehorn/rubberducky/grey/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(spam_flag == 0)
...
/obj/item/bikehorn/rubberducky/green // CHOMPEdit - Removal of obj/item/weapon
	name = "rubber ducky"
...
/obj/item/bikehorn/rubberducky/green/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(spam_flag == 0)
		var/turf/simulated/whereweare = get_turf(src)
...
/obj/item/bikehorn/rubberducky/white // CHOMPEdit - Removal of obj/item/weapon
	name = "rubber ducky"
...
/obj/item/bikehorn/rubberducky/white/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(spam_flag == 0)
...
/obj/item/grenade/anti_photon/rubberducky/black // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/grenade/anti_photon/rubberducky/black/detonate() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/sink/attackby(obj/item/O as obj, mob/user as mob)
	...
	var/obj/item/reagent_containers/RG = O // CHOMPEdit - Removal of obj/item/weapon
	...
	else if (istype(O, /obj/item/melee/baton)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/melee/baton/B = O // CHOMPEdit - Removal of obj/item/weapon
		if(B.bcell)
			if(B.bcell.charge > 0 && B.status == 1)
				...
				return 1
	else if(istype(O, /obj/item/mop)) // CHOMPEdit - Removal of obj/item/weapon
	...
	//CHOMPAdd Start
	if(istype(I, /obj/item/robot_tongue) && isrobot(user)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/robot_tongue/J = I // CHOMPEdit - Removal of obj/item/device
