...
/obj/item/canvas/proc/get_paint_tool_color(obj/item/I)
	...
	else if(istype(I, /obj/item/pen/crayon)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/pen/crayon/crayon = I // CHOMPEdit - Removal of obj/item/weapon
		return crayon.colour
	else if(istype(I, /obj/item/pen)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/pen/P = I // CHOMPEdit - Removal of obj/item/weapon
		switch(P.colour)
			if("black")
				return "#000000"
			if("blue")
			...
			if("red")
				return "#ff0000"
		return P.colour
	else if(istype(I, /obj/item/soap) || istype(I, /obj/item/reagent_containers/glass/rag)) // CHOMPEdit - Removal of obj/item/weapon
		return canvas_color
...
/obj/item/paint_palette/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/sign/painting/attackby(obj/item/I, mob/user, params)
	if(!current_canvas && istype(I, /obj/item/canvas))
		frame_canvas(user, I)
	else if(current_canvas && current_canvas.painting_name == initial(current_canvas.painting_name) && istype(I,/obj/item/pen)) // CHOMPEdit - Removal of obj/item/weapon
		try_rename(user)
