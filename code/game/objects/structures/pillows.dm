...
/obj/item/bedsheet/pillow // CHOMPEdit - Removal of obj/item/weapon
	name = "pillow"
...
/obj/item/bedsheet/pillow/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	user.drop_item()
	if(icon_state == initial(icon_state))
		icon_state = "[icon_state]_placed"
	add_fingerprint(user)

/obj/item/bedsheet/pillow/pickup(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..()
	icon_state = initial(icon_state)

/obj/item/bedsheet/pillow/attackby(var/obj/item/component, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/bed/pillowpile
	...
	var/sourcepillow = "/obj/item/bedsheet/pillow" // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/bedsheet/pillow/teal // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/bed/pillowpile/teal
	...
	sourcepillow = "/obj/item/bedsheet/pillow/teal" // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/bedsheet/pillow/yellow // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/bed/pillowpile/yellow
	...
	sourcepillow = "/obj/item/bedsheet/pillow/yellow" // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/bedsheet/pillow/white // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/bed/pillowpile/white
	...
	sourcepillow = "/obj/item/bedsheet/pillow/white" // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/bedsheet/pillow/black // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/bed/pillowpile/black
	...
	sourcepillow = "/obj/item/bedsheet/pillow/black" // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/bedsheet/pillow/green // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/bed/pillowpile/green
	...
	sourcepillow = "/obj/item/bedsheet/pillow/green" // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/bedsheet/pillow/red // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/bed/pillowpile/red
	...
	sourcepillow = "/obj/item/bedsheet/pillow/red" // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/bedsheet/pillow/orange // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/bed/pillowpile/orange
	...
	sourcepillow = "/obj/item/bedsheet/pillow/orange" // CHOMPEdit - Removal of obj/item/weapon
...
/datum/crafting_recipe/pillowpink
	name = "pillow (pink)"
	result = /obj/item/bedsheet/pillow // CHOMPEdit - Removal of obj/item/weapon
	reqs = list(
...
/datum/crafting_recipe/pillowteal
	name = "pillow (teal)"
	result = /obj/item/bedsheet/pillow/teal // CHOMPEdit - Removal of obj/item/weapon
	reqs = list(
		list(/obj/item/stack/material/cloth = 6)
	)
	time = 60
...
/datum/crafting_recipe/pillowwhite
	name = "pillow (white)"
	result = /obj/item/bedsheet/pillow/white // CHOMPEdit - Removal of obj/item/weapon
	reqs = list(
		list(/obj/item/stack/material/cloth = 6)
	)
	time = 60
...
/datum/crafting_recipe/pillowblack
	name = "pillow (black)"
	result = /obj/item/bedsheet/pillow/black // CHOMPEdit - Removal of obj/item/weapon
	reqs = list(
		list(/obj/item/stack/material/cloth = 6)
	)
	time = 60
...
/datum/crafting_recipe/pillowgreen
	name = "pillow (green)"
	result = /obj/item/bedsheet/pillow/green // CHOMPEdit - Removal of obj/item/weapon
	reqs = list(
		list(/obj/item/stack/material/cloth = 6)
	)
	time = 60
...
/datum/crafting_recipe/pillowyellow
	name = "pillow (yellow)"
	result = /obj/item/bedsheet/pillow/yellow // CHOMPEdit - Removal of obj/item/weapon
	reqs = list(
		list(/obj/item/stack/material/cloth = 6)
	)
	time = 60
...
/datum/crafting_recipe/pillowred
	name = "pillow (red)"
	result = /obj/item/bedsheet/pillow/red // CHOMPEdit - Removal of obj/item/weapon
	reqs = list(
		list(/obj/item/stack/material/cloth = 6)
	)
	time = 60
...
/datum/crafting_recipe/pilloworange
	name = "pillow (orange)"
	result = /obj/item/bedsheet/pillow/orange // CHOMPEdit - Removal of obj/item/weapon
	reqs = list(
		list(/obj/item/stack/material/cloth = 6)
	)
	time = 60
