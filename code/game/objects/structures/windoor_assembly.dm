...
/obj/structure/windoor_assembly/attackby(obj/item/W as obj, mob/user as mob)
	...
	switch(state)
		...
		if("02")
			...
			else if(istype(W, /obj/item/airlock_electronics)) // CHOMPEdit - Removal of obj/item/weapon
			...
			//Screwdriver to remove airlock electronics. Step 6 undone.
				...
				if(do_after(user, 40 * W.toolspeed))
					...
					step = 1
					var/obj/item/airlock_electronics/ae = electronics // CHOMPEdit - Removal of obj/item/weapon
					electronics = null
					ae.loc = src.loc
			...
			//Crowbar to complete the assembly, Step 7 complete.
				...
				if(!src.electronics)
					...
					return
				if(src.electronics && istype(src.electronics, /obj/item/circuitboard/broken)) // CHOMPEdit - Removal of obj/item/weapon
