/obj/effect/mine
	...
	var/obj/item/mine/mineitemtype = /obj/item/mine // CHOMPEdit - Removal of obj/item/weapon
...
/obj/effect/mine/proc/trigger_trap(var/mob/living/victim)
	if(istype(trap, /obj/item/grenade)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/grenade/G = trap // CHOMPEdit - Removal of obj/item/weapon
		trap = null
	...
	if(istype(trap, /obj/item/transfer_valve)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/transfer_valve/TV = trap // CHOMPEdit - Removal of obj/item/device
		trap = null
...
/obj/effect/mine/attackby(obj/item/W as obj, mob/living/user as mob)
	...
	else if((W.has_tool_quality(TOOL_WIRECUTTER) || istype(W, /obj/item/multitool)) && panel_open) // CHOMPEdit - Removal of obj/item/device
		interact(user)
	else
		..()
...
/obj/effect/mine/dnascramble
	mineitemtype = /obj/item/mine/dnascramble // CHOMPEdit - Removal of obj/item/weapon
...
/obj/effect/mine/stun
	mineitemtype = /obj/item/mine/stun // CHOMPEdit - Removal of obj/item/weapon
...
/obj/effect/mine/n2o
	mineitemtype = /obj/item/mine/n2o // CHOMPEdit - Removal of obj/item/weapon
...
/obj/effect/mine/phoron
	mineitemtype = /obj/item/mine/phoron // CHOMPEdit - Removal of obj/item/weapon
...
/obj/effect/mine/kick
	mineitemtype = /obj/item/mine/kick // CHOMPEdit - Removal of obj/item/weapon
...
/obj/effect/mine/frag
	mineitemtype = /obj/item/mine/frag // CHOMPEdit - Removal of obj/item/weapon
...
//	desc = "A mine with its payload removed, for EOD training and demonstrations."
	mineitemtype = /obj/item/mine/training // CHOMPEdit - Removal of obj/item/weapon
...
/obj/effect/mine/emp
	mineitemtype = /obj/item/mine/emp // CHOMPEdit - Removal of obj/item/weapon
...
/obj/effect/mine/incendiary
	mineitemtype = /obj/item/mine/incendiary // CHOMPEdit - Removal of obj/item/weapon
...
/obj/effect/mine/gadget
	mineitemtype = /obj/item/mine/gadget // CHOMPEdit - Removal of obj/item/weapon
...
/////////////////////////////////////////////
/obj/item/mine // CHOMPEdit - Removal of obj/item/weapon
	name = "mine"
...
/obj/item/mine/attack_self(mob/user as mob)	// You do not want to move or throw a land mine while priming it... Explosives + Sudden Movement = Bad Times // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/mine/attackby(obj/item/W as obj, mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/mine/proc/prime(mob/user as mob, var/explode_now = FALSE) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/mine/training // CHOMPEdit - Removal of obj/item/weapon
	name = "training mine"
	desc = "A mine with its payload removed, for EOD training and demonstrations."
	minetype = /obj/effect/mine/training

/obj/item/mine/emp // CHOMPEdit - Removal of obj/item/weapon
	name = "emp mine"
	desc = "A small explosive mine with a lightning bolt symbol on the side."
	minetype = /obj/effect/mine/emp

/obj/item/mine/incendiary // CHOMPEdit - Removal of obj/item/weapon
	name = "incendiary mine"
	desc = "A small explosive mine with a fire symbol on the side."
	minetype = /obj/effect/mine/incendiary

/obj/item/mine/gadget // CHOMPEdit - Removal of obj/item/weapon
	name = "gadget mine"
	...
	allowed_gadgets = list(/obj/item/grenade, /obj/item/transfer_valve) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device

// This tells AI mobs to not be dumb and step on mines willingly.
/obj/item/mine/is_safe_to_step(mob/living/L) // CHOMPEdit - Removal of obj/item/weapon
