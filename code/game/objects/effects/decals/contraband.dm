...
/obj/item/contraband // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/contraband/poster // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/contraband/poster/New(turf/loc, var/given_serial = 0) // CHOMPEdit - Removal of obj/item/weapon
	if(!serial_number)
		if(given_serial == 0)
...
/obj/item/contraband/poster/afterattack(var/atom/A, var/mob/user, var/adjacent, var/clickparams) // CHOMPEdit - Removal of obj/item/weapon
	if (!adjacent)
		return
...
//NT subtype
/obj/item/contraband/poster/nanotrasen // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "rolled_poster_nt"
	poster_type = /obj/structure/sign/poster/nanotrasen

/obj/item/contraband/poster/nanotrasen/New(turf/loc, var/given_serial = 0) // CHOMPEdit - Removal of obj/item/weapon
	if(given_serial == 0)
...
//Selectable subtype
/obj/item/contraband/poster/custom // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/contraband/poster/custom/New(turf/loc, var/given_serial = 0) // CHOMPEdit - Removal of obj/item/weapon
	if(given_serial == 0)
...
/obj/item/contraband/poster/custom/verb/select_poster() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/sign/poster/New(var/newloc, var/placement_dir=null, var/serial=null, var/itemtype = /obj/item/contraband/poster) // CHOMPEdit - Removal of obj/item/weapon
	..(newloc)
...
/obj/structure/sign/poster/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/sign/poster/proc/roll_and_drop(turf/newloc)
	var/obj/item/contraband/poster/P = new roll_type(src, serial_number) // CHOMPEdit - Removal of obj/item/weapon
	P.loc = newloc
	src.loc = P
	qdel(src)
...
/obj/structure/sign/poster/nanotrasen
	roll_type = /obj/item/contraband/poster/nanotrasen // CHOMPEdit - Removal of obj/item/weapon

/obj/structure/sign/poster/nanotrasen/New(var/newloc, var/placement_dir=null, var/serial=null, var/itemtype = /obj/item/contraband/poster/nanotrasen) // CHOMPEdit - Removal of obj/item/weapon
	if(!serial)
...
/obj/structure/sign/poster/custom
	roll_type = /obj/item/contraband/poster/custom // CHOMPEdit - Removal of obj/item/weapon
