...
/obj/effect/landmark/event_trigger/proc/set_vars(mob/M)
	...
	name = new_name
	creator_ckey = M.ckey
	if(!GLOB.event_triggers[creator_ckey]) // CHOMPEdit - Globals
		GLOB.event_triggers[creator_ckey] = list() // CHOMPEdit - Globals
	GLOB.event_triggers[creator_ckey] |= list(src) // CHOMPEdit - Globals
...
/obj/effect/landmark/event_trigger/Destroy()
	if(GLOB.event_triggers[creator_ckey]) // CHOMPEdit - Globals
		GLOB.event_triggers[creator_ckey] -= src // CHOMPEdit - Globals
	..()
