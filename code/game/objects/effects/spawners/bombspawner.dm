...
/obj/effect/spawner/newbomb
	...
	var/assembly_type = /obj/item/assembly/signaler // CHOMPEdit - Removal of obj/item/device
...
/obj/effect/spawner/newbomb/timer
	name = "TTV bomb - timer"
	assembly_type = /obj/item/assembly/timer // CHOMPEdit - Removal of obj/item/device
...
/obj/effect/spawner/newbomb/proximity
	...
	assembly_type = /obj/item/assembly/prox_sensor // CHOMPEdit - Removal of obj/item/device
...
/obj/effect/spawner/newbomb/Initialize(newloc)
	..(newloc)
	var/obj/item/transfer_valve/V = new(src.loc) // CHOMPEdit - Removal of obj/item/device
	var/obj/item/tank/phoron/PT = new(V) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/tank/oxygen/OT = new(V) // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/assembly/S = new assembly_type(V) // CHOMPEdit - Removal of obj/item/device
	V.attached_device = S
...
/obj/effect/spawner/onetankbomb/New(newloc) //just needs an assembly.
	...
	var/type = pick(/obj/item/tank/phoron/onetankbomb, /obj/item/tank/oxygen/onetankbomb) // CHOMPEdit - Removal of obj/item/weapon
	new type(src.loc)
...
/obj/effect/spawner/onetankbomb/full/New(newloc) //just needs an assembly.
	...
	var/type = pick(/obj/item/tank/phoron/onetankbomb/full, /obj/item/tank/oxygen/onetankbomb/full) // CHOMPEdit - Removal of obj/item/weapon
	new type(src.loc)
