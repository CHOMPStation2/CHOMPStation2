/obj/item/kit // CHOMPEdit - Removal of obj/item/device
	icon_state = "modkit"
...
/obj/item/kit/examine() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	. += "It has [uses] use\s left."

/obj/item/kit/proc/use(var/amt, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	uses -= amt
...
/obj/item/kit/proc/can_customize(var/obj/item/I) // CHOMPEdit - Removal of obj/item/device
	return is_type_in_list(I, allowed_types)

/obj/item/kit/proc/set_info(var/kit_name, var/kit_desc, var/kit_icon, var/kit_icon_file = CUSTOM_ITEM_OBJ, var/kit_icon_override_file = CUSTOM_ITEM_MOB, var/additional_data) // CHOMPEdit - Removal of obj/item/device
	new_name = kit_name
	new_desc = kit_desc
	new_icon = kit_icon
...
/obj/item/kit/proc/customize(var/obj/item/I, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	if(can_customize(I))
...
// Generic use
/obj/item/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/kit)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/kit/K = W // CHOMPEdit - Removal of obj/item/device
...
/obj/item/kit/suit // CHOMPEdit - Removal of obj/item/device
	name = "voidsuit modification kit"
	desc = "A kit for modifying a voidsuit."
	uses = 2
	var/new_light_overlay

/obj/item/kit/suit/can_customize(var/obj/item/I) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/kit/suit/set_info(var/kit_name, var/kit_desc, var/kit_icon, var/kit_icon_file = CUSTOM_ITEM_OBJ, var/kit_icon_override_file = CUSTOM_ITEM_MOB, var/additional_data) // CHOMPEdit - Removal of obj/item/device
	..()

	new_light_overlay = additional_data


/obj/item/kit/suit/customize(var/obj/item/I, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	if(can_customize(I))
...
/obj/item/clothing/head/helmet/space/void/attackby(var/obj/item/O, var/mob/user)
	if(istype(O,/obj/item/kit/suit)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/kit/suit/kit = O // CHOMPEdit - Removal of obj/item/device
...
/obj/item/kit/suit/rig // CHOMPEdit - Removal of obj/item/device
	name = "rig modification kit"
	desc = "A kit for modifying a rigsuit."
	uses = 1

/obj/item/kit/suit/rig/customize(var/obj/item/I, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	var/obj/item/rig/RIG = I // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/kit/suit/rig/can_customize(var/obj/item/I) // CHOMPEdit - Removal of obj/item/device
	return istype(I, /obj/item/rig) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/rig/attackby(var/obj/item/O, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(O,/obj/item/kit/suit)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/kit/suit/rig/kit = O // CHOMPEdit - Removal of obj/item/device
		kit.customize(src, user)
		return
	return ..()

/obj/item/kit/suit/rig/debug/Initialize() // CHOMPEdit - Removal of obj/item/device
	set_info("debug suit", "This is a test", "debug", CUSTOM_ITEM_OBJ, CUSTOM_ITEM_MOB)

/obj/item/kit/paint // CHOMPEdit - Removal of obj/item/device
	name = "mecha customisation kit"
	desc = "A kit containing all the needed tools and parts to repaint a mech."
	var/removable = null

/obj/item/kit/paint/can_customize(var/obj/mecha/M) // CHOMPEdit - Removal of obj/item/device
	if(!istype(M))
		return 0
...
/obj/item/kit/paint/set_info(var/kit_name, var/kit_desc, var/kit_icon, var/kit_icon_file = CUSTOM_ITEM_OBJ, var/kit_icon_override_file = CUSTOM_ITEM_MOB, var/additional_data) // CHOMPEdit - Removal of obj/item/device
	..()

	allowed_types = splittext(additional_data, ", ")


/obj/item/kit/paint/examine() // CHOMPEdit - Removal of obj/item/device
	. = ..()
...
/obj/item/kit/paint/customize(var/obj/mecha/M, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	if(!can_customize(M))
...
/obj/mecha/attackby(var/obj/item/W, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/kit/paint)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/kit/paint/P = W // CHOMPEdit - Removal of obj/item/device
...
/obj/item/kit/paint/ripley/customize(obj/mecha/M, mob/user) // CHOMPEdit - Removal of obj/item/device
	if(showpilot)
		M.show_pilot = TRUE
		M.pilot_lift = 5
	else
