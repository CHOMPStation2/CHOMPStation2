...
/obj/item/reagent_containers/food/snacks/slice/bread/afterattack(atom/A, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/food/snacks/tastybread/afterattack(atom/A, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(A, /obj/item/toy/plushie/ipc) && !toasted)
		toasted = TRUE
		icon = 'icons/obj/toy_vr.dmi'
		icon_state = "toast"
...
/obj/item/toy/plushie/ipc/attackby(obj/item/I as obj, mob/living/user as mob)
	if(istype(I, /obj/item/material/kitchen/utensil)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/toy/plushie/marketable_pip/attackby(obj/item/I, mob/user)
	...
	var/obj/item/card/id/id = I.GetID() // CHOMPEdit - Removal of obj/item/weapon
	if(istype(id))
		if(!cooldown)
 ...
 * Toy cuffs
 */
/obj/item/handcuffs/fake // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/handcuffs/legcuffs/fake // CHOMPEdit - Removal of obj/item/weapon
	name = "plastic legcuffs"
	desc = "Use this to keep plastic prisoners in line."
	breakouttime = 30	//Deciseconds = 30s = 0.5 minute
	use_time = 120

/obj/item/storage/box/handcuffs/fake // CHOMPEdit - Removal of obj/item/weapon
	name = "box of plastic handcuffs"
	desc = "A box full of plastic handcuffs."
	icon_state = "handcuff"
	starts_with = list(/obj/item/handcuffs/fake = 1, /obj/item/handcuffs/legcuffs/fake = 1) // CHOMPEdit - Removal of obj/item/weapon
	foldable = null
	can_hold = list(/obj/item/handcuffs/fake, /obj/item/handcuffs/legcuffs/fake) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/toy/nuke/attackby(obj/item/I as obj, mob/living/user as mob)
	if(istype(I, /obj/item/disk/nuclear)) // CHOMPEdit - Removal of obj/item/weapon
 ...
 * Professor Who sonic driver
 */
/obj/item/tool/screwdriver/sdriver // CHOMPEdit - Removal of obj/item/weapon
	name = "sonic driver"
 ...
 */
/obj/item/storage/box/timecap // CHOMPEdit - Removal of obj/item/weapon
 ...
 * Desk toys
 */
/obj/item/toy/desk // CHOMPEdit - Removal of obj/item/weapon
	icon = 'icons/obj/toy_vr.dmi'
	var/on = FALSE
	var/activation_sound = 'sound/machines/click.ogg'

/obj/item/toy/desk/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(on)
		icon_state = "[initial(icon_state)]-on"
	else
		icon_state = "[initial(icon_state)]"

/obj/item/toy/desk/proc/activate(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	on = !on
	playsound(src.loc, activation_sound, 75, 1)
	update_icon()
	return 1

/obj/item/toy/desk/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	activate(user)

/obj/item/toy/desk/AltClick(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	activate(user)

/obj/item/toy/desk/MouseDrop(mob/user as mob) // Code from Paper bin, so you can still pick up the deck // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/toy/desk/newtoncradle // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/toy/desk/fan // CHOMPEdit - Removal of obj/item/weapon
	name = "office fan"
...
/obj/item/toy/desk/officetoy // CHOMPEdit - Removal of obj/item/weapon
	name = "office toy"
...
/obj/item/toy/desk/dippingbird // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/toy/desk/stellardelight // CHOMPEdit - Removal of obj/item/weapon
 ...
 * Party popper
 */
/obj/item/toy/partypopper // CHOMPEdit - Removal of obj/item/weapon
	name = "party popper"
...
/obj/item/toy/partypopper/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
 ...
 * Snow Globes
 */
/obj/item/toy/snowglobe // CHOMPEdit - Removal of obj/item/weapon
	name = "snowglobe"
	icon = 'icons/obj/snowglobe_vr.dmi'

/obj/item/toy/snowglobe/snowvillage // CHOMPEdit - Removal of obj/item/weapon
	desc = "Depicts a small, quaint village buried in snow."
	icon_state = "smolsnowvillage"

/obj/item/toy/snowglobe/tether // CHOMPEdit - Removal of obj/item/weapon
	desc = "Depicts a massive space elevator reaching to the sky."
	icon_state = "smoltether"

/obj/item/toy/snowglobe/stellardelight // CHOMPEdit - Removal of obj/item/weapon
	desc = "Depicts an interstellar spacecraft."
	icon_state = "smolstellardelight"

/obj/item/toy/snowglobe/rascalspass // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/toy/monster_bait/afterattack(var/atom/A, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
