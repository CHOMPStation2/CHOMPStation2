...
/obj/item/robot_parts/head
	...
	icon_state = "head"
	part = list(BP_HEAD)
	var/obj/item/flash/flash1 = null // CHOMPEdit - Removal of obj/item/device
	var/obj/item/flash/flash2 = null // CHOMPEdit - Removal of obj/item/device
...
/obj/item/robot_parts/robot_suit/attackby(obj/item/W as obj, mob/user as mob)
	...
	if(istype(W, /obj/item/stack/material) && W.get_material_name() == MAT_STEEL && !l_arm && !r_arm && !l_leg && !r_leg && !chest && !head)
		...
		if (M.use(1))
			var/obj/item/secbot_assembly/ed209_assembly/B = new /obj/item/secbot_assembly/ed209_assembly // CHOMPEdit - Removal of obj/item/weapon
			B.loc = get_turf(src)
	...
	if(istype(W, /obj/item/mmi)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/mmi/M = W // CHOMPEdit - Removal of obj/item/device
		if(check_completion())
			if(!istype(loc,/turf))
				...
				return
			if(!istype(W, /obj/item/mmi/inert)) // CHOMPEdit - Removal of obj/item/device
				if(!M.brainmob)
...
/obj/item/robot_parts/head/attackby(obj/item/W as obj, mob/user as mob)
	..()
	if(istype(W, /obj/item/flash)) // CHOMPEdit - Removal of obj/item/device
