...
/obj/item/towel/equipped(var/M, var/slot) // CHOMPEdit - Removal of obj/item/weapon
	..()
	switch(slot)
		if(slot_head)
...
/obj/item/towel/attack_self(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/towel/random/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
