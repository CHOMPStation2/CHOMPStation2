/obj/item/nullrod // CHOMPEdit - Removal of obj/item/weapon
	name = "null rod"
...
/obj/item/nullrod/attack(mob/M as mob, mob/living/user as mob) //Paste from old-code to decult with a null rod. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/nullrod/afterattack(atom/A, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!proximity)
		return
...
/obj/item/energy_net // CHOMPEdit - Removal of obj/item/weapon
	name = "energy net"
...
/obj/item/energy_net/dropped() // CHOMPEdit - Removal of obj/item/weapon
	spawn(10)
		if(src) qdel(src)

/obj/item/energy_net/throw_impact(atom/hit_atom) // CHOMPEdit - Removal of obj/item/weapon
	..()
