...
/obj/machinery/implantchair
	...
	var/ready = 1
	var/malfunction = 0
	var/list/obj/item/implant/loyalty/implant_list = list() // CHOMPEdit - Removal of obj/item/weapon
	var/max_implants = 5
...
/obj/machinery/implantchair/attackby(var/obj/item/G as obj, var/mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/implantchair/proc/implant(var/mob/M)
	...
	for(var/obj/item/implant/loyalty/imp in implant_list) // CHOMPEdit - Removal of obj/item/weapon
		if(!imp)	continue
		if(istype(imp, /obj/item/implant/loyalty)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/machinery/implantchair/proc/add_implants()
	for(var/i=0, i<src.max_implants, i++)
		var/obj/item/implant/loyalty/I = new /obj/item/implant/loyalty(src) // CHOMPEdit - Removal of obj/item/weapon
		implant_list += I
	return
