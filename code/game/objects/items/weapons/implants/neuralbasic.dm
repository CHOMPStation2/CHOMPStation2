/obj/item/implant/neural // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/implant/neural/post_implant(var/mob/source) // CHOMPEdit - Removal of obj/item/weapon
	if(ishuman(source))
...
/obj/item/implant/neural/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	if(my_brain)
		if(my_brain.owner)
...
/obj/item/implant/neural/process() // CHOMPEdit - Removal of obj/item/weapon
	if(my_brain && part)
...
/obj/item/implant/neural/get_data() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/implant/neural/emp_act(severity) // CHOMPEdit - Removal of obj/item/weapon
	if(!my_brain)
		return
...
/obj/item/implant/neural/meltdown() // CHOMPEdit - Removal of obj/item/weapon
	..()
	STOP_PROCESSING(SSobj, src)
