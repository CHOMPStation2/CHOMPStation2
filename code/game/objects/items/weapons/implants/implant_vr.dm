/obj/item/implant/vrlanguage // CHOMPEdit - Removal of obj/item/weapon
	name = "language"
	desc = "Allows the user to understand and speak almost all known languages.."
	var/uses = 1

/obj/item/implant/vrlanguage/get_data() // CHOMPEdit - Removal of obj/item/weapon
	var/dat = {"
...
/obj/item/implant/vrlanguage/trigger(emote, mob/source as mob) // CHOMPEdit - Removal of obj/item/weapon
	if (src.uses < 1)
		return 0
	if (emote == "smile")
		src.uses--
...
/obj/item/implant/vrlanguage/post_implant(mob/source) // CHOMPEdit - Removal of obj/item/weapon
...
//////////////////////////////
/obj/item/implant/sizecontrol // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/implant/sizecontrol/get_data() // CHOMPEdit - Removal of obj/item/weapon
	var/dat = {"
<b>Implant Specifications:</b><BR>
...
/obj/item/implant/sizecontrol/hear_talk(mob/M, list/message_pieces) // CHOMPEdit - Removal of obj/item/weapon
	if(M == imp_in)
		return
	if(owner)
		if(M != owner)
...
/obj/item/implant/sizecontrol/see_emote(mob/living/M, message, m_type) // CHOMPEdit - Removal of obj/item/weapon
	if(M == imp_in)
		return
	if(owner)
		if(M != owner)
...
/obj/item/implant/sizecontrol/hear(var/msg) // CHOMPEdit - Removal of obj/item/weapon
	if (malfunction)
		return
...
/obj/item/implant/sizecontrol/post_implant(mob/source, mob/living/user = usr) // CHOMPEdit - Removal of obj/item/weapon
	if(source != user)
		owner = user


/obj/item/implant/sizecontrol/emp_act(severity) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(imp_in, /mob/living))
...
/obj/item/implanter/sizecontrol/New() // CHOMPEdit - Removal of obj/item/weapon
	src.imp = new /obj/item/implant/sizecontrol( src ) // CHOMPEdit - Removal of obj/item/weapon
	..()
	update()
	return
...
/obj/item/implanter/compliance/New() // CHOMPEdit - Removal of obj/item/weapon
	src.imp = new /obj/item/implant/compliance( src ) // CHOMPEdit - Removal of obj/item/weapon
	..()
	update()
	return

/obj/item/implanter/compliance/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(imp,/obj/item/implant/compliance)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/implant/compliance/implant = imp // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/implant/compliance // CHOMPEdit - Removal of obj/item/weapon
	name = "compliance implant"
...
/obj/item/implant/compliance/get_data() // CHOMPEdit - Removal of obj/item/weapon
	var/dat = {"
<b>Implant Specifications:</b><BR>
...
/obj/item/implant/compliance/post_implant(mob/source, mob/living/user = usr) // CHOMPEdit - Removal of obj/item/weapon
