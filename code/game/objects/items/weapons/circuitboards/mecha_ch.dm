...
/obj/item/circuitboard/mecha/scarab // CHOMPEdit - Removal of obj/item/weapon
		origin_tech = list(TECH_DATA = 4)

/obj/item/circuitboard/mecha/scarab/peripherals // CHOMPEdit - Removal of obj/item/weapon
		name = T_BOARD_CHMECHA("Scarab peripherals control")
		icon_state = "mcontroller"

/obj/item/circuitboard/mecha/scarab/targeting // CHOMPEdit - Removal of obj/item/weapon
		name = T_BOARD_CHMECHA("Scarab weapon control and targeting")
		icon_state = "mcontroller"
		origin_tech = list(TECH_DATA = 4, TECH_COMBAT = 4)

/obj/item/circuitboard/mecha/scarab/main // CHOMPEdit - Removal of obj/item/weapon
