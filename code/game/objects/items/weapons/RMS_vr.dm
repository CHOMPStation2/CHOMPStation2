...
/obj/item/rms // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rms/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/pipe_dispenser/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	qdel_null(spark_system)
	return ..()

/obj/item/rms/update_icon() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rms/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	. += display_resources()

/obj/item/rms/proc/display_resources() // CHOMPEdit - Removal of obj/item/weapon
	return "It currently holds [round(stored_charge/1000)]/[max_charge/1000] kW charge."

/obj/item/rms/proc/drain_battery(user, battery) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/cell/C = battery // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rms/proc/consume_resources(amount) // CHOMPEdit - Removal of obj/item/weapon
	stored_charge -= amount
	update_icon()
	return


/obj/item/rms/proc/can_afford(amount) // CHOMPEdit - Removal of obj/item/weapon
	if(stored_charge < amount)
		return FALSE
	else
		return TRUE

/obj/item/rms/proc/use_rms(atom/A, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/product
	if(!overcharge)
			...
			if(RMS_RAND)
				if(!overcharge && !emagged)
					product = pick(10;new /obj/item/trash/material/metal,
									10;new /obj/item/material/shard, // CHOMPEdit - Removal of obj/item/weapon
				...
				if(overcharge && !emagged)
					product = pick(1;new /obj/item/stack/rods,
									5;new /obj/item/fbp_backup_cell, // CHOMPEdit - Removal of obj/item/device
				...
				if(overcharge && emagged)
					product = pick(1;new /obj/item/stack/rods,
									...
									10;new /obj/item/stack/tile/grass,
									10;new /obj/item/stack/tile/carpet,
									10;new /obj/item/reagent_containers/spray/waterflower, // CHOMPEdit - Removal of obj/item/weapon
									10;new /obj/item/bikehorn, // CHOMPEdit - Removal of obj/item/weapon
									10;new /obj/item/storage/backpack/clown, // CHOMPEdit - Removal of obj/item/weapon
									...
									10;new /obj/item/pda/clown, // CHOMPEdit - Removal of obj/item/device
									1;new /mob/living/simple_mob/vore/catgirl
									)
					spark_system.start()
	product.loc = get_turf(A)

/obj/item/rms/proc/check_menu(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(user))
		return FALSE
...
/obj/item/rms/afterattack(atom/target, mob/user, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!proximity)
		return
	if(istype(target, /obj/item/cell)) //Check for a battery on-click // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rms/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rms/emag_act(var/remaining_charges, var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	emagged = !emagged
	playsound(src.loc, "sparks", 100, 1)
	return 1

/obj/item/rms/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
