...
/obj/item/flame/is_hot() // CHOMPEdit - Removal of obj/item/weapon
	return lit
...
/obj/item/flame/match/process() // CHOMPEdit - Removal of obj/item/weapon
	if(isliving(loc))
...
/obj/item/flame/match/dropped(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flame/match/proc/light(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flame/match/proc/burn_out() // CHOMPEdit - Removal of obj/item/weapon
	lit = 0
	burnt = 1
	damtype = "brute"
...
/obj/item/clothing/mask/smokable/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(W.is_hot())
		var/text = matchmes
		if(istype(W, /obj/item/flame/match)) // CHOMPEdit - Removal of obj/item/weapon
			text = matchmes
		else if(istype(W, /obj/item/flame/lighter/zippo)) // CHOMPEdit - Removal of obj/item/weapon
			text = zippomes
		else if(istype(W, /obj/item/flame/lighter)) // CHOMPEdit - Removal of obj/item/weapon
			text = lightermes
		else if(istype(W, /obj/item/weldingtool)) // CHOMPEdit - Removal of obj/item/weapon
			text = weldermes
		else if(istype(W, /obj/item/assembly/igniter)) // CHOMPEdit - Removal of obj/item/device
			text = ignitermes
...
/obj/item/clothing/mask/smokable/cigarette/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()

	if(istype(W, /obj/item/melee/energy/sword)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/melee/energy/sword/S = W // CHOMPEdit - Removal of obj/item/weapon
		if(S.active)
			light("<span class='warning'>[user] swings their [W], barely missing their nose. They light their [name] in the process.</span>")

	return

/obj/item/clothing/mask/smokable/cigarette/afterattack(obj/item/reagent_containers/glass/glass, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(!proximity)
		return
...
/obj/item/clothing/mask/smokable/cigarette/cigar/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/clothing/mask/smokable/pipe/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/melee/energy/sword)) // CHOMPEdit - Removal of obj/item/weapon
		return

	..()

	if (istype(W, /obj/item/reagent_containers/food/snacks)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/reagent_containers/food/snacks/grown/G = W // CHOMPEdit - Removal of obj/item/weapon
		if (!G.dry)
...
/obj/item/reagent_containers/rollingpaper // CHOMPEdit - Removal of obj/item/weapon
	name = "rolling paper"
...
/obj/item/reagent_containers/rollingpaper/blunt // CHOMPEdit - Removal of obj/item/weapon
	name = "blunt wrap"
...
/obj/item/reagent_containers/rollingpaper/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if (istype(W, /obj/item/reagent_containers/food/snacks)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/reagent_containers/food/snacks/grown/G = W // CHOMPEdit - Removal of obj/item/weapon
		...
		if (src.reagents.total_volume == 0)
			if (istype(src, /obj/item/reagent_containers/rollingpaper/blunt))                         //update the icon if this is the first thing we're adding to the paper // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/reagent_containers/rollingpaper/attack_self(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flame/lighter/random // CHOMPEdit - Removal of obj/item/weapon

// Randomizes Cheap Lighters on Spawn
/obj/item/flame/lighter/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	var/image/I = image(icon, "lighter-[pick("trans","tall","matte")]")
	I.color = pick(available_colors)
	add_overlay(I)

/obj/item/flame/lighter/attack_self(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!lit)
		lit = 1
...
/obj/item/flame/lighter/attack(mob/living/carbon/M as mob, mob/living/carbon/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(M, /mob))
		return
	...
	if(istype(M.wear_mask, /obj/item/clothing/mask/smokable/cigarette) && user.zone_sel.selecting == O_MOUTH && lit)
		...
		if(M == user)
			...
			if(istype(src, /obj/item/flame/lighter/zippo)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flame/lighter/process() // CHOMPEdit - Removal of obj/item/weapon
	var/turf/location = get_turf(src)
	if(location)
		location.hotspot_expose(700, 5)
	return
...
/obj/item/flame/lighter/zippo/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	cut_overlays() //Prevents the Cheap Lighter overlay from appearing on this

/obj/item/flame/lighter/zippo/attack_self(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!base_state)
...
/obj/item/flame/lighter/zippo/blue // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper blue Zippo lighter"
	icon_state = "bluezippo"

/obj/item/flame/lighter/zippo/engraved // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flame/lighter/zippo/moff // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper moth Zippo lighter"
	desc = "Too cute to be a Tymisian."
	icon_state = "moffzippo"

/obj/item/flame/lighter/zippo/red // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper red Zippo lighter"
	icon_state = "redzippo"

/obj/item/flame/lighter/zippo/ironic // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper ironic Zippo lighter"
	desc = "What a quiant idea."
	icon_state = "ironiczippo"

/obj/item/flame/lighter/zippo/capitalist // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flame/lighter/zippo/communist // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper communist Zippo lighter"
	desc = "All you need to spark a revolution."
	icon_state = "commiezippo"

/obj/item/flame/lighter/zippo/royal // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flame/lighter/zippo/gonzo // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper Gonzo Zippo lighter"
	desc = "A lighter with the iconic Gonzo fist painted on it."
	icon_state = "gonzozippo"

/obj/item/flame/lighter/zippo/rainbow // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper rainbow Zippo lighter"
	icon_state = "rainbowzippo"

/obj/item/flame/lighter/zippo/skull // CHOMPEdit - Removal of obj/item/weapon
