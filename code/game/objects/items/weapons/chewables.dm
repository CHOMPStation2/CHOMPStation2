...
/obj/item/storage/chewables // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/chewables/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	make_exact_fit()

//Tobacco Tins

/obj/item/storage/chewables/tobacco // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/chewables/tobacco/fine // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/box/fancy/chewables/tobacco/nico // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/box/fancy/chewables/tobacco/nico/New() // CHOMPEdit - Removal of obj/item/weapon
	if(!open_state)
...
/obj/item/storage/box/fancy/chewables/tobacco/nico/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	cut_overlays()
	if(open)
...
/obj/item/storage/box/fancy/chewables/tobacco/nico/open(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(open)
		return
	open = TRUE
	if(contents.len == 0)
...
/obj/item/storage/box/fancy/chewables/tobacco/nico/close(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	open = FALSE
	if(contents.len == 0)
		icon_state = "[initial(icon_state)]_empty"
	else
...
/obj/item/storage/box/gum // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/clothing/mask/chewable/candy/lolli/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/box/pocky // CHOMPEdit - Removal of obj/item/weapon
