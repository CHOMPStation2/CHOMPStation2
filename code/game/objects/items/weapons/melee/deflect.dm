...
/obj/item/melee/handle_shield(mob/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, var/attack_text = "the attack") // CHOMPEdit - Removal of obj/item/weapon
	if(.)
		return .
...
/obj/item/melee/unique_parry_check(mob/user, mob/attacker, atom/damage_source) // CHOMPEdit - Removal of obj/item/weapon
	if(.)
		return .
