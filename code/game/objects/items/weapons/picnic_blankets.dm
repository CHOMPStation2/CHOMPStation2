...
/obj/item/picnic_blankets_carried // CHOMPEdit - Removal of obj/item/weapon
	name = "picnic blanket"
...
/obj/item/picnic_blankets_carried/verb/fold_out() // CHOMPEdit - Removal of obj/item/weapon
	set name = "Fold out"
...
/obj/structure/picnic_blanket_deployed/verb/fold_up()
	...
	for(var/obj/structure/picnic_blanket_deployed/side in attached_blankets)
		qdel(side)
	var/obj/item/picnic_blankets_carried/P = new /obj/item/picnic_blankets_carried(usr.loc) // CHOMPEdit - Removal of obj/item/weapon
	P.name = name
	P.desc = folded_desc
	qdel(src)
