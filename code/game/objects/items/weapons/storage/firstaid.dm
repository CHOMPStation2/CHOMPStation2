...
/obj/item/storage/firstaid/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(icon_variety)
...
/obj/item/storage/firstaid/combat // CHOMPEdit - Removal of obj/item/weapon
	...
	item_state_slots = list(slot_r_hand_str = "firstaid-advanced", slot_l_hand_str = "firstaid-advanced")
	starts_with = list(
		/obj/item/storage/pill_bottle/bicaridine, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/storage/pill_bottle/dermaline, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/storage/pill_bottle/dexalin_plus, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/storage/pill_bottle/dylovene, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/storage/pill_bottle/tramadol, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/storage/pill_bottle/spaceacillin, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/reagent_containers/hypospray/autoinjector/biginjector/clotting, // CHOMPEdit - Removal of obj/item/weapon
		/obj/item/stack/medical/splint,
		/obj/item/healthanalyzer/advanced // CHOMPEdit - Removal of obj/item/device
	)

/obj/item/storage/firstaid/surgery // CHOMPEdit - Removal of obj/item/weapon
	name = "surgery kit"
...
/obj/item/storage/firstaid/clotting // CHOMPEdit - Removal of obj/item/weapon
	...
	starts_with = list(/obj/item/reagent_containers/hypospray/autoinjector/biginjector/clotting = 8) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/storage/firstaid/bonemed // CHOMPEdit - Removal of obj/item/weapon
	name = "bone repair kit"
	desc = "Contains chemicals to mend broken bones."
	max_storage_space = ITEMSIZE_COST_SMALL * 7
	starts_with = list(/obj/item/reagent_containers/hypospray/autoinjector/bonemed = 8) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/pill_bottle // CHOMPEdit - Removal of obj/item/weapon
	...
	can_hold = list(/obj/item/reagent_containers/pill,/obj/item/dice,/obj/item/paper) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/pill_bottle/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	base_name = name
	base_desc = desc
	update_icon()

/obj/item/storage/pill_bottle/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	cut_overlays()
	if(wrapper_color)
...
/obj/item/storage/pill_bottle/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/pill_bottle/proc/update_name_label() // CHOMPEdit - Removal of obj/item/weapon
	if(!label_text)
		name = base_name
		desc = base_desc
		return
...
/obj/item/storage/pill_bottle/antitox // CHOMPEdit - Removal of obj/item/weapon
	...
	starts_with = list(/obj/item/reagent_containers/pill/antitox = 7) // CHOMPEdit - Removal of obj/item/weapon
	wrapper_color = COLOR_GREEN

/obj/item/storage/pill_bottle/bicaridine // CHOMPEdit - Removal of obj/item/weapon
	name = "pill bottle (Bicaridine)"
	desc = "Contains pills used to stabilize the severely injured."
	starts_with = list(/obj/item/reagent_containers/pill/bicaridine = 7) // CHOMPEdit - Removal of obj/item/weapon
	wrapper_color = COLOR_MAROON

/obj/item/storage/pill_bottle/dexalin_plus // CHOMPEdit - Removal of obj/item/weapon
	name = "pill bottle (Dexalin Plus)"
	desc = "Contains pills used to treat extreme cases of oxygen deprivation."
	starts_with = list(/obj/item/reagent_containers/pill/dexalin_plus = 7) // CHOMPEdit - Removal of obj/item/weapon
	wrapper_color = "#3366cc"

/obj/item/storage/pill_bottle/dermaline // CHOMPEdit - Removal of obj/item/weapon
	name = "pill bottle (Dermaline)"
	desc = "Contains pills used to treat burn wounds."
	starts_with = list(/obj/item/reagent_containers/pill/dermaline = 7) // CHOMPEdit - Removal of obj/item/weapon
	wrapper_color = "#e8d131"

/obj/item/storage/pill_bottle/dylovene // CHOMPEdit - Removal of obj/item/weapon
	name = "pill bottle (Dylovene)"
	desc = "Contains pills used to treat toxic substances in the blood."
	starts_with = list(/obj/item/reagent_containers/pill/dylovene = 7) // CHOMPEdit - Removal of obj/item/weapon
	wrapper_color = COLOR_GREEN

/obj/item/storage/pill_bottle/inaprovaline // CHOMPEdit - Removal of obj/item/weapon
	name = "pill bottle (Inaprovaline)"
	desc = "Contains pills used to stabilize patients."
	starts_with = list(/obj/item/reagent_containers/pill/inaprovaline = 7) // CHOMPEdit - Removal of obj/item/weapon
	wrapper_color = COLOR_PALE_BLUE_GRAY

/obj/item/storage/pill_bottle/kelotane // CHOMPEdit - Removal of obj/item/weapon
	name = "pill bottle (Kelotane)"
	desc = "Contains pills used to treat burns."
	starts_with = list(/obj/item/reagent_containers/pill/kelotane = 7) // CHOMPEdit - Removal of obj/item/weapon
	wrapper_color = "#ec8b2f"

/obj/item/storage/pill_bottle/spaceacillin // CHOMPEdit - Removal of obj/item/weapon
	name = "pill bottle (Spaceacillin)"
	desc = "A theta-lactam antibiotic. Effective against many diseases likely to be encountered in space."
	starts_with = list(/obj/item/reagent_containers/pill/spaceacillin = 7) // CHOMPEdit - Removal of obj/item/weapon
	wrapper_color = COLOR_PALE_GREEN_GRAY

/obj/item/storage/pill_bottle/tramadol // CHOMPEdit - Removal of obj/item/weapon
	name = "pill bottle (Tramadol)"
	desc = "Contains pills used to relieve pain."
	starts_with = list(/obj/item/reagent_containers/pill/tramadol = 7) // CHOMPEdit - Removal of obj/item/weapon
	wrapper_color = COLOR_PURPLE_GRAY

/obj/item/storage/pill_bottle/citalopram // CHOMPEdit - Removal of obj/item/weapon
	name = "pill bottle (Citalopram)"
	desc = "Contains pills used to stabilize a patient's mood."
	starts_with = list(/obj/item/reagent_containers/pill/citalopram = 7) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/pill_bottle/carbon // CHOMPEdit - Removal of obj/item/weapon
	...
	starts_with = list(/obj/item/reagent_containers/pill/carbon = 7) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/storage/pill_bottle/iron // CHOMPEdit - Removal of obj/item/weapon
	name = "pill bottle (Iron)"
	desc = "Contains pills used to aid in blood regeneration."
	starts_with = list(/obj/item/reagent_containers/pill/iron = 7) // CHOMPEdit - Removal of obj/item/weapon
