...
/obj/item/storage/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()

	if(allow_quick_empty)
		verbs += /obj/item/storage/verb/quick_empty // CHOMPEdit - Removal of obj/item/weapon
	else
		verbs -= /obj/item/storage/verb/quick_empty // CHOMPEdit - Removal of obj/item/weapon

	if(allow_quick_gather)
		verbs += /obj/item/storage/verb/toggle_gathering_mode // CHOMPEdit - Removal of obj/item/weapon
	else
		verbs -= /obj/item/storage/verb/toggle_gathering_mode // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	close_all()
	clear_slot_catchers()
	QDEL_NULL(boxes)
...
/obj/item/storage/MouseDrop(obj/over_object as obj) // CHOMPEdit - Removal of obj/item/weapon
	if(!canremove)
		return
...
/obj/item/storage/AltClick(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/proc/return_inv() // CHOMPEdit - Removal of obj/item/weapon

	var/list/L = list(  )

	L += src.contents

	for(var/obj/item/storage/S in src) // CHOMPEdit - Removal of obj/item/weapon
		L += S.return_inv()
	for(var/obj/item/gift/G in src) // CHOMPEdit - Removal of obj/item/weapon
		L += G.gift
		if (istype(G.gift, /obj/item/storage)) // CHOMPEdit - Removal of obj/item/weapon
			L += G.gift:return_inv()
	return L

/obj/item/storage/proc/show_to(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/proc/hide_from(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	var/client/C = user.client
...
/obj/item/storage/proc/open(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if (use_sound)
		//CHOMPStation Edit
...
/obj/item/storage/proc/close(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	src.hide_from(user)
	user.s_active = null
	return

/obj/item/storage/proc/close_all() // CHOMPEdit - Removal of obj/item/weapon
	for(var/mob/M in can_see_contents())
		close(M)
		. = 1

/obj/item/storage/proc/can_see_contents() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/proc/create_slot_catchers() // CHOMPEdit - Removal of obj/item/weapon
	clear_slot_catchers()
...
/obj/item/storage/proc/clear_slot_catchers() // CHOMPEdit - Removal of obj/item/weapon
	if(box_catchers)
		for(var/mob/M in is_seeing)
...
/obj/item/storage/proc/orient_objs(tx, ty, mx, my) // CHOMPEdit - Removal of obj/item/weapon
	var/cx = tx
	var/cy = ty
...
/obj/item/storage/proc/slot_orient_objs(var/rows, var/cols, var/list/obj/item/display_contents) // CHOMPEdit - Removal of obj/item/weapon
	var/cx = 4
	var/cy = 2+rows
...
/obj/item/storage/proc/space_orient_objs(var/list/obj/item/display_contents) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/proc/orient2hud(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/proc/can_be_inserted(obj/item/W as obj, stop_messages = 0) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(LAZYLEN(can_hold) && !is_type_in_list(W, can_hold))
		if(!stop_messages)
			if (istype(W, /obj/item/hand_labeler)) // CHOMPEdit - Removal of obj/item/weapon
				return 0
	...
	if(W.w_class >= src.w_class && (istype(W, /obj/item/storage))) // CHOMPEdit - Removal of obj/item/weapon
		if(!stop_messages)
...
/obj/item/storage/proc/handle_item_insertion(obj/item/W as obj, prevent_warning = 0) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/proc/remove_from_storage(obj/item/W as obj, atom/new_location) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(W)) return 0

	if(!stall_removal(W, usr)) // Can sleep here and delay removal for slow storage
		return 0

	if(istype(src, /obj/item/storage/fancy)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/storage/fancy/F = src // CHOMPEdit - Removal of obj/item/weapon
		F.update_icon(1)
...
/obj/item/storage/proc/stall_insertion(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return TRUE

/// Called before removal completes, allowing you to delay or cancel it
/obj/item/storage/proc/stall_removal(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return TRUE

//This proc is called when you want to place an item into the storage item.
/obj/item/storage/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()

	if(isrobot(user))
		return //Robots can't interact with storage items.

	if(istype(W, /obj/item/lightreplacer)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/lightreplacer/LP = W // CHOMPEdit - Removal of obj/item/device
		var/amt_inserted = 0
		var/turf/T = get_turf(user)
		for(var/obj/item/light/L in src.contents) // CHOMPEdit - Removal of obj/item/weapon
			if(L.status == 0)
	...
	if(istype(W, /obj/item/tray)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/tray/T = W // CHOMPEdit - Removal of obj/item/weapon
		if(T.calc_carry() > 0)
			if(prob(85))
...
/obj/item/storage/dropped(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/storage/attack_hand(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/proc/gather_all(turf/T as turf, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/verb/toggle_gathering_mode() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/verb/quick_empty() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/proc/drop_contents() // why is this a proc? literally just for RPEDs // CHOMPEdit - Removal of obj/item/weapon
	hide_from(usr)
	var/turf/T = get_turf(src)
	for(var/obj/item/I in contents)
		remove_from_storage(I, T)

/obj/item/storage/proc/calibrate_size() // CHOMPEdit - Removal of obj/item/weapon
	var/total_storage_space = 0
	for(var/obj/item/I in contents)
		total_storage_space += I.get_storage_cost()
	max_storage_space = max(total_storage_space,max_storage_space) //Prevents spawned containers from being too small for their contents.

/obj/item/storage/emp_act(severity) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(src.loc, /mob/living))
		for(var/obj/O in contents)
			O.emp_act(severity)
	..()

/obj/item/storage/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if((user.get_active_hand() == src) || (isrobot(user)) && allow_quick_empty)
		if(src.verbs.Find(/obj/item/storage/verb/quick_empty)) // CHOMPEdit - Removal of obj/item/weapon
			src.quick_empty()
			return 1
...
/atom/proc/storage_depth(atom/container)
	...
	while (cur_atom && !(cur_atom in container.contents))
		...
		if (istype(cur_atom.loc, /obj/item/storage)) // CHOMPEdit - Removal of obj/item/weapon
			depth++
...
/obj/item/storage/proc/make_exact_fit() // CHOMPEdit - Removal of obj/item/weapon
 ...
 */
/obj/item/storage/trinketbox // CHOMPEdit - Removal of obj/item/weapon
	name = "trinket box"
...
/obj/item/storage/trinketbox/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	cut_overlays()
	if(open)
		...
		if(contents.len >= 1)
			...
			else if(istype(contents[1], /obj/item/coin)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/trinketbox/New() // CHOMPEdit - Removal of obj/item/weapon
	if(!open_state)
...
/obj/item/storage/trinketbox/attack_self() // CHOMPEdit - Removal of obj/item/weapon
	open = !open
	update_icon()
	..()

/obj/item/storage/trinketbox/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(open && contents.len)
		var/display_item = contents[1]
		. += "<span class='notice'>\The [src] contains \the [display_item]!</span>"

/obj/item/storage/AllowDrop() // CHOMPEdit - Removal of obj/item/weapon
	return TRUE

//Useful for spilling the contents of containers all over the floor
/obj/item/storage/proc/spill(var/dist = 2, var/turf/T = null) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/MouseDrop_T(mob/living/target, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/holder/D = new/obj/item/holder // CHOMPEdit - Removal of obj/item/weapon
	if(ismouse(user))
	...
	var/obj/item/holder/H = new user.holder_type(get_turf(user), user) // CHOMPEdit - Removal of obj/item/weapon
