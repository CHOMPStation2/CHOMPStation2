...
/obj/item/storage/bible/attack_self(mob/living/carbon/human/user) // CHOMPEdit - Removal of obj/item/weapon
...
/**
  ...
  */
/obj/item/storage/bible/proc/check_menu(mob/living/carbon/human/user) // CHOMPEdit - Removal of obj/item/weapon
	if(user.mind.my_religion.configured)
		return FALSE
	if(!istype(user))
		return FALSE
...
/obj/item/storage/bible/booze // CHOMPEdit - Removal of obj/item/weapon
	name = "bible"
	desc = "To be applied to the head repeatedly."
	icon_state ="bible"

/obj/item/storage/bible/booze/New() // CHOMPEdit - Removal of obj/item/weapon
	starts_with = list(
...
/obj/item/storage/bible/afterattack(atom/A, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!proximity) return
...
/obj/item/storage/bible/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if (src.use_sound)
