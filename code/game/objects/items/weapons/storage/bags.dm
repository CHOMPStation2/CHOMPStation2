...
//          Generic non-item
// -----------------------------
/obj/item/storage/bag // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/bag/trash // CHOMPEdit - Removal of obj/item/weapon
	...
	can_hold = list() // any
	cant_hold = list(/obj/item/disk/nuclear) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/storage/bag/trash/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(contents.len == 0)
		icon_state = "trashbag0"
...
/obj/item/storage/bag/trash/holding // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/bag/trash/holding/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	return

// -----------------------------
//        Plastic Bag
// -----------------------------
/obj/item/storage/bag/plasticbag // CHOMPEdit - Removal of obj/item/weapon
	name = "plastic bag"
...
/obj/item/storage/bag/ore // CHOMPEdit - Removal of obj/item/weapon
	...
	max_w_class = ITEMSIZE_NORMAL
	can_hold = list(/obj/item/ore) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/bag/ore/holding // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/bag/ore/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	...
	if (istype(W, /obj/item/ore)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/ore/ore = W // CHOMPEdit - Removal of obj/item/weapon
		stored_ore[ore.material]++
		current_capacity++
		user.remove_from_mob(W)
		qdel(ore)

/obj/item/storage/bag/ore/remove_from_storage(obj/item/W as obj, atom/new_location) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/bag/ore/gather_all(turf/T as turf, mob/user as mob, var/silent = 0) // CHOMPEdit - Removal of obj/item/weapon
	var/success = 0
	var/failure = 0
	var/current_pickup = 0
	var/max_pickup_reached = 0
	for(var/obj/item/ore/O in T) //Only ever grabs ores. Doesn't do any extraneous checks, as all ore is the same size. Tons of checks means it causes hanging for up to three seconds. // CHOMPEdit - Removal of obj/item/weapon
		if(current_capacity >= max_storage_space)
			failure = 1
			break
...
/obj/item/storage/bag/ore/equipped(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(user.get_inventory_slot(src) == slot_wear_suit || slot_l_hand || slot_l_hand || slot_belt) //Basically every place they can go. Makes sure it doesn't unregister if moved to other slots.
		...
		RegisterSignal(user, COMSIG_OBSERVER_MOVED, /obj/item/storage/bag/ore/proc/autoload, user, override = TRUE) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/storage/bag/ore/dropped(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/storage/bag/ore/proc/autoload(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/ore/O = locate() in get_turf(src) // CHOMPEdit - Removal of obj/item/weapon
	if(O)
		gather_all(get_turf(src), user)

/obj/item/storage/bag/ore/proc/rangedload(atom/A, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/ore/O = locate() in get_turf(A) // CHOMPEdit - Removal of obj/item/weapon
	if(O)
		gather_all(get_turf(A), user)

/obj/item/storage/bag/ore/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/storage/bag/ore/open(mob/user as mob) //No opening it for the weird UI of having shit-tons of ore inside it. // CHOMPEdit - Removal of obj/item/weapon
	user.examinate(src)
...
/obj/item/storage/bag/plants // CHOMPEdit - Removal of obj/item/weapon
	...
	can_hold = list(/obj/item/reagent_containers/food/snacks/grown,/obj/item/seeds,/obj/item/grown) // CHOMPEdit - Removal of obj/item/weapon

/obj/item/storage/bag/plants/large // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/bag/sheetsnatcher/can_be_inserted(obj/item/W as obj, stop_messages = 0) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/bag/sheetsnatcher/handle_item_insertion(obj/item/W as obj, prevent_warning = 0) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/bag/sheetsnatcher/orient2hud(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/bag/sheetsnatcher/quick_empty() // CHOMPEdit - Removal of obj/item/weapon
...
// Instead of removing
/obj/item/storage/bag/sheetsnatcher/remove_from_storage(obj/item/W as obj, atom/new_location) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/stack/material/S = W
	if(!istype(S)) return 0
...
/obj/item/storage/bag/sheetsnatcher/borg // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/storage/bag/cash // CHOMPEdit - Removal of obj/item/weapon
	...
	max_w_class = ITEMSIZE_NORMAL
	w_class = ITEMSIZE_SMALL
	can_hold = list(/obj/item/coin,/obj/item/spacecash,/obj/item/spacecasinocash) // CHOMPEdit - Removal of obj/item/weapon

// -----------------------------
//         Chemistry Bag
// -----------------------------
/obj/item/storage/bag/chemistry // CHOMPEdit - Removal of obj/item/weapon
	name = "chemistry bag"
	...
	w_class = ITEMSIZE_LARGE
	slowdown = 3
	can_hold = list(/obj/item/reagent_containers/pill,/obj/item/reagent_containers/glass/beaker,/obj/item/reagent_containers/glass/bottle, /obj/item/reagent_containers/hypospray/autoinjector/) // CHOMPEdit - Adds autoinjectors to the bag // CHOMPEdit - Removal of obj/item/weapon

// -----------------------------
//           Xeno Bag
// -----------------------------
/obj/item/storage/bag/xeno // CHOMPEdit - Removal of obj/item/weapon
	...
	max_w_class = ITEMSIZE_NORMAL
	w_class = ITEMSIZE_SMALL
	can_hold = list(/obj/item/slime_extract,/obj/item/slimepotion, /obj/item/reagent_containers/food/snacks/monkeycube) // CHOMPEdit - Removal of obj/item/weapon

// -----------------------------
//         Virology Bag
// -----------------------------
/obj/item/storage/bag/virology // CHOMPEdit - Removal of obj/item/weapon
	name = "virology bag"
	icon = 'icons/obj/storage_vr.dmi'
	icon_state = "biobag"
	...
	max_w_class = ITEMSIZE_NORMAL
	w_class = ITEMSIZE_SMALL
	can_hold = list(/obj/item/reagent_containers/glass/beaker/vial/,/obj/item/virusdish/) // CHOMPEdit - Removal of obj/item/weapon

// -----------------------------
//           Food Bag
// -----------------------------
/obj/item/storage/bag/food // CHOMPEdit - Removal of obj/item/weapon
	name = "food bag"
	icon = 'icons/obj/storage_vr.dmi'
	icon_state = "foodbag"
	...
	max_w_class = ITEMSIZE_NORMAL
	w_class = ITEMSIZE_SMALL
	can_hold = list(/obj/item/reagent_containers/food/snacks,/obj/item/reagent_containers/food/condiment) // CHOMPEdit - Removal of obj/item/weapon

// -----------------------------
//    Food Bag (Service Hound)
// -----------------------------
/obj/item/storage/bag/serviceborg // CHOMPEdit - Removal of obj/item/weapon
	name = "service bag"
	icon = 'icons/obj/storage_vr.dmi'
	icon_state = "foodbag"
	...
	w_class = ITEMSIZE_SMALL
	can_hold = list(/obj/item/reagent_containers/food/snacks,/obj/item/reagent_containers/food/condiment, // CHOMPEdit - Removal of obj/item/weapon
	/obj/item/reagent_containers/glass/beaker,/obj/item/reagent_containers/glass/bottle,/obj/item/coin,/obj/item/spacecash, // CHOMPEdit - Removal of obj/item/weapon
	/obj/item/reagent_containers/food/snacks/grown,/obj/item/seeds,/obj/item/grown,/obj/item/reagent_containers/pill) // CHOMPEdit - Removal of obj/item/weapon

// -----------------------------
//           Evidence Bag
// -----------------------------
/obj/item/storage/bag/detective // CHOMPEdit - Removal of obj/item/weapon
	name = "secure satchel"
	icon = 'icons/obj/storage_vr.dmi'
	icon_state = "detbag"
	...
	max_w_class = ITEMSIZE_NORMAL
	w_class = ITEMSIZE_SMALL
	can_hold = list(/obj/item/forensics/swab,/obj/item/sample/print,/obj/item/sample/fibers,/obj/item/evidencebag) // CHOMPEdit - Removal of obj/item/weapon
