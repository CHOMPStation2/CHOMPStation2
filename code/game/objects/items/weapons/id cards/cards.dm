...
/obj/item/card/New() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	reset_icon()

/obj/item/card/proc/reset_icon() // CHOMPEdit - Removal of obj/item/weapon
	sprite_stack = initial_sprite_stack
	update_icon()

/obj/item/card/update_icon() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/card/data // CHOMPEdit - Removal of obj/item/weapon
	name = "data card"
...
/obj/item/card/data/verb/label(t as text) // CHOMPEdit - Removal of obj/item/weapon
	set name = "Label Card"
	set category = "Object"
	set src in usr
...
/obj/item/card/data/clown // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/card/emag/resolve_attackby(atom/A, mob/user, var/click_parameters) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(uses<1)
		...
		user.drop_item()
		var/obj/item/card/emag_broken/junk = new(user.loc) // CHOMPEdit - Removal of obj/item/weapon
		junk.add_fingerprint(user)
		qdel(src)

	return 1

/obj/item/card/emag/attackby(obj/item/O as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/card/emag/borg // CHOMPEdit - Removal of obj/item/weapon
	uses = 12
	var/burnt_out = FALSE

/obj/item/card/emag/borg/afterattack(atom/A, mob/user, proximity, var/click_parameters) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/card_fluff/proc/reset_icon() // CHOMPEdit - Removal of obj/item/weapon
	sprite_stack = list("")
	update_icon()

/obj/item/card_fluff/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(!sprite_stack || !istype(sprite_stack) || sprite_stack == list(""))
		icon = base_icon
		icon_state = initial(icon_state)
...
/obj/item/card_fluff/attack_self() // CHOMPEdit - Removal of obj/item/weapon
