...
/obj/item/locator/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/locator/Topic(href, href_list) // CHOMPEdit - Removal of obj/item/weapon
	..()
	...
	if ((usr.contents.Find(src) || (in_range(src, usr) && istype(src.loc, /turf))))
		...
		if (href_list["refresh"])
			...
			if (sr)
				...
				for(var/obj/item/radio/beacon/W in GLOB.all_beacons) // CHOMPEdit - Removal of obj/item/device
				...
				for (var/obj/item/implant/tracking/W in GLOB.all_tracking_implants) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/hand_tele/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
