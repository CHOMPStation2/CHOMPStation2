/obj/item/pai_cable/proc/plugin(obj/machinery/M as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/pai_cable/attack(obj/machinery/M as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	src.plugin(M, user)
