...
/obj/item/material/twohanded/sledgehammer  // a SLEGDGEHAMMER // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/twohanded/sledgehammer/update_held_icon() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/twohanded/sledgehammer/afterattack(atom/A as mob|obj|turf|area, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!proximity) return
	..()
	if(A && wielded)
...
/obj/item/material/twohanded/sledgehammer/pre_attack(var/mob/living/target, var/mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(target))
		cleave(user, target)

/obj/item/material/twohanded/sledgehammer/mjollnir // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/twohanded/sledgehammer/mjollnir/afterattack(mob/living/G, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/material/twohanded/sledgehammer/mjollnir/update_icon()  //Currently only here to fuck with the on-mob icons. // CHOMPEdit - Removal of obj/item/weapon
