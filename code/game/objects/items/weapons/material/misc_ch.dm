...
/obj/item/material/butterfly/saw //This Saw Cleaver is in here since I do not know where else to put it // CHOMPEdit - Removal of obj/item/weapon
	name = "Saw Cleaver"
...
/obj/item/material/butterfly/saw/update_force() // CHOMPEdit - Removal of obj/item/weapon
	if(active)
