...
/obj/item/material/shard/set_material(var/new_material) // CHOMPEdit - Removal of obj/item/weapon
	..(new_material)
	if(!istype(material))
		return
...
/obj/item/material/shard/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(material)
...
/obj/item/material/shard/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/shard/afterattack(var/atom/target, mob/living/carbon/human/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!proximity)
		return
...
/obj/item/material/shard/Crossed(atom/movable/AM as mob|obj) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/material/shard/shrapnel/New(loc) // CHOMPEdit - Removal of obj/item/weapon
	..(loc, "steel")

/obj/item/material/shard/phoron/New(loc) // CHOMPEdit - Removal of obj/item/weapon
