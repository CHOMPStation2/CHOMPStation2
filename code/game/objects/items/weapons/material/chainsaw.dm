/obj/item/chainsaw // CHOMPEdit - Removal of obj/item/weapon
	name = "chainsaw"
	desc = "Vroom vroom."
...
/obj/item/chainsaw/Initialize() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/chainsaw/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	STOP_PROCESSING(SSobj, src)
	if(reagents)
		qdel(reagents)
	..()

/obj/item/chainsaw/proc/turnOn(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(on) return
...
/obj/item/chainsaw/proc/turnOff(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!on) return
...
/obj/item/chainsaw/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!on)
		turnOn(user)
	else
		turnOff(user)

/obj/item/chainsaw/afterattack(atom/A as mob|obj|turf|area, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!proximity) return
	..()
	if(on)
...
/obj/item/chainsaw/process() // CHOMPEdit - Removal of obj/item/weapon
	if(!on) return
...
/obj/item/chainsaw/proc/get_fuel() // CHOMPEdit - Removal of obj/item/weapon
	return reagents.get_reagent_amount("fuel")

/obj/item/chainsaw/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/chainsaw/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(on)
