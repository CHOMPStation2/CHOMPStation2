/obj/item/material/kitchen // CHOMPEdit - Removal of obj/item/weapon
	icon = 'icons/obj/kitchen.dmi'

/*
 * Utensils
 */
/obj/item/material/kitchen/utensil // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/kitchen/utensil/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if (prob(60))
		src.pixel_y = rand(0, 4)
	create_reagents(scoop_volume)

/obj/item/material/kitchen/utensil/Destroy() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/kitchen/utensil/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	cut_overlays()
	if(loaded)
...
/obj/item/material/kitchen/utensil/proc/load_food(var/mob/user, var/obj/item/reagent_containers/food/snacks/loading) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/kitchen/utensil/attack(mob/living/carbon/M as mob, mob/living/carbon/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(M))
		return ..()
...
/obj/item/material/kitchen/utensil/on_rag_wipe() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(reagents.total_volume > 0)
...
/obj/item/material/kitchen/utensil/container_resist(mob/living/M) // CHOMPEdit - Removal of obj/item/weapon
	if(food_inserted_micros)
		food_inserted_micros -= M
...
/obj/item/material/kitchen/utensil/fork/plastic // CHOMPEdit - Removal of obj/item/weapon
	default_material = "plastic"

/obj/item/material/kitchen/utensil/foon // CHOMPEdit - Removal of obj/item/weapon
	name = "foon"
...
/obj/item/material/kitchen/utensil/foon/plastic // CHOMPEdit - Removal of obj/item/weapon
	default_material = "plastic"

/obj/item/material/kitchen/utensil/spork // CHOMPEdit - Removal of obj/item/weapon
	name = "spork"
...
/obj/item/material/kitchen/utensil/spork/plastic // CHOMPEdit - Removal of obj/item/weapon
	default_material = "plastic"

/obj/item/material/kitchen/utensil/spoon // CHOMPEdit - Removal of obj/item/weapon
	name = "spoon"
...
/obj/item/material/knife/attack(target as mob, mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if ((CLUMSY in user.mutations) && prob(50))
...
/obj/item/material/kitchen/rollingpin // CHOMPEdit - Removal of obj/item/weapon
	name = "rolling pin"
...
/obj/item/material/kitchen/rollingpin/attack(mob/living/M as mob, mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if ((CLUMSY in user.mutations) && prob(50))
