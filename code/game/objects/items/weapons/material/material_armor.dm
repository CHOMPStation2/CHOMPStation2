...
/obj/item/clothing/proc/shatter()
	...
	if(istype(loc, /mob/living))
		...
		if(material.shard_type == SHARD_SHARD) // Wearing glass armor is a bad idea.
			var/obj/item/material/shard/S = material.place_shard(T) // CHOMPEdit - Removal of obj/item/weapon
			M.embed(S)
...
/obj/item/material/armor_plating // CHOMPEdit - Removal of obj/item/weapon
	name = "armor plating"
...
/obj/item/material/armor_plating/insert // CHOMPEdit - Removal of obj/item/weapon
	unbreakable = FALSE
	name = "plate insert"
	desc = "used to craft armor plates for a plate carrier. Trim with a welder for light armor or add a second for heavy armor"

/obj/item/material/armor_plating/attackby(var/obj/O, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(O, /obj/item/stack/cable_coil))
		...
		if(S.use(20))
			...
			return
	if(istype(O, /obj/item/material/armor_plating)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/material/armor_plating/second_plate = O // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/armor_plating/insert/attackby(var/obj/item/O, mob/user) // CHOMPEdit - Removal of obj/item/weapon

	. = ..()

	if(O.has_tool_quality(TOOL_WELDER))
		var /obj/item/weldingtool/S = O.get_welder() // CHOMPEdit - Removal of obj/item/weapon
	...
	if(istype(O, /obj/item/material/armor_plating/insert)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/material/armor_plating/insert/second_plate = O // CHOMPEdit - Removal of obj/item/weapon
		if(second_plate.material != src.material)
			to_chat(user, "<span class='warning'>Both plates need to be the same type of material.</span>")
			return
	...
	if(istype(O, /obj/item/tool/wirecutters)) // CHOMPEdit - Removal of obj/item/weapon
