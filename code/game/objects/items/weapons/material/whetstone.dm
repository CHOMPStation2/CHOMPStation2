...
/obj/item/whetstone // CHOMPEdit - Removal of obj/item/weapon
	name = "whetstone"
...
/obj/item/whetstone/attackby(obj/item/I, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(I, /obj/item/stack/material))
		...
		if(M.get_amount() >= 5)
			...
			if(do_after(user, 70))
				M.use(5)
				var/obj/item/SK
				SK = new /obj/item/material/sharpeningkit(get_turf(user), M.material.name) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/sharpeningkit // CHOMPEdit - Removal of obj/item/weapon
	name = "sharpening kit"
...
/obj/item/material/sharpeningkit/examine(mob/user, distance) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	. += "There [uses == 1 ? "is" : "are"] [uses] [material] [uses == 1 ? src.material.sheet_singular_name : src.material.sheet_plural_name] left for use."

/obj/item/material/sharpeningkit/New() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	setrepair()

/obj/item/material/sharpeningkit/proc/setrepair() // CHOMPEdit - Removal of obj/item/weapon
	repair_amount = material.hardness * 0.1
	repair_time = material.weight * 0.5
	sharpen_time = material.weight * 3

/obj/item/material/sharpeningkit/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	...
	if(istype(W, /obj/item/material)) // CHOMPEdit - Removal of obj/item/weapon
		if(istype(W, /obj/item/material/sharpeningkit)) // CHOMPEdit - Removal of obj/item/weapon
			...
			return
		var/obj/item/material/M = W // CHOMPEdit - Removal of obj/item/weapon
		if(uses >= M.w_class*2)
