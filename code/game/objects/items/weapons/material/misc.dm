/obj/item/material/harpoon // CHOMPEdit - Removal of obj/item/weapon
	name = "harpoon"
	sharp = TRUE
	edge = FALSE
...
/obj/item/material/knife/machete/hatchet/stone // CHOMPEdit - Removal of obj/item/weapon
	name = "sharp rock"
...
/obj/item/material/knife/machete/hatchet/stone/set_material(var/new_material) // CHOMPEdit - Removal of obj/item/weapon
	var/old_name = name
	. = ..()
	name = old_name
*/
/obj/item/material/knife/machete/hatchet/unathiknife // CHOMPEdit - Removal of obj/item/weapon
	name = "duelling knife"
...
/obj/item/material/knife/machete/hatchet/unathiknife/attack(mob/M as mob, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(hits > 0)
		return
	var/obj/item/I = user.get_inactive_hand()
	if(istype(I, /obj/item/material/knife/machete/hatchet/unathiknife)) // CHOMPEdit - Removal of obj/item/weapon
		hits ++
		var/obj/item/W = I // CHOMPEdit - Removal of obj/item/weapon
		W.attack(M, user)
		W.afterattack(M, user)
	..()

/obj/item/material/knife/machete/hatchet/unathiknife/afterattack(mob/M as mob, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	hits = initial(hits)
	..()

/obj/item/material/minihoe // -- Numbers // CHOMPEdit - Removal of obj/item/weapon
	name = "mini hoe"
...
/obj/item/material/snow/snowball // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/snow/snowball/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(user.a_intent == I_HURT)
		...
		if(do_after(user, 2 SECONDS))
			var/atom/S = new /obj/item/material/snow/snowball/reinforced(user.loc) // CHOMPEdit - Removal of obj/item/weapon
			qdel(src)
			user.put_in_hands(S)

/obj/item/material/snow/snowball/reinforced // CHOMPEdit - Removal of obj/item/weapon
	name = "snowball"
...
/obj/item/material/whip // CHOMPEdit - Removal of obj/item/weapon
	name = "whip"
...
/obj/item/material/whip/afterattack(atom/A as mob|obj|turf|area, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/material/whip/apply_hit_effect(mob/living/target, mob/living/user, var/hit_zone) // CHOMPEdit - Removal of obj/item/weapon
	if(user.a_intent)
...
/obj/item/material/whip/proc/ranged_disarm(var/mob/living/carbon/human/H, var/mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(H))
		...
		if(user.zone_sel in list(BP_L_ARM, BP_R_ARM, BP_L_HAND, BP_R_HAND))
			for(var/obj/item/gun/W in holding) // CHOMPEdit - Removal of obj/item/weapon
				if(W && prob(holding[W]))
					var/list/turfs = list()
...
/obj/item/material/whip/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/knife/machete/hatchet/stone/bone // CHOMPEdit - Removal of obj/item/weapon
