...
/obj/item/pipe_dispenser // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/tool/wrench/tool // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/pipe_dispenser/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	src.spark_system = new /datum/effect/effect/system/spark_spread
	spark_system.set_up(5, 0, src)
	spark_system.attach(src)
	tool = new /obj/item/tool/wrench/cyborg(src) // RPDs have wrenches inside of them, so that they can wrench down spawned pipes without being used as superior wrenches themselves. // CHOMPEdit - Removal of obj/item/weapon

/obj/item/pipe_dispenser/proc/SetupPipes() // CHOMPEdit - Removal of obj/item/weapon
	if(!first_atmos)
...
/obj/item/pipe_dispenser/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	tgui_interact(user)

/obj/item/pipe_dispenser/ui_assets(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return list(
		get_asset_datum(/datum/asset/spritesheet/pipes),
	)

/obj/item/pipe_dispenser/tgui_state(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return GLOB.tgui_inventory_state

/obj/item/pipe_dispenser/tgui_interact(mob/user, datum/tgui/ui) // CHOMPEdit - Removal of obj/item/weapon
	SetupPipes()
...
/obj/item/pipe_dispenser/tgui_data(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	var/list/data = list(
		"category" = category,
...
/obj/item/pipe_dispenser/tgui_act(action, params) // CHOMPEdit - Removal of obj/item/weapon
	if(..())
		return TRUE
...
/obj/item/pipe_dispenser/afterattack(atom/A, mob/user as mob, proximity) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/pipe_dispenser/proc/build_effect(var/obj/P, var/time = 1.5) // CHOMPEdit - Removal of obj/item/weapon
	set waitfor = FALSE
...
/obj/item/pipe_dispenser/proc/animate_deletion(var/obj/P, var/time = 1.5) // CHOMPEdit - Removal of obj/item/weapon
	set waitfor = FALSE
	P.filters += filter(type = "angular_blur", size = 0)
...
/obj/item/pipe_dispenser/proc/activate() // CHOMPEdit - Removal of obj/item/weapon
	playsound(src, 'sound/items/deconstruct.ogg', 50, 1)

/obj/item/pipe_dispenser/proc/do_wrench(var/atom/target, mob/user) // CHOMPEdit - Removal of obj/item/weapon
