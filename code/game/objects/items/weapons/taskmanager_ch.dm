/obj/item/taskmanager // CHOMPEdit - Removal of obj/item/weapon
	name = "Task Manager"
...
/obj/item/taskmanager/proc/check_menu(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(user))
		return FALSE
...
/obj/item/taskmanager/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	...
	switch(choice)
		if("Bridge")
			...
			scancount = 0
			scanned = list()
			scannables = list(/mob/living/simple_mob/animal/passive/dog/corgi/Ian,/obj/machinery/photocopier,/obj/machinery/papershredder,/obj/item/pen/multi, // CHOMPEdit - Removal of obj/item/weapon
			/obj/structure/filingcabinet/chestdrawer,/obj/item/folder/blue,/obj/item/folder/red,/obj/machinery/computer/communications, // CHOMPEdit - Removal of obj/item/weapon
			/obj/machinery/photocopier/faxmachine,/obj/item/hand_labeler,/obj/item/megaphone,/obj/item/taperecorder,/obj/item/melee/chainofcommand, // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
			/obj/item/hand_tele,/obj/item/stamp/captain,/obj/item/stamp/denied) // CHOMPEdit - Removal of obj/item/weapon
		if("Engineering")
			mode = 2
			scancount = 0
			scanned = list()
			scannables = list(/obj/item/book/manual/supermatter_engine,/obj/machinery/computer/security/engineering,/obj/item/rcd,/obj/item/stamp/ce, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/folder/yellow_ce,/obj/item/clothing/glasses/meson,/obj/item/tape_roll,/obj/machinery/computer/power_monitor,/obj/machinery/computer/rcon, // CHOMPEdit - Removal of obj/item/weapon
		...
		if("Medical")
			...
			scancount = 0
			scanned = list()
			scannables = list(/obj/item/reagent_containers/spray/cleaner,/obj/item/sleevemate,/obj/item/defib_kit/loaded,/obj/item/organ/internal/lungs/erikLungs, // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
			/obj/machinery/reagentgrinder,/obj/machinery/chem_master,/obj/machinery/chemical_dispenser/full,/obj/item/reagent_containers/glass/beaker/large,/obj/item/reagent_containers/glass/beaker, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/mass_spectrometer/adv,/obj/item/storage/firstaid/adv,/obj/item/storage/firstaid/o2,/obj/item/storage/firstaid/toxin, // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
			/obj/item/storage/firstaid/fire,/obj/machinery/vending/medical,/obj/item/roller,/obj/machinery/vending/blood,/obj/machinery/atmospherics/unary/cryo_cell, // CHOMPEdit - Removal of obj/item/weapon
		...
		if("Science")
			...
			/obj/item/storage/box/monkeycubes,/obj/item/gun/energy/taser/xeno,/obj/item/melee/baton/slime/loaded,/obj/item/slime_scanner, // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
			/obj/machinery/processor)
		if("Service")
			mode = 5
			scancount = 0
			scanned = list()
			scannables = list(/obj/machinery/holosign/bar,/obj/item/material/kitchen/utensil/spoon,/obj/item/material/kitchen/utensil/fork, // CHOMPEdit - Removal of obj/item/weapon
		...
		if("Security")
			...
			scancount = 0
			scanned = list()
			scannables = list(/obj/machinery/deployable/barrier,/obj/machinery/flasher/portable,/obj/item/storage/box/flashbangs,/obj/item/taperecorder, // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
			/mob/living/simple_mob/animal/passive/snake/python/noodle,/obj/item/gun/energy/taser,/obj/item/gun/energy/stunrevolver,/obj/item/reagent_containers/spray/pepper, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/storage/box/handcuffs,/obj/item/clothing/glasses/sunglasses/sechud/aviator,/obj/machinery/computer/secure_data,/obj/machinery/computer/security, // CHOMPEdit - Removal of obj/item/weapon
			/obj/item/storage/briefcase/crimekit,/obj/machinery/microscope,/obj/machinery/dnaforensics,/obj/machinery/flasher,/obj/structure/closet/secure_closet/brig, // CHOMPEdit - Removal of obj/item/weapon
			...
			/obj/item/stamp/hos,/obj/structure/closet/secure_closet/security) // CHOMPEdit - Removal of obj/item/weapon
		else
			return
...
/obj/item/taskmanager/afterattack(atom/target, mob/user, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!proximity)
		return
	if(!ready)
	...
	if((target.type in scannables) && scancount < scanreq && !(target.type in scanned))
		...
		return
	if(istype(target,/obj/item/paper) && scancount == scanreq) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/taskmanager/proc/scan_paper(user,paper) // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/paper/P = paper // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/taskmanager/proc/deploy_voucher(var/turf/T) // CHOMPEdit - Removal of obj/item/weapon
	switch(mode)
		if (1)
