/obj/item/book/manual/chemistry_guide // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/book/manual/chemistry_guide/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	dat = {"
				<head>
				<style>
