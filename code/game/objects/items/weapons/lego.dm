...
/obj/item/lego/Crossed(atom/movable/AM as mob|obj) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/lego/gib // CHOMPEdit - Removal of obj/item/weapon
	name = "Lego of Doom"
	throw_speed = 5
	throw_range = 4
	gender = PLURAL
...
/obj/item/lego/gib/Crossed(atom/movable/AM as mob|obj) // CHOMPEdit - Removal of obj/item/weapon
	if(AM.is_incorporeal())
		return
	if(isliving(AM))
		var/mob/living/L = AM
