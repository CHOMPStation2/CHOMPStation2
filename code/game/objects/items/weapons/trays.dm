 ...
 * Trays - Agouri
 */
/obj/item/tray // CHOMPEdit - Removal of obj/item/weapon
	name = "tray"
...
/obj/item/tray/attack(mob/living/carbon/M as mob, mob/living/carbon/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/tray/var/cooldown = 0	//shield bash cooldown. based on world.time // CHOMPEdit - Removal of obj/item/weapon

/obj/item/tray/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
===============~~~~~================================~~~~~====================
*/
/obj/item/tray/proc/calc_carry() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/tray/pickup(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	...
	for(var/obj/item/I in loc)
		if( I != src && !I.anchored && !istype(I, /obj/item/clothing/under) && !istype(I, /obj/item/clothing/suit) && !istype(I, /obj/item/projectile) )
			...
			if(istype(I, /obj/item/material)) // CHOMPEdit - Removal of obj/item/weapon
				var/obj/item/material/O = I // CHOMPEdit - Removal of obj/item/weapon
				if(O.applies_material_colour)
					Img.color = O.color
			add_overlay(Img)

/obj/item/tray/dropped(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	var/noTable = null
