...
/obj/item/autopsy_scanner/proc/add_data(var/obj/item/organ/external/O) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/autopsy_scanner/verb/print_data() // CHOMPEdit - Removal of obj/item/weapon
	set category = "Object"
	...
	var/obj/item/paper/P = new(usr.loc) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/autopsy_scanner/do_surgery(mob/living/carbon/human/M, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(M))
		return 0
