...
/obj/item/tank // CHOMPEdit - Removal of obj/item/weapon
	...
	var/maxintegrity = 20
	var/valve_welded = 0
	var/obj/item/tankassemblyproxy/proxyassembly // CHOMPEdit - Removal of obj/item/device
...
/obj/item/tank/proc/init_proxy() // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/tankassemblyproxy/proxy = new /obj/item/tankassemblyproxy(src) // CHOMPEdit - Removal of obj/item/device
	proxy.tank = src
	src.proxyassembly = proxy


/obj/item/tank/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/tank/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	QDEL_NULL(air_contents)

	STOP_PROCESSING(SSobj, src)
	QDEL_NULL(src.proxyassembly)

	if(istype(loc, /obj/item/transfer_valve)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/transfer_valve/TTV = loc // CHOMPEdit - Removal of obj/item/device
		TTV.remove_tank(src)

	. = ..()

/obj/item/tank/equipped() // Note that even grabbing into a hand calls this, so it should be fine as a 'has a player touched this' // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
...
/obj/item/tank/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(loc == user)
...
/obj/item/tank/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
	...
	if(W.has_tool_quality(TOOL_WIRECUTTER))
		if(wired && src.proxyassembly.assembly)
			...
			if(do_after(user, 100,src))
				...
				var/obj/item/assembly_holder/assy = src.proxyassembly.assembly // CHOMPEdit - Removal of obj/item/device
	...
	if(istype(W, /obj/item/assembly_holder)) // CHOMPEdit - Removal of obj/item/device
		if(wired)
	...
	if(istype(W, /obj/item/weldingtool)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/weldingtool/WT = W // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/tank/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	add_fingerprint(user)
	if (!(src.air_contents))
		return
	tgui_interact(user)
...
/obj/item/tank/tgui_state(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return GLOB.tgui_deep_inventory_state

/obj/item/tank/tgui_interact(mob/user, datum/tgui/ui) // CHOMPEdit - Removal of obj/item/weapon
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "Tank", name)
		ui.open()

/obj/item/tank/tgui_data(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	var/list/data = list()
...
/obj/item/tank/tgui_act(action, params) // CHOMPEdit - Removal of obj/item/weapon
	if(..())
		return TRUE
	switch(action)
		if("pressure")
...
/obj/item/tank/proc/toggle_valve(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/tank/remove_air(amount) // CHOMPEdit - Removal of obj/item/weapon
	return air_contents.remove(amount)

/obj/item/tank/proc/remove_air_by_flag(flag, amount) // CHOMPEdit - Removal of obj/item/weapon
	return air_contents.remove_by_flag(flag, amount)

/obj/item/tank/return_air() // CHOMPEdit - Removal of obj/item/weapon
	return air_contents

/obj/item/tank/assume_air(datum/gas_mixture/giver) // CHOMPEdit - Removal of obj/item/weapon
	air_contents.merge(giver)

	check_status()
	return 1

/obj/item/tank/proc/remove_air_volume(volume_to_return) // CHOMPEdit - Removal of obj/item/weapon
	if(!air_contents)
		return null
...
/obj/item/tank/process() // CHOMPEdit - Removal of obj/item/weapon
	if(!air_contents)
		return
	//Allow for reactions
...
/obj/item/tank/proc/add_bomb_overlay() // CHOMPEdit - Removal of obj/item/weapon
	if(src.wired)
...
/obj/item/tank/proc/update_gauge() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/tank/proc/check_status() // CHOMPEdit - Removal of obj/item/weapon
	...
	if(pressure > TANK_FRAGMENT_PRESSURE)
		if(integrity <= 7)
			if(!istype(src.loc,/obj/item/transfer_valve)) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/tank/phoron/welded // CHOMPEdit - Removal of obj/item/weapon
	valve_welded = 1
/obj/item/tank/oxygen/welded // CHOMPEdit - Removal of obj/item/weapon
	valve_welded = 1
...
/obj/item/tank/proc/onetankbomb(var/fill = 1) // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/assembly_holder/H = new(src) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/tank/phoron/onetankbomb/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	src.onetankbomb()

/obj/item/tank/oxygen/onetankbomb/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	src.onetankbomb()


/obj/item/tank/phoron/onetankbomb/full/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	src.onetankbomb(2)

/obj/item/tank/oxygen/onetankbomb/full/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	src.onetankbomb(2)

/obj/item/tank/phoron/onetankbomb/small/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	src.onetankbomb(0)

/obj/item/tank/oxygen/onetankbomb/small/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	src.onetankbomb(0)
...
/obj/item/tankassemblyproxy // CHOMPEdit - Removal of obj/item/device
	name = "Tank assembly proxy"
	desc = "Used as a stand in to trigger single tank assemblies... but you shouldn't see this."
	var/obj/item/tank/tank = null // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/assembly_holder/assembly = null // CHOMPEdit - Removal of obj/item/device


/obj/item/tankassemblyproxy/receive_signal()	//This is mainly called by the sensor through sense() to the holder, and from the holder to here. // CHOMPEdit - Removal of obj/item/device
	tank.ignite()	//boom (or not boom if you made shijwtty mix)

/obj/item/tankassemblyproxy/Destroy() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	tank = null
	assembly = null

/obj/item/tank/proc/assemble_bomb(W,user)	//Bomb assembly proc. This turns assembly+tank into a bomb // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/assembly_holder/S = W // CHOMPEdit - Removal of obj/item/device
	var/mob/M = user
...
/obj/item/tank/proc/ignite()	//This happens when a bomb is told to explode // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/tankassemblyproxy/update_icon() // CHOMPEdit - Removal of obj/item/device
	if(assembly)
		tank.update_icon()
...
// CHOMPEdit Start
/obj/item/tankassemblyproxy/HasProximity(turf/T, datum/weakref/WF, old_loc) // CHOMPEdit - Removal of obj/item/device
	SIGNAL_HANDLER
	if(isnull(WF))
		return
...
// CHOMPEdit End
/obj/item/tankassemblyproxy/Moved(old_loc, direction, forced) // CHOMPEdit - Removal of obj/item/device
	if(isturf(old_loc))
