/obj/item/syndie // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/syndie/c4explosive/New() // CHOMPEdit - Removal of obj/item/weapon
	var/K = rand(1,2000)
	K = md5(num2text(K)+name)
	K = copytext(K,1,7)
	desc += "\n You see [K] engraved on \the [src]."
	var/obj/item/flame/lighter/zippo/c4detonator/detonator = new(src.loc) // CHOMPEdit - Removal of obj/item/weapon
	detonator.desc += " You see [K] engraved on the lighter."
	detonator.bomb = src

/obj/item/syndie/c4explosive/proc/detonate() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/syndie/c4explosive/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/flame/lighter/zippo/c4detonator)) // CHOMPEdit - Removal of obj/item/weapon
		var/obj/item/flame/lighter/zippo/c4detonator/D = W // CHOMPEdit - Removal of obj/item/weapon
		D.bomb = src
		return
	..()
...
/obj/item/flame/lighter/zippo/c4detonator // CHOMPEdit - Removal of obj/item/weapon
	var/detonator_mode = 0
	var/obj/item/syndie/c4explosive/bomb // CHOMPEdit - Removal of obj/item/weapon

/obj/item/flame/lighter/zippo/c4detonator/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!detonator_mode)
		..()
...
/obj/item/flame/lighter/zippo/c4detonator/attackby(obj/item/W, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
