...
/obj/item/tool/wrench/cyborg // CHOMPEdit - Removal of obj/item/weapon
	name = "automatic wrench"
	desc = "An advanced robotic wrench. Can be found in industrial synthetic shells."
	usesound = 'sound/items/drill_use.ogg'
	toolspeed = 0.5

/obj/item/tool/wrench/pipe // CHOMPEdit - Removal of obj/item/weapon
	name = "pipe wrench"
...
/obj/item/tool/wrench/hybrid	// Slower and bulkier than normal power tools, but it has the power of reach. If reach even worked half the time. // CHOMPEdit - Removal of obj/item/weapon
	name = "strange wrench"
	desc = "A wrench with many common uses. Can be usually found in your hand."
	icon = 'icons/obj/tools.dmi'
...
/obj/item/tool/wrench/power // CHOMPEdit - Removal of obj/item/weapon
	name = "power wrench"
