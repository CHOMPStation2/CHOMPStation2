...
/obj/item/tool/wirecutters/New() // CHOMPEdit - Removal of obj/item/weapon
	if(random_color)
...
/obj/item/tool/wirecutters/attack(mob/living/carbon/C as mob, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(C) && user.a_intent == I_HELP && (C.handcuffed) && (istype(C.handcuffed, /obj/item/handcuffs/cable))) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/tool/wirecutters/cyborg // CHOMPEdit - Removal of obj/item/weapon
	name = "wirecutters"
	desc = "This cuts wires.  With science."
	usesound = 'sound/items/jaws_cut.ogg'
	toolspeed = 0.5

/obj/item/tool/wirecutters/hybrid // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/tool/wirecutters/power // CHOMPEdit - Removal of obj/item/weapon
	name = "power cutters"
