/obj/item/tool/transforming // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/weldingtool/welder // CHOMPEdit - Removal of obj/item/weapon
	var/weldertype = /obj/item/weldingtool/dummy // CHOMPEdit - Removal of obj/item/weapon

/obj/item/tool/transforming/New(newloc, no_counterpart = TRUE) // CHOMPEdit - Removal of obj/item/weapon
	..(newloc)
	if(TOOL_WELDER in possible_tooltypes)
		welder = new weldertype(src)
	on_tool_switch()

/obj/item/tool/transforming/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	if(welder)
		QDEL_NULL(welder)
	..()

/obj/item/tool/transforming/get_welder() // CHOMPEdit - Removal of obj/item/weapon
	return welder

/obj/item/tool/transforming/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/tool/transforming/proc/on_tool_switch(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return
...
/obj/item/tool/transforming/jawsoflife/on_tool_switch(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/tool/transforming/powerdrill/on_tool_switch(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	switch(possible_tooltypes[current_tooltype])
		if(TOOL_WRENCH)
...
/obj/item/tool/transforming/altevian // CHOMPEdit - Removal of obj/item/weapon
	...
	weldertype = /obj/item/weldingtool/dummy/altevian // CHOMPEdit - Removal of obj/item/weapon

/obj/item/tool/transforming/altevian/on_tool_switch(var/mob/user) // CHOMPEdit - Removal of obj/item/weapon
	switch(possible_tooltypes[current_tooltype])
		if(TOOL_WRENCH)
...
/obj/item/weldingtool/dummy/altevian // CHOMPEdit - Removal of obj/item/weapon
	toolspeed = 0.25