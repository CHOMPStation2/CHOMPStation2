...
/obj/item/shield/handle_shield(mob/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, var/attack_text = "the attack") // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shield/proc/get_block_chance(mob/user, var/damage, atom/damage_source = null, mob/attacker = null) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shield/riot/handle_shield(mob/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, var/attack_text = "the attack") // CHOMPEdit - Removal of obj/item/weapon
	if(user.incapacitated())
		return 0
...
/obj/item/shield/riot/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/melee/baton)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shield/energy/handle_shield(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(!active)
...
/obj/item/shield/energy/get_block_chance(mob/user, var/damage, atom/damage_source = null, mob/attacker = null) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(damage_source, /obj/item/projectile))
		var/obj/item/projectile/P = damage_source
...
/obj/item/shield/energy/attack_self(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shield/energy/update_icon() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shield/energy/AltClick(mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shield/energy/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
