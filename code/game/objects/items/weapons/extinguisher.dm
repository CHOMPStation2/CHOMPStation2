...
/obj/item/extinguisher/Initialize() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/extinguisher/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(get_dist(user, src) == 0)
		. += "[src] has [src.reagents.total_volume] units of foam left!"

/obj/item/extinguisher/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	safety = !safety
	icon_state = "[sprite_name][!safety]"
	desc = "The safety is [safety ? "on" : "off"]."
	to_chat(user, "The safety is [safety ? "on" : "off"].")

/obj/item/extinguisher/proc/propel_object(var/obj/O, mob/user, movementdirection) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/extinguisher/afterattack(var/atom/target, var/mob/user, var/flag) // CHOMPEdit - Removal of obj/item/weapon
