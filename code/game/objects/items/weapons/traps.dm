...
/obj/item/beartrap/proc/can_use(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return (user.IsAdvancedToolUser() && !issilicon(user) && !user.stat && !user.restrained())

/obj/item/beartrap/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/beartrap/attack_hand(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/beartrap/proc/attack_mob(mob/living/L) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/beartrap/Crossed(atom/movable/AM as mob|obj) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/beartrap/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/beartrap/hunting // CHOMPEdit - Removal of obj/item/weapon
	name = "hunting trap"
...
/obj/item/material/barbedwire // CHOMPEdit - Removal of obj/item/weapon
	name = "barbed wire"
	desc = "A coil of wire."
...
/obj/item/material/barbedwire/set_material(var/new_material) // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/material/barbedwire/proc/can_use(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	return (user.IsAdvancedToolUser() && !issilicon(user) && !user.stat && !user.restrained())

/obj/item/material/barbedwire/attack_hand(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/barbedwire/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(!anchored && can_use(user))
		user.visible_message(
			"<span class='danger'>[user] starts to deploy \the [src].</span>",
...
/obj/item/material/barbedwire/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(W))
		return
...
/obj/item/material/barbedwire/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/material/barbedwire/Crossed(atom/movable/AM as mob|obj) // CHOMPEdit - Removal of obj/item/weapon
	if(AM.is_incorporeal())
		return
...
/obj/item/material/barbedwire/proc/shock(mob/user as mob, prb, var/target_zone = BP_TORSO) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/material/barbedwire/proc/attack_mob(mob/living/L) // CHOMPEdit - Removal of obj/item/weapon
	var/target_zone
	if(L.lying)
		target_zone = ran_zone()
	else
...
/obj/item/material/barbedwire/plastic // CHOMPEdit - Removal of obj/item/weapon
	name = "snare wire"
