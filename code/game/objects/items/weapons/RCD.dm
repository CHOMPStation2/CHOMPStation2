...
/obj/item/rcd/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	...
	return ..()
*/
/obj/item/rcd/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	QDEL_NULL(spark_system)
	spark_system = null
	return ..()

/obj/item/rcd/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	. += display_resources()

// Used to show how much stuff (matter units, cell charge, etc) is left inside.
/obj/item/rcd/proc/display_resources() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rcd/proc/consume_resources(amount) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rcd/proc/can_afford(amount) // CHOMPEdit - Removal of obj/item/weapon
	return stored_matter >= amount

/obj/item/rcd/afterattack(atom/A, mob/living/user, proximity) // CHOMPEdit - Removal of obj/item/weapon
	if(!ranged && !proximity)
		return FALSE
	use_rcd(A, user)

// Used to call rcd_act() on the atom hit.
/obj/item/rcd/proc/use_rcd(atom/A, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rcd/loaded/Initialize() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rcd/shipwright/loaded/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	stored_matter = max_stored_matter
	return ..()
...
/obj/item/rcd/advanced/loaded/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	stored_matter = max_stored_matter
	return ..()
...
/obj/item/rcd/electric // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rcd/electric/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	if(make_cell)
		cell = new /obj/item/cell/high(src) // CHOMPEdit - Removal of obj/item/weapon
	return ..()

/obj/item/rcd/electric/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	if(cell)
		QDEL_NULL(cell)
	return ..()

/obj/item/rcd/electric/get_cell() // CHOMPEdit - Removal of obj/item/weapon
	return cell

/obj/item/rcd/electric/can_afford(amount) // This makes it so borgs won't drain their last sliver of charge by mistake, as a bonus. // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/cell/cell = get_cell() // CHOMPEdit - Removal of obj/item/weapon
	if(cell)
		return cell.check_charge(amount * electric_cost_coefficent)
	return FALSE

/obj/item/rcd/electric/consume_resources(amount) // CHOMPEdit - Removal of obj/item/weapon
	if(!can_afford(amount))
		return FALSE
	var/obj/item/cell/cell = get_cell() // CHOMPEdit - Removal of obj/item/weapon
	return cell.checked_use(amount * electric_cost_coefficent)

/obj/item/rcd/electric/display_resources() // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/cell/cell = get_cell() // CHOMPEdit - Removal of obj/item/weapon
	if(cell)
...
/obj/item/rcd/electric/mounted // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rcd/electric/mounted/get_cell() // CHOMPEdit - Removal of obj/item/weapon
	return get_external_power_supply()

/obj/item/rcd/electric/mounted/proc/get_external_power_supply() // CHOMPEdit - Removal of obj/item/weapon
...
// RCDs for borgs.
/obj/item/rcd/electric/mounted/borg // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rcd/electric/mounted/borg/swarm // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rcd/electric/mounted/borg/lesser // CHOMPEdit - Removal of obj/item/weapon
	can_remove_rwalls = FALSE


// RCDs for RIGs.
/obj/item/rcd/electric/mounted/rig // CHOMPEdit - Removal of obj/item/weapon


// RCDs for Mechs.
/obj/item/rcd/electric/mounted/mecha // CHOMPEdit - Removal of obj/item/weapon
	ranged = TRUE
	toolspeed = 0.5


// Infinite use RCD for debugging/adminbuse.
/obj/item/rcd/debug // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/rcd/debug/can_afford(amount) // CHOMPEdit - Removal of obj/item/weapon
	return TRUE

/obj/item/rcd/debug/consume_resources(amount) // CHOMPEdit - Removal of obj/item/weapon
	return TRUE

/obj/item/rcd/debug/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/rcd_ammo)) // CHOMPEdit - Removal of obj/item/weapon
		to_chat(user, span("notice", "\The [src] makes its own material, no need to add more."))
		return FALSE
	return ..()

/obj/item/rcd/debug/display_resources() // CHOMPEdit - Removal of obj/item/weapon
