/obj/item/shield/energy/imperial // CHOMPEdit - Removal of obj/item/weapon
	name = "energy scutum"
...
/obj/item/shield/fluff/wolfgirlshield // CHOMPEdit - Removal of obj/item/weapon
	...
	allowed = list(/obj/item/melee/fluffstuff/wolfgirlsword) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shield/riot/explorer/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(brightness_on)
		if(!isturf(user.loc))
...
/obj/item/shield/riot/explorer/proc/update_flashlight(var/mob/user = null) // CHOMPEdit - Removal of obj/item/weapon
	if(on && !light_applied)
...
/obj/item/shield/riot/explorer/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(on)
...
/obj/item/shield/riot/explorer/attackby(obj/item/W as obj, mob/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(istype(W, /obj/item/material/knife/machete)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shield/riot/explorer/purple/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	if(on)
		icon_state = "explorer_shield_P_lighted"
	else
		icon_state = "explorer_shield_P"

/obj/item/shield/primitive // CHOMPEdit - Removal of obj/item/weapon
