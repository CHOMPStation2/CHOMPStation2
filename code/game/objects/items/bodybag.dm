...
/obj/item/storage/box/bodybags // CHOMPEdit - Removal of obj/item/weapon
	name = "body bags"
...
/obj/structure/closet/body_bag/cryobag
	...
	var/tank_type = /obj/item/tank/stasis/oxygen // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/closet/body_bag/cryobag/attackby(obj/item/W, mob/user)
	if(opened)
		...
		if(istype(W,/obj/item/healthanalyzer)) // CHOMPEdit - Removal of obj/item/device
			var/obj/item/healthanalyzer/analyzer = W // CHOMPEdit - Removal of obj/item/device
			for(var/mob/living/L in contents)
				analyzer.attack(L,user)

		else if(istype(W,/obj/item/reagent_containers/syringe)) // CHOMPEdit - Removal of obj/item/weapon
			if(syringe)
				to_chat(user,"<span class='warning'>\The [src] already has an injector! Remove it first.</span>")
			else
				var/obj/item/reagent_containers/syringe/syringe = W // CHOMPEdit - Removal of obj/item/weapon
