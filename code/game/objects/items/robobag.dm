...
/obj/structure/closet/body_bag/cryobag/robobag
	...
	tank_type = /obj/item/tank/stasis/nitro_cryo // CHOMPEdit - Removal of obj/item/weapon
...
/obj/structure/closet/body_bag/cryobag/robobag/attackby(obj/item/W, mob/user)
	if(opened)
		...
		if(istype(W,/obj/item/robotanalyzer)) // CHOMPEdit - Removal of obj/item/device
			var/obj/item/robotanalyzer/analyzer = W // CHOMPEdit - Removal of obj/item/device
