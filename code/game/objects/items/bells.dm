/obj/item/deskbell // CHOMPEdit - Removal of obj/item/weapon
	name = "desk bell"
...
/obj/item/deskbell/examine(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(broken)
		. += "<b>It looks damaged, the ringer is stuck firmly inside.</b>"

/obj/item/deskbell/attack(mob/target as mob, mob/living/user as mob) // CHOMPEdit - Removal of obj/item/weapon
	if(!broken)
		playsound(src, 'sound/effects/deskbell.ogg', 50, 1)
	..()

/obj/item/deskbell/attack_hand(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/deskbell/proc/ring(mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/deskbell/proc/check_ability(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if (ishuman(user))
...
/obj/item/deskbell/attackby(obj/item/W, mob/user, params) // CHOMPEdit - Removal of obj/item/weapon
	if(!istype(W))
		return
...
/obj/item/deskbell/proc/break_bell(mob/user) // CHOMPEdit - Removal of obj/item/weapon
