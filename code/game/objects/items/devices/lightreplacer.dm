...
/obj/item/lightreplacer/New() // CHOMPEdit - Removal of obj/item/device
	failmsg = "The [name]'s refill light blinks red."
	..()

/obj/item/lightreplacer/examine(mob/user) // CHOMPEdit - Removal of obj/item/device
	. = ..()
	if(get_dist(user, src) <= 2)
		. += "It has [uses] lights remaining."

/obj/item/lightreplacer/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/device
	...
	if(istype(W, /obj/item/storage)) // CHOMPEdit - Removal of obj/item/weapon
		...
		for(var/obj/item/I in S.contents)
			if(istype(I,/obj/item/light)) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/lightreplacer/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/lightreplacer/update_icon() // CHOMPEdit - Removal of obj/item/device
	icon_state = "lightreplacer[emagged]"


/obj/item/lightreplacer/proc/Use(var/mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/lightreplacer/proc/add_uses(var/amount = 1) // CHOMPEdit - Removal of obj/item/device
	uses = min(max(uses + amount, 0), max_uses)


/obj/item/lightreplacer/proc/AddShards(amount = 1) // CHOMPEdit - Removal of obj/item/device
	bulb_shards += amount
...
/obj/item/lightreplacer/proc/Charge(var/mob/user, var/amount = 1) // CHOMPEdit - Removal of obj/item/device
	charge += amount
	if(charge > 6)
		add_uses(1)
		charge = 0

/obj/item/lightreplacer/proc/ReplaceLight(var/obj/machinery/light/target, var/mob/living/U) // CHOMPEdit - Removal of obj/item/device
	...
	if(target.status != LIGHT_OK)
		if(CanUse(U))
			...
			var/obj/item/light/L2 = new target.light_type() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/lightreplacer/emag_act(var/remaining_charges, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	emagged = !emagged
...
/obj/item/lightreplacer/proc/CanUse(var/mob/living/user) // CHOMPEdit - Removal of obj/item/device
