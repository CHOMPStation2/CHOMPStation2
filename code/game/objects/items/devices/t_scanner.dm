...
/obj/item/t_scanner/update_icon() // CHOMPEdit - Removal of obj/item/device
	icon_state = "t-ray[on]"

/obj/item/t_scanner/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
	set_active(!on)

/obj/item/t_scanner/proc/set_active(var/active) // CHOMPEdit - Removal of obj/item/device
	on = active
	if(on)
...
/obj/item/t_scanner/process() // CHOMPEdit - Removal of obj/item/device
	if(!on) return
...
/obj/item/t_scanner/proc/get_overlay(obj/scanned) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/t_scanner/proc/get_scanned_objects(var/scan_dist) // CHOMPEdit - Removal of obj/item/device
	. = list()
...
/obj/item/t_scanner/proc/set_user_client(var/client/new_client) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/t_scanner/dropped(mob/user) // CHOMPEdit - Removal of obj/item/device
	set_user_client(null)
...
/obj/item/t_scanner/advanced // CHOMPEdit - Removal of obj/item/device
