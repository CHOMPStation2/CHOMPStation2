...
//backpack item
/obj/item/defib_kit // CHOMPEdit - Removal of obj/item/device
	name = "defibrillator"
	...
	var/obj/item/shockpaddles/linked/paddles // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/cell/bcell = null // CHOMPEdit - Removal of obj/item/weapon

/obj/item/defib_kit/get_cell() // CHOMPEdit - Removal of obj/item/device
	return bcell

/obj/item/defib_kit/Initialize() //starts without a cell for rnd //ChompEDIT New --> Initialize // CHOMPEdit - Removal of obj/item/device
	..()
	if(ispath(paddles))
...
/obj/item/defib_kit/Destroy() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	QDEL_NULL(paddles)
	QDEL_NULL(bcell)

/obj/item/defib_kit/loaded //starts with a cell // CHOMPEdit - Removal of obj/item/device
	bcell = /obj/item/cell/apc // CHOMPEdit - Removal of obj/item/weapon


/obj/item/defib_kit/update_icon() // CHOMPEdit - Removal of obj/item/device
	cut_overlays()
...
/obj/item/defib_kit/ui_action_click() // CHOMPEdit - Removal of obj/item/device
	toggle_paddles()

/obj/item/defib_kit/attack_hand(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(loc == user)
		toggle_paddles()
	else
		..()

/obj/item/defib_kit/MouseDrop() // CHOMPEdit - Removal of obj/item/device
	if(ismob(src.loc))
		if(!CanMouseDrop(src))
			return
		var/mob/M = src.loc
...
/obj/item/defib_kit/attackby(obj/item/W, mob/user, params) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	if(W == paddles)
...
/obj/item/defib_kit/emag_act(var/remaining_charges, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	if(paddles)
...
/obj/item/defib_kit/verb/toggle_paddles() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/defib_kit/proc/slot_check() // CHOMPEdit - Removal of obj/item/device
	var/mob/M = loc
	if(!istype(M))
...
/obj/item/defib_kit/dropped(mob/user) // CHOMPEdit - Removal of obj/item/device
	..()
...
/obj/item/defib_kit/proc/reattach_paddles(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(!paddles) return
...
/obj/item/defib_kit/compact // CHOMPEdit - Removal of obj/item/device
...
/obj/item/defib_kit/compact/loaded // CHOMPEdit - Removal of obj/item/device
	bcell = /obj/item/cell/high // CHOMPEdit - Removal of obj/item/weapon


/obj/item/defib_kit/compact/combat // CHOMPEdit - Removal of obj/item/device
	name = "combat defibrillator"
	desc = "A belt-equipped blood-red defibrillator that can be rapidly deployed. Does not have the restrictions or safeties of conventional defibrillators and can revive through space suits."
	paddles = /obj/item/shockpaddles/linked/combat // CHOMPEdit - Removal of obj/item/weapon

/obj/item/defib_kit/compact/combat/loaded // CHOMPEdit - Removal of obj/item/device
	bcell = /obj/item/cell/high // CHOMPEdit - Removal of obj/item/weapon

/obj/item/shockpaddles/linked/combat // CHOMPEdit - Removal of obj/item/weapon
	combat = 1
	safety = 0
...
/obj/item/shockpaddles // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/proc/set_cooldown(var/delay) // CHOMPEdit - Removal of obj/item/weapon
	cooldown = 1
	update_icon()
...
/obj/item/shockpaddles/update_held_icon() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/update_icon() // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "defibpaddles[wielded]"
	item_state = "defibpaddles[wielded]"
	if(cooldown)
		icon_state = "defibpaddles[wielded]_cooldown"

/obj/item/shockpaddles/proc/can_use(mob/user, mob/M) // CHOMPEdit - Removal of obj/item/weapon
	if(busy)
		return 0
...
/obj/item/shockpaddles/proc/can_defib(mob/living/carbon/human/H) //This is checked before doing the defib operation // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/proc/can_revive(mob/living/carbon/human/H) //This is checked right before attempting to revive // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/proc/check_contact(mob/living/carbon/human/H) // CHOMPEdit - Removal of obj/item/weapon
	if(!combat)
...
/obj/item/shockpaddles/proc/check_vital_organs(mob/living/carbon/human/H) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/proc/check_blood_level(mob/living/carbon/human/H) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/proc/check_charge(var/charge_amt) // CHOMPEdit - Removal of obj/item/weapon
	return 0

/obj/item/shockpaddles/proc/checked_use(var/charge_amt) // CHOMPEdit - Removal of obj/item/weapon
	return 0

/obj/item/shockpaddles/attack(mob/living/M, mob/living/user, var/target_zone) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/apply_hit_effect(mob/living/target, mob/living/user, var/hit_zone) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/proc/do_revive(mob/living/carbon/human/H, mob/user) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/proc/do_electrocute(mob/living/carbon/human/H, mob/user, var/target_zone) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/proc/make_alive(mob/living/carbon/human/M) //This revives the mob // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/proc/apply_brain_damage(mob/living/carbon/human/H) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/proc/make_announcement(var/message, var/msg_class) // CHOMPEdit - Removal of obj/item/weapon
	audible_message("<b>\The [src]</b> [message]", "\The [src] vibrates slightly.", runemessage = "buzz")

/obj/item/shockpaddles/emag_act(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	if(safety)
		safety = 0
...
/obj/item/shockpaddles/emp_act(severity) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/robot // CHOMPEdit - Removal of obj/item/weapon
	name = "defibrillator paddles"
...
/obj/item/shockpaddles/robot/check_charge(var/charge_amt) // CHOMPEdit - Removal of obj/item/weapon
	if(isrobot(src.loc))
		var/mob/living/silicon/robot/R = src.loc
		return (R.cell && R.cell.check_charge(charge_amt))

/obj/item/shockpaddles/robot/checked_use(var/charge_amt) // CHOMPEdit - Removal of obj/item/weapon
	if(isrobot(src.loc))
		var/mob/living/silicon/robot/R = src.loc
		return (R.cell && R.cell.checked_use(charge_amt))

/obj/item/shockpaddles/robot/combat // CHOMPEdit - Removal of obj/item/weapon
...
*/
/obj/item/shockpaddles/linked // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/defib_kit/base_unit // CHOMPEdit - Removal of obj/item/device

/obj/item/shockpaddles/linked/New(newloc, obj/item/defib_kit/defib) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	base_unit = defib
	..(newloc)

/obj/item/shockpaddles/linked/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	if(base_unit)
...
/obj/item/shockpaddles/linked/dropped(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..() //update twohanding
	if(base_unit)
...
/obj/item/shockpaddles/linked/check_charge(var/charge_amt) // CHOMPEdit - Removal of obj/item/weapon
	return (base_unit.bcell && base_unit.bcell.check_charge(charge_amt))

/obj/item/shockpaddles/linked/checked_use(var/charge_amt) // CHOMPEdit - Removal of obj/item/weapon
	return (base_unit.bcell && base_unit.bcell.checked_use(charge_amt))

/obj/item/shockpaddles/linked/make_announcement(var/message, var/msg_class) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/standalone // CHOMPEdit - Removal of obj/item/weapon
	desc = "A pair of shockpaddles powered by an experimental miniaturized reactor" //Inspired by the advanced e-gun
	var/fail_counter = 0

/obj/item/shockpaddles/standalone/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	if(fail_counter)
		STOP_PROCESSING(SSobj, src)

/obj/item/shockpaddles/standalone/check_charge(var/charge_amt) // CHOMPEdit - Removal of obj/item/weapon
	return 1

/obj/item/shockpaddles/standalone/checked_use(var/charge_amt) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/shockpaddles/standalone/process() // CHOMPEdit - Removal of obj/item/weapon
	if(fail_counter > 0)
		SSradiation.radiate(src, fail_counter--)
	else
		STOP_PROCESSING(SSobj, src)

/obj/item/shockpaddles/standalone/emp_act(severity) // CHOMPEdit - Removal of obj/item/weapon
	..()
	var/new_fail = 0
	switch(severity)
		if(1)
...
/obj/item/shockpaddles/standalone/traitor // CHOMPEdit - Removal of obj/item/weapon
	name = "defibrillator paddles"
...
//FBP Defibs
/obj/item/defib_kit/jumper_kit // CHOMPEdit - Removal of obj/item/device
...
//	item_state = "jumperunit"
	paddles = /obj/item/shockpaddles/linked/jumper // CHOMPEdit - Removal of obj/item/weapon

/obj/item/defib_kit/jumper_kit/loaded // CHOMPEdit - Removal of obj/item/device
	bcell = /obj/item/cell/high // CHOMPEdit - Removal of obj/item/weapon

/obj/item/shockpaddles/linked/jumper // CHOMPEdit - Removal of obj/item/weapon
	name = "jumper cables"
	icon_state = "jumperpaddles"
	item_state = "jumperpaddles"
	use_on_synthetic = 1

/obj/item/shockpaddles/robot/jumper // CHOMPEdit - Removal of obj/item/weapon
	name = "jumper cables"
	desc = "A pair of advanced shockpaddles powered by a robot's internal power cell, able to penetrate thick clothing."
