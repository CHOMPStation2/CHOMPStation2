/obj/item/ticket_printer // CHOMPEdit - Removal of obj/item/device
	name = "ticket printer"
...
/obj/item/ticket_printer/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
	. = ..()
...
/obj/item/ticket_printer/proc/print_a_ticket(mob/user) // CHOMPEdit - Removal of obj/item/device
	...
	var/obj/item/paper/sec_ticket/p = new /obj/item/paper/sec_ticket(our_turf) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/sec_ticket // CHOMPEdit - Removal of obj/item/weapon
	name = "Security Citation"
	desc = "A citation issued by security for some kind of infraction!"
	icon = 'icons/obj/bureaucracy_vr.dmi'
	icon_state = "sec_ticket"

/obj/item/paper/sec_ticket/Initialize(mapload, text, title) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	icon = 'icons/obj/bureaucracy_vr.dmi'
	icon_state = "sec_ticket"

/obj/item/paper/sec_ticket/update_icon() // CHOMPEdit - Removal of obj/item/weapon
		icon = icon
		icon_state = icon_state


/obj/item/ticket_printer/train // CHOMPEdit - Removal of obj/item/device
	name = "permission ticket printer"
	desc = "It prints permit tickets!"
	icon = 'icons/obj/device_vr.dmi'
	icon_state = "train_ticket_printer"

/obj/item/ticket_printer/train/print_a_ticket(mob/user) // CHOMPEdit - Removal of obj/item/device
	...
	var/obj/item/paper/permit_ticket/p = new /obj/item/paper/permit_ticket(our_turf) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/paper/permit_ticket // CHOMPEdit - Removal of obj/item/weapon
	name = "Permit Ticket"
	desc = "A ticket issued to permit someone to do something!"
	icon = 'icons/obj/bureaucracy_vr.dmi'
	icon_state = "permit_ticket"

/obj/item/paper/permit_ticket/Initialize(mapload, text, title) // CHOMPEdit - Removal of obj/item/weapon
	. = ..()
	icon = 'icons/obj/bureaucracy_vr.dmi'
	icon_state = "permit_ticket"

/obj/item/paper/permit_ticket/update_icon() // CHOMPEdit - Removal of obj/item/weapon
		icon = icon
		icon_state = icon_state
