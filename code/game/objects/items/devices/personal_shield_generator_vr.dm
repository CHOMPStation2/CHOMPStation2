...
/obj/item/personal_shield_generator // CHOMPEdit - Removal of obj/item/device
	...
	var/obj/item/gun/energy/gun/generator/active_weapon // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/cell/device/bcell = null // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/personal_shield_generator/get_cell() // CHOMPEdit - Removal of obj/item/device
	return bcell

/obj/item/personal_shield_generator/New() // CHOMPEdit - Removal of obj/item/device
	..()
	if(ispath(bcell))
		bcell = new bcell(src)
	...
	if(has_weapon)
		...
		verbs -= /obj/item/personal_shield_generator/verb/weapon_toggle // CHOMPEdit - Removal of obj/item/device
	STOP_PROCESSING(SSobj, src) //We do this so it doesn't start processing until it's first used.
	update_icon()

/obj/item/personal_shield_generator/Destroy() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	QDEL_NULL(active_weapon)
	QDEL_NULL(bcell)

/obj/item/personal_shield_generator/loaded //starts with a cell // CHOMPEdit - Removal of obj/item/device
	bcell = /obj/item/cell/device/shield_generator/backpack // CHOMPEdit - Removal of obj/item/weapon


/obj/item/personal_shield_generator/update_icon() // CHOMPEdit - Removal of obj/item/device
	if(shield_active)
		icon_state = "shieldpack_basic_on"
	else
		icon_state = "shieldpack_basic"

/obj/item/personal_shield_generator/examine(mob/user) // CHOMPEdit - Removal of obj/item/device
	. = ..()
	if(Adjacent(user))
		if(upgraded)
...
/obj/item/personal_shield_generator/emp_act(severity) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/personal_shield_generator/ui_action_click() // CHOMPEdit - Removal of obj/item/device
	toggle_shield()

/obj/item/personal_shield_generator/attack_hand(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(loc == user)
		toggle_shield()
	else
		..()

/obj/item/personal_shield_generator/AltClick(mob/living/user) // CHOMPEdit - Removal of obj/item/device
	weapon_toggle()

/obj/item/personal_shield_generator/MouseDrop() // CHOMPEdit - Removal of obj/item/device
	if(ismob(src.loc))
		if(!CanMouseDrop(src))
			return
		var/mob/M = src.loc
...
/obj/item/personal_shield_generator/attackby(obj/item/W, mob/user, params) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	if(W == active_weapon)
		reattach_gun(user)
	else if(istype(W, /obj/item/cell)) // CHOMPEdit - Removal of obj/item/weapon
		if(bcell)
			to_chat(user, "<span class='notice'>\The [src] already has a cell.</span>")
		else if(!istype(W, /obj/item/cell/device/weapon)) //Weapon cells only! // CHOMPEdit - Removal of obj/item/weapon
		...
		if(bcell)
			if(istype(bcell, /obj/item/cell/device/shield_generator/parry)) //CHOMPedit: Cannot remove the cell from Parry shields. // CHOMPEdit - Removal of obj/item/weapon
			...
			if(istype(bcell, /obj/item/cell/device/shield_generator)) //No stealing self charging batteries! // CHOMPEdit - Removal of obj/item/weapon
				...
				update_icon()
	else if(istype(W,/obj/item/multitool)) // CHOMPEdit - Removal of obj/item/device
...
/*
/obj/item/personal_shield_generator/emag_act(var/remaining_charges, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	if(active_weapon)
...
/obj/item/personal_shield_generator/verb/toggle_shield() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/personal_shield_generator/verb/weapon_toggle() //Make this work on Alt-Click // CHOMPEdit - Removal of obj/item/device
	set name = "Toggle Gun"
	set category = "Object"
...
/obj/item/personal_shield_generator/process() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/personal_shield_generator/proc/slot_check() // CHOMPEdit - Removal of obj/item/device
	var/mob/M = loc
	if(!istype(M))
...
/obj/item/personal_shield_generator/dropped(mob/user) // CHOMPEdit - Removal of obj/item/device
	..()
...
/obj/item/personal_shield_generator/proc/reattach_gun(mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/gun/energy/gun/generator //The gun attached to the personal shield generator. // CHOMPEdit - Removal of obj/item/weapon
	name = "generator gun"
	...
	var/obj/item/personal_shield_generator/shield_generator //The generator we are linked to! // CHOMPEdit - Removal of obj/item/device
	var/wielded = 0
	var/cooldown = 0
	var/busy = 0

/obj/item/gun/energy/gun/generator/New(newloc, obj/item/personal_shield_generator/shield_gen) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	..(newloc)
	shield_generator = shield_gen
	power_supply = shield_generator.bcell

/* //Unused. Use for large guns.
/obj/item/gun/energy/gun/generator/update_held_icon() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/gun/energy/gun/generator/proc/can_use(mob/user, mob/M) // CHOMPEdit - Removal of obj/item/weapon
	if(busy)
		return 0
...
/*
/obj/item/gun/energy/gun/generator/emp_act(severity) // CHOMPEdit - Removal of obj/item/weapon
	..()
*/

/obj/item/gun/energy/gun/generator/dropped(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	..() //update twohanding
	if(shield_generator)
		shield_generator.reattach_gun(user)

/obj/item/gun/energy/proc/check_charge(var/charge_amt) //In case using any other guns. // CHOMPEdit - Removal of obj/item/weapon
	return 0

/obj/item/gun/energy/proc/checked_use(var/charge_amt) //In case using any other guns. // CHOMPEdit - Removal of obj/item/weapon
	return 0

/obj/item/gun/energy/gun/generator/check_charge(var/charge_amt) // CHOMPEdit - Removal of obj/item/weapon
	return (shield_generator.bcell && shield_generator.bcell.check_charge(charge_amt))

/obj/item/gun/energy/gun/generator/checked_use(var/charge_amt) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/personal_shield_generator/belt // CHOMPEdit - Removal of obj/item/device
	name = "personal shield generator"
	desc = "A personal shield generator."
	icon_state = "shieldpack_basic"
...
/obj/item/personal_shield_generator/belt/loaded // CHOMPEdit - Removal of obj/item/device
	bcell = /obj/item/cell/device/shield_generator // CHOMPEdit - Removal of obj/item/weapon

/obj/item/personal_shield_generator/belt/update_icon() // CHOMPEdit - Removal of obj/item/device
	if(shield_active)
		icon_state = "shieldpack_basic_on"
	else
		icon_state = "shieldpack_basic"

/obj/item/personal_shield_generator/belt/bruteburn //Example of a modified generator. // CHOMPEdit - Removal of obj/item/device
	modifier_type = /datum/modifier/shield_projection/bruteburn
/obj/item/personal_shield_generator/belt/bruteburn/loaded //If mapped in, ONLY put loaded ones down. // CHOMPEdit - Removal of obj/item/device
	bcell = /obj/item/cell/device/shield_generator // CHOMPEdit - Removal of obj/item/weapon

// Mining belts
/obj/item/personal_shield_generator/belt/mining // CHOMPEdit - Removal of obj/item/device
	name = "mining PSG"
...
/obj/item/personal_shield_generator/belt/mining/update_icon() // CHOMPEdit - Removal of obj/item/device
	if(shield_active)
...
/obj/item/personal_shield_generator/belt/mining/attackby(obj/item/W, mob/user, params) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
...
/obj/item/personal_shield_generator/belt/security // CHOMPEdit - Removal of obj/item/device
	name = "security PSG"
	desc = "A personal shield generator designed for security."
	modifier_type = /datum/modifier/shield_projection/security/weak

/obj/item/personal_shield_generator/belt/security/loaded // CHOMPEdit - Removal of obj/item/device
	bcell = /obj/item/cell/device/shield_generator // CHOMPEdit - Removal of obj/item/weapon

/obj/item/personal_shield_generator/belt/security/update_icon() // CHOMPEdit - Removal of obj/item/device
	if(shield_active)
...
/obj/item/personal_shield_generator/belt/adminbus // CHOMPEdit - Removal of obj/item/device
...
/obj/item/personal_shield_generator/belt/parry 	//The 'provides one second of pure immunity to brute/burn/halloss' belt. // CHOMPEdit - Removal of obj/item/device
	...
	shield_active = 0
	bcell = /obj/item/cell/device/shield_generator/parry // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/personal_shield_generator/security // CHOMPEdit - Removal of obj/item/device
	name = "security PSG"
...
/obj/item/personal_shield_generator/security/loaded // CHOMPEdit - Removal of obj/item/device
	bcell = /obj/item/cell/device/shield_generator/backpack // CHOMPEdit - Removal of obj/item/weapon

/obj/item/personal_shield_generator/security/strong // CHOMPEdit - Removal of obj/item/device
	modifier_type = /datum/modifier/shield_projection/security/strong

/obj/item/personal_shield_generator/security/strong/loaded // CHOMPEdit - Removal of obj/item/device
	bcell = /obj/item/cell/device/shield_generator/backpack // CHOMPEdit - Removal of obj/item/weapon

/obj/item/personal_shield_generator/security/update_icon() // CHOMPEdit - Removal of obj/item/device
	if(shield_active)
		icon_state = "shieldpack_security_on"
	else
		icon_state = "shieldpack_security"
...
//Power cells.
/obj/item/cell/device/shield_generator //The base power cell the shield gen comes with. // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/cell/device/shield_generator/backpack //The base power cell the backpack units come with. Double the charge vs the belt. // CHOMPEdit - Removal of obj/item/weapon
	maxcharge = 4800
	charge_amount = 160

/obj/item/cell/device/shield_generator/upgraded //A stronger version of the normal cell. Double the maxcharge, halved charge time. // CHOMPEdit - Removal of obj/item/weapon
	maxcharge = 4800
	charge_amount = 320
	charge_delay = 300

/obj/item/cell/device/shield_generator/parry //The cell for the 'parry' shield gen. // CHOMPEdit - Removal of obj/item/weapon
