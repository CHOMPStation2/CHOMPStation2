...
/obj/item/emergency_beacon/New() // CHOMPEdit - Removal of obj/item/device
	gps = new/obj/item/gps/emergency_beacon(src) // CHOMPEdit - Removal of obj/item/device

/obj/item/gps/emergency_beacon // CHOMPEdit - Removal of obj/item/device
	gps_tag = "EMERGENCY BEACON"

/obj/item/emergency_beacon/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
	var/T = user.loc
	if(!beacon_active)
		if(!isturf(T))
...
/obj/item/emergency_beacon/attack_hand(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(beacon_active)
...
/obj/item/emergency_beacon/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
