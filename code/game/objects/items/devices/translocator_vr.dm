...
/obj/item/perfect_tele // CHOMPEdit - Removal of obj/item/device
	...
	var/cell_type = /obj/item/cell/device/weapon // CHOMPEdit - Removal of obj/item/weapon
	var/obj/item/cell/power_source // CHOMPEdit - Removal of obj/item/weapon
	...
	var/obj/item/perfect_tele_beacon/destination // CHOMPEdit - Removal of obj/item/device
...
/obj/item/perfect_tele/Initialize() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	...
	if(cell_type)
		...
		power_source = new /obj/item/cell/device(src) // CHOMPEdit - Removal of obj/item/weapon
	spk = new(src)
	spk.set_up(5, 0, src)
	spk.attach(src)
...
/obj/item/perfect_tele/Destroy() // CHOMPEdit - Removal of obj/item/device
	// Must clear the beacon's backpointer or we won't GC. Someday maybe do something nicer even.
	for(var/obj/item/perfect_tele_beacon/B in beacons) // CHOMPEdit - Removal of obj/item/device
		B.tele_hand = null
	beacons.Cut()
...
/obj/item/perfect_tele/update_icon() // CHOMPEdit - Removal of obj/item/device
	if(!power_source)
...
/obj/item/perfect_tele/proc/rebuild_radial_images() // CHOMPEdit - Removal of obj/item/device
	radial_images.Cut()
	...
	for(var/bcn in beacons) //Grumble
		...
		var/obj/item/perfect_tele_beacon/beacon = beacons[bcn] // CHOMPEdit - Removal of obj/item/device
...
/obj/item/perfect_tele/attack_hand(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(user.get_inactive_hand() == src)
		unload_ammo(user)
	else
		return ..()

/obj/item/perfect_tele/proc/unload_ammo(mob/user, var/ignore_inactive_hand_check = 0) // CHOMPEdit - Removal of obj/item/device
	if(battery_lock)
...
/obj/item/perfect_tele/proc/check_menu(var/mob/living/user) // CHOMPEdit - Removal of obj/item/device
	if(!istype(user))
		return FALSE
...
/obj/item/perfect_tele/attack_self(mob/user, var/radial_menu_anchor = src) // CHOMPEdit - Removal of obj/item/device
	if(loc_network)
		for(var/obj/item/perfect_tele_beacon/stationary/nb in GLOB.premade_tele_beacons) // CHOMPEdit - Removal of obj/item/device
...
"},"OOC Warning")
	...
	if(!choice)
		...
		var/obj/item/perfect_tele_beacon/nb = new(get_turf(src)) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/perfect_tele/attackby(obj/W, mob/user) // CHOMPEdit - Removal of obj/item/device
	...
	else if(istype(W,/obj/item/perfect_tele_beacon)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/perfect_tele_beacon/tb = W // CHOMPEdit - Removal of obj/item/device
...
/obj/item/perfect_tele/proc/teleport_checks(mob/living/target,mob/living/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/perfect_tele/afterattack(mob/living/target, mob/living/user, proximity, var/ignore_fail_chance = 0) // CHOMPEdit - Removal of obj/item/device
	...
	//And any friends!
	for(var/obj/item/grab/G in target.contents) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/perfect_tele/proc/phase_out(var/mob/M,var/turf/T) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/perfect_tele/proc/phase_in(var/mob/M,var/turf/T) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/perfect_tele_beacon // CHOMPEdit - Removal of obj/item/device
	...
	var/tele_name
	var/obj/item/perfect_tele/tele_hand // CHOMPEdit - Removal of obj/item/device
	var/creator
	var/warned_users = list()
	var/tele_network = null

/obj/item/perfect_tele_beacon/New() // CHOMPEdit - Removal of obj/item/device
	..()
	flags |= NOBLUDGEON

/obj/item/perfect_tele_beacon/Destroy() // CHOMPEdit - Removal of obj/item/device
	tele_name = null
	tele_hand = null
	return ..()

/obj/item/perfect_tele_beacon/attack_hand(mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/perfect_tele_beacon/stationary // CHOMPEdit - Removal of obj/item/device
...
GLOBAL_LIST_BOILERPLATE(premade_tele_beacons, /obj/item/perfect_tele_beacon/stationary) // CHOMPEdit - Removal of obj/item/device

/obj/item/perfect_tele_beacon/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(!isliving(user))
		return
	var/mob/living/L = user
...
/obj/item/perfect_tele/one_beacon // CHOMPEdit - Removal of obj/item/device
	...
	cell_type = /obj/item/cell/device // CHOMPEdit - Removal of obj/item/weapon
	origin_tech = list(TECH_MAGNET = 5, TECH_BLUESPACE = 5)

/*
/obj/item/perfect_tele/one_beacon/teleport_checks(mob/living/target,mob/living/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/perfect_tele/alien // CHOMPEdit - Removal of obj/item/device
	...
	cell_type = /obj/item/cell/device/weapon/recharge/alien // CHOMPEdit - Removal of obj/item/weapon
	charge_cost = 400
	beacons_left = 6
...
/obj/item/perfect_tele/alien/bluefo // CHOMPEdit - Removal of obj/item/device
...
/obj/item/perfect_tele/frontier // CHOMPEdit - Removal of obj/item/device
...
/obj/item/perfect_tele/frontier/unload_ammo(mob/user, var/ignore_inactive_hand_check = 0) // CHOMPEdit - Removal of obj/item/device
	if(recharging)
		return
	recharging = 1
	update_icon()
...
/obj/item/perfect_tele/frontier/update_icon() // CHOMPEdit - Removal of obj/item/device
	if(recharging)
		icon_state = "[initial(icon_state)]_o"
		update_held_icon()
		return
...
/obj/item/perfect_tele/frontier/staff // CHOMPEdit - Removal of obj/item/device
...
/obj/item/perfect_tele/frontier/unknown // CHOMPEdit - Removal of obj/item/device
...
/obj/item/perfect_tele/frontier/unknown/one // CHOMPEdit - Removal of obj/item/device
	loc_network = "unkone"
/obj/item/perfect_tele/frontier/unknown/two // CHOMPEdit - Removal of obj/item/device
	loc_network = "unktwo"
/obj/item/perfect_tele/frontier/unknown/three // CHOMPEdit - Removal of obj/item/device
	loc_network = "unkthree"
/obj/item/perfect_tele/frontier/unknown/four // CHOMPEdit - Removal of obj/item/device
	loc_network = "unkfour"
/obj/item/perfect_tele/frontier/unknown/five // CHOMPEdit - Removal of obj/item/device
	loc_network = "unkfive"
/obj/item/perfect_tele/frontier/unknown/six // CHOMPEdit - Removal of obj/item/device
	loc_network = "unksix"
