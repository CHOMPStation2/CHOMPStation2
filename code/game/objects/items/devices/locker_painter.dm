/obj/item/closet_painter // CHOMPEdit - Removal of obj/item/device
	name = "closet painter"
...
/obj/item/closet_painter/afterattack(atom/A, var/mob/user, proximity) // CHOMPEdit - Removal of obj/item/device
	if(!proximity)
		return
...
/obj/item/closet_painter/attack_self(var/mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/closet_painter/examine(mob/user) // CHOMPEdit - Removal of obj/item/device
	. = ..()
	. += "It is configured to produce the '[colour]' paint scheme or the '[colour_secure]' secure closet paint scheme."

/obj/item/closet_painter/verb/choose_colour() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/closet_painter/verb/choose_colour_secure() // CHOMPEdit - Removal of obj/item/device
