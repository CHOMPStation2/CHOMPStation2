...
/obj/item/flash/Initialize() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	power_supply = new cell_type(src)

/obj/item/flash/attackby(var/obj/item/W, var/mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/flash/update_icon() // CHOMPEdit - Removal of obj/item/device
	var/obj/item/cell/battery = power_supply // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/flash/get_cell() // CHOMPEdit - Removal of obj/item/device
	return power_supply

/obj/item/flash/proc/get_external_power_supply() // CHOMPEdit - Removal of obj/item/device
	if(isrobot(src.loc))
...
/obj/item/flash/proc/clown_check(var/mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/flash/proc/flash_recharge() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/flash/proc/check_capacitor(var/mob/user) // CHOMPEdit - Removal of obj/item/device
...
//attack_as_weapon
/obj/item/flash/attack(mob/living/M, mob/living/user, var/target_zone) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/flash/attack_self(mob/living/carbon/user as mob, flag = 0, emp = 0) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/flash/emp_act(severity) // CHOMPEdit - Removal of obj/item/device
	if(broken)	return
	flash_recharge()
	if(!check_capacitor())
		return
...
/obj/item/flash/synthetic // CHOMPEdit - Removal of obj/item/device
...
//attack_as_weapon
/obj/item/flash/synthetic/attack(mob/living/M, mob/living/user, var/target_zone) // CHOMPEdit - Removal of obj/item/device
	..()
	if(!broken)
		broken = 1
		to_chat(user, "<span class='warning'>The bulb has burnt out!</span>")
...
/obj/item/flash/synthetic/attack_self(mob/living/carbon/user as mob, flag = 0, emp = 0) // CHOMPEdit - Removal of obj/item/device
	..()
	if(!broken)
		broken = 1
		to_chat(user, "<span class='warning'>The bulb has burnt out!</span>")
...
/obj/item/flash/robot // CHOMPEdit - Removal of obj/item/device
	name = "mounted flash"
	can_break = FALSE
