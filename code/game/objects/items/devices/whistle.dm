...
/obj/item/hailer/verb/set_message() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/hailer/attack_self(mob/living/carbon/user as mob) // CHOMPEdit - Removal of obj/item/device
	if (spamcheck)
		return
...
/obj/item/hailer/emag_act(var/remaining_charges, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	if(isnull(insults))
