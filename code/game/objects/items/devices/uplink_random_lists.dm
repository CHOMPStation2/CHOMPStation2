...
/datum/uplink_random_selection/proc/get_random_item(var/telecrystals, obj/item/uplink/U, var/list/bought_items, var/items_override = 0) // CHOMPEdit - Removal of obj/item/device
