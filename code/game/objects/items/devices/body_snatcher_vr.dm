...
/obj/item/bodysnatcher/New() // CHOMPEdit - Removal of obj/item/device
	..()
	flags |= NOBLUDGEON //So borgs don't spark.

/obj/item/bodysnatcher/attack(mob/living/M, mob/living/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/bodysnatcher/attack_self(mob/living/user) // CHOMPEdit - Removal of obj/item/device
		to_chat(user,"<span class='warning'> A message pops up on the LED display, informing you that you that the mind transfer to yourself was successful... Wait, did that even do anything?</span>")
		return
