...
/obj/item/denecrotizer //Away map reward. FOR TRAINED NECROMANCERS ONLY. >:C // CHOMPEdit - Removal of obj/item/device
...
/obj/item/denecrotizer/examine(var/mob/user) // CHOMPEdit - Removal of obj/item/device
	. = ..()
...
/obj/item/denecrotizer/proc/check_target(mob/living/simple_mob/target, mob/living/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/denecrotizer/proc/ghostjoin_rez(mob/living/simple_mob/target, mob/living/user) // CHOMPEdit - Removal of obj/item/device
	user.visible_message("[user] gently presses [src] to [target]...", runemessage = "presses [src] to [target]")
...
/obj/item/denecrotizer/proc/basic_rez(mob/living/simple_mob/target, mob/living/user) //so medical can have a way to bring back people's pets or whatever, does not change any settings about the mob or offer it to ghosts. // CHOMPEdit - Removal of obj/item/device
...
/obj/item/denecrotizer/attack(mob/living/simple_mob/target, mob/living/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/denecrotizer/medical //Can revive more things, but without the special ghost and faction stuff. For medical use. // CHOMPEdit - Removal of obj/item/device
