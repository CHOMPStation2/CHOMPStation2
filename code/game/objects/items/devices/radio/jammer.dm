...
/proc/is_jammed(var/obj/radio)
	...
	for(var/obj/item/radio_jammer/J as anything in active_radio_jammers) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/radio_jammer // CHOMPEdit - Removal of obj/item/device
	...
	var/on = 0
	var/jam_range = 7
	var/obj/item/cell/device/weapon/power_source // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/radio_jammer/New() // CHOMPEdit - Removal of obj/item/device
	power_source = new(src)
	update_icon() // So it starts with the full overlay.

/obj/item/radio_jammer/Destroy() // CHOMPEdit - Removal of obj/item/device
	if(on)
		turn_off()
	QDEL_NULL(power_source)
	return ..()

/obj/item/radio_jammer/get_cell() // CHOMPEdit - Removal of obj/item/device
	return power_source

/obj/item/radio_jammer/proc/turn_off(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(user)
...
/obj/item/radio_jammer/proc/turn_on(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(user)
...
/obj/item/radio_jammer/process() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/radio_jammer/attack_hand(mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/radio_jammer/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(on)
		turn_off(user)
	else
		if(power_source)
...
/obj/item/radio_jammer/attackby(obj/W, mob/user) // CHOMPEdit - Removal of obj/item/device
	if(istype(W,/obj/item/cell/device/weapon) && !power_source) // CHOMPEdit - Removal of obj/item/weapon
		power_source = W
...
/obj/item/radio_jammer/update_icon() // CHOMPEdit - Removal of obj/item/device
	if(on)
