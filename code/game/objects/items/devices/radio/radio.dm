...
/obj/item/device/radio/Initialize()
	...
	if(bluespace_radio)
		if(bs_tx_preload_id)
			...
			for(var/obj/machinery/telecomms/receiver/RX in GLOB.telecomms_list) // CHOMPEdit - Globals
			...
			if(!bs_tx_weakref)
				for(var/obj/machinery/telecomms/allinone/AIO in GLOB.telecomms_list) // CHOMPEdit - Globals
		...
		if(bs_rx_preload_id)
			...
			for(var/obj/machinery/telecomms/broadcaster/TX in GLOB.telecomms_list) // CHOMPEdit - Globals
...
/obj/item/device/radio/talk_into(mob/living/M as mob, list/message_pieces, channel, var/verb = "says")
	...
	*/
	...
	/* ###### Radios with subspace_transmission can only broadcast through subspace (unless they have adhoc_fallback) ###### */
		...
		for(var/obj/machinery/telecomms/allinone/R in GLOB.telecomms_list) // CHOMPEdit - Globals
			R.receive_signal(signal)
