...
/obj/item/communicator/integrated // CHOMPEdit - Removal of obj/item/device
...
/obj/item/communicator/integrated/open_connection_to_ghost(user, candidate) // CHOMPEdit - Removal of obj/item/device
	..(user, candidate)
	spawn(1)
...
/obj/item/communicator/integrated/verb/activate() // CHOMPEdit - Removal of obj/item/device
