...
/obj/item/communicator/proc/add_communicating(obj/item/communicator/comm) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/communicator/proc/del_communicating(obj/item/communicator/comm) // CHOMPEdit - Removal of obj/item/device
	if(!comm || !istype(comm)) return
...
/obj/item/communicator/proc/open_connection(mob/user, var/atom/candidate) // CHOMPEdit - Removal of obj/item/device
	if(isobserver(candidate))
		voice_invites.Remove(candidate)
		open_connection_to_ghost(user, candidate)
	else
		if(istype(candidate, /obj/item/communicator)) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/communicator/proc/open_connection_to_communicator(mob/user, var/atom/candidate) // CHOMPEdit - Removal of obj/item/device
	if(!istype(candidate, /obj/item/communicator)) // CHOMPEdit - Removal of obj/item/device
		return
	var/obj/item/communicator/comm = candidate // CHOMPEdit - Removal of obj/item/device
	voice_invites.Remove(candidate)
...
/obj/item/communicator/proc/open_connection_to_ghost(mob/user, var/mob/candidate) // CHOMPEdit - Removal of obj/item/device
	if(!isobserver(candidate))
		return
...
/obj/item/communicator/proc/close_connection(mob/user, var/atom/target, var/reason) // CHOMPEdit - Removal of obj/item/device
	...
	for(var/obj/item/communicator/comm in communicating) //Now we handle real communicators. // CHOMPEdit - Removal of obj/item/device
...
/obj/item/communicator/proc/request(var/atom/candidate) // CHOMPEdit - Removal of obj/item/device
	if(candidate in voice_requests)
		return
	var/who = null
	if(isobserver(candidate))
		who = candidate.name
	else if(istype(candidate, /obj/item/communicator)) // CHOMPEdit - Removal of obj/item/device
		var/obj/item/communicator/comm = candidate // CHOMPEdit - Removal of obj/item/device
		who = comm.owner
...
/obj/item/communicator/proc/del_request(var/atom/candidate) // CHOMPEdit - Removal of obj/item/device
	if(!(candidate in voice_requests))
		return
...
/obj/item/communicator/see_emote(mob/living/M, text) // CHOMPEdit - Removal of obj/item/device

	for(var/obj/item/communicator/comm in communicating) // CHOMPEdit - Removal of obj/item/device
		var/turf/T = get_turf(comm)
		if(!T) return
		//VOREStation Edit Start for commlinks
		var/list/mobs_to_relay
		if(istype(comm,/obj/item/communicator/commlink)) // CHOMPEdit - Removal of obj/item/device
			var/obj/item/communicator/commlink/CL = comm // CHOMPEdit - Removal of obj/item/device
...
/obj/item/communicator/hear_talk(mob/M, list/message_pieces, verb) // CHOMPEdit - Removal of obj/item/device
	for(var/obj/item/communicator/comm in communicating) // CHOMPEdit - Removal of obj/item/device
		var/turf/T = get_turf(comm)
		if(!T) return
		//VOREStation Edit Start for commlinks
...
/obj/item/communicator/show_message(msg, type, alt, alt_type) // CHOMPEdit - Removal of obj/item/device
...
/mob/observer/dead/verb/join_as_voice()
	...
	if(choice)
		var/obj/item/communicator/chosen_communicator = choice // CHOMPEdit - Removal of obj/item/device
...
/obj/item/communicator/proc/connect_video(mob/user,obj/item/communicator/comm) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/communicator/proc/end_video(var/reason) // CHOMPEdit - Removal of obj/item/device
