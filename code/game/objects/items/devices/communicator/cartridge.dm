...
/obj/item/commcard // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/proc/get_device_status() // CHOMPEdit - Removal of obj/item/weapon
	var/list/L = list()
	var/i = 1
...
/obj/item/commcard/proc/get_data() // CHOMPEdit - Removal of obj/item/weapon
	return list()
...
/obj/item/commcard/Topic(href, href_list) // CHOMPEdit - Removal of obj/item/weapon

	// Signalers
	if(href_list["signaler_target"])

		var/obj/item/assembly/signaler/S = locate(href_list["signaler_target"]) // Should locate the correct signaler // CHOMPEdit - Removal of obj/item/device
	...
	if(href_list["gps_target"])
		var/obj/item/gps/G = locate(href_list["gps_target"]) // CHOMPEdit - Removal of obj/item/device
...
// Copied from /obj/item/cartridge/proc/post_status(), // CHOMPEdit - Removal of obj/item/weapon
// code/game/objects/items/devices/PDA/cart.dm, line 251
/obj/item/commcard/proc/post_status(var/command, var/data1, var/data2) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/receive_signal(var/datum/signal/signal, var/receive_method, var/receive_param) // CHOMPEdit - Removal of obj/item/weapon
...
// Templates
//  *- Power Monitor
/obj/item/commcard/engineering // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper Power-ON cartridge"
	icon_state = "cart-e"
	ui_templates = list(list("name" = "Power Monitor", "template" = "comm_power_monitor.tmpl"))

/obj/item/commcard/engineering/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	internal_devices |= new /obj/item/halogen_counter(src) // CHOMPEdit - Removal of obj/item/device

/obj/item/commcard/engineering/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	internal_data["grid_sensors"] = find_powernet_sensors()
	internal_data["powernet_target"] = ""

/obj/item/commcard/engineering/get_data() // CHOMPEdit - Removal of obj/item/weapon
	return list(
...
// Devices
//  *- Gas scanner
/obj/item/commcard/atmos // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper BreatheDeep cartridge"
	icon_state = "cart-a"

/obj/item/commcard/atmos/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	internal_devices |= new /obj/item/analyzer(src) // CHOMPEdit - Removal of obj/item/device
...
// Templates
//  *- Medical Records
/obj/item/commcard/medical // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper Med-U cartridge"
	icon_state = "cart-m"
	ui_templates = list(list("name" = "Medical Records", "template" = "med_records.tmpl"))

/obj/item/commcard/medical/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	internal_devices |= new /obj/item/healthanalyzer(src) // CHOMPEdit - Removal of obj/item/device
	internal_devices |= new /obj/item/halogen_counter(src) // CHOMPEdit - Removal of obj/item/device

/obj/item/commcard/medical/get_data() // CHOMPEdit - Removal of obj/item/weapon
...
// Templates
//  *- Medical Records
/obj/item/commcard/medical/chemistry // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper ChemWhiz cartridge"
	icon_state = "cart-chem"

/obj/item/commcard/medical/chemistry/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	internal_devices |= new /obj/item/reagent_scanner(src) // CHOMPEdit - Removal of obj/item/device
...
//  *- Medical Records
//  *- Security Records
/obj/item/commcard/medical/detective // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/medical/detective/get_data() // CHOMPEdit - Removal of obj/item/weapon
	var/list/data = ..()
...
//  *- Security Records
//  *- Employment Records
/obj/item/commcard/int_aff // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/int_aff/get_data() // CHOMPEdit - Removal of obj/item/weapon
	return list(
...
//  *- Security Records
//  *- Security Bot Access
/obj/item/commcard/security // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/security/get_data() // CHOMPEdit - Removal of obj/item/weapon
	return list(
			list("field" = "sec_records", "value" = get_sec_records()),
...
/obj/item/commcard/janitor // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/janitor/get_data() // CHOMPEdit - Removal of obj/item/weapon
	return list(
...
// Templates
//  *- Signaler Access
/obj/item/commcard/signal // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/signal/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	internal_devices |= new /obj/item/assembly/signaler(src) // CHOMPEdit - Removal of obj/item/device

/obj/item/commcard/signal/get_data() // CHOMPEdit - Removal of obj/item/weapon
	return list(
...
// Templates
//  *- Signaler Access
/obj/item/commcard/signal/science // CHOMPEdit - Removal of obj/item/weapon
	name = "\improper Signal Ace 2 cartridge"
	desc = "Complete with integrated radio signaler!"
	icon_state = "cart-tox"
	// UI templates inherited

/obj/item/commcard/signal/science/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	internal_devices |= new /obj/item/reagent_scanner(src) // CHOMPEdit - Removal of obj/item/device
	internal_devices |= new /obj/item/analyzer(src) // CHOMPEdit - Removal of obj/item/device
...
// Templates
//  *- Supply Records
/obj/item/commcard/supply // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/supply/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/commcard/supply/get_data() // CHOMPEdit - Removal of obj/item/weapon
	// Supply records data
...
//  *- Employment Records
/obj/item/commcard/head // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/head/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
...
/obj/item/commcard/head/Initialize() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/head/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	// Have to unregister the commcard for proper bookkeeping
	radio_controller.remove_object(src, 1435)
	..()

/obj/item/commcard/head/get_data() // CHOMPEdit - Removal of obj/item/weapon
	return list(
			list("field" = "emp_records", "value" = get_emp_records()),
...
//  ?- Supply Bot Access
//  *- Janitorial Locator Magicbox
/obj/item/commcard/head/hop // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/head/hop/get_data() // CHOMPEdit - Removal of obj/item/weapon
	var/list/data = ..()
...
//  *- Security Records
//  *- Security Bot Access
/obj/item/commcard/head/hos // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/head/hos/get_data() // CHOMPEdit - Removal of obj/item/weapon
	var/list/data = ..()
	// Sec records
	data[++data.len] = list("field" = "sec_records", "value" = get_sec_records())
	// Sec bot access
...
//  *- Employment Records
//  *- Signaler Access
/obj/item/commcard/head/rd // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/head/rd/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	internal_devices |= new /obj/item/analyzer(src) // CHOMPEdit - Removal of obj/item/device
	internal_devices |= new /obj/item/reagent_scanner(src) // CHOMPEdit - Removal of obj/item/device
	internal_devices |= new /obj/item/assembly/signaler(src) // CHOMPEdit - Removal of obj/item/device

/obj/item/commcard/head/rd/get_data() // CHOMPEdit - Removal of obj/item/weapon
	var/list/data = ..()
	// Signaler access
...
//  *- Employment Records
//  *- Medical Records
/obj/item/commcard/head/cmo // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/head/cmo/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	internal_devices |= new /obj/item/healthanalyzer(src) // CHOMPEdit - Removal of obj/item/device
	internal_devices |= new /obj/item/reagent_scanner(src) // CHOMPEdit - Removal of obj/item/device
	internal_devices |= new /obj/item/halogen_counter(src) // CHOMPEdit - Removal of obj/item/device

/obj/item/commcard/head/cmo/get_data() // CHOMPEdit - Removal of obj/item/weapon
	var/list/data = ..()
	// Med records
...
//  *- Employment Records
//  *- Power Monitoring
/obj/item/commcard/head/ce // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/head/ce/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	internal_devices |= new /obj/item/analyzer(src)  // CHOMPEdit - Removal of obj/item/weapon
	internal_devices |= new /obj/item/halogen_counter(src) // CHOMPEdit - Removal of obj/item/device

/obj/item/commcard/head/ce/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	internal_data["grid_sensors"] = find_powernet_sensors()
	internal_data["powernet_target"] = ""

/obj/item/commcard/head/ce/get_data() // CHOMPEdit - Removal of obj/item/weapon
	var/list/data = ..()
...
//  *- Signaler Access
/obj/item/commcard/head/captain // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/head/captain/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	internal_devices |= new /obj/item/analyzer(src)  // CHOMPEdit - Removal of obj/item/weapon
	internal_devices |= new /obj/item/healthanalyzer(src) // CHOMPEdit - Removal of obj/item/device
	internal_devices |= new /obj/item/reagent_scanner(src) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/commcard/head/captain/get_data() // CHOMPEdit - Removal of obj/item/weapon
	var/list/data = ..()
	//Med records
	data[++data.len] = list("field" = "med_records", "value" = get_med_records())
...
/obj/item/commcard/mercenary // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/mercenary/Initialize() // CHOMPEdit - Removal of obj/item/weapon
	internal_data["shuttle_door_code"] = "smindicate" // Copied from PDA code
	internal_data["shuttle_doors"] = find_blast_doors()

/obj/item/commcard/mercenary/get_data() // CHOMPEdit - Removal of obj/item/weapon
	var/door_status[0]
	for(var/obj/machinery/door/blast/B in internal_data["shuttle_doors"])
...
/obj/item/commcard/explorer // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/commcard/explorer/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	internal_devices |= new /obj/item/gps/explorer(src) // CHOMPEdit - Removal of obj/item/device

/obj/item/commcard/explorer/get_data() // CHOMPEdit - Removal of obj/item/weapon
