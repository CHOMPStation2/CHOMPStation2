...
/obj/item/powersink/Destroy() // CHOMPEdit - Removal of obj/item/device
	STOP_PROCESSING(SSobj, src)
	STOP_PROCESSING_POWER_OBJECT(src)
	..()

/obj/item/powersink/attackby(var/obj/item/I, var/mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/powersink/attack_ai() // CHOMPEdit - Removal of obj/item/device
	return

/obj/item/powersink/attack_hand(var/mob/user) // CHOMPEdit - Removal of obj/item/device
	switch(mode)
		if(0)
			..()
		if(1)
...
/obj/item/powersink/pwr_drain() // CHOMPEdit - Removal of obj/item/device
	if(!attached)
		return 0
...
/obj/item/powersink/process() // CHOMPEdit - Removal of obj/item/device
	drained_this_tick = 0
