...
/obj/item/geiger/wall/Destroy() // CHOMPEdit - Removal of obj/item/device
	...
	return ..()
/*
/obj/item/geiger/wall/process() // CHOMPEdit - Removal of obj/item/device
	get_radiation()

/obj/item/geiger/wall/proc/get_radiation() // CHOMPEdit - Removal of obj/item/device
	if(!scanning)
		return
...
/obj/item/geiger/wall/examine(mob/user) // CHOMPEdit - Removal of obj/item/device
	..(user)
	get_radiation()
	to_chat(user, "<span class='warning'>[scanning ? "Ambient" : "Stored"] radiation level: [radiation_count ? radiation_count : "0"]Bq.</span>")

/obj/item/geiger/wall/rad_act(amount) // CHOMPEdit - Removal of obj/item/device
	if(!amount || !scanning)
		return FALSE
