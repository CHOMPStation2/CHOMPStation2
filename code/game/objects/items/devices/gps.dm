...
/obj/item/gps/Initialize() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	compass = new(src)
	GPS_list += src
...
/obj/item/gps/proc/check_visible_to_holder() // CHOMPEdit - Removal of obj/item/device
	. = (holder && (holder.get_active_hand() == src || holder.get_inactive_hand() == src))

/obj/item/gps/proc/update_holder() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/gps/pickup() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	update_holder()

/obj/item/gps/equipped_robot() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	update_holder()

/obj/item/gps/equipped() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	update_holder()

/obj/item/gps/dropped() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	update_holder()

/obj/item/gps/process() // CHOMPEdit - Removal of obj/item/device
	if(!tracking)
		is_in_processing_list = FALSE
		return PROCESS_KILL
	update_holder()
...
/obj/item/gps/Destroy() // CHOMPEdit - Removal of obj/item/device
	STOP_PROCESSING(SSobj, src)
	is_in_processing_list = FALSE
	GPS_list -= src
	update_holder()
...
/obj/item/gps/proc/can_track(var/obj/item/gps/other, var/reachable_z_levels) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/gps/proc/update_compass(var/update_compass_icon) // CHOMPEdit - Removal of obj/item/device
	compass.hide_waypoints(FALSE)
	var/turf/my_turf = get_turf(src)
	for(var/thing in tracking_devices)
		var/obj/item/gps/gps = locate(thing) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/gps/AltClick(mob/user) // CHOMPEdit - Removal of obj/item/device
	toggletracking(user)

/obj/item/gps/proc/toggletracking(mob/living/user) // CHOMPEdit - Removal of obj/item/device
	if(!istype(user))
		return
	if(emped)
...
/obj/item/gps/proc/toggle_tracking() // CHOMPEdit - Removal of obj/item/device
	tracking = !tracking
	if(tracking)
		if(!is_in_processing_list)
			is_in_processing_list = TRUE
...
/obj/item/gps/emp_act(severity) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/gps/update_icon() // CHOMPEdit - Removal of obj/item/device
	cut_overlays()
	if(emped)
		add_overlay("emp")
	else if(tracking)
...
/obj/item/gps/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
	display(user)

 // Compiles all the data not available directly from the GPS
 // Like the positions and directions to all other GPS units
/obj/item/gps/proc/display_list() // CHOMPEdit - Removal of obj/item/device
	var/list/dat = list()
	...
	var/list/gps_list = list()
	for(var/obj/item/gps/G in GPS_list - src) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/gps/proc/display(mob/user) // CHOMPEdit - Removal of obj/item/device
	...
	if(!tracking)
		...
		if(gps_list.len)
			...
			for(var/gps in gps_data["gps_list"])
				...
				if(istype(gps_data["ref"], /obj/item/gps/internal/poi)) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/gps/Topic(var/href, var/list/href_list) // CHOMPEdit - Removal of obj/item/device
	if(..())
		return TRUE
	...
	if(href_list["track_label"])
		...
		var/obj/item/gps/gps = locate(gps_ref) // CHOMPEdit - Removal of obj/item/device
	...
	if(href_list["track_color"])
		var/obj/item/gps/gps = locate(href_list["track_color"]) // CHOMPEdit - Removal of obj/item/device
		if(istype(gps) && !QDELETED(gps))
...
/obj/item/gps/on // Defaults to off to avoid polluting the signal list with a bunch of GPSes without owners. If you need to spawn active ones, use these. // CHOMPEdit - Removal of obj/item/device
	tracking = TRUE

/obj/item/gps/command // CHOMPEdit - Removal of obj/item/device
	icon_state = "gps-com"
	gps_tag = "COM0"

/obj/item/gps/command/on // CHOMPEdit - Removal of obj/item/device
	tracking = TRUE

/obj/item/gps/security // CHOMPEdit - Removal of obj/item/device
	icon_state = "gps-sec"
	gps_tag = "SEC0"

/obj/item/gps/security/on // CHOMPEdit - Removal of obj/item/device
	tracking = TRUE

/obj/item/gps/security/hos // CHOMPEdit - Removal of obj/item/device
	icon_state = "gps-sec-hos"
	gps_tag = "HOS0"

/obj/item/gps/security/hos/on // CHOMPEdit - Removal of obj/item/device
	tracking = TRUE
...
/obj/item/gps/medical/on // CHOMPEdit - Removal of obj/item/device
	tracking = TRUE

/obj/item/gps/medical/cmo // CHOMPEdit - Removal of obj/item/device
	icon_state = "gps-med-cmo"
	gps_tag = "CMO0"

/obj/item/gps/medical/cmo/on // CHOMPEdit - Removal of obj/item/device
	tracking = TRUE

/obj/item/gps/science // CHOMPEdit - Removal of obj/item/device
	icon_state = "gps-sci"
	gps_tag = "SCI0"

/obj/item/gps/science/on // CHOMPEdit - Removal of obj/item/device
	tracking = TRUE

/obj/item/gps/science/rd // CHOMPEdit - Removal of obj/item/device
	icon_state = "gps-sci-rd"
	gps_tag = "RD0"

/obj/item/gps/science/rd/on // CHOMPEdit - Removal of obj/item/device
	tracking = TRUE

/obj/item/gps/engineering // CHOMPEdit - Removal of obj/item/device
	icon_state = "gps-eng"
	gps_tag = "ENG0"

/obj/item/gps/engineering/on // CHOMPEdit - Removal of obj/item/device
	tracking = TRUE

/obj/item/gps/engineering/atmos // CHOMPEdit - Removal of obj/item/device
	icon_state = "gps-eng-atm"
	gps_tag = "ATM0"

/obj/item/gps/engineering/atmos/on // CHOMPEdit - Removal of obj/item/device
	tracking = TRUE

/obj/item/gps/engineering/ce // CHOMPEdit - Removal of obj/item/device
	icon_state = "gps-eng-ce"
	gps_tag = "CE0"

/obj/item/gps/engineering/ce/on // CHOMPEdit - Removal of obj/item/device
	tracking = TRUE

/obj/item/gps/mining // CHOMPEdit - Removal of obj/item/device
	icon_state = "gps-mine"
	gps_tag = "MINE0"
...
/obj/item/gps/mining/on // CHOMPEdit - Removal of obj/item/device
	tracking = TRUE
...
/obj/item/gps/explorer/on // CHOMPEdit - Removal of obj/item/device
	tracking = TRUE

/obj/item/gps/robot // CHOMPEdit - Removal of obj/item/device
	icon_state = "gps-borg"
	gps_tag = "SYNTH0"
...
/obj/item/gps/internal // Base type for immobile/internal GPS units. // CHOMPEdit - Removal of obj/item/device
	icon_state = "internal"
...
/obj/item/gps/internal/base // CHOMPEdit - Removal of obj/item/device
	gps_tag = "NT_BASE"
	desc = "A homing signal from NanoTrasen's outpost."

/obj/item/gps/internal/poi // CHOMPEdit - Removal of obj/item/device
	gps_tag = "Unidentified Signal"
	desc = "A signal that seems forboding."

/obj/item/gps/syndie // CHOMPEdit - Removal of obj/item/device
...
/obj/item/gps/syndie/display(mob/user) // CHOMPEdit - Removal of obj/item/device
