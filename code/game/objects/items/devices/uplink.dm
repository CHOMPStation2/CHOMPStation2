...
/obj/item/uplink // CHOMPEdit - Removal of obj/item/device
...
/obj/item/uplink/Initialize(var/mapload) // CHOMPEdit - Removal of obj/item/device
	. = ..()
	addtimer(CALLBACK(src, PROC_REF(next_offer)), offer_time) //It seems like only the /hidden type actually makes use of this...

/obj/item/uplink/get_item_cost(var/item_type, var/item_cost) // CHOMPEdit - Removal of obj/item/device
	return (discount_item && (item_type == discount_item)) ? max(1, round(item_cost*discount_amount)) : item_cost

/obj/item/uplink/proc/next_offer() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/uplink/hidden // CHOMPEdit - Removal of obj/item/device
	name = "hidden uplink"
...
/obj/item/uplink/hidden/Initialize() // CHOMPEdit - Removal of obj/item/device
	. = ..()
	if(!isitem(loc))
		return INITIALIZE_HINT_QDEL

/obj/item/uplink/hidden/next_offer() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/uplink/hidden/proc/toggle() // CHOMPEdit - Removal of obj/item/device
	active = !active

// Directly trigger the uplink. Turn on if it isn't already.
/obj/item/uplink/hidden/proc/trigger(mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	if(!active)
		toggle()
	tgui_interact(user)
...
// current item's menu.
/obj/item/uplink/hidden/proc/check_trigger(mob/user as mob, var/value, var/target) // CHOMPEdit - Removal of obj/item/device
	if(value == target)
		trigger(user)
		return TRUE
	return FALSE
...
// Legacy
/obj/item/uplink/hidden/interact(mob/user) // CHOMPEdit - Removal of obj/item/device
	tgui_interact(user)

/*****************
 * Uplink TGUI
 *****************/
/obj/item/uplink/tgui_host() // CHOMPEdit - Removal of obj/item/device
	return loc

/obj/item/uplink/hidden/tgui_state(mob/user) // CHOMPEdit - Removal of obj/item/device
	return GLOB.tgui_deep_inventory_state

/obj/item/uplink/hidden/tgui_interact(mob/user, datum/tgui/ui, datum/tgui/parent_ui) // CHOMPEdit - Removal of obj/item/device
	if(!active)
		toggle()
...
/obj/item/uplink/hidden/tgui_data(mob/user, datum/tgui/ui, datum/tgui_state/state) // CHOMPEdit - Removal of obj/item/device
	if(!user.mind)
		return
...
/obj/item/uplink/hidden/tgui_static_data(mob/user) // CHOMPEdit - Removal of obj/item/device
	var/list/data = ..()
...
/obj/item/uplink/hidden/tgui_status(mob/user, datum/tgui_state/state) // CHOMPEdit - Removal of obj/item/device
	if(!active)
		return STATUS_CLOSE
	return ..()

/obj/item/uplink/hidden/tgui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state) // CHOMPEdit - Removal of obj/item/device
	if(..())
		return TRUE
...
/obj/item/radio/uplink/New() // CHOMPEdit - Removal of obj/item/device
	..()
	hidden_uplink = new(src)
	icon_state = "radio"

/obj/item/radio/uplink/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	if(hidden_uplink)
		hidden_uplink.trigger(user)

/obj/item/multitool/uplink/New() // CHOMPEdit - Removal of obj/item/device
	..()
	hidden_uplink = new(src)

/obj/item/multitool/uplink/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/device
	if(hidden_uplink)
		hidden_uplink.trigger(user)

/obj/item/radio/headset/uplink // CHOMPEdit - Removal of obj/item/device
	traitor_frequency = 1445

/obj/item/radio/headset/uplink/New() // CHOMPEdit - Removal of obj/item/device
	..()
	hidden_uplink = new(src)
