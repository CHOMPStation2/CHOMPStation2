...
/obj/item/batterer // CHOMPEdit - Removal of obj/item/device
	name = "mind batterer"
...
/obj/item/batterer/attack_self(mob/living/carbon/user as mob, flag = 0, emp = 0) // CHOMPEdit - Removal of obj/item/device
	if(!user) 	return
