...
/obj/item/aicard/attack(mob/living/silicon/decoy/M as mob, mob/user as mob) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/aicard/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
	tgui_interact(user)

/obj/item/aicard/tgui_interact(mob/user, datum/tgui/ui = null, datum/tgui_state/custom_state) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/aicard/tgui_state(mob/user) // CHOMPEdit - Removal of obj/item/device
	return GLOB.tgui_inventory_state

/obj/item/aicard/tgui_data(mob/user) // CHOMPEdit - Removal of obj/item/device
	var/data[0]
...
/obj/item/aicard/tgui_act(action, params) // CHOMPEdit - Removal of obj/item/device
	if(..())
		return TRUE
...
/obj/item/aicard/update_icon() // CHOMPEdit - Removal of obj/item/device
	cut_overlays()
	if(carded_ai)
...
/obj/item/aicard/proc/grab_ai(var/mob/living/silicon/ai/ai, var/mob/living/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/aicard/proc/clear() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/aicard/see_emote(mob/living/M, text) // CHOMPEdit - Removal of obj/item/device
	if(carded_ai && carded_ai.client)
		var/rendered = "<span class='message'>[text]</span>"
		carded_ai.show_message(rendered, 2)
	..()

/obj/item/aicard/show_message(msg, type, alt, alt_type) // CHOMPEdit - Removal of obj/item/device
	if(carded_ai && carded_ai.client)
		var/rendered = "<span class='message'>[msg]</span>"
		carded_ai.show_message(rendered, type)
	..()

/obj/item/aicard/relaymove(var/mob/user, var/direction) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/aicard/proc/wipe_ai() // CHOMPEdit - Removal of obj/item/device
