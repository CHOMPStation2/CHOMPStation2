...
/obj/item/megaphone/proc/can_broadcast(var/mob/living/user) // CHOMPEdit - Removal of obj/item/device
	if(user.client)
...
/obj/item/megaphone/proc/do_broadcast(var/mob/living/user, var/message) // CHOMPEdit - Removal of obj/item/device
	if(emagged)
		if(insults)
...
/obj/item/megaphone/attack_self(var/mob/living/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/megaphone/emag_act(var/remaining_charges, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	if(!emagged)
...
/obj/item/megaphone/super // CHOMPEdit - Removal of obj/item/device
	name = "gigaphone"
...
/obj/item/megaphone/super/emag_act(var/remaining_charges, var/mob/user) // CHOMPEdit - Removal of obj/item/device
	..()
	if(emagged)
...
/obj/item/megaphone/super/verb/turn_volume_dial() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/megaphone/super/proc/adjust_volume(var/mob/living/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/megaphone/super/verb/change_font() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/megaphone/super/proc/adjust_font(var/mob/living/user) // CHOMPEdit - Removal of obj/item/device
	var/new_font = tgui_input_list(user, "Set Volume", "Set Volume", font_options)

	if(new_font && Adjacent(user))
		broadcast_font = new_font

/obj/item/megaphone/super/verb/change_color() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/megaphone/super/proc/adjust_color(var/mob/living/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/megaphone/super/do_broadcast(var/mob/living/user, var/message) // CHOMPEdit - Removal of obj/item/device
	if(emagged)
		if(insults)
			var/insult = pick(insultmsg)
