...
/obj/item/healthanalyzer/New() // CHOMPEdit - Removal of obj/item/device
	if(advscan >= 1)
		verbs += /obj/item/healthanalyzer/proc/toggle_adv // CHOMPEdit - Removal of obj/item/device
	..()

/obj/item/healthanalyzer/examine(mob/user) // CHOMPEdit - Removal of obj/item/device
	. = ..()
	if(guide)
...
/obj/item/healthanalyzer/do_surgery(mob/living/M, mob/living/user) // CHOMPEdit - Removal of obj/item/device
	if(user.a_intent != I_HELP) //in case it is ever used as a surgery tool
		return ..()
	scan_mob(M, user) //default surgery behaviour is just to scan as usual
	return 1

/obj/item/healthanalyzer/attack(mob/living/M, mob/living/user) // CHOMPEdit - Removal of obj/item/device
	scan_mob(M, user)

/obj/item/healthanalyzer/proc/scan_mob(mob/living/M, mob/living/user) // CHOMPEdit - Removal of obj/item/device
	var/dat = ""
...
/obj/item/healthanalyzer/verb/toggle_mode() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/healthanalyzer/proc/toggle_adv() // CHOMPEdit - Removal of obj/item/device
...
/obj/item/healthanalyzer/improved //reports bone fractures, IB, quantity of beneficial reagents in stomach; also regular health analyzer stuff // CHOMPEdit - Removal of obj/item/device
...
/obj/item/healthanalyzer/advanced //reports all of the above, as well as radiation severity and minor brain damage // CHOMPEdit - Removal of obj/item/device
...
/obj/item/healthanalyzer/phasic //reports all of the above, as well as name and quantity of nonmed reagents in stomach // CHOMPEdit - Removal of obj/item/device
