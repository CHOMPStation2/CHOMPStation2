...
/obj/item/reagent_scanner/afterattack(obj/O, mob/living/user, proximity) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/reagent_scanner/adv // CHOMPEdit - Removal of obj/item/device
