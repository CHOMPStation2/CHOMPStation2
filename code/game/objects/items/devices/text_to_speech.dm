/obj/item/text_to_speech // CHOMPEdit - Removal of obj/item/device
	name = "TTS device"
...
/obj/item/text_to_speech/attack_self(mob/user as mob) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/text_to_speech/AltClick(mob/user) // QOL Change // CHOMPEdit - Removal of obj/item/device
	attack_self(user)
