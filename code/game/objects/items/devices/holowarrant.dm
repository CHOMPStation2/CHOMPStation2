...
//look at it
/obj/item/holowarrant/examine(mob/user) // CHOMPEdit - Removal of obj/item/device
	. = ..()
	if(active)
...
/obj/item/holowarrant/attack_self(mob/living/user as mob) // CHOMPEdit - Removal of obj/item/device
	active = null
...
/obj/item/holowarrant/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/weapon // CHOMPEdit - Removal of obj/item/device
	if(active)
		var/obj/item/card/id/I = W.GetIdCard() // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/holowarrant/attack(mob/living/carbon/M as mob, mob/living/carbon/user as mob) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/holowarrant/update_icon() // CHOMPEdit - Removal of obj/item/device
	if(active)
		icon_state = "holowarrant_filled"
	else
		icon_state = "holowarrant"

/obj/item/holowarrant/proc/show_content(mob/user, forceshow) // CHOMPEdit - Removal of obj/item/device
	if(!active)
		return
...
/obj/item/storage/box/holowarrants // VOREStation addition starts // CHOMPEdit - Removal of obj/item/weapon
	name = "holowarrant devices"
	desc = "A box of holowarrant displays for security use."

/obj/item/storage/box/holowarrants/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	for(var/i = 0 to 3)
		new /obj/item/holowarrant(src) // VOREStation addition ends // CHOMPEdit - Removal of obj/item/device
