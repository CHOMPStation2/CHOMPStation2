/obj/item/selectable_item
	...
	var/list/item_options = list("Gift" = /obj/item/a_gift, // CHOMPEdit - Removal of obj/item/weapon
								 "Health Analyzer" = /obj/item/healthanalyzer) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/selectable_item/chemistrykit/size
	...
	item_options = list("Macrocillin" = /obj/item/reagent_containers/glass/beaker/vial/macrocillin, // CHOMPEdit - Removal of obj/item/weapon
						"Microcillin" = /obj/item/reagent_containers/glass/beaker/vial/microcillin, // CHOMPEdit - Removal of obj/item/weapon
						"Normalcillin" = /obj/item/reagent_containers/glass/beaker/vial/normalcillin) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/selectable_item/chemistrykit/gender
	...
	item_options = list("Androrovir" = /obj/item/reagent_containers/glass/beaker/vial/androrovir, // CHOMPEdit - Removal of obj/item/weapon
						"Gynorovir" = /obj/item/reagent_containers/glass/beaker/vial/gynorovir, // CHOMPEdit - Removal of obj/item/weapon
						"Androgynorovir" = /obj/item/reagent_containers/glass/beaker/vial/androgynorovir) // CHOMPEdit - Removal of obj/item/weapon
