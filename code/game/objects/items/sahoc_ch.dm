/obj/item/buttonofnormal // CHOMPEdit - Removal of obj/item/device
	name = "Chaos button"
...
/obj/item/buttonofnormal/pickup(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(!capsuleowner)
		capsuleowner = user

/obj/item/buttonofnormal/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
	if(colorindex)
		nonrandom()
	sleep(10)
...
/obj/item/buttonofnormal/throw_impact(atom/A, speed, mob/user) // CHOMPEdit - Removal of obj/item/device
	..()
	if(isliving(A))
		if(colorindex)
			nonrandom()
...
/obj/item/buttonofnormal/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/device
...
/obj/item/buttonofnormal/proc/nonrandom() //Secret ball randmoizer rig code // CHOMPEdit - Removal of obj/item/device
	switch(colorindex)
...
/obj/item/daredevice // CHOMPEdit - Removal of obj/item/device
	name = "Dare button"
...
/obj/item/daredevice/attackby(obj/item/W, mob/user) // CHOMPEdit - Removal of obj/item/device
	if(istype(W, /obj/item/pen)) // CHOMPEdit - Removal of obj/item/weapon
		colorindex += 1
		if(colorindex >= 6)
			colorindex = 0
...
/obj/item/daredevice/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/device
	...
	switch(luckynumber7)
		...
		if(7)
			new	/obj/item/material/butterfly/switchblade(capsuleowner.loc) // CHOMPEdit - Removal of obj/item/weapon
			capsuleowner.apply_damage(10, BRUTE) //Loss Damaging! WIN KNIVE!
		if(9)
			new	/obj/item/gun/energy/sizegun/not_advanced(capsuleowner.loc) // CHOMPEdit - Removal of obj/item/weapon
			qdel(src)
		if(777)	new	/obj/item/spacecash/c1000(capsuleowner.loc) //for rigging // CHOMPEdit - Removal of obj/item/weapon
