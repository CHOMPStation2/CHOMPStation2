/obj/item/antag_spawner // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/antag_spawner/New() // CHOMPEdit - Removal of obj/item/weapon
	..()
	sparks = new /datum/effect/effect/system/spark_spread()
	sparks.set_up(5, 0, src)
	sparks.attach(loc)

/obj/item/antag_spawner/Destroy() // CHOMPEdit - Removal of obj/item/weapon
	QDEL_NULL(sparks)
	return ..()

/obj/item/antag_spawner/proc/spawn_antag(client/C, turf/T) // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/antag_spawner/proc/equip_antag(mob/target) // CHOMPEdit - Removal of obj/item/weapon
	return

/obj/item/antag_spawner/proc/request_player() // CHOMPEdit - Removal of obj/item/weapon
	if(!ghost_query_type)
		return
	if(searching)
...
/obj/item/antag_spawner/proc/reset_search() // CHOMPEdit - Removal of obj/item/weapon
	searching = FALSE
	return

/obj/item/antag_spawner/technomancer_apprentice // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/antag_spawner/technomancer_apprentice/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	to_chat(user, "<span class='notice'>Teleporter attempting to lock on to your apprentice.</span>")
	request_player()

/obj/item/antag_spawner/technomancer_apprentice/request_player() // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "oldshieldon"
	..()

/obj/item/antag_spawner/technomancer_apprentice/reset_search() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(!used)
		icon_state = "oldshieldoff"
...
/obj/item/antag_spawner/technomancer_apprentice/spawn_antag(client/C, turf/T) // CHOMPEdit - Removal of obj/item/weapon
	sparks.start()
...
/obj/item/antag_spawner/technomancer_apprentice/equip_antag(mob/technomancer_mob) // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/antag_spawner/syndicate_drone // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/antag_spawner/syndicate_drone/attack_self(mob/user) // CHOMPEdit - Removal of obj/item/weapon
	to_chat(user, "<span class='notice'>Teleporter attempting to lock on to an available unit.</span>")
	request_player()

/obj/item/antag_spawner/syndicate_drone/request_player() // CHOMPEdit - Removal of obj/item/weapon
	icon_state = "oldshieldon"
	..()

/obj/item/antag_spawner/syndicate_drone/reset_search() // CHOMPEdit - Removal of obj/item/weapon
	..()
	if(!used)
		icon_state = "oldshieldoff"
...
/obj/item/antag_spawner/syndicate_drone/spawn_antag(client/C, turf/T) // CHOMPEdit - Removal of obj/item/weapon
	sparks.start()
...
/obj/item/antag_spawner/syndicate_drone/protector // CHOMPEdit - Removal of obj/item/weapon
	drone_type = /mob/living/silicon/robot/syndicate/protector

/obj/item/antag_spawner/syndicate_drone/combat_medic // CHOMPEdit - Removal of obj/item/weapon
	drone_type = /mob/living/silicon/robot/syndicate/combat_medic

/obj/item/antag_spawner/syndicate_drone/mechanist // CHOMPEdit - Removal of obj/item/weapon
