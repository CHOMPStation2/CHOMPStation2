...
/obj/item/Bump(mob/M as mob) // CHOMPEdit - Removal of obj/item/weapon
	spawn(0)
		..()
	return
...
/obj/item/proc/cleave(mob/living/user, atom/target) // CHOMPEdit - Removal of obj/item/weapon
	if(cleaving)
...
/obj/item/material/pre_attack(mob/living/target, mob/living/user) // CHOMPEdit - Removal of obj/item/weapon
	if(can_cleave && istype(target))
		cleave(user, target)
	..()

// This is purely the visual effect of cleaving.
/obj/item/proc/cleave_visual(var/mob/living/user, var/mob/living/target) // CHOMPEdit - Removal of obj/item/weapon
