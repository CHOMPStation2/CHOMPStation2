/obj/item/banner // CHOMPEdit - Removal of obj/item/weapon
	name = "banner"
	icon = 'icons/obj/items.dmi'
	icon_state = "banner"
	desc = "A banner that's invisible because it shouldn't exist."

/obj/item/banner/red // CHOMPEdit - Removal of obj/item/weapon
	name = "red banner"
	icon_state = "banner-red"
	desc = "A red colored banner."

/obj/item/banner/blue // CHOMPEdit - Removal of obj/item/weapon
	name = "blue banner"
	icon_state = "banner-blue"
	desc = "A blue colored banner."

/obj/item/banner/green // CHOMPEdit - Removal of obj/item/weapon
	name = "green banner"
	icon_state = "banner-green"
	desc = "A green colored banner."

/obj/item/banner/nt // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/banner/altevian // CHOMPEdit - Removal of obj/item/weapon
...
/obj/item/banner/virgov // CHOMPEdit - Removal of obj/item/weapon
