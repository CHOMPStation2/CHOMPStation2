...
/proc/get_random_useful_type()
	if(!random_useful_)
		random_useful_ = subtypesof(/obj/item/pen/crayon) // CHOMPEdit - Removal of obj/item/weapon
		random_useful_ += /obj/item/pen // CHOMPEdit - Removal of obj/item/weapon
		random_useful_ += /obj/item/pen/blue // CHOMPEdit - Removal of obj/item/weapon
		random_useful_ += /obj/item/pen/red // CHOMPEdit - Removal of obj/item/weapon
		random_useful_ += /obj/item/pen/multi // CHOMPEdit - Removal of obj/item/weapon
		random_useful_ += /obj/item/storage/box/matches // CHOMPEdit - Removal of obj/item/weapon
...
/proc/get_random_junk_type()
	...
	if(prob(70)) // Misc. junk
		if(!random_junk_)
			...
			random_junk_ += /obj/item/paper/crumpled // CHOMPEdit - Removal of obj/item/weapon
			random_junk_ += /obj/item/inflatable/torn
			random_junk_ += /obj/effect/decal/cleanable/molten_item
			random_junk_ += /obj/item/material/shard // CHOMPEdit - Removal of obj/item/weapon
