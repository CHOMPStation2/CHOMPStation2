...
/obj/random/multiple/gun/projectile/shotgun/item_to_spawn()
	return pick(
			prob(4);list(
				/obj/item/gun/projectile/shotgun/doublebarrel/pellet, // CHOMPEdit Start - Removal of obj/item/weapon
			...
			prob(3);list(
				/obj/item/gun/projectile/shotgun/doublebarrel/sawn, // CHOMPEdit Start - Removal of obj/item/weapon
				/obj/item/ammo_magazine/clip/c12g/pellet,
				/obj/item/ammo_magazine/clip/c12g/pellet,
				/obj/item/ammo_magazine/clip/c12g/pellet,
				/obj/item/ammo_magazine/clip/c12g/pellet
			...
			prob(3);list(
				/obj/item/gun/projectile/shotgun/pump/slug, // CHOMPEdit Start - Removal of obj/item/weapon
				/obj/item/ammo_magazine/ammo_box/b12g
			),
			prob(1);list(
				/obj/item/gun/projectile/shotgun/pump/combat, // CHOMPEdit Start - Removal of obj/item/weapon
				/obj/item/ammo_magazine/ammo_box/b12g
			),
			prob(1);list(
				/obj/item/gun/projectile/shotgun/semi, // CHOMPEdit Start - Removal of obj/item/weapon
				/obj/item/ammo_magazine/ammo_box/b12g
			)
		)
