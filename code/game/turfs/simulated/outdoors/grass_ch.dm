...
GLOBAL_LIST_INIT(grass_animals,list(
	...
	"thor_real" = list(
		...
		/mob/living/simple_mob/vore/aggressive/frog = 6,
		/mob/living/simple_mob/animal/passive/chicken = 6, // Did you know chickens come from South-East Asia? In the jungle? Bet they'd thrive here as an invasive species.
		/mob/living/simple_mob/animal/passive/mouse = 6,
		/mob/living/simple_mob/animal/passive/mouse/rat = 6,
		/mob/living/simple_mob/vore/aggressive/rat = 6,
		...
		// /mob/living/simple_mob/vore/pitcher = 6, // Inactive until the jank on these is fixed by Virgo.
		/mob/living/simple_mob/vore/pitcher_plant = 6,
		/mob/living/simple_mob/vore/meowl = 4,
		/mob/living/simple_mob/vore/fennec = 4,
		/mob/living/simple_mob/vore/redpanda = 4,
