...
/datum/category_item/catalogue/flora/torris/jungle_grass
	...
	desc = "A naturally thick grass that has adapted to the hostile climate of Torris. \
	The grass is dense and covers the moist ground of the surface of Torris. The grass \
	can't grow or survive long anywhere else as it requires the dense moisture in the \
	atmosphere to survive. When cut it gives off a pleasantly sweet scent."
