...
/turf/unsimulated/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	return FALSE

/turf/unsimulated/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	return FALSE
