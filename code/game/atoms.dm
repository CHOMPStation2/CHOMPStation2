...
/atom/proc/rcd_values(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	return FALSE

/atom/proc/rcd_act(mob/living/user, obj/item/rcd/the_rcd, passed_mode) // CHOMPEdit - Removal of obj/item/weapon
	return
...
/atom/proc/on_rag_wipe(var/obj/item/reagent_containers/glass/rag/R) // CHOMPEdit - Removal of obj/item/weapon
	clean_blood()
