...
datum/controller/transfer_controller/process()
	...
	//CHOMPEdit if (round_duration_in_ds >= shift_last_vote - 2 MINUTES)
	//CHOMPEdit 	shift_last_vote = 999999999999 //Setting to a stupidly high number since it'll be not used again.
	//CHOMPEdit 	to_world("<b>Warning: This upcoming round-extend vote will be your last chance to vote for shift extension. Wrap up your scenes in the next 60 minutes if the round is extended.</b>") //CHOMPStation Edit
	...
	//CHOMPEdit else if (round_duration_in_ds >= timerbuffer - 1 MINUTE)
	//CHOMPEdit 	SSvote.autotransfer()
	//VOREStation Edit END
	//CHOMPEdit 	timerbuffer = timerbuffer + config.vote_autotransfer_interval
