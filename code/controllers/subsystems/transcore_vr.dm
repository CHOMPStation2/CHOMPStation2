...
/datum/controller/subsystem/transcore/proc/process_implants(resumed = 0)
	if (!resumed)
		...
		for(var/key in databases)
			...
			for(var/obj/item/implant/backup/imp as anything in db.implants) // CHOMPEdit - Removal of obj/item/weapon
				src.current_run[imp] = db

	var/list/current_run = src.current_run
	while(current_run.len)
		var/obj/item/implant/backup/imp = current_run[current_run.len] // CHOMPEdit - Removal of obj/item/weapon
...
/datum/controller/subsystem/transcore/proc/m_backup(var/datum/mind/mind, var/obj/item/nif/nif, var/one_time = FALSE, var/database_key) // CHOMPEdit - Removal of obj/item/device
...
/datum/controller/subsystem/transcore/proc/core_dump(var/obj/item/disk/transcore/disk, var/database_key) // CHOMPEdit - Removal of obj/item/weapon
	var/datum/transcore_db/db = db_by_key(database_key)
...
/datum/transcore_db
	...
	var/list/obj/item/implant/backup/implants = list()	// All OPERATING implants that are being ticked // CHOMPEdit - Removal of obj/item/weapon

	var/core_dumped = FALSE
	var/key // Key for this DB

/datum/transcore_db/proc/m_backup(var/datum/mind/mind, var/obj/item/nif/nif, var/one_time = FALSE) // CHOMPEdit - Removal of obj/item/device
	ASSERT(mind)
...
/datum/transcore_db/proc/core_dump(var/obj/item/disk/transcore/disk) // CHOMPEdit - Removal of obj/item/weapon
	ASSERT(disk)
