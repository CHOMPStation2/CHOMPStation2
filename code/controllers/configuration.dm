...
||||||| parent of 293b021290... Merge pull request #10840 from VOREStation/Arokha/discobutton
var/list/gamemode_cache = list()
...
/datum/configuration/proc/post_load()
	...
	if (!config.python_path)
		if(world.system_type == UNIX)
			...
			config.python_path = "python"
>>>>>>> 293b021290... Merge pull request #10840 from VOREStation/Arokha/discobutton
