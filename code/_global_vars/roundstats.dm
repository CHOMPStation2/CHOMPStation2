<<<<<<< HEAD:code/_global_vars/roundstats.dm
...
||||||| parent of 2fac83c382... Merge pull request #9516 from VOREStation/upstream-merge-7790:code/datums/roundstats/roundstats.dm
...
/hook/roundend/proc/RoundTrivia()//bazinga
	...
	if(LAZYLEN(valid_stats_list))
		...
		for(var/body in valid_stats_list)
			to_world("[body]")
>>>>>>> 2fac83c382... Merge pull request #9516 from VOREStation/upstream-merge-7790:code/datums/roundstats/roundstats.dm
